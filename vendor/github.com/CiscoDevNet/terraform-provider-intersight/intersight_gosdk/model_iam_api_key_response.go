...
func (dst *IamApiKeyResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'iam.ApiKey.List'
	if jsonDict["ObjectType"] == "iam.ApiKey.List" {
		// try to unmarshal JSON data into IamApiKeyList
		err = json.Unmarshal(data, &dst.IamApiKeyList)
		if err == nil {
			return nil // data stored in dst.IamApiKeyList, return on the first match
		} else {
			dst.IamApiKeyList = nil
			return fmt.Errorf("Failed to unmarshal IamApiKeyResponse as IamApiKeyList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamApiKeyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamApiKeyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamApiKeyResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src IamApiKeyResponse) MarshalJSON() ([]byte, error) {
	if src.IamApiKeyList != nil {
		return json.Marshal(&src.IamApiKeyList)
	}
...
type NullableIamApiKeyResponse struct {
	value *IamApiKeyResponse
	isSet bool
}

func (v NullableIamApiKeyResponse) Get() *IamApiKeyResponse {
	return v.value
}

func (v *NullableIamApiKeyResponse) Set(val *IamApiKeyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIamApiKeyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIamApiKeyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamApiKeyResponse(val *IamApiKeyResponse) *NullableIamApiKeyResponse {
	return &NullableIamApiKeyResponse{value: val, isSet: true}
}

func (v NullableIamApiKeyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamApiKeyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
