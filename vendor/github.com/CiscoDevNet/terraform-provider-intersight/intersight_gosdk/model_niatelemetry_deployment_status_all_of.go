...
// NiatelemetryDeploymentStatusAllOf Definition of the list of properties defined in 'niatelemetry.DeploymentStatus', excluding properties defined in parent classes.
type NiatelemetryDeploymentStatusAllOf struct {
...
type _NiatelemetryDeploymentStatusAllOf NiatelemetryDeploymentStatusAllOf
...
func NewNiatelemetryDeploymentStatusAllOf(classId string, objectType string) *NiatelemetryDeploymentStatusAllOf {
	this := NiatelemetryDeploymentStatusAllOf{}
...
func (o NiatelemetryDeploymentStatusAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryDeploymentStatusAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryDeploymentStatusAllOf := _NiatelemetryDeploymentStatusAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryDeploymentStatusAllOf); err == nil {
		*o = NiatelemetryDeploymentStatusAllOf(varNiatelemetryDeploymentStatusAllOf)
	}
...
type NullableNiatelemetryDeploymentStatusAllOf struct {
	value *NiatelemetryDeploymentStatusAllOf
	isSet bool
}

func (v NullableNiatelemetryDeploymentStatusAllOf) Get() *NiatelemetryDeploymentStatusAllOf {
	return v.value
}

func (v *NullableNiatelemetryDeploymentStatusAllOf) Set(val *NiatelemetryDeploymentStatusAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryDeploymentStatusAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryDeploymentStatusAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryDeploymentStatusAllOf(val *NiatelemetryDeploymentStatusAllOf) *NullableNiatelemetryDeploymentStatusAllOf {
	return &NullableNiatelemetryDeploymentStatusAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryDeploymentStatusAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryDeploymentStatusAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
