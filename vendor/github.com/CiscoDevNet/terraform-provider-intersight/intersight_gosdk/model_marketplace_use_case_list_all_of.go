...
// MarketplaceUseCaseListAllOf struct for MarketplaceUseCaseListAllOf
type MarketplaceUseCaseListAllOf struct {
...
type _MarketplaceUseCaseListAllOf MarketplaceUseCaseListAllOf
...
func NewMarketplaceUseCaseListAllOf() *MarketplaceUseCaseListAllOf {
	this := MarketplaceUseCaseListAllOf{}
	return &this
}
...
func (o MarketplaceUseCaseListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *MarketplaceUseCaseListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMarketplaceUseCaseListAllOf := _MarketplaceUseCaseListAllOf{}

	if err = json.Unmarshal(bytes, &varMarketplaceUseCaseListAllOf); err == nil {
		*o = MarketplaceUseCaseListAllOf(varMarketplaceUseCaseListAllOf)
	}
...
type NullableMarketplaceUseCaseListAllOf struct {
	value *MarketplaceUseCaseListAllOf
	isSet bool
}

func (v NullableMarketplaceUseCaseListAllOf) Get() *MarketplaceUseCaseListAllOf {
	return v.value
}

func (v *NullableMarketplaceUseCaseListAllOf) Set(val *MarketplaceUseCaseListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceUseCaseListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceUseCaseListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceUseCaseListAllOf(val *MarketplaceUseCaseListAllOf) *NullableMarketplaceUseCaseListAllOf {
	return &NullableMarketplaceUseCaseListAllOf{value: val, isSet: true}
}

func (v NullableMarketplaceUseCaseListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceUseCaseListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
