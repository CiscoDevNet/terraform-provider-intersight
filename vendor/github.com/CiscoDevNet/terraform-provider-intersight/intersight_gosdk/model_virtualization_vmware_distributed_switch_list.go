...
// checks if the VirtualizationVmwareDistributedSwitchList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationVmwareDistributedSwitchList{}
...
func (o VirtualizationVmwareDistributedSwitchList) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationVmwareDistributedSwitchList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareDistributedSwitchListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareDistributedSwitchList)
	if err == nil {
