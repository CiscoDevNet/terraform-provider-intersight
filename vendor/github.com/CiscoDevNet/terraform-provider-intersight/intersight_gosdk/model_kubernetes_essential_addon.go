...
func (o *KubernetesEssentialAddon) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varKubernetesEssentialAddonWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varKubernetesEssentialAddon)
	if err == nil {
