...
// KubernetesBaseVirtualMachineInfraConfigAllOf Definition of the list of properties defined in 'kubernetes.BaseVirtualMachineInfraConfig', excluding properties defined in parent classes.
type KubernetesBaseVirtualMachineInfraConfigAllOf struct {
...
type _KubernetesBaseVirtualMachineInfraConfigAllOf KubernetesBaseVirtualMachineInfraConfigAllOf
...
func NewKubernetesBaseVirtualMachineInfraConfigAllOf(classId string, objectType string) *KubernetesBaseVirtualMachineInfraConfigAllOf {
	this := KubernetesBaseVirtualMachineInfraConfigAllOf{}
...
// SetNetworkInterfaces gets a reference to the given []KubernetesNetworkInterfaceSpec and assigns it to the NetworkInterfaces field.
...
func (o KubernetesBaseVirtualMachineInfraConfigAllOf) MarshalJSON() ([]byte, error) {
...
func (o *KubernetesBaseVirtualMachineInfraConfigAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varKubernetesBaseVirtualMachineInfraConfigAllOf := _KubernetesBaseVirtualMachineInfraConfigAllOf{}

	if err = json.Unmarshal(bytes, &varKubernetesBaseVirtualMachineInfraConfigAllOf); err == nil {
		*o = KubernetesBaseVirtualMachineInfraConfigAllOf(varKubernetesBaseVirtualMachineInfraConfigAllOf)
	}
...
type NullableKubernetesBaseVirtualMachineInfraConfigAllOf struct {
	value *KubernetesBaseVirtualMachineInfraConfigAllOf
	isSet bool
}

func (v NullableKubernetesBaseVirtualMachineInfraConfigAllOf) Get() *KubernetesBaseVirtualMachineInfraConfigAllOf {
	return v.value
}

func (v *NullableKubernetesBaseVirtualMachineInfraConfigAllOf) Set(val *KubernetesBaseVirtualMachineInfraConfigAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesBaseVirtualMachineInfraConfigAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesBaseVirtualMachineInfraConfigAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesBaseVirtualMachineInfraConfigAllOf(val *KubernetesBaseVirtualMachineInfraConfigAllOf) *NullableKubernetesBaseVirtualMachineInfraConfigAllOf {
	return &NullableKubernetesBaseVirtualMachineInfraConfigAllOf{value: val, isSet: true}
}

func (v NullableKubernetesBaseVirtualMachineInfraConfigAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesBaseVirtualMachineInfraConfigAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
