...
func (o *CommHttpProxyPolicyList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCommHttpProxyPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCommHttpProxyPolicyList)
	if err == nil {
