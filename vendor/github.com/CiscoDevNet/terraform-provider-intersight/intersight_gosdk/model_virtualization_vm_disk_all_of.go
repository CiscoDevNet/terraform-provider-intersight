...
// VirtualizationVmDiskAllOf Definition of the list of properties defined in 'virtualization.VmDisk', excluding properties defined in parent classes.
type VirtualizationVmDiskAllOf struct {
...
type _VirtualizationVmDiskAllOf VirtualizationVmDiskAllOf
...
func NewVirtualizationVmDiskAllOf(classId string, objectType string) *VirtualizationVmDiskAllOf {
	this := VirtualizationVmDiskAllOf{}
...
func (o VirtualizationVmDiskAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationVmDiskAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationVmDiskAllOf := _VirtualizationVmDiskAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationVmDiskAllOf); err == nil {
		*o = VirtualizationVmDiskAllOf(varVirtualizationVmDiskAllOf)
	}
...
type NullableVirtualizationVmDiskAllOf struct {
	value *VirtualizationVmDiskAllOf
	isSet bool
}

func (v NullableVirtualizationVmDiskAllOf) Get() *VirtualizationVmDiskAllOf {
	return v.value
}

func (v *NullableVirtualizationVmDiskAllOf) Set(val *VirtualizationVmDiskAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmDiskAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmDiskAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmDiskAllOf(val *VirtualizationVmDiskAllOf) *NullableVirtualizationVmDiskAllOf {
	return &NullableVirtualizationVmDiskAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmDiskAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmDiskAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
