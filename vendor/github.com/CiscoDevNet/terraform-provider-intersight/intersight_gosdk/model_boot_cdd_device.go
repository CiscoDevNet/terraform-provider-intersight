...
func (o *BootCddDevice) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varBootCddDeviceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varBootCddDevice)
	if err == nil {
