...
// checks if the HyperflexAutoSupportPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexAutoSupportPolicy{}
...
type HyperflexAutoSupportPolicy struct {
	...
	ServiceTicketReceipient *string "json:\"ServiceTicketReceipient,omitempty\" validate:\"regexp=^$|^[a-zA-Z0-9.!#$%&'*+\\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$\""
...
// GetDefaultClassId returns the default value "hyperflex.AutoSupportPolicy" of the ClassId field.
func (o *HyperflexAutoSupportPolicy) GetDefaultClassId() interface{} {
	return "hyperflex.AutoSupportPolicy"
}
...
// GetDefaultObjectType returns the default value "hyperflex.AutoSupportPolicy" of the ObjectType field.
func (o *HyperflexAutoSupportPolicy) GetDefaultObjectType() interface{} {
	return "hyperflex.AutoSupportPolicy"
}
...
func (o *HyperflexAutoSupportPolicy) GetServiceTicketReceipient() string {
	if o == nil || IsNil(o.ServiceTicketReceipient) {
		var ret string
		return ret
	}
...
func (o *HyperflexAutoSupportPolicy) SetOrganizationNil() {
...
func (o HyperflexAutoSupportPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ServiceTicketReceipient) {
...
func (o *HyperflexAutoSupportPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexAutoSupportPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexAutoSupportPolicy)
	if err == nil {
