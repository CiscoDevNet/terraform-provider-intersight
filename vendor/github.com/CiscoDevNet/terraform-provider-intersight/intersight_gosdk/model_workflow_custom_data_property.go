...
// checks if the WorkflowCustomDataProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowCustomDataProperty{}
...
// GetDefaultClassId returns the default value "workflow.CustomDataProperty" of the ClassId field.
func (o *WorkflowCustomDataProperty) GetDefaultClassId() interface{} {
	return "workflow.CustomDataProperty"
}
...
// GetDefaultObjectType returns the default value "workflow.CustomDataProperty" of the ObjectType field.
func (o *WorkflowCustomDataProperty) GetDefaultObjectType() interface{} {
	return "workflow.CustomDataProperty"
}
...
func (o *WorkflowCustomDataProperty) GetCustomDataTypeId() string {
	if o == nil || IsNil(o.CustomDataTypeId) {
		var ret string
		return ret
	}
...
func (o *WorkflowCustomDataProperty) GetCustomDataTypeName() string {
	if o == nil || IsNil(o.CustomDataTypeName) {
		var ret string
		return ret
	}
...
func (o WorkflowCustomDataProperty) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CustomDataTypeId) {
		toSerialize["CustomDataTypeId"] = o.CustomDataTypeId
	}
	if !IsNil(o.CustomDataTypeName) {
...
func (o *WorkflowCustomDataProperty) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowCustomDataPropertyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowCustomDataProperty)
	if err == nil {
