...
// checks if the WorkflowUiInputFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowUiInputFilter{}
...
// GetDefaultClassId returns the default value "workflow.UiInputFilter" of the ClassId field.
func (o *WorkflowUiInputFilter) GetDefaultClassId() interface{} {
	return "workflow.UiInputFilter"
}
...
// GetDefaultObjectType returns the default value "workflow.UiInputFilter" of the ObjectType field.
func (o *WorkflowUiInputFilter) GetDefaultObjectType() interface{} {
	return "workflow.UiInputFilter"
}
...
func (o *WorkflowUiInputFilter) GetUserHelpMessage() string {
	if o == nil || IsNil(o.UserHelpMessage) {
		var ret string
		return ret
	}
...
func (o WorkflowUiInputFilter) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowUiInputFilter) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowUiInputFilterWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowUiInputFilter)
	if err == nil {
