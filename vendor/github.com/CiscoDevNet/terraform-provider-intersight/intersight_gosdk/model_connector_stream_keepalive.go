...
// checks if the ConnectorStreamKeepalive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorStreamKeepalive{}
...
func (o ConnectorStreamKeepalive) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorStreamKeepalive) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConnectorStreamKeepaliveWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varConnectorStreamKeepalive)
	if err == nil {
