...
// StorageHitachiInitiatorAllOf Definition of the list of properties defined in 'storage.HitachiInitiator', excluding properties defined in parent classes.
type StorageHitachiInitiatorAllOf struct {
...
type _StorageHitachiInitiatorAllOf StorageHitachiInitiatorAllOf
...
func NewStorageHitachiInitiatorAllOf(classId string, objectType string) *StorageHitachiInitiatorAllOf {
	this := StorageHitachiInitiatorAllOf{}
...
func (o StorageHitachiInitiatorAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageHitachiInitiatorAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageHitachiInitiatorAllOf := _StorageHitachiInitiatorAllOf{}

	if err = json.Unmarshal(bytes, &varStorageHitachiInitiatorAllOf); err == nil {
		*o = StorageHitachiInitiatorAllOf(varStorageHitachiInitiatorAllOf)
	}
...
type NullableStorageHitachiInitiatorAllOf struct {
	value *StorageHitachiInitiatorAllOf
	isSet bool
}

func (v NullableStorageHitachiInitiatorAllOf) Get() *StorageHitachiInitiatorAllOf {
	return v.value
}

func (v *NullableStorageHitachiInitiatorAllOf) Set(val *StorageHitachiInitiatorAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageHitachiInitiatorAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageHitachiInitiatorAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageHitachiInitiatorAllOf(val *StorageHitachiInitiatorAllOf) *NullableStorageHitachiInitiatorAllOf {
	return &NullableStorageHitachiInitiatorAllOf{value: val, isSet: true}
}

func (v NullableStorageHitachiInitiatorAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageHitachiInitiatorAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
