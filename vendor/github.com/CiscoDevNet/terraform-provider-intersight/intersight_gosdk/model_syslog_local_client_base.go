...
// checks if the SyslogLocalClientBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogLocalClientBase{}
...
// GetDefaultClassId returns the default value "syslog.LocalFileLoggingClient" of the ClassId field.
func (o *SyslogLocalClientBase) GetDefaultClassId() interface{} {
	return "syslog.LocalFileLoggingClient"
}
...
// GetDefaultObjectType returns the default value "syslog.LocalFileLoggingClient" of the ObjectType field.
func (o *SyslogLocalClientBase) GetDefaultObjectType() interface{} {
	return "syslog.LocalFileLoggingClient"
}
...
func (o SyslogLocalClientBase) ToMap() (map[string]interface{}, error) {
...
func (o *SyslogLocalClientBase) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSyslogLocalClientBaseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSyslogLocalClientBase)
	if err == nil {
