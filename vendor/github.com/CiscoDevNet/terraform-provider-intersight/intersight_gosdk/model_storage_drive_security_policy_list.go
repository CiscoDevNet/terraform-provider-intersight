...
func (o *StorageDriveSecurityPolicyList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageDriveSecurityPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageDriveSecurityPolicyList)
	if err == nil {
