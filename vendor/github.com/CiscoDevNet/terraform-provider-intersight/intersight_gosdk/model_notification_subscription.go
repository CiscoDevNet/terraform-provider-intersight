...
type NotificationSubscription struct {
	...
	// Operation that binds all the different conditions together. * `All` - All is an AND condition applied against the individual conditions. * `Any` - Any is an OR condition applied against the individual conditions.
...
func (o *NotificationSubscription) GetDefaultClassId() interface{} {
...
func (o *NotificationSubscription) GetDefaultObjectType() interface{} {
	return "notification.AccountSubscription"
}
...
func (o *NotificationSubscription) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNotificationSubscriptionWithoutEmbeddedStruct)
	if err == nil {
		...
		varNotificationSubscription.ConditionOperator = varNotificationSubscriptionWithoutEmbeddedStruct.ConditionOperator
	...
	err = json.Unmarshal(data, &varNotificationSubscription)
	if err == nil {
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ConditionOperator")
