...
type _NiaapiFieldNoticeAllOf NiaapiFieldNoticeAllOf
...
func (o *NiaapiFieldNoticeAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiaapiFieldNoticeAllOf := _NiaapiFieldNoticeAllOf{}

	if err = json.Unmarshal(bytes, &varNiaapiFieldNoticeAllOf); err == nil {
		*o = NiaapiFieldNoticeAllOf(varNiaapiFieldNoticeAllOf)
	}
