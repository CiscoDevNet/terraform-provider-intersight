...
func (o *FirmwareEulaList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFirmwareEulaListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFirmwareEulaList)
	if err == nil {
