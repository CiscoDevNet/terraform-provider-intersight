...
// checks if the BootBootloader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootBootloader{}

// BootBootloader The boot loader is a program that loads the operating system when the computer is powered on. #### Purpose BootLoader defines common properties of a boot loader like bootloader path, which can be used by all boot devices. Other properties can be defined in individual boot device objects. #### Key Concepts - **Boot Loader Definition:** Captures common boot loader attributes, such as the loader name and path, used across multiple boot device types. - **Shared Structure:** Provides a reusable configuration framework that standardizes boot loader properties for all boot devices.
...
// GetDefaultClassId returns the default value "boot.Bootloader" of the ClassId field.
func (o *BootBootloader) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "boot.Bootloader" of the ObjectType field.
func (o *BootBootloader) GetDefaultObjectType() interface{} {
	return "boot.Bootloader"
}
...
func (o BootBootloader) ToMap() (map[string]interface{}, error) {
...
func (o *BootBootloader) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBootBootloaderWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBootBootloader)
	if err == nil {
