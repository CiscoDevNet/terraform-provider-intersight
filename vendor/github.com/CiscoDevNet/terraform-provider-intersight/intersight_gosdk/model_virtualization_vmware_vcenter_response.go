...
func VirtualizationVmwareVcenterListAsVirtualizationVmwareVcenterResponse(v *VirtualizationVmwareVcenterList) VirtualizationVmwareVcenterResponse {
	return VirtualizationVmwareVcenterResponse{
		VirtualizationVmwareVcenterList: v,
	}
}
...
func (dst *VirtualizationVmwareVcenterResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareVcenterResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareVcenterResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareVcenterResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'virtualization.VmwareVcenter.List'
	if jsonDict["ObjectType"] == "virtualization.VmwareVcenter.List" {
		// try to unmarshal JSON data into VirtualizationVmwareVcenterList
		err = json.Unmarshal(data, &dst.VirtualizationVmwareVcenterList)
		if err == nil {
			return nil // data stored in dst.VirtualizationVmwareVcenterList, return on the first match
		} else {
			dst.VirtualizationVmwareVcenterList = nil
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareVcenterResponse as VirtualizationVmwareVcenterList: %s", err.Error())
		}
	}
...
func (src VirtualizationVmwareVcenterResponse) MarshalJSON() ([]byte, error) {
	...
	if src.VirtualizationVmwareVcenterList != nil {
		return json.Marshal(&src.VirtualizationVmwareVcenterList)
	}
...
func (obj *VirtualizationVmwareVcenterResponse) GetActualInstance() interface{} {
	...
	if obj.VirtualizationVmwareVcenterList != nil {
		return obj.VirtualizationVmwareVcenterList
	}
...
type NullableVirtualizationVmwareVcenterResponse struct {
	value *VirtualizationVmwareVcenterResponse
	isSet bool
}

func (v NullableVirtualizationVmwareVcenterResponse) Get() *VirtualizationVmwareVcenterResponse {
	return v.value
}

func (v *NullableVirtualizationVmwareVcenterResponse) Set(val *VirtualizationVmwareVcenterResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmwareVcenterResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmwareVcenterResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmwareVcenterResponse(val *VirtualizationVmwareVcenterResponse) *NullableVirtualizationVmwareVcenterResponse {
	return &NullableVirtualizationVmwareVcenterResponse{value: val, isSet: true}
}

func (v NullableVirtualizationVmwareVcenterResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmwareVcenterResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
