...
// VncConsoleAllOf Definition of the list of properties defined in 'vnc.Console', excluding properties defined in parent classes.
type VncConsoleAllOf struct {
...
type _VncConsoleAllOf VncConsoleAllOf
...
func (o VncConsoleAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VncConsoleAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVncConsoleAllOf := _VncConsoleAllOf{}

	if err = json.Unmarshal(bytes, &varVncConsoleAllOf); err == nil {
		*o = VncConsoleAllOf(varVncConsoleAllOf)
	}
...
type NullableVncConsoleAllOf struct {
	value *VncConsoleAllOf
	isSet bool
}

func (v NullableVncConsoleAllOf) Get() *VncConsoleAllOf {
	return v.value
}

func (v *NullableVncConsoleAllOf) Set(val *VncConsoleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVncConsoleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVncConsoleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVncConsoleAllOf(val *VncConsoleAllOf) *NullableVncConsoleAllOf {
	return &NullableVncConsoleAllOf{value: val, isSet: true}
}

func (v NullableVncConsoleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVncConsoleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
