...
// checks if the KubernetesVersionPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesVersionPolicy{}
...
// GetDefaultClassId returns the default value "kubernetes.VersionPolicy" of the ClassId field.
func (o *KubernetesVersionPolicy) GetDefaultClassId() interface{} {
	return "kubernetes.VersionPolicy"
}
...
// GetDefaultObjectType returns the default value "kubernetes.VersionPolicy" of the ObjectType field.
func (o *KubernetesVersionPolicy) GetDefaultObjectType() interface{} {
	return "kubernetes.VersionPolicy"
}
...
func (o *KubernetesVersionPolicy) SetOrganizationNil() {
...
func (o *KubernetesVersionPolicy) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o KubernetesVersionPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesVersionPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesVersionPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesVersionPolicy)
	if err == nil {
