...
// IamEndPointRoleListAllOf struct for IamEndPointRoleListAllOf
type IamEndPointRoleListAllOf struct {
...
type _IamEndPointRoleListAllOf IamEndPointRoleListAllOf
...
func (o IamEndPointRoleListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IamEndPointRoleListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamEndPointRoleListAllOf := _IamEndPointRoleListAllOf{}

	if err = json.Unmarshal(bytes, &varIamEndPointRoleListAllOf); err == nil {
		*o = IamEndPointRoleListAllOf(varIamEndPointRoleListAllOf)
	}
...
type NullableIamEndPointRoleListAllOf struct {
	value *IamEndPointRoleListAllOf
	isSet bool
}

func (v NullableIamEndPointRoleListAllOf) Get() *IamEndPointRoleListAllOf {
	return v.value
}

func (v *NullableIamEndPointRoleListAllOf) Set(val *IamEndPointRoleListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamEndPointRoleListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamEndPointRoleListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamEndPointRoleListAllOf(val *IamEndPointRoleListAllOf) *NullableIamEndPointRoleListAllOf {
	return &NullableIamEndPointRoleListAllOf{value: val, isSet: true}
}

func (v NullableIamEndPointRoleListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamEndPointRoleListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
