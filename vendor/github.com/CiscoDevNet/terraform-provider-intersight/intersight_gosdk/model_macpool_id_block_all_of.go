...
// MacpoolIdBlockAllOf Definition of the list of properties defined in 'macpool.IdBlock', excluding properties defined in parent classes.
type MacpoolIdBlockAllOf struct {
...
type _MacpoolIdBlockAllOf MacpoolIdBlockAllOf
...
func (o MacpoolIdBlockAllOf) MarshalJSON() ([]byte, error) {
...
func (o *MacpoolIdBlockAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMacpoolIdBlockAllOf := _MacpoolIdBlockAllOf{}

	if err = json.Unmarshal(bytes, &varMacpoolIdBlockAllOf); err == nil {
		*o = MacpoolIdBlockAllOf(varMacpoolIdBlockAllOf)
	}
...
type NullableMacpoolIdBlockAllOf struct {
	value *MacpoolIdBlockAllOf
	isSet bool
}

func (v NullableMacpoolIdBlockAllOf) Get() *MacpoolIdBlockAllOf {
	return v.value
}

func (v *NullableMacpoolIdBlockAllOf) Set(val *MacpoolIdBlockAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMacpoolIdBlockAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMacpoolIdBlockAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMacpoolIdBlockAllOf(val *MacpoolIdBlockAllOf) *NullableMacpoolIdBlockAllOf {
	return &NullableMacpoolIdBlockAllOf{value: val, isSet: true}
}

func (v NullableMacpoolIdBlockAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMacpoolIdBlockAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
