...
func (dst *IamOAuthTokenResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'iam.OAuthToken.List'
	if jsonDict["ObjectType"] == "iam.OAuthToken.List" {
		// try to unmarshal JSON data into IamOAuthTokenList
		err = json.Unmarshal(data, &dst.IamOAuthTokenList)
		if err == nil {
			return nil // data stored in dst.IamOAuthTokenList, return on the first match
		} else {
			dst.IamOAuthTokenList = nil
			return fmt.Errorf("Failed to unmarshal IamOAuthTokenResponse as IamOAuthTokenList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamOAuthTokenResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamOAuthTokenResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IamOAuthTokenResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src IamOAuthTokenResponse) MarshalJSON() ([]byte, error) {
	if src.IamOAuthTokenList != nil {
		return json.Marshal(&src.IamOAuthTokenList)
	}
...
type NullableIamOAuthTokenResponse struct {
	value *IamOAuthTokenResponse
	isSet bool
}

func (v NullableIamOAuthTokenResponse) Get() *IamOAuthTokenResponse {
	return v.value
}

func (v *NullableIamOAuthTokenResponse) Set(val *IamOAuthTokenResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIamOAuthTokenResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIamOAuthTokenResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamOAuthTokenResponse(val *IamOAuthTokenResponse) *NullableIamOAuthTokenResponse {
	return &NullableIamOAuthTokenResponse{value: val, isSet: true}
}

func (v NullableIamOAuthTokenResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamOAuthTokenResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
