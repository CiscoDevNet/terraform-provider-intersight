...
// CloudImageReferenceAllOf Definition of the list of properties defined in 'cloud.ImageReference', excluding properties defined in parent classes.
type CloudImageReferenceAllOf struct {
...
type _CloudImageReferenceAllOf CloudImageReferenceAllOf
...
func (o CloudImageReferenceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CloudImageReferenceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCloudImageReferenceAllOf := _CloudImageReferenceAllOf{}

	if err = json.Unmarshal(bytes, &varCloudImageReferenceAllOf); err == nil {
		*o = CloudImageReferenceAllOf(varCloudImageReferenceAllOf)
	}
...
type NullableCloudImageReferenceAllOf struct {
	value *CloudImageReferenceAllOf
	isSet bool
}

func (v NullableCloudImageReferenceAllOf) Get() *CloudImageReferenceAllOf {
	return v.value
}

func (v *NullableCloudImageReferenceAllOf) Set(val *CloudImageReferenceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudImageReferenceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudImageReferenceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudImageReferenceAllOf(val *CloudImageReferenceAllOf) *NullableCloudImageReferenceAllOf {
	return &NullableCloudImageReferenceAllOf{value: val, isSet: true}
}

func (v NullableCloudImageReferenceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudImageReferenceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
