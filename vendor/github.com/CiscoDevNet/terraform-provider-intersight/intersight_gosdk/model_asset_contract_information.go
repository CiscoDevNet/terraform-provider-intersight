...
// checks if the AssetContractInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetContractInformation{}
...
// GetDefaultClassId returns the default value "asset.ContractInformation" of the ClassId field.
func (o *AssetContractInformation) GetDefaultClassId() interface{} {
	return "asset.ContractInformation"
}
...
// GetDefaultObjectType returns the default value "asset.ContractInformation" of the ObjectType field.
func (o *AssetContractInformation) GetDefaultObjectType() interface{} {
	return "asset.ContractInformation"
}
...
func (o *AssetContractInformation) GetBillToGlobalUltimate() AssetGlobalUltimate {
	if o == nil || IsNil(o.BillToGlobalUltimate.Get()) {
...
func (o AssetContractInformation) ToMap() (map[string]interface{}, error) {
...
func (o *AssetContractInformation) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetContractInformationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetContractInformation)
	if err == nil {
