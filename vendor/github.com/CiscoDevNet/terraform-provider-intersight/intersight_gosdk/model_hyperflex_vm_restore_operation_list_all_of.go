...
// HyperflexVmRestoreOperationListAllOf struct for HyperflexVmRestoreOperationListAllOf
type HyperflexVmRestoreOperationListAllOf struct {
...
type _HyperflexVmRestoreOperationListAllOf HyperflexVmRestoreOperationListAllOf
...
func NewHyperflexVmRestoreOperationListAllOf() *HyperflexVmRestoreOperationListAllOf {
	this := HyperflexVmRestoreOperationListAllOf{}
	return &this
}
...
func (o HyperflexVmRestoreOperationListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexVmRestoreOperationListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexVmRestoreOperationListAllOf := _HyperflexVmRestoreOperationListAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexVmRestoreOperationListAllOf); err == nil {
		*o = HyperflexVmRestoreOperationListAllOf(varHyperflexVmRestoreOperationListAllOf)
	}
...
type NullableHyperflexVmRestoreOperationListAllOf struct {
	value *HyperflexVmRestoreOperationListAllOf
	isSet bool
}

func (v NullableHyperflexVmRestoreOperationListAllOf) Get() *HyperflexVmRestoreOperationListAllOf {
	return v.value
}

func (v *NullableHyperflexVmRestoreOperationListAllOf) Set(val *HyperflexVmRestoreOperationListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexVmRestoreOperationListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexVmRestoreOperationListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexVmRestoreOperationListAllOf(val *HyperflexVmRestoreOperationListAllOf) *NullableHyperflexVmRestoreOperationListAllOf {
	return &NullableHyperflexVmRestoreOperationListAllOf{value: val, isSet: true}
}

func (v NullableHyperflexVmRestoreOperationListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexVmRestoreOperationListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
