...
// CapabilityServerDescriptor The capability.ServerDescriptor object is a hardware descriptor that uniquely identifies an Intersight Managed Mode (IMM) server model and defines its specific capabilities and characteristics. #### Purpose The ServerDescriptor object serves as a central point in the capability catalog for defining model-specific server attributes. It allows the system to understand the unique features, limitations, and default configurations of a particular server model, such as UCSB-B200-M5. It is crucial for applying correct policies, enabling or disabling features, and ensuring proper management. #### Key Concepts - **Model-Specific Capabilities:** Defines attributes that are specific to a server model, such as whether the NCSI side-band interface is enabled (isNcsiEnabled) or the default PCIe slot for an MLOM adapter (mlomAdapterPcieSlotNumber). - **Policy Applicability:** The unsupportedPolicies property lists policies that are not applicable to a specific server model, preventing misconfiguration. - **Form Factor Identification:** Specifies the server's physical form factor (serverFormFactor), such as \"blade\" or \"rack\" which influences management logic. - **Unique Identification:** Uniquely identifies a server capability profile by its vendor and model.
type CapabilityServerDescriptor struct {
	...
	IsPplEnabled *bool `json:"IsPplEnabled,omitempty"`
...
func NewCapabilityServerDescriptor(classId string, objectType string) *CapabilityServerDescriptor {
	...
	this.IsPplEnabled = &isPplEnabled
	return &this
}
...
// GetIsPplEnabled returns the IsPplEnabled field value if set, zero value otherwise.
func (o *CapabilityServerDescriptor) GetIsPplEnabled() bool {
	if o == nil || IsNil(o.IsPplEnabled) {
		var ret bool
		return ret
	}
	return *o.IsPplEnabled
}

// GetIsPplEnabledOk returns a tuple with the IsPplEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CapabilityServerDescriptor) GetIsPplEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPplEnabled) {
		return nil, false
	}
	return o.IsPplEnabled, true
}
...
// SetIsPplEnabled gets a reference to the given bool and assigns it to the IsPplEnabled field.
...
func (o *CapabilityServerDescriptor) GetUnsupportedPoliciesOk() ([]string, bool) {
...
func (o *CapabilityServerDescriptor) HasUnsupportedPolicies() bool {
	if o != nil && !IsNil(o.UnsupportedPolicies) {
		return true
	}
...
func (o *CapabilityServerDescriptor) SetUnsupportedPolicies(v []string) {
...
func (o CapabilityServerDescriptor) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsPplEnabled) {
		toSerialize["IsPplEnabled"] = o.IsPplEnabled
	}
...
func (o *CapabilityServerDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varCapabilityServerDescriptor.IsPplEnabled = varCapabilityServerDescriptorWithoutEmbeddedStruct.IsPplEnabled
		...
		varCapabilityServerDescriptor.UnsupportedPolicies = varCapabilityServerDescriptorWithoutEmbeddedStruct.UnsupportedPolicies
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "IsPplEnabled")
