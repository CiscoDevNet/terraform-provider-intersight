...
func (o *CapabilityServerDescriptor) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCapabilityServerDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCapabilityServerDescriptor)
	if err == nil {
