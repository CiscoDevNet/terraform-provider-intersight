...
// checks if the VirtualizationCloudVmStorageConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationCloudVmStorageConfiguration{}
...
// GetDefaultClassId returns the default value "virtualization.AwsVmStorageConfiguration" of the ClassId field.
func (o *VirtualizationCloudVmStorageConfiguration) GetDefaultClassId() interface{} {
	return "virtualization.AwsVmStorageConfiguration"
}
...
// GetDefaultObjectType returns the default value "virtualization.AwsVmStorageConfiguration" of the ObjectType field.
func (o *VirtualizationCloudVmStorageConfiguration) GetDefaultObjectType() interface{} {
	return "virtualization.AwsVmStorageConfiguration"
}
...
func (o VirtualizationCloudVmStorageConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationCloudVmStorageConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationCloudVmStorageConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationCloudVmStorageConfiguration)
	if err == nil {
