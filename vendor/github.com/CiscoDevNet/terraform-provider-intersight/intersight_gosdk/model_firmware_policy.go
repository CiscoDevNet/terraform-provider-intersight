...
func (o *FirmwarePolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFirmwarePolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFirmwarePolicy)
	if err == nil {
