...
// ConfigExportedItem A single managed object that is being exported.
...
type _ConfigExportedItem ConfigExportedItem
...
func (o *ConfigExportedItem) SetItemNil() {
	o.Item.Set(nil)
}
...
func (o ConfigExportedItem) MarshalJSON() ([]byte, error) {
...
func (o *ConfigExportedItem) UnmarshalJSON(bytes []byte) (err error) {
	type ConfigExportedItemWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varConfigExportedItemWithoutEmbeddedStruct := ConfigExportedItemWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varConfigExportedItemWithoutEmbeddedStruct)
	if err == nil {
		varConfigExportedItem := _ConfigExportedItem{}
		varConfigExportedItem.ClassId = varConfigExportedItemWithoutEmbeddedStruct.ClassId
		varConfigExportedItem.ObjectType = varConfigExportedItemWithoutEmbeddedStruct.ObjectType
		varConfigExportedItem.FileName = varConfigExportedItemWithoutEmbeddedStruct.FileName
		varConfigExportedItem.Item = varConfigExportedItemWithoutEmbeddedStruct.Item
		varConfigExportedItem.Name = varConfigExportedItemWithoutEmbeddedStruct.Name
		varConfigExportedItem.ServiceVersion = varConfigExportedItemWithoutEmbeddedStruct.ServiceVersion
		varConfigExportedItem.Status = varConfigExportedItemWithoutEmbeddedStruct.Status
		varConfigExportedItem.StatusMessage = varConfigExportedItemWithoutEmbeddedStruct.StatusMessage
		varConfigExportedItem.Exporter = varConfigExportedItemWithoutEmbeddedStruct.Exporter
		varConfigExportedItem.ParentItem = varConfigExportedItemWithoutEmbeddedStruct.ParentItem
		varConfigExportedItem.RelatedItems = varConfigExportedItemWithoutEmbeddedStruct.RelatedItems
		*o = ConfigExportedItem(varConfigExportedItem)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varConfigExportedItem)
	if err == nil {
		o.MoBaseMo = varConfigExportedItem.MoBaseMo
	} else {
		return err
	}
...
type NullableConfigExportedItem struct {
	value *ConfigExportedItem
	isSet bool
}

func (v NullableConfigExportedItem) Get() *ConfigExportedItem {
	return v.value
}

func (v *NullableConfigExportedItem) Set(val *ConfigExportedItem) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigExportedItem) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigExportedItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigExportedItem(val *ConfigExportedItem) *NullableConfigExportedItem {
	return &NullableConfigExportedItem{value: val, isSet: true}
}

func (v NullableConfigExportedItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigExportedItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
