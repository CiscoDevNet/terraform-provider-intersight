...
// NiatelemetrySnmpSrcAllOf Definition of the list of properties defined in 'niatelemetry.SnmpSrc', excluding properties defined in parent classes.
type NiatelemetrySnmpSrcAllOf struct {
...
type _NiatelemetrySnmpSrcAllOf NiatelemetrySnmpSrcAllOf
...
func (o NiatelemetrySnmpSrcAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetrySnmpSrcAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetrySnmpSrcAllOf := _NiatelemetrySnmpSrcAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetrySnmpSrcAllOf); err == nil {
		*o = NiatelemetrySnmpSrcAllOf(varNiatelemetrySnmpSrcAllOf)
	}
...
type NullableNiatelemetrySnmpSrcAllOf struct {
	value *NiatelemetrySnmpSrcAllOf
	isSet bool
}

func (v NullableNiatelemetrySnmpSrcAllOf) Get() *NiatelemetrySnmpSrcAllOf {
	return v.value
}

func (v *NullableNiatelemetrySnmpSrcAllOf) Set(val *NiatelemetrySnmpSrcAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetrySnmpSrcAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetrySnmpSrcAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetrySnmpSrcAllOf(val *NiatelemetrySnmpSrcAllOf) *NullableNiatelemetrySnmpSrcAllOf {
	return &NullableNiatelemetrySnmpSrcAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetrySnmpSrcAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetrySnmpSrcAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
