...
// WorkflowTaskNotification The push notification of the scheduled task received from conductor.
...
type _WorkflowTaskNotification WorkflowTaskNotification
...
func (o WorkflowTaskNotification) MarshalJSON() ([]byte, error) {
...
func (o *WorkflowTaskNotification) UnmarshalJSON(bytes []byte) (err error) {
	type WorkflowTaskNotificationWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varWorkflowTaskNotificationWithoutEmbeddedStruct := WorkflowTaskNotificationWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varWorkflowTaskNotificationWithoutEmbeddedStruct)
	if err == nil {
		varWorkflowTaskNotification := _WorkflowTaskNotification{}
		varWorkflowTaskNotification.ClassId = varWorkflowTaskNotificationWithoutEmbeddedStruct.ClassId
		varWorkflowTaskNotification.ObjectType = varWorkflowTaskNotificationWithoutEmbeddedStruct.ObjectType
		varWorkflowTaskNotification.CorrelationId = varWorkflowTaskNotificationWithoutEmbeddedStruct.CorrelationId
		varWorkflowTaskNotification.EndTime = varWorkflowTaskNotificationWithoutEmbeddedStruct.EndTime
		varWorkflowTaskNotification.Input = varWorkflowTaskNotificationWithoutEmbeddedStruct.Input
		varWorkflowTaskNotification.Iteration = varWorkflowTaskNotificationWithoutEmbeddedStruct.Iteration
		varWorkflowTaskNotification.LoopOverTask = varWorkflowTaskNotificationWithoutEmbeddedStruct.LoopOverTask
		varWorkflowTaskNotification.Output = varWorkflowTaskNotificationWithoutEmbeddedStruct.Output
		varWorkflowTaskNotification.ReasonForIncompletion = varWorkflowTaskNotificationWithoutEmbeddedStruct.ReasonForIncompletion
		varWorkflowTaskNotification.ReferenceTaskName = varWorkflowTaskNotificationWithoutEmbeddedStruct.ReferenceTaskName
		varWorkflowTaskNotification.RetryCount = varWorkflowTaskNotificationWithoutEmbeddedStruct.RetryCount
		varWorkflowTaskNotification.ScheduledTime = varWorkflowTaskNotificationWithoutEmbeddedStruct.ScheduledTime
		varWorkflowTaskNotification.StartTime = varWorkflowTaskNotificationWithoutEmbeddedStruct.StartTime
		varWorkflowTaskNotification.Status = varWorkflowTaskNotificationWithoutEmbeddedStruct.Status
		varWorkflowTaskNotification.TaskDefName = varWorkflowTaskNotificationWithoutEmbeddedStruct.TaskDefName
		varWorkflowTaskNotification.TaskDescription = varWorkflowTaskNotificationWithoutEmbeddedStruct.TaskDescription
		varWorkflowTaskNotification.TaskId = varWorkflowTaskNotificationWithoutEmbeddedStruct.TaskId
		varWorkflowTaskNotification.TaskType = varWorkflowTaskNotificationWithoutEmbeddedStruct.TaskType
		varWorkflowTaskNotification.UpdateTime = varWorkflowTaskNotificationWithoutEmbeddedStruct.UpdateTime
		varWorkflowTaskNotification.WorkflowId = varWorkflowTaskNotificationWithoutEmbeddedStruct.WorkflowId
		varWorkflowTaskNotification.WorkflowTaskType = varWorkflowTaskNotificationWithoutEmbeddedStruct.WorkflowTaskType
		varWorkflowTaskNotification.WorkflowType = varWorkflowTaskNotificationWithoutEmbeddedStruct.WorkflowType
		*o = WorkflowTaskNotification(varWorkflowTaskNotification)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varWorkflowTaskNotification)
	if err == nil {
		o.MoBaseMo = varWorkflowTaskNotification.MoBaseMo
	} else {
		return err
	}
...
type NullableWorkflowTaskNotification struct {
	value *WorkflowTaskNotification
	isSet bool
}

func (v NullableWorkflowTaskNotification) Get() *WorkflowTaskNotification {
	return v.value
}

func (v *NullableWorkflowTaskNotification) Set(val *WorkflowTaskNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTaskNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTaskNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTaskNotification(val *WorkflowTaskNotification) *NullableWorkflowTaskNotification {
	return &NullableWorkflowTaskNotification{value: val, isSet: true}
}

func (v NullableWorkflowTaskNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowTaskNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true
