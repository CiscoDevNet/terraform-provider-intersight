...
// EquipmentSystemIoControllerListAllOf struct for EquipmentSystemIoControllerListAllOf
type EquipmentSystemIoControllerListAllOf struct {
...
type _EquipmentSystemIoControllerListAllOf EquipmentSystemIoControllerListAllOf
...
func NewEquipmentSystemIoControllerListAllOf() *EquipmentSystemIoControllerListAllOf {
	this := EquipmentSystemIoControllerListAllOf{}
	return &this
}
...
func (o EquipmentSystemIoControllerListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *EquipmentSystemIoControllerListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varEquipmentSystemIoControllerListAllOf := _EquipmentSystemIoControllerListAllOf{}

	if err = json.Unmarshal(bytes, &varEquipmentSystemIoControllerListAllOf); err == nil {
		*o = EquipmentSystemIoControllerListAllOf(varEquipmentSystemIoControllerListAllOf)
	}
...
type NullableEquipmentSystemIoControllerListAllOf struct {
	value *EquipmentSystemIoControllerListAllOf
	isSet bool
}

func (v NullableEquipmentSystemIoControllerListAllOf) Get() *EquipmentSystemIoControllerListAllOf {
	return v.value
}

func (v *NullableEquipmentSystemIoControllerListAllOf) Set(val *EquipmentSystemIoControllerListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentSystemIoControllerListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentSystemIoControllerListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentSystemIoControllerListAllOf(val *EquipmentSystemIoControllerListAllOf) *NullableEquipmentSystemIoControllerListAllOf {
	return &NullableEquipmentSystemIoControllerListAllOf{value: val, isSet: true}
}

func (v NullableEquipmentSystemIoControllerListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentSystemIoControllerListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
