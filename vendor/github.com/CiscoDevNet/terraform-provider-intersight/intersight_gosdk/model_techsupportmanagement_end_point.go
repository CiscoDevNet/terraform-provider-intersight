...
func (o *TechsupportmanagementEndPoint) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTechsupportmanagementEndPointWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varTechsupportmanagementEndPoint)
	if err == nil {
