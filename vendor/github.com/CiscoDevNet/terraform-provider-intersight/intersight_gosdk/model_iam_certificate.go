...
// GetDefaultClassId returns the default value "iam.Certificate" of the ClassId field.
func (o *IamCertificate) GetDefaultClassId() interface{} {
	return "iam.Certificate"
}
...
// GetDefaultObjectType returns the default value "iam.Certificate" of the ObjectType field.
func (o *IamCertificate) GetDefaultObjectType() interface{} {
	return "iam.Certificate"
}
...
func (o *IamCertificate) SetCertificateRequestNil() {
...
func (o IamCertificate) ToMap() (map[string]interface{}, error) {
...
func (o *IamCertificate) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamCertificateWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIamCertificate)
	if err == nil {
