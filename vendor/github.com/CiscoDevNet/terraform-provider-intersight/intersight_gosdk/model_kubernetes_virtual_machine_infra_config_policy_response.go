...
func KubernetesVirtualMachineInfraConfigPolicyListAsKubernetesVirtualMachineInfraConfigPolicyResponse(v *KubernetesVirtualMachineInfraConfigPolicyList) KubernetesVirtualMachineInfraConfigPolicyResponse {
	return KubernetesVirtualMachineInfraConfigPolicyResponse{
		KubernetesVirtualMachineInfraConfigPolicyList: v,
	}
}
...
func (dst *KubernetesVirtualMachineInfraConfigPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'kubernetes.VirtualMachineInfraConfigPolicy.List'
	if jsonDict["ObjectType"] == "kubernetes.VirtualMachineInfraConfigPolicy.List" {
		// try to unmarshal JSON data into KubernetesVirtualMachineInfraConfigPolicyList
		err = json.Unmarshal(data, &dst.KubernetesVirtualMachineInfraConfigPolicyList)
		if err == nil {
			return nil // data stored in dst.KubernetesVirtualMachineInfraConfigPolicyList, return on the first match
		} else {
			dst.KubernetesVirtualMachineInfraConfigPolicyList = nil
			return fmt.Errorf("failed to unmarshal KubernetesVirtualMachineInfraConfigPolicyResponse as KubernetesVirtualMachineInfraConfigPolicyList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal KubernetesVirtualMachineInfraConfigPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal KubernetesVirtualMachineInfraConfigPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal KubernetesVirtualMachineInfraConfigPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src KubernetesVirtualMachineInfraConfigPolicyResponse) MarshalJSON() ([]byte, error) {
	if src.KubernetesVirtualMachineInfraConfigPolicyList != nil {
		return json.Marshal(&src.KubernetesVirtualMachineInfraConfigPolicyList)
	}
...
type NullableKubernetesVirtualMachineInfraConfigPolicyResponse struct {
	value *KubernetesVirtualMachineInfraConfigPolicyResponse
	isSet bool
}

func (v NullableKubernetesVirtualMachineInfraConfigPolicyResponse) Get() *KubernetesVirtualMachineInfraConfigPolicyResponse {
	return v.value
}

func (v *NullableKubernetesVirtualMachineInfraConfigPolicyResponse) Set(val *KubernetesVirtualMachineInfraConfigPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesVirtualMachineInfraConfigPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesVirtualMachineInfraConfigPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesVirtualMachineInfraConfigPolicyResponse(val *KubernetesVirtualMachineInfraConfigPolicyResponse) *NullableKubernetesVirtualMachineInfraConfigPolicyResponse {
	return &NullableKubernetesVirtualMachineInfraConfigPolicyResponse{value: val, isSet: true}
}

func (v NullableKubernetesVirtualMachineInfraConfigPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesVirtualMachineInfraConfigPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
