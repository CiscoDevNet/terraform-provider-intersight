...
// FirmwareChassisUpgrade The ChassisUpgrade object is focused on upgrading firmware for chassis systems, providing a streamlined approach to downloading and applying firmware images from cloud repositories or network shares. #### Purpose ChassisUpgrade ensures chassis systems remain secure and performant through firmware updates. This provides options for both direct download and network share–based upgrades for UCSM devices, and supports certain IMM chassis upgrades via direct download. IMM chassis upgrade updates supported PSU and XFM components when connected to the chassis. #### Key Concepts - **Chassis System Enhancement:** Designed to optimize chassis firmware upgrades, improving system reliability and efficiency through structured update processes. - **Exclusion Options:** Offers the ability to exclude certain components from the upgrade, providing flexibility and customization based on specific upgrade needs. - **Integrated Management:** Facilitates comprehensive upgrade operations, from image selection to deployment, ensuring seamless execution and management. - **Security and Access Control: Enforces strict access and compliance measures to protect the upgrade process, maintaining system integrity and security.
type FirmwareChassisUpgrade struct {
	...
	// Name of the chassis on which the firmware upgrade operation is performed.
...
func (o *FirmwareChassisUpgrade) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFirmwareChassisUpgrade.ChassisName = varFirmwareChassisUpgradeWithoutEmbeddedStruct.ChassisName
		varFirmwareChassisUpgrade.ExcludeComponentList = varFirmwareChassisUpgradeWithoutEmbeddedStruct.ExcludeComponentList
		varFirmwareChassisUpgrade.XfmUpgradeOption = varFirmwareChassisUpgradeWithoutEmbeddedStruct.XfmUpgradeOption
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ChassisName")
