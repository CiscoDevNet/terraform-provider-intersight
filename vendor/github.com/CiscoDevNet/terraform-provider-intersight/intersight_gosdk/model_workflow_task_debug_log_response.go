...
func (dst *WorkflowTaskDebugLogResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowTaskDebugLogResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowTaskDebugLogResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowTaskDebugLogResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'workflow.TaskDebugLog.List'
	if jsonDict["ObjectType"] == "workflow.TaskDebugLog.List" {
		// try to unmarshal JSON data into WorkflowTaskDebugLogList
		err = json.Unmarshal(data, &dst.WorkflowTaskDebugLogList)
		if err == nil {
			return nil // data stored in dst.WorkflowTaskDebugLogList, return on the first match
		} else {
			dst.WorkflowTaskDebugLogList = nil
			return fmt.Errorf("failed to unmarshal WorkflowTaskDebugLogResponse as WorkflowTaskDebugLogList: %s", err.Error())
		}
	}
...
func (src WorkflowTaskDebugLogResponse) MarshalJSON() ([]byte, error) {
	...
	if src.WorkflowTaskDebugLogList != nil {
		return json.Marshal(&src.WorkflowTaskDebugLogList)
	}
...
func (obj *WorkflowTaskDebugLogResponse) GetActualInstance() interface{} {
	...
	if obj.WorkflowTaskDebugLogList != nil {
		return obj.WorkflowTaskDebugLogList
	}
...
type NullableWorkflowTaskDebugLogResponse struct {
	value *WorkflowTaskDebugLogResponse
	isSet bool
}

func (v NullableWorkflowTaskDebugLogResponse) Get() *WorkflowTaskDebugLogResponse {
	return v.value
}

func (v *NullableWorkflowTaskDebugLogResponse) Set(val *WorkflowTaskDebugLogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTaskDebugLogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTaskDebugLogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTaskDebugLogResponse(val *WorkflowTaskDebugLogResponse) *NullableWorkflowTaskDebugLogResponse {
	return &NullableWorkflowTaskDebugLogResponse{value: val, isSet: true}
}

func (v NullableWorkflowTaskDebugLogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowTaskDebugLogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
