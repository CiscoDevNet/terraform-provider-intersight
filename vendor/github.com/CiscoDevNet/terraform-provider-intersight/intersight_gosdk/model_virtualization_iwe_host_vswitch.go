...
// VirtualizationIweHostVswitch A Intersight Workload Engine vSwitch entity that is part of a cluster wide dvSwitch.
type VirtualizationIweHostVswitch struct {
...
type _VirtualizationIweHostVswitch VirtualizationIweHostVswitch
...
func NewVirtualizationIweHostVswitch(classId string, objectType string) *VirtualizationIweHostVswitch {
	this := VirtualizationIweHostVswitch{}
...
func (o VirtualizationIweHostVswitch) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationIweHostVswitch) UnmarshalJSON(bytes []byte) (err error) {
	type VirtualizationIweHostVswitchWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	err = json.Unmarshal(bytes, &varVirtualizationIweHostVswitchWithoutEmbeddedStruct)
	if err == nil {
		varVirtualizationIweHostVswitch := _VirtualizationIweHostVswitch{}
		varVirtualizationIweHostVswitch.ClassId = varVirtualizationIweHostVswitchWithoutEmbeddedStruct.ClassId
		varVirtualizationIweHostVswitch.ObjectType = varVirtualizationIweHostVswitchWithoutEmbeddedStruct.ObjectType
		varVirtualizationIweHostVswitch.HostName = varVirtualizationIweHostVswitchWithoutEmbeddedStruct.HostName
		varVirtualizationIweHostVswitch.Ports = varVirtualizationIweHostVswitchWithoutEmbeddedStruct.Ports
		varVirtualizationIweHostVswitch.Cluster = varVirtualizationIweHostVswitchWithoutEmbeddedStruct.Cluster
		varVirtualizationIweHostVswitch.DvSwitch = varVirtualizationIweHostVswitchWithoutEmbeddedStruct.DvSwitch
		varVirtualizationIweHostVswitch.Host = varVirtualizationIweHostVswitchWithoutEmbeddedStruct.Host
		*o = VirtualizationIweHostVswitch(varVirtualizationIweHostVswitch)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varVirtualizationIweHostVswitch)
	if err == nil {
		o.VirtualizationBaseVswitch = varVirtualizationIweHostVswitch.VirtualizationBaseVswitch
	} else {
		return err
	}
...
type NullableVirtualizationIweHostVswitch struct {
	value *VirtualizationIweHostVswitch
	isSet bool
}

func (v NullableVirtualizationIweHostVswitch) Get() *VirtualizationIweHostVswitch {
	return v.value
}

func (v *NullableVirtualizationIweHostVswitch) Set(val *VirtualizationIweHostVswitch) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationIweHostVswitch) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationIweHostVswitch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationIweHostVswitch(val *VirtualizationIweHostVswitch) *NullableVirtualizationIweHostVswitch {
	return &NullableVirtualizationIweHostVswitch{value: val, isSet: true}
}

func (v NullableVirtualizationIweHostVswitch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationIweHostVswitch) UnmarshalJSON(src []byte) error {
	v.isSet = true
