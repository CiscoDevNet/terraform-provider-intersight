...
type LicenseAccountLicenseData struct {
	...
	ErpCustomerOp             NullableLicenseErpCustomerOpRelationship             `json:"ErpCustomerOp,omitempty"`
	ErpLicenseCount           NullableLicenseErpLicenseCountRelationship           `json:"ErpLicenseCount,omitempty"`
...
// GetErpCustomerOp returns the ErpCustomerOp field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LicenseAccountLicenseData) GetErpCustomerOp() LicenseErpCustomerOpRelationship {
	if o == nil || IsNil(o.ErpCustomerOp.Get()) {
		var ret LicenseErpCustomerOpRelationship
		return ret
	}
	return *o.ErpCustomerOp.Get()
}

// GetErpCustomerOpOk returns a tuple with the ErpCustomerOp field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetErpCustomerOp gets a reference to the given NullableLicenseErpCustomerOpRelationship and assigns it to the ErpCustomerOp field.
func (o *LicenseAccountLicenseData) SetErpCustomerOp(v LicenseErpCustomerOpRelationship) {
	o.ErpCustomerOp.Set(&v)
}

// SetErpCustomerOpNil sets the value for ErpCustomerOp to be an explicit nil
func (o *LicenseAccountLicenseData) SetErpCustomerOpNil() {
	o.ErpCustomerOp.Set(nil)
}
...
func (o *LicenseAccountLicenseData) UnsetErpCustomerOp() {
	o.ErpCustomerOp.Unset()
}

// GetErpLicenseCount returns the ErpLicenseCount field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LicenseAccountLicenseData) GetErpLicenseCount() LicenseErpLicenseCountRelationship {
	if o == nil || IsNil(o.ErpLicenseCount.Get()) {
		var ret LicenseErpLicenseCountRelationship
		return ret
	}
	return *o.ErpLicenseCount.Get()
}

// GetErpLicenseCountOk returns a tuple with the ErpLicenseCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetErpLicenseCount gets a reference to the given NullableLicenseErpLicenseCountRelationship and assigns it to the ErpLicenseCount field.
func (o *LicenseAccountLicenseData) SetErpLicenseCount(v LicenseErpLicenseCountRelationship) {
	o.ErpLicenseCount.Set(&v)
}

// SetErpLicenseCountNil sets the value for ErpLicenseCount to be an explicit nil
func (o *LicenseAccountLicenseData) SetErpLicenseCountNil() {
	o.ErpLicenseCount.Set(nil)
}
...
func (o LicenseAccountLicenseData) ToMap() (map[string]interface{}, error) {
	...
	if o.ErpCustomerOp.IsSet() {
		toSerialize["ErpCustomerOp"] = o.ErpCustomerOp.Get()
	}
	if o.ErpLicenseCount.IsSet() {
		toSerialize["ErpLicenseCount"] = o.ErpLicenseCount.Get()
	}
...
func (o *LicenseAccountLicenseData) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varLicenseAccountLicenseData.ErpCustomerOp = varLicenseAccountLicenseDataWithoutEmbeddedStruct.ErpCustomerOp
		varLicenseAccountLicenseData.ErpLicenseCount = varLicenseAccountLicenseDataWithoutEmbeddedStruct.ErpLicenseCount
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ErpCustomerOp")
		delete(additionalProperties, "ErpLicenseCount")
