...
// ApplianceUpgradeListAllOf struct for ApplianceUpgradeListAllOf
type ApplianceUpgradeListAllOf struct {
...
type _ApplianceUpgradeListAllOf ApplianceUpgradeListAllOf
...
func NewApplianceUpgradeListAllOf() *ApplianceUpgradeListAllOf {
	this := ApplianceUpgradeListAllOf{}
	return &this
}
...
func (o ApplianceUpgradeListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceUpgradeListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceUpgradeListAllOf := _ApplianceUpgradeListAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceUpgradeListAllOf); err == nil {
		*o = ApplianceUpgradeListAllOf(varApplianceUpgradeListAllOf)
	}
...
type NullableApplianceUpgradeListAllOf struct {
	value *ApplianceUpgradeListAllOf
	isSet bool
}

func (v NullableApplianceUpgradeListAllOf) Get() *ApplianceUpgradeListAllOf {
	return v.value
}

func (v *NullableApplianceUpgradeListAllOf) Set(val *ApplianceUpgradeListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceUpgradeListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceUpgradeListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceUpgradeListAllOf(val *ApplianceUpgradeListAllOf) *NullableApplianceUpgradeListAllOf {
	return &NullableApplianceUpgradeListAllOf{value: val, isSet: true}
}

func (v NullableApplianceUpgradeListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceUpgradeListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
