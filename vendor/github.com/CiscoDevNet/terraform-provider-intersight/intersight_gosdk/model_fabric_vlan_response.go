...
func (dst *FabricVlanResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "fabric.Vlan.List" {
		// try to unmarshal JSON data into FabricVlanList
		err = json.Unmarshal(data, &dst.FabricVlanList)
		if err == nil {
			return nil // data stored in dst.FabricVlanList, return on the first match
		} else {
			dst.FabricVlanList = nil
			return fmt.Errorf("Failed to unmarshal FabricVlanResponse as FabricVlanList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricVlanResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricVlanResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricVlanResponse as MoTagSummary: %s", err.Error())
		}
	}
...
type NullableFabricVlanResponse struct {
	value *FabricVlanResponse
	isSet bool
}

func (v NullableFabricVlanResponse) Get() *FabricVlanResponse {
	return v.value
}

func (v *NullableFabricVlanResponse) Set(val *FabricVlanResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricVlanResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricVlanResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricVlanResponse(val *FabricVlanResponse) *NullableFabricVlanResponse {
	return &NullableFabricVlanResponse{value: val, isSet: true}
}

func (v NullableFabricVlanResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricVlanResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
