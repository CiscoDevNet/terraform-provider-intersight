...
// BootPrecisionPolicyListAllOf struct for BootPrecisionPolicyListAllOf
type BootPrecisionPolicyListAllOf struct {
...
type _BootPrecisionPolicyListAllOf BootPrecisionPolicyListAllOf
...
func NewBootPrecisionPolicyListAllOf() *BootPrecisionPolicyListAllOf {
	this := BootPrecisionPolicyListAllOf{}
	return &this
}
...
func (o BootPrecisionPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BootPrecisionPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBootPrecisionPolicyListAllOf := _BootPrecisionPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varBootPrecisionPolicyListAllOf); err == nil {
		*o = BootPrecisionPolicyListAllOf(varBootPrecisionPolicyListAllOf)
	}
...
type NullableBootPrecisionPolicyListAllOf struct {
	value *BootPrecisionPolicyListAllOf
	isSet bool
}

func (v NullableBootPrecisionPolicyListAllOf) Get() *BootPrecisionPolicyListAllOf {
	return v.value
}

func (v *NullableBootPrecisionPolicyListAllOf) Set(val *BootPrecisionPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBootPrecisionPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBootPrecisionPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootPrecisionPolicyListAllOf(val *BootPrecisionPolicyListAllOf) *NullableBootPrecisionPolicyListAllOf {
	return &NullableBootPrecisionPolicyListAllOf{value: val, isSet: true}
}

func (v NullableBootPrecisionPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootPrecisionPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
