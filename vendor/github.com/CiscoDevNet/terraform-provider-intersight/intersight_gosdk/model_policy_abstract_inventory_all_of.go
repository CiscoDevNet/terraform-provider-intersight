...
// PolicyAbstractInventoryAllOf Definition of the list of properties defined in 'policy.AbstractInventory', excluding properties defined in parent classes.
type PolicyAbstractInventoryAllOf struct {
...
type _PolicyAbstractInventoryAllOf PolicyAbstractInventoryAllOf
...
func NewPolicyAbstractInventoryAllOf(classId string, objectType string) *PolicyAbstractInventoryAllOf {
	this := PolicyAbstractInventoryAllOf{}
...
func (o PolicyAbstractInventoryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *PolicyAbstractInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varPolicyAbstractInventoryAllOf := _PolicyAbstractInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varPolicyAbstractInventoryAllOf); err == nil {
		*o = PolicyAbstractInventoryAllOf(varPolicyAbstractInventoryAllOf)
	}
...
type NullablePolicyAbstractInventoryAllOf struct {
	value *PolicyAbstractInventoryAllOf
	isSet bool
}

func (v NullablePolicyAbstractInventoryAllOf) Get() *PolicyAbstractInventoryAllOf {
	return v.value
}

func (v *NullablePolicyAbstractInventoryAllOf) Set(val *PolicyAbstractInventoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyAbstractInventoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyAbstractInventoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyAbstractInventoryAllOf(val *PolicyAbstractInventoryAllOf) *NullablePolicyAbstractInventoryAllOf {
	return &NullablePolicyAbstractInventoryAllOf{value: val, isSet: true}
}

func (v NullablePolicyAbstractInventoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyAbstractInventoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
