...
// checks if the TechsupportmanagementCollectionControlPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TechsupportmanagementCollectionControlPolicy{}
...
// GetDefaultClassId returns the default value "techsupportmanagement.CollectionControlPolicy" of the ClassId field.
func (o *TechsupportmanagementCollectionControlPolicy) GetDefaultClassId() interface{} {
	return "techsupportmanagement.CollectionControlPolicy"
}
...
// GetDefaultObjectType returns the default value "techsupportmanagement.CollectionControlPolicy" of the ObjectType field.
func (o *TechsupportmanagementCollectionControlPolicy) GetDefaultObjectType() interface{} {
	return "techsupportmanagement.CollectionControlPolicy"
}
...
func (o *TechsupportmanagementCollectionControlPolicy) GetTechSupportCollection() string {
	if o == nil || IsNil(o.TechSupportCollection) {
		var ret string
		return ret
	}
...
func (o *TechsupportmanagementCollectionControlPolicy) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o TechsupportmanagementCollectionControlPolicy) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TechSupportCollection) {
...
func (o *TechsupportmanagementCollectionControlPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTechsupportmanagementCollectionControlPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTechsupportmanagementCollectionControlPolicy)
	if err == nil {
