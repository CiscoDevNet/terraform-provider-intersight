...
// PartnerintegrationInventoryListAllOf struct for PartnerintegrationInventoryListAllOf
type PartnerintegrationInventoryListAllOf struct {
...
type _PartnerintegrationInventoryListAllOf PartnerintegrationInventoryListAllOf
...
func NewPartnerintegrationInventoryListAllOf() *PartnerintegrationInventoryListAllOf {
	this := PartnerintegrationInventoryListAllOf{}
	return &this
}
...
func (o PartnerintegrationInventoryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *PartnerintegrationInventoryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varPartnerintegrationInventoryListAllOf := _PartnerintegrationInventoryListAllOf{}

	if err = json.Unmarshal(bytes, &varPartnerintegrationInventoryListAllOf); err == nil {
		*o = PartnerintegrationInventoryListAllOf(varPartnerintegrationInventoryListAllOf)
	}
...
type NullablePartnerintegrationInventoryListAllOf struct {
	value *PartnerintegrationInventoryListAllOf
	isSet bool
}

func (v NullablePartnerintegrationInventoryListAllOf) Get() *PartnerintegrationInventoryListAllOf {
	return v.value
}

func (v *NullablePartnerintegrationInventoryListAllOf) Set(val *PartnerintegrationInventoryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerintegrationInventoryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerintegrationInventoryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerintegrationInventoryListAllOf(val *PartnerintegrationInventoryListAllOf) *NullablePartnerintegrationInventoryListAllOf {
	return &NullablePartnerintegrationInventoryListAllOf{value: val, isSet: true}
}

func (v NullablePartnerintegrationInventoryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerintegrationInventoryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
