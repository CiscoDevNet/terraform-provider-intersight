...
// checks if the EquipmentPsuList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EquipmentPsuList{}
...
func (o EquipmentPsuList) ToMap() (map[string]interface{}, error) {
...
func (o *EquipmentPsuList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEquipmentPsuListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varEquipmentPsuList)
	if err == nil {
