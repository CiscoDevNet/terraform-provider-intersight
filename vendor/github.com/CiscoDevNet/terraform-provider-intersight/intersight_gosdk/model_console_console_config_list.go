...
func (o *ConsoleConsoleConfigList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varConsoleConsoleConfigListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varConsoleConsoleConfigList)
	if err == nil {
