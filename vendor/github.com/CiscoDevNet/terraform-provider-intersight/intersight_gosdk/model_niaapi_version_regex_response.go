...
func (dst *NiaapiVersionRegexResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal NiaapiVersionRegexResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal NiaapiVersionRegexResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal NiaapiVersionRegexResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'niaapi.VersionRegex.List'
	if jsonDict["ObjectType"] == "niaapi.VersionRegex.List" {
		// try to unmarshal JSON data into NiaapiVersionRegexList
		err = json.Unmarshal(data, &dst.NiaapiVersionRegexList)
		if err == nil {
			return nil // data stored in dst.NiaapiVersionRegexList, return on the first match
		} else {
			dst.NiaapiVersionRegexList = nil
			return fmt.Errorf("failed to unmarshal NiaapiVersionRegexResponse as NiaapiVersionRegexList: %s", err.Error())
		}
	}
...
func (src NiaapiVersionRegexResponse) MarshalJSON() ([]byte, error) {
	...
	if src.NiaapiVersionRegexList != nil {
		return json.Marshal(&src.NiaapiVersionRegexList)
	}
...
func (obj *NiaapiVersionRegexResponse) GetActualInstance() interface{} {
	...
	if obj.NiaapiVersionRegexList != nil {
		return obj.NiaapiVersionRegexList
	}
...
type NullableNiaapiVersionRegexResponse struct {
	value *NiaapiVersionRegexResponse
	isSet bool
}

func (v NullableNiaapiVersionRegexResponse) Get() *NiaapiVersionRegexResponse {
	return v.value
}

func (v *NullableNiaapiVersionRegexResponse) Set(val *NiaapiVersionRegexResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNiaapiVersionRegexResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNiaapiVersionRegexResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiaapiVersionRegexResponse(val *NiaapiVersionRegexResponse) *NullableNiaapiVersionRegexResponse {
	return &NullableNiaapiVersionRegexResponse{value: val, isSet: true}
}

func (v NullableNiaapiVersionRegexResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiaapiVersionRegexResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
