...
func (dst *RecoveryBackupProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal RecoveryBackupProfileResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal RecoveryBackupProfileResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal RecoveryBackupProfileResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'recovery.BackupProfile.List'
	if jsonDict["ObjectType"] == "recovery.BackupProfile.List" {
		// try to unmarshal JSON data into RecoveryBackupProfileList
		err = json.Unmarshal(data, &dst.RecoveryBackupProfileList)
		if err == nil {
			return nil // data stored in dst.RecoveryBackupProfileList, return on the first match
		} else {
			dst.RecoveryBackupProfileList = nil
			return fmt.Errorf("Failed to unmarshal RecoveryBackupProfileResponse as RecoveryBackupProfileList: %s", err.Error())
		}
	}
...
func (src RecoveryBackupProfileResponse) MarshalJSON() ([]byte, error) {
	...
	if src.RecoveryBackupProfileList != nil {
		return json.Marshal(&src.RecoveryBackupProfileList)
	}
...
func (obj *RecoveryBackupProfileResponse) GetActualInstance() interface{} {
	...
	if obj.RecoveryBackupProfileList != nil {
		return obj.RecoveryBackupProfileList
	}
...
type NullableRecoveryBackupProfileResponse struct {
	value *RecoveryBackupProfileResponse
	isSet bool
}

func (v NullableRecoveryBackupProfileResponse) Get() *RecoveryBackupProfileResponse {
	return v.value
}

func (v *NullableRecoveryBackupProfileResponse) Set(val *RecoveryBackupProfileResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryBackupProfileResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryBackupProfileResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryBackupProfileResponse(val *RecoveryBackupProfileResponse) *NullableRecoveryBackupProfileResponse {
	return &NullableRecoveryBackupProfileResponse{value: val, isSet: true}
}

func (v NullableRecoveryBackupProfileResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryBackupProfileResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
