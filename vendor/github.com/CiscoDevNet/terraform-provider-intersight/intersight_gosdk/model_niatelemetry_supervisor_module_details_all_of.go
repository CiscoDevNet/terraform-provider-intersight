...
// NiatelemetrySupervisorModuleDetailsAllOf Definition of the list of properties defined in 'niatelemetry.SupervisorModuleDetails', excluding properties defined in parent classes.
type NiatelemetrySupervisorModuleDetailsAllOf struct {
...
type _NiatelemetrySupervisorModuleDetailsAllOf NiatelemetrySupervisorModuleDetailsAllOf
...
func NewNiatelemetrySupervisorModuleDetailsAllOf(classId string, objectType string) *NiatelemetrySupervisorModuleDetailsAllOf {
	this := NiatelemetrySupervisorModuleDetailsAllOf{}
...
func (o NiatelemetrySupervisorModuleDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetrySupervisorModuleDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetrySupervisorModuleDetailsAllOf := _NiatelemetrySupervisorModuleDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetrySupervisorModuleDetailsAllOf); err == nil {
		*o = NiatelemetrySupervisorModuleDetailsAllOf(varNiatelemetrySupervisorModuleDetailsAllOf)
	}
...
type NullableNiatelemetrySupervisorModuleDetailsAllOf struct {
	value *NiatelemetrySupervisorModuleDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetrySupervisorModuleDetailsAllOf) Get() *NiatelemetrySupervisorModuleDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetrySupervisorModuleDetailsAllOf) Set(val *NiatelemetrySupervisorModuleDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetrySupervisorModuleDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetrySupervisorModuleDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetrySupervisorModuleDetailsAllOf(val *NiatelemetrySupervisorModuleDetailsAllOf) *NullableNiatelemetrySupervisorModuleDetailsAllOf {
	return &NullableNiatelemetrySupervisorModuleDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetrySupervisorModuleDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetrySupervisorModuleDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
