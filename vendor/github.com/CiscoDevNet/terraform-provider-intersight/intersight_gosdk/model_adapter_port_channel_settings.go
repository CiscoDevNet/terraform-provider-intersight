...
// checks if the AdapterPortChannelSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdapterPortChannelSettings{}
...
// GetDefaultClassId returns the default value "adapter.PortChannelSettings" of the ClassId field.
func (o *AdapterPortChannelSettings) GetDefaultClassId() interface{} {
	return "adapter.PortChannelSettings"
}
...
// GetDefaultObjectType returns the default value "adapter.PortChannelSettings" of the ObjectType field.
func (o *AdapterPortChannelSettings) GetDefaultObjectType() interface{} {
	return "adapter.PortChannelSettings"
}
...
func (o AdapterPortChannelSettings) ToMap() (map[string]interface{}, error) {
...
func (o *AdapterPortChannelSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAdapterPortChannelSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAdapterPortChannelSettings)
	if err == nil {
