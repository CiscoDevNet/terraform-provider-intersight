...
func VirtualizationVmwareClusterListAsVirtualizationVmwareClusterResponse(v *VirtualizationVmwareClusterList) VirtualizationVmwareClusterResponse {
	return VirtualizationVmwareClusterResponse{
		VirtualizationVmwareClusterList: v,
	}
}
...
func (dst *VirtualizationVmwareClusterResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareClusterResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareClusterResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareClusterResponse as MoTagSummary: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "virtualization.VmwareCluster.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVmwareClusterResponse as VirtualizationVmwareClusterList: %s", err.Error())
		}
	}
