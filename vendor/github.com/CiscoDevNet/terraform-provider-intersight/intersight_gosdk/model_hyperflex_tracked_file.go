...
// checks if the HyperflexTrackedFile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexTrackedFile{}
...
// GetDefaultClassId returns the default value "hyperflex.TrackedFile" of the ClassId field.
func (o *HyperflexTrackedFile) GetDefaultClassId() interface{} {
	return "hyperflex.TrackedFile"
}
...
// GetDefaultObjectType returns the default value "hyperflex.TrackedFile" of the ObjectType field.
func (o *HyperflexTrackedFile) GetDefaultObjectType() interface{} {
	return "hyperflex.TrackedFile"
}
...
func (o HyperflexTrackedFile) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexTrackedFile) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexTrackedFileWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexTrackedFile)
	if err == nil {
