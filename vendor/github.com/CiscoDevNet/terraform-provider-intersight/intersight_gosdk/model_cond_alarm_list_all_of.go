...
// CondAlarmListAllOf struct for CondAlarmListAllOf
type CondAlarmListAllOf struct {
...
type _CondAlarmListAllOf CondAlarmListAllOf
...
func (o CondAlarmListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CondAlarmListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCondAlarmListAllOf := _CondAlarmListAllOf{}

	if err = json.Unmarshal(bytes, &varCondAlarmListAllOf); err == nil {
		*o = CondAlarmListAllOf(varCondAlarmListAllOf)
	}
...
type NullableCondAlarmListAllOf struct {
	value *CondAlarmListAllOf
	isSet bool
}

func (v NullableCondAlarmListAllOf) Get() *CondAlarmListAllOf {
	return v.value
}

func (v *NullableCondAlarmListAllOf) Set(val *CondAlarmListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCondAlarmListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCondAlarmListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondAlarmListAllOf(val *CondAlarmListAllOf) *NullableCondAlarmListAllOf {
	return &NullableCondAlarmListAllOf{value: val, isSet: true}
}

func (v NullableCondAlarmListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondAlarmListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
