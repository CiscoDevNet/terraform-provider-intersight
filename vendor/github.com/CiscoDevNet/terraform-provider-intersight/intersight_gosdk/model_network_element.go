...
func (o *NetworkElement) SetLocationDetailsNil() {
...
func (o *NetworkElement) SetAssignedLocationNil() {
...
func (o *NetworkElement) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varNetworkElement.LocationDetails = varNetworkElementWithoutEmbeddedStruct.LocationDetails
		...
		varNetworkElement.AssignedLocation = varNetworkElementWithoutEmbeddedStruct.AssignedLocation
