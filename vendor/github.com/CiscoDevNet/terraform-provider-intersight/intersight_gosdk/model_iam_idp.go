...
type IamIdp struct {
	...
	TestIdp    NullableIamTestIdpConfigurationRelationship `json:"TestIdp,omitempty"`
...
// GetLdapMeta returns the LdapMeta field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IamIdp) GetLdapMeta() IamLdapMetaRelationship {
	if o == nil || IsNil(o.LdapMeta.Get()) {
		var ret IamLdapMetaRelationship
		return ret
	}
	return *o.LdapMeta.Get()
}

// GetLdapMetaOk returns a tuple with the LdapMeta field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetLdapMeta gets a reference to the given NullableIamLdapMetaRelationship and assigns it to the LdapMeta field.
func (o *IamIdp) SetLdapMeta(v IamLdapMetaRelationship) {
	o.LdapMeta.Set(&v)
}

// SetLdapMetaNil sets the value for LdapMeta to be an explicit nil
func (o *IamIdp) SetLdapMetaNil() {
	o.LdapMeta.Set(nil)
}
...
// GetTestIdp returns the TestIdp field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IamIdp) GetTestIdp() IamTestIdpConfigurationRelationship {
	if o == nil || IsNil(o.TestIdp.Get()) {
		var ret IamTestIdpConfigurationRelationship
		return ret
	}
	return *o.TestIdp.Get()
}

// GetTestIdpOk returns a tuple with the TestIdp field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetTestIdp gets a reference to the given NullableIamTestIdpConfigurationRelationship and assigns it to the TestIdp field.
...
func (o IamIdp) ToMap() (map[string]interface{}, error) {
	...
	if o.LdapMeta.IsSet() {
		toSerialize["LdapMeta"] = o.LdapMeta.Get()
	}
	...
	if o.TestIdp.IsSet() {
		toSerialize["TestIdp"] = o.TestIdp.Get()
	}
...
func (o *IamIdp) UnmarshalJSON(data []byte) (err error) {
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "LdapMeta")
		delete(additionalProperties, "LdapPolicy")
		delete(additionalProperties, "System")
		delete(additionalProperties, "TestIdp")
