...
func (o *TaskFabricMosScopedInventory) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTaskFabricMosScopedInventoryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varTaskFabricMosScopedInventory)
	if err == nil {
