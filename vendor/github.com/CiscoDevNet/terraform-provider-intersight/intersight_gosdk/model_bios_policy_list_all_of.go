...
// BiosPolicyListAllOf struct for BiosPolicyListAllOf
type BiosPolicyListAllOf struct {
...
type _BiosPolicyListAllOf BiosPolicyListAllOf
...
func (o BiosPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BiosPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBiosPolicyListAllOf := _BiosPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varBiosPolicyListAllOf); err == nil {
		*o = BiosPolicyListAllOf(varBiosPolicyListAllOf)
	}
...
type NullableBiosPolicyListAllOf struct {
	value *BiosPolicyListAllOf
	isSet bool
}

func (v NullableBiosPolicyListAllOf) Get() *BiosPolicyListAllOf {
	return v.value
}

func (v *NullableBiosPolicyListAllOf) Set(val *BiosPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBiosPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBiosPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBiosPolicyListAllOf(val *BiosPolicyListAllOf) *NullableBiosPolicyListAllOf {
	return &NullableBiosPolicyListAllOf{value: val, isSet: true}
}

func (v NullableBiosPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBiosPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
