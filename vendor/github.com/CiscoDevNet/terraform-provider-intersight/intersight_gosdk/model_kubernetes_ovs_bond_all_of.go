...
// KubernetesOvsBondAllOf Definition of the list of properties defined in 'kubernetes.OvsBond', excluding properties defined in parent classes.
type KubernetesOvsBondAllOf struct {
...
type _KubernetesOvsBondAllOf KubernetesOvsBondAllOf
...
func (o KubernetesOvsBondAllOf) MarshalJSON() ([]byte, error) {
...
func (o *KubernetesOvsBondAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varKubernetesOvsBondAllOf := _KubernetesOvsBondAllOf{}

	if err = json.Unmarshal(bytes, &varKubernetesOvsBondAllOf); err == nil {
		*o = KubernetesOvsBondAllOf(varKubernetesOvsBondAllOf)
	}
...
type NullableKubernetesOvsBondAllOf struct {
	value *KubernetesOvsBondAllOf
	isSet bool
}

func (v NullableKubernetesOvsBondAllOf) Get() *KubernetesOvsBondAllOf {
	return v.value
}

func (v *NullableKubernetesOvsBondAllOf) Set(val *KubernetesOvsBondAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesOvsBondAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesOvsBondAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesOvsBondAllOf(val *KubernetesOvsBondAllOf) *NullableKubernetesOvsBondAllOf {
	return &NullableKubernetesOvsBondAllOf{value: val, isSet: true}
}

func (v NullableKubernetesOvsBondAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesOvsBondAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
