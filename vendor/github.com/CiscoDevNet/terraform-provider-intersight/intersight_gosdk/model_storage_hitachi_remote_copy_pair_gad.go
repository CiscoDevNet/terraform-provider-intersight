...
// checks if the StorageHitachiRemoteCopyPairGad type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageHitachiRemoteCopyPairGad{}

// StorageHitachiRemoteCopyPairGad The global-active device pair entity in Hitachi storage array.
type StorageHitachiRemoteCopyPairGad struct {
	MoBaseMo
	...
	CreatedLocalTime *string `json:"CreatedLocalTime,omitempty"`
	// Indicates whether the state of the volume on the local storage system is SSWS.
	IsSsws *bool `json:"IsSsws,omitempty"`
	...
	SuspendedMode *string `json:"SuspendedMode,omitempty"`
...
type _StorageHitachiRemoteCopyPairGad StorageHitachiRemoteCopyPairGad
...
func NewStorageHitachiRemoteCopyPairGad(classId string, objectType string) *StorageHitachiRemoteCopyPairGad {
	this := StorageHitachiRemoteCopyPairGad{}
...
func NewStorageHitachiRemoteCopyPairGadWithDefaults() *StorageHitachiRemoteCopyPairGad {
	this := StorageHitachiRemoteCopyPairGad{}
	var classId string = "storage.HitachiRemoteCopyPairGad"
	this.ClassId = classId
	var objectType string = "storage.HitachiRemoteCopyPairGad"
	this.ObjectType = objectType
	return &this
}
...
// GetDefaultClassId returns the default value "storage.HitachiRemoteCopyPairGad" of the ClassId field.
func (o *StorageHitachiRemoteCopyPairGad) GetDefaultClassId() interface{} {
	return "storage.HitachiRemoteCopyPairGad"
}
...
// GetDefaultObjectType returns the default value "storage.HitachiRemoteCopyPairGad" of the ObjectType field.
func (o *StorageHitachiRemoteCopyPairGad) GetDefaultObjectType() interface{} {
	return "storage.HitachiRemoteCopyPairGad"
}

// GetCreatedLocalTime returns the CreatedLocalTime field value if set, zero value otherwise.
func (o *StorageHitachiRemoteCopyPairGad) GetCreatedLocalTime() string {
	if o == nil || IsNil(o.CreatedLocalTime) {
		var ret string
		return ret
	}
	return *o.CreatedLocalTime
}

// GetCreatedLocalTimeOk returns a tuple with the CreatedLocalTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StorageHitachiRemoteCopyPairGad) GetCreatedLocalTimeOk() (*string, bool) {
	if o == nil || IsNil(o.CreatedLocalTime) {
		return nil, false
	}
	return o.CreatedLocalTime, true
}
...
// SetCreatedLocalTime gets a reference to the given string and assigns it to the CreatedLocalTime field.
func (o *StorageHitachiRemoteCopyPairGad) SetCreatedLocalTime(v string) {
	o.CreatedLocalTime = &v
}

// GetIsSsws returns the IsSsws field value if set, zero value otherwise.
func (o *StorageHitachiRemoteCopyPairGad) GetIsSsws() bool {
	if o == nil || IsNil(o.IsSsws) {
		var ret bool
		return ret
	}
	return *o.IsSsws
...
// GetIsSswsOk returns a tuple with the IsSsws field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StorageHitachiRemoteCopyPairGad) GetIsSswsOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSsws) {
		return nil, false
	}
	return o.IsSsws, true
}
...
// SetIsSsws gets a reference to the given bool and assigns it to the IsSsws field.
...
// GetSuspendedMode returns the SuspendedMode field value if set, zero value otherwise.
func (o *StorageHitachiRemoteCopyPairGad) GetSuspendedMode() string {
	if o == nil || IsNil(o.SuspendedMode) {
		var ret string
		return ret
	}
	return *o.SuspendedMode
}

// GetSuspendedModeOk returns a tuple with the SuspendedMode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StorageHitachiRemoteCopyPairGad) GetSuspendedModeOk() (*string, bool) {
	if o == nil || IsNil(o.SuspendedMode) {
		return nil, false
	}
	return o.SuspendedMode, true
}
...
// SetSuspendedMode gets a reference to the given string and assigns it to the SuspendedMode field.
...
func (o *StorageHitachiRemoteCopyPairGad) SetArrayNil() {
	o.Array.Set(nil)
}
...
func (o *StorageHitachiRemoteCopyPairGad) SetRegisteredDeviceNil() {
...
func (o StorageHitachiRemoteCopyPairGad) MarshalJSON() ([]byte, error) {
...
func (o StorageHitachiRemoteCopyPairGad) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CreatedLocalTime) {
		toSerialize["CreatedLocalTime"] = o.CreatedLocalTime
	}
	if !IsNil(o.IsSsws) {
		toSerialize["IsSsws"] = o.IsSsws
	}
	if !IsNil(o.MuNumber) {
	...
	if !IsNil(o.SuspendedMode) {
		toSerialize["SuspendedMode"] = o.SuspendedMode
	}
...
func (o *StorageHitachiRemoteCopyPairGad) UnmarshalJSON(data []byte) (err error) {
	...
	type StorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct := StorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct)
	if err == nil {
		varStorageHitachiRemoteCopyPairGad := _StorageHitachiRemoteCopyPairGad{}
		varStorageHitachiRemoteCopyPairGad.ClassId = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.ClassId
		varStorageHitachiRemoteCopyPairGad.ObjectType = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.ObjectType
		varStorageHitachiRemoteCopyPairGad.CreatedLocalTime = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.CreatedLocalTime
		varStorageHitachiRemoteCopyPairGad.IsSsws = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.IsSsws
		varStorageHitachiRemoteCopyPairGad.MuNumber = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.MuNumber
		varStorageHitachiRemoteCopyPairGad.Name = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.Name
		varStorageHitachiRemoteCopyPairGad.PvolLdevId = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.PvolLdevId
		varStorageHitachiRemoteCopyPairGad.PvolStorageSerial = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.PvolStorageSerial
		varStorageHitachiRemoteCopyPairGad.QuorumDiskId = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.QuorumDiskId
		varStorageHitachiRemoteCopyPairGad.ReplicationType = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.ReplicationType
		varStorageHitachiRemoteCopyPairGad.Status = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.Status
		varStorageHitachiRemoteCopyPairGad.SuspendedMode = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.SuspendedMode
		varStorageHitachiRemoteCopyPairGad.SvolLdevId = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.SvolLdevId
		varStorageHitachiRemoteCopyPairGad.SvolStorageSerial = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.SvolStorageSerial
		varStorageHitachiRemoteCopyPairGad.Array = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.Array
		varStorageHitachiRemoteCopyPairGad.RegisteredDevice = varStorageHitachiRemoteCopyPairGadWithoutEmbeddedStruct.RegisteredDevice
		*o = StorageHitachiRemoteCopyPairGad(varStorageHitachiRemoteCopyPairGad)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varStorageHitachiRemoteCopyPairGad)
	if err == nil {
		o.MoBaseMo = varStorageHitachiRemoteCopyPairGad.MoBaseMo
	} else {
		return err
	}
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "CreatedLocalTime")
		delete(additionalProperties, "IsSsws")
		...
		delete(additionalProperties, "SuspendedMode")
...
type NullableStorageHitachiRemoteCopyPairGad struct {
	value *StorageHitachiRemoteCopyPairGad
	isSet bool
}

func (v NullableStorageHitachiRemoteCopyPairGad) Get() *StorageHitachiRemoteCopyPairGad {
	return v.value
}

func (v *NullableStorageHitachiRemoteCopyPairGad) Set(val *StorageHitachiRemoteCopyPairGad) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageHitachiRemoteCopyPairGad) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageHitachiRemoteCopyPairGad) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageHitachiRemoteCopyPairGad(val *StorageHitachiRemoteCopyPairGad) *NullableStorageHitachiRemoteCopyPairGad {
	return &NullableStorageHitachiRemoteCopyPairGad{value: val, isSet: true}
}

func (v NullableStorageHitachiRemoteCopyPairGad) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageHitachiRemoteCopyPairGad) UnmarshalJSON(src []byte) error {
	v.isSet = true
