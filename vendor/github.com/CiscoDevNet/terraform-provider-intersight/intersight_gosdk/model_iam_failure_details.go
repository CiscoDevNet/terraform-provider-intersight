...
type _IamFailureDetails IamFailureDetails
...
func (o *IamFailureDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varIamFailureDetails.ObjectType = varIamFailureDetailsWithoutEmbeddedStruct.ObjectType
		varIamFailureDetails.FailureReason = varIamFailureDetailsWithoutEmbeddedStruct.FailureReason
		varIamFailureDetails.FailureTime = varIamFailureDetailsWithoutEmbeddedStruct.FailureTime
		*o = IamFailureDetails(varIamFailureDetails)
	} else {
		return err
	}
...
type NullableIamFailureDetails struct {
	value *IamFailureDetails
	isSet bool
}

func (v NullableIamFailureDetails) Get() *IamFailureDetails {
	return v.value
}

func (v *NullableIamFailureDetails) Set(val *IamFailureDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableIamFailureDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableIamFailureDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamFailureDetails(val *IamFailureDetails) *NullableIamFailureDetails {
	return &NullableIamFailureDetails{value: val, isSet: true}
}

func (v NullableIamFailureDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamFailureDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
