...
// StorageNetAppNamespaceAllOf Definition of the list of properties defined in 'storage.NetAppNamespace', excluding properties defined in parent classes.
type StorageNetAppNamespaceAllOf struct {
...
type _StorageNetAppNamespaceAllOf StorageNetAppNamespaceAllOf
...
func NewStorageNetAppNamespaceAllOf(classId string, objectType string) *StorageNetAppNamespaceAllOf {
	this := StorageNetAppNamespaceAllOf{}
...
func (o *StorageNetAppNamespaceAllOf) SetStorageUtilizationNil() {
...
func (o StorageNetAppNamespaceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppNamespaceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppNamespaceAllOf := _StorageNetAppNamespaceAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppNamespaceAllOf); err == nil {
		*o = StorageNetAppNamespaceAllOf(varStorageNetAppNamespaceAllOf)
	}
...
type NullableStorageNetAppNamespaceAllOf struct {
	value *StorageNetAppNamespaceAllOf
	isSet bool
}

func (v NullableStorageNetAppNamespaceAllOf) Get() *StorageNetAppNamespaceAllOf {
	return v.value
}

func (v *NullableStorageNetAppNamespaceAllOf) Set(val *StorageNetAppNamespaceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppNamespaceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppNamespaceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppNamespaceAllOf(val *StorageNetAppNamespaceAllOf) *NullableStorageNetAppNamespaceAllOf {
	return &NullableStorageNetAppNamespaceAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppNamespaceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppNamespaceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
