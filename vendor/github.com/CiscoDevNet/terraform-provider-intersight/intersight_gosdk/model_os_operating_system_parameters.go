...
// checks if the OsOperatingSystemParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsOperatingSystemParameters{}
...
func NewOsOperatingSystemParameters(classId string, objectType string) *OsOperatingSystemParameters {
...
func (o OsOperatingSystemParameters) ToMap() (map[string]interface{}, error) {
...
func (o *OsOperatingSystemParameters) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsOperatingSystemParametersWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsOperatingSystemParameters)
	if err == nil {
