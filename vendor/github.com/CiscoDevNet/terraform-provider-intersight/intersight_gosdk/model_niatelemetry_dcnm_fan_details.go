...
// checks if the NiatelemetryDcnmFanDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryDcnmFanDetails{}
...
// GetDefaultClassId returns the default value "niatelemetry.DcnmFanDetails" of the ClassId field.
func (o *NiatelemetryDcnmFanDetails) GetDefaultClassId() interface{} {
	return "niatelemetry.DcnmFanDetails"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.DcnmFanDetails" of the ObjectType field.
func (o *NiatelemetryDcnmFanDetails) GetDefaultObjectType() interface{} {
	return "niatelemetry.DcnmFanDetails"
}
...
func (o *NiatelemetryDcnmFanDetails) SetRegisteredDeviceNil() {
...
func (o NiatelemetryDcnmFanDetails) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryDcnmFanDetails) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryDcnmFanDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryDcnmFanDetails)
	if err == nil {
