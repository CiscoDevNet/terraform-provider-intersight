...
// checks if the BootUsbDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootUsbDevice{}

// BootUsbDevice Usb Boot Device configured on the server.
type BootUsbDevice struct {
...
type _BootUsbDevice BootUsbDevice
...
// GetDefaultClassId returns the default value "boot.UsbDevice" of the ClassId field.
func (o *BootUsbDevice) GetDefaultClassId() interface{} {
	return "boot.UsbDevice"
}
...
// GetDefaultObjectType returns the default value "boot.UsbDevice" of the ObjectType field.
func (o *BootUsbDevice) GetDefaultObjectType() interface{} {
	return "boot.UsbDevice"
}
...
func (o *BootUsbDevice) SetComputePhysicalNil() {
...
func (o *BootUsbDevice) SetInventoryDeviceInfoNil() {
...
func (o *BootUsbDevice) SetRegisteredDeviceNil() {
...
func (o BootUsbDevice) MarshalJSON() ([]byte, error) {
...
func (o BootUsbDevice) ToMap() (map[string]interface{}, error) {
...
func (o *BootUsbDevice) UnmarshalJSON(data []byte) (err error) {
	...
	type BootUsbDeviceWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType          string                                      `json:"ObjectType"`
	...
	varBootUsbDeviceWithoutEmbeddedStruct := BootUsbDeviceWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varBootUsbDeviceWithoutEmbeddedStruct)
	if err == nil {
		varBootUsbDevice := _BootUsbDevice{}
		varBootUsbDevice.ClassId = varBootUsbDeviceWithoutEmbeddedStruct.ClassId
		varBootUsbDevice.ObjectType = varBootUsbDeviceWithoutEmbeddedStruct.ObjectType
		varBootUsbDevice.ComputePhysical = varBootUsbDeviceWithoutEmbeddedStruct.ComputePhysical
		varBootUsbDevice.InventoryDeviceInfo = varBootUsbDeviceWithoutEmbeddedStruct.InventoryDeviceInfo
		varBootUsbDevice.RegisteredDevice = varBootUsbDeviceWithoutEmbeddedStruct.RegisteredDevice
		*o = BootUsbDevice(varBootUsbDevice)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varBootUsbDevice)
	if err == nil {
		o.BootConfiguredDevice = varBootUsbDevice.BootConfiguredDevice
	} else {
		return err
	}
...
type NullableBootUsbDevice struct {
	value *BootUsbDevice
	isSet bool
}

func (v NullableBootUsbDevice) Get() *BootUsbDevice {
	return v.value
}

func (v *NullableBootUsbDevice) Set(val *BootUsbDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableBootUsbDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableBootUsbDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootUsbDevice(val *BootUsbDevice) *NullableBootUsbDevice {
	return &NullableBootUsbDevice{value: val, isSet: true}
}

func (v NullableBootUsbDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootUsbDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
