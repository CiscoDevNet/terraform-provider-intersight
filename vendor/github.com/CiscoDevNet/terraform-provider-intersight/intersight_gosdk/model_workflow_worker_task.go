...
// checks if the WorkflowWorkerTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowWorkerTask{}
...
// GetDefaultClassId returns the default value "workflow.WorkerTask" of the ClassId field.
func (o *WorkflowWorkerTask) GetDefaultClassId() interface{} {
	return "workflow.WorkerTask"
}
...
// GetDefaultObjectType returns the default value "workflow.WorkerTask" of the ObjectType field.
func (o *WorkflowWorkerTask) GetDefaultObjectType() interface{} {
	return "workflow.WorkerTask"
}
...
func (o *WorkflowWorkerTask) GetTaskDefinitionId() string {
	if o == nil || IsNil(o.TaskDefinitionId) {
		var ret string
		return ret
	}
...
func (o *WorkflowWorkerTask) GetTaskDefinitionName() string {
	if o == nil || IsNil(o.TaskDefinitionName) {
		var ret string
		return ret
	}
...
func (o WorkflowWorkerTask) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TaskDefinitionId) {
		toSerialize["TaskDefinitionId"] = o.TaskDefinitionId
	}
	if !IsNil(o.TaskDefinitionName) {
...
func (o *WorkflowWorkerTask) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowWorkerTaskWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowWorkerTask)
	if err == nil {
