...
// CapabilitySiocModuleCapabilityDefListAllOf struct for CapabilitySiocModuleCapabilityDefListAllOf
type CapabilitySiocModuleCapabilityDefListAllOf struct {
...
type _CapabilitySiocModuleCapabilityDefListAllOf CapabilitySiocModuleCapabilityDefListAllOf
...
func NewCapabilitySiocModuleCapabilityDefListAllOf() *CapabilitySiocModuleCapabilityDefListAllOf {
	this := CapabilitySiocModuleCapabilityDefListAllOf{}
	return &this
}
...
func (o CapabilitySiocModuleCapabilityDefListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CapabilitySiocModuleCapabilityDefListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCapabilitySiocModuleCapabilityDefListAllOf := _CapabilitySiocModuleCapabilityDefListAllOf{}

	if err = json.Unmarshal(bytes, &varCapabilitySiocModuleCapabilityDefListAllOf); err == nil {
		*o = CapabilitySiocModuleCapabilityDefListAllOf(varCapabilitySiocModuleCapabilityDefListAllOf)
	}
...
type NullableCapabilitySiocModuleCapabilityDefListAllOf struct {
	value *CapabilitySiocModuleCapabilityDefListAllOf
	isSet bool
}

func (v NullableCapabilitySiocModuleCapabilityDefListAllOf) Get() *CapabilitySiocModuleCapabilityDefListAllOf {
	return v.value
}

func (v *NullableCapabilitySiocModuleCapabilityDefListAllOf) Set(val *CapabilitySiocModuleCapabilityDefListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilitySiocModuleCapabilityDefListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilitySiocModuleCapabilityDefListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilitySiocModuleCapabilityDefListAllOf(val *CapabilitySiocModuleCapabilityDefListAllOf) *NullableCapabilitySiocModuleCapabilityDefListAllOf {
	return &NullableCapabilitySiocModuleCapabilityDefListAllOf{value: val, isSet: true}
}

func (v NullableCapabilitySiocModuleCapabilityDefListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilitySiocModuleCapabilityDefListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
