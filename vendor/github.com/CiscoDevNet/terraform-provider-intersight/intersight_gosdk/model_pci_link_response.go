...
func (dst *PciLinkResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal PciLinkResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal PciLinkResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal PciLinkResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'pci.Link.List'
	if jsonDict["ObjectType"] == "pci.Link.List" {
		// try to unmarshal JSON data into PciLinkList
		err = json.Unmarshal(data, &dst.PciLinkList)
		if err == nil {
			return nil // data stored in dst.PciLinkList, return on the first match
		} else {
			dst.PciLinkList = nil
			return fmt.Errorf("failed to unmarshal PciLinkResponse as PciLinkList: %s", err.Error())
		}
	}
...
func (src PciLinkResponse) MarshalJSON() ([]byte, error) {
	...
	if src.PciLinkList != nil {
		return json.Marshal(&src.PciLinkList)
	}
...
func (obj *PciLinkResponse) GetActualInstance() interface{} {
	...
	if obj.PciLinkList != nil {
		return obj.PciLinkList
	}
...
type NullablePciLinkResponse struct {
	value *PciLinkResponse
	isSet bool
}

func (v NullablePciLinkResponse) Get() *PciLinkResponse {
	return v.value
}

func (v *NullablePciLinkResponse) Set(val *PciLinkResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePciLinkResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePciLinkResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePciLinkResponse(val *PciLinkResponse) *NullablePciLinkResponse {
	return &NullablePciLinkResponse{value: val, isSet: true}
}

func (v NullablePciLinkResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePciLinkResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
