...
func (o *CloudVolumeType) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCloudVolumeTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCloudVolumeType)
	if err == nil {
