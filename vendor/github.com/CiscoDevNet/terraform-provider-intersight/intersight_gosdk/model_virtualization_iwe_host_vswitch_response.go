...
func VirtualizationIweHostVswitchListAsVirtualizationIweHostVswitchResponse(v *VirtualizationIweHostVswitchList) VirtualizationIweHostVswitchResponse {
	return VirtualizationIweHostVswitchResponse{
		VirtualizationIweHostVswitchList: v,
	}
}
...
func (dst *VirtualizationIweHostVswitchResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationIweHostVswitchResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationIweHostVswitchResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationIweHostVswitchResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'virtualization.IweHostVswitch.List'
	if jsonDict["ObjectType"] == "virtualization.IweHostVswitch.List" {
		// try to unmarshal JSON data into VirtualizationIweHostVswitchList
		err = json.Unmarshal(data, &dst.VirtualizationIweHostVswitchList)
		if err == nil {
			return nil // data stored in dst.VirtualizationIweHostVswitchList, return on the first match
		} else {
			dst.VirtualizationIweHostVswitchList = nil
			return fmt.Errorf("Failed to unmarshal VirtualizationIweHostVswitchResponse as VirtualizationIweHostVswitchList: %s", err.Error())
		}
	}
...
func (src VirtualizationIweHostVswitchResponse) MarshalJSON() ([]byte, error) {
	...
	if src.VirtualizationIweHostVswitchList != nil {
		return json.Marshal(&src.VirtualizationIweHostVswitchList)
	}
...
func (obj *VirtualizationIweHostVswitchResponse) GetActualInstance() interface{} {
	...
	if obj.VirtualizationIweHostVswitchList != nil {
		return obj.VirtualizationIweHostVswitchList
	}
...
type NullableVirtualizationIweHostVswitchResponse struct {
	value *VirtualizationIweHostVswitchResponse
	isSet bool
}

func (v NullableVirtualizationIweHostVswitchResponse) Get() *VirtualizationIweHostVswitchResponse {
	return v.value
}

func (v *NullableVirtualizationIweHostVswitchResponse) Set(val *VirtualizationIweHostVswitchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationIweHostVswitchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationIweHostVswitchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationIweHostVswitchResponse(val *VirtualizationIweHostVswitchResponse) *NullableVirtualizationIweHostVswitchResponse {
	return &NullableVirtualizationIweHostVswitchResponse{value: val, isSet: true}
}

func (v NullableVirtualizationIweHostVswitchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationIweHostVswitchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
