...
// checks if the FabricFlowControlPolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricFlowControlPolicyList{}
...
func (o FabricFlowControlPolicyList) ToMap() (map[string]interface{}, error) {
...
func (o *FabricFlowControlPolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricFlowControlPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricFlowControlPolicyList)
	if err == nil {
