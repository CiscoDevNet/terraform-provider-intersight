...
// WorkflowFileDownloadOpAllOf Definition of the list of properties defined in 'workflow.FileDownloadOp', excluding properties defined in parent classes.
type WorkflowFileDownloadOpAllOf struct {
...
type _WorkflowFileDownloadOpAllOf WorkflowFileDownloadOpAllOf
...
func NewWorkflowFileDownloadOpAllOf(classId string, objectType string) *WorkflowFileDownloadOpAllOf {
	this := WorkflowFileDownloadOpAllOf{}
...
func (o WorkflowFileDownloadOpAllOf) MarshalJSON() ([]byte, error) {
...
func (o *WorkflowFileDownloadOpAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varWorkflowFileDownloadOpAllOf := _WorkflowFileDownloadOpAllOf{}

	if err = json.Unmarshal(bytes, &varWorkflowFileDownloadOpAllOf); err == nil {
		*o = WorkflowFileDownloadOpAllOf(varWorkflowFileDownloadOpAllOf)
	}
...
type NullableWorkflowFileDownloadOpAllOf struct {
	value *WorkflowFileDownloadOpAllOf
	isSet bool
}

func (v NullableWorkflowFileDownloadOpAllOf) Get() *WorkflowFileDownloadOpAllOf {
	return v.value
}

func (v *NullableWorkflowFileDownloadOpAllOf) Set(val *WorkflowFileDownloadOpAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowFileDownloadOpAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowFileDownloadOpAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowFileDownloadOpAllOf(val *WorkflowFileDownloadOpAllOf) *NullableWorkflowFileDownloadOpAllOf {
	return &NullableWorkflowFileDownloadOpAllOf{value: val, isSet: true}
}

func (v NullableWorkflowFileDownloadOpAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowFileDownloadOpAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
