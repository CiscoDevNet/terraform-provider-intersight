...
// KubernetesInfrastructureProvider Infrastructure backend to use for providing compute and storage resources.
type KubernetesInfrastructureProvider struct {
	MoBaseMo
...
type _KubernetesInfrastructureProvider KubernetesInfrastructureProvider
...
func NewKubernetesInfrastructureProvider(classId string, objectType string) *KubernetesInfrastructureProvider {
	this := KubernetesInfrastructureProvider{}
...
func (o KubernetesInfrastructureProvider) MarshalJSON() ([]byte, error) {
...
func (o *KubernetesInfrastructureProvider) UnmarshalJSON(bytes []byte) (err error) {
	type KubernetesInfrastructureProviderWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property. The enum values provides the list of concrete types that can be instantiated from this abstract type.
		ObjectType string `json:"ObjectType"`
	...
	varKubernetesInfrastructureProviderWithoutEmbeddedStruct := KubernetesInfrastructureProviderWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varKubernetesInfrastructureProviderWithoutEmbeddedStruct)
	if err == nil {
		varKubernetesInfrastructureProvider := _KubernetesInfrastructureProvider{}
		varKubernetesInfrastructureProvider.ClassId = varKubernetesInfrastructureProviderWithoutEmbeddedStruct.ClassId
		varKubernetesInfrastructureProvider.ObjectType = varKubernetesInfrastructureProviderWithoutEmbeddedStruct.ObjectType
		varKubernetesInfrastructureProvider.Description = varKubernetesInfrastructureProviderWithoutEmbeddedStruct.Description
		varKubernetesInfrastructureProvider.Name = varKubernetesInfrastructureProviderWithoutEmbeddedStruct.Name
		varKubernetesInfrastructureProvider.NodeGroups = varKubernetesInfrastructureProviderWithoutEmbeddedStruct.NodeGroups
		*o = KubernetesInfrastructureProvider(varKubernetesInfrastructureProvider)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varKubernetesInfrastructureProvider)
	if err == nil {
		o.MoBaseMo = varKubernetesInfrastructureProvider.MoBaseMo
	} else {
		return err
	}
...
type NullableKubernetesInfrastructureProvider struct {
	value *KubernetesInfrastructureProvider
	isSet bool
}

func (v NullableKubernetesInfrastructureProvider) Get() *KubernetesInfrastructureProvider {
	return v.value
}

func (v *NullableKubernetesInfrastructureProvider) Set(val *KubernetesInfrastructureProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesInfrastructureProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesInfrastructureProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesInfrastructureProvider(val *KubernetesInfrastructureProvider) *NullableKubernetesInfrastructureProvider {
	return &NullableKubernetesInfrastructureProvider{value: val, isSet: true}
}

func (v NullableKubernetesInfrastructureProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesInfrastructureProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true
