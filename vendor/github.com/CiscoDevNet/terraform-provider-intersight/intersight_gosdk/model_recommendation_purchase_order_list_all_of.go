...
// RecommendationPurchaseOrderListAllOf Definition of the list of properties defined in 'recommendation.PurchaseOrderList', excluding properties defined in parent classes.
type RecommendationPurchaseOrderListAllOf struct {
...
type _RecommendationPurchaseOrderListAllOf RecommendationPurchaseOrderListAllOf
...
func NewRecommendationPurchaseOrderListAllOf(classId string, objectType string) *RecommendationPurchaseOrderListAllOf {
	this := RecommendationPurchaseOrderListAllOf{}
...
func (o RecommendationPurchaseOrderListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *RecommendationPurchaseOrderListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varRecommendationPurchaseOrderListAllOf := _RecommendationPurchaseOrderListAllOf{}

	if err = json.Unmarshal(bytes, &varRecommendationPurchaseOrderListAllOf); err == nil {
		*o = RecommendationPurchaseOrderListAllOf(varRecommendationPurchaseOrderListAllOf)
	}
...
type NullableRecommendationPurchaseOrderListAllOf struct {
	value *RecommendationPurchaseOrderListAllOf
	isSet bool
}

func (v NullableRecommendationPurchaseOrderListAllOf) Get() *RecommendationPurchaseOrderListAllOf {
	return v.value
}

func (v *NullableRecommendationPurchaseOrderListAllOf) Set(val *RecommendationPurchaseOrderListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRecommendationPurchaseOrderListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRecommendationPurchaseOrderListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecommendationPurchaseOrderListAllOf(val *RecommendationPurchaseOrderListAllOf) *NullableRecommendationPurchaseOrderListAllOf {
	return &NullableRecommendationPurchaseOrderListAllOf{value: val, isSet: true}
}

func (v NullableRecommendationPurchaseOrderListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecommendationPurchaseOrderListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
