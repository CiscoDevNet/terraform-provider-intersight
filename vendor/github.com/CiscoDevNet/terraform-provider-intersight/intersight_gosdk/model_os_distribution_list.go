...
// checks if the OsDistributionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsDistributionList{}
...
func NewOsDistributionList(objectType string) *OsDistributionList {
...
func (o OsDistributionList) ToMap() (map[string]interface{}, error) {
...
func (o *OsDistributionList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsDistributionListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsDistributionList)
	if err == nil {
