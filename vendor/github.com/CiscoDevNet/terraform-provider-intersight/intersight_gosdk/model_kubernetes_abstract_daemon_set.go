...
func (o *KubernetesAbstractDaemonSet) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varKubernetesAbstractDaemonSetWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varKubernetesAbstractDaemonSet)
	if err == nil {
