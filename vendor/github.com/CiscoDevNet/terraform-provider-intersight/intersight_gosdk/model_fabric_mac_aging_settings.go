...
// checks if the FabricMacAgingSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricMacAgingSettings{}
...
// GetDefaultClassId returns the default value "fabric.MacAgingSettings" of the ClassId field.
func (o *FabricMacAgingSettings) GetDefaultClassId() interface{} {
	return "fabric.MacAgingSettings"
}
...
// GetDefaultObjectType returns the default value "fabric.MacAgingSettings" of the ObjectType field.
func (o *FabricMacAgingSettings) GetDefaultObjectType() interface{} {
	return "fabric.MacAgingSettings"
}
...
func (o *FabricMacAgingSettings) GetMacAgingOption() string {
	if o == nil || IsNil(o.MacAgingOption) {
		var ret string
		return ret
	}
...
func (o FabricMacAgingSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MacAgingOption) {
		toSerialize["MacAgingOption"] = o.MacAgingOption
	}
	if !IsNil(o.MacAgingTime) {
...
func (o *FabricMacAgingSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricMacAgingSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricMacAgingSettings)
	if err == nil {
