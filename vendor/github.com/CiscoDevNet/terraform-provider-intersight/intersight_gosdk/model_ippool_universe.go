...
func (o *IppoolUniverse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varIppoolUniverseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varIppoolUniverse)
	if err == nil {
