...
func (r ApiDeleteVmrcConsoleRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.DeleteVmrcConsoleExecute(r)
}
 ...
 * Execute executes the request
 */
func (a *VmrcApiService) DeleteVmrcConsoleExecute(r ApiDeleteVmrcConsoleRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VmrcApiService.DeleteVmrcConsole")
	if err != nil {
