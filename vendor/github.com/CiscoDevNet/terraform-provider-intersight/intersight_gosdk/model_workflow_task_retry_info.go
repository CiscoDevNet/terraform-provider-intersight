...
// checks if the WorkflowTaskRetryInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTaskRetryInfo{}
...
// GetDefaultClassId returns the default value "workflow.TaskRetryInfo" of the ClassId field.
func (o *WorkflowTaskRetryInfo) GetDefaultClassId() interface{} {
	return "workflow.TaskRetryInfo"
}
...
// GetDefaultObjectType returns the default value "workflow.TaskRetryInfo" of the ObjectType field.
func (o *WorkflowTaskRetryInfo) GetDefaultObjectType() interface{} {
	return "workflow.TaskRetryInfo"
}
...
func (o WorkflowTaskRetryInfo) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowTaskRetryInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowTaskRetryInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowTaskRetryInfo)
	if err == nil {
