...
// checks if the IamAccountExperience type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamAccountExperience{}

// IamAccountExperience AccountExperience captures the set of beta or preview features enabled for a specific account. #### Purpose It allows controlled enablement of new capabilities for evaluation and phased rollout. #### Key Concepts - **Feature Flags:** Represents toggles for account-specific experiences. - **Marketing and OPS Control:** Managed by authorized internal roles. - **Shared Scope:** Visible across organizations where applicable. - **Rollout Safety:** Enables granular, account-level previews.
...
// GetDefaultClassId returns the default value "iam.AccountExperience" of the ClassId field.
func (o *IamAccountExperience) GetDefaultClassId() interface{} {
	return "iam.AccountExperience"
}
...
// GetDefaultObjectType returns the default value "iam.AccountExperience" of the ObjectType field.
func (o *IamAccountExperience) GetDefaultObjectType() interface{} {
	return "iam.AccountExperience"
}
...
func (o *IamAccountExperience) SetAccountNil() {
	o.Account.Set(nil)
}

// UnsetAccount ensures that no value is present for Account, not even an explicit nil
func (o *IamAccountExperience) UnsetAccount() {
	o.Account.Unset()
}
...
func (o IamAccountExperience) ToMap() (map[string]interface{}, error) {
...
func (o *IamAccountExperience) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamAccountExperienceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIamAccountExperience)
	if err == nil {
