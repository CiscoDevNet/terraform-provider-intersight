...
func (dst *VmrcConsoleResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VmrcConsoleResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VmrcConsoleResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VmrcConsoleResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'vmrc.Console.List'
	if jsonDict["ObjectType"] == "vmrc.Console.List" {
		// try to unmarshal JSON data into VmrcConsoleList
		err = json.Unmarshal(data, &dst.VmrcConsoleList)
		if err == nil {
			return nil // data stored in dst.VmrcConsoleList, return on the first match
		} else {
			dst.VmrcConsoleList = nil
			return fmt.Errorf("failed to unmarshal VmrcConsoleResponse as VmrcConsoleList: %s", err.Error())
		}
	}
...
func (src VmrcConsoleResponse) MarshalJSON() ([]byte, error) {
	...
	if src.VmrcConsoleList != nil {
		return json.Marshal(&src.VmrcConsoleList)
	}
...
func (obj *VmrcConsoleResponse) GetActualInstance() interface{} {
	...
	if obj.VmrcConsoleList != nil {
		return obj.VmrcConsoleList
	}
...
type NullableVmrcConsoleResponse struct {
	value *VmrcConsoleResponse
	isSet bool
}

func (v NullableVmrcConsoleResponse) Get() *VmrcConsoleResponse {
	return v.value
}

func (v *NullableVmrcConsoleResponse) Set(val *VmrcConsoleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmrcConsoleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmrcConsoleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmrcConsoleResponse(val *VmrcConsoleResponse) *NullableVmrcConsoleResponse {
	return &NullableVmrcConsoleResponse{value: val, isSet: true}
}

func (v NullableVmrcConsoleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmrcConsoleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
