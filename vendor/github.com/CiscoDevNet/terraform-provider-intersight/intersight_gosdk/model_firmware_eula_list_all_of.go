...
// FirmwareEulaListAllOf struct for FirmwareEulaListAllOf
type FirmwareEulaListAllOf struct {
...
type _FirmwareEulaListAllOf FirmwareEulaListAllOf
...
func (o FirmwareEulaListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FirmwareEulaListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFirmwareEulaListAllOf := _FirmwareEulaListAllOf{}

	if err = json.Unmarshal(bytes, &varFirmwareEulaListAllOf); err == nil {
		*o = FirmwareEulaListAllOf(varFirmwareEulaListAllOf)
	}
...
type NullableFirmwareEulaListAllOf struct {
	value *FirmwareEulaListAllOf
	isSet bool
}

func (v NullableFirmwareEulaListAllOf) Get() *FirmwareEulaListAllOf {
	return v.value
}

func (v *NullableFirmwareEulaListAllOf) Set(val *FirmwareEulaListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFirmwareEulaListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFirmwareEulaListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirmwareEulaListAllOf(val *FirmwareEulaListAllOf) *NullableFirmwareEulaListAllOf {
	return &NullableFirmwareEulaListAllOf{value: val, isSet: true}
}

func (v NullableFirmwareEulaListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirmwareEulaListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
