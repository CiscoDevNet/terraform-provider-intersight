...
// GetVersionContext returns the VersionContext field value if set, zero value otherwise.
func (o *MoBaseMo) GetVersionContext() MoVersionContext {
	if o == nil || o.VersionContext == nil {
		var ret MoVersionContext
		return ret
	}
	return *o.VersionContext
}
...
// SetVersionContext gets a reference to the given MoVersionContext and assigns it to the VersionContext field.
...
func (o MoBaseMo) MarshalJSON() ([]byte, error) {
	...
	if o.VersionContext != nil {
		toSerialize["VersionContext"] = o.VersionContext
	}
	if o.Ancestors != nil {
