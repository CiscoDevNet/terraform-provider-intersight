...
type _BootHddDevice BootHddDevice
...
// GetDefaultClassId returns the default value "boot.HddDevice" of the ClassId field.
func (o *BootHddDevice) GetDefaultClassId() interface{} {
	return "boot.HddDevice"
}
...
// GetDefaultObjectType returns the default value "boot.HddDevice" of the ObjectType field.
func (o *BootHddDevice) GetDefaultObjectType() interface{} {
	return "boot.HddDevice"
}
...
func (o *BootHddDevice) SetComputePhysicalNil() {
...
func (o *BootHddDevice) SetInventoryDeviceInfoNil() {
...
func (o *BootHddDevice) SetRegisteredDeviceNil() {
...
func (o BootHddDevice) MarshalJSON() ([]byte, error) {
...
func (o BootHddDevice) ToMap() (map[string]interface{}, error) {
...
func (o *BootHddDevice) UnmarshalJSON(data []byte) (err error) {
	...
	type BootHddDeviceWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType          string                                      `json:"ObjectType"`
	...
	varBootHddDeviceWithoutEmbeddedStruct := BootHddDeviceWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varBootHddDeviceWithoutEmbeddedStruct)
	if err == nil {
		varBootHddDevice := _BootHddDevice{}
		varBootHddDevice.ClassId = varBootHddDeviceWithoutEmbeddedStruct.ClassId
		varBootHddDevice.ObjectType = varBootHddDeviceWithoutEmbeddedStruct.ObjectType
		varBootHddDevice.ComputePhysical = varBootHddDeviceWithoutEmbeddedStruct.ComputePhysical
		varBootHddDevice.InventoryDeviceInfo = varBootHddDeviceWithoutEmbeddedStruct.InventoryDeviceInfo
		varBootHddDevice.RegisteredDevice = varBootHddDeviceWithoutEmbeddedStruct.RegisteredDevice
		*o = BootHddDevice(varBootHddDevice)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varBootHddDevice)
	if err == nil {
		o.BootConfiguredDevice = varBootHddDevice.BootConfiguredDevice
	} else {
		return err
	}
...
type NullableBootHddDevice struct {
	value *BootHddDevice
	isSet bool
}

func (v NullableBootHddDevice) Get() *BootHddDevice {
	return v.value
}

func (v *NullableBootHddDevice) Set(val *BootHddDevice) {
	v.value = val
	v.isSet = true
}

func (v NullableBootHddDevice) IsSet() bool {
	return v.isSet
}

func (v *NullableBootHddDevice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootHddDevice(val *BootHddDevice) *NullableBootHddDevice {
	return &NullableBootHddDevice{value: val, isSet: true}
}

func (v NullableBootHddDevice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootHddDevice) UnmarshalJSON(src []byte) error {
	v.isSet = true
