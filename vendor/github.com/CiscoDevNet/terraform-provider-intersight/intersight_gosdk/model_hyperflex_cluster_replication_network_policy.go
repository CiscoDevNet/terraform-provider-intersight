...
func (o *HyperflexClusterReplicationNetworkPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varHyperflexClusterReplicationNetworkPolicyWithoutEmbeddedStruct)
	if err == nil {
		...
		varHyperflexClusterReplicationNetworkPolicy.IpPoolMoReference = varHyperflexClusterReplicationNetworkPolicyWithoutEmbeddedStruct.IpPoolMoReference
	...
	err = json.Unmarshal(bytes, &varHyperflexClusterReplicationNetworkPolicy)
	if err == nil {
