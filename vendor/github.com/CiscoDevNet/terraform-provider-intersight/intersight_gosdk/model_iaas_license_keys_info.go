...
type _IaasLicenseKeysInfo IaasLicenseKeysInfo
...
func (o *IaasLicenseKeysInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varIaasLicenseKeysInfo.ObjectType = varIaasLicenseKeysInfoWithoutEmbeddedStruct.ObjectType
		varIaasLicenseKeysInfo.Count = varIaasLicenseKeysInfoWithoutEmbeddedStruct.Count
		varIaasLicenseKeysInfo.ExpirationDate = varIaasLicenseKeysInfoWithoutEmbeddedStruct.ExpirationDate
		varIaasLicenseKeysInfo.LicenseId = varIaasLicenseKeysInfoWithoutEmbeddedStruct.LicenseId
		varIaasLicenseKeysInfo.Pid = varIaasLicenseKeysInfoWithoutEmbeddedStruct.Pid
		*o = IaasLicenseKeysInfo(varIaasLicenseKeysInfo)
	} else {
		return err
	}
