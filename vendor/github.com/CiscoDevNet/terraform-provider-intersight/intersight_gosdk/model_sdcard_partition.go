...
// checks if the SdcardPartition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdcardPartition{}
...
// GetDefaultClassId returns the default value "sdcard.Partition" of the ClassId field.
func (o *SdcardPartition) GetDefaultClassId() interface{} {
	return "sdcard.Partition"
}
...
// GetDefaultObjectType returns the default value "sdcard.Partition" of the ObjectType field.
func (o *SdcardPartition) GetDefaultObjectType() interface{} {
	return "sdcard.Partition"
}
...
func (o SdcardPartition) ToMap() (map[string]interface{}, error) {
...
func (o *SdcardPartition) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSdcardPartitionWithoutEmbeddedStruct)
	if err == nil {
		varSdcardPartition := _SdcardPartition{}
		varSdcardPartition.ClassId = varSdcardPartitionWithoutEmbeddedStruct.ClassId
		varSdcardPartition.ObjectType = varSdcardPartitionWithoutEmbeddedStruct.ObjectType
	...
	err = json.Unmarshal(data, &varSdcardPartition)
	if err == nil {
