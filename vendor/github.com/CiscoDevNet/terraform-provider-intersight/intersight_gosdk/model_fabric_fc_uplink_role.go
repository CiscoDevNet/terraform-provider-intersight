...
type FabricFcUplinkRole struct {
	...
	// Admin configured speed for the port. * `16Gbps` - Admin configurable speed 16Gbps. * `8Gbps` - Admin configurable speed 8Gbps. * `32Gbps` - Admin configurable speed 32Gbps. * `64Gbps` - Admin configurable speed 64Gbps. * `Auto` - Admin configurable speed AUTO ( default ).
