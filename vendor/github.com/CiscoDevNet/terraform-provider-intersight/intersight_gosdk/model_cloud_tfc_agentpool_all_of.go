...
// CloudTfcAgentpoolAllOf Definition of the list of properties defined in 'cloud.TfcAgentpool', excluding properties defined in parent classes.
type CloudTfcAgentpoolAllOf struct {
...
type _CloudTfcAgentpoolAllOf CloudTfcAgentpoolAllOf
...
func (o CloudTfcAgentpoolAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CloudTfcAgentpoolAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCloudTfcAgentpoolAllOf := _CloudTfcAgentpoolAllOf{}

	if err = json.Unmarshal(bytes, &varCloudTfcAgentpoolAllOf); err == nil {
		*o = CloudTfcAgentpoolAllOf(varCloudTfcAgentpoolAllOf)
	}
...
type NullableCloudTfcAgentpoolAllOf struct {
	value *CloudTfcAgentpoolAllOf
	isSet bool
}

func (v NullableCloudTfcAgentpoolAllOf) Get() *CloudTfcAgentpoolAllOf {
	return v.value
}

func (v *NullableCloudTfcAgentpoolAllOf) Set(val *CloudTfcAgentpoolAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTfcAgentpoolAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTfcAgentpoolAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTfcAgentpoolAllOf(val *CloudTfcAgentpoolAllOf) *NullableCloudTfcAgentpoolAllOf {
	return &NullableCloudTfcAgentpoolAllOf{value: val, isSet: true}
}

func (v NullableCloudTfcAgentpoolAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTfcAgentpoolAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
