...
type NiaapiNdMetadata struct {
	...
	// Size of this Metadata package in bytes.
...
// SetMetadataSize gets a reference to the given int64 and assigns it to the MetadataSize field.
...
func (o NiaapiNdMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MetadataSize) {
		toSerialize["MetadataSize"] = o.MetadataSize
	}
	if !IsNil(o.Version) {
...
func (o *NiaapiNdMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varNiaapiNdMetadata.MetadataSize = varNiaapiNdMetadataWithoutEmbeddedStruct.MetadataSize
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "MetadataSize")
