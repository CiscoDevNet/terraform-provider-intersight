...
type LicenseLicenseInfo struct {
	...
	// The last time the trial/grace period evaluation was performed for this license.
	LastTrialGraceEvalTime *time.Time `json:"LastTrialGraceEvalTime,omitempty"`
...
// GetLastTrialGraceEvalTime returns the LastTrialGraceEvalTime field value if set, zero value otherwise.
func (o *LicenseLicenseInfo) GetLastTrialGraceEvalTime() time.Time {
	if o == nil || IsNil(o.LastTrialGraceEvalTime) {
		var ret time.Time
		return ret
	}
	return *o.LastTrialGraceEvalTime
}

// GetLastTrialGraceEvalTimeOk returns a tuple with the LastTrialGraceEvalTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LicenseLicenseInfo) GetLastTrialGraceEvalTimeOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastTrialGraceEvalTime) {
		return nil, false
	}
	return o.LastTrialGraceEvalTime, true
}
...
// SetLastTrialGraceEvalTime gets a reference to the given time.Time and assigns it to the LastTrialGraceEvalTime field.
func (o *LicenseLicenseInfo) SetLastTrialGraceEvalTime(v time.Time) {
	o.LastTrialGraceEvalTime = &v
}
...
func (o LicenseLicenseInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LastTrialGraceEvalTime) {
		toSerialize["LastTrialGraceEvalTime"] = o.LastTrialGraceEvalTime
	}
...
func (o *LicenseLicenseInfo) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varLicenseLicenseInfo.LastTrialGraceEvalTime = varLicenseLicenseInfoWithoutEmbeddedStruct.LastTrialGraceEvalTime
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "LastTrialGraceEvalTime")
