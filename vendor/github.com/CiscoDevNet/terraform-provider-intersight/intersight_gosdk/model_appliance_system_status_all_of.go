...
// ApplianceSystemStatusAllOf Definition of the list of properties defined in 'appliance.SystemStatus', excluding properties defined in parent classes.
type ApplianceSystemStatusAllOf struct {
	// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
	ClassId string `json:"ClassId"`
	// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
	ObjectType string `json:"ObjectType"`
	// Operational status of the Intersight Appliance. Operational status is based on the result of the status checks. If result of any check is Critical, then its value is Impaired. Otherwise, if result of any check is Warning, then its value is AttentionNeeded. If all checks are OK, then its value is Operational. * `Unknown` - The status of the appliance node is unknown. * `Operational` - The appliance node is operational. * `Impaired` - The appliance node is impaired. * `AttentionNeeded` - The appliance node needs attention. * `ReadyToJoin` - The node is ready to be added to a standalone Intersight Appliance to form a cluster. * `OutOfService` - The user has taken this node (part of a cluster) to out of service. * `ReadyForReplacement` - The cluster node is ready to be replaced.
...
type _ApplianceSystemStatusAllOf ApplianceSystemStatusAllOf
...
func NewApplianceSystemStatusAllOf(classId string, objectType string) *ApplianceSystemStatusAllOf {
	this := ApplianceSystemStatusAllOf{}
...
func (o ApplianceSystemStatusAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceSystemStatusAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceSystemStatusAllOf := _ApplianceSystemStatusAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceSystemStatusAllOf); err == nil {
		*o = ApplianceSystemStatusAllOf(varApplianceSystemStatusAllOf)
	}
...
type NullableApplianceSystemStatusAllOf struct {
	value *ApplianceSystemStatusAllOf
	isSet bool
}

func (v NullableApplianceSystemStatusAllOf) Get() *ApplianceSystemStatusAllOf {
	return v.value
}

func (v *NullableApplianceSystemStatusAllOf) Set(val *ApplianceSystemStatusAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceSystemStatusAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceSystemStatusAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceSystemStatusAllOf(val *ApplianceSystemStatusAllOf) *NullableApplianceSystemStatusAllOf {
	return &NullableApplianceSystemStatusAllOf{value: val, isSet: true}
}

func (v NullableApplianceSystemStatusAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceSystemStatusAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
