...
// checks if the NiatelemetryInterfaceElement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryInterfaceElement{}
...
// GetDefaultClassId returns the default value "niatelemetry.InterfaceElement" of the ClassId field.
func (o *NiatelemetryInterfaceElement) GetDefaultClassId() interface{} {
	return "niatelemetry.InterfaceElement"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.InterfaceElement" of the ObjectType field.
func (o *NiatelemetryInterfaceElement) GetDefaultObjectType() interface{} {
	return "niatelemetry.InterfaceElement"
}
...
func (o NiatelemetryInterfaceElement) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryInterfaceElement) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryInterfaceElementWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryInterfaceElement)
	if err == nil {
