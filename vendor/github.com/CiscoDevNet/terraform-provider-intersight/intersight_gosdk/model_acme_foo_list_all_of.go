...
// AcmeFooListAllOf struct for AcmeFooListAllOf
type AcmeFooListAllOf struct {
...
type _AcmeFooListAllOf AcmeFooListAllOf
...
func (o AcmeFooListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *AcmeFooListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varAcmeFooListAllOf := _AcmeFooListAllOf{}

	if err = json.Unmarshal(bytes, &varAcmeFooListAllOf); err == nil {
		*o = AcmeFooListAllOf(varAcmeFooListAllOf)
	}
...
type NullableAcmeFooListAllOf struct {
	value *AcmeFooListAllOf
	isSet bool
}

func (v NullableAcmeFooListAllOf) Get() *AcmeFooListAllOf {
	return v.value
}

func (v *NullableAcmeFooListAllOf) Set(val *AcmeFooListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAcmeFooListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAcmeFooListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcmeFooListAllOf(val *AcmeFooListAllOf) *NullableAcmeFooListAllOf {
	return &NullableAcmeFooListAllOf{value: val, isSet: true}
}

func (v NullableAcmeFooListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcmeFooListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
