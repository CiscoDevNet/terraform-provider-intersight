...
func (o *TelemetryDruidExtractionFunctionPartial) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidExtractionFunctionPartial := _TelemetryDruidExtractionFunctionPartial{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidExtractionFunctionPartial); err == nil {
