...
// HyperflexConfigResultEntryAllOf Definition of the list of properties defined in 'hyperflex.ConfigResultEntry', excluding properties defined in parent classes.
type HyperflexConfigResultEntryAllOf struct {
...
type _HyperflexConfigResultEntryAllOf HyperflexConfigResultEntryAllOf
...
func NewHyperflexConfigResultEntryAllOf(classId string, objectType string) *HyperflexConfigResultEntryAllOf {
	this := HyperflexConfigResultEntryAllOf{}
...
func (o HyperflexConfigResultEntryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexConfigResultEntryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexConfigResultEntryAllOf := _HyperflexConfigResultEntryAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexConfigResultEntryAllOf); err == nil {
		*o = HyperflexConfigResultEntryAllOf(varHyperflexConfigResultEntryAllOf)
	}
...
type NullableHyperflexConfigResultEntryAllOf struct {
	value *HyperflexConfigResultEntryAllOf
	isSet bool
}

func (v NullableHyperflexConfigResultEntryAllOf) Get() *HyperflexConfigResultEntryAllOf {
	return v.value
}

func (v *NullableHyperflexConfigResultEntryAllOf) Set(val *HyperflexConfigResultEntryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexConfigResultEntryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexConfigResultEntryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexConfigResultEntryAllOf(val *HyperflexConfigResultEntryAllOf) *NullableHyperflexConfigResultEntryAllOf {
	return &NullableHyperflexConfigResultEntryAllOf{value: val, isSet: true}
}

func (v NullableHyperflexConfigResultEntryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexConfigResultEntryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
