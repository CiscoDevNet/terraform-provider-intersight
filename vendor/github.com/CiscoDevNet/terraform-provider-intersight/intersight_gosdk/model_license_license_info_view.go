...
// checks if the LicenseLicenseInfoView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LicenseLicenseInfoView{}

// LicenseLicenseInfoView The LicenseInfoView object provides a custom view for license information, designed to be displayed by user interfaces, enhancing user experience and information accessibility. #### Purpose LicenseInfoView serves as a presentation layer for license information, offering structured views that enhance the user's ability to access and understand licensing data. #### Key Concepts - **Custom View Creation:** Facilitates the creation of tailored views for license information, ensuring data is presented in an accessible and user-friendly manner. - **UI Integration:** Designed for integration with user interfaces, providing seamless access to licensing data. - **Information Accessibility:** Enhances the ability of users to access and interpret license information, supporting informed decision-making. - **Organizational Resource:** Operates within shared organizational contexts, ensuring consistent presentation across different accounts and user roles.
...
// GetDefaultClassId returns the default value "license.LicenseInfoView" of the ClassId field.
func (o *LicenseLicenseInfoView) GetDefaultClassId() interface{} {
	return "license.LicenseInfoView"
}
...
// GetDefaultObjectType returns the default value "license.LicenseInfoView" of the ObjectType field.
func (o *LicenseLicenseInfoView) GetDefaultObjectType() interface{} {
	return "license.LicenseInfoView"
}
...
func (o *LicenseLicenseInfoView) SetAccountLicenseDataNil() {
...
func (o LicenseLicenseInfoView) ToMap() (map[string]interface{}, error) {
...
func (o *LicenseLicenseInfoView) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLicenseLicenseInfoViewWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varLicenseLicenseInfoView)
	if err == nil {
