...
// LicenseIwoCustomerOpListAllOf struct for LicenseIwoCustomerOpListAllOf
type LicenseIwoCustomerOpListAllOf struct {
...
type _LicenseIwoCustomerOpListAllOf LicenseIwoCustomerOpListAllOf
...
func NewLicenseIwoCustomerOpListAllOf() *LicenseIwoCustomerOpListAllOf {
	this := LicenseIwoCustomerOpListAllOf{}
	return &this
}
...
func (o LicenseIwoCustomerOpListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *LicenseIwoCustomerOpListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varLicenseIwoCustomerOpListAllOf := _LicenseIwoCustomerOpListAllOf{}

	if err = json.Unmarshal(bytes, &varLicenseIwoCustomerOpListAllOf); err == nil {
		*o = LicenseIwoCustomerOpListAllOf(varLicenseIwoCustomerOpListAllOf)
	}
...
type NullableLicenseIwoCustomerOpListAllOf struct {
	value *LicenseIwoCustomerOpListAllOf
	isSet bool
}

func (v NullableLicenseIwoCustomerOpListAllOf) Get() *LicenseIwoCustomerOpListAllOf {
	return v.value
}

func (v *NullableLicenseIwoCustomerOpListAllOf) Set(val *LicenseIwoCustomerOpListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableLicenseIwoCustomerOpListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableLicenseIwoCustomerOpListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicenseIwoCustomerOpListAllOf(val *LicenseIwoCustomerOpListAllOf) *NullableLicenseIwoCustomerOpListAllOf {
	return &NullableLicenseIwoCustomerOpListAllOf{value: val, isSet: true}
}

func (v NullableLicenseIwoCustomerOpListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicenseIwoCustomerOpListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
