...
// checks if the InfraHardwareInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfraHardwareInfo{}
...
// GetDefaultClassId returns the default value "infra.HardwareInfo" of the ClassId field.
func (o *InfraHardwareInfo) GetDefaultClassId() interface{} {
	return "infra.HardwareInfo"
}
...
// GetDefaultObjectType returns the default value "infra.HardwareInfo" of the ObjectType field.
func (o *InfraHardwareInfo) GetDefaultObjectType() interface{} {
	return "infra.HardwareInfo"
}
...
func (o InfraHardwareInfo) ToMap() (map[string]interface{}, error) {
...
func (o *InfraHardwareInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varInfraHardwareInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varInfraHardwareInfo)
	if err == nil {
