...
// IaasDiagnosticMessagesListAllOf struct for IaasDiagnosticMessagesListAllOf
type IaasDiagnosticMessagesListAllOf struct {
...
type _IaasDiagnosticMessagesListAllOf IaasDiagnosticMessagesListAllOf
...
func NewIaasDiagnosticMessagesListAllOf() *IaasDiagnosticMessagesListAllOf {
	this := IaasDiagnosticMessagesListAllOf{}
	return &this
}
...
func (o IaasDiagnosticMessagesListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IaasDiagnosticMessagesListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIaasDiagnosticMessagesListAllOf := _IaasDiagnosticMessagesListAllOf{}

	if err = json.Unmarshal(bytes, &varIaasDiagnosticMessagesListAllOf); err == nil {
		*o = IaasDiagnosticMessagesListAllOf(varIaasDiagnosticMessagesListAllOf)
	}
...
type NullableIaasDiagnosticMessagesListAllOf struct {
	value *IaasDiagnosticMessagesListAllOf
	isSet bool
}

func (v NullableIaasDiagnosticMessagesListAllOf) Get() *IaasDiagnosticMessagesListAllOf {
	return v.value
}

func (v *NullableIaasDiagnosticMessagesListAllOf) Set(val *IaasDiagnosticMessagesListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIaasDiagnosticMessagesListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIaasDiagnosticMessagesListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIaasDiagnosticMessagesListAllOf(val *IaasDiagnosticMessagesListAllOf) *NullableIaasDiagnosticMessagesListAllOf {
	return &NullableIaasDiagnosticMessagesListAllOf{value: val, isSet: true}
}

func (v NullableIaasDiagnosticMessagesListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIaasDiagnosticMessagesListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
