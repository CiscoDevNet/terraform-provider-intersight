...
// checks if the NiatelemetryNveVni type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryNveVni{}
...
// GetDefaultClassId returns the default value "niatelemetry.NveVni" of the ClassId field.
func (o *NiatelemetryNveVni) GetDefaultClassId() interface{} {
	return "niatelemetry.NveVni"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.NveVni" of the ObjectType field.
func (o *NiatelemetryNveVni) GetDefaultObjectType() interface{} {
	return "niatelemetry.NveVni"
}
...
func (o NiatelemetryNveVni) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryNveVni) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryNveVniWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryNveVni)
	if err == nil {
