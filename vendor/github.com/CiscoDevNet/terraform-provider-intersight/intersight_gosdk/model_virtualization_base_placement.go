...
// VirtualizationBasePlacement BasePlacement is an abstract base type for all concrete placement types.
...
func (o *VirtualizationBasePlacement) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varVirtualizationBasePlacement.Identity = varVirtualizationBasePlacementWithoutEmbeddedStruct.Identity
