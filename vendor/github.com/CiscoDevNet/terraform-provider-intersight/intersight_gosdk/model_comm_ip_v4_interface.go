...
// checks if the CommIpV4Interface type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommIpV4Interface{}
...
type CommIpV4Interface struct {
	...
	Gateway *string `json:"Gateway,omitempty" validate:"regexp=^$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
	// The IPv4 Address, represented in the standard dot-decimal notation, e.g. 192.168.1.3.
	IpAddress *string `json:"IpAddress,omitempty" validate:"regexp=^$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
...
// GetDefaultClassId returns the default value "comm.IpV4Interface" of the ClassId field.
func (o *CommIpV4Interface) GetDefaultClassId() interface{} {
	return "comm.IpV4Interface"
}
...
// GetDefaultObjectType returns the default value "comm.IpV4Interface" of the ObjectType field.
func (o *CommIpV4Interface) GetDefaultObjectType() interface{} {
	return "comm.IpV4Interface"
}
...
func (o CommIpV4Interface) ToMap() (map[string]interface{}, error) {
...
func (o *CommIpV4Interface) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCommIpV4InterfaceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCommIpV4Interface)
	if err == nil {
