...
// checks if the AssetCustomerInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetCustomerInformation{}
...
// GetDefaultClassId returns the default value "asset.CustomerInformation" of the ClassId field.
func (o *AssetCustomerInformation) GetDefaultClassId() interface{} {
	return "asset.CustomerInformation"
}
...
// GetDefaultObjectType returns the default value "asset.CustomerInformation" of the ObjectType field.
func (o *AssetCustomerInformation) GetDefaultObjectType() interface{} {
	return "asset.CustomerInformation"
}
...
func (o AssetCustomerInformation) ToMap() (map[string]interface{}, error) {
...
func (o *AssetCustomerInformation) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetCustomerInformationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetCustomerInformation)
	if err == nil {
