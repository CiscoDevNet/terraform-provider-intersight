...
// checks if the OauthAuthorizationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthAuthorizationList{}
...
func (o OauthAuthorizationList) ToMap() (map[string]interface{}, error) {
...
func (o *OauthAuthorizationList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOauthAuthorizationListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOauthAuthorizationList)
	if err == nil {
