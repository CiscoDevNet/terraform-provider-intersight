...
// checks if the HyperflexServerModelEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexServerModelEntry{}
...
// GetDefaultClassId returns the default value "hyperflex.ServerModelEntry" of the ClassId field.
func (o *HyperflexServerModelEntry) GetDefaultClassId() interface{} {
	return "hyperflex.ServerModelEntry"
}
...
// GetDefaultObjectType returns the default value "hyperflex.ServerModelEntry" of the ObjectType field.
func (o *HyperflexServerModelEntry) GetDefaultObjectType() interface{} {
	return "hyperflex.ServerModelEntry"
}
...
func (o HyperflexServerModelEntry) ToMap() (map[string]interface{}, error) {
	...
	if errHyperflexAbstractAppSetting != nil {
		return map[string]interface{}{}, errHyperflexAbstractAppSetting
	}
...
func (o *HyperflexServerModelEntry) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexServerModelEntryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexServerModelEntry)
	if err == nil {
