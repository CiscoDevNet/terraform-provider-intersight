...
// NiatelemetryFabricPodProfileListAllOf struct for NiatelemetryFabricPodProfileListAllOf
type NiatelemetryFabricPodProfileListAllOf struct {
...
type _NiatelemetryFabricPodProfileListAllOf NiatelemetryFabricPodProfileListAllOf
...
func NewNiatelemetryFabricPodProfileListAllOf() *NiatelemetryFabricPodProfileListAllOf {
	this := NiatelemetryFabricPodProfileListAllOf{}
	return &this
}
...
func (o NiatelemetryFabricPodProfileListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryFabricPodProfileListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryFabricPodProfileListAllOf := _NiatelemetryFabricPodProfileListAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryFabricPodProfileListAllOf); err == nil {
		*o = NiatelemetryFabricPodProfileListAllOf(varNiatelemetryFabricPodProfileListAllOf)
	}
...
type NullableNiatelemetryFabricPodProfileListAllOf struct {
	value *NiatelemetryFabricPodProfileListAllOf
	isSet bool
}

func (v NullableNiatelemetryFabricPodProfileListAllOf) Get() *NiatelemetryFabricPodProfileListAllOf {
	return v.value
}

func (v *NullableNiatelemetryFabricPodProfileListAllOf) Set(val *NiatelemetryFabricPodProfileListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryFabricPodProfileListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryFabricPodProfileListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryFabricPodProfileListAllOf(val *NiatelemetryFabricPodProfileListAllOf) *NullableNiatelemetryFabricPodProfileListAllOf {
	return &NullableNiatelemetryFabricPodProfileListAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryFabricPodProfileListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryFabricPodProfileListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
