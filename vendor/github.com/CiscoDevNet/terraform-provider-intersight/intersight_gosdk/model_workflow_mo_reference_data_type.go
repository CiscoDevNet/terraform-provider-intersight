...
// checks if the WorkflowMoReferenceDataType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowMoReferenceDataType{}
...
// GetDefaultClassId returns the default value "workflow.MoReferenceDataType" of the ClassId field.
func (o *WorkflowMoReferenceDataType) GetDefaultClassId() interface{} {
	return "workflow.MoReferenceDataType"
}
...
// GetDefaultObjectType returns the default value "workflow.MoReferenceDataType" of the ObjectType field.
func (o *WorkflowMoReferenceDataType) GetDefaultObjectType() interface{} {
	return "workflow.MoReferenceDataType"
}
...
func (o WorkflowMoReferenceDataType) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowMoReferenceDataType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowMoReferenceDataTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowMoReferenceDataType)
	if err == nil {
