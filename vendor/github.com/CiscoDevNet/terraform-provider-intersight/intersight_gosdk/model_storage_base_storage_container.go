...
func (o *StorageBaseStorageContainer) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageBaseStorageContainerWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageBaseStorageContainer)
	if err == nil {
