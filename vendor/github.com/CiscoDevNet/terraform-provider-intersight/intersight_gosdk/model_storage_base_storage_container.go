...
// checks if the StorageBaseStorageContainer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageBaseStorageContainer{}
...
type StorageBaseStorageContainer struct {
	MoBaseMo
...
type _StorageBaseStorageContainer StorageBaseStorageContainer
...
func NewStorageBaseStorageContainer(classId string, objectType string) *StorageBaseStorageContainer {
	this := StorageBaseStorageContainer{}
...
func (o StorageBaseStorageContainer) MarshalJSON() ([]byte, error) {
...
func (o StorageBaseStorageContainer) ToMap() (map[string]interface{}, error) {
...
func (o *StorageBaseStorageContainer) UnmarshalJSON(data []byte) (err error) {
	...
	type StorageBaseStorageContainerWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property. The enum values provides the list of concrete types that can be instantiated from this abstract type.
		ObjectType string `json:"ObjectType"`
	...
	varStorageBaseStorageContainerWithoutEmbeddedStruct := StorageBaseStorageContainerWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varStorageBaseStorageContainerWithoutEmbeddedStruct)
	if err == nil {
		varStorageBaseStorageContainer := _StorageBaseStorageContainer{}
		varStorageBaseStorageContainer.ClassId = varStorageBaseStorageContainerWithoutEmbeddedStruct.ClassId
		varStorageBaseStorageContainer.ObjectType = varStorageBaseStorageContainerWithoutEmbeddedStruct.ObjectType
		varStorageBaseStorageContainer.CreatedTime = varStorageBaseStorageContainerWithoutEmbeddedStruct.CreatedTime
		varStorageBaseStorageContainer.Name = varStorageBaseStorageContainerWithoutEmbeddedStruct.Name
		varStorageBaseStorageContainer.StorageUtilization = varStorageBaseStorageContainerWithoutEmbeddedStruct.StorageUtilization
		*o = StorageBaseStorageContainer(varStorageBaseStorageContainer)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varStorageBaseStorageContainer)
	if err == nil {
		o.MoBaseMo = varStorageBaseStorageContainer.MoBaseMo
	} else {
		return err
	}
...
type NullableStorageBaseStorageContainer struct {
	value *StorageBaseStorageContainer
	isSet bool
}

func (v NullableStorageBaseStorageContainer) Get() *StorageBaseStorageContainer {
	return v.value
}

func (v *NullableStorageBaseStorageContainer) Set(val *StorageBaseStorageContainer) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageBaseStorageContainer) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageBaseStorageContainer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageBaseStorageContainer(val *StorageBaseStorageContainer) *NullableStorageBaseStorageContainer {
	return &NullableStorageBaseStorageContainer{value: val, isSet: true}
}

func (v NullableStorageBaseStorageContainer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageBaseStorageContainer) UnmarshalJSON(src []byte) error {
	v.isSet = true
