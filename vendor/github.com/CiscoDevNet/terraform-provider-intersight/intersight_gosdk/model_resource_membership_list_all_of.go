...
// ResourceMembershipListAllOf struct for ResourceMembershipListAllOf
type ResourceMembershipListAllOf struct {
...
type _ResourceMembershipListAllOf ResourceMembershipListAllOf
...
func NewResourceMembershipListAllOf() *ResourceMembershipListAllOf {
	this := ResourceMembershipListAllOf{}
	return &this
}
...
func (o ResourceMembershipListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ResourceMembershipListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varResourceMembershipListAllOf := _ResourceMembershipListAllOf{}

	if err = json.Unmarshal(bytes, &varResourceMembershipListAllOf); err == nil {
		*o = ResourceMembershipListAllOf(varResourceMembershipListAllOf)
	}
...
type NullableResourceMembershipListAllOf struct {
	value *ResourceMembershipListAllOf
	isSet bool
}

func (v NullableResourceMembershipListAllOf) Get() *ResourceMembershipListAllOf {
	return v.value
}

func (v *NullableResourceMembershipListAllOf) Set(val *ResourceMembershipListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceMembershipListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceMembershipListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceMembershipListAllOf(val *ResourceMembershipListAllOf) *NullableResourceMembershipListAllOf {
	return &NullableResourceMembershipListAllOf{value: val, isSet: true}
}

func (v NullableResourceMembershipListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceMembershipListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
