...
func (o *OsIscsiTarget) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOsIscsiTargetWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varOsIscsiTarget)
	if err == nil {
