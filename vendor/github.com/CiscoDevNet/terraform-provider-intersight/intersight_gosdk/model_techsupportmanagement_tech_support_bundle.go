...
type TechsupportmanagementTechSupportBundle struct {
	...
	PlatformParam NullableMoBaseComplexType `json:"PlatformParam,omitempty"`
...
// GetDefaultClassId returns the default value "techsupportmanagement.TechSupportBundle" of the ClassId field.
func (o *TechsupportmanagementTechSupportBundle) GetDefaultClassId() interface{} {
	return "techsupportmanagement.TechSupportBundle"
}
...
// GetDefaultObjectType returns the default value "techsupportmanagement.TechSupportBundle" of the ObjectType field.
func (o *TechsupportmanagementTechSupportBundle) GetDefaultObjectType() interface{} {
	return "techsupportmanagement.TechSupportBundle"
}
...
// SetPlatformParam gets a reference to the given NullableMoBaseComplexType and assigns it to the PlatformParam field.
