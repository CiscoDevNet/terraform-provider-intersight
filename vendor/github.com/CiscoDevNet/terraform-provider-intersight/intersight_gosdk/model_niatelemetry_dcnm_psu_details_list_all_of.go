...
// NiatelemetryDcnmPsuDetailsListAllOf struct for NiatelemetryDcnmPsuDetailsListAllOf
type NiatelemetryDcnmPsuDetailsListAllOf struct {
...
type _NiatelemetryDcnmPsuDetailsListAllOf NiatelemetryDcnmPsuDetailsListAllOf
...
func NewNiatelemetryDcnmPsuDetailsListAllOf() *NiatelemetryDcnmPsuDetailsListAllOf {
	this := NiatelemetryDcnmPsuDetailsListAllOf{}
	return &this
}
...
func (o NiatelemetryDcnmPsuDetailsListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryDcnmPsuDetailsListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryDcnmPsuDetailsListAllOf := _NiatelemetryDcnmPsuDetailsListAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryDcnmPsuDetailsListAllOf); err == nil {
		*o = NiatelemetryDcnmPsuDetailsListAllOf(varNiatelemetryDcnmPsuDetailsListAllOf)
	}
...
type NullableNiatelemetryDcnmPsuDetailsListAllOf struct {
	value *NiatelemetryDcnmPsuDetailsListAllOf
	isSet bool
}

func (v NullableNiatelemetryDcnmPsuDetailsListAllOf) Get() *NiatelemetryDcnmPsuDetailsListAllOf {
	return v.value
}

func (v *NullableNiatelemetryDcnmPsuDetailsListAllOf) Set(val *NiatelemetryDcnmPsuDetailsListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryDcnmPsuDetailsListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryDcnmPsuDetailsListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryDcnmPsuDetailsListAllOf(val *NiatelemetryDcnmPsuDetailsListAllOf) *NullableNiatelemetryDcnmPsuDetailsListAllOf {
	return &NullableNiatelemetryDcnmPsuDetailsListAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryDcnmPsuDetailsListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryDcnmPsuDetailsListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
