...
// HyperflexVmBackupInfo The VmBackupInfo object is key to managing protected Virtual Machine information for backups within HyperFlex clusters. #### Purpose VmBackupInfo provides detailed insights into the backup status and protection information for Virtual Machines, aiding in the effective management and monitoring of VM backups. #### Key Concepts - **Protection Status:** Offers visibility into the backup and protection status of Virtual Machines. - **Cluster Associations:** Maps VM backup data to cluster IDs, facilitating organized tracking and management of backup operations. - **Privilege Management:** Utilizes privilege sets for controlled access to VM backup information, ensuring data security and compliance.
