...
// checks if the NiaapiDcnmReleaseRecommend type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiDcnmReleaseRecommend{}
...
func NewNiaapiDcnmReleaseRecommend(classId string, objectType string) *NiaapiDcnmReleaseRecommend {
...
func (o NiaapiDcnmReleaseRecommend) ToMap() (map[string]interface{}, error) {
	...
	if errNiaapiReleaseRecommend != nil {
		return map[string]interface{}{}, errNiaapiReleaseRecommend
	}
...
func (o *NiaapiDcnmReleaseRecommend) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiDcnmReleaseRecommendWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiDcnmReleaseRecommend)
	if err == nil {
