...
// checks if the TelemetryDruidRegexSearchSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidRegexSearchSpec{}
...
func (o TelemetryDruidRegexSearchSpec) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidRegexSearchSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidRegexSearchSpec)
