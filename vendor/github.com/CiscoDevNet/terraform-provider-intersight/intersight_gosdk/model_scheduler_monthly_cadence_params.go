...
func (o *SchedulerMonthlyCadenceParams) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSchedulerMonthlyCadenceParamsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSchedulerMonthlyCadenceParams)
	if err == nil {
