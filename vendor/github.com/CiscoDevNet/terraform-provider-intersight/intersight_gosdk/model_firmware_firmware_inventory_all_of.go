...
type _FirmwareFirmwareInventoryAllOf FirmwareFirmwareInventoryAllOf
...
func (o *FirmwareFirmwareInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFirmwareFirmwareInventoryAllOf := _FirmwareFirmwareInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varFirmwareFirmwareInventoryAllOf); err == nil {
		*o = FirmwareFirmwareInventoryAllOf(varFirmwareFirmwareInventoryAllOf)
	}
