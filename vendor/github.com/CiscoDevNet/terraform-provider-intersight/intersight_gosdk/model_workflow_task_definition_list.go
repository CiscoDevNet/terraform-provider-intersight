...
// checks if the WorkflowTaskDefinitionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTaskDefinitionList{}
...
type _WorkflowTaskDefinitionList WorkflowTaskDefinitionList
...
func NewWorkflowTaskDefinitionList(objectType string) *WorkflowTaskDefinitionList {
...
func (o WorkflowTaskDefinitionList) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowTaskDefinitionList) UnmarshalJSON(data []byte) (err error) {
	...
	type WorkflowTaskDefinitionListWithoutEmbeddedStruct struct {
		// The total number of 'workflow.TaskDefinition' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.
		Count *int32 `json:"Count,omitempty"`
		// The array of 'workflow.TaskDefinition' resources matching the request.
		Results []WorkflowTaskDefinition `json:"Results,omitempty"`
	...
	varWorkflowTaskDefinitionListWithoutEmbeddedStruct := WorkflowTaskDefinitionListWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varWorkflowTaskDefinitionListWithoutEmbeddedStruct)
	if err == nil {
		varWorkflowTaskDefinitionList := _WorkflowTaskDefinitionList{}
		varWorkflowTaskDefinitionList.Count = varWorkflowTaskDefinitionListWithoutEmbeddedStruct.Count
		varWorkflowTaskDefinitionList.Results = varWorkflowTaskDefinitionListWithoutEmbeddedStruct.Results
		*o = WorkflowTaskDefinitionList(varWorkflowTaskDefinitionList)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varWorkflowTaskDefinitionList)
	if err == nil {
		o.MoBaseResponse = varWorkflowTaskDefinitionList.MoBaseResponse
	} else {
		return err
	}
