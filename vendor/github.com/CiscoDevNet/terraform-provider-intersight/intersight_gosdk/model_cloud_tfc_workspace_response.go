...
func (dst *CloudTfcWorkspaceResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'cloud.TfcWorkspace.List'
	if jsonDict["ObjectType"] == "cloud.TfcWorkspace.List" {
		// try to unmarshal JSON data into CloudTfcWorkspaceList
		err = json.Unmarshal(data, &dst.CloudTfcWorkspaceList)
		if err == nil {
			return nil // data stored in dst.CloudTfcWorkspaceList, return on the first match
		} else {
			dst.CloudTfcWorkspaceList = nil
			return fmt.Errorf("Failed to unmarshal CloudTfcWorkspaceResponse as CloudTfcWorkspaceList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CloudTfcWorkspaceResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CloudTfcWorkspaceResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CloudTfcWorkspaceResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src CloudTfcWorkspaceResponse) MarshalJSON() ([]byte, error) {
	if src.CloudTfcWorkspaceList != nil {
		return json.Marshal(&src.CloudTfcWorkspaceList)
	}
...
type NullableCloudTfcWorkspaceResponse struct {
	value *CloudTfcWorkspaceResponse
	isSet bool
}

func (v NullableCloudTfcWorkspaceResponse) Get() *CloudTfcWorkspaceResponse {
	return v.value
}

func (v *NullableCloudTfcWorkspaceResponse) Set(val *CloudTfcWorkspaceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudTfcWorkspaceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudTfcWorkspaceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudTfcWorkspaceResponse(val *CloudTfcWorkspaceResponse) *NullableCloudTfcWorkspaceResponse {
	return &NullableCloudTfcWorkspaceResponse{value: val, isSet: true}
}

func (v NullableCloudTfcWorkspaceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudTfcWorkspaceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
