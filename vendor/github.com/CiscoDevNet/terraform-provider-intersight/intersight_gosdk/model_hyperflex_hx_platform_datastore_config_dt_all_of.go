...
func (o *HyperflexHxPlatformDatastoreConfigDtAllOf) GetUsageType() string {
...
// and a boolean to check if the value has been set.
func (o *HyperflexHxPlatformDatastoreConfigDtAllOf) GetUsageTypeOk() (*string, bool) {
	if o == nil || o.UsageType == nil {
		return nil, false
	}
...
func (o *HyperflexHxPlatformDatastoreConfigDtAllOf) HasUsageType() bool {
	if o != nil && o.UsageType != nil {
		return true
	}
...
func (o *HyperflexHxPlatformDatastoreConfigDtAllOf) SetUsageType(v string) {
	o.UsageType = &v
}
