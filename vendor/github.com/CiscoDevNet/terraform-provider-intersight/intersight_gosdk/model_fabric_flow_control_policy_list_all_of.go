...
// FabricFlowControlPolicyListAllOf struct for FabricFlowControlPolicyListAllOf
type FabricFlowControlPolicyListAllOf struct {
...
type _FabricFlowControlPolicyListAllOf FabricFlowControlPolicyListAllOf
...
func NewFabricFlowControlPolicyListAllOf() *FabricFlowControlPolicyListAllOf {
	this := FabricFlowControlPolicyListAllOf{}
	return &this
}
...
func (o FabricFlowControlPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricFlowControlPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricFlowControlPolicyListAllOf := _FabricFlowControlPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varFabricFlowControlPolicyListAllOf); err == nil {
		*o = FabricFlowControlPolicyListAllOf(varFabricFlowControlPolicyListAllOf)
	}
...
type NullableFabricFlowControlPolicyListAllOf struct {
	value *FabricFlowControlPolicyListAllOf
	isSet bool
}

func (v NullableFabricFlowControlPolicyListAllOf) Get() *FabricFlowControlPolicyListAllOf {
	return v.value
}

func (v *NullableFabricFlowControlPolicyListAllOf) Set(val *FabricFlowControlPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricFlowControlPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricFlowControlPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricFlowControlPolicyListAllOf(val *FabricFlowControlPolicyListAllOf) *NullableFabricFlowControlPolicyListAllOf {
	return &NullableFabricFlowControlPolicyListAllOf{value: val, isSet: true}
}

func (v NullableFabricFlowControlPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricFlowControlPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
