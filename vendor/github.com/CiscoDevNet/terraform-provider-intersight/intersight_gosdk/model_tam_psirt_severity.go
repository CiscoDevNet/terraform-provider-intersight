...
// checks if the TamPsirtSeverity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TamPsirtSeverity{}
...
// GetDefaultClassId returns the default value "tam.PsirtSeverity" of the ClassId field.
func (o *TamPsirtSeverity) GetDefaultClassId() interface{} {
	return "tam.PsirtSeverity"
}
...
// GetDefaultObjectType returns the default value "tam.PsirtSeverity" of the ObjectType field.
func (o *TamPsirtSeverity) GetDefaultObjectType() interface{} {
	return "tam.PsirtSeverity"
}
...
func (o TamPsirtSeverity) ToMap() (map[string]interface{}, error) {
...
func (o *TamPsirtSeverity) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTamPsirtSeverityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTamPsirtSeverity)
	if err == nil {
