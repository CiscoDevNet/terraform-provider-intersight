...
func CapabilityIoCardManufacturingDefListAsCapabilityIoCardManufacturingDefResponse(v *CapabilityIoCardManufacturingDefList) CapabilityIoCardManufacturingDefResponse {
	return CapabilityIoCardManufacturingDefResponse{
		CapabilityIoCardManufacturingDefList: v,
	}
}
...
func (dst *CapabilityIoCardManufacturingDefResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "capability.IoCardManufacturingDef.List" {
		// try to unmarshal JSON data into CapabilityIoCardManufacturingDefList
		err = json.Unmarshal(data, &dst.CapabilityIoCardManufacturingDefList)
		if err == nil {
			return nil // data stored in dst.CapabilityIoCardManufacturingDefList, return on the first match
		} else {
			dst.CapabilityIoCardManufacturingDefList = nil
			return fmt.Errorf("Failed to unmarshal CapabilityIoCardManufacturingDefResponse as CapabilityIoCardManufacturingDefList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilityIoCardManufacturingDefResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilityIoCardManufacturingDefResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal CapabilityIoCardManufacturingDefResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src CapabilityIoCardManufacturingDefResponse) MarshalJSON() ([]byte, error) {
	if src.CapabilityIoCardManufacturingDefList != nil {
		return json.Marshal(&src.CapabilityIoCardManufacturingDefList)
	}
...
type NullableCapabilityIoCardManufacturingDefResponse struct {
	value *CapabilityIoCardManufacturingDefResponse
	isSet bool
}

func (v NullableCapabilityIoCardManufacturingDefResponse) Get() *CapabilityIoCardManufacturingDefResponse {
	return v.value
}

func (v *NullableCapabilityIoCardManufacturingDefResponse) Set(val *CapabilityIoCardManufacturingDefResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityIoCardManufacturingDefResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityIoCardManufacturingDefResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityIoCardManufacturingDefResponse(val *CapabilityIoCardManufacturingDefResponse) *NullableCapabilityIoCardManufacturingDefResponse {
	return &NullableCapabilityIoCardManufacturingDefResponse{value: val, isSet: true}
}

func (v NullableCapabilityIoCardManufacturingDefResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityIoCardManufacturingDefResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
