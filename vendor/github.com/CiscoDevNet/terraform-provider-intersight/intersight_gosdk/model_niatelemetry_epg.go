...
type NiatelemetryEpg struct {
	...
	// Number of static path Attachments.
	StaticPathAttachmentCount *int64 `json:"StaticPathAttachmentCount,omitempty"`
...
// GetStaticPathAttachmentCount returns the StaticPathAttachmentCount field value if set, zero value otherwise.
func (o *NiatelemetryEpg) GetStaticPathAttachmentCount() int64 {
	if o == nil || o.StaticPathAttachmentCount == nil {
		var ret int64
		return ret
	}
	return *o.StaticPathAttachmentCount
}

// GetStaticPathAttachmentCountOk returns a tuple with the StaticPathAttachmentCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NiatelemetryEpg) GetStaticPathAttachmentCountOk() (*int64, bool) {
	if o == nil || o.StaticPathAttachmentCount == nil {
		return nil, false
	}
	return o.StaticPathAttachmentCount, true
}
...
// SetStaticPathAttachmentCount gets a reference to the given int64 and assigns it to the StaticPathAttachmentCount field.
func (o *NiatelemetryEpg) SetStaticPathAttachmentCount(v int64) {
	o.StaticPathAttachmentCount = &v
}
...
func (o NiatelemetryEpg) MarshalJSON() ([]byte, error) {
	...
	if o.StaticPathAttachmentCount != nil {
		toSerialize["StaticPathAttachmentCount"] = o.StaticPathAttachmentCount
	}
...
func (o *NiatelemetryEpg) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varNiatelemetryEpg.StaticPathAttachmentCount = varNiatelemetryEpgWithoutEmbeddedStruct.StaticPathAttachmentCount
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "StaticPathAttachmentCount")
