...
// checks if the PoolAbstractBlockLease type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolAbstractBlockLease{}
...
func (o *PoolAbstractBlockLease) GetDefaultClassId() interface{} {
...
func (o *PoolAbstractBlockLease) GetDefaultObjectType() interface{} {
	return "ippool.BlockLease"
}
...
func (o PoolAbstractBlockLease) ToMap() (map[string]interface{}, error) {
...
func (o *PoolAbstractBlockLease) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPoolAbstractBlockLeaseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varPoolAbstractBlockLease)
	if err == nil {
