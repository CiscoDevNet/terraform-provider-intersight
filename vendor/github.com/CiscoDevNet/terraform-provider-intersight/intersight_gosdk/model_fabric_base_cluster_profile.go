...
func (o *FabricBaseClusterProfile) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFabricBaseClusterProfileWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFabricBaseClusterProfile)
	if err == nil {
