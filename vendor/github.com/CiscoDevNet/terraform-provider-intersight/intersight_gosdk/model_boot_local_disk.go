...
type BootLocalDisk struct {
	...
	Slot                 *string `json:"Slot,omitempty" validate:"regexp=^$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|20[0-5]|M|HBA|SAS|MRAID|RAID|MRAID1|MRAID2|MSTOR-RAID|FMEZZ1-SAS|MSTOR-RAID-1|MSTOR-RAID-2|LOM-NIC-1)$"`
...
// GetDefaultClassId returns the default value "boot.LocalDisk" of the ClassId field.
func (o *BootLocalDisk) GetDefaultClassId() interface{} {
	return "boot.LocalDisk"
}
...
// GetDefaultObjectType returns the default value "boot.LocalDisk" of the ObjectType field.
func (o *BootLocalDisk) GetDefaultObjectType() interface{} {
	return "boot.LocalDisk"
}
