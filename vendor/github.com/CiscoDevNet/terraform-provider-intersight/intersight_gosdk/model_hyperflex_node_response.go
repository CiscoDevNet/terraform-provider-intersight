...
func (dst *HyperflexNodeResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'hyperflex.Node.List'
	if jsonDict["ObjectType"] == "hyperflex.Node.List" {
		// try to unmarshal JSON data into HyperflexNodeList
		err = json.Unmarshal(data, &dst.HyperflexNodeList)
		if err == nil {
			return nil // data stored in dst.HyperflexNodeList, return on the first match
		} else {
			dst.HyperflexNodeList = nil
			return fmt.Errorf("Failed to unmarshal HyperflexNodeResponse as HyperflexNodeList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexNodeResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexNodeResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexNodeResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src HyperflexNodeResponse) MarshalJSON() ([]byte, error) {
	if src.HyperflexNodeList != nil {
		return json.Marshal(&src.HyperflexNodeList)
	}
...
type NullableHyperflexNodeResponse struct {
	value *HyperflexNodeResponse
	isSet bool
}

func (v NullableHyperflexNodeResponse) Get() *HyperflexNodeResponse {
	return v.value
}

func (v *NullableHyperflexNodeResponse) Set(val *HyperflexNodeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexNodeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexNodeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexNodeResponse(val *HyperflexNodeResponse) *NullableHyperflexNodeResponse {
	return &NullableHyperflexNodeResponse{value: val, isSet: true}
}

func (v NullableHyperflexNodeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexNodeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
