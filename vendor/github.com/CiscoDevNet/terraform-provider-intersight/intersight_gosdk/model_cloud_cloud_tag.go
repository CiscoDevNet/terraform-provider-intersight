...
// checks if the CloudCloudTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCloudTag{}
...
func (o CloudCloudTag) ToMap() (map[string]interface{}, error) {
...
func (o *CloudCloudTag) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCloudCloudTagWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCloudCloudTag)
	if err == nil {
