...
// ApplianceBackupRotateDataAllOf Definition of the list of properties defined in 'appliance.BackupRotateData', excluding properties defined in parent classes.
type ApplianceBackupRotateDataAllOf struct {
...
type _ApplianceBackupRotateDataAllOf ApplianceBackupRotateDataAllOf
...
func NewApplianceBackupRotateDataAllOf(classId string, objectType string) *ApplianceBackupRotateDataAllOf {
	this := ApplianceBackupRotateDataAllOf{}
...
func (o ApplianceBackupRotateDataAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceBackupRotateDataAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceBackupRotateDataAllOf := _ApplianceBackupRotateDataAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceBackupRotateDataAllOf); err == nil {
		*o = ApplianceBackupRotateDataAllOf(varApplianceBackupRotateDataAllOf)
	}
...
type NullableApplianceBackupRotateDataAllOf struct {
	value *ApplianceBackupRotateDataAllOf
	isSet bool
}

func (v NullableApplianceBackupRotateDataAllOf) Get() *ApplianceBackupRotateDataAllOf {
	return v.value
}

func (v *NullableApplianceBackupRotateDataAllOf) Set(val *ApplianceBackupRotateDataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceBackupRotateDataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceBackupRotateDataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceBackupRotateDataAllOf(val *ApplianceBackupRotateDataAllOf) *NullableApplianceBackupRotateDataAllOf {
	return &NullableApplianceBackupRotateDataAllOf{value: val, isSet: true}
}

func (v NullableApplianceBackupRotateDataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceBackupRotateDataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
