...
func (o *NiatelemetryApicSysLogGrp) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryApicSysLogGrpWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryApicSysLogGrp)
	if err == nil {
