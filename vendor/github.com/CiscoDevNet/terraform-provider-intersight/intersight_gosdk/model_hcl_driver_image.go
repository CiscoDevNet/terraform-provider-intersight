...
type HclDriverImage struct {
	...
	// Type of the UCS version indicating whether it is a UCSM release vesion or a IMC release. * `UCSM` - The server is managed by UCS Manager. * `IMC` - The server is standalone managed by CIMC. * `IMM` - The server is standalone managed by Intersight.
...
// GetDefaultClassId returns the default value "hcl.DriverImage" of the ClassId field.
func (o *HclDriverImage) GetDefaultClassId() interface{} {
	return "hcl.DriverImage"
}
...
// GetDefaultObjectType returns the default value "hcl.DriverImage" of the ObjectType field.
func (o *HclDriverImage) GetDefaultObjectType() interface{} {
	return "hcl.DriverImage"
}
