...
func (o *ApplianceDeviceUpgradePolicyList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varApplianceDeviceUpgradePolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varApplianceDeviceUpgradePolicyList)
	if err == nil {
