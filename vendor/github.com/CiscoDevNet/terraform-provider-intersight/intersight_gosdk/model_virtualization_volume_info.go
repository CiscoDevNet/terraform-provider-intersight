...
func (o *VirtualizationVolumeInfo) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVirtualizationVolumeInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVirtualizationVolumeInfo)
	if err == nil {
