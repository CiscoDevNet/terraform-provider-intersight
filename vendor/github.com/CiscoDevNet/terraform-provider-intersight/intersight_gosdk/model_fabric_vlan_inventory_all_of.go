...
// FabricVlanInventoryAllOf Definition of the list of properties defined in 'fabric.VlanInventory', excluding properties defined in parent classes.
type FabricVlanInventoryAllOf struct {
...
type _FabricVlanInventoryAllOf FabricVlanInventoryAllOf
...
func (o FabricVlanInventoryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricVlanInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricVlanInventoryAllOf := _FabricVlanInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varFabricVlanInventoryAllOf); err == nil {
		*o = FabricVlanInventoryAllOf(varFabricVlanInventoryAllOf)
	}
...
type NullableFabricVlanInventoryAllOf struct {
	value *FabricVlanInventoryAllOf
	isSet bool
}

func (v NullableFabricVlanInventoryAllOf) Get() *FabricVlanInventoryAllOf {
	return v.value
}

func (v *NullableFabricVlanInventoryAllOf) Set(val *FabricVlanInventoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricVlanInventoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricVlanInventoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricVlanInventoryAllOf(val *FabricVlanInventoryAllOf) *NullableFabricVlanInventoryAllOf {
	return &NullableFabricVlanInventoryAllOf{value: val, isSet: true}
}

func (v NullableFabricVlanInventoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricVlanInventoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
