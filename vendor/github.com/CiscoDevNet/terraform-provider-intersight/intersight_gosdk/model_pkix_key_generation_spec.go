...
// checks if the PkixKeyGenerationSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PkixKeyGenerationSpec{}
...
func (o PkixKeyGenerationSpec) ToMap() (map[string]interface{}, error) {
...
func (o *PkixKeyGenerationSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPkixKeyGenerationSpecWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varPkixKeyGenerationSpec)
	if err == nil {
