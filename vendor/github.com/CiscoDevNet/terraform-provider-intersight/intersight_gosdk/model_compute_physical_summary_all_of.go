...
type _ComputePhysicalSummaryAllOf ComputePhysicalSummaryAllOf
...
func (o *ComputePhysicalSummaryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varComputePhysicalSummaryAllOf := _ComputePhysicalSummaryAllOf{}

	if err = json.Unmarshal(bytes, &varComputePhysicalSummaryAllOf); err == nil {
		*o = ComputePhysicalSummaryAllOf(varComputePhysicalSummaryAllOf)
	}
