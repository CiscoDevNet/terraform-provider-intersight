...
func WorkflowAnsibleBatchExecutorListAsWorkflowAnsibleBatchExecutorResponse(v *WorkflowAnsibleBatchExecutorList) WorkflowAnsibleBatchExecutorResponse {
	return WorkflowAnsibleBatchExecutorResponse{
		WorkflowAnsibleBatchExecutorList: v,
	}
}
...
func (dst *WorkflowAnsibleBatchExecutorResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowAnsibleBatchExecutorResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowAnsibleBatchExecutorResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowAnsibleBatchExecutorResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'workflow.AnsibleBatchExecutor.List'
	if jsonDict["ObjectType"] == "workflow.AnsibleBatchExecutor.List" {
		// try to unmarshal JSON data into WorkflowAnsibleBatchExecutorList
		err = json.Unmarshal(data, &dst.WorkflowAnsibleBatchExecutorList)
		if err == nil {
			return nil // data stored in dst.WorkflowAnsibleBatchExecutorList, return on the first match
		} else {
			dst.WorkflowAnsibleBatchExecutorList = nil
			return fmt.Errorf("failed to unmarshal WorkflowAnsibleBatchExecutorResponse as WorkflowAnsibleBatchExecutorList: %s", err.Error())
		}
	}
...
func (src WorkflowAnsibleBatchExecutorResponse) MarshalJSON() ([]byte, error) {
	...
	if src.WorkflowAnsibleBatchExecutorList != nil {
		return json.Marshal(&src.WorkflowAnsibleBatchExecutorList)
	}
...
func (obj *WorkflowAnsibleBatchExecutorResponse) GetActualInstance() interface{} {
	...
	if obj.WorkflowAnsibleBatchExecutorList != nil {
		return obj.WorkflowAnsibleBatchExecutorList
	}
...
type NullableWorkflowAnsibleBatchExecutorResponse struct {
	value *WorkflowAnsibleBatchExecutorResponse
	isSet bool
}

func (v NullableWorkflowAnsibleBatchExecutorResponse) Get() *WorkflowAnsibleBatchExecutorResponse {
	return v.value
}

func (v *NullableWorkflowAnsibleBatchExecutorResponse) Set(val *WorkflowAnsibleBatchExecutorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowAnsibleBatchExecutorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowAnsibleBatchExecutorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowAnsibleBatchExecutorResponse(val *WorkflowAnsibleBatchExecutorResponse) *NullableWorkflowAnsibleBatchExecutorResponse {
	return &NullableWorkflowAnsibleBatchExecutorResponse{value: val, isSet: true}
}

func (v NullableWorkflowAnsibleBatchExecutorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowAnsibleBatchExecutorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
