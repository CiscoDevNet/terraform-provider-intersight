...
func (o *SoftwareHclMetaList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSoftwareHclMetaListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSoftwareHclMetaList)
	if err == nil {
