...
func (o *PartnerintegrationModel) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varPartnerintegrationModelWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varPartnerintegrationModel)
	if err == nil {
