...
type ServerServerAssignTypeSlot struct {
	...
	// The domain name of the Fabric Interconnect or the chassis name prefix. The name must start and end with an alphanumeric character, can include underscores and hyphens, and has a maximum length of 30 characters.
