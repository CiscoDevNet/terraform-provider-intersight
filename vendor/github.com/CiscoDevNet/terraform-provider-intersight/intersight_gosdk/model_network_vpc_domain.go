...
type _NetworkVpcDomain NetworkVpcDomain
...
// GetDefaultClassId returns the default value "network.VpcDomain" of the ClassId field.
func (o *NetworkVpcDomain) GetDefaultClassId() interface{} {
	return "network.VpcDomain"
}
...
// GetDefaultObjectType returns the default value "network.VpcDomain" of the ObjectType field.
func (o *NetworkVpcDomain) GetDefaultObjectType() interface{} {
	return "network.VpcDomain"
}
...
func (o *NetworkVpcDomain) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varNetworkVpcDomain.ObjectType = varNetworkVpcDomainWithoutEmbeddedStruct.ObjectType
		varNetworkVpcDomain.AutoRecoveryStatus = varNetworkVpcDomainWithoutEmbeddedStruct.AutoRecoveryStatus
		varNetworkVpcDomain.ConsistencyStatus = varNetworkVpcDomainWithoutEmbeddedStruct.ConsistencyStatus
		varNetworkVpcDomain.DualActiveExcludedVlans = varNetworkVpcDomainWithoutEmbeddedStruct.DualActiveExcludedVlans
		varNetworkVpcDomain.KeepAliveStatus = varNetworkVpcDomainWithoutEmbeddedStruct.KeepAliveStatus
		varNetworkVpcDomain.PeerStatus = varNetworkVpcDomainWithoutEmbeddedStruct.PeerStatus
		varNetworkVpcDomain.Role = varNetworkVpcDomainWithoutEmbeddedStruct.Role
		varNetworkVpcDomain.VpcDomainId = varNetworkVpcDomainWithoutEmbeddedStruct.VpcDomainId
		varNetworkVpcDomain.VpcsConfiguredCount = varNetworkVpcDomainWithoutEmbeddedStruct.VpcsConfiguredCount
		varNetworkVpcDomain.NetworkElement = varNetworkVpcDomainWithoutEmbeddedStruct.NetworkElement
		varNetworkVpcDomain.RegisteredDevice = varNetworkVpcDomainWithoutEmbeddedStruct.RegisteredDevice
		*o = NetworkVpcDomain(varNetworkVpcDomain)
	} else {
		return err
	}
...
type NullableNetworkVpcDomain struct {
	value *NetworkVpcDomain
	isSet bool
}

func (v NullableNetworkVpcDomain) Get() *NetworkVpcDomain {
	return v.value
}

func (v *NullableNetworkVpcDomain) Set(val *NetworkVpcDomain) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkVpcDomain) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkVpcDomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkVpcDomain(val *NetworkVpcDomain) *NullableNetworkVpcDomain {
	return &NullableNetworkVpcDomain{value: val, isSet: true}
}

func (v NullableNetworkVpcDomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkVpcDomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
