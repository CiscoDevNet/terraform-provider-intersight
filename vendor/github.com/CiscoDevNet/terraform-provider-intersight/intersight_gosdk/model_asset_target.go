...
func (o *AssetTarget) SetAssignedLocationNil() {
...
func (o *AssetTarget) SetReservationNil() {
...
func (o *AssetTarget) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varAssetTarget.AssignedLocation = varAssetTargetWithoutEmbeddedStruct.AssignedLocation
		...
		varAssetTarget.Reservation = varAssetTargetWithoutEmbeddedStruct.Reservation
