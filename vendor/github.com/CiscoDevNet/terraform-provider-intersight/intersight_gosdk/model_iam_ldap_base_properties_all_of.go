...
type _IamLdapBasePropertiesAllOf IamLdapBasePropertiesAllOf
...
func (o *IamLdapBasePropertiesAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamLdapBasePropertiesAllOf := _IamLdapBasePropertiesAllOf{}

	if err = json.Unmarshal(bytes, &varIamLdapBasePropertiesAllOf); err == nil {
		*o = IamLdapBasePropertiesAllOf(varIamLdapBasePropertiesAllOf)
	}
