...
// checks if the NiaapiFileDownloader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiFileDownloader{}

// NiaapiFileDownloader The FileDownloader object is pivotal in file management, providing presigned URLs for downloading metadata files from servers. It ensures users have efficient access to required data. #### Purpose FileDownloader offers presigned URLs for secure and efficient download of metadata files, supporting users in accessing necessary information for their systems. #### Key Concepts - **Secure Access:** Provides presigned URLs for metadata file downloads, ensuring secure and reliable access. - **Efficient Download:** Facilitates the retrieval of metadata files, supporting users in accessing required data quickly. - **System Integration:** Ensures seamless integration with systems for efficient data management and access.
...
// GetDefaultClassId returns the default value "niaapi.FileDownloader" of the ClassId field.
func (o *NiaapiFileDownloader) GetDefaultClassId() interface{} {
	return "niaapi.FileDownloader"
}
...
// GetDefaultObjectType returns the default value "niaapi.FileDownloader" of the ObjectType field.
func (o *NiaapiFileDownloader) GetDefaultObjectType() interface{} {
	return "niaapi.FileDownloader"
}
...
func (o NiaapiFileDownloader) ToMap() (map[string]interface{}, error) {
...
func (o *NiaapiFileDownloader) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiFileDownloaderWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiFileDownloader)
	if err == nil {
