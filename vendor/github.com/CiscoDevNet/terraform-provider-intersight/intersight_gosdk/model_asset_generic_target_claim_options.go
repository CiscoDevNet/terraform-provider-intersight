...
func (o *AssetGenericTargetClaimOptions) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAssetGenericTargetClaimOptionsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varAssetGenericTargetClaimOptions)
	if err == nil {
