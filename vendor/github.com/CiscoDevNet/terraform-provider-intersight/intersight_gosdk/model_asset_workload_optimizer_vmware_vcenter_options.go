...
// GetDefaultClassId returns the default value "asset.WorkloadOptimizerVmwareVcenterOptions" of the ClassId field.
func (o *AssetWorkloadOptimizerVmwareVcenterOptions) GetDefaultClassId() interface{} {
	return "asset.WorkloadOptimizerVmwareVcenterOptions"
}
...
// GetDefaultObjectType returns the default value "asset.WorkloadOptimizerVmwareVcenterOptions" of the ObjectType field.
func (o *AssetWorkloadOptimizerVmwareVcenterOptions) GetDefaultObjectType() interface{} {
	return "asset.WorkloadOptimizerVmwareVcenterOptions"
}
...
func (o *AssetWorkloadOptimizerVmwareVcenterOptions) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varAssetWorkloadOptimizerVmwareVcenterOptions.GuestMetricsEnabled = varAssetWorkloadOptimizerVmwareVcenterOptionsWithoutEmbeddedStruct.GuestMetricsEnabled
