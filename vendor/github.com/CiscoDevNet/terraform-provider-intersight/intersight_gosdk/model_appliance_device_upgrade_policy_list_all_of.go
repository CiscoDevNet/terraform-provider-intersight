...
// ApplianceDeviceUpgradePolicyListAllOf struct for ApplianceDeviceUpgradePolicyListAllOf
type ApplianceDeviceUpgradePolicyListAllOf struct {
...
type _ApplianceDeviceUpgradePolicyListAllOf ApplianceDeviceUpgradePolicyListAllOf
...
func NewApplianceDeviceUpgradePolicyListAllOf() *ApplianceDeviceUpgradePolicyListAllOf {
	this := ApplianceDeviceUpgradePolicyListAllOf{}
	return &this
}
...
func (o ApplianceDeviceUpgradePolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceDeviceUpgradePolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceDeviceUpgradePolicyListAllOf := _ApplianceDeviceUpgradePolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceDeviceUpgradePolicyListAllOf); err == nil {
		*o = ApplianceDeviceUpgradePolicyListAllOf(varApplianceDeviceUpgradePolicyListAllOf)
	}
...
type NullableApplianceDeviceUpgradePolicyListAllOf struct {
	value *ApplianceDeviceUpgradePolicyListAllOf
	isSet bool
}

func (v NullableApplianceDeviceUpgradePolicyListAllOf) Get() *ApplianceDeviceUpgradePolicyListAllOf {
	return v.value
}

func (v *NullableApplianceDeviceUpgradePolicyListAllOf) Set(val *ApplianceDeviceUpgradePolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceDeviceUpgradePolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceDeviceUpgradePolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceDeviceUpgradePolicyListAllOf(val *ApplianceDeviceUpgradePolicyListAllOf) *NullableApplianceDeviceUpgradePolicyListAllOf {
	return &NullableApplianceDeviceUpgradePolicyListAllOf{value: val, isSet: true}
}

func (v NullableApplianceDeviceUpgradePolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceDeviceUpgradePolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
