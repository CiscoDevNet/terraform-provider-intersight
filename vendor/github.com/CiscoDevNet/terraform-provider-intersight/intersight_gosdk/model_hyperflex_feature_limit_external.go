...
// checks if the HyperflexFeatureLimitExternal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexFeatureLimitExternal{}
...
// GetDefaultClassId returns the default value "hyperflex.FeatureLimitExternal" of the ClassId field.
func (o *HyperflexFeatureLimitExternal) GetDefaultClassId() interface{} {
	return "hyperflex.FeatureLimitExternal"
}
...
// GetDefaultObjectType returns the default value "hyperflex.FeatureLimitExternal" of the ObjectType field.
func (o *HyperflexFeatureLimitExternal) GetDefaultObjectType() interface{} {
	return "hyperflex.FeatureLimitExternal"
}
...
func (o HyperflexFeatureLimitExternal) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexFeatureLimitExternal) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexFeatureLimitExternalWithoutEmbeddedStruct)
	if err == nil {
		varHyperflexFeatureLimitExternal := _HyperflexFeatureLimitExternal{}
		varHyperflexFeatureLimitExternal.ClassId = varHyperflexFeatureLimitExternalWithoutEmbeddedStruct.ClassId
		varHyperflexFeatureLimitExternal.ObjectType = varHyperflexFeatureLimitExternalWithoutEmbeddedStruct.ObjectType
	...
	err = json.Unmarshal(data, &varHyperflexFeatureLimitExternal)
	if err == nil {
