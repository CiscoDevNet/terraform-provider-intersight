...
// checks if the TelemetryDruidIntervalResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidIntervalResult{}

// TelemetryDruidIntervalResult The time series results for a particular interval
...
type _TelemetryDruidIntervalResult TelemetryDruidIntervalResult
...
func (o TelemetryDruidIntervalResult) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidIntervalResult) UnmarshalJSON(data []byte) (err error) {
	varTelemetryDruidIntervalResult := _TelemetryDruidIntervalResult{}

	err = json.Unmarshal(data, &varTelemetryDruidIntervalResult)

	if err != nil {
		return err
	}

	*o = TelemetryDruidIntervalResult(varTelemetryDruidIntervalResult)
