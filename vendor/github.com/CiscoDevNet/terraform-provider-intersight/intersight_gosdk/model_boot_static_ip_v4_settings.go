...
func (o *BootStaticIpV4Settings) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varBootStaticIpV4SettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varBootStaticIpV4Settings)
	if err == nil {
