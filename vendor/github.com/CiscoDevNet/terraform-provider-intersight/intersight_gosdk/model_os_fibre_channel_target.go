...
// checks if the OsFibreChannelTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsFibreChannelTarget{}
...
// GetDefaultClassId returns the default value "os.FibreChannelTarget" of the ClassId field.
func (o *OsFibreChannelTarget) GetDefaultClassId() interface{} {
	return "os.FibreChannelTarget"
}
...
// GetDefaultObjectType returns the default value "os.FibreChannelTarget" of the ObjectType field.
func (o *OsFibreChannelTarget) GetDefaultObjectType() interface{} {
	return "os.FibreChannelTarget"
}
...
func (o OsFibreChannelTarget) ToMap() (map[string]interface{}, error) {
...
func (o *OsFibreChannelTarget) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsFibreChannelTargetWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsFibreChannelTarget)
	if err == nil {
