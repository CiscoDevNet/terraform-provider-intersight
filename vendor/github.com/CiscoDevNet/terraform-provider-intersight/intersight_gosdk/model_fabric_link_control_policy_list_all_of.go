...
// FabricLinkControlPolicyListAllOf struct for FabricLinkControlPolicyListAllOf
type FabricLinkControlPolicyListAllOf struct {
...
type _FabricLinkControlPolicyListAllOf FabricLinkControlPolicyListAllOf
...
func NewFabricLinkControlPolicyListAllOf() *FabricLinkControlPolicyListAllOf {
	this := FabricLinkControlPolicyListAllOf{}
	return &this
}
...
func (o FabricLinkControlPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricLinkControlPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricLinkControlPolicyListAllOf := _FabricLinkControlPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varFabricLinkControlPolicyListAllOf); err == nil {
		*o = FabricLinkControlPolicyListAllOf(varFabricLinkControlPolicyListAllOf)
	}
...
type NullableFabricLinkControlPolicyListAllOf struct {
	value *FabricLinkControlPolicyListAllOf
	isSet bool
}

func (v NullableFabricLinkControlPolicyListAllOf) Get() *FabricLinkControlPolicyListAllOf {
	return v.value
}

func (v *NullableFabricLinkControlPolicyListAllOf) Set(val *FabricLinkControlPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricLinkControlPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricLinkControlPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricLinkControlPolicyListAllOf(val *FabricLinkControlPolicyListAllOf) *NullableFabricLinkControlPolicyListAllOf {
	return &NullableFabricLinkControlPolicyListAllOf{value: val, isSet: true}
}

func (v NullableFabricLinkControlPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricLinkControlPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
