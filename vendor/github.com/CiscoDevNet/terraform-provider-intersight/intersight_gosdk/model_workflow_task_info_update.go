...
func (o *WorkflowTaskInfoUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varWorkflowTaskInfoUpdateWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varWorkflowTaskInfoUpdate)
	if err == nil {
