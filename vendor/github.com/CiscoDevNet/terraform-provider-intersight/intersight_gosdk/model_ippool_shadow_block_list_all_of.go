...
// IppoolShadowBlockListAllOf struct for IppoolShadowBlockListAllOf
type IppoolShadowBlockListAllOf struct {
...
type _IppoolShadowBlockListAllOf IppoolShadowBlockListAllOf
...
func NewIppoolShadowBlockListAllOf() *IppoolShadowBlockListAllOf {
	this := IppoolShadowBlockListAllOf{}
	return &this
}
...
func (o IppoolShadowBlockListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IppoolShadowBlockListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIppoolShadowBlockListAllOf := _IppoolShadowBlockListAllOf{}

	if err = json.Unmarshal(bytes, &varIppoolShadowBlockListAllOf); err == nil {
		*o = IppoolShadowBlockListAllOf(varIppoolShadowBlockListAllOf)
	}
...
type NullableIppoolShadowBlockListAllOf struct {
	value *IppoolShadowBlockListAllOf
	isSet bool
}

func (v NullableIppoolShadowBlockListAllOf) Get() *IppoolShadowBlockListAllOf {
	return v.value
}

func (v *NullableIppoolShadowBlockListAllOf) Set(val *IppoolShadowBlockListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIppoolShadowBlockListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIppoolShadowBlockListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIppoolShadowBlockListAllOf(val *IppoolShadowBlockListAllOf) *NullableIppoolShadowBlockListAllOf {
	return &NullableIppoolShadowBlockListAllOf{value: val, isSet: true}
}

func (v NullableIppoolShadowBlockListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIppoolShadowBlockListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
