...
// checks if the BiosBootDeviceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BiosBootDeviceList{}
...
func NewBiosBootDeviceList(objectType string) *BiosBootDeviceList {
...
func (o BiosBootDeviceList) ToMap() (map[string]interface{}, error) {
...
func (o *BiosBootDeviceList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBiosBootDeviceListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBiosBootDeviceList)
	if err == nil {
