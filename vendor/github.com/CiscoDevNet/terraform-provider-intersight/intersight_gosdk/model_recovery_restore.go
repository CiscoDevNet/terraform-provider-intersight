...
type RecoveryRestore struct {
	...
	ConfigParams         NullableMoBaseComplexType                      `json:"ConfigParams,omitempty"`
...
// SetConfigParams gets a reference to the given NullableMoBaseComplexType and assigns it to the ConfigParams field.
