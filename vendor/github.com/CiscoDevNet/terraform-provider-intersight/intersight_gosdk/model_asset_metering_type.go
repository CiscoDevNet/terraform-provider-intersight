...
// checks if the AssetMeteringType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetMeteringType{}
...
// GetDefaultClassId returns the default value "asset.MeteringType" of the ClassId field.
func (o *AssetMeteringType) GetDefaultClassId() interface{} {
	return "asset.MeteringType"
}
...
// GetDefaultObjectType returns the default value "asset.MeteringType" of the ObjectType field.
func (o *AssetMeteringType) GetDefaultObjectType() interface{} {
	return "asset.MeteringType"
}
...
func (o AssetMeteringType) ToMap() (map[string]interface{}, error) {
...
func (o *AssetMeteringType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetMeteringTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetMeteringType)
	if err == nil {
