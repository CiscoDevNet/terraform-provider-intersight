...
// NetworkVrfListAllOf struct for NetworkVrfListAllOf
type NetworkVrfListAllOf struct {
...
type _NetworkVrfListAllOf NetworkVrfListAllOf
...
func (o NetworkVrfListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NetworkVrfListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNetworkVrfListAllOf := _NetworkVrfListAllOf{}

	if err = json.Unmarshal(bytes, &varNetworkVrfListAllOf); err == nil {
		*o = NetworkVrfListAllOf(varNetworkVrfListAllOf)
	}
...
type NullableNetworkVrfListAllOf struct {
	value *NetworkVrfListAllOf
	isSet bool
}

func (v NullableNetworkVrfListAllOf) Get() *NetworkVrfListAllOf {
	return v.value
}

func (v *NullableNetworkVrfListAllOf) Set(val *NetworkVrfListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkVrfListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkVrfListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkVrfListAllOf(val *NetworkVrfListAllOf) *NullableNetworkVrfListAllOf {
	return &NullableNetworkVrfListAllOf{value: val, isSet: true}
}

func (v NullableNetworkVrfListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkVrfListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
