...
type SchedulerRecurringScheduleParams struct {
	...
	Params               NullableMoBaseComplexType `json:"Params,omitempty"`
...
// SetParams gets a reference to the given NullableMoBaseComplexType and assigns it to the Params field.
