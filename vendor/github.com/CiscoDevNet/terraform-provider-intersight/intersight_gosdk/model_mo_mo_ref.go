...
// checks if the MoMoRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MoMoRef{}
...
// GetDefaultClassId returns the default value "mo.MoRef" of the ClassId field.
func (o *MoMoRef) GetDefaultClassId() interface{} {
	return "mo.MoRef"
}
...
func (o MoMoRef) ToMap() (map[string]interface{}, error) {
...
func (o *MoMoRef) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMoMoRef)
