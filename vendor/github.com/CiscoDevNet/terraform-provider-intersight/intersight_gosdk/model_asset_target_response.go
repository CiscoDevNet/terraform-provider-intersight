...
func (dst *AssetTargetResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'asset.Target.List'
	if jsonDict["ObjectType"] == "asset.Target.List" {
		// try to unmarshal JSON data into AssetTargetList
		err = json.Unmarshal(data, &dst.AssetTargetList)
		if err == nil {
			return nil // data stored in dst.AssetTargetList, return on the first match
		} else {
			dst.AssetTargetList = nil
			return fmt.Errorf("Failed to unmarshal AssetTargetResponse as AssetTargetList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetTargetResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetTargetResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetTargetResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src AssetTargetResponse) MarshalJSON() ([]byte, error) {
	if src.AssetTargetList != nil {
		return json.Marshal(&src.AssetTargetList)
	}
...
type NullableAssetTargetResponse struct {
	value *AssetTargetResponse
	isSet bool
}

func (v NullableAssetTargetResponse) Get() *AssetTargetResponse {
	return v.value
}

func (v *NullableAssetTargetResponse) Set(val *AssetTargetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetTargetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetTargetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetTargetResponse(val *AssetTargetResponse) *NullableAssetTargetResponse {
	return &NullableAssetTargetResponse{value: val, isSet: true}
}

func (v NullableAssetTargetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetTargetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
