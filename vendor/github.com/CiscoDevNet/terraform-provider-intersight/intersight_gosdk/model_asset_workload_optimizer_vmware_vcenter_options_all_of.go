...
// SetGuestMetricsEnabled gets a reference to the given bool and assigns it to the GuestMetricsEnabled field.
func (o *AssetWorkloadOptimizerVmwareVcenterOptionsAllOf) SetGuestMetricsEnabled(v bool) {
	o.GuestMetricsEnabled = &v
}
...
func (o *AssetWorkloadOptimizerVmwareVcenterOptionsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "GuestMetricsEnabled")
