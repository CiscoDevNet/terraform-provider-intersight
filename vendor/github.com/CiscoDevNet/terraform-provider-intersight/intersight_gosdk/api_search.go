...
func (r ApiGetSearchSearchItemByMoidRequest) Execute() (*MoBaseMo, *http.Response, error) {
...
//
//	@return MoBaseMo
func (a *SearchApiService) GetSearchSearchItemByMoidExecute(r ApiGetSearchSearchItemByMoidRequest) (*MoBaseMo, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *MoBaseMo
	)
