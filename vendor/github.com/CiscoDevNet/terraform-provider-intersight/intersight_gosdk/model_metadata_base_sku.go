...
// MetadataBaseSku Contains the details of an instance type.
type MetadataBaseSku struct {
	MoBaseMo
...
type _MetadataBaseSku MetadataBaseSku
...
func (o MetadataBaseSku) MarshalJSON() ([]byte, error) {
...
func (o *MetadataBaseSku) UnmarshalJSON(bytes []byte) (err error) {
	type MetadataBaseSkuWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property. The enum values provides the list of concrete types that can be instantiated from this abstract type.
		ObjectType       string                     `json:"ObjectType"`
	...
	varMetadataBaseSkuWithoutEmbeddedStruct := MetadataBaseSkuWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varMetadataBaseSkuWithoutEmbeddedStruct)
	if err == nil {
		varMetadataBaseSku := _MetadataBaseSku{}
		varMetadataBaseSku.ClassId = varMetadataBaseSkuWithoutEmbeddedStruct.ClassId
		varMetadataBaseSku.ObjectType = varMetadataBaseSkuWithoutEmbeddedStruct.ObjectType
		varMetadataBaseSku.CustomAttributes = varMetadataBaseSkuWithoutEmbeddedStruct.CustomAttributes
		varMetadataBaseSku.Description = varMetadataBaseSkuWithoutEmbeddedStruct.Description
		varMetadataBaseSku.IsActive = varMetadataBaseSkuWithoutEmbeddedStruct.IsActive
		varMetadataBaseSku.IsAutoDiscovered = varMetadataBaseSkuWithoutEmbeddedStruct.IsAutoDiscovered
		varMetadataBaseSku.Name = varMetadataBaseSkuWithoutEmbeddedStruct.Name
		varMetadataBaseSku.PlatformType = varMetadataBaseSkuWithoutEmbeddedStruct.PlatformType
		varMetadataBaseSku.ServiceCategory = varMetadataBaseSkuWithoutEmbeddedStruct.ServiceCategory
		varMetadataBaseSku.ServiceFamily = varMetadataBaseSkuWithoutEmbeddedStruct.ServiceFamily
		varMetadataBaseSku.ServiceName = varMetadataBaseSkuWithoutEmbeddedStruct.ServiceName
		varMetadataBaseSku.Target = varMetadataBaseSkuWithoutEmbeddedStruct.Target
		*o = MetadataBaseSku(varMetadataBaseSku)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varMetadataBaseSku)
	if err == nil {
		o.MoBaseMo = varMetadataBaseSku.MoBaseMo
	} else {
		return err
	}
...
type NullableMetadataBaseSku struct {
	value *MetadataBaseSku
	isSet bool
}

func (v NullableMetadataBaseSku) Get() *MetadataBaseSku {
	return v.value
}

func (v *NullableMetadataBaseSku) Set(val *MetadataBaseSku) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataBaseSku) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataBaseSku) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataBaseSku(val *MetadataBaseSku) *NullableMetadataBaseSku {
	return &NullableMetadataBaseSku{value: val, isSet: true}
}

func (v NullableMetadataBaseSku) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataBaseSku) UnmarshalJSON(src []byte) error {
	v.isSet = true
