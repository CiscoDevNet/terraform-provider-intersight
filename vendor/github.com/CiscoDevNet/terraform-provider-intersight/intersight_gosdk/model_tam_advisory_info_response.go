...
func (dst *TamAdvisoryInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal TamAdvisoryInfoResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal TamAdvisoryInfoResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal TamAdvisoryInfoResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'tam.AdvisoryInfo.List'
	if jsonDict["ObjectType"] == "tam.AdvisoryInfo.List" {
		// try to unmarshal JSON data into TamAdvisoryInfoList
		err = json.Unmarshal(data, &dst.TamAdvisoryInfoList)
		if err == nil {
			return nil // data stored in dst.TamAdvisoryInfoList, return on the first match
		} else {
			dst.TamAdvisoryInfoList = nil
			return fmt.Errorf("Failed to unmarshal TamAdvisoryInfoResponse as TamAdvisoryInfoList: %s", err.Error())
		}
	}
...
func (src TamAdvisoryInfoResponse) MarshalJSON() ([]byte, error) {
	...
	if src.TamAdvisoryInfoList != nil {
		return json.Marshal(&src.TamAdvisoryInfoList)
	}
...
func (obj *TamAdvisoryInfoResponse) GetActualInstance() interface{} {
	...
	if obj.TamAdvisoryInfoList != nil {
		return obj.TamAdvisoryInfoList
	}
...
type NullableTamAdvisoryInfoResponse struct {
	value *TamAdvisoryInfoResponse
	isSet bool
}

func (v NullableTamAdvisoryInfoResponse) Get() *TamAdvisoryInfoResponse {
	return v.value
}

func (v *NullableTamAdvisoryInfoResponse) Set(val *TamAdvisoryInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTamAdvisoryInfoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTamAdvisoryInfoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTamAdvisoryInfoResponse(val *TamAdvisoryInfoResponse) *NullableTamAdvisoryInfoResponse {
	return &NullableTamAdvisoryInfoResponse{value: val, isSet: true}
}

func (v NullableTamAdvisoryInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTamAdvisoryInfoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
