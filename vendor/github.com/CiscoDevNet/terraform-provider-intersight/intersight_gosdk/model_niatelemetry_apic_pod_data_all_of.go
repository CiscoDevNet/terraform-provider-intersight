...
// NiatelemetryApicPodDataAllOf Definition of the list of properties defined in 'niatelemetry.ApicPodData', excluding properties defined in parent classes.
type NiatelemetryApicPodDataAllOf struct {
...
type _NiatelemetryApicPodDataAllOf NiatelemetryApicPodDataAllOf
...
func NewNiatelemetryApicPodDataAllOf(classId string, objectType string) *NiatelemetryApicPodDataAllOf {
	this := NiatelemetryApicPodDataAllOf{}
...
func (o NiatelemetryApicPodDataAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryApicPodDataAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryApicPodDataAllOf := _NiatelemetryApicPodDataAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryApicPodDataAllOf); err == nil {
		*o = NiatelemetryApicPodDataAllOf(varNiatelemetryApicPodDataAllOf)
	}
...
type NullableNiatelemetryApicPodDataAllOf struct {
	value *NiatelemetryApicPodDataAllOf
	isSet bool
}

func (v NullableNiatelemetryApicPodDataAllOf) Get() *NiatelemetryApicPodDataAllOf {
	return v.value
}

func (v *NullableNiatelemetryApicPodDataAllOf) Set(val *NiatelemetryApicPodDataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryApicPodDataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryApicPodDataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryApicPodDataAllOf(val *NiatelemetryApicPodDataAllOf) *NullableNiatelemetryApicPodDataAllOf {
	return &NullableNiatelemetryApicPodDataAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryApicPodDataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryApicPodDataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
