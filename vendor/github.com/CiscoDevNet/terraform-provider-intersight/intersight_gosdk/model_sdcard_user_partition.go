...
// checks if the SdcardUserPartition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdcardUserPartition{}
...
// GetDefaultClassId returns the default value "sdcard.UserPartition" of the ClassId field.
func (o *SdcardUserPartition) GetDefaultClassId() interface{} {
	return "sdcard.UserPartition"
}
...
// GetDefaultObjectType returns the default value "sdcard.UserPartition" of the ObjectType field.
func (o *SdcardUserPartition) GetDefaultObjectType() interface{} {
	return "sdcard.UserPartition"
}
...
func (o SdcardUserPartition) ToMap() (map[string]interface{}, error) {
...
func (o *SdcardUserPartition) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSdcardUserPartitionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSdcardUserPartition)
	if err == nil {
