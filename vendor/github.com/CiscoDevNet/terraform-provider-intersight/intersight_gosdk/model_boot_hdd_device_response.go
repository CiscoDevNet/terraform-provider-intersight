...
func (dst *BootHddDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "boot.HddDevice.List" {
		// try to unmarshal JSON data into BootHddDeviceList
		err = json.Unmarshal(data, &dst.BootHddDeviceList)
		if err == nil {
			return nil // data stored in dst.BootHddDeviceList, return on the first match
		} else {
			dst.BootHddDeviceList = nil
			return fmt.Errorf("Failed to unmarshal BootHddDeviceResponse as BootHddDeviceList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BootHddDeviceResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BootHddDeviceResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BootHddDeviceResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src BootHddDeviceResponse) MarshalJSON() ([]byte, error) {
	if src.BootHddDeviceList != nil {
		return json.Marshal(&src.BootHddDeviceList)
	}
...
type NullableBootHddDeviceResponse struct {
	value *BootHddDeviceResponse
	isSet bool
}

func (v NullableBootHddDeviceResponse) Get() *BootHddDeviceResponse {
	return v.value
}

func (v *NullableBootHddDeviceResponse) Set(val *BootHddDeviceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBootHddDeviceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBootHddDeviceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootHddDeviceResponse(val *BootHddDeviceResponse) *NullableBootHddDeviceResponse {
	return &NullableBootHddDeviceResponse{value: val, isSet: true}
}

func (v NullableBootHddDeviceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootHddDeviceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
