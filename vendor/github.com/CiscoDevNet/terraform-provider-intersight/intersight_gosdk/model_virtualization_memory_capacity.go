...
// checks if the VirtualizationMemoryCapacity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationMemoryCapacity{}
...
// GetDefaultClassId returns the default value "virtualization.MemoryCapacity" of the ClassId field.
func (o *VirtualizationMemoryCapacity) GetDefaultClassId() interface{} {
	return "virtualization.MemoryCapacity"
}
...
// GetDefaultObjectType returns the default value "virtualization.MemoryCapacity" of the ObjectType field.
func (o *VirtualizationMemoryCapacity) GetDefaultObjectType() interface{} {
	return "virtualization.MemoryCapacity"
}
...
func (o VirtualizationMemoryCapacity) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationMemoryCapacity) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationMemoryCapacityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationMemoryCapacity)
	if err == nil {
