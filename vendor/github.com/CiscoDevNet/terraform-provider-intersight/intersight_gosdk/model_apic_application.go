...
// ApicApplication Cisco Application Policy Infrastructure Controller (APIC).
type ApicApplication struct {
	...
	// Application name of an object in Cisco Application Policy Infrastructure Controller (APIC) GUI.
