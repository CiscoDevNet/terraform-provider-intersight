...
// checks if the CondAlarmList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CondAlarmList{}
...
func (o CondAlarmList) ToMap() (map[string]interface{}, error) {
...
func (o *CondAlarmList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCondAlarmListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCondAlarmList)
	if err == nil {
