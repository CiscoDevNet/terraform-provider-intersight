...
type _HyperflexCiscoHypervisorManager HyperflexCiscoHypervisorManager
...
func (o *HyperflexCiscoHypervisorManager) UnmarshalJSON(bytes []byte) (err error) {
	type HyperflexCiscoHypervisorManagerWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string                  `json:"ObjectType"`
	...
	varHyperflexCiscoHypervisorManagerWithoutEmbeddedStruct := HyperflexCiscoHypervisorManagerWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varHyperflexCiscoHypervisorManagerWithoutEmbeddedStruct)
	if err == nil {
		varHyperflexCiscoHypervisorManager := _HyperflexCiscoHypervisorManager{}
		varHyperflexCiscoHypervisorManager.ClassId = varHyperflexCiscoHypervisorManagerWithoutEmbeddedStruct.ClassId
		varHyperflexCiscoHypervisorManager.ObjectType = varHyperflexCiscoHypervisorManagerWithoutEmbeddedStruct.ObjectType
		varHyperflexCiscoHypervisorManager.Account = varHyperflexCiscoHypervisorManagerWithoutEmbeddedStruct.Account
		*o = HyperflexCiscoHypervisorManager(varHyperflexCiscoHypervisorManager)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varHyperflexCiscoHypervisorManager)
	if err == nil {
		o.VirtualizationBaseHypervisorManager = varHyperflexCiscoHypervisorManager.VirtualizationBaseHypervisorManager
	} else {
		return err
	}
