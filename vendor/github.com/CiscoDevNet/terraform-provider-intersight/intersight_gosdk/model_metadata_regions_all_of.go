...
// MetadataRegionsAllOf Definition of the list of properties defined in 'metadata.Regions', excluding properties defined in parent classes.
type MetadataRegionsAllOf struct {
...
type _MetadataRegionsAllOf MetadataRegionsAllOf
...
func (o MetadataRegionsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *MetadataRegionsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMetadataRegionsAllOf := _MetadataRegionsAllOf{}

	if err = json.Unmarshal(bytes, &varMetadataRegionsAllOf); err == nil {
		*o = MetadataRegionsAllOf(varMetadataRegionsAllOf)
	}
...
type NullableMetadataRegionsAllOf struct {
	value *MetadataRegionsAllOf
	isSet bool
}

func (v NullableMetadataRegionsAllOf) Get() *MetadataRegionsAllOf {
	return v.value
}

func (v *NullableMetadataRegionsAllOf) Set(val *MetadataRegionsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataRegionsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataRegionsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataRegionsAllOf(val *MetadataRegionsAllOf) *NullableMetadataRegionsAllOf {
	return &NullableMetadataRegionsAllOf{value: val, isSet: true}
}

func (v NullableMetadataRegionsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataRegionsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
