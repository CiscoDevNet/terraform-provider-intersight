...
func (o *TaskNexusScopedInventory) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTaskNexusScopedInventoryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varTaskNexusScopedInventory)
	if err == nil {
