...
func HyperflexClusterBackupPolicyDeploymentListAsHyperflexClusterBackupPolicyDeploymentResponse(v *HyperflexClusterBackupPolicyDeploymentList) HyperflexClusterBackupPolicyDeploymentResponse {
	return HyperflexClusterBackupPolicyDeploymentResponse{
		HyperflexClusterBackupPolicyDeploymentList: v,
	}
}
...
func (dst *HyperflexClusterBackupPolicyDeploymentResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'hyperflex.ClusterBackupPolicyDeployment.List'
	if jsonDict["ObjectType"] == "hyperflex.ClusterBackupPolicyDeployment.List" {
		// try to unmarshal JSON data into HyperflexClusterBackupPolicyDeploymentList
		err = json.Unmarshal(data, &dst.HyperflexClusterBackupPolicyDeploymentList)
		if err == nil {
			return nil // data stored in dst.HyperflexClusterBackupPolicyDeploymentList, return on the first match
		} else {
			dst.HyperflexClusterBackupPolicyDeploymentList = nil
			return fmt.Errorf("Failed to unmarshal HyperflexClusterBackupPolicyDeploymentResponse as HyperflexClusterBackupPolicyDeploymentList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexClusterBackupPolicyDeploymentResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexClusterBackupPolicyDeploymentResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexClusterBackupPolicyDeploymentResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src HyperflexClusterBackupPolicyDeploymentResponse) MarshalJSON() ([]byte, error) {
	if src.HyperflexClusterBackupPolicyDeploymentList != nil {
		return json.Marshal(&src.HyperflexClusterBackupPolicyDeploymentList)
	}
...
type NullableHyperflexClusterBackupPolicyDeploymentResponse struct {
	value *HyperflexClusterBackupPolicyDeploymentResponse
	isSet bool
}

func (v NullableHyperflexClusterBackupPolicyDeploymentResponse) Get() *HyperflexClusterBackupPolicyDeploymentResponse {
	return v.value
}

func (v *NullableHyperflexClusterBackupPolicyDeploymentResponse) Set(val *HyperflexClusterBackupPolicyDeploymentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexClusterBackupPolicyDeploymentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexClusterBackupPolicyDeploymentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexClusterBackupPolicyDeploymentResponse(val *HyperflexClusterBackupPolicyDeploymentResponse) *NullableHyperflexClusterBackupPolicyDeploymentResponse {
	return &NullableHyperflexClusterBackupPolicyDeploymentResponse{value: val, isSet: true}
}

func (v NullableHyperflexClusterBackupPolicyDeploymentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexClusterBackupPolicyDeploymentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
