...
// StorageFlexUtilPhysicalDriveAllOf Definition of the list of properties defined in 'storage.FlexUtilPhysicalDrive', excluding properties defined in parent classes.
type StorageFlexUtilPhysicalDriveAllOf struct {
...
type _StorageFlexUtilPhysicalDriveAllOf StorageFlexUtilPhysicalDriveAllOf
...
func NewStorageFlexUtilPhysicalDriveAllOf(classId string, objectType string) *StorageFlexUtilPhysicalDriveAllOf {
	this := StorageFlexUtilPhysicalDriveAllOf{}
...
func (o StorageFlexUtilPhysicalDriveAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageFlexUtilPhysicalDriveAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageFlexUtilPhysicalDriveAllOf := _StorageFlexUtilPhysicalDriveAllOf{}

	if err = json.Unmarshal(bytes, &varStorageFlexUtilPhysicalDriveAllOf); err == nil {
		*o = StorageFlexUtilPhysicalDriveAllOf(varStorageFlexUtilPhysicalDriveAllOf)
	}
...
type NullableStorageFlexUtilPhysicalDriveAllOf struct {
	value *StorageFlexUtilPhysicalDriveAllOf
	isSet bool
}

func (v NullableStorageFlexUtilPhysicalDriveAllOf) Get() *StorageFlexUtilPhysicalDriveAllOf {
	return v.value
}

func (v *NullableStorageFlexUtilPhysicalDriveAllOf) Set(val *StorageFlexUtilPhysicalDriveAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageFlexUtilPhysicalDriveAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageFlexUtilPhysicalDriveAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageFlexUtilPhysicalDriveAllOf(val *StorageFlexUtilPhysicalDriveAllOf) *NullableStorageFlexUtilPhysicalDriveAllOf {
	return &NullableStorageFlexUtilPhysicalDriveAllOf{value: val, isSet: true}
}

func (v NullableStorageFlexUtilPhysicalDriveAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageFlexUtilPhysicalDriveAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
