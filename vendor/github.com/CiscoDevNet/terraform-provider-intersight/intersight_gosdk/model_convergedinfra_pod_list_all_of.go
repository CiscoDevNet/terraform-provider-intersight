...
// ConvergedinfraPodListAllOf struct for ConvergedinfraPodListAllOf
type ConvergedinfraPodListAllOf struct {
...
type _ConvergedinfraPodListAllOf ConvergedinfraPodListAllOf
...
func NewConvergedinfraPodListAllOf() *ConvergedinfraPodListAllOf {
	this := ConvergedinfraPodListAllOf{}
	return &this
}
...
func (o ConvergedinfraPodListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ConvergedinfraPodListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varConvergedinfraPodListAllOf := _ConvergedinfraPodListAllOf{}

	if err = json.Unmarshal(bytes, &varConvergedinfraPodListAllOf); err == nil {
		*o = ConvergedinfraPodListAllOf(varConvergedinfraPodListAllOf)
	}
...
type NullableConvergedinfraPodListAllOf struct {
	value *ConvergedinfraPodListAllOf
	isSet bool
}

func (v NullableConvergedinfraPodListAllOf) Get() *ConvergedinfraPodListAllOf {
	return v.value
}

func (v *NullableConvergedinfraPodListAllOf) Set(val *ConvergedinfraPodListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableConvergedinfraPodListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableConvergedinfraPodListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvergedinfraPodListAllOf(val *ConvergedinfraPodListAllOf) *NullableConvergedinfraPodListAllOf {
	return &NullableConvergedinfraPodListAllOf{value: val, isSet: true}
}

func (v NullableConvergedinfraPodListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvergedinfraPodListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
