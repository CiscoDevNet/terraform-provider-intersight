...
// checks if the FabricUdldGlobalSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricUdldGlobalSettings{}
...
type FabricUdldGlobalSettings struct {
	...
	// Configures the time between UDLD probe messages on ports that are in advertisement mode and are currently determined to be bidirectional. Valid values are from 1 to 90 seconds.
...
// GetDefaultClassId returns the default value "fabric.UdldGlobalSettings" of the ClassId field.
func (o *FabricUdldGlobalSettings) GetDefaultClassId() interface{} {
	return "fabric.UdldGlobalSettings"
}
...
// GetDefaultObjectType returns the default value "fabric.UdldGlobalSettings" of the ObjectType field.
func (o *FabricUdldGlobalSettings) GetDefaultObjectType() interface{} {
	return "fabric.UdldGlobalSettings"
}
...
func (o *FabricUdldGlobalSettings) GetMessageInterval() int64 {
	if o == nil || IsNil(o.MessageInterval) {
		var ret int64
		return ret
	}
...
func (o FabricUdldGlobalSettings) ToMap() (map[string]interface{}, error) {
...
func (o *FabricUdldGlobalSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricUdldGlobalSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricUdldGlobalSettings)
	if err == nil {
