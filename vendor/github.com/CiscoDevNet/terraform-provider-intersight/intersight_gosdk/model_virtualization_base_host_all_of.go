...
// VirtualizationBaseHostAllOf Definition of the list of properties defined in 'virtualization.BaseHost', excluding properties defined in parent classes.
type VirtualizationBaseHostAllOf struct {
...
type _VirtualizationBaseHostAllOf VirtualizationBaseHostAllOf
...
func NewVirtualizationBaseHostAllOf(classId string, objectType string) *VirtualizationBaseHostAllOf {
	this := VirtualizationBaseHostAllOf{}
...
func (o VirtualizationBaseHostAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationBaseHostAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationBaseHostAllOf := _VirtualizationBaseHostAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationBaseHostAllOf); err == nil {
		*o = VirtualizationBaseHostAllOf(varVirtualizationBaseHostAllOf)
	}
...
type NullableVirtualizationBaseHostAllOf struct {
	value *VirtualizationBaseHostAllOf
	isSet bool
}

func (v NullableVirtualizationBaseHostAllOf) Get() *VirtualizationBaseHostAllOf {
	return v.value
}

func (v *NullableVirtualizationBaseHostAllOf) Set(val *VirtualizationBaseHostAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationBaseHostAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationBaseHostAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationBaseHostAllOf(val *VirtualizationBaseHostAllOf) *NullableVirtualizationBaseHostAllOf {
	return &NullableVirtualizationBaseHostAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationBaseHostAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationBaseHostAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
