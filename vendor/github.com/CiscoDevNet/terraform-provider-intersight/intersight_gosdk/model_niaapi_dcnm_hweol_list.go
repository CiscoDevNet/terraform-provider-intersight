...
// checks if the NiaapiDcnmHweolList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiDcnmHweolList{}
...
func NewNiaapiDcnmHweolList(objectType string) *NiaapiDcnmHweolList {
...
func (o NiaapiDcnmHweolList) ToMap() (map[string]interface{}, error) {
...
func (o *NiaapiDcnmHweolList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiDcnmHweolListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiDcnmHweolList)
	if err == nil {
