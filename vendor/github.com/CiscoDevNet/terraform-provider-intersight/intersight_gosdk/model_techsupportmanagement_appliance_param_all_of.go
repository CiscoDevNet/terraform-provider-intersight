...
// TechsupportmanagementApplianceParamAllOf Definition of the list of properties defined in 'techsupportmanagement.ApplianceParam', excluding properties defined in parent classes.
type TechsupportmanagementApplianceParamAllOf struct {
...
type _TechsupportmanagementApplianceParamAllOf TechsupportmanagementApplianceParamAllOf
...
func NewTechsupportmanagementApplianceParamAllOf(classId string, objectType string) *TechsupportmanagementApplianceParamAllOf {
	this := TechsupportmanagementApplianceParamAllOf{}
...
func (o TechsupportmanagementApplianceParamAllOf) MarshalJSON() ([]byte, error) {
...
func (o *TechsupportmanagementApplianceParamAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTechsupportmanagementApplianceParamAllOf := _TechsupportmanagementApplianceParamAllOf{}

	if err = json.Unmarshal(bytes, &varTechsupportmanagementApplianceParamAllOf); err == nil {
		*o = TechsupportmanagementApplianceParamAllOf(varTechsupportmanagementApplianceParamAllOf)
	}
...
type NullableTechsupportmanagementApplianceParamAllOf struct {
	value *TechsupportmanagementApplianceParamAllOf
	isSet bool
}

func (v NullableTechsupportmanagementApplianceParamAllOf) Get() *TechsupportmanagementApplianceParamAllOf {
	return v.value
}

func (v *NullableTechsupportmanagementApplianceParamAllOf) Set(val *TechsupportmanagementApplianceParamAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTechsupportmanagementApplianceParamAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTechsupportmanagementApplianceParamAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTechsupportmanagementApplianceParamAllOf(val *TechsupportmanagementApplianceParamAllOf) *NullableTechsupportmanagementApplianceParamAllOf {
	return &NullableTechsupportmanagementApplianceParamAllOf{value: val, isSet: true}
}

func (v NullableTechsupportmanagementApplianceParamAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTechsupportmanagementApplianceParamAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
