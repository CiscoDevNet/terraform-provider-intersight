...
func (dst *KubernetesCatalogResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'kubernetes.Catalog.List'
	if jsonDict["ObjectType"] == "kubernetes.Catalog.List" {
		// try to unmarshal JSON data into KubernetesCatalogList
		err = json.Unmarshal(data, &dst.KubernetesCatalogList)
		if err == nil {
			return nil // data stored in dst.KubernetesCatalogList, return on the first match
		} else {
			dst.KubernetesCatalogList = nil
			return fmt.Errorf("failed to unmarshal KubernetesCatalogResponse as KubernetesCatalogList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal KubernetesCatalogResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal KubernetesCatalogResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal KubernetesCatalogResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src KubernetesCatalogResponse) MarshalJSON() ([]byte, error) {
	if src.KubernetesCatalogList != nil {
		return json.Marshal(&src.KubernetesCatalogList)
	}
...
type NullableKubernetesCatalogResponse struct {
	value *KubernetesCatalogResponse
	isSet bool
}

func (v NullableKubernetesCatalogResponse) Get() *KubernetesCatalogResponse {
	return v.value
}

func (v *NullableKubernetesCatalogResponse) Set(val *KubernetesCatalogResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesCatalogResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesCatalogResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesCatalogResponse(val *KubernetesCatalogResponse) *NullableKubernetesCatalogResponse {
	return &NullableKubernetesCatalogResponse{value: val, isSet: true}
}

func (v NullableKubernetesCatalogResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesCatalogResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
