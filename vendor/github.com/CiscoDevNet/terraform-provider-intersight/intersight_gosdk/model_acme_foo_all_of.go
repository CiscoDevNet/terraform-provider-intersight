...
// AcmeFooAllOf Definition of the list of properties defined in 'acme.Foo', excluding properties defined in parent classes.
type AcmeFooAllOf struct {
...
type _AcmeFooAllOf AcmeFooAllOf
...
func (o AcmeFooAllOf) MarshalJSON() ([]byte, error) {
...
func (o *AcmeFooAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varAcmeFooAllOf := _AcmeFooAllOf{}

	if err = json.Unmarshal(bytes, &varAcmeFooAllOf); err == nil {
		*o = AcmeFooAllOf(varAcmeFooAllOf)
	}
...
type NullableAcmeFooAllOf struct {
	value *AcmeFooAllOf
	isSet bool
}

func (v NullableAcmeFooAllOf) Get() *AcmeFooAllOf {
	return v.value
}

func (v *NullableAcmeFooAllOf) Set(val *AcmeFooAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAcmeFooAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAcmeFooAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcmeFooAllOf(val *AcmeFooAllOf) *NullableAcmeFooAllOf {
	return &NullableAcmeFooAllOf{value: val, isSet: true}
}

func (v NullableAcmeFooAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcmeFooAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
