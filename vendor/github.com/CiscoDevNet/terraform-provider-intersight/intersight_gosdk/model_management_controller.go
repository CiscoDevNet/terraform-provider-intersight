...
type ManagementController struct {
	...
	ReplayConfigInfo   NullableManagementReplayConfigInfo       `json:"ReplayConfigInfo,omitempty"`
...
// GetReplayConfigInfo returns the ReplayConfigInfo field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ManagementController) GetReplayConfigInfo() ManagementReplayConfigInfo {
	if o == nil || IsNil(o.ReplayConfigInfo.Get()) {
		var ret ManagementReplayConfigInfo
		return ret
	}
	return *o.ReplayConfigInfo.Get()
}

// GetReplayConfigInfoOk returns a tuple with the ReplayConfigInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetReplayConfigInfo gets a reference to the given NullableManagementReplayConfigInfo and assigns it to the ReplayConfigInfo field.
func (o *ManagementController) SetReplayConfigInfo(v ManagementReplayConfigInfo) {
	o.ReplayConfigInfo.Set(&v)
}

// SetReplayConfigInfoNil sets the value for ReplayConfigInfo to be an explicit nil
func (o *ManagementController) SetReplayConfigInfoNil() {
	o.ReplayConfigInfo.Set(nil)
}
...
func (o ManagementController) ToMap() (map[string]interface{}, error) {
	...
	if o.ReplayConfigInfo.IsSet() {
		toSerialize["ReplayConfigInfo"] = o.ReplayConfigInfo.Get()
	}
...
func (o *ManagementController) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varManagementController.ReplayConfigInfo = varManagementControllerWithoutEmbeddedStruct.ReplayConfigInfo
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ReplayConfigInfo")
