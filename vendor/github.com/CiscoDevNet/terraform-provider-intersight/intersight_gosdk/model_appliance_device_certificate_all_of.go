...
// ApplianceDeviceCertificateAllOf Definition of the list of properties defined in 'appliance.DeviceCertificate', excluding properties defined in parent classes.
type ApplianceDeviceCertificateAllOf struct {
...
type _ApplianceDeviceCertificateAllOf ApplianceDeviceCertificateAllOf
...
func NewApplianceDeviceCertificateAllOf(classId string, objectType string) *ApplianceDeviceCertificateAllOf {
	this := ApplianceDeviceCertificateAllOf{}
...
func (o ApplianceDeviceCertificateAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceDeviceCertificateAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceDeviceCertificateAllOf := _ApplianceDeviceCertificateAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceDeviceCertificateAllOf); err == nil {
		*o = ApplianceDeviceCertificateAllOf(varApplianceDeviceCertificateAllOf)
	}
...
type NullableApplianceDeviceCertificateAllOf struct {
	value *ApplianceDeviceCertificateAllOf
	isSet bool
}

func (v NullableApplianceDeviceCertificateAllOf) Get() *ApplianceDeviceCertificateAllOf {
	return v.value
}

func (v *NullableApplianceDeviceCertificateAllOf) Set(val *ApplianceDeviceCertificateAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceDeviceCertificateAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceDeviceCertificateAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceDeviceCertificateAllOf(val *ApplianceDeviceCertificateAllOf) *NullableApplianceDeviceCertificateAllOf {
	return &NullableApplianceDeviceCertificateAllOf{value: val, isSet: true}
}

func (v NullableApplianceDeviceCertificateAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceDeviceCertificateAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
