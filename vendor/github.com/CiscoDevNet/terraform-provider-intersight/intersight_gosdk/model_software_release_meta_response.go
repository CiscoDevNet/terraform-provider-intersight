...
func (dst *SoftwareReleaseMetaResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal SoftwareReleaseMetaResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal SoftwareReleaseMetaResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal SoftwareReleaseMetaResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'software.ReleaseMeta.List'
	if jsonDict["ObjectType"] == "software.ReleaseMeta.List" {
		// try to unmarshal JSON data into SoftwareReleaseMetaList
		err = json.Unmarshal(data, &dst.SoftwareReleaseMetaList)
		if err == nil {
			return nil // data stored in dst.SoftwareReleaseMetaList, return on the first match
		} else {
			dst.SoftwareReleaseMetaList = nil
			return fmt.Errorf("failed to unmarshal SoftwareReleaseMetaResponse as SoftwareReleaseMetaList: %s", err.Error())
		}
	}
...
func (src SoftwareReleaseMetaResponse) MarshalJSON() ([]byte, error) {
	...
	if src.SoftwareReleaseMetaList != nil {
		return json.Marshal(&src.SoftwareReleaseMetaList)
	}
...
func (obj *SoftwareReleaseMetaResponse) GetActualInstance() interface{} {
	...
	if obj.SoftwareReleaseMetaList != nil {
		return obj.SoftwareReleaseMetaList
	}
...
type NullableSoftwareReleaseMetaResponse struct {
	value *SoftwareReleaseMetaResponse
	isSet bool
}

func (v NullableSoftwareReleaseMetaResponse) Get() *SoftwareReleaseMetaResponse {
	return v.value
}

func (v *NullableSoftwareReleaseMetaResponse) Set(val *SoftwareReleaseMetaResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareReleaseMetaResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareReleaseMetaResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareReleaseMetaResponse(val *SoftwareReleaseMetaResponse) *NullableSoftwareReleaseMetaResponse {
	return &NullableSoftwareReleaseMetaResponse{value: val, isSet: true}
}

func (v NullableSoftwareReleaseMetaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareReleaseMetaResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
