...
// checks if the MacpoolUniverseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MacpoolUniverseList{}
...
func (o MacpoolUniverseList) ToMap() (map[string]interface{}, error) {
...
func (o *MacpoolUniverseList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMacpoolUniverseListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varMacpoolUniverseList)
	if err == nil {
