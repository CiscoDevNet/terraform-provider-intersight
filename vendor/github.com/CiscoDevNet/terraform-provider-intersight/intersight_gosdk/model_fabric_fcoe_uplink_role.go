...
// checks if the FabricFcoeUplinkRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricFcoeUplinkRole{}
...
// GetDefaultClassId returns the default value "fabric.FcoeUplinkRole" of the ClassId field.
func (o *FabricFcoeUplinkRole) GetDefaultClassId() interface{} {
	return "fabric.FcoeUplinkRole"
}
...
// GetDefaultObjectType returns the default value "fabric.FcoeUplinkRole" of the ObjectType field.
func (o *FabricFcoeUplinkRole) GetDefaultObjectType() interface{} {
	return "fabric.FcoeUplinkRole"
}
...
func (o *FabricFcoeUplinkRole) SetLinkControlPolicyNil() {
...
func (o FabricFcoeUplinkRole) ToMap() (map[string]interface{}, error) {
...
func (o *FabricFcoeUplinkRole) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricFcoeUplinkRoleWithoutEmbeddedStruct)
	if err == nil {
		...
		varFabricFcoeUplinkRole.LinkControlPolicy = varFabricFcoeUplinkRoleWithoutEmbeddedStruct.LinkControlPolicy
	...
	err = json.Unmarshal(data, &varFabricFcoeUplinkRole)
	if err == nil {
