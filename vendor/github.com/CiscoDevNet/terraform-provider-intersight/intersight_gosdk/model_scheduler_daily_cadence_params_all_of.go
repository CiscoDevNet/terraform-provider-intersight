...
// SchedulerDailyCadenceParamsAllOf Definition of the list of properties defined in 'scheduler.DailyCadenceParams', excluding properties defined in parent classes.
type SchedulerDailyCadenceParamsAllOf struct {
...
type _SchedulerDailyCadenceParamsAllOf SchedulerDailyCadenceParamsAllOf
...
func NewSchedulerDailyCadenceParamsAllOf(classId string, objectType string) *SchedulerDailyCadenceParamsAllOf {
	this := SchedulerDailyCadenceParamsAllOf{}
...
func (o SchedulerDailyCadenceParamsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *SchedulerDailyCadenceParamsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varSchedulerDailyCadenceParamsAllOf := _SchedulerDailyCadenceParamsAllOf{}

	if err = json.Unmarshal(bytes, &varSchedulerDailyCadenceParamsAllOf); err == nil {
		*o = SchedulerDailyCadenceParamsAllOf(varSchedulerDailyCadenceParamsAllOf)
	}
...
type NullableSchedulerDailyCadenceParamsAllOf struct {
	value *SchedulerDailyCadenceParamsAllOf
	isSet bool
}

func (v NullableSchedulerDailyCadenceParamsAllOf) Get() *SchedulerDailyCadenceParamsAllOf {
	return v.value
}

func (v *NullableSchedulerDailyCadenceParamsAllOf) Set(val *SchedulerDailyCadenceParamsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSchedulerDailyCadenceParamsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSchedulerDailyCadenceParamsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchedulerDailyCadenceParamsAllOf(val *SchedulerDailyCadenceParamsAllOf) *NullableSchedulerDailyCadenceParamsAllOf {
	return &NullableSchedulerDailyCadenceParamsAllOf{value: val, isSet: true}
}

func (v NullableSchedulerDailyCadenceParamsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchedulerDailyCadenceParamsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
