...
// checks if the NiatelemetryFabricPodProfileList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryFabricPodProfileList{}
...
func (o NiatelemetryFabricPodProfileList) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryFabricPodProfileList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryFabricPodProfileListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryFabricPodProfileList)
	if err == nil {
