...
type IamSystem struct {
	...
	ServiceProvider      NullableIamServiceProviderRelationship `json:"ServiceProvider,omitempty"`
...
// GetDefaultClassId returns the default value "iam.System" of the ClassId field.
func (o *IamSystem) GetDefaultClassId() interface{} {
	return "iam.System"
}
...
// GetDefaultObjectType returns the default value "iam.System" of the ObjectType field.
func (o *IamSystem) GetDefaultObjectType() interface{} {
	return "iam.System"
}
...
// SetServiceProvider gets a reference to the given NullableIamServiceProviderRelationship and assigns it to the ServiceProvider field.
...
func (o *IamSystem) SetServiceProviderNil() {
...
func (o IamSystem) ToMap() (map[string]interface{}, error) {
...
func (o *IamSystem) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamSystemWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIamSystem)
	if err == nil {
