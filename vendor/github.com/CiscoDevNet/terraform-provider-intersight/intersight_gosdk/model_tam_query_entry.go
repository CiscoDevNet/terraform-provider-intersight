...
// checks if the TamQueryEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TamQueryEntry{}
...
// GetDefaultClassId returns the default value "tam.QueryEntry" of the ClassId field.
func (o *TamQueryEntry) GetDefaultClassId() interface{} {
	return "tam.QueryEntry"
}
...
// GetDefaultObjectType returns the default value "tam.QueryEntry" of the ObjectType field.
func (o *TamQueryEntry) GetDefaultObjectType() interface{} {
	return "tam.QueryEntry"
}
...
func (o TamQueryEntry) ToMap() (map[string]interface{}, error) {
...
func (o *TamQueryEntry) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTamQueryEntryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTamQueryEntry)
	if err == nil {
