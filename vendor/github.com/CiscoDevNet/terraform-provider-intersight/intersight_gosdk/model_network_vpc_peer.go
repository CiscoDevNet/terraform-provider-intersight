...
// GetDefaultClassId returns the default value "network.VpcPeer" of the ClassId field.
func (o *NetworkVpcPeer) GetDefaultClassId() interface{} {
	return "network.VpcPeer"
}
...
// GetDefaultObjectType returns the default value "network.VpcPeer" of the ObjectType field.
func (o *NetworkVpcPeer) GetDefaultObjectType() interface{} {
	return "network.VpcPeer"
}
