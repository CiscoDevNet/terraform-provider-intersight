...
func (o *VnicSriovSettings) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVnicSriovSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVnicSriovSettings)
	if err == nil {
