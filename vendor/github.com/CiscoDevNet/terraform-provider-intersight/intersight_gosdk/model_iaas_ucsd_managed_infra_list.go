...
// checks if the IaasUcsdManagedInfraList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IaasUcsdManagedInfraList{}
...
func NewIaasUcsdManagedInfraList(objectType string) *IaasUcsdManagedInfraList {
...
func (o IaasUcsdManagedInfraList) ToMap() (map[string]interface{}, error) {
...
func (o *IaasUcsdManagedInfraList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIaasUcsdManagedInfraListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIaasUcsdManagedInfraList)
	if err == nil {
