...
// checks if the NiatelemetryBootflashDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryBootflashDetails{}
...
// GetDefaultClassId returns the default value "niatelemetry.BootflashDetails" of the ClassId field.
func (o *NiatelemetryBootflashDetails) GetDefaultClassId() interface{} {
	return "niatelemetry.BootflashDetails"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.BootflashDetails" of the ObjectType field.
func (o *NiatelemetryBootflashDetails) GetDefaultObjectType() interface{} {
	return "niatelemetry.BootflashDetails"
}

// GetFwRev returns the FwRev field value if set, zero value otherwise.
func (o *NiatelemetryBootflashDetails) GetFwRev() string {
	if o == nil || IsNil(o.FwRev) {
		var ret string
		return ret
	}
	return *o.FwRev
...
func (o NiatelemetryBootflashDetails) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryBootflashDetails) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryBootflashDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryBootflashDetails)
	if err == nil {
