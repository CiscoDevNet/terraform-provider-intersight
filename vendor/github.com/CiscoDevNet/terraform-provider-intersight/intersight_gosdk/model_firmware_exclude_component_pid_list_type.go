...
func (o *FirmwareExcludeComponentPidListType) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFirmwareExcludeComponentPidListTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFirmwareExcludeComponentPidListType)
	if err == nil {
