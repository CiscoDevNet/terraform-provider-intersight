...
// checks if the OsIpv4Configuration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsIpv4Configuration{}
...
// GetDefaultClassId returns the default value "os.Ipv4Configuration" of the ClassId field.
func (o *OsIpv4Configuration) GetDefaultClassId() interface{} {
	return "os.Ipv4Configuration"
}
...
// GetDefaultObjectType returns the default value "os.Ipv4Configuration" of the ObjectType field.
func (o *OsIpv4Configuration) GetDefaultObjectType() interface{} {
	return "os.Ipv4Configuration"
}
...
func (o *OsIpv4Configuration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsIpv4ConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsIpv4Configuration)
	if err == nil {
