...
// checks if the MemoryPersistentMemoryLocalSecurity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemoryPersistentMemoryLocalSecurity{}
...
type MemoryPersistentMemoryLocalSecurity struct {
	...
	SecurePassphrase     *string `json:"SecurePassphrase,omitempty" validate:"regexp=^$|^[a-zA-Z0-9=!&#$%+^@_*-]+$"`
...
// GetDefaultClassId returns the default value "memory.PersistentMemoryLocalSecurity" of the ClassId field.
func (o *MemoryPersistentMemoryLocalSecurity) GetDefaultClassId() interface{} {
	return "memory.PersistentMemoryLocalSecurity"
}
...
// GetDefaultObjectType returns the default value "memory.PersistentMemoryLocalSecurity" of the ObjectType field.
func (o *MemoryPersistentMemoryLocalSecurity) GetDefaultObjectType() interface{} {
	return "memory.PersistentMemoryLocalSecurity"
}
...
func (o MemoryPersistentMemoryLocalSecurity) ToMap() (map[string]interface{}, error) {
...
func (o *MemoryPersistentMemoryLocalSecurity) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMemoryPersistentMemoryLocalSecurityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varMemoryPersistentMemoryLocalSecurity)
	if err == nil {
