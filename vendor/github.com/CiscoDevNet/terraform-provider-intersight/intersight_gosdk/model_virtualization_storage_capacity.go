...
// checks if the VirtualizationStorageCapacity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationStorageCapacity{}
...
// GetDefaultClassId returns the default value "virtualization.StorageCapacity" of the ClassId field.
func (o *VirtualizationStorageCapacity) GetDefaultClassId() interface{} {
	return "virtualization.StorageCapacity"
}
...
// GetDefaultObjectType returns the default value "virtualization.StorageCapacity" of the ObjectType field.
func (o *VirtualizationStorageCapacity) GetDefaultObjectType() interface{} {
	return "virtualization.StorageCapacity"
}
...
func (o VirtualizationStorageCapacity) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationStorageCapacity) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationStorageCapacityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationStorageCapacity)
	if err == nil {
