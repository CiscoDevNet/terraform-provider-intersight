...
// checks if the PkixRsaAlgorithm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PkixRsaAlgorithm{}
...
// GetDefaultClassId returns the default value "pkix.RsaAlgorithm" of the ClassId field.
func (o *PkixRsaAlgorithm) GetDefaultClassId() interface{} {
	return "pkix.RsaAlgorithm"
}
...
// GetDefaultObjectType returns the default value "pkix.RsaAlgorithm" of the ObjectType field.
func (o *PkixRsaAlgorithm) GetDefaultObjectType() interface{} {
	return "pkix.RsaAlgorithm"
}
...
func (o PkixRsaAlgorithm) ToMap() (map[string]interface{}, error) {
...
func (o *PkixRsaAlgorithm) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPkixRsaAlgorithmWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varPkixRsaAlgorithm)
	if err == nil {
