...
// checks if the TelemetryDruidNumericTopNMetricSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidNumericTopNMetricSpec{}
...
func (o TelemetryDruidNumericTopNMetricSpec) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidNumericTopNMetricSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidNumericTopNMetricSpec)
