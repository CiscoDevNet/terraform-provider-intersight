...
func (dst *EquipmentRackEnclosureResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'equipment.RackEnclosure.List'
	if jsonDict["ObjectType"] == "equipment.RackEnclosure.List" {
		// try to unmarshal JSON data into EquipmentRackEnclosureList
		err = json.Unmarshal(data, &dst.EquipmentRackEnclosureList)
		if err == nil {
			return nil // data stored in dst.EquipmentRackEnclosureList, return on the first match
		} else {
			dst.EquipmentRackEnclosureList = nil
			return fmt.Errorf("failed to unmarshal EquipmentRackEnclosureResponse as EquipmentRackEnclosureList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal EquipmentRackEnclosureResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal EquipmentRackEnclosureResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal EquipmentRackEnclosureResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src EquipmentRackEnclosureResponse) MarshalJSON() ([]byte, error) {
	if src.EquipmentRackEnclosureList != nil {
		return json.Marshal(&src.EquipmentRackEnclosureList)
	}
...
type NullableEquipmentRackEnclosureResponse struct {
	value *EquipmentRackEnclosureResponse
	isSet bool
}

func (v NullableEquipmentRackEnclosureResponse) Get() *EquipmentRackEnclosureResponse {
	return v.value
}

func (v *NullableEquipmentRackEnclosureResponse) Set(val *EquipmentRackEnclosureResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentRackEnclosureResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentRackEnclosureResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentRackEnclosureResponse(val *EquipmentRackEnclosureResponse) *NullableEquipmentRackEnclosureResponse {
	return &NullableEquipmentRackEnclosureResponse{value: val, isSet: true}
}

func (v NullableEquipmentRackEnclosureResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentRackEnclosureResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
