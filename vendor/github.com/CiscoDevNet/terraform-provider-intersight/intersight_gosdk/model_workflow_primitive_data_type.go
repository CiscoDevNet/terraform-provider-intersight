...
// checks if the WorkflowPrimitiveDataType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowPrimitiveDataType{}
...
// GetDefaultClassId returns the default value "workflow.PrimitiveDataType" of the ClassId field.
func (o *WorkflowPrimitiveDataType) GetDefaultClassId() interface{} {
	return "workflow.PrimitiveDataType"
}
...
// GetDefaultObjectType returns the default value "workflow.PrimitiveDataType" of the ObjectType field.
func (o *WorkflowPrimitiveDataType) GetDefaultObjectType() interface{} {
	return "workflow.PrimitiveDataType"
}
...
func (o WorkflowPrimitiveDataType) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowPrimitiveDataType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowPrimitiveDataTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowPrimitiveDataType)
	if err == nil {
