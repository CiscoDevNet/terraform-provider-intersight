...
// checks if the I18nMessageParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &I18nMessageParam{}
...
// GetDefaultClassId returns the default value "i18n.MessageParam" of the ClassId field.
func (o *I18nMessageParam) GetDefaultClassId() interface{} {
	return "i18n.MessageParam"
}
...
// GetDefaultObjectType returns the default value "i18n.MessageParam" of the ObjectType field.
func (o *I18nMessageParam) GetDefaultObjectType() interface{} {
	return "i18n.MessageParam"
}
...
func (o I18nMessageParam) ToMap() (map[string]interface{}, error) {
...
func (o *I18nMessageParam) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varI18nMessageParamWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varI18nMessageParam)
	if err == nil {
