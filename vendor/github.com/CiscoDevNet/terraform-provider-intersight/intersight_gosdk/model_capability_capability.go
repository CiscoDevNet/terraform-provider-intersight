...
// checks if the CapabilityCapability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityCapability{}
...
func (o CapabilityCapability) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityCapability) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityCapabilityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityCapability)
	if err == nil {
