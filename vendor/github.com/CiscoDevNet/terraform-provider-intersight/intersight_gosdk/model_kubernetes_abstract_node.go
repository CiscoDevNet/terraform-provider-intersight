...
// checks if the KubernetesAbstractNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesAbstractNode{}
...
// GetDefaultClassId returns the default value "kubernetes.Node" of the ClassId field.
func (o *KubernetesAbstractNode) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "kubernetes.Node" of the ObjectType field.
func (o *KubernetesAbstractNode) GetDefaultObjectType() interface{} {
	return "kubernetes.Node"
}
...
func (o KubernetesAbstractNode) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesAbstractNode) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesAbstractNodeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesAbstractNode)
	if err == nil {
