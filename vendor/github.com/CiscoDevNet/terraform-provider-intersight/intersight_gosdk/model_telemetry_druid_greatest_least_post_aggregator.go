...
func (o *TelemetryDruidGreatestLeastPostAggregator) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidGreatestLeastPostAggregator := _TelemetryDruidGreatestLeastPostAggregator{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidGreatestLeastPostAggregator); err == nil {
