...
// GetDefaultClassId returns the default value "connector.SshConfig" of the ClassId field.
func (o *ConnectorSshConfig) GetDefaultClassId() interface{} {
	return "connector.SshConfig"
}
...
// GetDefaultObjectType returns the default value "connector.SshConfig" of the ObjectType field.
func (o *ConnectorSshConfig) GetDefaultObjectType() interface{} {
	return "connector.SshConfig"
}
...
func (o *ConnectorSshConfig) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varConnectorSshConfig.PkeyString = varConnectorSshConfigWithoutEmbeddedStruct.PkeyString
