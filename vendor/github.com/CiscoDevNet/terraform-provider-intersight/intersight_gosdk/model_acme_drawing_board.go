...
func (o *AcmeDrawingBoard) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAcmeDrawingBoardWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varAcmeDrawingBoard)
	if err == nil {
