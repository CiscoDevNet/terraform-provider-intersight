...
func (o *IamEndPointRoleList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varIamEndPointRoleListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varIamEndPointRoleList)
	if err == nil {
