...
func (o *TerraformRunstate) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTerraformRunstateWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varTerraformRunstate)
	if err == nil {
