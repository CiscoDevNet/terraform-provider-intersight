...
// checks if the FabricUdldSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricUdldSettings{}
...
// GetDefaultClassId returns the default value "fabric.UdldSettings" of the ClassId field.
func (o *FabricUdldSettings) GetDefaultClassId() interface{} {
	return "fabric.UdldSettings"
}
...
// GetDefaultObjectType returns the default value "fabric.UdldSettings" of the ObjectType field.
func (o *FabricUdldSettings) GetDefaultObjectType() interface{} {
	return "fabric.UdldSettings"
}
...
func (o FabricUdldSettings) ToMap() (map[string]interface{}, error) {
...
func (o *FabricUdldSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricUdldSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricUdldSettings)
	if err == nil {
