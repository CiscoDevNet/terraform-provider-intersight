...
func (o *NiatelemetrySupervisorModuleDetailsList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetrySupervisorModuleDetailsListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetrySupervisorModuleDetailsList)
	if err == nil {
