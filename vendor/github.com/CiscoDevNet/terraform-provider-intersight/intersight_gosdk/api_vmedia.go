...
func (r ApiCreateVmediaPolicyRequest) Execute() (*VmediaPolicy, *http.Response, error) {
...
func (r ApiDeleteVmediaPolicyRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *VmediaApiService) DeleteVmediaPolicyExecute(r ApiDeleteVmediaPolicyRequest) (*http.Response, error) {
	var (
...
func (r ApiGetVmediaPolicyByMoidRequest) Execute() (*VmediaPolicy, *http.Response, error) {
...
type ApiGetVmediaPolicyInventoryByMoidRequest struct {
	ctx        context.Context
	ApiService *VmediaApiService
	moid       string
}

func (r ApiGetVmediaPolicyInventoryByMoidRequest) Execute() (*VmediaPolicyInventory, *http.Response, error) {
	return r.ApiService.GetVmediaPolicyInventoryByMoidExecute(r)
}
...
func (a *VmediaApiService) GetVmediaPolicyInventoryByMoidExecute(r ApiGetVmediaPolicyInventoryByMoidRequest) (*VmediaPolicyInventory, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *VmediaPolicyInventory
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.GetVmediaPolicyInventoryByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/vmedia/PolicyInventories/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
type ApiGetVmediaPolicyInventoryListRequest struct {
	ctx         context.Context
	ApiService  *VmediaApiService
	filter      *string
	orderby     *string
...
func (r ApiGetVmediaPolicyInventoryListRequest) Filter(filter string) ApiGetVmediaPolicyInventoryListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetVmediaPolicyInventoryListRequest) Orderby(orderby string) ApiGetVmediaPolicyInventoryListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetVmediaPolicyInventoryListRequest) Top(top int32) ApiGetVmediaPolicyInventoryListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetVmediaPolicyInventoryListRequest) Skip(skip int32) ApiGetVmediaPolicyInventoryListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetVmediaPolicyInventoryListRequest) Select_(select_ string) ApiGetVmediaPolicyInventoryListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetVmediaPolicyInventoryListRequest) Expand(expand string) ApiGetVmediaPolicyInventoryListRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetVmediaPolicyInventoryListRequest) Apply(apply string) ApiGetVmediaPolicyInventoryListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetVmediaPolicyInventoryListRequest) Count(count bool) ApiGetVmediaPolicyInventoryListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetVmediaPolicyInventoryListRequest) Inlinecount(inlinecount string) ApiGetVmediaPolicyInventoryListRequest {
...
func (r ApiGetVmediaPolicyInventoryListRequest) At(at string) ApiGetVmediaPolicyInventoryListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetVmediaPolicyInventoryListRequest) Tags(tags string) ApiGetVmediaPolicyInventoryListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetVmediaPolicyInventoryListRequest) Execute() (*VmediaPolicyInventoryResponse, *http.Response, error) {
	return r.ApiService.GetVmediaPolicyInventoryListExecute(r)
}
...
func (a *VmediaApiService) GetVmediaPolicyInventoryListExecute(r ApiGetVmediaPolicyInventoryListRequest) (*VmediaPolicyInventoryResponse, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *VmediaPolicyInventoryResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.GetVmediaPolicyInventoryList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/vmedia/PolicyInventories"
...
func (r ApiGetVmediaPolicyListRequest) Execute() (*VmediaPolicyResponse, *http.Response, error) {
...
func (r ApiPatchVmediaPolicyRequest) Execute() (*VmediaPolicy, *http.Response, error) {
...
func (r ApiUpdateVmediaPolicyRequest) Execute() (*VmediaPolicy, *http.Response, error) {
