...
func (r apiCreateVmediaPolicyRequest) Execute() (VmediaPolicy, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.CreateVmediaPolicy")
	if err != nil {
...
func (r apiDeleteVmediaPolicyRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.DeleteVmediaPolicy")
	if err != nil {
...
func (r apiGetVmediaPolicyByMoidRequest) Execute() (VmediaPolicy, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.GetVmediaPolicyByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetVmediaPolicyListRequest) Execute() (VmediaPolicyResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.GetVmediaPolicyList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiPatchVmediaPolicyRequest) Execute() (VmediaPolicy, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.PatchVmediaPolicy")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateVmediaPolicyRequest) Execute() (VmediaPolicy, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VmediaApiService.UpdateVmediaPolicy")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
