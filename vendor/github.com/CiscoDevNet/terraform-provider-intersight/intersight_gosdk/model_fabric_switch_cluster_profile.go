...
// FabricSwitchClusterProfile The SwitchClusterProfile object is an essential element in the network management domain, designed to specify configuration policies for a cluster of switches. It consolidates the configuration context of all the switch profiles referred by the Switch Cluster Profile, ensuring seamless integration and management of network resources. #### Purpose The SwitchClusterProfile serves as a comprehensive configuration entity for managing multiple switches as a unified cluster. It allows administrators to define, deploy, and manage network switch profiles efficiently, providing a streamlined approach to switch configuration and deployment. #### Key Concepts - **Configuration Consolidation:** Aggregates configuration policies across multiple switch profiles, providing a single point of management for cluster configurations. - **Deployment Management:** Facilitates the deployment of switch profiles across different switches in the cluster, ensuring coordinated configuration changes and updates. - **Access Control:** Incorporates privilege sets to manage access and operations, ensuring secure configuration management. - **Template Utilization:** Supports the creation and management of switch profiles from templates, promoting consistency and reducing setup time.
type FabricSwitchClusterProfile struct {
	...
	AssignedEntity NullableMoBaseMoRelationship                 `json:"AssignedEntity,omitempty"`
...
// GetAssignedEntity returns the AssignedEntity field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FabricSwitchClusterProfile) GetAssignedEntity() MoBaseMoRelationship {
	if o == nil || IsNil(o.AssignedEntity.Get()) {
		var ret MoBaseMoRelationship
		return ret
	}
	return *o.AssignedEntity.Get()
}

// GetAssignedEntityOk returns a tuple with the AssignedEntity field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetAssignedEntity gets a reference to the given NullableMoBaseMoRelationship and assigns it to the AssignedEntity field.
func (o *FabricSwitchClusterProfile) SetAssignedEntity(v MoBaseMoRelationship) {
	o.AssignedEntity.Set(&v)
}

// SetAssignedEntityNil sets the value for AssignedEntity to be an explicit nil
func (o *FabricSwitchClusterProfile) SetAssignedEntityNil() {
	o.AssignedEntity.Set(nil)
}
...
func (o FabricSwitchClusterProfile) ToMap() (map[string]interface{}, error) {
	...
	if o.AssignedEntity.IsSet() {
		toSerialize["AssignedEntity"] = o.AssignedEntity.Get()
	}
...
func (o *FabricSwitchClusterProfile) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFabricSwitchClusterProfile.Action = varFabricSwitchClusterProfileWithoutEmbeddedStruct.Action
		...
		varFabricSwitchClusterProfile.AssignedEntity = varFabricSwitchClusterProfileWithoutEmbeddedStruct.AssignedEntity
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "AssignedEntity")
