...
// checks if the BootPrecisionPolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootPrecisionPolicyList{}
...
type _BootPrecisionPolicyList BootPrecisionPolicyList

// NewBootPrecisionPolicyList instantiates a new BootPrecisionPolicyList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewBootPrecisionPolicyList(objectType string) *BootPrecisionPolicyList {
...
func (o BootPrecisionPolicyList) ToMap() (map[string]interface{}, error) {
...
func (o *BootPrecisionPolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	type BootPrecisionPolicyListWithoutEmbeddedStruct struct {
		// The total number of 'boot.PrecisionPolicy' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.
		Count *int32 `json:"Count,omitempty"`
		// The array of 'boot.PrecisionPolicy' resources matching the request.
		Results []BootPrecisionPolicy `json:"Results,omitempty"`
	...
	varBootPrecisionPolicyListWithoutEmbeddedStruct := BootPrecisionPolicyListWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varBootPrecisionPolicyListWithoutEmbeddedStruct)
	if err == nil {
		varBootPrecisionPolicyList := _BootPrecisionPolicyList{}
		varBootPrecisionPolicyList.Count = varBootPrecisionPolicyListWithoutEmbeddedStruct.Count
		varBootPrecisionPolicyList.Results = varBootPrecisionPolicyListWithoutEmbeddedStruct.Results
		*o = BootPrecisionPolicyList(varBootPrecisionPolicyList)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varBootPrecisionPolicyList)
	if err == nil {
		o.MoBaseResponse = varBootPrecisionPolicyList.MoBaseResponse
	} else {
		return err
	}
