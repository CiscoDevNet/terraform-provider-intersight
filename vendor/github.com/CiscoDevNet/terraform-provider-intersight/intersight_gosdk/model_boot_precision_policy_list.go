...
func (o *BootPrecisionPolicyList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varBootPrecisionPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varBootPrecisionPolicyList)
	if err == nil {
