...
// StorageNetAppEthernetPortListAllOf struct for StorageNetAppEthernetPortListAllOf
type StorageNetAppEthernetPortListAllOf struct {
...
type _StorageNetAppEthernetPortListAllOf StorageNetAppEthernetPortListAllOf
...
func NewStorageNetAppEthernetPortListAllOf() *StorageNetAppEthernetPortListAllOf {
	this := StorageNetAppEthernetPortListAllOf{}
	return &this
}
...
func (o StorageNetAppEthernetPortListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppEthernetPortListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppEthernetPortListAllOf := _StorageNetAppEthernetPortListAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppEthernetPortListAllOf); err == nil {
		*o = StorageNetAppEthernetPortListAllOf(varStorageNetAppEthernetPortListAllOf)
	}
...
type NullableStorageNetAppEthernetPortListAllOf struct {
	value *StorageNetAppEthernetPortListAllOf
	isSet bool
}

func (v NullableStorageNetAppEthernetPortListAllOf) Get() *StorageNetAppEthernetPortListAllOf {
	return v.value
}

func (v *NullableStorageNetAppEthernetPortListAllOf) Set(val *StorageNetAppEthernetPortListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppEthernetPortListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppEthernetPortListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppEthernetPortListAllOf(val *StorageNetAppEthernetPortListAllOf) *NullableStorageNetAppEthernetPortListAllOf {
	return &NullableStorageNetAppEthernetPortListAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppEthernetPortListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppEthernetPortListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
