...
// ConnectorCommandTerminalStreamAllOf Definition of the list of properties defined in 'connector.CommandTerminalStream', excluding properties defined in parent classes.
type ConnectorCommandTerminalStreamAllOf struct {
...
type _ConnectorCommandTerminalStreamAllOf ConnectorCommandTerminalStreamAllOf
...
func NewConnectorCommandTerminalStreamAllOf(classId string, objectType string) *ConnectorCommandTerminalStreamAllOf {
	this := ConnectorCommandTerminalStreamAllOf{}
...
func (o ConnectorCommandTerminalStreamAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ConnectorCommandTerminalStreamAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varConnectorCommandTerminalStreamAllOf := _ConnectorCommandTerminalStreamAllOf{}

	if err = json.Unmarshal(bytes, &varConnectorCommandTerminalStreamAllOf); err == nil {
		*o = ConnectorCommandTerminalStreamAllOf(varConnectorCommandTerminalStreamAllOf)
	}
...
type NullableConnectorCommandTerminalStreamAllOf struct {
	value *ConnectorCommandTerminalStreamAllOf
	isSet bool
}

func (v NullableConnectorCommandTerminalStreamAllOf) Get() *ConnectorCommandTerminalStreamAllOf {
	return v.value
}

func (v *NullableConnectorCommandTerminalStreamAllOf) Set(val *ConnectorCommandTerminalStreamAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorCommandTerminalStreamAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorCommandTerminalStreamAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorCommandTerminalStreamAllOf(val *ConnectorCommandTerminalStreamAllOf) *NullableConnectorCommandTerminalStreamAllOf {
	return &NullableConnectorCommandTerminalStreamAllOf{value: val, isSet: true}
}

func (v NullableConnectorCommandTerminalStreamAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorCommandTerminalStreamAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
