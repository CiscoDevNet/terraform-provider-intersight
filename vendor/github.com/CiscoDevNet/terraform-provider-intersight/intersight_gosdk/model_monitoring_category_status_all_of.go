...
// MonitoringCategoryStatusAllOf Definition of the list of properties defined in 'monitoring.CategoryStatus', excluding properties defined in parent classes.
type MonitoringCategoryStatusAllOf struct {
...
type _MonitoringCategoryStatusAllOf MonitoringCategoryStatusAllOf
...
func NewMonitoringCategoryStatusAllOf(classId string, objectType string) *MonitoringCategoryStatusAllOf {
	this := MonitoringCategoryStatusAllOf{}
...
func (o MonitoringCategoryStatusAllOf) MarshalJSON() ([]byte, error) {
...
func (o *MonitoringCategoryStatusAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMonitoringCategoryStatusAllOf := _MonitoringCategoryStatusAllOf{}

	if err = json.Unmarshal(bytes, &varMonitoringCategoryStatusAllOf); err == nil {
		*o = MonitoringCategoryStatusAllOf(varMonitoringCategoryStatusAllOf)
	}
...
type NullableMonitoringCategoryStatusAllOf struct {
	value *MonitoringCategoryStatusAllOf
	isSet bool
}

func (v NullableMonitoringCategoryStatusAllOf) Get() *MonitoringCategoryStatusAllOf {
	return v.value
}

func (v *NullableMonitoringCategoryStatusAllOf) Set(val *MonitoringCategoryStatusAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringCategoryStatusAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringCategoryStatusAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringCategoryStatusAllOf(val *MonitoringCategoryStatusAllOf) *NullableMonitoringCategoryStatusAllOf {
	return &NullableMonitoringCategoryStatusAllOf{value: val, isSet: true}
}

func (v NullableMonitoringCategoryStatusAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringCategoryStatusAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
