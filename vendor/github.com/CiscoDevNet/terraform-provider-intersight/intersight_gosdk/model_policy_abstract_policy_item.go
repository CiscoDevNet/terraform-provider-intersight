...
// PolicyAbstractPolicyItem A base abstract class for all sub policy items.
...
func (o *PolicyAbstractPolicyItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varPolicyAbstractPolicyItemWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varPolicyAbstractPolicyItem)
	if err == nil {
