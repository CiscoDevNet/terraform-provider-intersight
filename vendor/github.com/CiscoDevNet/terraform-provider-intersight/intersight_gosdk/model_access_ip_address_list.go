...
// checks if the AccessIpAddressList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessIpAddressList{}
...
func (o AccessIpAddressList) ToMap() (map[string]interface{}, error) {
...
func (o *AccessIpAddressList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAccessIpAddressListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAccessIpAddressList)
	if err == nil {
