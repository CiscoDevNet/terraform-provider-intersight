...
func (o *NiatelemetryAaaRadiusProviderDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryAaaRadiusProviderDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryAaaRadiusProviderDetails)
	if err == nil {
