...
func (o *TaskServerScopedInventory) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTaskServerScopedInventoryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varTaskServerScopedInventory)
	if err == nil {
