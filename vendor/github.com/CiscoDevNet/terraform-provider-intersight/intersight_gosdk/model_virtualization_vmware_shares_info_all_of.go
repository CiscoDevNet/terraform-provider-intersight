...
// VirtualizationVmwareSharesInfoAllOf Definition of the list of properties defined in 'virtualization.VmwareSharesInfo', excluding properties defined in parent classes.
type VirtualizationVmwareSharesInfoAllOf struct {
...
type _VirtualizationVmwareSharesInfoAllOf VirtualizationVmwareSharesInfoAllOf
...
func NewVirtualizationVmwareSharesInfoAllOf(classId string, objectType string) *VirtualizationVmwareSharesInfoAllOf {
	this := VirtualizationVmwareSharesInfoAllOf{}
...
func (o VirtualizationVmwareSharesInfoAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationVmwareSharesInfoAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationVmwareSharesInfoAllOf := _VirtualizationVmwareSharesInfoAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationVmwareSharesInfoAllOf); err == nil {
		*o = VirtualizationVmwareSharesInfoAllOf(varVirtualizationVmwareSharesInfoAllOf)
	}
...
type NullableVirtualizationVmwareSharesInfoAllOf struct {
	value *VirtualizationVmwareSharesInfoAllOf
	isSet bool
}

func (v NullableVirtualizationVmwareSharesInfoAllOf) Get() *VirtualizationVmwareSharesInfoAllOf {
	return v.value
}

func (v *NullableVirtualizationVmwareSharesInfoAllOf) Set(val *VirtualizationVmwareSharesInfoAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmwareSharesInfoAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmwareSharesInfoAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmwareSharesInfoAllOf(val *VirtualizationVmwareSharesInfoAllOf) *NullableVirtualizationVmwareSharesInfoAllOf {
	return &NullableVirtualizationVmwareSharesInfoAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmwareSharesInfoAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmwareSharesInfoAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
