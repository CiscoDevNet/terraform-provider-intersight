...
func StorageVirtualDriveExtensionListAsStorageVirtualDriveExtensionResponse(v *StorageVirtualDriveExtensionList) StorageVirtualDriveExtensionResponse {
	return StorageVirtualDriveExtensionResponse{
		StorageVirtualDriveExtensionList: v,
	}
}
...
func (dst *StorageVirtualDriveExtensionResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageVirtualDriveExtensionResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageVirtualDriveExtensionResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageVirtualDriveExtensionResponse as MoTagSummary: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "storage.VirtualDriveExtension.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageVirtualDriveExtensionResponse as StorageVirtualDriveExtensionList: %s", err.Error())
		}
	}
