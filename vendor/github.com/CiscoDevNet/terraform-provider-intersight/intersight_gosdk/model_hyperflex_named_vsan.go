...
// checks if the HyperflexNamedVsan type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexNamedVsan{}
...
// GetDefaultClassId returns the default value "hyperflex.NamedVsan" of the ClassId field.
func (o *HyperflexNamedVsan) GetDefaultClassId() interface{} {
	return "hyperflex.NamedVsan"
}
...
// GetDefaultObjectType returns the default value "hyperflex.NamedVsan" of the ObjectType field.
func (o *HyperflexNamedVsan) GetDefaultObjectType() interface{} {
	return "hyperflex.NamedVsan"
}
...
func (o HyperflexNamedVsan) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexNamedVsan) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexNamedVsanWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexNamedVsan)
	if err == nil {
