...
// HyperflexTargetListAllOf struct for HyperflexTargetListAllOf
type HyperflexTargetListAllOf struct {
...
type _HyperflexTargetListAllOf HyperflexTargetListAllOf
...
func (o HyperflexTargetListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexTargetListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexTargetListAllOf := _HyperflexTargetListAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexTargetListAllOf); err == nil {
		*o = HyperflexTargetListAllOf(varHyperflexTargetListAllOf)
	}
...
type NullableHyperflexTargetListAllOf struct {
	value *HyperflexTargetListAllOf
	isSet bool
}

func (v NullableHyperflexTargetListAllOf) Get() *HyperflexTargetListAllOf {
	return v.value
}

func (v *NullableHyperflexTargetListAllOf) Set(val *HyperflexTargetListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexTargetListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexTargetListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexTargetListAllOf(val *HyperflexTargetListAllOf) *NullableHyperflexTargetListAllOf {
	return &NullableHyperflexTargetListAllOf{value: val, isSet: true}
}

func (v NullableHyperflexTargetListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexTargetListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
