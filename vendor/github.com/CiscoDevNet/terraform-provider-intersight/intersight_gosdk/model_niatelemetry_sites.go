...
func (o *NiatelemetrySites) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetrySitesWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetrySites)
	if err == nil {
