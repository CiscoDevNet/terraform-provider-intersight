...
func (dst *StorageNetAppLunEventResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageNetAppLunEventResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageNetAppLunEventResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StorageNetAppLunEventResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'storage.NetAppLunEvent.List'
	if jsonDict["ObjectType"] == "storage.NetAppLunEvent.List" {
		// try to unmarshal JSON data into StorageNetAppLunEventList
		err = json.Unmarshal(data, &dst.StorageNetAppLunEventList)
		if err == nil {
			return nil // data stored in dst.StorageNetAppLunEventList, return on the first match
		} else {
			dst.StorageNetAppLunEventList = nil
			return fmt.Errorf("Failed to unmarshal StorageNetAppLunEventResponse as StorageNetAppLunEventList: %s", err.Error())
		}
	}
...
func (src StorageNetAppLunEventResponse) MarshalJSON() ([]byte, error) {
	...
	if src.StorageNetAppLunEventList != nil {
		return json.Marshal(&src.StorageNetAppLunEventList)
	}
...
func (obj *StorageNetAppLunEventResponse) GetActualInstance() interface{} {
	...
	if obj.StorageNetAppLunEventList != nil {
		return obj.StorageNetAppLunEventList
	}
...
type NullableStorageNetAppLunEventResponse struct {
	value *StorageNetAppLunEventResponse
	isSet bool
}

func (v NullableStorageNetAppLunEventResponse) Get() *StorageNetAppLunEventResponse {
	return v.value
}

func (v *NullableStorageNetAppLunEventResponse) Set(val *StorageNetAppLunEventResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppLunEventResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppLunEventResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppLunEventResponse(val *StorageNetAppLunEventResponse) *NullableStorageNetAppLunEventResponse {
	return &NullableStorageNetAppLunEventResponse{value: val, isSet: true}
}

func (v NullableStorageNetAppLunEventResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppLunEventResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
