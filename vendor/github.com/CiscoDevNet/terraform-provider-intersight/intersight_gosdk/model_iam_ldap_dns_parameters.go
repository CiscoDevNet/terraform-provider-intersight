...
// checks if the IamLdapDnsParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamLdapDnsParameters{}
...
type IamLdapDnsParameters struct {
	...
	SearchDomain *string `json:"SearchDomain,omitempty" validate:"regexp=^$|^(([a-zA-Z0-9])|([a-zA-Z0-9][a-zA-Z0-9\\\\.\\\\-]*[a-zA-Z0-9]))$"`
	// Forest name that acts as a source for a DNS query.
	SearchForest *string `json:"SearchForest,omitempty" validate:"regexp=^$|^(([a-zA-Z0-9])|([a-zA-Z0-9][a-zA-Z0-9\\\\.\\\\-]*[a-zA-Z0-9]))$"`
...
// GetDefaultClassId returns the default value "iam.LdapDnsParameters" of the ClassId field.
func (o *IamLdapDnsParameters) GetDefaultClassId() interface{} {
	return "iam.LdapDnsParameters"
}
...
// GetDefaultObjectType returns the default value "iam.LdapDnsParameters" of the ObjectType field.
func (o *IamLdapDnsParameters) GetDefaultObjectType() interface{} {
	return "iam.LdapDnsParameters"
}
...
func (o IamLdapDnsParameters) ToMap() (map[string]interface{}, error) {
...
func (o *IamLdapDnsParameters) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamLdapDnsParametersWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIamLdapDnsParameters)
	if err == nil {
