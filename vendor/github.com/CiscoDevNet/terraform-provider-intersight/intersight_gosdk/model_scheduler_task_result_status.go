...
func (o *SchedulerTaskResultStatus) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSchedulerTaskResultStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSchedulerTaskResultStatus)
	if err == nil {
