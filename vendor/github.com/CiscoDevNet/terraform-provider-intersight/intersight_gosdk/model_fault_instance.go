...
// GetDefaultClassId returns the default value "fault.Instance" of the ClassId field.
func (o *FaultInstance) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "fault.Instance" of the ObjectType field.
func (o *FaultInstance) GetDefaultObjectType() interface{} {
	return "fault.Instance"
}
...
func (o *FaultInstance) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFaultInstance.AffectedMo = varFaultInstanceWithoutEmbeddedStruct.AffectedMo
		varFaultInstance.AncestorMo = varFaultInstanceWithoutEmbeddedStruct.AncestorMo
