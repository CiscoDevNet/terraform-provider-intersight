...
// StorageBaseTargetAllOf Definition of the list of properties defined in 'storage.BaseTarget', excluding properties defined in parent classes.
type StorageBaseTargetAllOf struct {
...
type _StorageBaseTargetAllOf StorageBaseTargetAllOf
...
func (o StorageBaseTargetAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageBaseTargetAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageBaseTargetAllOf := _StorageBaseTargetAllOf{}

	if err = json.Unmarshal(bytes, &varStorageBaseTargetAllOf); err == nil {
		*o = StorageBaseTargetAllOf(varStorageBaseTargetAllOf)
	}
...
type NullableStorageBaseTargetAllOf struct {
	value *StorageBaseTargetAllOf
	isSet bool
}

func (v NullableStorageBaseTargetAllOf) Get() *StorageBaseTargetAllOf {
	return v.value
}

func (v *NullableStorageBaseTargetAllOf) Set(val *StorageBaseTargetAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageBaseTargetAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageBaseTargetAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageBaseTargetAllOf(val *StorageBaseTargetAllOf) *NullableStorageBaseTargetAllOf {
	return &NullableStorageBaseTargetAllOf{value: val, isSet: true}
}

func (v NullableStorageBaseTargetAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageBaseTargetAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
