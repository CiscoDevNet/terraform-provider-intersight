...
// The &#39;terraform.Executor&#39; resource to create.
func (r ApiCreateTerraformExecutorRequest) TerraformExecutor(terraformExecutor TerraformExecutor) ApiCreateTerraformExecutorRequest {
	r.terraformExecutor = &terraformExecutor
	return r
}
...
func (r ApiCreateTerraformExecutorRequest) IfMatch(ifMatch string) ApiCreateTerraformExecutorRequest {
	r.ifMatch = &ifMatch
	return r
}
...
func (r ApiCreateTerraformExecutorRequest) IfNoneMatch(ifNoneMatch string) ApiCreateTerraformExecutorRequest {
...
func (r ApiGetTerraformExecutorListRequest) Filter(filter string) ApiGetTerraformExecutorListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetTerraformExecutorListRequest) Orderby(orderby string) ApiGetTerraformExecutorListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetTerraformExecutorListRequest) Top(top int32) ApiGetTerraformExecutorListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetTerraformExecutorListRequest) Skip(skip int32) ApiGetTerraformExecutorListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetTerraformExecutorListRequest) Select_(select_ string) ApiGetTerraformExecutorListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetTerraformExecutorListRequest) Expand(expand string) ApiGetTerraformExecutorListRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetTerraformExecutorListRequest) Apply(apply string) ApiGetTerraformExecutorListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetTerraformExecutorListRequest) Count(count bool) ApiGetTerraformExecutorListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetTerraformExecutorListRequest) Inlinecount(inlinecount string) ApiGetTerraformExecutorListRequest {
...
func (r ApiGetTerraformExecutorListRequest) At(at string) ApiGetTerraformExecutorListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetTerraformExecutorListRequest) Tags(tags string) ApiGetTerraformExecutorListRequest {
	r.tags = &tags
	return r
}
...
// The &#39;terraform.Executor&#39; resource to update.
func (r ApiPatchTerraformExecutorRequest) TerraformExecutor(terraformExecutor TerraformExecutor) ApiPatchTerraformExecutorRequest {
	r.terraformExecutor = &terraformExecutor
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiPatchTerraformExecutorRequest) IfMatch(ifMatch string) ApiPatchTerraformExecutorRequest {
	r.ifMatch = &ifMatch
	return r
}
...
// The &#39;terraform.Executor&#39; resource to update.
func (r ApiUpdateTerraformExecutorRequest) TerraformExecutor(terraformExecutor TerraformExecutor) ApiUpdateTerraformExecutorRequest {
	r.terraformExecutor = &terraformExecutor
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiUpdateTerraformExecutorRequest) IfMatch(ifMatch string) ApiUpdateTerraformExecutorRequest {
	r.ifMatch = &ifMatch
	return r
}
