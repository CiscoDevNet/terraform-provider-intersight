...
// checks if the WorkflowErrorResponseHandler type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowErrorResponseHandler{}
...
// GetDefaultClassId returns the default value "workflow.ErrorResponseHandler" of the ClassId field.
func (o *WorkflowErrorResponseHandler) GetDefaultClassId() interface{} {
	return "workflow.ErrorResponseHandler"
}
...
// GetDefaultObjectType returns the default value "workflow.ErrorResponseHandler" of the ObjectType field.
func (o *WorkflowErrorResponseHandler) GetDefaultObjectType() interface{} {
	return "workflow.ErrorResponseHandler"
}
...
func (o *WorkflowErrorResponseHandler) SetCatalogNil() {
	o.Catalog.Set(nil)
}

// UnsetCatalog ensures that no value is present for Catalog, not even an explicit nil
func (o *WorkflowErrorResponseHandler) UnsetCatalog() {
	o.Catalog.Unset()
}
...
func (o WorkflowErrorResponseHandler) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowErrorResponseHandler) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowErrorResponseHandlerWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowErrorResponseHandler)
	if err == nil {
