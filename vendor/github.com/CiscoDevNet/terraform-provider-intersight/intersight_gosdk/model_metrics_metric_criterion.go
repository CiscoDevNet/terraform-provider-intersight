...
func (o *MetricsMetricCriterion) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMetricsMetricCriterionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varMetricsMetricCriterion)
	if err == nil {
