...
// ComputeStoragePhysicalDriveAllOf Definition of the list of properties defined in 'compute.StoragePhysicalDrive', excluding properties defined in parent classes.
type ComputeStoragePhysicalDriveAllOf struct {
...
type _ComputeStoragePhysicalDriveAllOf ComputeStoragePhysicalDriveAllOf
...
func NewComputeStoragePhysicalDriveAllOf(classId string, objectType string) *ComputeStoragePhysicalDriveAllOf {
	this := ComputeStoragePhysicalDriveAllOf{}
...
func (o ComputeStoragePhysicalDriveAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ComputeStoragePhysicalDriveAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varComputeStoragePhysicalDriveAllOf := _ComputeStoragePhysicalDriveAllOf{}

	if err = json.Unmarshal(bytes, &varComputeStoragePhysicalDriveAllOf); err == nil {
		*o = ComputeStoragePhysicalDriveAllOf(varComputeStoragePhysicalDriveAllOf)
	}
...
type NullableComputeStoragePhysicalDriveAllOf struct {
	value *ComputeStoragePhysicalDriveAllOf
	isSet bool
}

func (v NullableComputeStoragePhysicalDriveAllOf) Get() *ComputeStoragePhysicalDriveAllOf {
	return v.value
}

func (v *NullableComputeStoragePhysicalDriveAllOf) Set(val *ComputeStoragePhysicalDriveAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableComputeStoragePhysicalDriveAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableComputeStoragePhysicalDriveAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputeStoragePhysicalDriveAllOf(val *ComputeStoragePhysicalDriveAllOf) *NullableComputeStoragePhysicalDriveAllOf {
	return &NullableComputeStoragePhysicalDriveAllOf{value: val, isSet: true}
}

func (v NullableComputeStoragePhysicalDriveAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputeStoragePhysicalDriveAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
