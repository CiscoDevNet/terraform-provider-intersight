...
func (o *OpenapiKeyValuePair) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOpenapiKeyValuePairWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varOpenapiKeyValuePair)
	if err == nil {
