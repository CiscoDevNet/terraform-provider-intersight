...
func HyperflexLocalCredentialPolicyListAsHyperflexLocalCredentialPolicyResponse(v *HyperflexLocalCredentialPolicyList) HyperflexLocalCredentialPolicyResponse {
	return HyperflexLocalCredentialPolicyResponse{
		HyperflexLocalCredentialPolicyList: v,
	}
}
...
func (dst *HyperflexLocalCredentialPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'hyperflex.LocalCredentialPolicy.List'
	if jsonDict["ObjectType"] == "hyperflex.LocalCredentialPolicy.List" {
		// try to unmarshal JSON data into HyperflexLocalCredentialPolicyList
		err = json.Unmarshal(data, &dst.HyperflexLocalCredentialPolicyList)
		if err == nil {
			return nil // data stored in dst.HyperflexLocalCredentialPolicyList, return on the first match
		} else {
			dst.HyperflexLocalCredentialPolicyList = nil
			return fmt.Errorf("Failed to unmarshal HyperflexLocalCredentialPolicyResponse as HyperflexLocalCredentialPolicyList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexLocalCredentialPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexLocalCredentialPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexLocalCredentialPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src HyperflexLocalCredentialPolicyResponse) MarshalJSON() ([]byte, error) {
	if src.HyperflexLocalCredentialPolicyList != nil {
		return json.Marshal(&src.HyperflexLocalCredentialPolicyList)
	}
...
type NullableHyperflexLocalCredentialPolicyResponse struct {
	value *HyperflexLocalCredentialPolicyResponse
	isSet bool
}

func (v NullableHyperflexLocalCredentialPolicyResponse) Get() *HyperflexLocalCredentialPolicyResponse {
	return v.value
}

func (v *NullableHyperflexLocalCredentialPolicyResponse) Set(val *HyperflexLocalCredentialPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexLocalCredentialPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexLocalCredentialPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexLocalCredentialPolicyResponse(val *HyperflexLocalCredentialPolicyResponse) *NullableHyperflexLocalCredentialPolicyResponse {
	return &NullableHyperflexLocalCredentialPolicyResponse{value: val, isSet: true}
}

func (v NullableHyperflexLocalCredentialPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexLocalCredentialPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
