...
// CapabilityFexCapabilityDefListAllOf struct for CapabilityFexCapabilityDefListAllOf
type CapabilityFexCapabilityDefListAllOf struct {
...
type _CapabilityFexCapabilityDefListAllOf CapabilityFexCapabilityDefListAllOf
...
func NewCapabilityFexCapabilityDefListAllOf() *CapabilityFexCapabilityDefListAllOf {
	this := CapabilityFexCapabilityDefListAllOf{}
	return &this
}
...
func (o CapabilityFexCapabilityDefListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CapabilityFexCapabilityDefListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCapabilityFexCapabilityDefListAllOf := _CapabilityFexCapabilityDefListAllOf{}

	if err = json.Unmarshal(bytes, &varCapabilityFexCapabilityDefListAllOf); err == nil {
		*o = CapabilityFexCapabilityDefListAllOf(varCapabilityFexCapabilityDefListAllOf)
	}
...
type NullableCapabilityFexCapabilityDefListAllOf struct {
	value *CapabilityFexCapabilityDefListAllOf
	isSet bool
}

func (v NullableCapabilityFexCapabilityDefListAllOf) Get() *CapabilityFexCapabilityDefListAllOf {
	return v.value
}

func (v *NullableCapabilityFexCapabilityDefListAllOf) Set(val *CapabilityFexCapabilityDefListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityFexCapabilityDefListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityFexCapabilityDefListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityFexCapabilityDefListAllOf(val *CapabilityFexCapabilityDefListAllOf) *NullableCapabilityFexCapabilityDefListAllOf {
	return &NullableCapabilityFexCapabilityDefListAllOf{value: val, isSet: true}
}

func (v NullableCapabilityFexCapabilityDefListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityFexCapabilityDefListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
