...
// ServerConfigChangeDetailAllOf Definition of the list of properties defined in 'server.ConfigChangeDetail', excluding properties defined in parent classes.
type ServerConfigChangeDetailAllOf struct {
...
type _ServerConfigChangeDetailAllOf ServerConfigChangeDetailAllOf
...
func NewServerConfigChangeDetailAllOf(classId string, objectType string) *ServerConfigChangeDetailAllOf {
	this := ServerConfigChangeDetailAllOf{}
...
func (o ServerConfigChangeDetailAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ServerConfigChangeDetailAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varServerConfigChangeDetailAllOf := _ServerConfigChangeDetailAllOf{}

	if err = json.Unmarshal(bytes, &varServerConfigChangeDetailAllOf); err == nil {
		*o = ServerConfigChangeDetailAllOf(varServerConfigChangeDetailAllOf)
	}
...
type NullableServerConfigChangeDetailAllOf struct {
	value *ServerConfigChangeDetailAllOf
	isSet bool
}

func (v NullableServerConfigChangeDetailAllOf) Get() *ServerConfigChangeDetailAllOf {
	return v.value
}

func (v *NullableServerConfigChangeDetailAllOf) Set(val *ServerConfigChangeDetailAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableServerConfigChangeDetailAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableServerConfigChangeDetailAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerConfigChangeDetailAllOf(val *ServerConfigChangeDetailAllOf) *NullableServerConfigChangeDetailAllOf {
	return &NullableServerConfigChangeDetailAllOf{value: val, isSet: true}
}

func (v NullableServerConfigChangeDetailAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerConfigChangeDetailAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
