...
// checks if the VirtualizationVmwareSharesInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationVmwareSharesInfo{}
...
// GetDefaultClassId returns the default value "virtualization.VmwareSharesInfo" of the ClassId field.
func (o *VirtualizationVmwareSharesInfo) GetDefaultClassId() interface{} {
	return "virtualization.VmwareSharesInfo"
}
...
// GetDefaultObjectType returns the default value "virtualization.VmwareSharesInfo" of the ObjectType field.
func (o *VirtualizationVmwareSharesInfo) GetDefaultObjectType() interface{} {
	return "virtualization.VmwareSharesInfo"
}
...
func (o VirtualizationVmwareSharesInfo) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationVmwareSharesInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareSharesInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareSharesInfo)
	if err == nil {
