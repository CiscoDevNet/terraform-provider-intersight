...
type IamLdapPolicyAllOf struct {
	...
	Var0Idp              *IamIdpRelationship     `json:"_0_Idp,omitempty"`
...
type _IamLdapPolicyAllOf IamLdapPolicyAllOf
...
func (o *IamLdapPolicyAllOf) SetBasePropertiesNil() {
...
func (o *IamLdapPolicyAllOf) SetDnsParametersNil() {
...
func (o *IamLdapPolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamLdapPolicyAllOf := _IamLdapPolicyAllOf{}

	if err = json.Unmarshal(bytes, &varIamLdapPolicyAllOf); err == nil {
		*o = IamLdapPolicyAllOf(varIamLdapPolicyAllOf)
	}
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_0_Idp")
