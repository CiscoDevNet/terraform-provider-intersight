...
type VirtualizationVmwareVirtualDisk struct {
	...
	// Specifies whether the virtual disk is a RDM or a flat disk. * `flatDisk` - Specifies that it is a flat disk. * `rdmDisk` - Specifies that it is a raw device mapping disk.
