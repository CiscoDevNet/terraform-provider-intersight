...
// checks if the FabricPortMode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricPortMode{}
...
// GetDefaultClassId returns the default value "fabric.PortMode" of the ClassId field.
func (o *FabricPortMode) GetDefaultClassId() interface{} {
	return "fabric.PortMode"
}
...
// GetDefaultObjectType returns the default value "fabric.PortMode" of the ObjectType field.
func (o *FabricPortMode) GetDefaultObjectType() interface{} {
	return "fabric.PortMode"
}
...
func (o *FabricPortMode) SetPortPolicyNil() {
...
func (o FabricPortMode) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PortIdEnd) {
		toSerialize["PortIdEnd"] = o.PortIdEnd
	}
	if !IsNil(o.PortIdStart) {
...
func (o *FabricPortMode) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricPortModeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricPortMode)
	if err == nil {
