...
// checks if the CapabilitySiocModuleCapabilityDefList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilitySiocModuleCapabilityDefList{}
...
func (o CapabilitySiocModuleCapabilityDefList) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilitySiocModuleCapabilityDefList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilitySiocModuleCapabilityDefListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilitySiocModuleCapabilityDefList)
	if err == nil {
