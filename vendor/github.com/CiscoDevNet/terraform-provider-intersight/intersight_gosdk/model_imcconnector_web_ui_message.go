...
// checks if the ImcconnectorWebUiMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImcconnectorWebUiMessage{}
...
// GetDefaultClassId returns the default value "imcconnector.WebUiMessage" of the ClassId field.
func (o *ImcconnectorWebUiMessage) GetDefaultClassId() interface{} {
	return "imcconnector.WebUiMessage"
}
...
// GetDefaultObjectType returns the default value "imcconnector.WebUiMessage" of the ObjectType field.
func (o *ImcconnectorWebUiMessage) GetDefaultObjectType() interface{} {
	return "imcconnector.WebUiMessage"
}
...
func (o ImcconnectorWebUiMessage) ToMap() (map[string]interface{}, error) {
...
func (o *ImcconnectorWebUiMessage) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varImcconnectorWebUiMessageWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varImcconnectorWebUiMessage)
	if err == nil {
