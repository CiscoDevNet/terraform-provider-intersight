...
// checks if the RecoveryConfigParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryConfigParams{}

// RecoveryConfigParams Restore workflows configuration parameters.
type RecoveryConfigParams struct {
	MoBaseComplexType
	AdditionalProperties map[string]interface{}
}

type _RecoveryConfigParams RecoveryConfigParams

// NewRecoveryConfigParams instantiates a new RecoveryConfigParams object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRecoveryConfigParams(classId string, objectType string) *RecoveryConfigParams {
...
func (o RecoveryConfigParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryConfigParams) UnmarshalJSON(data []byte) (err error) {
	...
	type RecoveryConfigParamsWithoutEmbeddedStruct struct {
	}

	varRecoveryConfigParamsWithoutEmbeddedStruct := RecoveryConfigParamsWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varRecoveryConfigParamsWithoutEmbeddedStruct)
	if err == nil {
		varRecoveryConfigParams := _RecoveryConfigParams{}
		*o = RecoveryConfigParams(varRecoveryConfigParams)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varRecoveryConfigParams)
	if err == nil {
		o.MoBaseComplexType = varRecoveryConfigParams.MoBaseComplexType
	} else {
		return err
	}
