...
func (o *RecoveryConfigParams) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varRecoveryConfigParamsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varRecoveryConfigParams)
	if err == nil {
