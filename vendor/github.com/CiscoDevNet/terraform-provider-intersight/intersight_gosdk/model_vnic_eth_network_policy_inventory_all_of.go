...
// VnicEthNetworkPolicyInventoryAllOf Definition of the list of properties defined in 'vnic.EthNetworkPolicyInventory', excluding properties defined in parent classes.
type VnicEthNetworkPolicyInventoryAllOf struct {
...
type _VnicEthNetworkPolicyInventoryAllOf VnicEthNetworkPolicyInventoryAllOf
...
func NewVnicEthNetworkPolicyInventoryAllOf(classId string, objectType string) *VnicEthNetworkPolicyInventoryAllOf {
	this := VnicEthNetworkPolicyInventoryAllOf{}
...
func (o *VnicEthNetworkPolicyInventoryAllOf) SetVlanSettingsNil() {
...
func (o VnicEthNetworkPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicEthNetworkPolicyInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicEthNetworkPolicyInventoryAllOf := _VnicEthNetworkPolicyInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varVnicEthNetworkPolicyInventoryAllOf); err == nil {
		*o = VnicEthNetworkPolicyInventoryAllOf(varVnicEthNetworkPolicyInventoryAllOf)
	}
...
type NullableVnicEthNetworkPolicyInventoryAllOf struct {
	value *VnicEthNetworkPolicyInventoryAllOf
	isSet bool
}

func (v NullableVnicEthNetworkPolicyInventoryAllOf) Get() *VnicEthNetworkPolicyInventoryAllOf {
	return v.value
}

func (v *NullableVnicEthNetworkPolicyInventoryAllOf) Set(val *VnicEthNetworkPolicyInventoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicEthNetworkPolicyInventoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicEthNetworkPolicyInventoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicEthNetworkPolicyInventoryAllOf(val *VnicEthNetworkPolicyInventoryAllOf) *NullableVnicEthNetworkPolicyInventoryAllOf {
	return &NullableVnicEthNetworkPolicyInventoryAllOf{value: val, isSet: true}
}

func (v NullableVnicEthNetworkPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicEthNetworkPolicyInventoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
