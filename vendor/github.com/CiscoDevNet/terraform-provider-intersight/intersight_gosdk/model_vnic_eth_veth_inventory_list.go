...
func (o *VnicEthVethInventoryList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVnicEthVethInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVnicEthVethInventoryList)
	if err == nil {
