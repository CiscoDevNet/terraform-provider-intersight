...
// MotemplateActionParamAllOf Definition of the list of properties defined in 'motemplate.ActionParam', excluding properties defined in parent classes.
type MotemplateActionParamAllOf struct {
...
type _MotemplateActionParamAllOf MotemplateActionParamAllOf
...
func NewMotemplateActionParamAllOf(classId string, objectType string) *MotemplateActionParamAllOf {
	this := MotemplateActionParamAllOf{}
...
func (o MotemplateActionParamAllOf) MarshalJSON() ([]byte, error) {
...
func (o *MotemplateActionParamAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMotemplateActionParamAllOf := _MotemplateActionParamAllOf{}

	if err = json.Unmarshal(bytes, &varMotemplateActionParamAllOf); err == nil {
		*o = MotemplateActionParamAllOf(varMotemplateActionParamAllOf)
	}
...
type NullableMotemplateActionParamAllOf struct {
	value *MotemplateActionParamAllOf
	isSet bool
}

func (v NullableMotemplateActionParamAllOf) Get() *MotemplateActionParamAllOf {
	return v.value
}

func (v *NullableMotemplateActionParamAllOf) Set(val *MotemplateActionParamAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMotemplateActionParamAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMotemplateActionParamAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMotemplateActionParamAllOf(val *MotemplateActionParamAllOf) *NullableMotemplateActionParamAllOf {
	return &NullableMotemplateActionParamAllOf{value: val, isSet: true}
}

func (v NullableMotemplateActionParamAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMotemplateActionParamAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
