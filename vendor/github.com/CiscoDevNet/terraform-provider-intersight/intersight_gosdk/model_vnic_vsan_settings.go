...
// checks if the VnicVsanSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicVsanSettings{}
...
// GetDefaultClassId returns the default value "vnic.VsanSettings" of the ClassId field.
func (o *VnicVsanSettings) GetDefaultClassId() interface{} {
	return "vnic.VsanSettings"
}
...
// GetDefaultObjectType returns the default value "vnic.VsanSettings" of the ObjectType field.
func (o *VnicVsanSettings) GetDefaultObjectType() interface{} {
	return "vnic.VsanSettings"
}
...
func (o VnicVsanSettings) ToMap() (map[string]interface{}, error) {
...
func (o *VnicVsanSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicVsanSettingsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVnicVsanSettings)
	if err == nil {
