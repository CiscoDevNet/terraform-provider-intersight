...
func (o *TechsupportmanagementPlatformParam) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTechsupportmanagementPlatformParamWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varTechsupportmanagementPlatformParam)
	if err == nil {
