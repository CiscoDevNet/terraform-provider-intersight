...
// checks if the VirtualizationEsxiVmNetworkConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationEsxiVmNetworkConfiguration{}
...
// GetDefaultClassId returns the default value "virtualization.EsxiVmNetworkConfiguration" of the ClassId field.
func (o *VirtualizationEsxiVmNetworkConfiguration) GetDefaultClassId() interface{} {
	return "virtualization.EsxiVmNetworkConfiguration"
}
...
// GetDefaultObjectType returns the default value "virtualization.EsxiVmNetworkConfiguration" of the ObjectType field.
func (o *VirtualizationEsxiVmNetworkConfiguration) GetDefaultObjectType() interface{} {
	return "virtualization.EsxiVmNetworkConfiguration"
}
...
func (o VirtualizationEsxiVmNetworkConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationEsxiVmNetworkConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiVmNetworkConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiVmNetworkConfiguration)
	if err == nil {
