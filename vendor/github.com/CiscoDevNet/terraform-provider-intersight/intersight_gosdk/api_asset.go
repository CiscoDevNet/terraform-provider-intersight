...
func (r ApiCreateAssetDeviceClaimRequest) Execute() (*AssetDeviceClaim, *http.Response, error) {
...
func (r ApiCreateAssetDeviceContractNotificationRequest) AssetDeviceContractNotification(assetDeviceContractNotification AssetDeviceContractNotification) ApiCreateAssetDeviceContractNotificationRequest {
...
func (r ApiCreateAssetDeviceContractNotificationRequest) Execute() (*AssetDeviceContractNotification, *http.Response, error) {
	return r.ApiService.CreateAssetDeviceContractNotificationExecute(r)
}
...
func (a *AssetApiService) CreateAssetDeviceContractNotificationExecute(r ApiCreateAssetDeviceContractNotificationRequest) (*AssetDeviceContractNotification, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AssetDeviceContractNotification
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.CreateAssetDeviceContractNotification")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/asset/DeviceContractNotifications"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.assetDeviceContractNotification == nil {
		return localVarReturnValue, nil, reportError("assetDeviceContractNotification is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.assetDeviceContractNotification
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiCreateAssetGeoLocationRequest struct {
	ctx              context.Context
	ApiService       *AssetApiService
...
// The &#39;asset.GeoLocation&#39; resource to create.
func (r ApiCreateAssetGeoLocationRequest) AssetGeoLocation(assetGeoLocation AssetGeoLocation) ApiCreateAssetGeoLocationRequest {
	r.assetGeoLocation = &assetGeoLocation
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiCreateAssetGeoLocationRequest) IfMatch(ifMatch string) ApiCreateAssetGeoLocationRequest {
	r.ifMatch = &ifMatch
	return r
}

// For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte.
func (r ApiCreateAssetGeoLocationRequest) IfNoneMatch(ifNoneMatch string) ApiCreateAssetGeoLocationRequest {
	r.ifNoneMatch = &ifNoneMatch
	return r
}

func (r ApiCreateAssetGeoLocationRequest) Execute() (*AssetGeoLocation, *http.Response, error) {
	return r.ApiService.CreateAssetGeoLocationExecute(r)
}

/*
CreateAssetGeoLocation Create a 'asset.GeoLocation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateAssetGeoLocationRequest
*/
func (a *AssetApiService) CreateAssetGeoLocation(ctx context.Context) ApiCreateAssetGeoLocationRequest {
	return ApiCreateAssetGeoLocationRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AssetApiService) CreateAssetGeoLocationExecute(r ApiCreateAssetGeoLocationRequest) (*AssetGeoLocation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AssetGeoLocation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.CreateAssetGeoLocation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/asset/GeoLocations"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.assetGeoLocation == nil {
		return localVarReturnValue, nil, reportError("assetGeoLocation is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.assetGeoLocation
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiCreateAssetTargetRequest) Execute() (*AssetTarget, *http.Response, error) {
...
type ApiDeleteAssetClusterMemberRequest struct {
	ctx        context.Context
	ApiService *AssetApiService
	moid       string
}

func (r ApiDeleteAssetClusterMemberRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteAssetClusterMemberExecute(r)
}
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetClusterMemberExecute(r ApiDeleteAssetClusterMemberRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.DeleteAssetClusterMember")
	if err != nil {
...
func (r ApiDeleteAssetDeploymentRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetDeploymentExecute(r ApiDeleteAssetDeploymentRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiDeleteAssetDeploymentDeviceRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetDeploymentDeviceExecute(r ApiDeleteAssetDeploymentDeviceRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiDeleteAssetDeviceClaimRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetDeviceClaimExecute(r ApiDeleteAssetDeviceClaimRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiDeleteAssetDeviceContractInformationRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetDeviceContractInformationExecute(r ApiDeleteAssetDeviceContractInformationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiDeleteAssetDeviceRegistrationRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetDeviceRegistrationExecute(r ApiDeleteAssetDeviceRegistrationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
type ApiDeleteAssetGeoLocationRequest struct {
	ctx        context.Context
	ApiService *AssetApiService
	moid       string
}

func (r ApiDeleteAssetGeoLocationRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteAssetGeoLocationExecute(r)
}

/*
DeleteAssetGeoLocation Delete a 'asset.GeoLocation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiDeleteAssetGeoLocationRequest
*/
func (a *AssetApiService) DeleteAssetGeoLocation(ctx context.Context, moid string) ApiDeleteAssetGeoLocationRequest {
	return ApiDeleteAssetGeoLocationRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetGeoLocationExecute(r ApiDeleteAssetGeoLocationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.DeleteAssetGeoLocation")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/asset/GeoLocations/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
func (r ApiDeleteAssetSubscriptionRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetSubscriptionExecute(r ApiDeleteAssetSubscriptionRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiDeleteAssetSubscriptionAccountRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetSubscriptionAccountExecute(r ApiDeleteAssetSubscriptionAccountRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiDeleteAssetTargetRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *AssetApiService) DeleteAssetTargetExecute(r ApiDeleteAssetTargetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
...
func (r ApiGetAssetClusterMemberByMoidRequest) Execute() (*AssetClusterMember, *http.Response, error) {
...
func (r ApiGetAssetClusterMemberListRequest) Execute() (*AssetClusterMemberResponse, *http.Response, error) {
...
func (r ApiGetAssetDeploymentByMoidRequest) Execute() (*AssetDeployment, *http.Response, error) {
...
func (r ApiGetAssetDeploymentDeviceByMoidRequest) Execute() (*AssetDeploymentDevice, *http.Response, error) {
...
func (r ApiGetAssetDeploymentDeviceListRequest) Execute() (*AssetDeploymentDeviceResponse, *http.Response, error) {
...
func (r ApiGetAssetDeploymentListRequest) Execute() (*AssetDeploymentResponse, *http.Response, error) {
...
func (r ApiGetAssetDeviceConfigurationByMoidRequest) Execute() (*AssetDeviceConfiguration, *http.Response, error) {
...
func (r ApiGetAssetDeviceConfigurationListRequest) Execute() (*AssetDeviceConfigurationResponse, *http.Response, error) {
...
func (r ApiGetAssetDeviceConnectorManagerByMoidRequest) Execute() (*AssetDeviceConnectorManager, *http.Response, error) {
...
func (r ApiGetAssetDeviceConnectorManagerListRequest) Execute() (*AssetDeviceConnectorManagerResponse, *http.Response, error) {
...
func (r ApiGetAssetDeviceContractInformationByMoidRequest) Execute() (*AssetDeviceContractInformation, *http.Response, error) {
...
func (r ApiGetAssetDeviceContractInformationListRequest) Execute() (*AssetDeviceContractInformationResponse, *http.Response, error) {
...
func (r ApiGetAssetDeviceRegistrationByMoidRequest) Execute() (*AssetDeviceRegistration, *http.Response, error) {
...
func (r ApiGetAssetDeviceRegistrationListRequest) Execute() (*AssetDeviceRegistrationResponse, *http.Response, error) {
...
type ApiGetAssetGeoLocationByMoidRequest struct {
	ctx        context.Context
	ApiService *AssetApiService
	moid       string
}

func (r ApiGetAssetGeoLocationByMoidRequest) Execute() (*AssetGeoLocation, *http.Response, error) {
	return r.ApiService.GetAssetGeoLocationByMoidExecute(r)
}

/*
GetAssetGeoLocationByMoid Read a 'asset.GeoLocation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiGetAssetGeoLocationByMoidRequest
*/
func (a *AssetApiService) GetAssetGeoLocationByMoid(ctx context.Context, moid string) ApiGetAssetGeoLocationByMoidRequest {
	return ApiGetAssetGeoLocationByMoidRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return AssetGeoLocation
func (a *AssetApiService) GetAssetGeoLocationByMoidExecute(r ApiGetAssetGeoLocationByMoidRequest) (*AssetGeoLocation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.GetAssetGeoLocationByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetAssetGeoLocationListRequest struct {
	ctx         context.Context
	ApiService  *AssetApiService
	filter      *string
	orderby     *string
...
// Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
func (r ApiGetAssetGeoLocationListRequest) Filter(filter string) ApiGetAssetGeoLocationListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetAssetGeoLocationListRequest) Orderby(orderby string) ApiGetAssetGeoLocationListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetAssetGeoLocationListRequest) Top(top int32) ApiGetAssetGeoLocationListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetAssetGeoLocationListRequest) Skip(skip int32) ApiGetAssetGeoLocationListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetAssetGeoLocationListRequest) Select_(select_ string) ApiGetAssetGeoLocationListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetAssetGeoLocationListRequest) Expand(expand string) ApiGetAssetGeoLocationListRequest {
	r.expand = &expand
	return r
}

// Specify one or more transformation operations to perform aggregation on the resources. The transformations are processed in order with the output from a transformation being used as input for the subsequent transformation. The \&quot;$apply\&quot; query takes a sequence of set transformations, separated by forward slashes to express that they are consecutively applied, i.e., the result of each transformation is the input to the next transformation. Supported aggregation methods are \&quot;aggregate\&quot; and \&quot;groupby\&quot;. The **aggregate** transformation takes a comma-separated list of one or more aggregate expressions as parameters and returns a result set with a single instance, representing the aggregated value for all instances in the input set. The **groupby** transformation takes one or two parameters and 1. Splits the initial set into subsets where all instances in a subset have the same values for the grouping properties specified in the first parameter, 2. Applies set transformations to each subset according to the second parameter, resulting in a new set of potentially different structure and cardinality, 3. Ensures that the instances in the result set contain all grouping properties with the correct values for the group, 4. Concatenates the intermediate result sets into one result set. A groupby transformation affects the structure of the result set.
func (r ApiGetAssetGeoLocationListRequest) Apply(apply string) ApiGetAssetGeoLocationListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetAssetGeoLocationListRequest) Count(count bool) ApiGetAssetGeoLocationListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetAssetGeoLocationListRequest) Inlinecount(inlinecount string) ApiGetAssetGeoLocationListRequest {
	r.inlinecount = &inlinecount
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetAssetGeoLocationListRequest) At(at string) ApiGetAssetGeoLocationListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetAssetGeoLocationListRequest) Tags(tags string) ApiGetAssetGeoLocationListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetAssetGeoLocationListRequest) Execute() (*AssetGeoLocationResponse, *http.Response, error) {
	return r.ApiService.GetAssetGeoLocationListExecute(r)
}

/*
GetAssetGeoLocationList Read a 'asset.GeoLocation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetAssetGeoLocationListRequest
*/
func (a *AssetApiService) GetAssetGeoLocationList(ctx context.Context) ApiGetAssetGeoLocationListRequest {
	return ApiGetAssetGeoLocationListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return AssetGeoLocationResponse
func (a *AssetApiService) GetAssetGeoLocationListExecute(r ApiGetAssetGeoLocationListRequest) (*AssetGeoLocationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AssetGeoLocationResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.GetAssetGeoLocationList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetAssetSubscriptionAccountByMoidRequest) Execute() (*AssetSubscriptionAccount, *http.Response, error) {
...
func (r ApiGetAssetSubscriptionAccountListRequest) Execute() (*AssetSubscriptionAccountResponse, *http.Response, error) {
...
func (r ApiGetAssetSubscriptionByMoidRequest) Execute() (*AssetSubscription, *http.Response, error) {
...
func (r ApiGetAssetSubscriptionDeviceContractInformationByMoidRequest) Execute() (*AssetSubscriptionDeviceContractInformation, *http.Response, error) {
...
func (r ApiGetAssetSubscriptionDeviceContractInformationListRequest) Execute() (*AssetSubscriptionDeviceContractInformationResponse, *http.Response, error) {
...
func (r ApiGetAssetSubscriptionListRequest) Execute() (*AssetSubscriptionResponse, *http.Response, error) {
...
func (r ApiGetAssetTargetByMoidRequest) Execute() (*AssetTarget, *http.Response, error) {
...
func (r ApiGetAssetTargetListRequest) Execute() (*AssetTargetResponse, *http.Response, error) {
...
func (r ApiPatchAssetDeviceConfigurationRequest) Execute() (*AssetDeviceConfiguration, *http.Response, error) {
...
func (r ApiPatchAssetDeviceContractInformationRequest) Execute() (*AssetDeviceContractInformation, *http.Response, error) {
...
func (r ApiPatchAssetDeviceRegistrationRequest) Execute() (*AssetDeviceRegistration, *http.Response, error) {
...
type ApiPatchAssetGeoLocationRequest struct {
	ctx              context.Context
	ApiService       *AssetApiService
	moid             string
	assetGeoLocation *AssetGeoLocation
...
// The &#39;asset.GeoLocation&#39; resource to update.
func (r ApiPatchAssetGeoLocationRequest) AssetGeoLocation(assetGeoLocation AssetGeoLocation) ApiPatchAssetGeoLocationRequest {
	r.assetGeoLocation = &assetGeoLocation
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiPatchAssetGeoLocationRequest) IfMatch(ifMatch string) ApiPatchAssetGeoLocationRequest {
	r.ifMatch = &ifMatch
	return r
}

func (r ApiPatchAssetGeoLocationRequest) Execute() (*AssetGeoLocation, *http.Response, error) {
	return r.ApiService.PatchAssetGeoLocationExecute(r)
}

/*
PatchAssetGeoLocation Update a 'asset.GeoLocation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiPatchAssetGeoLocationRequest
*/
func (a *AssetApiService) PatchAssetGeoLocation(ctx context.Context, moid string) ApiPatchAssetGeoLocationRequest {
	return ApiPatchAssetGeoLocationRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return AssetGeoLocation
func (a *AssetApiService) PatchAssetGeoLocationExecute(r ApiPatchAssetGeoLocationRequest) (*AssetGeoLocation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.PatchAssetGeoLocation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPatchAssetTargetRequest) Execute() (*AssetTarget, *http.Response, error) {
...
func (r ApiUpdateAssetDeviceConfigurationRequest) Execute() (*AssetDeviceConfiguration, *http.Response, error) {
...
func (r ApiUpdateAssetDeviceContractInformationRequest) Execute() (*AssetDeviceContractInformation, *http.Response, error) {
...
func (r ApiUpdateAssetDeviceRegistrationRequest) Execute() (*AssetDeviceRegistration, *http.Response, error) {
...
type ApiUpdateAssetGeoLocationRequest struct {
	ctx              context.Context
	ApiService       *AssetApiService
	moid             string
	assetGeoLocation *AssetGeoLocation
...
// The &#39;asset.GeoLocation&#39; resource to update.
func (r ApiUpdateAssetGeoLocationRequest) AssetGeoLocation(assetGeoLocation AssetGeoLocation) ApiUpdateAssetGeoLocationRequest {
	r.assetGeoLocation = &assetGeoLocation
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiUpdateAssetGeoLocationRequest) IfMatch(ifMatch string) ApiUpdateAssetGeoLocationRequest {
	r.ifMatch = &ifMatch
	return r
}

func (r ApiUpdateAssetGeoLocationRequest) Execute() (*AssetGeoLocation, *http.Response, error) {
	return r.ApiService.UpdateAssetGeoLocationExecute(r)
}

/*
UpdateAssetGeoLocation Update a 'asset.GeoLocation' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiUpdateAssetGeoLocationRequest
*/
func (a *AssetApiService) UpdateAssetGeoLocation(ctx context.Context, moid string) ApiUpdateAssetGeoLocationRequest {
	return ApiUpdateAssetGeoLocationRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return AssetGeoLocation
func (a *AssetApiService) UpdateAssetGeoLocationExecute(r ApiUpdateAssetGeoLocationRequest) (*AssetGeoLocation, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssetApiService.UpdateAssetGeoLocation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateAssetTargetRequest) Execute() (*AssetTarget, *http.Response, error) {
