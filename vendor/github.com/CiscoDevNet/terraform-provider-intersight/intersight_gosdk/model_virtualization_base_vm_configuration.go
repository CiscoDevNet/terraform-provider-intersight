...
func (o *VirtualizationBaseVmConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVirtualizationBaseVmConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVirtualizationBaseVmConfiguration)
	if err == nil {
