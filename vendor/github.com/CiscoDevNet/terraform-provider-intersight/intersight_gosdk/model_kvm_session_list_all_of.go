...
// KvmSessionListAllOf struct for KvmSessionListAllOf
type KvmSessionListAllOf struct {
...
type _KvmSessionListAllOf KvmSessionListAllOf
...
func (o KvmSessionListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *KvmSessionListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varKvmSessionListAllOf := _KvmSessionListAllOf{}

	if err = json.Unmarshal(bytes, &varKvmSessionListAllOf); err == nil {
		*o = KvmSessionListAllOf(varKvmSessionListAllOf)
	}
...
type NullableKvmSessionListAllOf struct {
	value *KvmSessionListAllOf
	isSet bool
}

func (v NullableKvmSessionListAllOf) Get() *KvmSessionListAllOf {
	return v.value
}

func (v *NullableKvmSessionListAllOf) Set(val *KvmSessionListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKvmSessionListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKvmSessionListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKvmSessionListAllOf(val *KvmSessionListAllOf) *NullableKvmSessionListAllOf {
	return &NullableKvmSessionListAllOf{value: val, isSet: true}
}

func (v NullableKvmSessionListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKvmSessionListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
