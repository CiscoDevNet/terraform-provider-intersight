...
func (o *TelemetryDruidExtractionFunctionCascade) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidExtractionFunctionCascade := _TelemetryDruidExtractionFunctionCascade{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidExtractionFunctionCascade); err == nil {
