...
// checks if the AssetHttpConnection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetHttpConnection{}
...
// GetDefaultClassId returns the default value "asset.HttpConnection" of the ClassId field.
func (o *AssetHttpConnection) GetDefaultClassId() interface{} {
	return "asset.HttpConnection"
}
...
// GetDefaultObjectType returns the default value "asset.HttpConnection" of the ObjectType field.
func (o *AssetHttpConnection) GetDefaultObjectType() interface{} {
	return "asset.HttpConnection"
}
...
func (o AssetHttpConnection) ToMap() (map[string]interface{}, error) {
...
func (o *AssetHttpConnection) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetHttpConnectionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetHttpConnection)
	if err == nil {
