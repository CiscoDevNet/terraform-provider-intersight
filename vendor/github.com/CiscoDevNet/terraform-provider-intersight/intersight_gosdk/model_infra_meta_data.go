...
// checks if the InfraMetaData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfraMetaData{}
...
// GetDefaultClassId returns the default value "infra.MetaData" of the ClassId field.
func (o *InfraMetaData) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "infra.MetaData" of the ObjectType field.
func (o *InfraMetaData) GetDefaultObjectType() interface{} {
	return "infra.MetaData"
}
...
func (o InfraMetaData) ToMap() (map[string]interface{}, error) {
...
func (o *InfraMetaData) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varInfraMetaDataWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varInfraMetaData)
	if err == nil {
