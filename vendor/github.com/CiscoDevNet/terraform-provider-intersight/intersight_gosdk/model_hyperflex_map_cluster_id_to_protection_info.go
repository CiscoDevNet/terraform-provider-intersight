...
// checks if the HyperflexMapClusterIdToProtectionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexMapClusterIdToProtectionInfo{}
...
// GetDefaultClassId returns the default value "hyperflex.MapClusterIdToProtectionInfo" of the ClassId field.
func (o *HyperflexMapClusterIdToProtectionInfo) GetDefaultClassId() interface{} {
	return "hyperflex.MapClusterIdToProtectionInfo"
}
...
// GetDefaultObjectType returns the default value "hyperflex.MapClusterIdToProtectionInfo" of the ObjectType field.
func (o *HyperflexMapClusterIdToProtectionInfo) GetDefaultObjectType() interface{} {
	return "hyperflex.MapClusterIdToProtectionInfo"
}
...
func (o *HyperflexMapClusterIdToProtectionInfo) GetProtectionInfo() HyperflexProtectionInfo {
	if o == nil || IsNil(o.ProtectionInfo.Get()) {
...
func (o HyperflexMapClusterIdToProtectionInfo) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexMapClusterIdToProtectionInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexMapClusterIdToProtectionInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexMapClusterIdToProtectionInfo)
	if err == nil {
