...
// checks if the HyperflexVirtualMachine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexVirtualMachine{}
...
// GetDefaultClassId returns the default value "hyperflex.VirtualMachine" of the ClassId field.
func (o *HyperflexVirtualMachine) GetDefaultClassId() interface{} {
	return "hyperflex.VirtualMachine"
}
...
// GetDefaultObjectType returns the default value "hyperflex.VirtualMachine" of the ObjectType field.
func (o *HyperflexVirtualMachine) GetDefaultObjectType() interface{} {
	return "hyperflex.VirtualMachine"
}
...
func (o *HyperflexVirtualMachine) GetRunTimeInfo() HyperflexVirtualMachineRuntimeInfo {
	if o == nil || IsNil(o.RunTimeInfo.Get()) {
...
func (o HyperflexVirtualMachine) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexVirtualMachine) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexVirtualMachineWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexVirtualMachine)
	if err == nil {
