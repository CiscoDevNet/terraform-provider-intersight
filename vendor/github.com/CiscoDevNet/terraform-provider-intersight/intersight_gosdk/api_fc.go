...
type ApiGetFcNeighborByMoidRequest struct {
	ctx        context.Context
	ApiService *FcApiService
	moid       string
}

func (r ApiGetFcNeighborByMoidRequest) Execute() (*FcNeighbor, *http.Response, error) {
	return r.ApiService.GetFcNeighborByMoidExecute(r)
}
...
func (a *FcApiService) GetFcNeighborByMoidExecute(r ApiGetFcNeighborByMoidRequest) (*FcNeighbor, *http.Response, error) {
	var (
		...
		formFiles           []formFile
		localVarReturnValue *FcNeighbor
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FcApiService.GetFcNeighborByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/fc/Neighbors/{Moid}"
...
type ApiGetFcNeighborListRequest struct {
	ctx         context.Context
	ApiService  *FcApiService
	filter      *string
	orderby     *string
...
func (r ApiGetFcNeighborListRequest) Filter(filter string) ApiGetFcNeighborListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetFcNeighborListRequest) Orderby(orderby string) ApiGetFcNeighborListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetFcNeighborListRequest) Top(top int32) ApiGetFcNeighborListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetFcNeighborListRequest) Skip(skip int32) ApiGetFcNeighborListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetFcNeighborListRequest) Select_(select_ string) ApiGetFcNeighborListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetFcNeighborListRequest) Expand(expand string) ApiGetFcNeighborListRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetFcNeighborListRequest) Apply(apply string) ApiGetFcNeighborListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetFcNeighborListRequest) Count(count bool) ApiGetFcNeighborListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetFcNeighborListRequest) Inlinecount(inlinecount string) ApiGetFcNeighborListRequest {
...
func (r ApiGetFcNeighborListRequest) At(at string) ApiGetFcNeighborListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetFcNeighborListRequest) Tags(tags string) ApiGetFcNeighborListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetFcNeighborListRequest) Execute() (*FcNeighborResponse, *http.Response, error) {
	return r.ApiService.GetFcNeighborListExecute(r)
}
...
func (a *FcApiService) GetFcNeighborListExecute(r ApiGetFcNeighborListRequest) (*FcNeighborResponse, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *FcNeighborResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FcApiService.GetFcNeighborList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/fc/Neighbors"
...
func (r ApiGetFcPhysicalPortByMoidRequest) Execute() (*FcPhysicalPort, *http.Response, error) {
...
func (r ApiGetFcPhysicalPortListRequest) Execute() (*FcPhysicalPortResponse, *http.Response, error) {
...
func (r ApiGetFcPortChannelByMoidRequest) Execute() (*FcPortChannel, *http.Response, error) {
...
func (r ApiGetFcPortChannelListRequest) Execute() (*FcPortChannelResponse, *http.Response, error) {
...
func (r ApiPatchFcPhysicalPortRequest) Execute() (*FcPhysicalPort, *http.Response, error) {
...
func (r ApiUpdateFcPhysicalPortRequest) Execute() (*FcPhysicalPort, *http.Response, error) {
