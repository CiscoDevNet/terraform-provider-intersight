...
// checks if the AssetSubscriptionAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetSubscriptionAccount{}
...
// GetDefaultClassId returns the default value "asset.SubscriptionAccount" of the ClassId field.
func (o *AssetSubscriptionAccount) GetDefaultClassId() interface{} {
	return "asset.SubscriptionAccount"
}
...
// GetDefaultObjectType returns the default value "asset.SubscriptionAccount" of the ObjectType field.
func (o *AssetSubscriptionAccount) GetDefaultObjectType() interface{} {
	return "asset.SubscriptionAccount"
}
...
func (o *AssetSubscriptionAccount) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o AssetSubscriptionAccount) ToMap() (map[string]interface{}, error) {
...
func (o *AssetSubscriptionAccount) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetSubscriptionAccountWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetSubscriptionAccount)
	if err == nil {
