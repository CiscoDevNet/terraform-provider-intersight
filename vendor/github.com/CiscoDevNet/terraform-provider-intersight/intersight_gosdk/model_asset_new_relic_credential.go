...
func (o *AssetNewRelicCredential) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAssetNewRelicCredentialWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varAssetNewRelicCredential)
	if err == nil {
