...
// checks if the RecommendationExpansionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecommendationExpansionRequest{}
...
func (o *RecommendationExpansionRequest) GetDefaultClassId() interface{} {
...
func (o *RecommendationExpansionRequest) GetDefaultObjectType() interface{} {
	return "recommendation.HardwareExpansionRequest"
}
...
func (o RecommendationExpansionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RecommendationExpansionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRecommendationExpansionRequestWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varRecommendationExpansionRequest)
	if err == nil {
