...
// StorageExternalParityGroupAllOf Definition of the list of properties defined in 'storage.ExternalParityGroup', excluding properties defined in parent classes.
type StorageExternalParityGroupAllOf struct {
...
type _StorageExternalParityGroupAllOf StorageExternalParityGroupAllOf
...
func NewStorageExternalParityGroupAllOf(classId string, objectType string) *StorageExternalParityGroupAllOf {
	this := StorageExternalParityGroupAllOf{}
...
func (o StorageExternalParityGroupAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageExternalParityGroupAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageExternalParityGroupAllOf := _StorageExternalParityGroupAllOf{}

	if err = json.Unmarshal(bytes, &varStorageExternalParityGroupAllOf); err == nil {
		*o = StorageExternalParityGroupAllOf(varStorageExternalParityGroupAllOf)
	}
...
type NullableStorageExternalParityGroupAllOf struct {
	value *StorageExternalParityGroupAllOf
	isSet bool
}

func (v NullableStorageExternalParityGroupAllOf) Get() *StorageExternalParityGroupAllOf {
	return v.value
}

func (v *NullableStorageExternalParityGroupAllOf) Set(val *StorageExternalParityGroupAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageExternalParityGroupAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageExternalParityGroupAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageExternalParityGroupAllOf(val *StorageExternalParityGroupAllOf) *NullableStorageExternalParityGroupAllOf {
	return &NullableStorageExternalParityGroupAllOf{value: val, isSet: true}
}

func (v NullableStorageExternalParityGroupAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageExternalParityGroupAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
