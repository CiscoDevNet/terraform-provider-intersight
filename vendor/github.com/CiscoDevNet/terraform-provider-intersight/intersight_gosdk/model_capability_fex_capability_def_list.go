...
func (o *CapabilityFexCapabilityDefList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCapabilityFexCapabilityDefListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCapabilityFexCapabilityDefList)
	if err == nil {
