...
type _PolicyActionParam PolicyActionParam
...
// GetDefaultClassId returns the default value "policy.ActionParam" of the ClassId field.
func (o *PolicyActionParam) GetDefaultClassId() interface{} {
	return "policy.ActionParam"
}
...
// GetDefaultObjectType returns the default value "policy.ActionParam" of the ObjectType field.
func (o *PolicyActionParam) GetDefaultObjectType() interface{} {
	return "policy.ActionParam"
}
...
func (o *PolicyActionParam) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varPolicyActionParam.ObjectType = varPolicyActionParamWithoutEmbeddedStruct.ObjectType
		varPolicyActionParam.Name = varPolicyActionParamWithoutEmbeddedStruct.Name
		varPolicyActionParam.Value = varPolicyActionParamWithoutEmbeddedStruct.Value
		*o = PolicyActionParam(varPolicyActionParam)
	} else {
		return err
	}
...
type NullablePolicyActionParam struct {
	value *PolicyActionParam
	isSet bool
}

func (v NullablePolicyActionParam) Get() *PolicyActionParam {
	return v.value
}

func (v *NullablePolicyActionParam) Set(val *PolicyActionParam) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyActionParam) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyActionParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyActionParam(val *PolicyActionParam) *NullablePolicyActionParam {
	return &NullablePolicyActionParam{value: val, isSet: true}
}

func (v NullablePolicyActionParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyActionParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
