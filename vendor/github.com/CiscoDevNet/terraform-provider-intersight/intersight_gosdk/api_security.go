...
func (r ApiGetSecurityUnitByMoidRequest) Execute() (*SecurityUnit, *http.Response, error) {
...
func (r ApiGetSecurityUnitListRequest) Execute() (*SecurityUnitResponse, *http.Response, error) {
...
func (r ApiPatchSecurityUnitRequest) Execute() (*SecurityUnit, *http.Response, error) {
...
func (r ApiUpdateSecurityUnitRequest) Execute() (*SecurityUnit, *http.Response, error) {
