...
func (o *FabricSwitchProfileTemplate) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFabricSwitchProfileTemplateWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFabricSwitchProfileTemplate)
	if err == nil {
