...
// FcPortChannelListAllOf struct for FcPortChannelListAllOf
type FcPortChannelListAllOf struct {
...
type _FcPortChannelListAllOf FcPortChannelListAllOf
...
func (o FcPortChannelListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FcPortChannelListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFcPortChannelListAllOf := _FcPortChannelListAllOf{}

	if err = json.Unmarshal(bytes, &varFcPortChannelListAllOf); err == nil {
		*o = FcPortChannelListAllOf(varFcPortChannelListAllOf)
	}
...
type NullableFcPortChannelListAllOf struct {
	value *FcPortChannelListAllOf
	isSet bool
}

func (v NullableFcPortChannelListAllOf) Get() *FcPortChannelListAllOf {
	return v.value
}

func (v *NullableFcPortChannelListAllOf) Set(val *FcPortChannelListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFcPortChannelListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFcPortChannelListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFcPortChannelListAllOf(val *FcPortChannelListAllOf) *NullableFcPortChannelListAllOf {
	return &NullableFcPortChannelListAllOf{value: val, isSet: true}
}

func (v NullableFcPortChannelListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFcPortChannelListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
