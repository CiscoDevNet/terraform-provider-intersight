...
// VirtualizationComputeCapacityAllOf Definition of the list of properties defined in 'virtualization.ComputeCapacity', excluding properties defined in parent classes.
type VirtualizationComputeCapacityAllOf struct {
...
type _VirtualizationComputeCapacityAllOf VirtualizationComputeCapacityAllOf
...
func NewVirtualizationComputeCapacityAllOf(classId string, objectType string) *VirtualizationComputeCapacityAllOf {
	this := VirtualizationComputeCapacityAllOf{}
...
func (o VirtualizationComputeCapacityAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationComputeCapacityAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationComputeCapacityAllOf := _VirtualizationComputeCapacityAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationComputeCapacityAllOf); err == nil {
		*o = VirtualizationComputeCapacityAllOf(varVirtualizationComputeCapacityAllOf)
	}
...
type NullableVirtualizationComputeCapacityAllOf struct {
	value *VirtualizationComputeCapacityAllOf
	isSet bool
}

func (v NullableVirtualizationComputeCapacityAllOf) Get() *VirtualizationComputeCapacityAllOf {
	return v.value
}

func (v *NullableVirtualizationComputeCapacityAllOf) Set(val *VirtualizationComputeCapacityAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationComputeCapacityAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationComputeCapacityAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationComputeCapacityAllOf(val *VirtualizationComputeCapacityAllOf) *NullableVirtualizationComputeCapacityAllOf {
	return &NullableVirtualizationComputeCapacityAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationComputeCapacityAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationComputeCapacityAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
