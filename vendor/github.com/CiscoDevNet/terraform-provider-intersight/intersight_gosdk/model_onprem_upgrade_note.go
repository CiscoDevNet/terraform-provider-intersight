...
// checks if the OnpremUpgradeNote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnpremUpgradeNote{}
...
// GetDefaultClassId returns the default value "onprem.UpgradeNote" of the ClassId field.
func (o *OnpremUpgradeNote) GetDefaultClassId() interface{} {
	return "onprem.UpgradeNote"
}
...
// GetDefaultObjectType returns the default value "onprem.UpgradeNote" of the ObjectType field.
func (o *OnpremUpgradeNote) GetDefaultObjectType() interface{} {
	return "onprem.UpgradeNote"
}
...
func (o OnpremUpgradeNote) ToMap() (map[string]interface{}, error) {
...
func (o *OnpremUpgradeNote) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOnpremUpgradeNoteWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOnpremUpgradeNote)
	if err == nil {
