...
// checks if the HyperflexFeatureLimitInternalList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexFeatureLimitInternalList{}
...
func (o HyperflexFeatureLimitInternalList) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexFeatureLimitInternalList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexFeatureLimitInternalListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexFeatureLimitInternalList)
	if err == nil {
