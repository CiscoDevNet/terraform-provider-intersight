...
// checks if the VirtualizationBaseDatastore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationBaseDatastore{}
...
func (o *VirtualizationBaseDatastore) GetDefaultClassId() interface{} {
...
func (o *VirtualizationBaseDatastore) GetDefaultObjectType() interface{} {
	return "virtualization.VmwareDatastore"
}
...
func (o VirtualizationBaseDatastore) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationBaseDatastore) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseDatastoreWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseDatastore)
	if err == nil {
