...
func (o *HyperflexServerFirmwareVersionEntryList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varHyperflexServerFirmwareVersionEntryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varHyperflexServerFirmwareVersionEntryList)
	if err == nil {
