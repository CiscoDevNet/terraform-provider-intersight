...
// checks if the WorkflowFailureEndTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowFailureEndTask{}
...
func NewWorkflowFailureEndTask(classId string, objectType string) *WorkflowFailureEndTask {
...
func (o WorkflowFailureEndTask) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowFailureEndTask) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowFailureEndTaskWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowFailureEndTask)
	if err == nil {
