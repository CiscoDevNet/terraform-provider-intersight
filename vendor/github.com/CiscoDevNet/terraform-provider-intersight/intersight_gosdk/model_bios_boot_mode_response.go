...
func (dst *BiosBootModeResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'bios.BootMode.List'
	if jsonDict["ObjectType"] == "bios.BootMode.List" {
		// try to unmarshal JSON data into BiosBootModeList
		err = json.Unmarshal(data, &dst.BiosBootModeList)
		if err == nil {
			return nil // data stored in dst.BiosBootModeList, return on the first match
		} else {
			dst.BiosBootModeList = nil
			return fmt.Errorf("Failed to unmarshal BiosBootModeResponse as BiosBootModeList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosBootModeResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosBootModeResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BiosBootModeResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src BiosBootModeResponse) MarshalJSON() ([]byte, error) {
	if src.BiosBootModeList != nil {
		return json.Marshal(&src.BiosBootModeList)
	}
...
type NullableBiosBootModeResponse struct {
	value *BiosBootModeResponse
	isSet bool
}

func (v NullableBiosBootModeResponse) Get() *BiosBootModeResponse {
	return v.value
}

func (v *NullableBiosBootModeResponse) Set(val *BiosBootModeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBiosBootModeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBiosBootModeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBiosBootModeResponse(val *BiosBootModeResponse) *NullableBiosBootModeResponse {
	return &NullableBiosBootModeResponse{value: val, isSet: true}
}

func (v NullableBiosBootModeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBiosBootModeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
