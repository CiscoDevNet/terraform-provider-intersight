...
// KvmPolicyInventoryListAllOf struct for KvmPolicyInventoryListAllOf
type KvmPolicyInventoryListAllOf struct {
...
type _KvmPolicyInventoryListAllOf KvmPolicyInventoryListAllOf
...
func NewKvmPolicyInventoryListAllOf() *KvmPolicyInventoryListAllOf {
	this := KvmPolicyInventoryListAllOf{}
	return &this
}
...
func (o KvmPolicyInventoryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *KvmPolicyInventoryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varKvmPolicyInventoryListAllOf := _KvmPolicyInventoryListAllOf{}

	if err = json.Unmarshal(bytes, &varKvmPolicyInventoryListAllOf); err == nil {
		*o = KvmPolicyInventoryListAllOf(varKvmPolicyInventoryListAllOf)
	}
...
type NullableKvmPolicyInventoryListAllOf struct {
	value *KvmPolicyInventoryListAllOf
	isSet bool
}

func (v NullableKvmPolicyInventoryListAllOf) Get() *KvmPolicyInventoryListAllOf {
	return v.value
}

func (v *NullableKvmPolicyInventoryListAllOf) Set(val *KvmPolicyInventoryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKvmPolicyInventoryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKvmPolicyInventoryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKvmPolicyInventoryListAllOf(val *KvmPolicyInventoryListAllOf) *NullableKvmPolicyInventoryListAllOf {
	return &NullableKvmPolicyInventoryListAllOf{value: val, isSet: true}
}

func (v NullableKvmPolicyInventoryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKvmPolicyInventoryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
