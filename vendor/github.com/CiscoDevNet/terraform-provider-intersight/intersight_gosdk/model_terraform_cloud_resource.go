...
// checks if the TerraformCloudResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TerraformCloudResource{}
...
// GetDefaultClassId returns the default value "terraform.CloudResource" of the ClassId field.
func (o *TerraformCloudResource) GetDefaultClassId() interface{} {
	return "terraform.CloudResource"
}
...
// GetDefaultObjectType returns the default value "terraform.CloudResource" of the ObjectType field.
func (o *TerraformCloudResource) GetDefaultObjectType() interface{} {
	return "terraform.CloudResource"
}
...
func (o TerraformCloudResource) ToMap() (map[string]interface{}, error) {
...
func (o *TerraformCloudResource) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTerraformCloudResourceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTerraformCloudResource)
	if err == nil {
