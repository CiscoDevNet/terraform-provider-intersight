...
func (dst *VnicIscsiAdapterPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VnicIscsiAdapterPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VnicIscsiAdapterPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VnicIscsiAdapterPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'vnic.IscsiAdapterPolicy.List'
	if jsonDict["ObjectType"] == "vnic.IscsiAdapterPolicy.List" {
		// try to unmarshal JSON data into VnicIscsiAdapterPolicyList
		err = json.Unmarshal(data, &dst.VnicIscsiAdapterPolicyList)
		if err == nil {
			return nil // data stored in dst.VnicIscsiAdapterPolicyList, return on the first match
		} else {
			dst.VnicIscsiAdapterPolicyList = nil
			return fmt.Errorf("failed to unmarshal VnicIscsiAdapterPolicyResponse as VnicIscsiAdapterPolicyList: %s", err.Error())
		}
	}
...
func (src VnicIscsiAdapterPolicyResponse) MarshalJSON() ([]byte, error) {
	...
	if src.VnicIscsiAdapterPolicyList != nil {
		return json.Marshal(&src.VnicIscsiAdapterPolicyList)
	}
...
func (obj *VnicIscsiAdapterPolicyResponse) GetActualInstance() interface{} {
	...
	if obj.VnicIscsiAdapterPolicyList != nil {
		return obj.VnicIscsiAdapterPolicyList
	}
...
type NullableVnicIscsiAdapterPolicyResponse struct {
	value *VnicIscsiAdapterPolicyResponse
	isSet bool
}

func (v NullableVnicIscsiAdapterPolicyResponse) Get() *VnicIscsiAdapterPolicyResponse {
	return v.value
}

func (v *NullableVnicIscsiAdapterPolicyResponse) Set(val *VnicIscsiAdapterPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicIscsiAdapterPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicIscsiAdapterPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicIscsiAdapterPolicyResponse(val *VnicIscsiAdapterPolicyResponse) *NullableVnicIscsiAdapterPolicyResponse {
	return &NullableVnicIscsiAdapterPolicyResponse{value: val, isSet: true}
}

func (v NullableVnicIscsiAdapterPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicIscsiAdapterPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
