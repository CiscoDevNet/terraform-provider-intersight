...
// StorageNetAppSvmSnapshotPolicyAllOf Definition of the list of properties defined in 'storage.NetAppSvmSnapshotPolicy', excluding properties defined in parent classes.
type StorageNetAppSvmSnapshotPolicyAllOf struct {
...
type _StorageNetAppSvmSnapshotPolicyAllOf StorageNetAppSvmSnapshotPolicyAllOf
...
func NewStorageNetAppSvmSnapshotPolicyAllOf(classId string, objectType string) *StorageNetAppSvmSnapshotPolicyAllOf {
	this := StorageNetAppSvmSnapshotPolicyAllOf{}
...
func (o StorageNetAppSvmSnapshotPolicyAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppSvmSnapshotPolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppSvmSnapshotPolicyAllOf := _StorageNetAppSvmSnapshotPolicyAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppSvmSnapshotPolicyAllOf); err == nil {
		*o = StorageNetAppSvmSnapshotPolicyAllOf(varStorageNetAppSvmSnapshotPolicyAllOf)
	}
...
type NullableStorageNetAppSvmSnapshotPolicyAllOf struct {
	value *StorageNetAppSvmSnapshotPolicyAllOf
	isSet bool
}

func (v NullableStorageNetAppSvmSnapshotPolicyAllOf) Get() *StorageNetAppSvmSnapshotPolicyAllOf {
	return v.value
}

func (v *NullableStorageNetAppSvmSnapshotPolicyAllOf) Set(val *StorageNetAppSvmSnapshotPolicyAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppSvmSnapshotPolicyAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppSvmSnapshotPolicyAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppSvmSnapshotPolicyAllOf(val *StorageNetAppSvmSnapshotPolicyAllOf) *NullableStorageNetAppSvmSnapshotPolicyAllOf {
	return &NullableStorageNetAppSvmSnapshotPolicyAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppSvmSnapshotPolicyAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppSvmSnapshotPolicyAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
