...
// checks if the CloudBasePlacement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudBasePlacement{}
...
func (o *CloudBasePlacement) GetDefaultClassId() interface{} {
	return "cloud.AwsVpc"
}
...
func (o *CloudBasePlacement) GetDefaultObjectType() interface{} {
	return "cloud.AwsVpc"
}
...
func (o CloudBasePlacement) ToMap() (map[string]interface{}, error) {
...
func (o *CloudBasePlacement) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCloudBasePlacementWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCloudBasePlacement)
	if err == nil {
