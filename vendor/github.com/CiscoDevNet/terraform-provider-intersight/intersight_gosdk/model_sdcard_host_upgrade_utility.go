...
// checks if the SdcardHostUpgradeUtility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdcardHostUpgradeUtility{}
...
func (o SdcardHostUpgradeUtility) ToMap() (map[string]interface{}, error) {
...
func (o *SdcardHostUpgradeUtility) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSdcardHostUpgradeUtilityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSdcardHostUpgradeUtility)
	if err == nil {
