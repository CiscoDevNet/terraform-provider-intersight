...
func (o *MoDocumentCount) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMoDocumentCountWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varMoDocumentCount)
	if err == nil {
