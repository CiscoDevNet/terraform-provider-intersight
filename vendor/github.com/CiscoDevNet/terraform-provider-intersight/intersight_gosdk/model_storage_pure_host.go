...
func (o *StoragePureHost) SetRealmNil() {
	o.Realm.Set(nil)
}
...
func (o *StoragePureHost) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varStoragePureHost.RealmName = varStoragePureHostWithoutEmbeddedStruct.RealmName
		...
		varStoragePureHost.Realm = varStoragePureHostWithoutEmbeddedStruct.Realm
