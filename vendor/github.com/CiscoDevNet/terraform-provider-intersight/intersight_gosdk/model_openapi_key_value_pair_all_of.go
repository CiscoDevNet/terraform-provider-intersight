...
// OpenapiKeyValuePairAllOf Definition of the list of properties defined in 'openapi.KeyValuePair', excluding properties defined in parent classes.
type OpenapiKeyValuePairAllOf struct {
...
type _OpenapiKeyValuePairAllOf OpenapiKeyValuePairAllOf
...
func (o OpenapiKeyValuePairAllOf) MarshalJSON() ([]byte, error) {
...
func (o *OpenapiKeyValuePairAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varOpenapiKeyValuePairAllOf := _OpenapiKeyValuePairAllOf{}

	if err = json.Unmarshal(bytes, &varOpenapiKeyValuePairAllOf); err == nil {
		*o = OpenapiKeyValuePairAllOf(varOpenapiKeyValuePairAllOf)
	}
...
type NullableOpenapiKeyValuePairAllOf struct {
	value *OpenapiKeyValuePairAllOf
	isSet bool
}

func (v NullableOpenapiKeyValuePairAllOf) Get() *OpenapiKeyValuePairAllOf {
	return v.value
}

func (v *NullableOpenapiKeyValuePairAllOf) Set(val *OpenapiKeyValuePairAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenapiKeyValuePairAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenapiKeyValuePairAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenapiKeyValuePairAllOf(val *OpenapiKeyValuePairAllOf) *NullableOpenapiKeyValuePairAllOf {
	return &NullableOpenapiKeyValuePairAllOf{value: val, isSet: true}
}

func (v NullableOpenapiKeyValuePairAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenapiKeyValuePairAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
