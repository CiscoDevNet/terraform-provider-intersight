...
func (o *CondAlarmAction) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCondAlarmActionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCondAlarmAction)
	if err == nil {
