...
// LicenseLicenseReservationOpAllOf Definition of the list of properties defined in 'license.LicenseReservationOp', excluding properties defined in parent classes.
type LicenseLicenseReservationOpAllOf struct {
...
type _LicenseLicenseReservationOpAllOf LicenseLicenseReservationOpAllOf
...
func NewLicenseLicenseReservationOpAllOf(classId string, objectType string) *LicenseLicenseReservationOpAllOf {
	this := LicenseLicenseReservationOpAllOf{}
...
func (o LicenseLicenseReservationOpAllOf) MarshalJSON() ([]byte, error) {
...
func (o *LicenseLicenseReservationOpAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varLicenseLicenseReservationOpAllOf := _LicenseLicenseReservationOpAllOf{}

	if err = json.Unmarshal(bytes, &varLicenseLicenseReservationOpAllOf); err == nil {
		*o = LicenseLicenseReservationOpAllOf(varLicenseLicenseReservationOpAllOf)
	}
...
type NullableLicenseLicenseReservationOpAllOf struct {
	value *LicenseLicenseReservationOpAllOf
	isSet bool
}

func (v NullableLicenseLicenseReservationOpAllOf) Get() *LicenseLicenseReservationOpAllOf {
	return v.value
}

func (v *NullableLicenseLicenseReservationOpAllOf) Set(val *LicenseLicenseReservationOpAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableLicenseLicenseReservationOpAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableLicenseLicenseReservationOpAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicenseLicenseReservationOpAllOf(val *LicenseLicenseReservationOpAllOf) *NullableLicenseLicenseReservationOpAllOf {
	return &NullableLicenseLicenseReservationOpAllOf{value: val, isSet: true}
}

func (v NullableLicenseLicenseReservationOpAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicenseLicenseReservationOpAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
