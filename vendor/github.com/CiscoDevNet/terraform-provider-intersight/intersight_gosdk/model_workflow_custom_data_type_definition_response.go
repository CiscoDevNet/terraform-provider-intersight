...
func WorkflowCustomDataTypeDefinitionListAsWorkflowCustomDataTypeDefinitionResponse(v *WorkflowCustomDataTypeDefinitionList) WorkflowCustomDataTypeDefinitionResponse {
	return WorkflowCustomDataTypeDefinitionResponse{
		WorkflowCustomDataTypeDefinitionList: v,
	}
}
...
func (dst *WorkflowCustomDataTypeDefinitionResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowCustomDataTypeDefinitionResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowCustomDataTypeDefinitionResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal WorkflowCustomDataTypeDefinitionResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'workflow.CustomDataTypeDefinition.List'
	if jsonDict["ObjectType"] == "workflow.CustomDataTypeDefinition.List" {
		// try to unmarshal JSON data into WorkflowCustomDataTypeDefinitionList
		err = json.Unmarshal(data, &dst.WorkflowCustomDataTypeDefinitionList)
		if err == nil {
			return nil // data stored in dst.WorkflowCustomDataTypeDefinitionList, return on the first match
		} else {
			dst.WorkflowCustomDataTypeDefinitionList = nil
			return fmt.Errorf("failed to unmarshal WorkflowCustomDataTypeDefinitionResponse as WorkflowCustomDataTypeDefinitionList: %s", err.Error())
		}
	}
...
type NullableWorkflowCustomDataTypeDefinitionResponse struct {
	value *WorkflowCustomDataTypeDefinitionResponse
	isSet bool
}

func (v NullableWorkflowCustomDataTypeDefinitionResponse) Get() *WorkflowCustomDataTypeDefinitionResponse {
	return v.value
}

func (v *NullableWorkflowCustomDataTypeDefinitionResponse) Set(val *WorkflowCustomDataTypeDefinitionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowCustomDataTypeDefinitionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowCustomDataTypeDefinitionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowCustomDataTypeDefinitionResponse(val *WorkflowCustomDataTypeDefinitionResponse) *NullableWorkflowCustomDataTypeDefinitionResponse {
	return &NullableWorkflowCustomDataTypeDefinitionResponse{value: val, isSet: true}
}

func (v NullableWorkflowCustomDataTypeDefinitionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowCustomDataTypeDefinitionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
