...
// NiatelemetryFabricNodeControlDetailsAllOf Definition of the list of properties defined in 'niatelemetry.FabricNodeControlDetails', excluding properties defined in parent classes.
type NiatelemetryFabricNodeControlDetailsAllOf struct {
...
type _NiatelemetryFabricNodeControlDetailsAllOf NiatelemetryFabricNodeControlDetailsAllOf
...
func NewNiatelemetryFabricNodeControlDetailsAllOf(classId string, objectType string) *NiatelemetryFabricNodeControlDetailsAllOf {
	this := NiatelemetryFabricNodeControlDetailsAllOf{}
...
func (o NiatelemetryFabricNodeControlDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryFabricNodeControlDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryFabricNodeControlDetailsAllOf := _NiatelemetryFabricNodeControlDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryFabricNodeControlDetailsAllOf); err == nil {
		*o = NiatelemetryFabricNodeControlDetailsAllOf(varNiatelemetryFabricNodeControlDetailsAllOf)
	}
...
type NullableNiatelemetryFabricNodeControlDetailsAllOf struct {
	value *NiatelemetryFabricNodeControlDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetryFabricNodeControlDetailsAllOf) Get() *NiatelemetryFabricNodeControlDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetryFabricNodeControlDetailsAllOf) Set(val *NiatelemetryFabricNodeControlDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryFabricNodeControlDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryFabricNodeControlDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryFabricNodeControlDetailsAllOf(val *NiatelemetryFabricNodeControlDetailsAllOf) *NullableNiatelemetryFabricNodeControlDetailsAllOf {
	return &NullableNiatelemetryFabricNodeControlDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryFabricNodeControlDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryFabricNodeControlDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
