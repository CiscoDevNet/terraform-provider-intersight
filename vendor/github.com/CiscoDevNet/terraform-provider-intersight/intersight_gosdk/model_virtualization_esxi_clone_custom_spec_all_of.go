...
// VirtualizationEsxiCloneCustomSpecAllOf Definition of the list of properties defined in 'virtualization.EsxiCloneCustomSpec', excluding properties defined in parent classes.
type VirtualizationEsxiCloneCustomSpecAllOf struct {
...
type _VirtualizationEsxiCloneCustomSpecAllOf VirtualizationEsxiCloneCustomSpecAllOf
...
func NewVirtualizationEsxiCloneCustomSpecAllOf(classId string, objectType string) *VirtualizationEsxiCloneCustomSpecAllOf {
	this := VirtualizationEsxiCloneCustomSpecAllOf{}
...
func (o VirtualizationEsxiCloneCustomSpecAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationEsxiCloneCustomSpecAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationEsxiCloneCustomSpecAllOf := _VirtualizationEsxiCloneCustomSpecAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationEsxiCloneCustomSpecAllOf); err == nil {
		*o = VirtualizationEsxiCloneCustomSpecAllOf(varVirtualizationEsxiCloneCustomSpecAllOf)
	}
...
type NullableVirtualizationEsxiCloneCustomSpecAllOf struct {
	value *VirtualizationEsxiCloneCustomSpecAllOf
	isSet bool
}

func (v NullableVirtualizationEsxiCloneCustomSpecAllOf) Get() *VirtualizationEsxiCloneCustomSpecAllOf {
	return v.value
}

func (v *NullableVirtualizationEsxiCloneCustomSpecAllOf) Set(val *VirtualizationEsxiCloneCustomSpecAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationEsxiCloneCustomSpecAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationEsxiCloneCustomSpecAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationEsxiCloneCustomSpecAllOf(val *VirtualizationEsxiCloneCustomSpecAllOf) *NullableVirtualizationEsxiCloneCustomSpecAllOf {
	return &NullableVirtualizationEsxiCloneCustomSpecAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationEsxiCloneCustomSpecAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationEsxiCloneCustomSpecAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
