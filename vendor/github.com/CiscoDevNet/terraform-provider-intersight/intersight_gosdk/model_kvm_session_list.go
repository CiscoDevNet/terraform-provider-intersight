...
// checks if the KvmSessionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KvmSessionList{}
...
func (o KvmSessionList) ToMap() (map[string]interface{}, error) {
...
func (o *KvmSessionList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKvmSessionListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKvmSessionList)
	if err == nil {
