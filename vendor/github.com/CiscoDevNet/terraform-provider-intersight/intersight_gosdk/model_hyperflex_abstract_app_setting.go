...
// checks if the HyperflexAbstractAppSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexAbstractAppSetting{}
...
func (o HyperflexAbstractAppSetting) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexAbstractAppSetting) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexAbstractAppSettingWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexAbstractAppSetting)
	if err == nil {
