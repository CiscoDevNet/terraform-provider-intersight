...
// KubernetesPodAllOf Definition of the list of properties defined in 'kubernetes.Pod', excluding properties defined in parent classes.
type KubernetesPodAllOf struct {
...
type _KubernetesPodAllOf KubernetesPodAllOf
...
func (o *KubernetesPodAllOf) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o KubernetesPodAllOf) MarshalJSON() ([]byte, error) {
...
func (o *KubernetesPodAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varKubernetesPodAllOf := _KubernetesPodAllOf{}

	if err = json.Unmarshal(bytes, &varKubernetesPodAllOf); err == nil {
		*o = KubernetesPodAllOf(varKubernetesPodAllOf)
	}
...
type NullableKubernetesPodAllOf struct {
	value *KubernetesPodAllOf
	isSet bool
}

func (v NullableKubernetesPodAllOf) Get() *KubernetesPodAllOf {
	return v.value
}

func (v *NullableKubernetesPodAllOf) Set(val *KubernetesPodAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesPodAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesPodAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesPodAllOf(val *KubernetesPodAllOf) *NullableKubernetesPodAllOf {
	return &NullableKubernetesPodAllOf{value: val, isSet: true}
}

func (v NullableKubernetesPodAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesPodAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
