...
// checks if the PolicyQualifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyQualifier{}
...
func (o PolicyQualifier) ToMap() (map[string]interface{}, error) {
...
func (o *PolicyQualifier) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPolicyQualifierWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varPolicyQualifier)
	if err == nil {
