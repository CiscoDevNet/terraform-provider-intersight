...
func (o *CapabilityProcessorUnitUpdateConstraintMeta) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCapabilityProcessorUnitUpdateConstraintMetaWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCapabilityProcessorUnitUpdateConstraintMeta)
	if err == nil {
