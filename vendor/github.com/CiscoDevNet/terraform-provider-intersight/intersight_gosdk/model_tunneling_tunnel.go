...
// checks if the TunnelingTunnel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TunnelingTunnel{}
...
func (o TunnelingTunnel) ToMap() (map[string]interface{}, error) {
...
func (o *TunnelingTunnel) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTunnelingTunnelWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTunnelingTunnel)
	if err == nil {
