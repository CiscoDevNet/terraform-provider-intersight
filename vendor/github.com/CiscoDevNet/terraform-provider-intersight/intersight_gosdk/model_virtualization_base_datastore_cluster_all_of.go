...
// VirtualizationBaseDatastoreClusterAllOf Definition of the list of properties defined in 'virtualization.BaseDatastoreCluster', excluding properties defined in parent classes.
type VirtualizationBaseDatastoreClusterAllOf struct {
...
type _VirtualizationBaseDatastoreClusterAllOf VirtualizationBaseDatastoreClusterAllOf
...
func NewVirtualizationBaseDatastoreClusterAllOf(classId string, objectType string) *VirtualizationBaseDatastoreClusterAllOf {
	this := VirtualizationBaseDatastoreClusterAllOf{}
...
func (o VirtualizationBaseDatastoreClusterAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationBaseDatastoreClusterAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationBaseDatastoreClusterAllOf := _VirtualizationBaseDatastoreClusterAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationBaseDatastoreClusterAllOf); err == nil {
		*o = VirtualizationBaseDatastoreClusterAllOf(varVirtualizationBaseDatastoreClusterAllOf)
	}
...
type NullableVirtualizationBaseDatastoreClusterAllOf struct {
	value *VirtualizationBaseDatastoreClusterAllOf
	isSet bool
}

func (v NullableVirtualizationBaseDatastoreClusterAllOf) Get() *VirtualizationBaseDatastoreClusterAllOf {
	return v.value
}

func (v *NullableVirtualizationBaseDatastoreClusterAllOf) Set(val *VirtualizationBaseDatastoreClusterAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationBaseDatastoreClusterAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationBaseDatastoreClusterAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationBaseDatastoreClusterAllOf(val *VirtualizationBaseDatastoreClusterAllOf) *NullableVirtualizationBaseDatastoreClusterAllOf {
	return &NullableVirtualizationBaseDatastoreClusterAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationBaseDatastoreClusterAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationBaseDatastoreClusterAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
