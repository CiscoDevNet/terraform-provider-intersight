...
func (o *KubernetesVersionPolicyList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varKubernetesVersionPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varKubernetesVersionPolicyList)
	if err == nil {
