...
type _VnicEthQosPolicyAllOf VnicEthQosPolicyAllOf
...
func (o *VnicEthQosPolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicEthQosPolicyAllOf := _VnicEthQosPolicyAllOf{}

	if err = json.Unmarshal(bytes, &varVnicEthQosPolicyAllOf); err == nil {
		*o = VnicEthQosPolicyAllOf(varVnicEthQosPolicyAllOf)
	}
