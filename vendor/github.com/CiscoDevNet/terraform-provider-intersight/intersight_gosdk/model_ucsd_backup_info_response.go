...
func (dst *UcsdBackupInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal UcsdBackupInfoResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal UcsdBackupInfoResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal UcsdBackupInfoResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'ucsd.BackupInfo.List'
	if jsonDict["ObjectType"] == "ucsd.BackupInfo.List" {
		// try to unmarshal JSON data into UcsdBackupInfoList
		err = json.Unmarshal(data, &dst.UcsdBackupInfoList)
		if err == nil {
			return nil // data stored in dst.UcsdBackupInfoList, return on the first match
		} else {
			dst.UcsdBackupInfoList = nil
			return fmt.Errorf("Failed to unmarshal UcsdBackupInfoResponse as UcsdBackupInfoList: %s", err.Error())
		}
	}
...
type NullableUcsdBackupInfoResponse struct {
	value *UcsdBackupInfoResponse
	isSet bool
}

func (v NullableUcsdBackupInfoResponse) Get() *UcsdBackupInfoResponse {
	return v.value
}

func (v *NullableUcsdBackupInfoResponse) Set(val *UcsdBackupInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUcsdBackupInfoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUcsdBackupInfoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUcsdBackupInfoResponse(val *UcsdBackupInfoResponse) *NullableUcsdBackupInfoResponse {
	return &NullableUcsdBackupInfoResponse{value: val, isSet: true}
}

func (v NullableUcsdBackupInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUcsdBackupInfoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
