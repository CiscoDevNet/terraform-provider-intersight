...
// checks if the HyperflexServerModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexServerModel{}
...
// GetDefaultClassId returns the default value "hyperflex.ServerModel" of the ClassId field.
func (o *HyperflexServerModel) GetDefaultClassId() interface{} {
	return "hyperflex.ServerModel"
}
...
// GetDefaultObjectType returns the default value "hyperflex.ServerModel" of the ObjectType field.
func (o *HyperflexServerModel) GetDefaultObjectType() interface{} {
	return "hyperflex.ServerModel"
}
...
func (o *HyperflexServerModel) SetAppCatalogNil() {
...
func (o HyperflexServerModel) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexServerModel) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexServerModelWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexServerModel)
	if err == nil {
