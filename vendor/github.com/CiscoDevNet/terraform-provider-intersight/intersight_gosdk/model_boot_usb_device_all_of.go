...
// BootUsbDeviceAllOf Definition of the list of properties defined in 'boot.UsbDevice', excluding properties defined in parent classes.
type BootUsbDeviceAllOf struct {
...
type _BootUsbDeviceAllOf BootUsbDeviceAllOf
...
func NewBootUsbDeviceAllOfWithDefaults() *BootUsbDeviceAllOf {
	this := BootUsbDeviceAllOf{}
	var classId string = "boot.UsbDevice"
	this.ClassId = classId
	var objectType string = "boot.UsbDevice"
	this.ObjectType = objectType
	return &this
}
...
func (o BootUsbDeviceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BootUsbDeviceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBootUsbDeviceAllOf := _BootUsbDeviceAllOf{}

	if err = json.Unmarshal(bytes, &varBootUsbDeviceAllOf); err == nil {
		*o = BootUsbDeviceAllOf(varBootUsbDeviceAllOf)
	}
...
type NullableBootUsbDeviceAllOf struct {
	value *BootUsbDeviceAllOf
	isSet bool
}

func (v NullableBootUsbDeviceAllOf) Get() *BootUsbDeviceAllOf {
	return v.value
}

func (v *NullableBootUsbDeviceAllOf) Set(val *BootUsbDeviceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBootUsbDeviceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBootUsbDeviceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootUsbDeviceAllOf(val *BootUsbDeviceAllOf) *NullableBootUsbDeviceAllOf {
	return &NullableBootUsbDeviceAllOf{value: val, isSet: true}
}

func (v NullableBootUsbDeviceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootUsbDeviceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
