...
// checks if the TelemetryDruidExtractionFunctionStrlen type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidExtractionFunctionStrlen{}
...
func (o TelemetryDruidExtractionFunctionStrlen) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidExtractionFunctionStrlen) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidExtractionFunctionStrlen)
