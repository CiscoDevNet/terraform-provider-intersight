...
func AssetSubscriptionDeviceContractInformationListAsAssetSubscriptionDeviceContractInformationResponse(v *AssetSubscriptionDeviceContractInformationList) AssetSubscriptionDeviceContractInformationResponse {
	return AssetSubscriptionDeviceContractInformationResponse{
		AssetSubscriptionDeviceContractInformationList: v,
	}
}
...
func (dst *AssetSubscriptionDeviceContractInformationResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "asset.SubscriptionDeviceContractInformation.List" {
		// try to unmarshal JSON data into AssetSubscriptionDeviceContractInformationList
		err = json.Unmarshal(data, &dst.AssetSubscriptionDeviceContractInformationList)
		if err == nil {
			return nil // data stored in dst.AssetSubscriptionDeviceContractInformationList, return on the first match
		} else {
			dst.AssetSubscriptionDeviceContractInformationList = nil
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionDeviceContractInformationResponse as AssetSubscriptionDeviceContractInformationList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionDeviceContractInformationResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionDeviceContractInformationResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionDeviceContractInformationResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src AssetSubscriptionDeviceContractInformationResponse) MarshalJSON() ([]byte, error) {
	if src.AssetSubscriptionDeviceContractInformationList != nil {
		return json.Marshal(&src.AssetSubscriptionDeviceContractInformationList)
	}
...
type NullableAssetSubscriptionDeviceContractInformationResponse struct {
	value *AssetSubscriptionDeviceContractInformationResponse
	isSet bool
}

func (v NullableAssetSubscriptionDeviceContractInformationResponse) Get() *AssetSubscriptionDeviceContractInformationResponse {
	return v.value
}

func (v *NullableAssetSubscriptionDeviceContractInformationResponse) Set(val *AssetSubscriptionDeviceContractInformationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetSubscriptionDeviceContractInformationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetSubscriptionDeviceContractInformationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetSubscriptionDeviceContractInformationResponse(val *AssetSubscriptionDeviceContractInformationResponse) *NullableAssetSubscriptionDeviceContractInformationResponse {
	return &NullableAssetSubscriptionDeviceContractInformationResponse{value: val, isSet: true}
}

func (v NullableAssetSubscriptionDeviceContractInformationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetSubscriptionDeviceContractInformationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
