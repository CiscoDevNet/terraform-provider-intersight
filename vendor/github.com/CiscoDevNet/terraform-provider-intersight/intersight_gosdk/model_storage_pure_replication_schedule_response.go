...
func StoragePureReplicationScheduleListAsStoragePureReplicationScheduleResponse(v *StoragePureReplicationScheduleList) StoragePureReplicationScheduleResponse {
	return StoragePureReplicationScheduleResponse{
		StoragePureReplicationScheduleList: v,
	}
}
...
func (dst *StoragePureReplicationScheduleResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StoragePureReplicationScheduleResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StoragePureReplicationScheduleResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal StoragePureReplicationScheduleResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'storage.PureReplicationSchedule.List'
	if jsonDict["ObjectType"] == "storage.PureReplicationSchedule.List" {
		// try to unmarshal JSON data into StoragePureReplicationScheduleList
		err = json.Unmarshal(data, &dst.StoragePureReplicationScheduleList)
		if err == nil {
			return nil // data stored in dst.StoragePureReplicationScheduleList, return on the first match
		} else {
			dst.StoragePureReplicationScheduleList = nil
			return fmt.Errorf("Failed to unmarshal StoragePureReplicationScheduleResponse as StoragePureReplicationScheduleList: %s", err.Error())
		}
	}
...
func (src StoragePureReplicationScheduleResponse) MarshalJSON() ([]byte, error) {
	...
	if src.StoragePureReplicationScheduleList != nil {
		return json.Marshal(&src.StoragePureReplicationScheduleList)
	}
...
func (obj *StoragePureReplicationScheduleResponse) GetActualInstance() interface{} {
	...
	if obj.StoragePureReplicationScheduleList != nil {
		return obj.StoragePureReplicationScheduleList
	}
...
type NullableStoragePureReplicationScheduleResponse struct {
	value *StoragePureReplicationScheduleResponse
	isSet bool
}

func (v NullableStoragePureReplicationScheduleResponse) Get() *StoragePureReplicationScheduleResponse {
	return v.value
}

func (v *NullableStoragePureReplicationScheduleResponse) Set(val *StoragePureReplicationScheduleResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePureReplicationScheduleResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePureReplicationScheduleResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePureReplicationScheduleResponse(val *StoragePureReplicationScheduleResponse) *NullableStoragePureReplicationScheduleResponse {
	return &NullableStoragePureReplicationScheduleResponse{value: val, isSet: true}
}

func (v NullableStoragePureReplicationScheduleResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePureReplicationScheduleResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
