...
// checks if the NiaapiApicSweol type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiApicSweol{}
...
func (o NiaapiApicSweol) ToMap() (map[string]interface{}, error) {
...
func (o *NiaapiApicSweol) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiApicSweolWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiApicSweol)
	if err == nil {
