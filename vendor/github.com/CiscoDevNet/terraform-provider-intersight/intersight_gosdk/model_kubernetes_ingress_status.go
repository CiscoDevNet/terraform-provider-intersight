...
// checks if the KubernetesIngressStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesIngressStatus{}
...
// GetDefaultClassId returns the default value "kubernetes.IngressStatus" of the ClassId field.
func (o *KubernetesIngressStatus) GetDefaultClassId() interface{} {
	return "kubernetes.IngressStatus"
}
...
// GetDefaultObjectType returns the default value "kubernetes.IngressStatus" of the ObjectType field.
func (o *KubernetesIngressStatus) GetDefaultObjectType() interface{} {
	return "kubernetes.IngressStatus"
}
...
func (o KubernetesIngressStatus) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesIngressStatus) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesIngressStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesIngressStatus)
	if err == nil {
