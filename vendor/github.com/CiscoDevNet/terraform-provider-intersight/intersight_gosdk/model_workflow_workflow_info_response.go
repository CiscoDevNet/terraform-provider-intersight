...
func (dst *WorkflowWorkflowInfoResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal WorkflowWorkflowInfoResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal WorkflowWorkflowInfoResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal WorkflowWorkflowInfoResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'workflow.WorkflowInfo.List'
	if jsonDict["ObjectType"] == "workflow.WorkflowInfo.List" {
		// try to unmarshal JSON data into WorkflowWorkflowInfoList
		err = json.Unmarshal(data, &dst.WorkflowWorkflowInfoList)
		if err == nil {
			return nil // data stored in dst.WorkflowWorkflowInfoList, return on the first match
		} else {
			dst.WorkflowWorkflowInfoList = nil
			return fmt.Errorf("Failed to unmarshal WorkflowWorkflowInfoResponse as WorkflowWorkflowInfoList: %s", err.Error())
		}
	}
...
func (src WorkflowWorkflowInfoResponse) MarshalJSON() ([]byte, error) {
	...
	if src.WorkflowWorkflowInfoList != nil {
		return json.Marshal(&src.WorkflowWorkflowInfoList)
	}
...
func (obj *WorkflowWorkflowInfoResponse) GetActualInstance() interface{} {
	...
	if obj.WorkflowWorkflowInfoList != nil {
		return obj.WorkflowWorkflowInfoList
	}
...
type NullableWorkflowWorkflowInfoResponse struct {
	value *WorkflowWorkflowInfoResponse
	isSet bool
}

func (v NullableWorkflowWorkflowInfoResponse) Get() *WorkflowWorkflowInfoResponse {
	return v.value
}

func (v *NullableWorkflowWorkflowInfoResponse) Set(val *WorkflowWorkflowInfoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowWorkflowInfoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowWorkflowInfoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowWorkflowInfoResponse(val *WorkflowWorkflowInfoResponse) *NullableWorkflowWorkflowInfoResponse {
	return &NullableWorkflowWorkflowInfoResponse{value: val, isSet: true}
}

func (v NullableWorkflowWorkflowInfoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowWorkflowInfoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
