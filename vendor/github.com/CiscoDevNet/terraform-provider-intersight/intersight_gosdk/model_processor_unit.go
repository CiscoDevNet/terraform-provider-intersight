...
type ProcessorUnit struct {
	...
	ConnectedPcieDevices []MoBaseMoRelationship                      `json:"ConnectedPcieDevices,omitempty"`
...
// GetConnectedPcieDevices returns the ConnectedPcieDevices field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ProcessorUnit) GetConnectedPcieDevices() []MoBaseMoRelationship {
	if o == nil {
		var ret []MoBaseMoRelationship
		return ret
	}
	return o.ConnectedPcieDevices
}

// GetConnectedPcieDevicesOk returns a tuple with the ConnectedPcieDevices field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ProcessorUnit) GetConnectedPcieDevicesOk() ([]MoBaseMoRelationship, bool) {
	if o == nil || IsNil(o.ConnectedPcieDevices) {
		return nil, false
	}
	return o.ConnectedPcieDevices, true
}
...
// SetConnectedPcieDevices gets a reference to the given []MoBaseMoRelationship and assigns it to the ConnectedPcieDevices field.
func (o *ProcessorUnit) SetConnectedPcieDevices(v []MoBaseMoRelationship) {
	o.ConnectedPcieDevices = v
}
...
func (o *ProcessorUnit) SetPciEndpointNil() {
...
func (o ProcessorUnit) ToMap() (map[string]interface{}, error) {
	...
	if o.ConnectedPcieDevices != nil {
		toSerialize["ConnectedPcieDevices"] = o.ConnectedPcieDevices
	}
...
func (o *ProcessorUnit) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varProcessorUnit.ConnectedPcieDevices = varProcessorUnitWithoutEmbeddedStruct.ConnectedPcieDevices
		...
		varProcessorUnit.PciEndpoint = varProcessorUnitWithoutEmbeddedStruct.PciEndpoint
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ConnectedPcieDevices")
