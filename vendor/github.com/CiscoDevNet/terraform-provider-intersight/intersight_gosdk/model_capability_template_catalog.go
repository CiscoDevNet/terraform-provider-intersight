...
func (o *CapabilityTemplateCatalog) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCapabilityTemplateCatalogWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCapabilityTemplateCatalog)
	if err == nil {
