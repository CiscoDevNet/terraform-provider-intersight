...
// checks if the HclConstraint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HclConstraint{}
...
// GetDefaultClassId returns the default value "hcl.Constraint" of the ClassId field.
func (o *HclConstraint) GetDefaultClassId() interface{} {
	return "hcl.Constraint"
}
...
// GetDefaultObjectType returns the default value "hcl.Constraint" of the ObjectType field.
func (o *HclConstraint) GetDefaultObjectType() interface{} {
	return "hcl.Constraint"
}
...
func (o HclConstraint) ToMap() (map[string]interface{}, error) {
...
func (o *HclConstraint) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHclConstraintWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHclConstraint)
	if err == nil {
