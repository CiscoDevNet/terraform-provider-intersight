...
// TamSecurityAdvisoryDetailsAllOf Definition of the list of properties defined in 'tam.SecurityAdvisoryDetails', excluding properties defined in parent classes.
type TamSecurityAdvisoryDetailsAllOf struct {
...
type _TamSecurityAdvisoryDetailsAllOf TamSecurityAdvisoryDetailsAllOf
...
func NewTamSecurityAdvisoryDetailsAllOf(classId string, objectType string) *TamSecurityAdvisoryDetailsAllOf {
	this := TamSecurityAdvisoryDetailsAllOf{}
...
func (o TamSecurityAdvisoryDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *TamSecurityAdvisoryDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTamSecurityAdvisoryDetailsAllOf := _TamSecurityAdvisoryDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varTamSecurityAdvisoryDetailsAllOf); err == nil {
		*o = TamSecurityAdvisoryDetailsAllOf(varTamSecurityAdvisoryDetailsAllOf)
	}
...
type NullableTamSecurityAdvisoryDetailsAllOf struct {
	value *TamSecurityAdvisoryDetailsAllOf
	isSet bool
}

func (v NullableTamSecurityAdvisoryDetailsAllOf) Get() *TamSecurityAdvisoryDetailsAllOf {
	return v.value
}

func (v *NullableTamSecurityAdvisoryDetailsAllOf) Set(val *TamSecurityAdvisoryDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTamSecurityAdvisoryDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTamSecurityAdvisoryDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTamSecurityAdvisoryDetailsAllOf(val *TamSecurityAdvisoryDetailsAllOf) *NullableTamSecurityAdvisoryDetailsAllOf {
	return &NullableTamSecurityAdvisoryDetailsAllOf{value: val, isSet: true}
}

func (v NullableTamSecurityAdvisoryDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTamSecurityAdvisoryDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
