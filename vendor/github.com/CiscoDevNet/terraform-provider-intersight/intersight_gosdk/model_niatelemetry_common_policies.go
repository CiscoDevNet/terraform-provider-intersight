...
// checks if the NiatelemetryCommonPolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryCommonPolicies{}
...
// GetDefaultClassId returns the default value "niatelemetry.CommonPolicies" of the ClassId field.
func (o *NiatelemetryCommonPolicies) GetDefaultClassId() interface{} {
	return "niatelemetry.CommonPolicies"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.CommonPolicies" of the ObjectType field.
func (o *NiatelemetryCommonPolicies) GetDefaultObjectType() interface{} {
	return "niatelemetry.CommonPolicies"
}
...
func (o *NiatelemetryCommonPolicies) SetRegisteredDeviceNil() {
...
func (o NiatelemetryCommonPolicies) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryCommonPolicies) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryCommonPoliciesWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryCommonPolicies)
	if err == nil {
