...
// checks if the KubernetesBaseGpuProduct type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesBaseGpuProduct{}
...
func (o *KubernetesBaseGpuProduct) GetDefaultClassId() interface{} {
...
func (o *KubernetesBaseGpuProduct) GetDefaultObjectType() interface{} {
	return "kubernetes.NvidiaGpuProduct"
}
...
func (o KubernetesBaseGpuProduct) ToMap() (map[string]interface{}, error) {
	...
	if errKubernetesBaseProduct != nil {
		return map[string]interface{}{}, errKubernetesBaseProduct
	}
...
func (o *KubernetesBaseGpuProduct) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesBaseGpuProductWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesBaseGpuProduct)
	if err == nil {
