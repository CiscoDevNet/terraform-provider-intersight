...
func HyperflexFeatureLimitInternalListAsHyperflexFeatureLimitInternalResponse(v *HyperflexFeatureLimitInternalList) HyperflexFeatureLimitInternalResponse {
	return HyperflexFeatureLimitInternalResponse{
		HyperflexFeatureLimitInternalList: v,
	}
}
...
func (dst *HyperflexFeatureLimitInternalResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'hyperflex.FeatureLimitInternal.List'
	if jsonDict["ObjectType"] == "hyperflex.FeatureLimitInternal.List" {
		// try to unmarshal JSON data into HyperflexFeatureLimitInternalList
		err = json.Unmarshal(data, &dst.HyperflexFeatureLimitInternalList)
		if err == nil {
			return nil // data stored in dst.HyperflexFeatureLimitInternalList, return on the first match
		} else {
			dst.HyperflexFeatureLimitInternalList = nil
			return fmt.Errorf("failed to unmarshal HyperflexFeatureLimitInternalResponse as HyperflexFeatureLimitInternalList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal HyperflexFeatureLimitInternalResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal HyperflexFeatureLimitInternalResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal HyperflexFeatureLimitInternalResponse as MoTagSummary: %s", err.Error())
		}
	}
