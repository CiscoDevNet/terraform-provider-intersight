...
func (o *NiatelemetryDcnmPsuDetailsList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryDcnmPsuDetailsListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryDcnmPsuDetailsList)
	if err == nil {
