...
// checks if the AdapterHostEthInterfaceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdapterHostEthInterfaceList{}
...
func (o AdapterHostEthInterfaceList) ToMap() (map[string]interface{}, error) {
...
func (o *AdapterHostEthInterfaceList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAdapterHostEthInterfaceListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAdapterHostEthInterfaceList)
	if err == nil {
