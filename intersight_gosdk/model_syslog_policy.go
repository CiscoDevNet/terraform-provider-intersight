...
// GetLocalClients returns the LocalClients field value if set, zero value otherwise.
...
// GetRemoteClients returns the RemoteClients field value if set, zero value otherwise.
