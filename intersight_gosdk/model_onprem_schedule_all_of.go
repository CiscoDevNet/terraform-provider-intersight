...
type _OnpremScheduleAllOf OnpremScheduleAllOf
...
func (o *OnpremScheduleAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varOnpremScheduleAllOf := _OnpremScheduleAllOf{}

	if err = json.Unmarshal(bytes, &varOnpremScheduleAllOf); err == nil {
		*o = OnpremScheduleAllOf(varOnpremScheduleAllOf)
	}
