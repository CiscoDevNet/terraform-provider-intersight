...
func (o *KubernetesClusterManagementConfig) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varKubernetesClusterManagementConfig.EncryptedEtcd = varKubernetesClusterManagementConfigWithoutEmbeddedStruct.EncryptedEtcd
		varKubernetesClusterManagementConfig.InternalMgmtPrivateKey = varKubernetesClusterManagementConfigWithoutEmbeddedStruct.InternalMgmtPrivateKey
		varKubernetesClusterManagementConfig.InternalMgmtPublicKey = varKubernetesClusterManagementConfigWithoutEmbeddedStruct.InternalMgmtPublicKey
