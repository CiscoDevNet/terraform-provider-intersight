...
// checks if the SdcardServerConfigurationUtility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdcardServerConfigurationUtility{}
...
func (o SdcardServerConfigurationUtility) ToMap() (map[string]interface{}, error) {
...
func (o *SdcardServerConfigurationUtility) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSdcardServerConfigurationUtilityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSdcardServerConfigurationUtility)
	if err == nil {
