...
func (o *IpmioverlanPolicyInventoryList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varIpmioverlanPolicyInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varIpmioverlanPolicyInventoryList)
	if err == nil {
