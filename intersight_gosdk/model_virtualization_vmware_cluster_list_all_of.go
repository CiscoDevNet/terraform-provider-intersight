...
// VirtualizationVmwareClusterListAllOf struct for VirtualizationVmwareClusterListAllOf
type VirtualizationVmwareClusterListAllOf struct {
...
type _VirtualizationVmwareClusterListAllOf VirtualizationVmwareClusterListAllOf
...
func NewVirtualizationVmwareClusterListAllOf() *VirtualizationVmwareClusterListAllOf {
	this := VirtualizationVmwareClusterListAllOf{}
	return &this
}
...
func (o VirtualizationVmwareClusterListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationVmwareClusterListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationVmwareClusterListAllOf := _VirtualizationVmwareClusterListAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationVmwareClusterListAllOf); err == nil {
		*o = VirtualizationVmwareClusterListAllOf(varVirtualizationVmwareClusterListAllOf)
	}
...
type NullableVirtualizationVmwareClusterListAllOf struct {
	value *VirtualizationVmwareClusterListAllOf
	isSet bool
}

func (v NullableVirtualizationVmwareClusterListAllOf) Get() *VirtualizationVmwareClusterListAllOf {
	return v.value
}

func (v *NullableVirtualizationVmwareClusterListAllOf) Set(val *VirtualizationVmwareClusterListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmwareClusterListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmwareClusterListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmwareClusterListAllOf(val *VirtualizationVmwareClusterListAllOf) *NullableVirtualizationVmwareClusterListAllOf {
	return &NullableVirtualizationVmwareClusterListAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmwareClusterListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmwareClusterListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
