...
// checks if the FirmwareComponentImpact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirmwareComponentImpact{}
...
// GetDefaultClassId returns the default value "firmware.ComponentImpact" of the ClassId field.
func (o *FirmwareComponentImpact) GetDefaultClassId() interface{} {
	return "firmware.ComponentImpact"
}
...
// GetDefaultObjectType returns the default value "firmware.ComponentImpact" of the ObjectType field.
func (o *FirmwareComponentImpact) GetDefaultObjectType() interface{} {
	return "firmware.ComponentImpact"
}
...
func (o FirmwareComponentImpact) ToMap() (map[string]interface{}, error) {
...
func (o *FirmwareComponentImpact) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFirmwareComponentImpactWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFirmwareComponentImpact)
	if err == nil {
