...
// checks if the TaskHyperFlexManagementScopedInventory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskHyperFlexManagementScopedInventory{}
...
// GetDefaultClassId returns the default value "task.HyperFlexManagementScopedInventory" of the ClassId field.
func (o *TaskHyperFlexManagementScopedInventory) GetDefaultClassId() interface{} {
	return "task.HyperFlexManagementScopedInventory"
}
...
// GetDefaultObjectType returns the default value "task.HyperFlexManagementScopedInventory" of the ObjectType field.
func (o *TaskHyperFlexManagementScopedInventory) GetDefaultObjectType() interface{} {
	return "task.HyperFlexManagementScopedInventory"
}
...
func (o *TaskHyperFlexManagementScopedInventory) SetRegisteredDeviceNil() {
...
func (o TaskHyperFlexManagementScopedInventory) ToMap() (map[string]interface{}, error) {
...
func (o *TaskHyperFlexManagementScopedInventory) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTaskHyperFlexManagementScopedInventoryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTaskHyperFlexManagementScopedInventory)
	if err == nil {
