...
// checks if the FirmwareGpuDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirmwareGpuDescriptor{}
...
func (o FirmwareGpuDescriptor) ToMap() (map[string]interface{}, error) {
...
func (o *FirmwareGpuDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFirmwareGpuDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFirmwareGpuDescriptor)
	if err == nil {
