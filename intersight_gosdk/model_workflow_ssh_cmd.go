...
// checks if the WorkflowSshCmd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowSshCmd{}
...
// GetDefaultClassId returns the default value "workflow.SshCmd" of the ClassId field.
func (o *WorkflowSshCmd) GetDefaultClassId() interface{} {
	return "workflow.SshCmd"
}
...
// GetDefaultObjectType returns the default value "workflow.SshCmd" of the ObjectType field.
func (o *WorkflowSshCmd) GetDefaultObjectType() interface{} {
	return "workflow.SshCmd"
}
...
func (o *WorkflowSshCmd) GetShellPromptTimeout() int64 {
	if o == nil || IsNil(o.ShellPromptTimeout) {
		var ret int64
		return ret
	}
...
func (o WorkflowSshCmd) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowSshCmd) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowSshCmdWithoutEmbeddedStruct)
	if err == nil {
		varWorkflowSshCmd := _WorkflowSshCmd{}
		varWorkflowSshCmd.ClassId = varWorkflowSshCmdWithoutEmbeddedStruct.ClassId
		varWorkflowSshCmd.ObjectType = varWorkflowSshCmdWithoutEmbeddedStruct.ObjectType
	...
	err = json.Unmarshal(data, &varWorkflowSshCmd)
	if err == nil {
