...
// checks if the HclOperatingSystemList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HclOperatingSystemList{}
...
func NewHclOperatingSystemList(objectType string) *HclOperatingSystemList {
...
func (o HclOperatingSystemList) ToMap() (map[string]interface{}, error) {
...
func (o *HclOperatingSystemList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHclOperatingSystemListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHclOperatingSystemList)
	if err == nil {
