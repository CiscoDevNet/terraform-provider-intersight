...
func (o *SdcardPolicy) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSdcardPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSdcardPolicy)
	if err == nil {
