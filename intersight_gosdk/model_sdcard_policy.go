...
// checks if the SdcardPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdcardPolicy{}
...
type _SdcardPolicy SdcardPolicy
...
// GetDefaultClassId returns the default value "sdcard.Policy" of the ClassId field.
func (o *SdcardPolicy) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "sdcard.Policy" of the ObjectType field.
func (o *SdcardPolicy) GetDefaultObjectType() interface{} {
	return "sdcard.Policy"
}
...
func (o *SdcardPolicy) SetOrganizationNil() {
	o.Organization.Set(nil)
}

// UnsetOrganization ensures that no value is present for Organization, not even an explicit nil
func (o *SdcardPolicy) UnsetOrganization() {
...
func (o SdcardPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *SdcardPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	type SdcardPolicyWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType   string                                       `json:"ObjectType"`
	...
	varSdcardPolicyWithoutEmbeddedStruct := SdcardPolicyWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varSdcardPolicyWithoutEmbeddedStruct)
	if err == nil {
		varSdcardPolicy := _SdcardPolicy{}
		varSdcardPolicy.ClassId = varSdcardPolicyWithoutEmbeddedStruct.ClassId
		varSdcardPolicy.ObjectType = varSdcardPolicyWithoutEmbeddedStruct.ObjectType
		varSdcardPolicy.Partitions = varSdcardPolicyWithoutEmbeddedStruct.Partitions
		varSdcardPolicy.Organization = varSdcardPolicyWithoutEmbeddedStruct.Organization
		varSdcardPolicy.Profiles = varSdcardPolicyWithoutEmbeddedStruct.Profiles
		*o = SdcardPolicy(varSdcardPolicy)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varSdcardPolicy)
	if err == nil {
		o.PolicyAbstractPolicy = varSdcardPolicy.PolicyAbstractPolicy
	} else {
		return err
	}
