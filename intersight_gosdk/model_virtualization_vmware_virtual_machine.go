...
// GetDnsServerList returns the DnsServerList field value if set, zero value otherwise.
...
func (o *VirtualizationVmwareVirtualMachine) GetRemoteDisplayInfoOk() (*VirtualizationVmwareRemoteDisplayInfo, bool) {
	...
	return o.RemoteDisplayInfo, true
}
...
func (o VirtualizationVmwareVirtualMachine) MarshalJSON() ([]byte, error) {
	...
	if o.CpuSocketInfo != nil {
		toSerialize["CpuSocketInfo"] = o.CpuSocketInfo
	}
	...
	if o.DiskCommitInfo != nil {
		toSerialize["DiskCommitInfo"] = o.DiskCommitInfo
	}
	...
	if o.RemoteDisplayInfo != nil {
		toSerialize["RemoteDisplayInfo"] = o.RemoteDisplayInfo
	}
...
func (o *VirtualizationVmwareVirtualMachine) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varVirtualizationVmwareVirtualMachine.BootTime = varVirtualizationVmwareVirtualMachineWithoutEmbeddedStruct.BootTime
