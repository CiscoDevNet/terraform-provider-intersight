...
// checks if the IppoolShadowBlockList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IppoolShadowBlockList{}
...
func (o IppoolShadowBlockList) ToMap() (map[string]interface{}, error) {
...
func (o *IppoolShadowBlockList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIppoolShadowBlockListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIppoolShadowBlockList)
	if err == nil {
