...
func (o *TelemetryDruidQuerySpecInsensitiveContains) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidQuerySpecInsensitiveContains := _TelemetryDruidQuerySpecInsensitiveContains{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidQuerySpecInsensitiveContains); err == nil {
