...
// checks if the CloudBaseBillingUnit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudBaseBillingUnit{}
...
func (o *CloudBaseBillingUnit) GetDefaultClassId() interface{} {
...
func (o *CloudBaseBillingUnit) GetDefaultObjectType() interface{} {
	return "cloud.AwsBillingUnit"
}
...
func (o CloudBaseBillingUnit) ToMap() (map[string]interface{}, error) {
...
func (o *CloudBaseBillingUnit) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCloudBaseBillingUnitWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCloudBaseBillingUnit)
	if err == nil {
