...
func (r ApiGetTopSystemByMoidRequest) Execute() (TopSystem, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return TopSystem
 */
func (a *TopApiService) GetTopSystemByMoidExecute(r ApiGetTopSystemByMoidRequest) (TopSystem, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetTopSystemListRequest) Execute() (TopSystemResponse, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *TopApiService) GetTopSystemListExecute(r ApiGetTopSystemListRequest) (TopSystemResponse, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiPatchTopSystemRequest) Execute() (TopSystem, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return TopSystem
 */
func (a *TopApiService) PatchTopSystemExecute(r ApiPatchTopSystemRequest) (TopSystem, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	localVarFormParams := _neturl.Values{}
	if r.topSystem == nil {
		executionError.error = "topSystem is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
...
func (r ApiUpdateTopSystemRequest) Execute() (TopSystem, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return TopSystem
 */
func (a *TopApiService) UpdateTopSystemExecute(r ApiUpdateTopSystemRequest) (TopSystem, *_nethttp.Response, GenericOpenAPIError) {
	var (
