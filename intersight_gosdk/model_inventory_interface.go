...
// checks if the InventoryInterface type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InventoryInterface{}
...
func (o InventoryInterface) ToMap() (map[string]interface{}, error) {
...
func (o *InventoryInterface) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varInventoryInterfaceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varInventoryInterface)
	if err == nil {
