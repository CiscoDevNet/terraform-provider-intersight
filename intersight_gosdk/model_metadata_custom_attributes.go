...
// MetadataCustomAttributes Stores any platform specific information.
type MetadataCustomAttributes struct {
	MoBaseComplexType
...
type _MetadataCustomAttributes MetadataCustomAttributes
...
func NewMetadataCustomAttributesWithDefaults() *MetadataCustomAttributes {
	this := MetadataCustomAttributes{}
	var classId string = "metadata.CustomAttributes"
	this.ClassId = classId
	var objectType string = "metadata.CustomAttributes"
	this.ObjectType = objectType
	return &this
}
...
func (o MetadataCustomAttributes) MarshalJSON() ([]byte, error) {
...
func (o *MetadataCustomAttributes) UnmarshalJSON(bytes []byte) (err error) {
	type MetadataCustomAttributesWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varMetadataCustomAttributesWithoutEmbeddedStruct := MetadataCustomAttributesWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varMetadataCustomAttributesWithoutEmbeddedStruct)
	if err == nil {
		varMetadataCustomAttributes := _MetadataCustomAttributes{}
		varMetadataCustomAttributes.ClassId = varMetadataCustomAttributesWithoutEmbeddedStruct.ClassId
		varMetadataCustomAttributes.ObjectType = varMetadataCustomAttributesWithoutEmbeddedStruct.ObjectType
		varMetadataCustomAttributes.AttributeName = varMetadataCustomAttributesWithoutEmbeddedStruct.AttributeName
		varMetadataCustomAttributes.AttributeType = varMetadataCustomAttributesWithoutEmbeddedStruct.AttributeType
		varMetadataCustomAttributes.AttributeValue = varMetadataCustomAttributesWithoutEmbeddedStruct.AttributeValue
		*o = MetadataCustomAttributes(varMetadataCustomAttributes)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varMetadataCustomAttributes)
	if err == nil {
		o.MoBaseComplexType = varMetadataCustomAttributes.MoBaseComplexType
	} else {
		return err
	}
...
type NullableMetadataCustomAttributes struct {
	value *MetadataCustomAttributes
	isSet bool
}

func (v NullableMetadataCustomAttributes) Get() *MetadataCustomAttributes {
	return v.value
}

func (v *NullableMetadataCustomAttributes) Set(val *MetadataCustomAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataCustomAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataCustomAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataCustomAttributes(val *MetadataCustomAttributes) *NullableMetadataCustomAttributes {
	return &NullableMetadataCustomAttributes{value: val, isSet: true}
}

func (v NullableMetadataCustomAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataCustomAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
