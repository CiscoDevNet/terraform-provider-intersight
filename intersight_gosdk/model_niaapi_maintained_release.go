...
// checks if the NiaapiMaintainedRelease type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiMaintainedRelease{}

// NiaapiMaintainedRelease The MaintainedRelease object is a cornerstone of software lifecycle management, focusing on maintaining up-to-date software versions. It ensures users have access to the latest stable releases. #### Purpose MaintainedRelease provides information on the current maintained software versions, ensuring users are informed about stable and supported releases. It is crucial for system stability and continuity. #### Key Concepts - **Version Maintenance:** Focuses on providing stable and supported software versions for users. - **System Continuity:** Ensures users can rely on maintained releases for consistent and uninterrupted operation. - **Release Updates:** Keeps users informed about updates to maintained software versions, promoting system reliability.
...
func (o *NiaapiMaintainedRelease) GetMaintainedRelease() string {
	if o == nil || IsNil(o.MaintainedRelease) {
		var ret string
		return ret
	}
...
func (o *NiaapiMaintainedRelease) GetSoftwareRelease() string {
	if o == nil || IsNil(o.SoftwareRelease) {
		var ret string
		return ret
	}
...
func (o NiaapiMaintainedRelease) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaintainedRelease) {
		toSerialize["MaintainedRelease"] = o.MaintainedRelease
	}
	if !IsNil(o.SoftwareRelease) {
...
func (o *NiaapiMaintainedRelease) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiMaintainedReleaseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiMaintainedRelease)
	if err == nil {
