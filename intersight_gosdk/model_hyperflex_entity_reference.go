...
// checks if the HyperflexEntityReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexEntityReference{}
...
// GetDefaultClassId returns the default value "hyperflex.EntityReference" of the ClassId field.
func (o *HyperflexEntityReference) GetDefaultClassId() interface{} {
	return "hyperflex.EntityReference"
}
...
// GetDefaultObjectType returns the default value "hyperflex.EntityReference" of the ObjectType field.
func (o *HyperflexEntityReference) GetDefaultObjectType() interface{} {
	return "hyperflex.EntityReference"
}
...
func (o HyperflexEntityReference) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexEntityReference) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexEntityReferenceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexEntityReference)
	if err == nil {
