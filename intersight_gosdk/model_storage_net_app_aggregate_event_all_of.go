...
// StorageNetAppAggregateEventAllOf Definition of the list of properties defined in 'storage.NetAppAggregateEvent', excluding properties defined in parent classes.
type StorageNetAppAggregateEventAllOf struct {
...
type _StorageNetAppAggregateEventAllOf StorageNetAppAggregateEventAllOf
...
func NewStorageNetAppAggregateEventAllOf(classId string, objectType string) *StorageNetAppAggregateEventAllOf {
	this := StorageNetAppAggregateEventAllOf{}
...
func (o StorageNetAppAggregateEventAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppAggregateEventAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppAggregateEventAllOf := _StorageNetAppAggregateEventAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppAggregateEventAllOf); err == nil {
		*o = StorageNetAppAggregateEventAllOf(varStorageNetAppAggregateEventAllOf)
	}
...
type NullableStorageNetAppAggregateEventAllOf struct {
	value *StorageNetAppAggregateEventAllOf
	isSet bool
}

func (v NullableStorageNetAppAggregateEventAllOf) Get() *StorageNetAppAggregateEventAllOf {
	return v.value
}

func (v *NullableStorageNetAppAggregateEventAllOf) Set(val *StorageNetAppAggregateEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppAggregateEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppAggregateEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppAggregateEventAllOf(val *StorageNetAppAggregateEventAllOf) *NullableStorageNetAppAggregateEventAllOf {
	return &NullableStorageNetAppAggregateEventAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppAggregateEventAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppAggregateEventAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
