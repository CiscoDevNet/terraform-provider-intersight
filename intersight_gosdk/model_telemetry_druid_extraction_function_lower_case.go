...
func (o *TelemetryDruidExtractionFunctionLowerCase) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidExtractionFunctionLowerCase := _TelemetryDruidExtractionFunctionLowerCase{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidExtractionFunctionLowerCase); err == nil {
