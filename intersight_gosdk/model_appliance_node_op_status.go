...
func (o *ApplianceNodeOpStatus) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varApplianceNodeOpStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varApplianceNodeOpStatus)
	if err == nil {
