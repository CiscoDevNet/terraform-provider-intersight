...
// CommHttpProxyPolicyListAllOf struct for CommHttpProxyPolicyListAllOf
type CommHttpProxyPolicyListAllOf struct {
...
type _CommHttpProxyPolicyListAllOf CommHttpProxyPolicyListAllOf
...
func NewCommHttpProxyPolicyListAllOf() *CommHttpProxyPolicyListAllOf {
	this := CommHttpProxyPolicyListAllOf{}
	return &this
}
...
func (o CommHttpProxyPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CommHttpProxyPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCommHttpProxyPolicyListAllOf := _CommHttpProxyPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varCommHttpProxyPolicyListAllOf); err == nil {
		*o = CommHttpProxyPolicyListAllOf(varCommHttpProxyPolicyListAllOf)
	}
...
type NullableCommHttpProxyPolicyListAllOf struct {
	value *CommHttpProxyPolicyListAllOf
	isSet bool
}

func (v NullableCommHttpProxyPolicyListAllOf) Get() *CommHttpProxyPolicyListAllOf {
	return v.value
}

func (v *NullableCommHttpProxyPolicyListAllOf) Set(val *CommHttpProxyPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCommHttpProxyPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCommHttpProxyPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommHttpProxyPolicyListAllOf(val *CommHttpProxyPolicyListAllOf) *NullableCommHttpProxyPolicyListAllOf {
	return &NullableCommHttpProxyPolicyListAllOf{value: val, isSet: true}
}

func (v NullableCommHttpProxyPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommHttpProxyPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
