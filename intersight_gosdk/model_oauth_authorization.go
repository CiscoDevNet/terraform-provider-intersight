...
// OauthAuthorization User's consent for Intersight to contact an external software repository such as cisco.com, on the user's behalf. Used by Intersight Appliance to support the resource owner grant type.
...
// GetDefaultClassId returns the default value "oauth.Authorization" of the ClassId field.
func (o *OauthAuthorization) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "oauth.Authorization" of the ObjectType field.
func (o *OauthAuthorization) GetDefaultObjectType() interface{} {
	return "oauth.Authorization"
}
