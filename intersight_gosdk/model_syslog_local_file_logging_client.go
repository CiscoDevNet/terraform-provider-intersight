...
// checks if the SyslogLocalFileLoggingClient type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogLocalFileLoggingClient{}
...
func NewSyslogLocalFileLoggingClient(classId string, objectType string) *SyslogLocalFileLoggingClient {
...
func (o SyslogLocalFileLoggingClient) ToMap() (map[string]interface{}, error) {
	...
	if errSyslogLocalClientBase != nil {
		return map[string]interface{}{}, errSyslogLocalClientBase
	}
...
func (o *SyslogLocalFileLoggingClient) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSyslogLocalFileLoggingClientWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSyslogLocalFileLoggingClient)
	if err == nil {
