...
// checks if the StorageR0Drive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageR0Drive{}
...
type StorageR0Drive struct {
	...
	DriveSlots *string `json:"DriveSlots,omitempty" validate:"regexp=^$|^((\\\\d+\\\\-\\\\d+)|(\\\\d+))(,((\\\\d+\\\\-\\\\d+)|(\\\\d+)))*$"`
	// The list of drive slots where RAID0 virtual drives must be created (comma separated).
	DriveSlotsList *string `json:"DriveSlotsList,omitempty" validate:"regexp=^$|^((\\\\d+\\\\-\\\\d+)|(\\\\d+))(,((\\\\d+\\\\-\\\\d+)|(\\\\d+)))*$"`
...
// GetDefaultClassId returns the default value "storage.R0Drive" of the ClassId field.
func (o *StorageR0Drive) GetDefaultClassId() interface{} {
	return "storage.R0Drive"
}
...
// GetDefaultObjectType returns the default value "storage.R0Drive" of the ObjectType field.
func (o *StorageR0Drive) GetDefaultObjectType() interface{} {
	return "storage.R0Drive"
}
...
func (o *StorageR0Drive) GetDriveSlotsList() string {
	if o == nil || IsNil(o.DriveSlotsList) {
		var ret string
		return ret
	}
...
func (o *StorageR0Drive) GetVirtualDrivePolicy() StorageVirtualDrivePolicy {
	if o == nil || IsNil(o.VirtualDrivePolicy.Get()) {
...
func (o StorageR0Drive) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DriveSlots) {
		toSerialize["DriveSlots"] = o.DriveSlots
	}
	if !IsNil(o.DriveSlotsList) {
...
func (o *StorageR0Drive) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageR0DriveWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageR0Drive)
	if err == nil {
