...
// StorageHitachiPoolListAllOf struct for StorageHitachiPoolListAllOf
type StorageHitachiPoolListAllOf struct {
...
type _StorageHitachiPoolListAllOf StorageHitachiPoolListAllOf
...
func NewStorageHitachiPoolListAllOf() *StorageHitachiPoolListAllOf {
	this := StorageHitachiPoolListAllOf{}
	return &this
}
...
func (o StorageHitachiPoolListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageHitachiPoolListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageHitachiPoolListAllOf := _StorageHitachiPoolListAllOf{}

	if err = json.Unmarshal(bytes, &varStorageHitachiPoolListAllOf); err == nil {
		*o = StorageHitachiPoolListAllOf(varStorageHitachiPoolListAllOf)
	}
...
type NullableStorageHitachiPoolListAllOf struct {
	value *StorageHitachiPoolListAllOf
	isSet bool
}

func (v NullableStorageHitachiPoolListAllOf) Get() *StorageHitachiPoolListAllOf {
	return v.value
}

func (v *NullableStorageHitachiPoolListAllOf) Set(val *StorageHitachiPoolListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageHitachiPoolListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageHitachiPoolListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageHitachiPoolListAllOf(val *StorageHitachiPoolListAllOf) *NullableStorageHitachiPoolListAllOf {
	return &NullableStorageHitachiPoolListAllOf{value: val, isSet: true}
}

func (v NullableStorageHitachiPoolListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageHitachiPoolListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
