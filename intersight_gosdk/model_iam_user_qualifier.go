...
// IamUserQualifier UserQualifier specifies explicit guest user lists for a guest-type UserGroup and supports notification flows. #### Purpose It streamlines management of guest access by enumerating allowed users and automating communication to them. #### Key Concepts - **Explicit Inclusion:** Lists guest users for controlled access. - **Notification Control:** Supports emailing access details to users. - **Guest Lifecycle:** Aligns with group activation and expiry. - **Group-bound:** Functions in the context of a guest user group.
