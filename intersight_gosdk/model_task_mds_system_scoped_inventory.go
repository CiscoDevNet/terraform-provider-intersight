...
// checks if the TaskMdsSystemScopedInventory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskMdsSystemScopedInventory{}
...
// GetDefaultClassId returns the default value "task.MdsSystemScopedInventory" of the ClassId field.
func (o *TaskMdsSystemScopedInventory) GetDefaultClassId() interface{} {
	return "task.MdsSystemScopedInventory"
}
...
// GetDefaultObjectType returns the default value "task.MdsSystemScopedInventory" of the ObjectType field.
func (o *TaskMdsSystemScopedInventory) GetDefaultObjectType() interface{} {
	return "task.MdsSystemScopedInventory"
}
...
func (o *TaskMdsSystemScopedInventory) SetRegisteredDeviceNil() {
...
func (o TaskMdsSystemScopedInventory) ToMap() (map[string]interface{}, error) {
...
func (o *TaskMdsSystemScopedInventory) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTaskMdsSystemScopedInventoryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTaskMdsSystemScopedInventory)
	if err == nil {
