...
// HyperflexServiceAuthTokenAllOf Definition of the list of properties defined in 'hyperflex.ServiceAuthToken', excluding properties defined in parent classes.
type HyperflexServiceAuthTokenAllOf struct {
...
type _HyperflexServiceAuthTokenAllOf HyperflexServiceAuthTokenAllOf
...
func NewHyperflexServiceAuthTokenAllOf(classId string, objectType string) *HyperflexServiceAuthTokenAllOf {
	this := HyperflexServiceAuthTokenAllOf{}
...
func (o HyperflexServiceAuthTokenAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexServiceAuthTokenAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexServiceAuthTokenAllOf := _HyperflexServiceAuthTokenAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexServiceAuthTokenAllOf); err == nil {
		*o = HyperflexServiceAuthTokenAllOf(varHyperflexServiceAuthTokenAllOf)
	}
...
type NullableHyperflexServiceAuthTokenAllOf struct {
	value *HyperflexServiceAuthTokenAllOf
	isSet bool
}

func (v NullableHyperflexServiceAuthTokenAllOf) Get() *HyperflexServiceAuthTokenAllOf {
	return v.value
}

func (v *NullableHyperflexServiceAuthTokenAllOf) Set(val *HyperflexServiceAuthTokenAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexServiceAuthTokenAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexServiceAuthTokenAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexServiceAuthTokenAllOf(val *HyperflexServiceAuthTokenAllOf) *NullableHyperflexServiceAuthTokenAllOf {
	return &NullableHyperflexServiceAuthTokenAllOf{value: val, isSet: true}
}

func (v NullableHyperflexServiceAuthTokenAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexServiceAuthTokenAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
