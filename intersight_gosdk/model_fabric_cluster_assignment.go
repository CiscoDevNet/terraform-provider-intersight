...
func (o *FabricClusterAssignment) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFabricClusterAssignmentWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFabricClusterAssignment)
	if err == nil {
