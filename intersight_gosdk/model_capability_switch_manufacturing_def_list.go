...
// checks if the CapabilitySwitchManufacturingDefList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilitySwitchManufacturingDefList{}
...
func NewCapabilitySwitchManufacturingDefList(objectType string) *CapabilitySwitchManufacturingDefList {
...
func (o CapabilitySwitchManufacturingDefList) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilitySwitchManufacturingDefList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilitySwitchManufacturingDefListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilitySwitchManufacturingDefList)
	if err == nil {
