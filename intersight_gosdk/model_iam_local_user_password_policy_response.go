...
func IamLocalUserPasswordPolicyListAsIamLocalUserPasswordPolicyResponse(v *IamLocalUserPasswordPolicyList) IamLocalUserPasswordPolicyResponse {
	return IamLocalUserPasswordPolicyResponse{
		IamLocalUserPasswordPolicyList: v,
	}
}
...
func (dst *IamLocalUserPasswordPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "iam.LocalUserPasswordPolicy.List" {
		// try to unmarshal JSON data into IamLocalUserPasswordPolicyList
		err = json.Unmarshal(data, &dst.IamLocalUserPasswordPolicyList)
		if err == nil {
			return nil // data stored in dst.IamLocalUserPasswordPolicyList, return on the first match
		} else {
			dst.IamLocalUserPasswordPolicyList = nil
			return fmt.Errorf("failed to unmarshal IamLocalUserPasswordPolicyResponse as IamLocalUserPasswordPolicyList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal IamLocalUserPasswordPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal IamLocalUserPasswordPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal IamLocalUserPasswordPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src IamLocalUserPasswordPolicyResponse) MarshalJSON() ([]byte, error) {
	if src.IamLocalUserPasswordPolicyList != nil {
		return json.Marshal(&src.IamLocalUserPasswordPolicyList)
	}
...
type NullableIamLocalUserPasswordPolicyResponse struct {
	value *IamLocalUserPasswordPolicyResponse
	isSet bool
}

func (v NullableIamLocalUserPasswordPolicyResponse) Get() *IamLocalUserPasswordPolicyResponse {
	return v.value
}

func (v *NullableIamLocalUserPasswordPolicyResponse) Set(val *IamLocalUserPasswordPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIamLocalUserPasswordPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIamLocalUserPasswordPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamLocalUserPasswordPolicyResponse(val *IamLocalUserPasswordPolicyResponse) *NullableIamLocalUserPasswordPolicyResponse {
	return &NullableIamLocalUserPasswordPolicyResponse{value: val, isSet: true}
}

func (v NullableIamLocalUserPasswordPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamLocalUserPasswordPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
