...
// FabricVsanListAllOf struct for FabricVsanListAllOf
type FabricVsanListAllOf struct {
...
type _FabricVsanListAllOf FabricVsanListAllOf
...
func (o FabricVsanListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricVsanListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricVsanListAllOf := _FabricVsanListAllOf{}

	if err = json.Unmarshal(bytes, &varFabricVsanListAllOf); err == nil {
		*o = FabricVsanListAllOf(varFabricVsanListAllOf)
	}
...
type NullableFabricVsanListAllOf struct {
	value *FabricVsanListAllOf
	isSet bool
}

func (v NullableFabricVsanListAllOf) Get() *FabricVsanListAllOf {
	return v.value
}

func (v *NullableFabricVsanListAllOf) Set(val *FabricVsanListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricVsanListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricVsanListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricVsanListAllOf(val *FabricVsanListAllOf) *NullableFabricVsanListAllOf {
	return &NullableFabricVsanListAllOf{value: val, isSet: true}
}

func (v NullableFabricVsanListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricVsanListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
