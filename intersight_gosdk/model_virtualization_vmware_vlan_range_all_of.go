...
// VirtualizationVmwareVlanRangeAllOf Definition of the list of properties defined in 'virtualization.VmwareVlanRange', excluding properties defined in parent classes.
type VirtualizationVmwareVlanRangeAllOf struct {
...
type _VirtualizationVmwareVlanRangeAllOf VirtualizationVmwareVlanRangeAllOf
...
func NewVirtualizationVmwareVlanRangeAllOf(classId string, objectType string) *VirtualizationVmwareVlanRangeAllOf {
	this := VirtualizationVmwareVlanRangeAllOf{}
...
func (o VirtualizationVmwareVlanRangeAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationVmwareVlanRangeAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationVmwareVlanRangeAllOf := _VirtualizationVmwareVlanRangeAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationVmwareVlanRangeAllOf); err == nil {
		*o = VirtualizationVmwareVlanRangeAllOf(varVirtualizationVmwareVlanRangeAllOf)
	}
...
type NullableVirtualizationVmwareVlanRangeAllOf struct {
	value *VirtualizationVmwareVlanRangeAllOf
	isSet bool
}

func (v NullableVirtualizationVmwareVlanRangeAllOf) Get() *VirtualizationVmwareVlanRangeAllOf {
	return v.value
}

func (v *NullableVirtualizationVmwareVlanRangeAllOf) Set(val *VirtualizationVmwareVlanRangeAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmwareVlanRangeAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmwareVlanRangeAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmwareVlanRangeAllOf(val *VirtualizationVmwareVlanRangeAllOf) *NullableVirtualizationVmwareVlanRangeAllOf {
	return &NullableVirtualizationVmwareVlanRangeAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmwareVlanRangeAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmwareVlanRangeAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
