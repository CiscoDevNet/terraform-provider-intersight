...
// VirtualizationIweHostInterfaceAllOf Definition of the list of properties defined in 'virtualization.IweHostInterface', excluding properties defined in parent classes.
type VirtualizationIweHostInterfaceAllOf struct {
...
type _VirtualizationIweHostInterfaceAllOf VirtualizationIweHostInterfaceAllOf
...
func NewVirtualizationIweHostInterfaceAllOf(classId string, objectType string) *VirtualizationIweHostInterfaceAllOf {
	this := VirtualizationIweHostInterfaceAllOf{}
...
func (o *VirtualizationIweHostInterfaceAllOf) SetBondStateNil() {
	o.BondState.Set(nil)
}
...
func (o VirtualizationIweHostInterfaceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationIweHostInterfaceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationIweHostInterfaceAllOf := _VirtualizationIweHostInterfaceAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationIweHostInterfaceAllOf); err == nil {
		*o = VirtualizationIweHostInterfaceAllOf(varVirtualizationIweHostInterfaceAllOf)
	}
...
type NullableVirtualizationIweHostInterfaceAllOf struct {
	value *VirtualizationIweHostInterfaceAllOf
	isSet bool
}

func (v NullableVirtualizationIweHostInterfaceAllOf) Get() *VirtualizationIweHostInterfaceAllOf {
	return v.value
}

func (v *NullableVirtualizationIweHostInterfaceAllOf) Set(val *VirtualizationIweHostInterfaceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationIweHostInterfaceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationIweHostInterfaceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationIweHostInterfaceAllOf(val *VirtualizationIweHostInterfaceAllOf) *NullableVirtualizationIweHostInterfaceAllOf {
	return &NullableVirtualizationIweHostInterfaceAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationIweHostInterfaceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationIweHostInterfaceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
