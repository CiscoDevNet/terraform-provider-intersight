...
func (o *ConvergedinfraPodList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varConvergedinfraPodListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varConvergedinfraPodList)
	if err == nil {
