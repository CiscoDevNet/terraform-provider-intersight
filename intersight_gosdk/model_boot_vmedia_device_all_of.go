...
// BootVmediaDeviceAllOf Definition of the list of properties defined in 'boot.VmediaDevice', excluding properties defined in parent classes.
type BootVmediaDeviceAllOf struct {
...
type _BootVmediaDeviceAllOf BootVmediaDeviceAllOf
...
func (o BootVmediaDeviceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BootVmediaDeviceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBootVmediaDeviceAllOf := _BootVmediaDeviceAllOf{}

	if err = json.Unmarshal(bytes, &varBootVmediaDeviceAllOf); err == nil {
		*o = BootVmediaDeviceAllOf(varBootVmediaDeviceAllOf)
	}
...
type NullableBootVmediaDeviceAllOf struct {
	value *BootVmediaDeviceAllOf
	isSet bool
}

func (v NullableBootVmediaDeviceAllOf) Get() *BootVmediaDeviceAllOf {
	return v.value
}

func (v *NullableBootVmediaDeviceAllOf) Set(val *BootVmediaDeviceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBootVmediaDeviceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBootVmediaDeviceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootVmediaDeviceAllOf(val *BootVmediaDeviceAllOf) *NullableBootVmediaDeviceAllOf {
	return &NullableBootVmediaDeviceAllOf{value: val, isSet: true}
}

func (v NullableBootVmediaDeviceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootVmediaDeviceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
