...
type _FirmwareChassisUpgradeImpactAllOf FirmwareChassisUpgradeImpactAllOf
...
func (o *FirmwareChassisUpgradeImpactAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFirmwareChassisUpgradeImpactAllOf := _FirmwareChassisUpgradeImpactAllOf{}

	if err = json.Unmarshal(bytes, &varFirmwareChassisUpgradeImpactAllOf); err == nil {
		*o = FirmwareChassisUpgradeImpactAllOf(varFirmwareChassisUpgradeImpactAllOf)
	}
