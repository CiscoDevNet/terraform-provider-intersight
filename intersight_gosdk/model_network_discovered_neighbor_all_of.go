...
// NetworkDiscoveredNeighborAllOf Definition of the list of properties defined in 'network.DiscoveredNeighbor', excluding properties defined in parent classes.
type NetworkDiscoveredNeighborAllOf struct {
...
type _NetworkDiscoveredNeighborAllOf NetworkDiscoveredNeighborAllOf
...
func NewNetworkDiscoveredNeighborAllOf(classId string, objectType string) *NetworkDiscoveredNeighborAllOf {
	this := NetworkDiscoveredNeighborAllOf{}
...
func (o NetworkDiscoveredNeighborAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NetworkDiscoveredNeighborAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNetworkDiscoveredNeighborAllOf := _NetworkDiscoveredNeighborAllOf{}

	if err = json.Unmarshal(bytes, &varNetworkDiscoveredNeighborAllOf); err == nil {
		*o = NetworkDiscoveredNeighborAllOf(varNetworkDiscoveredNeighborAllOf)
	}
...
type NullableNetworkDiscoveredNeighborAllOf struct {
	value *NetworkDiscoveredNeighborAllOf
	isSet bool
}

func (v NullableNetworkDiscoveredNeighborAllOf) Get() *NetworkDiscoveredNeighborAllOf {
	return v.value
}

func (v *NullableNetworkDiscoveredNeighborAllOf) Set(val *NetworkDiscoveredNeighborAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDiscoveredNeighborAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDiscoveredNeighborAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDiscoveredNeighborAllOf(val *NetworkDiscoveredNeighborAllOf) *NullableNetworkDiscoveredNeighborAllOf {
	return &NullableNetworkDiscoveredNeighborAllOf{value: val, isSet: true}
}

func (v NullableNetworkDiscoveredNeighborAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDiscoveredNeighborAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
