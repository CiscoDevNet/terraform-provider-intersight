...
// checks if the HyperflexReplicationPlatDatastore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexReplicationPlatDatastore{}
...
// GetDefaultClassId returns the default value "hyperflex.ReplicationPlatDatastore" of the ClassId field.
func (o *HyperflexReplicationPlatDatastore) GetDefaultClassId() interface{} {
	return "hyperflex.ReplicationPlatDatastore"
}
...
// GetDefaultObjectType returns the default value "hyperflex.ReplicationPlatDatastore" of the ObjectType field.
func (o *HyperflexReplicationPlatDatastore) GetDefaultObjectType() interface{} {
	return "hyperflex.ReplicationPlatDatastore"
}
...
func (o *HyperflexReplicationPlatDatastore) GetClusterEr() HyperflexEntityReference {
	if o == nil || IsNil(o.ClusterEr.Get()) {
...
func (o *HyperflexReplicationPlatDatastore) GetDatastoreEr() HyperflexEntityReference {
	if o == nil || IsNil(o.DatastoreEr.Get()) {
		var ret HyperflexEntityReference
		return ret
	}
...
func (o HyperflexReplicationPlatDatastore) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexReplicationPlatDatastore) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexReplicationPlatDatastoreWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexReplicationPlatDatastore)
	if err == nil {
