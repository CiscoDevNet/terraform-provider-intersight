...
// FirmwareNxosDescriptorListAllOf struct for FirmwareNxosDescriptorListAllOf
type FirmwareNxosDescriptorListAllOf struct {
...
type _FirmwareNxosDescriptorListAllOf FirmwareNxosDescriptorListAllOf
...
func NewFirmwareNxosDescriptorListAllOf() *FirmwareNxosDescriptorListAllOf {
	this := FirmwareNxosDescriptorListAllOf{}
	return &this
}
...
func (o FirmwareNxosDescriptorListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FirmwareNxosDescriptorListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFirmwareNxosDescriptorListAllOf := _FirmwareNxosDescriptorListAllOf{}

	if err = json.Unmarshal(bytes, &varFirmwareNxosDescriptorListAllOf); err == nil {
		*o = FirmwareNxosDescriptorListAllOf(varFirmwareNxosDescriptorListAllOf)
	}
...
type NullableFirmwareNxosDescriptorListAllOf struct {
	value *FirmwareNxosDescriptorListAllOf
	isSet bool
}

func (v NullableFirmwareNxosDescriptorListAllOf) Get() *FirmwareNxosDescriptorListAllOf {
	return v.value
}

func (v *NullableFirmwareNxosDescriptorListAllOf) Set(val *FirmwareNxosDescriptorListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFirmwareNxosDescriptorListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFirmwareNxosDescriptorListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirmwareNxosDescriptorListAllOf(val *FirmwareNxosDescriptorListAllOf) *NullableFirmwareNxosDescriptorListAllOf {
	return &NullableFirmwareNxosDescriptorListAllOf{value: val, isSet: true}
}

func (v NullableFirmwareNxosDescriptorListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirmwareNxosDescriptorListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
