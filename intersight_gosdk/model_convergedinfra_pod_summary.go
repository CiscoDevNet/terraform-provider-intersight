...
// checks if the ConvergedinfraPodSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvergedinfraPodSummary{}
...
func (o *ConvergedinfraPodSummary) GetDefaultClassId() interface{} {
...
func (o *ConvergedinfraPodSummary) GetDefaultObjectType() interface{} {
	return "convergedinfra.PodSummary"
}
...
func (o ConvergedinfraPodSummary) ToMap() (map[string]interface{}, error) {
	...
	if errConvergedinfraBasePodSummary != nil {
		return map[string]interface{}{}, errConvergedinfraBasePodSummary
	}
...
func (o *ConvergedinfraPodSummary) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConvergedinfraPodSummaryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varConvergedinfraPodSummary)
	if err == nil {
