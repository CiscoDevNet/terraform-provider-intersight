...
// checks if the BootNvmeDeviceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootNvmeDeviceList{}
...
func (o BootNvmeDeviceList) ToMap() (map[string]interface{}, error) {
...
func (o *BootNvmeDeviceList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBootNvmeDeviceListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBootNvmeDeviceList)
	if err == nil {
