...
// checks if the PartnerintegrationInventoryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerintegrationInventoryList{}
...
func (o PartnerintegrationInventoryList) ToMap() (map[string]interface{}, error) {
...
func (o *PartnerintegrationInventoryList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPartnerintegrationInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varPartnerintegrationInventoryList)
	if err == nil {
