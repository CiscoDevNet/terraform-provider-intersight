...
// checks if the IqnpoolPoolMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IqnpoolPoolMember{}
...
type IqnpoolPoolMember struct {
	...
	BlockHead            NullableIqnpoolBlockRelationship       `json:"BlockHead,omitempty"`
	Peer                 NullableIqnpoolLeaseRelationship       `json:"Peer,omitempty"`
	Pool                 NullableIqnpoolPoolRelationship        `json:"Pool,omitempty"`
	Reservation          NullableIqnpoolReservationRelationship `json:"Reservation,omitempty"`
...
// GetDefaultClassId returns the default value "iqnpool.PoolMember" of the ClassId field.
func (o *IqnpoolPoolMember) GetDefaultClassId() interface{} {
	return "iqnpool.PoolMember"
}
...
// GetDefaultObjectType returns the default value "iqnpool.PoolMember" of the ObjectType field.
func (o *IqnpoolPoolMember) GetDefaultObjectType() interface{} {
	return "iqnpool.PoolMember"
}
...
func (o *IqnpoolPoolMember) SetAssignedToEntityNil() {
...
// SetBlockHead gets a reference to the given NullableIqnpoolBlockRelationship and assigns it to the BlockHead field.
...
func (o *IqnpoolPoolMember) SetBlockHeadNil() {
	o.BlockHead.Set(nil)
}
...
// SetPeer gets a reference to the given NullableIqnpoolLeaseRelationship and assigns it to the Peer field.
func (o *IqnpoolPoolMember) SetPeer(v IqnpoolLeaseRelationship) {
	o.Peer.Set(&v)
}

// SetPeerNil sets the value for Peer to be an explicit nil
func (o *IqnpoolPoolMember) SetPeerNil() {
	o.Peer.Set(nil)
}
...
func (o *IqnpoolPoolMember) SetPoolNil() {
	o.Pool.Set(nil)
}
...
// SetReservation gets a reference to the given NullableIqnpoolReservationRelationship and assigns it to the Reservation field.
...
func (o *IqnpoolPoolMember) SetReservationNil() {
...
func (o IqnpoolPoolMember) ToMap() (map[string]interface{}, error) {
...
func (o *IqnpoolPoolMember) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIqnpoolPoolMemberWithoutEmbeddedStruct)
	if err == nil {
		...
		varIqnpoolPoolMember.Reservation = varIqnpoolPoolMemberWithoutEmbeddedStruct.Reservation
	...
	err = json.Unmarshal(data, &varIqnpoolPoolMember)
	if err == nil {
