...
func (dst *NetworkconfigPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal NetworkconfigPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal NetworkconfigPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal NetworkconfigPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'networkconfig.Policy.List'
	if jsonDict["ObjectType"] == "networkconfig.Policy.List" {
		// try to unmarshal JSON data into NetworkconfigPolicyList
		err = json.Unmarshal(data, &dst.NetworkconfigPolicyList)
		if err == nil {
			return nil // data stored in dst.NetworkconfigPolicyList, return on the first match
		} else {
			dst.NetworkconfigPolicyList = nil
			return fmt.Errorf("failed to unmarshal NetworkconfigPolicyResponse as NetworkconfigPolicyList: %s", err.Error())
		}
	}
...
type NullableNetworkconfigPolicyResponse struct {
	value *NetworkconfigPolicyResponse
	isSet bool
}

func (v NullableNetworkconfigPolicyResponse) Get() *NetworkconfigPolicyResponse {
	return v.value
}

func (v *NullableNetworkconfigPolicyResponse) Set(val *NetworkconfigPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkconfigPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkconfigPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkconfigPolicyResponse(val *NetworkconfigPolicyResponse) *NullableNetworkconfigPolicyResponse {
	return &NullableNetworkconfigPolicyResponse{value: val, isSet: true}
}

func (v NullableNetworkconfigPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkconfigPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
