...
// KubernetesNvidiaGpuProductAllOf Definition of the list of properties defined in 'kubernetes.NvidiaGpuProduct', excluding properties defined in parent classes.
type KubernetesNvidiaGpuProductAllOf struct {
...
type _KubernetesNvidiaGpuProductAllOf KubernetesNvidiaGpuProductAllOf
...
func NewKubernetesNvidiaGpuProductAllOf(classId string, objectType string) *KubernetesNvidiaGpuProductAllOf {
	this := KubernetesNvidiaGpuProductAllOf{}
...
func (o KubernetesNvidiaGpuProductAllOf) MarshalJSON() ([]byte, error) {
...
func (o *KubernetesNvidiaGpuProductAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varKubernetesNvidiaGpuProductAllOf := _KubernetesNvidiaGpuProductAllOf{}

	if err = json.Unmarshal(bytes, &varKubernetesNvidiaGpuProductAllOf); err == nil {
		*o = KubernetesNvidiaGpuProductAllOf(varKubernetesNvidiaGpuProductAllOf)
	}
...
type NullableKubernetesNvidiaGpuProductAllOf struct {
	value *KubernetesNvidiaGpuProductAllOf
	isSet bool
}

func (v NullableKubernetesNvidiaGpuProductAllOf) Get() *KubernetesNvidiaGpuProductAllOf {
	return v.value
}

func (v *NullableKubernetesNvidiaGpuProductAllOf) Set(val *KubernetesNvidiaGpuProductAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesNvidiaGpuProductAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesNvidiaGpuProductAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesNvidiaGpuProductAllOf(val *KubernetesNvidiaGpuProductAllOf) *NullableKubernetesNvidiaGpuProductAllOf {
	return &NullableKubernetesNvidiaGpuProductAllOf{value: val, isSet: true}
}

func (v NullableKubernetesNvidiaGpuProductAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesNvidiaGpuProductAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
