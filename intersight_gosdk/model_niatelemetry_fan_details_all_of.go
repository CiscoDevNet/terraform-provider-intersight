...
// NiatelemetryFanDetailsAllOf Definition of the list of properties defined in 'niatelemetry.FanDetails', excluding properties defined in parent classes.
type NiatelemetryFanDetailsAllOf struct {
...
type _NiatelemetryFanDetailsAllOf NiatelemetryFanDetailsAllOf
...
func NewNiatelemetryFanDetailsAllOf(classId string, objectType string) *NiatelemetryFanDetailsAllOf {
	this := NiatelemetryFanDetailsAllOf{}
...
func NewNiatelemetryFanDetailsAllOfWithDefaults() *NiatelemetryFanDetailsAllOf {
	this := NiatelemetryFanDetailsAllOf{}
	var classId string = "niatelemetry.FanDetails"
	this.ClassId = classId
	var objectType string = "niatelemetry.FanDetails"
	this.ObjectType = objectType
	return &this
}
...
func (o NiatelemetryFanDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryFanDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryFanDetailsAllOf := _NiatelemetryFanDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryFanDetailsAllOf); err == nil {
		*o = NiatelemetryFanDetailsAllOf(varNiatelemetryFanDetailsAllOf)
	}
...
type NullableNiatelemetryFanDetailsAllOf struct {
	value *NiatelemetryFanDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetryFanDetailsAllOf) Get() *NiatelemetryFanDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetryFanDetailsAllOf) Set(val *NiatelemetryFanDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryFanDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryFanDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryFanDetailsAllOf(val *NiatelemetryFanDetailsAllOf) *NullableNiatelemetryFanDetailsAllOf {
	return &NullableNiatelemetryFanDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryFanDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryFanDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
