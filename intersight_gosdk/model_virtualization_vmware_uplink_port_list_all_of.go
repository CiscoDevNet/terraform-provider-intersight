...
// VirtualizationVmwareUplinkPortListAllOf struct for VirtualizationVmwareUplinkPortListAllOf
type VirtualizationVmwareUplinkPortListAllOf struct {
...
type _VirtualizationVmwareUplinkPortListAllOf VirtualizationVmwareUplinkPortListAllOf
...
func NewVirtualizationVmwareUplinkPortListAllOf() *VirtualizationVmwareUplinkPortListAllOf {
	this := VirtualizationVmwareUplinkPortListAllOf{}
	return &this
}
...
func (o VirtualizationVmwareUplinkPortListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationVmwareUplinkPortListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationVmwareUplinkPortListAllOf := _VirtualizationVmwareUplinkPortListAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationVmwareUplinkPortListAllOf); err == nil {
		*o = VirtualizationVmwareUplinkPortListAllOf(varVirtualizationVmwareUplinkPortListAllOf)
	}
...
type NullableVirtualizationVmwareUplinkPortListAllOf struct {
	value *VirtualizationVmwareUplinkPortListAllOf
	isSet bool
}

func (v NullableVirtualizationVmwareUplinkPortListAllOf) Get() *VirtualizationVmwareUplinkPortListAllOf {
	return v.value
}

func (v *NullableVirtualizationVmwareUplinkPortListAllOf) Set(val *VirtualizationVmwareUplinkPortListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmwareUplinkPortListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmwareUplinkPortListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmwareUplinkPortListAllOf(val *VirtualizationVmwareUplinkPortListAllOf) *NullableVirtualizationVmwareUplinkPortListAllOf {
	return &NullableVirtualizationVmwareUplinkPortListAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVmwareUplinkPortListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmwareUplinkPortListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
