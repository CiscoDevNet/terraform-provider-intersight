...
func (dst *StorageNetAppSvmEventResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal StorageNetAppSvmEventResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal StorageNetAppSvmEventResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal StorageNetAppSvmEventResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'storage.NetAppSvmEvent.List'
	if jsonDict["ObjectType"] == "storage.NetAppSvmEvent.List" {
		// try to unmarshal JSON data into StorageNetAppSvmEventList
		err = json.Unmarshal(data, &dst.StorageNetAppSvmEventList)
		if err == nil {
			return nil // data stored in dst.StorageNetAppSvmEventList, return on the first match
		} else {
			dst.StorageNetAppSvmEventList = nil
			return fmt.Errorf("failed to unmarshal StorageNetAppSvmEventResponse as StorageNetAppSvmEventList: %s", err.Error())
		}
	}
...
func (src StorageNetAppSvmEventResponse) MarshalJSON() ([]byte, error) {
	...
	if src.StorageNetAppSvmEventList != nil {
		return json.Marshal(&src.StorageNetAppSvmEventList)
	}
...
func (obj *StorageNetAppSvmEventResponse) GetActualInstance() interface{} {
	...
	if obj.StorageNetAppSvmEventList != nil {
		return obj.StorageNetAppSvmEventList
	}
...
type NullableStorageNetAppSvmEventResponse struct {
	value *StorageNetAppSvmEventResponse
	isSet bool
}

func (v NullableStorageNetAppSvmEventResponse) Get() *StorageNetAppSvmEventResponse {
	return v.value
}

func (v *NullableStorageNetAppSvmEventResponse) Set(val *StorageNetAppSvmEventResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppSvmEventResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppSvmEventResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppSvmEventResponse(val *StorageNetAppSvmEventResponse) *NullableStorageNetAppSvmEventResponse {
	return &NullableStorageNetAppSvmEventResponse{value: val, isSet: true}
}

func (v NullableStorageNetAppSvmEventResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppSvmEventResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
