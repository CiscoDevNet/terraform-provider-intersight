...
// checks if the TelemetryDruidInvertedTopNMetricSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidInvertedTopNMetricSpec{}
...
func (o TelemetryDruidInvertedTopNMetricSpec) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidInvertedTopNMetricSpec) UnmarshalJSON(data []byte) (err error) {
