...
// checks if the KubernetesNodeGroupTaint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesNodeGroupTaint{}
...
// GetDefaultClassId returns the default value "kubernetes.NodeGroupTaint" of the ClassId field.
func (o *KubernetesNodeGroupTaint) GetDefaultClassId() interface{} {
	return "kubernetes.NodeGroupTaint"
}
...
// GetDefaultObjectType returns the default value "kubernetes.NodeGroupTaint" of the ObjectType field.
func (o *KubernetesNodeGroupTaint) GetDefaultObjectType() interface{} {
	return "kubernetes.NodeGroupTaint"
}
...
func (o KubernetesNodeGroupTaint) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesNodeGroupTaint) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesNodeGroupTaintWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesNodeGroupTaint)
	if err == nil {
