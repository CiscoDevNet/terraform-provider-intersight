...
**PendingDiscovery** | Pointer to **string** | Value to indicate if discovery needs to be triggered after some event (ex. device connector reconnect). | [optional] [readonly] 
