...
func main() {
    feedbackFeedbackPost := *openapiclient.Newfeedback.FeedbackPost("ClassId_example", "ObjectType_example") // FeedbackFeedbackPost | The 'feedback.FeedbackPost' resource to create.
