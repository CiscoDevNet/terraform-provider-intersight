...
`func (o *IamIdpReferenceAllOf) GetUserSettings() []IamUserSettingRelationship`

GetUserSettings returns the UserSettings field if non-nil, zero value otherwise.

### GetUserSettingsOk

`func (o *IamIdpReferenceAllOf) GetUserSettingsOk() (*[]IamUserSettingRelationship, bool)`
...
`func (o *IamIdpReferenceAllOf) SetUserSettings(v []IamUserSettingRelationship)`

SetUserSettings sets UserSettings field to given value.

### HasUserSettings

`func (o *IamIdpReferenceAllOf) HasUserSettings() bool`

HasUserSettings returns a boolean if a field has been set.

### SetUserSettingsNil

`func (o *IamIdpReferenceAllOf) SetUserSettingsNil(b bool)`

 SetUserSettingsNil sets the value for UserSettings to be an explicit nil

### UnsetUserSettings
`func (o *IamIdpReferenceAllOf) UnsetUserSettings()`
