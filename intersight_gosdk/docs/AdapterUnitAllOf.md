...
`func (o *AdapterUnitAllOf) GetVicCommunicable() string`

GetVicCommunicable returns the VicCommunicable field if non-nil, zero value otherwise.

### GetVicCommunicableOk

`func (o *AdapterUnitAllOf) GetVicCommunicableOk() (*string, bool)`
...
`func (o *AdapterUnitAllOf) SetVicCommunicable(v string)`

SetVicCommunicable sets VicCommunicable field to given value.

### HasVicCommunicable

`func (o *AdapterUnitAllOf) HasVicCommunicable() bool`
