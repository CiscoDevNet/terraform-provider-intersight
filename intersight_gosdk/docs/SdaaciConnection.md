...
**AciL3Out** | Pointer to **string** | User input for ACI L3Out name. | [optional] 
**AciMatchRuleName** | Pointer to **string** | Match rule name in Cisco APIC. | [optional] 
**AciTenant** | Pointer to **string** | ACI tenant name for the selected APIC target. | [optional] 
**CampusFabricSite** | Pointer to **string** | Campus fabric site Id where the border node is configured. | [optional] 
**Epg** | Pointer to **string** | Application EPG name for this connection. | [optional] 
**EpgSubnet** | Pointer to **string** | EPG Subnet Ipv4Cidr configured on APIC. | [optional] 
**FirewallDevice** | Pointer to **string** | Device within the selected domain used for firewall configuration. | [optional] 
**FirewallDomain** | Pointer to **string** | Domain used for firewall configuration. | [optional] 
**NodeProfile** | Pointer to **string** | L3Out node profile in Cisco APIC. | [optional] 
**Status** | Pointer to **string** | Connection status between SDA and ACI. * &#x60;NotConnected&#x60; - Status of the connection:Not connected. * &#x60;Connected&#x60; - Status of the connection:Connected. | [optional] [default to "NotConnected"]
**Transit** | Pointer to **string** | Transit Id for the given border node. | [optional] 
**VirtualNetwork** | Pointer to **string** | Virtual Network for this connection. | [optional] 
**VnEpg** | Pointer to **string** | VN and EPG information for this connection. | [optional] 
**Vrf** | Pointer to **string** | Tenant VRF in Cisco APIC. | [optional] 
