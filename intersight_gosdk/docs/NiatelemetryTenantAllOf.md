...
`func (o *NiatelemetryTenantAllOf) GetTenantHealth() int64`

GetTenantHealth returns the TenantHealth field if non-nil, zero value otherwise.

### GetTenantHealthOk

`func (o *NiatelemetryTenantAllOf) GetTenantHealthOk() (*int64, bool)`
...
`func (o *NiatelemetryTenantAllOf) SetTenantHealth(v int64)`

SetTenantHealth sets TenantHealth field to given value.

### HasTenantHealth

`func (o *NiatelemetryTenantAllOf) HasTenantHealth() bool`
