...
**SelLogPath** | Pointer to **string** | Location of Sel log script. | [optional] [readonly] 
**SelScriptFilePath** | Pointer to **string** | Location of Sel file script. | [optional] [readonly] 
...
GetSelLogPath returns the SelLogPath field if non-nil, zero value otherwise.

### GetSelLogPathOk

`func (o *CapabilityActionsMetaData) GetSelLogPathOk() (*string, bool)`

GetSelLogPathOk returns a tuple with the SelLogPath field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetSelLogPath sets SelLogPath field to given value.
...
### GetSelScriptFilePath

`func (o *CapabilityActionsMetaData) GetSelScriptFilePath() string`

GetSelScriptFilePath returns the SelScriptFilePath field if non-nil, zero value otherwise.

### GetSelScriptFilePathOk

`func (o *CapabilityActionsMetaData) GetSelScriptFilePathOk() (*string, bool)`

GetSelScriptFilePathOk returns a tuple with the SelScriptFilePath field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSelScriptFilePath

`func (o *CapabilityActionsMetaData) SetSelScriptFilePath(v string)`

SetSelScriptFilePath sets SelScriptFilePath field to given value.

### HasSelScriptFilePath
