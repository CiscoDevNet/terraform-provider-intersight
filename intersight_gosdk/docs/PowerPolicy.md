...
**AllocatedBudget** | Pointer to **int64** | Sets the limit for the maximum input power consumption by the chassis (in Watts). Set to 0 for no limit. | [optional] [default to 0]
