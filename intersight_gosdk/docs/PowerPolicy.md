...
**AllocatedBudget** | Pointer to **int64** | Sets the Allocated Power Budget of the Chassis (in Watts). This field is only supported for Cisco UCS X series Chassis. | [optional] [default to 0]
