...
**DockerBridgeNetworkCidr** | Pointer to **string** | The CIDR for docker bridge network. This address space must not collide with other CIDRs on your networks, including the cluster&#39;s service CIDR, pod CIDR and IP Pools. | [optional] 
