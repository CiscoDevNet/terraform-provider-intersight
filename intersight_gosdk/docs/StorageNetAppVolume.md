...
**SnapshotPolicyName** | Pointer to **string** | Name of Snapshot Policy. | [optional] [readonly] 
**SnapshotPolicyUuid** | Pointer to **string** | Name of Snapshot Policy. | [optional] [readonly] 
