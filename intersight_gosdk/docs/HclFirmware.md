...
**DriverName** | Pointer to **string** | Protocol for which the driver is provided. E.g.  enic, fnic, lsi_mr3. | [optional] [readonly] 
**DriverVersion** | Pointer to **string** | Version of the Driver supported. | [optional] [readonly] 
...
**FirmwareVersion** | Pointer to **string** | Firmware version of the product/adapter supported. | [optional] [readonly] 
**Id** | Pointer to **string** | Identifier of the firmware. | [optional] [readonly] 
