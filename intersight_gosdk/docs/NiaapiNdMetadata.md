...
**MetadataSize** | Pointer to **int64** | Size of this Metadata package in bytes. | [optional] [readonly] 
...
`func (o *NiaapiNdMetadata) GetMetadataSize() int64`

GetMetadataSize returns the MetadataSize field if non-nil, zero value otherwise.

### GetMetadataSizeOk

`func (o *NiaapiNdMetadata) GetMetadataSizeOk() (*int64, bool)`
...
`func (o *NiaapiNdMetadata) SetMetadataSize(v int64)`

SetMetadataSize sets MetadataSize field to given value.

### HasMetadataSize

`func (o *NiaapiNdMetadata) HasMetadataSize() bool`
