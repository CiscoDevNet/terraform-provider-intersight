...
`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) GetSelector() string`

GetSelector returns the Selector field if non-nil, zero value otherwise.

### GetSelectorOk

`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) GetSelectorOk() (*string, bool)`
...
`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) SetSelector(v string)`

SetSelector sets Selector field to given value.

### HasSelector

`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) HasSelector() bool`

HasSelector returns a boolean if a field has been set.

### GetLink

`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) GetLink() string`

GetLink returns the Link field if non-nil, zero value otherwise.

### GetLinkOk

`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) GetLinkOk() (*string, bool)`
...
`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) SetLink(v string)`

SetLink sets Link field to given value.

### HasLink

`func (o *FirmwareServerConfigurationUtilityDistributableRelationship) HasLink() bool`
