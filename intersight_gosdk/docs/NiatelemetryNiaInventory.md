...
`func (o *NiatelemetryNiaInventory) SetDcnmFanDetailsNil(b bool)`

 SetDcnmFanDetailsNil sets the value for DcnmFanDetails to be an explicit nil

### UnsetDcnmFanDetails
`func (o *NiatelemetryNiaInventory) UnsetDcnmFanDetails()`
...
`func (o *NiatelemetryNiaInventory) SetVniStatusNil(b bool)`
