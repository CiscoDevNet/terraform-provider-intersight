...
[**CreateWorkloadClearWorkloadTag**](WorkloadApi.md#CreateWorkloadClearWorkloadTag) | **Post** /api/v1/workload/ClearWorkloadTags | Create a &#39;workload.ClearWorkloadTag&#39; resource.
...
[**DeleteWorkloadClearWorkloadTag**](WorkloadApi.md#DeleteWorkloadClearWorkloadTag) | **Delete** /api/v1/workload/ClearWorkloadTags/{Moid} | Delete a &#39;workload.ClearWorkloadTag&#39; resource.
...
[**GetWorkloadClearWorkloadTagByMoid**](WorkloadApi.md#GetWorkloadClearWorkloadTagByMoid) | **Get** /api/v1/workload/ClearWorkloadTags/{Moid} | Read a &#39;workload.ClearWorkloadTag&#39; resource.
[**GetWorkloadClearWorkloadTagList**](WorkloadApi.md#GetWorkloadClearWorkloadTagList) | **Get** /api/v1/workload/ClearWorkloadTags | Read a &#39;workload.ClearWorkloadTag&#39; resource.
...
[**GetWorkloadWorkloadMetadataByMoid**](WorkloadApi.md#GetWorkloadWorkloadMetadataByMoid) | **Get** /api/v1/workload/WorkloadMetadata/{Moid} | Read a &#39;workload.WorkloadMetadata&#39; resource.
[**GetWorkloadWorkloadMetadataList**](WorkloadApi.md#GetWorkloadWorkloadMetadataList) | **Get** /api/v1/workload/WorkloadMetadata | Read a &#39;workload.WorkloadMetadata&#39; resource.
...
## CreateWorkloadClearWorkloadTag

> WorkloadClearWorkloadTag CreateWorkloadClearWorkloadTag(ctx).WorkloadClearWorkloadTag(workloadClearWorkloadTag).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
	workloadClearWorkloadTag := *openapiclient.NewWorkloadClearWorkloadTag("ClassId_example", "ObjectType_example") // WorkloadClearWorkloadTag | The 'workload.ClearWorkloadTag' resource to create.
	ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)
	ifNoneMatch := "ifNoneMatch_example" // string | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn't happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource's ETag doesn't match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don't have to be identical byte for byte. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkloadApi.CreateWorkloadClearWorkloadTag(context.Background()).WorkloadClearWorkloadTag(workloadClearWorkloadTag).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkloadApi.CreateWorkloadClearWorkloadTag``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CreateWorkloadClearWorkloadTag`: WorkloadClearWorkloadTag
	fmt.Fprintf(os.Stdout, "Response from `WorkloadApi.CreateWorkloadClearWorkloadTag`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateWorkloadClearWorkloadTagRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **workloadClearWorkloadTag** | [**WorkloadClearWorkloadTag**](WorkloadClearWorkloadTag.md) | The &#39;workload.ClearWorkloadTag&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**WorkloadClearWorkloadTag**](WorkloadClearWorkloadTag.md)
...
## DeleteWorkloadClearWorkloadTag

> DeleteWorkloadClearWorkloadTag(ctx, moid).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.WorkloadApi.DeleteWorkloadClearWorkloadTag(context.Background(), moid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkloadApi.DeleteWorkloadClearWorkloadTag``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiDeleteWorkloadClearWorkloadTagRequest struct via the builder pattern
...
func main() {
	...
	// response from `GetWorkloadClearWorkloadTagByMoid`: WorkloadClearWorkloadTag
	fmt.Fprintf(os.Stdout, "Response from `WorkloadApi.GetWorkloadClearWorkloadTagByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetWorkloadClearWorkloadTagByMoidRequest struct via the builder pattern
...
## GetWorkloadClearWorkloadTagList

> WorkloadClearWorkloadTagResponse GetWorkloadClearWorkloadTagList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkloadApi.GetWorkloadClearWorkloadTagList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkloadApi.GetWorkloadClearWorkloadTagList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetWorkloadClearWorkloadTagList`: WorkloadClearWorkloadTagResponse
	fmt.Fprintf(os.Stdout, "Response from `WorkloadApi.GetWorkloadClearWorkloadTagList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetWorkloadClearWorkloadTagListRequest struct via the builder pattern
...
[**WorkloadClearWorkloadTagResponse**](WorkloadClearWorkloadTagResponse.md)
...
func main() {
	...
	// response from `GetWorkloadWorkloadMetadataByMoid`: WorkloadWorkloadMetadata
	fmt.Fprintf(os.Stdout, "Response from `WorkloadApi.GetWorkloadWorkloadMetadataByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetWorkloadWorkloadMetadataByMoidRequest struct via the builder pattern
...
## GetWorkloadWorkloadMetadataList

> WorkloadWorkloadMetadataResponse GetWorkloadWorkloadMetadataList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WorkloadApi.GetWorkloadWorkloadMetadataList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WorkloadApi.GetWorkloadWorkloadMetadataList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetWorkloadWorkloadMetadataList`: WorkloadWorkloadMetadataResponse
	fmt.Fprintf(os.Stdout, "Response from `WorkloadApi.GetWorkloadWorkloadMetadataList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetWorkloadWorkloadMetadataListRequest struct via the builder pattern
...
[**WorkloadWorkloadMetadataResponse**](WorkloadWorkloadMetadataResponse.md)
