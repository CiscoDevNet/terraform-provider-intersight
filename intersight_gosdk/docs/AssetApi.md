...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.AssetApi.CreateAssetDeviceContractNotification(context.Background()).AssetDeviceContractNotification(assetDeviceContractNotification).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
