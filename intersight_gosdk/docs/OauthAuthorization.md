...
**ApiType** | Pointer to **string** | OAuth API type (e.g., Smart licensing API). * &#x60;Unknown&#x60; - Unknown serves as the default API type. * &#x60;SmartLicensing-API&#x60; - Smart licensing API type. * &#x60;CommerceEstimate-API&#x60; - Commerce Estimate API type. | [optional] [default to "Unknown"]
...
**Password** | Pointer to **string** | Password used by Intersight to create OAuth2 tokens for interacting with the external repository on behalf of the user account. | [optional] 
**UserId** | Pointer to **string** | Username used by Intersight to create OAuth2 tokens for interacting with the external repository on behalf of the user account. | [optional] 
