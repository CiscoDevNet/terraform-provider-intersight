...
[**GetHclHwCatalogInfoByMoid**](HclApi.md#GetHclHwCatalogInfoByMoid) | **Get** /api/v1/hcl/HwCatalogInfos/{Moid} | Read a &#39;hcl.HwCatalogInfo&#39; resource.
[**GetHclHwCatalogInfoList**](HclApi.md#GetHclHwCatalogInfoList) | **Get** /api/v1/hcl/HwCatalogInfos | Read a &#39;hcl.HwCatalogInfo&#39; resource.
...
[**GetHclServerCatalogByMoid**](HclApi.md#GetHclServerCatalogByMoid) | **Get** /api/v1/hcl/ServerCatalogs/{Moid} | Read a &#39;hcl.ServerCatalog&#39; resource.
[**GetHclServerCatalogList**](HclApi.md#GetHclServerCatalogList) | **Get** /api/v1/hcl/ServerCatalogs | Read a &#39;hcl.ServerCatalog&#39; resource.
[**GetHclServerHwCatalogInfoByMoid**](HclApi.md#GetHclServerHwCatalogInfoByMoid) | **Get** /api/v1/hcl/ServerHwCatalogInfos/{Moid} | Read a &#39;hcl.ServerHwCatalogInfo&#39; resource.
[**GetHclServerHwCatalogInfoList**](HclApi.md#GetHclServerHwCatalogInfoList) | **Get** /api/v1/hcl/ServerHwCatalogInfos | Read a &#39;hcl.ServerHwCatalogInfo&#39; resource.
...
[**HclHwCatalogInfo**](HclHwCatalogInfo.md)
...
[**HclHwCatalogInfoResponse**](HclHwCatalogInfoResponse.md)
...
## GetHclServerCatalogByMoid

> HclServerCatalog GetHclServerCatalogByMoid(ctx, moid).Execute()

Read a 'hcl.ServerCatalog' resource.
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.HclApi.GetHclServerCatalogByMoid(context.Background(), moid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `HclApi.GetHclServerCatalogByMoid``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetHclServerCatalogByMoid`: HclServerCatalog
	fmt.Fprintf(os.Stdout, "Response from `HclApi.GetHclServerCatalogByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetHclServerCatalogByMoidRequest struct via the builder pattern
...
[**HclServerCatalog**](HclServerCatalog.md)
...
## GetHclServerCatalogList

> HclServerCatalogResponse GetHclServerCatalogList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.HclApi.GetHclServerCatalogList(context.Background()).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `HclApi.GetHclServerCatalogList``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetHclServerCatalogList`: HclServerCatalogResponse
	fmt.Fprintf(os.Stdout, "Response from `HclApi.GetHclServerCatalogList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetHclServerCatalogListRequest struct via the builder pattern
...
[**HclServerCatalogResponse**](HclServerCatalogResponse.md)
...
## GetHclServerHwCatalogInfoByMoid
...
[**HclServerHwCatalogInfo**](HclServerHwCatalogInfo.md)
...
[**HclServerHwCatalogInfoResponse**](HclServerHwCatalogInfoResponse.md)
