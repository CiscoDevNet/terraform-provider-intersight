...
**PlatformParam** | Pointer to [**NullableMoBaseComplexType**](MoBaseComplexType.md) | Parameter object for Tech Support requests. PlatformParamBase is the base class for the platform-specific parameter types. | [optional] 
...
`func (o *TechsupportmanagementTechSupportBundle) GetPlatformParam() MoBaseComplexType`

GetPlatformParam returns the PlatformParam field if non-nil, zero value otherwise.

### GetPlatformParamOk

`func (o *TechsupportmanagementTechSupportBundle) GetPlatformParamOk() (*MoBaseComplexType, bool)`
...
`func (o *TechsupportmanagementTechSupportBundle) SetPlatformParam(v MoBaseComplexType)`
