...
------------- | ------------- | -------------
[**CreateResourcepoolLease**](ResourcepoolApi.md#CreateResourcepoolLease) | **Post** /api/v1/resourcepool/Leases | Create a &#39;resourcepool.Lease&#39; resource.
...
[**PatchResourcepoolLease**](ResourcepoolApi.md#PatchResourcepoolLease) | **Patch** /api/v1/resourcepool/Leases/{Moid} | Update a &#39;resourcepool.Lease&#39; resource.
...
[**UpdateResourcepoolLease**](ResourcepoolApi.md#UpdateResourcepoolLease) | **Post** /api/v1/resourcepool/Leases/{Moid} | Update a &#39;resourcepool.Lease&#39; resource.
...
## CreateResourcepoolLease

> ResourcepoolLease CreateResourcepoolLease(ctx).ResourcepoolLease(resourcepoolLease).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()

Create a 'resourcepool.Lease' resource.
...
func main() {
    resourcepoolLease := *openapiclient.NewResourcepoolLease("ClassId_example", "ObjectType_example") // ResourcepoolLease | The 'resourcepool.Lease' resource to create.
    ...
    resp, r, err := api_client.ResourcepoolApi.CreateResourcepoolLease(context.Background()).ResourcepoolLease(resourcepoolLease).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ResourcepoolApi.CreateResourcepoolLease``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateResourcepoolLease`: ResourcepoolLease
    fmt.Fprintf(os.Stdout, "Response from `ResourcepoolApi.CreateResourcepoolLease`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateResourcepoolLeaseRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **resourcepoolLease** | [**ResourcepoolLease**](ResourcepoolLease.md) | The &#39;resourcepool.Lease&#39; resource to create. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
 **ifNoneMatch** | **string** | For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte. | 

### Return type

[**ResourcepoolLease**](resourcepool.Lease.md)
...
[**ResourcepoolPool**](resourcepool.Pool.md)
...
[**ResourcepoolLeaseResponse**](resourcepool.Lease.Response.md)
...
[**ResourcepoolLeaseResource**](resourcepool.LeaseResource.md)
...
[**ResourcepoolLeaseResourceResponse**](resourcepool.LeaseResource.Response.md)
...
[**ResourcepoolPoolResponse**](resourcepool.Pool.Response.md)
...
[**ResourcepoolPoolMember**](resourcepool.PoolMember.md)
...
[**ResourcepoolPoolMemberResponse**](resourcepool.PoolMember.Response.md)
...
[**ResourcepoolUniverse**](resourcepool.Universe.md)
...
[**ResourcepoolUniverseResponse**](resourcepool.Universe.Response.md)
...
## PatchResourcepoolLease

> ResourcepoolLease PatchResourcepoolLease(ctx, moid).ResourcepoolLease(resourcepoolLease).IfMatch(ifMatch).Execute()

Update a 'resourcepool.Lease' resource.
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    resourcepoolLease := *openapiclient.NewResourcepoolLease("ClassId_example", "ObjectType_example") // ResourcepoolLease | The 'resourcepool.Lease' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.ResourcepoolApi.PatchResourcepoolLease(context.Background(), moid).ResourcepoolLease(resourcepoolLease).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ResourcepoolApi.PatchResourcepoolLease``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchResourcepoolLease`: ResourcepoolLease
    fmt.Fprintf(os.Stdout, "Response from `ResourcepoolApi.PatchResourcepoolLease`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchResourcepoolLeaseRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **resourcepoolLease** | [**ResourcepoolLease**](ResourcepoolLease.md) | The &#39;resourcepool.Lease&#39; resource to update. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
...
## UpdateResourcepoolLease

> ResourcepoolLease UpdateResourcepoolLease(ctx, moid).ResourcepoolLease(resourcepoolLease).IfMatch(ifMatch).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.ResourcepoolApi.UpdateResourcepoolLease(context.Background(), moid).ResourcepoolLease(resourcepoolLease).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ResourcepoolApi.UpdateResourcepoolLease``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateResourcepoolLease`: ResourcepoolLease
    fmt.Fprintf(os.Stdout, "Response from `ResourcepoolApi.UpdateResourcepoolLease`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateResourcepoolLeaseRequest struct via the builder pattern
