...
`func (o *TechsupportmanagementTechSupportStatusAllOf) GetTechsupportFiles() []TechsupportmanagementTechSupportFileInfo`

GetTechsupportFiles returns the TechsupportFiles field if non-nil, zero value otherwise.

### GetTechsupportFilesOk

`func (o *TechsupportmanagementTechSupportStatusAllOf) GetTechsupportFilesOk() (*[]TechsupportmanagementTechSupportFileInfo, bool)`
...
`func (o *TechsupportmanagementTechSupportStatusAllOf) SetTechsupportFiles(v []TechsupportmanagementTechSupportFileInfo)`

SetTechsupportFiles sets TechsupportFiles field to given value.

### HasTechsupportFiles

`func (o *TechsupportmanagementTechSupportStatusAllOf) HasTechsupportFiles() bool`

HasTechsupportFiles returns a boolean if a field has been set.

### SetTechsupportFilesNil

`func (o *TechsupportmanagementTechSupportStatusAllOf) SetTechsupportFilesNil(b bool)`

 SetTechsupportFilesNil sets the value for TechsupportFiles to be an explicit nil

### UnsetTechsupportFiles
`func (o *TechsupportmanagementTechSupportStatusAllOf) UnsetTechsupportFiles()`
