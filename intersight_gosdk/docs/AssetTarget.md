...
`func (o *AssetTarget) GetAssignedLocation() AssetGeoLocationRelationship`

GetAssignedLocation returns the AssignedLocation field if non-nil, zero value otherwise.

### GetAssignedLocationOk

`func (o *AssetTarget) GetAssignedLocationOk() (*AssetGeoLocationRelationship, bool)`
...
`func (o *AssetTarget) GetReservation() ResourceReservationRelationship`

GetReservation returns the Reservation field if non-nil, zero value otherwise.

### GetReservationOk

`func (o *AssetTarget) GetReservationOk() (*ResourceReservationRelationship, bool)`
...
`func (o *AssetTarget) SetReservation(v ResourceReservationRelationship)`

SetReservation sets Reservation field to given value.

### HasReservation

`func (o *AssetTarget) HasReservation() bool`

HasReservation returns a boolean if a field has been set.

### SetReservationNil

`func (o *AssetTarget) SetReservationNil(b bool)`

 SetReservationNil sets the value for Reservation to be an explicit nil

### UnsetReservation
`func (o *AssetTarget) UnsetReservation()`
