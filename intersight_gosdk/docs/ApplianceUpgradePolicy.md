...
**AutoUpgrade** | Pointer to **bool** | Updates are installed automatically 2 weeks after detection, or 4 weeks if an appliance reboot is required. | [optional] 
**BlackoutDatesEnabled** | Pointer to **bool** | Appliance will not be updated during the blocked dates. | [optional] 
...
**DisruptiveGracePeriodWeek** | Pointer to **int64** | Updates that require an appliance reboot start automatically after the grace period ends. | [optional] [default to 4]
...
**IsCustomGracePeriodEnabled** | Pointer to **bool** | Waiting period before major and patch updates are triggered automatically. | [optional] 
...
**NondisruptiveGracePeriodWeek** | Pointer to **int64** | Updates that do not require an appliance reboot start automatically after the grace period ends. | [optional] [default to 4]
