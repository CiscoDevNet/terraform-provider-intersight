...
**UfsDisableIo** | Pointer to **string** | BIOS Token for setting Uncore Frequency Scaling IO configuration. * &#x60;platform-default&#x60; - Default value used by the platform for the BIOS setting. * &#x60;Mode 0&#x60; - Value - Mode 0 for configuring UfsDisableIo token. * &#x60;Mode 1&#x60; - Value - Mode 1 for configuring UfsDisableIo token. | [optional] [default to "platform-default"]
...
GetUfsDisableIo returns the UfsDisableIo field if non-nil, zero value otherwise.

### GetUfsDisableIoOk

`func (o *BiosPolicy) GetUfsDisableIoOk() (*string, bool)`

GetUfsDisableIoOk returns a tuple with the UfsDisableIo field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetUfsDisableIo sets UfsDisableIo field to given value.
