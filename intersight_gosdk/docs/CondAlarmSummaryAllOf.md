...
`func (o *CondAlarmSummaryAllOf) GetSuppressedCritical() int64`

GetSuppressedCritical returns the SuppressedCritical field if non-nil, zero value otherwise.

### GetSuppressedCriticalOk

`func (o *CondAlarmSummaryAllOf) GetSuppressedCriticalOk() (*int64, bool)`
...
`func (o *CondAlarmSummaryAllOf) SetSuppressedWarning(v int64)`

SetSuppressedWarning sets SuppressedWarning field to given value.

### HasSuppressedWarning

`func (o *CondAlarmSummaryAllOf) HasSuppressedWarning() bool`
