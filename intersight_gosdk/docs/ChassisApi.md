...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.ChassisApi.DeleteChassisProfile(context.Background(), moid).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.ChassisApi.DeleteChassisProfileTemplate(context.Background(), moid).Execute()
	if err != nil {
