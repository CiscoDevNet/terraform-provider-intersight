...
`func (o *NiatelemetryNiaInventoryAllOf) GetControllerIpAddress() string`

GetControllerIpAddress returns the ControllerIpAddress field if non-nil, zero value otherwise.

### GetControllerIpAddressOk

`func (o *NiatelemetryNiaInventoryAllOf) GetControllerIpAddressOk() (*string, bool)`
...
`func (o *NiatelemetryNiaInventoryAllOf) SetControllerIpAddress(v string)`

SetControllerIpAddress sets ControllerIpAddress field to given value.

### HasControllerIpAddress

`func (o *NiatelemetryNiaInventoryAllOf) HasControllerIpAddress() bool`
...
`func (o *NiatelemetryNiaInventoryAllOf) GetNexusCloudMembershipStatus() bool`
...
`func (o *NiatelemetryNiaInventoryAllOf) GetNexusCloudMembershipStatusOk() (*bool, bool)`
...
`func (o *NiatelemetryNiaInventoryAllOf) SetNexusCloudMembershipStatus(v bool)`

SetNexusCloudMembershipStatus sets NexusCloudMembershipStatus field to given value.

### HasNexusCloudMembershipStatus

`func (o *NiatelemetryNiaInventoryAllOf) HasNexusCloudMembershipStatus() bool`
...
`func (o *NiatelemetryNiaInventoryAllOf) GetSiteuuid() string`

GetSiteuuid returns the Siteuuid field if non-nil, zero value otherwise.

### GetSiteuuidOk

`func (o *NiatelemetryNiaInventoryAllOf) GetSiteuuidOk() (*string, bool)`
...
`func (o *NiatelemetryNiaInventoryAllOf) SetSiteuuid(v string)`

SetSiteuuid sets Siteuuid field to given value.

### HasSiteuuid

`func (o *NiatelemetryNiaInventoryAllOf) HasSiteuuid() bool`
...
`func (o *NiatelemetryNiaInventoryAllOf) GetVpcPeerIpAddress() string`

GetVpcPeerIpAddress returns the VpcPeerIpAddress field if non-nil, zero value otherwise.

### GetVpcPeerIpAddressOk

`func (o *NiatelemetryNiaInventoryAllOf) GetVpcPeerIpAddressOk() (*string, bool)`
...
`func (o *NiatelemetryNiaInventoryAllOf) SetVpcPeerIpAddress(v string)`

SetVpcPeerIpAddress sets VpcPeerIpAddress field to given value.

### HasVpcPeerIpAddress

`func (o *NiatelemetryNiaInventoryAllOf) HasVpcPeerIpAddress() bool`
