...
**RateLimit** | Pointer to **int64** | The value in Mbps to use for limiting the data rate on the virtual interface. | [optional] [default to 0]
...
`func (o *VnicFcQosPolicy) SetOrganizationNil(b bool)`
