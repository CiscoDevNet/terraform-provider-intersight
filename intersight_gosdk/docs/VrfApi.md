...
------------- | ------------- | -------------
[**CreateVrfVrf**](VrfApi.md#CreateVrfVrf) | **Post** /api/v1/vrf/Vrves | Create a &#39;vrf.Vrf&#39; resource.
[**DeleteVrfVrf**](VrfApi.md#DeleteVrfVrf) | **Delete** /api/v1/vrf/Vrves/{Moid} | Delete a &#39;vrf.Vrf&#39; resource.
[**GetVrfVrfByMoid**](VrfApi.md#GetVrfVrfByMoid) | **Get** /api/v1/vrf/Vrves/{Moid} | Read a &#39;vrf.Vrf&#39; resource.
[**GetVrfVrfList**](VrfApi.md#GetVrfVrfList) | **Get** /api/v1/vrf/Vrves | Read a &#39;vrf.Vrf&#39; resource.
[**PatchVrfVrf**](VrfApi.md#PatchVrfVrf) | **Patch** /api/v1/vrf/Vrves/{Moid} | Update a &#39;vrf.Vrf&#39; resource.
[**UpdateVrfVrf**](VrfApi.md#UpdateVrfVrf) | **Post** /api/v1/vrf/Vrves/{Moid} | Update a &#39;vrf.Vrf&#39; resource.



## CreateVrfVrf

> VrfVrf CreateVrfVrf(ctx).VrfVrf(vrfVrf).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
...
func main() {
    ...
    resp, r, err := api_client.VrfApi.CreateVrfVrf(context.Background(), vrfVrf).IfMatch(ifMatch).IfNoneMatch(ifNoneMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `VrfApi.CreateVrfVrf``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `CreateVrfVrf`: VrfVrf
    fmt.Fprintf(os.Stdout, "Response from `VrfApi.CreateVrfVrf`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCreateVrfVrfRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **vrfVrf** | [**VrfVrf**](VrfVrf.md) | The &#39;vrf.Vrf&#39; resource to create. | 
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.VrfApi.DeleteVrfVrf(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `VrfApi.DeleteVrfVrf``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDeleteVrfVrfRequest struct via the builder pattern
...
> VrfVrf GetVrfVrfByMoid(ctx, moid).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.VrfApi.GetVrfVrfByMoid(context.Background(), moid).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `VrfApi.GetVrfVrfByMoid``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetVrfVrfByMoid`: VrfVrf
    fmt.Fprintf(os.Stdout, "Response from `VrfApi.GetVrfVrfByMoid`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetVrfVrfByMoidRequest struct via the builder pattern
...
> VrfVrfResponse GetVrfVrfList(ctx).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.VrfApi.GetVrfVrfList(context.Background(), ).Filter(filter).Orderby(orderby).Top(top).Skip(skip).Select_(select_).Expand(expand).Apply(apply).Count(count).Inlinecount(inlinecount).At(at).Tags(tags).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `VrfApi.GetVrfVrfList``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetVrfVrfList`: VrfVrfResponse
    fmt.Fprintf(os.Stdout, "Response from `VrfApi.GetVrfVrfList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetVrfVrfListRequest struct via the builder pattern
...
> VrfVrf PatchVrfVrf(ctx, moid).VrfVrf(vrfVrf).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    vrfVrf := openapiclient.vrf.Vrf{AccountMoid: "AccountMoid_example", ClassId: "ClassId_example", CreateTime: "TODO", DomainGroupMoid: "DomainGroupMoid_example", ModTime: "TODO", Moid: "Moid_example", ObjectType: "ObjectType_example", Owners: []string{"Owners_example"), SharedScope: "SharedScope_example", Tags: []MoTag{), VersionContext: , Ancestors: []MoBaseMoRelationship{), Parent: , PermissionResources: []MoBaseMoRelationship{), DisplayNames: map[string]string{ "Key" = "Value" }, Description: "Description_example", Name: "Name_example", Account: } // VrfVrf | The 'vrf.Vrf' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.VrfApi.PatchVrfVrf(context.Background(), moid, vrfVrf).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `VrfApi.PatchVrfVrf``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `PatchVrfVrf`: VrfVrf
    fmt.Fprintf(os.Stdout, "Response from `VrfApi.PatchVrfVrf`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchVrfVrfRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **vrfVrf** | [**VrfVrf**](VrfVrf.md) | The &#39;vrf.Vrf&#39; resource to update. | 
 **ifMatch** | **string** | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. | 
...
> VrfVrf UpdateVrfVrf(ctx, moid).VrfVrf(vrfVrf).IfMatch(ifMatch).Execute()
...
func main() {
    moid := "moid_example" // string | The unique Moid identifier of a resource instance.
    vrfVrf :=  // VrfVrf | The 'vrf.Vrf' resource to update.
    ifMatch := "ifMatch_example" // string | For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.VrfApi.UpdateVrfVrf(context.Background(), moid, vrfVrf).IfMatch(ifMatch).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `VrfApi.UpdateVrfVrf``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateVrfVrf`: VrfVrf
    fmt.Fprintf(os.Stdout, "Response from `VrfApi.UpdateVrfVrf`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateVrfVrfRequest struct via the builder pattern
