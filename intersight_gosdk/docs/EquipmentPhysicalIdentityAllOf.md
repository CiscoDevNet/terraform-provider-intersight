...
`func (o *EquipmentPhysicalIdentityAllOf) GetLastDiscoveryTriggered() string`
...
`func (o *EquipmentPhysicalIdentityAllOf) GetLastDiscoveryTriggeredOk() (*string, bool)`
...
`func (o *EquipmentPhysicalIdentityAllOf) SetLastDiscoveryTriggered(v string)`

SetLastDiscoveryTriggered sets LastDiscoveryTriggered field to given value.

### HasLastDiscoveryTriggered

`func (o *EquipmentPhysicalIdentityAllOf) HasLastDiscoveryTriggered() bool`
