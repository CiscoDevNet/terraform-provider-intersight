...
func (dst *HyperflexConfigResultResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "hyperflex.ConfigResult.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexConfigResultResponse as HyperflexConfigResultList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexConfigResultResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexConfigResultResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal HyperflexConfigResultResponse as MoTagSummary: %s", err.Error())
		}
	}
