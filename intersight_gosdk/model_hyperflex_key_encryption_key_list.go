...
// checks if the HyperflexKeyEncryptionKeyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexKeyEncryptionKeyList{}
...
func (o HyperflexKeyEncryptionKeyList) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexKeyEncryptionKeyList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexKeyEncryptionKeyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexKeyEncryptionKeyList)
	if err == nil {
