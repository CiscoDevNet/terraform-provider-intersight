...
// checks if the TamApiDataSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TamApiDataSource{}
...
// GetDefaultClassId returns the default value "tam.ApiDataSource" of the ClassId field.
func (o *TamApiDataSource) GetDefaultClassId() interface{} {
	return "tam.ApiDataSource"
}
...
// GetDefaultObjectType returns the default value "tam.ApiDataSource" of the ObjectType field.
func (o *TamApiDataSource) GetDefaultObjectType() interface{} {
	return "tam.ApiDataSource"
}
...
func (o TamApiDataSource) ToMap() (map[string]interface{}, error) {
...
func (o *TamApiDataSource) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTamApiDataSourceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTamApiDataSource)
	if err == nil {
