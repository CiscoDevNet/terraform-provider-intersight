...
// checks if the AssetParentConnectionSignature type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetParentConnectionSignature{}
...
// GetDefaultClassId returns the default value "asset.ParentConnectionSignature" of the ClassId field.
func (o *AssetParentConnectionSignature) GetDefaultClassId() interface{} {
	return "asset.ParentConnectionSignature"
}
...
// GetDefaultObjectType returns the default value "asset.ParentConnectionSignature" of the ObjectType field.
func (o *AssetParentConnectionSignature) GetDefaultObjectType() interface{} {
	return "asset.ParentConnectionSignature"
}
...
func (o AssetParentConnectionSignature) ToMap() (map[string]interface{}, error) {
...
func (o *AssetParentConnectionSignature) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetParentConnectionSignatureWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetParentConnectionSignature)
	if err == nil {
