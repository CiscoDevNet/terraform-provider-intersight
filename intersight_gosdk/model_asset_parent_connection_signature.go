...
func (o *AssetParentConnectionSignature) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varAssetParentConnectionSignature.Signature = varAssetParentConnectionSignatureWithoutEmbeddedStruct.Signature
		varAssetParentConnectionSignature.TimeStamp = varAssetParentConnectionSignatureWithoutEmbeddedStruct.TimeStamp
	...
	if err == nil {
		o.MoBaseComplexType = varAssetParentConnectionSignature.MoBaseComplexType
	} else {
		return err
	}
