...
// checks if the StorageVirtualDriveConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageVirtualDriveConfiguration{}
...
// GetDefaultClassId returns the default value "storage.VirtualDriveConfiguration" of the ClassId field.
func (o *StorageVirtualDriveConfiguration) GetDefaultClassId() interface{} {
	return "storage.VirtualDriveConfiguration"
}
...
// GetDefaultObjectType returns the default value "storage.VirtualDriveConfiguration" of the ObjectType field.
func (o *StorageVirtualDriveConfiguration) GetDefaultObjectType() interface{} {
	return "storage.VirtualDriveConfiguration"
}
...
func (o *StorageVirtualDriveConfiguration) GetExpandToAvailable() bool {
	if o == nil || IsNil(o.ExpandToAvailable) {
		var ret bool
		return ret
	}
...
func (o StorageVirtualDriveConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BootDrive) {
		toSerialize["BootDrive"] = o.BootDrive
	}
	if !IsNil(o.ExpandToAvailable) {
...
func (o *StorageVirtualDriveConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageVirtualDriveConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageVirtualDriveConfiguration)
	if err == nil {
