...
func (r ApiCreateSdcardPolicyRequest) Execute() (*SdcardPolicy, *http.Response, error) {
...
func (r ApiDeleteSdcardPolicyRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *SdcardApiService) DeleteSdcardPolicyExecute(r ApiDeleteSdcardPolicyRequest) (*http.Response, error) {
	var (
...
func (r ApiGetSdcardPolicyByMoidRequest) Execute() (*SdcardPolicy, *http.Response, error) {
...
type ApiGetSdcardPolicyInventoryByMoidRequest struct {
	ctx        context.Context
	ApiService *SdcardApiService
	moid       string
}

func (r ApiGetSdcardPolicyInventoryByMoidRequest) Execute() (*SdcardPolicyInventory, *http.Response, error) {
	return r.ApiService.GetSdcardPolicyInventoryByMoidExecute(r)
}
...
func (a *SdcardApiService) GetSdcardPolicyInventoryByMoidExecute(r ApiGetSdcardPolicyInventoryByMoidRequest) (*SdcardPolicyInventory, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SdcardPolicyInventory
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SdcardApiService.GetSdcardPolicyInventoryByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sdcard/PolicyInventories/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
type ApiGetSdcardPolicyInventoryListRequest struct {
	ctx         context.Context
	ApiService  *SdcardApiService
	filter      *string
	orderby     *string
...
func (r ApiGetSdcardPolicyInventoryListRequest) Filter(filter string) ApiGetSdcardPolicyInventoryListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetSdcardPolicyInventoryListRequest) Orderby(orderby string) ApiGetSdcardPolicyInventoryListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetSdcardPolicyInventoryListRequest) Top(top int32) ApiGetSdcardPolicyInventoryListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetSdcardPolicyInventoryListRequest) Skip(skip int32) ApiGetSdcardPolicyInventoryListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetSdcardPolicyInventoryListRequest) Select_(select_ string) ApiGetSdcardPolicyInventoryListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetSdcardPolicyInventoryListRequest) Expand(expand string) ApiGetSdcardPolicyInventoryListRequest {
	r.expand = &expand
	return r
}
...
func (r ApiGetSdcardPolicyInventoryListRequest) Apply(apply string) ApiGetSdcardPolicyInventoryListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetSdcardPolicyInventoryListRequest) Count(count bool) ApiGetSdcardPolicyInventoryListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetSdcardPolicyInventoryListRequest) Inlinecount(inlinecount string) ApiGetSdcardPolicyInventoryListRequest {
...
func (r ApiGetSdcardPolicyInventoryListRequest) At(at string) ApiGetSdcardPolicyInventoryListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetSdcardPolicyInventoryListRequest) Tags(tags string) ApiGetSdcardPolicyInventoryListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetSdcardPolicyInventoryListRequest) Execute() (*SdcardPolicyInventoryResponse, *http.Response, error) {
	return r.ApiService.GetSdcardPolicyInventoryListExecute(r)
}
...
func (a *SdcardApiService) GetSdcardPolicyInventoryListExecute(r ApiGetSdcardPolicyInventoryListRequest) (*SdcardPolicyInventoryResponse, *http.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SdcardPolicyInventoryResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SdcardApiService.GetSdcardPolicyInventoryList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/sdcard/PolicyInventories"
...
func (r ApiGetSdcardPolicyListRequest) Execute() (*SdcardPolicyResponse, *http.Response, error) {
...
func (r ApiPatchSdcardPolicyRequest) Execute() (*SdcardPolicy, *http.Response, error) {
...
func (r ApiUpdateSdcardPolicyRequest) Execute() (*SdcardPolicy, *http.Response, error) {
