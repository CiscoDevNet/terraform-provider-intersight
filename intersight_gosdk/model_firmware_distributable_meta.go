...
// checks if the FirmwareDistributableMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirmwareDistributableMeta{}
...
// GetDefaultClassId returns the default value "firmware.DistributableMeta" of the ClassId field.
func (o *FirmwareDistributableMeta) GetDefaultClassId() interface{} {
	return "firmware.DistributableMeta"
}
...
// GetDefaultObjectType returns the default value "firmware.DistributableMeta" of the ObjectType field.
func (o *FirmwareDistributableMeta) GetDefaultObjectType() interface{} {
	return "firmware.DistributableMeta"
}
...
func (o FirmwareDistributableMeta) ToMap() (map[string]interface{}, error) {
...
func (o *FirmwareDistributableMeta) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFirmwareDistributableMetaWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFirmwareDistributableMeta)
	if err == nil {
