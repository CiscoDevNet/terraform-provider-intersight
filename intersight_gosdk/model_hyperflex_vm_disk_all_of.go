...
type _HyperflexVmDiskAllOf HyperflexVmDiskAllOf
...
func (o *HyperflexVmDiskAllOf) SetVirtualDiskNil() {
...
func (o *HyperflexVmDiskAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexVmDiskAllOf := _HyperflexVmDiskAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexVmDiskAllOf); err == nil {
		*o = HyperflexVmDiskAllOf(varHyperflexVmDiskAllOf)
	}
