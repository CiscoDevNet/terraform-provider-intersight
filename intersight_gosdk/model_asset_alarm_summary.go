...
// GetDefaultClassId returns the default value "asset.AlarmSummary" of the ClassId field.
func (o *AssetAlarmSummary) GetDefaultClassId() interface{} {
	return "asset.AlarmSummary"
}
...
// GetDefaultObjectType returns the default value "asset.AlarmSummary" of the ObjectType field.
func (o *AssetAlarmSummary) GetDefaultObjectType() interface{} {
	return "asset.AlarmSummary"
}
...
func (o *AssetAlarmSummary) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varAssetAlarmSummary.SuppressedCritical = varAssetAlarmSummaryWithoutEmbeddedStruct.SuppressedCritical
		varAssetAlarmSummary.SuppressedInfo = varAssetAlarmSummaryWithoutEmbeddedStruct.SuppressedInfo
		varAssetAlarmSummary.SuppressedWarning = varAssetAlarmSummaryWithoutEmbeddedStruct.SuppressedWarning
