...
// checks if the VirtualizationBaseSwitch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationBaseSwitch{}
...
func (o VirtualizationBaseSwitch) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationBaseSwitch) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseSwitchWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseSwitch)
	if err == nil {
