...
func (o *KubernetesAbstractStatefulSet) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varKubernetesAbstractStatefulSetWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varKubernetesAbstractStatefulSet)
	if err == nil {
