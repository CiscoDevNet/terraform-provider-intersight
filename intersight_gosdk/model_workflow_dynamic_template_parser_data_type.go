...
// checks if the WorkflowDynamicTemplateParserDataType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowDynamicTemplateParserDataType{}
...
// GetDefaultClassId returns the default value "workflow.DynamicTemplateParserDataType" of the ClassId field.
func (o *WorkflowDynamicTemplateParserDataType) GetDefaultClassId() interface{} {
	return "workflow.DynamicTemplateParserDataType"
}
...
// GetDefaultObjectType returns the default value "workflow.DynamicTemplateParserDataType" of the ObjectType field.
func (o *WorkflowDynamicTemplateParserDataType) GetDefaultObjectType() interface{} {
	return "workflow.DynamicTemplateParserDataType"
}
...
func (o *WorkflowDynamicTemplateParserDataType) GetIsTemplateSecure() bool {
	if o == nil || IsNil(o.IsTemplateSecure) {
		var ret bool
		return ret
	}
...
func (o WorkflowDynamicTemplateParserDataType) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowDynamicTemplateParserDataType) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowDynamicTemplateParserDataTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowDynamicTemplateParserDataType)
	if err == nil {
