...
func (dst *AdapterUnitResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'adapter.Unit.List'
	if jsonDict["ObjectType"] == "adapter.Unit.List" {
		// try to unmarshal JSON data into AdapterUnitList
		err = json.Unmarshal(data, &dst.AdapterUnitList)
		if err == nil {
			return nil // data stored in dst.AdapterUnitList, return on the first match
		} else {
			dst.AdapterUnitList = nil
			return fmt.Errorf("Failed to unmarshal AdapterUnitResponse as AdapterUnitList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AdapterUnitResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AdapterUnitResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AdapterUnitResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src AdapterUnitResponse) MarshalJSON() ([]byte, error) {
	if src.AdapterUnitList != nil {
		return json.Marshal(&src.AdapterUnitList)
	}
...
type NullableAdapterUnitResponse struct {
	value *AdapterUnitResponse
	isSet bool
}

func (v NullableAdapterUnitResponse) Get() *AdapterUnitResponse {
	return v.value
}

func (v *NullableAdapterUnitResponse) Set(val *AdapterUnitResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAdapterUnitResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAdapterUnitResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdapterUnitResponse(val *AdapterUnitResponse) *NullableAdapterUnitResponse {
	return &NullableAdapterUnitResponse{value: val, isSet: true}
}

func (v NullableAdapterUnitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdapterUnitResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
