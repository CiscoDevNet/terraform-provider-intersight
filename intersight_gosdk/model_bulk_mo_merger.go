...
// BulkMoMerger ### Overview The MoMerger object is an interface designed to merge properties of managed object (MO) instances. It allows for the synchronization and updating of multiple target MOs based on specified source configurations.    #### Purpose   MoMerger is instrumental in template synchronization, enabling bulk updates of derived instances with changes made to their parent templates, ensuring consistency across configurations.    #### Key Concepts  - **Property Merging: Supports the merging of selected properties from source to target instances, allowing for efficient updates and configuration synchronization.  - **Template Synchronization: Facilitates the propagation of template changes to derived profiles, ensuring uniformity and adherence to updated configurations.  - **Configuration Application: Offers the ability to apply specific configuration changes across all target instances during the merge process.  - **Async Processing: Operates asynchronously, accommodating large-scale merge operations without impacting system performance.
...
// GetDefaultClassId returns the default value "bulk.MoMerger" of the ClassId field.
func (o *BulkMoMerger) GetDefaultClassId() interface{} {
	return "bulk.MoMerger"
}
...
// GetDefaultObjectType returns the default value "bulk.MoMerger" of the ObjectType field.
func (o *BulkMoMerger) GetDefaultObjectType() interface{} {
	return "bulk.MoMerger"
}
