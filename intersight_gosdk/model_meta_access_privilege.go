...
// checks if the MetaAccessPrivilege type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaAccessPrivilege{}
...
// GetDefaultClassId returns the default value "meta.AccessPrivilege" of the ClassId field.
func (o *MetaAccessPrivilege) GetDefaultClassId() interface{} {
	return "meta.AccessPrivilege"
}
...
// GetDefaultObjectType returns the default value "meta.AccessPrivilege" of the ObjectType field.
func (o *MetaAccessPrivilege) GetDefaultObjectType() interface{} {
	return "meta.AccessPrivilege"
}
...
func (o MetaAccessPrivilege) ToMap() (map[string]interface{}, error) {
...
func (o *MetaAccessPrivilege) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMetaAccessPrivilegeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varMetaAccessPrivilege)
	if err == nil {
