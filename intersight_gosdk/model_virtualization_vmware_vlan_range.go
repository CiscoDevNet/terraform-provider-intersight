...
// checks if the VirtualizationVmwareVlanRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationVmwareVlanRange{}
...
// GetDefaultClassId returns the default value "virtualization.VmwareVlanRange" of the ClassId field.
func (o *VirtualizationVmwareVlanRange) GetDefaultClassId() interface{} {
	return "virtualization.VmwareVlanRange"
}
...
// GetDefaultObjectType returns the default value "virtualization.VmwareVlanRange" of the ObjectType field.
func (o *VirtualizationVmwareVlanRange) GetDefaultObjectType() interface{} {
	return "virtualization.VmwareVlanRange"
}
...
func (o *VirtualizationVmwareVlanRange) GetVlanRangeStart() int64 {
	if o == nil || IsNil(o.VlanRangeStart) {
		var ret int64
		return ret
	}
...
func (o VirtualizationVmwareVlanRange) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VlanRangeEnd) {
		toSerialize["VlanRangeEnd"] = o.VlanRangeEnd
	}
	if !IsNil(o.VlanRangeStart) {
...
func (o *VirtualizationVmwareVlanRange) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareVlanRangeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareVlanRange)
	if err == nil {
