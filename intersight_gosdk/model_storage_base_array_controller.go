...
// checks if the StorageBaseArrayController type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageBaseArrayController{}
...
func (o *StorageBaseArrayController) GetOperationalMode() string {
	if o == nil || IsNil(o.OperationalMode) {
		var ret string
		return ret
	}
...
func (o StorageBaseArrayController) ToMap() (map[string]interface{}, error) {
...
func (o *StorageBaseArrayController) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageBaseArrayControllerWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageBaseArrayController)
	if err == nil {
