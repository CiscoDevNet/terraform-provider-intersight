...
func (dst *ApplianceDeviceClaimResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "appliance.DeviceClaim.List" {
		// try to unmarshal JSON data into ApplianceDeviceClaimList
		err = json.Unmarshal(data, &dst.ApplianceDeviceClaimList)
		if err == nil {
			return nil // data stored in dst.ApplianceDeviceClaimList, return on the first match
		} else {
			dst.ApplianceDeviceClaimList = nil
			return fmt.Errorf("Failed to unmarshal ApplianceDeviceClaimResponse as ApplianceDeviceClaimList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ApplianceDeviceClaimResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ApplianceDeviceClaimResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ApplianceDeviceClaimResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src ApplianceDeviceClaimResponse) MarshalJSON() ([]byte, error) {
	if src.ApplianceDeviceClaimList != nil {
		return json.Marshal(&src.ApplianceDeviceClaimList)
	}
...
type NullableApplianceDeviceClaimResponse struct {
	value *ApplianceDeviceClaimResponse
	isSet bool
}

func (v NullableApplianceDeviceClaimResponse) Get() *ApplianceDeviceClaimResponse {
	return v.value
}

func (v *NullableApplianceDeviceClaimResponse) Set(val *ApplianceDeviceClaimResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceDeviceClaimResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceDeviceClaimResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceDeviceClaimResponse(val *ApplianceDeviceClaimResponse) *NullableApplianceDeviceClaimResponse {
	return &NullableApplianceDeviceClaimResponse{value: val, isSet: true}
}

func (v NullableApplianceDeviceClaimResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceDeviceClaimResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
