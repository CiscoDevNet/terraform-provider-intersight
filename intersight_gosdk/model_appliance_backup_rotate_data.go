...
func (o *ApplianceBackupRotateData) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varApplianceBackupRotateDataWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varApplianceBackupRotateData)
	if err == nil {
