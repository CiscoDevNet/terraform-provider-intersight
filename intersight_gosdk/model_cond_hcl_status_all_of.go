...
type CondHclStatusAllOf struct {
...
type _CondHclStatusAllOf CondHclStatusAllOf

// NewCondHclStatusAllOf instantiates a new CondHclStatusAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCondHclStatusAllOf() *CondHclStatusAllOf {
	this := CondHclStatusAllOf{}
...
func (o CondHclStatusAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CondHclStatusAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCondHclStatusAllOf := _CondHclStatusAllOf{}

	if err = json.Unmarshal(bytes, &varCondHclStatusAllOf); err == nil {
		*o = CondHclStatusAllOf(varCondHclStatusAllOf)
	}
...
type NullableCondHclStatusAllOf struct {
	value *CondHclStatusAllOf
	isSet bool
}

func (v NullableCondHclStatusAllOf) Get() *CondHclStatusAllOf {
	return v.value
}

func (v *NullableCondHclStatusAllOf) Set(val *CondHclStatusAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCondHclStatusAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCondHclStatusAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCondHclStatusAllOf(val *CondHclStatusAllOf) *NullableCondHclStatusAllOf {
	return &NullableCondHclStatusAllOf{value: val, isSet: true}
}

func (v NullableCondHclStatusAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCondHclStatusAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
