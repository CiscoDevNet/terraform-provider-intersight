...
// checks if the VnicFcAdapterPolicyInventory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicFcAdapterPolicyInventory{}
...
// GetDefaultClassId returns the default value "vnic.FcAdapterPolicyInventory" of the ClassId field.
func (o *VnicFcAdapterPolicyInventory) GetDefaultClassId() interface{} {
	return "vnic.FcAdapterPolicyInventory"
}
...
// GetDefaultObjectType returns the default value "vnic.FcAdapterPolicyInventory" of the ObjectType field.
func (o *VnicFcAdapterPolicyInventory) GetDefaultObjectType() interface{} {
	return "vnic.FcAdapterPolicyInventory"
}
...
func (o *VnicFcAdapterPolicyInventory) SetTargetMoNil() {
	o.TargetMo.Set(nil)
}
...
func (o VnicFcAdapterPolicyInventory) ToMap() (map[string]interface{}, error) {
...
func (o *VnicFcAdapterPolicyInventory) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicFcAdapterPolicyInventoryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVnicFcAdapterPolicyInventory)
	if err == nil {
