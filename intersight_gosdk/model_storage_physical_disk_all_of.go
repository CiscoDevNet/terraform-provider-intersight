...
// StoragePhysicalDiskAllOf Definition of the list of properties defined in 'storage.PhysicalDisk', excluding properties defined in parent classes.
type StoragePhysicalDiskAllOf struct {
...
type _StoragePhysicalDiskAllOf StoragePhysicalDiskAllOf
...
func (o StoragePhysicalDiskAllOf) MarshalJSON() ([]byte, error) {
	...
	if o.PowerOnHoursPercentage != nil {
...
func (o *StoragePhysicalDiskAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStoragePhysicalDiskAllOf := _StoragePhysicalDiskAllOf{}

	if err = json.Unmarshal(bytes, &varStoragePhysicalDiskAllOf); err == nil {
		*o = StoragePhysicalDiskAllOf(varStoragePhysicalDiskAllOf)
	}
...
type NullableStoragePhysicalDiskAllOf struct {
	value *StoragePhysicalDiskAllOf
	isSet bool
}

func (v NullableStoragePhysicalDiskAllOf) Get() *StoragePhysicalDiskAllOf {
	return v.value
}

func (v *NullableStoragePhysicalDiskAllOf) Set(val *StoragePhysicalDiskAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePhysicalDiskAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePhysicalDiskAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePhysicalDiskAllOf(val *StoragePhysicalDiskAllOf) *NullableStoragePhysicalDiskAllOf {
	return &NullableStoragePhysicalDiskAllOf{value: val, isSet: true}
}

func (v NullableStoragePhysicalDiskAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePhysicalDiskAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
