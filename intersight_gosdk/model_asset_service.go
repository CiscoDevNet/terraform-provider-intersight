...
type AssetService struct {
	...
	Options              NullableMoBaseComplexType `json:"Options,omitempty"`
...
// SetOptions gets a reference to the given NullableMoBaseComplexType and assigns it to the Options field.
