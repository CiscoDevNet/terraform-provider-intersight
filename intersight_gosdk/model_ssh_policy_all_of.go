...
// SshPolicyAllOf Definition of the list of properties defined in 'ssh.Policy', excluding properties defined in parent classes.
type SshPolicyAllOf struct {
...
type _SshPolicyAllOf SshPolicyAllOf
...
func (o SshPolicyAllOf) MarshalJSON() ([]byte, error) {
...
func (o *SshPolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varSshPolicyAllOf := _SshPolicyAllOf{}

	if err = json.Unmarshal(bytes, &varSshPolicyAllOf); err == nil {
		*o = SshPolicyAllOf(varSshPolicyAllOf)
	}
...
type NullableSshPolicyAllOf struct {
	value *SshPolicyAllOf
	isSet bool
}

func (v NullableSshPolicyAllOf) Get() *SshPolicyAllOf {
	return v.value
}

func (v *NullableSshPolicyAllOf) Set(val *SshPolicyAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSshPolicyAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSshPolicyAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSshPolicyAllOf(val *SshPolicyAllOf) *NullableSshPolicyAllOf {
	return &NullableSshPolicyAllOf{value: val, isSet: true}
}

func (v NullableSshPolicyAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSshPolicyAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
