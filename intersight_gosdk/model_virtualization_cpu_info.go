...
// checks if the VirtualizationCpuInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationCpuInfo{}
...
// GetDefaultClassId returns the default value "virtualization.CpuInfo" of the ClassId field.
func (o *VirtualizationCpuInfo) GetDefaultClassId() interface{} {
	return "virtualization.CpuInfo"
}
...
// GetDefaultObjectType returns the default value "virtualization.CpuInfo" of the ObjectType field.
func (o *VirtualizationCpuInfo) GetDefaultObjectType() interface{} {
	return "virtualization.CpuInfo"
}
...
func (o VirtualizationCpuInfo) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationCpuInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationCpuInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationCpuInfo)
	if err == nil {
