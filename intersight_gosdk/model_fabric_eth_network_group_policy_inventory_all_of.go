...
// FabricEthNetworkGroupPolicyInventoryAllOf Definition of the list of properties defined in 'fabric.EthNetworkGroupPolicyInventory', excluding properties defined in parent classes.
type FabricEthNetworkGroupPolicyInventoryAllOf struct {
...
type _FabricEthNetworkGroupPolicyInventoryAllOf FabricEthNetworkGroupPolicyInventoryAllOf
...
func NewFabricEthNetworkGroupPolicyInventoryAllOf(classId string, objectType string) *FabricEthNetworkGroupPolicyInventoryAllOf {
	this := FabricEthNetworkGroupPolicyInventoryAllOf{}
...
func (o *FabricEthNetworkGroupPolicyInventoryAllOf) SetVlanSettingsNil() {
...
func (o FabricEthNetworkGroupPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricEthNetworkGroupPolicyInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricEthNetworkGroupPolicyInventoryAllOf := _FabricEthNetworkGroupPolicyInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varFabricEthNetworkGroupPolicyInventoryAllOf); err == nil {
		*o = FabricEthNetworkGroupPolicyInventoryAllOf(varFabricEthNetworkGroupPolicyInventoryAllOf)
	}
...
type NullableFabricEthNetworkGroupPolicyInventoryAllOf struct {
	value *FabricEthNetworkGroupPolicyInventoryAllOf
	isSet bool
}

func (v NullableFabricEthNetworkGroupPolicyInventoryAllOf) Get() *FabricEthNetworkGroupPolicyInventoryAllOf {
	return v.value
}

func (v *NullableFabricEthNetworkGroupPolicyInventoryAllOf) Set(val *FabricEthNetworkGroupPolicyInventoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricEthNetworkGroupPolicyInventoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricEthNetworkGroupPolicyInventoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricEthNetworkGroupPolicyInventoryAllOf(val *FabricEthNetworkGroupPolicyInventoryAllOf) *NullableFabricEthNetworkGroupPolicyInventoryAllOf {
	return &NullableFabricEthNetworkGroupPolicyInventoryAllOf{value: val, isSet: true}
}

func (v NullableFabricEthNetworkGroupPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricEthNetworkGroupPolicyInventoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
