...
type AssetDeviceRegistration struct {
	...
	ParentSignature NullableAssetParentConnectionSignature `json:"ParentSignature,omitempty"`
...
// SetParentSignature gets a reference to the given NullableAssetParentConnectionSignature and assigns it to the ParentSignature field.
