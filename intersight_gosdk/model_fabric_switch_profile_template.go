...
func (o *FabricSwitchProfileTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFabricSwitchProfileTemplate.EnableOverride = varFabricSwitchProfileTemplateWithoutEmbeddedStruct.EnableOverride
		varFabricSwitchProfileTemplate.TemplateActions = varFabricSwitchProfileTemplateWithoutEmbeddedStruct.TemplateActions
		varFabricSwitchProfileTemplate.UpdateStatus = varFabricSwitchProfileTemplateWithoutEmbeddedStruct.UpdateStatus
		varFabricSwitchProfileTemplate.UsageCount = varFabricSwitchProfileTemplateWithoutEmbeddedStruct.UsageCount
