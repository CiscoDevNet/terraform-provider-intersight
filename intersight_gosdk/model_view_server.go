...
// ViewServer The Server object facilitates querying a list of UCS servers, including API resource types compute.Blade and compute.RackUnit, along with associated managed object information. #### Purpose The Server object is intended to provide a REST endpoint for accessing and managing server-related data within the UCS ecosystem. It helps users query comprehensive server information, supporting various operational and management tasks. #### Key Concepts - **REST Endpoint:** Offers a standardized interface for querying server data, supporting OData operators for filtering and ordering results. - **Integration with MO Information:** Allows access to related managed object information such as device registration and health status.
