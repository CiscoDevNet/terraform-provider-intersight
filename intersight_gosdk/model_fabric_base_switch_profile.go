...
func (o *FabricBaseSwitchProfile) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFabricBaseSwitchProfileWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFabricBaseSwitchProfile)
	if err == nil {
