...
func (dst *ConfigExporterRelationship) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ClassId"] == "config.Exporter" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal ConfigExporterRelationship as ConfigExporter: %s", err.Error())
		}
	}
	...
	if jsonDict["ClassId"] == "mo.MoRef" {
		...
		if err == nil {
			...
			dst.MoMoRef = nil
			return fmt.Errorf("Failed to unmarshal ConfigExporterRelationship as MoMoRef: %s", err.Error())
		}
	}
