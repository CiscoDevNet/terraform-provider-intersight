...
func (o *WorkflowArrayItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varWorkflowArrayItemWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varWorkflowArrayItem)
	if err == nil {
