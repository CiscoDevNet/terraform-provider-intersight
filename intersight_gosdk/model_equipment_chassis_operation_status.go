...
func (o *EquipmentChassisOperationStatus) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varEquipmentChassisOperationStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varEquipmentChassisOperationStatus)
	if err == nil {
