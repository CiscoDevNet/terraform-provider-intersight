...
// checks if the KubernetesRoute type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesRoute{}
...
type KubernetesRoute struct {
	...
	To *string `json:"To,omitempty" validate:"regexp=^$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]).([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]).([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]).([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\/([0-9]|[1-2][0-9]|3[0-2])$"`
	// Via is the gateway for traffic destined for the subnet in the To property.
	Via                  *string `json:"Via,omitempty" validate:"regexp=^$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
...
// GetDefaultClassId returns the default value "kubernetes.Route" of the ClassId field.
func (o *KubernetesRoute) GetDefaultClassId() interface{} {
	return "kubernetes.Route"
}
...
// GetDefaultObjectType returns the default value "kubernetes.Route" of the ObjectType field.
func (o *KubernetesRoute) GetDefaultObjectType() interface{} {
	return "kubernetes.Route"
}
...
func (o KubernetesRoute) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesRoute) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesRouteWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesRoute)
	if err == nil {
