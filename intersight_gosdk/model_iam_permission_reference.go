...
// checks if the IamPermissionReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamPermissionReference{}
...
type IamPermissionReference struct {
	...
	UserGroupMappings    []MoMoRef `json:"UserGroupMappings,omitempty"`
...
// GetDefaultClassId returns the default value "iam.PermissionReference" of the ClassId field.
func (o *IamPermissionReference) GetDefaultClassId() interface{} {
	return "iam.PermissionReference"
}
...
// GetDefaultObjectType returns the default value "iam.PermissionReference" of the ObjectType field.
func (o *IamPermissionReference) GetDefaultObjectType() interface{} {
	return "iam.PermissionReference"
}
...
func (o *IamPermissionReference) GetPermissionIdentifier() string {
	if o == nil || IsNil(o.PermissionIdentifier) {
		var ret string
		return ret
	}
...
// GetUserGroupMappings returns the UserGroupMappings field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IamPermissionReference) GetUserGroupMappings() []MoMoRef {
	if o == nil {
		var ret []MoMoRef
		return ret
	}
	return o.UserGroupMappings
}

// GetUserGroupMappingsOk returns a tuple with the UserGroupMappings field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IamPermissionReference) GetUserGroupMappingsOk() ([]MoMoRef, bool) {
	if o == nil || IsNil(o.UserGroupMappings) {
		return nil, false
	}
	return o.UserGroupMappings, true
}
...
// SetUserGroupMappings gets a reference to the given []MoMoRef and assigns it to the UserGroupMappings field.
func (o *IamPermissionReference) SetUserGroupMappings(v []MoMoRef) {
	o.UserGroupMappings = v
}
...
func (o IamPermissionReference) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PermissionIdentifier) {
	...
	if o.UserGroupMappings != nil {
		toSerialize["UserGroupMappings"] = o.UserGroupMappings
	}
...
func (o *IamPermissionReference) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamPermissionReferenceWithoutEmbeddedStruct)
	if err == nil {
		...
		varIamPermissionReference.UserGroupMappings = varIamPermissionReferenceWithoutEmbeddedStruct.UserGroupMappings
	...
	err = json.Unmarshal(data, &varIamPermissionReference)
	if err == nil {
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "UserGroupMappings")
