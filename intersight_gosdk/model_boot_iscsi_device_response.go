...
func (dst *BootIscsiDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'boot.IscsiDevice.List'
	if jsonDict["ObjectType"] == "boot.IscsiDevice.List" {
		// try to unmarshal JSON data into BootIscsiDeviceList
		err = json.Unmarshal(data, &dst.BootIscsiDeviceList)
		if err == nil {
			return nil // data stored in dst.BootIscsiDeviceList, return on the first match
		} else {
			dst.BootIscsiDeviceList = nil
			return fmt.Errorf("failed to unmarshal BootIscsiDeviceResponse as BootIscsiDeviceList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal BootIscsiDeviceResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal BootIscsiDeviceResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal BootIscsiDeviceResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src BootIscsiDeviceResponse) MarshalJSON() ([]byte, error) {
	if src.BootIscsiDeviceList != nil {
		return json.Marshal(&src.BootIscsiDeviceList)
	}
...
type NullableBootIscsiDeviceResponse struct {
	value *BootIscsiDeviceResponse
	isSet bool
}

func (v NullableBootIscsiDeviceResponse) Get() *BootIscsiDeviceResponse {
	return v.value
}

func (v *NullableBootIscsiDeviceResponse) Set(val *BootIscsiDeviceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBootIscsiDeviceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBootIscsiDeviceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootIscsiDeviceResponse(val *BootIscsiDeviceResponse) *NullableBootIscsiDeviceResponse {
	return &NullableBootIscsiDeviceResponse{value: val, isSet: true}
}

func (v NullableBootIscsiDeviceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootIscsiDeviceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
