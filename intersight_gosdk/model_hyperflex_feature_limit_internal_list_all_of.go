...
// HyperflexFeatureLimitInternalListAllOf struct for HyperflexFeatureLimitInternalListAllOf
type HyperflexFeatureLimitInternalListAllOf struct {
...
type _HyperflexFeatureLimitInternalListAllOf HyperflexFeatureLimitInternalListAllOf
...
func NewHyperflexFeatureLimitInternalListAllOf() *HyperflexFeatureLimitInternalListAllOf {
	this := HyperflexFeatureLimitInternalListAllOf{}
	return &this
}
...
func (o HyperflexFeatureLimitInternalListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexFeatureLimitInternalListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexFeatureLimitInternalListAllOf := _HyperflexFeatureLimitInternalListAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexFeatureLimitInternalListAllOf); err == nil {
		*o = HyperflexFeatureLimitInternalListAllOf(varHyperflexFeatureLimitInternalListAllOf)
	}
...
type NullableHyperflexFeatureLimitInternalListAllOf struct {
	value *HyperflexFeatureLimitInternalListAllOf
	isSet bool
}

func (v NullableHyperflexFeatureLimitInternalListAllOf) Get() *HyperflexFeatureLimitInternalListAllOf {
	return v.value
}

func (v *NullableHyperflexFeatureLimitInternalListAllOf) Set(val *HyperflexFeatureLimitInternalListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexFeatureLimitInternalListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexFeatureLimitInternalListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexFeatureLimitInternalListAllOf(val *HyperflexFeatureLimitInternalListAllOf) *NullableHyperflexFeatureLimitInternalListAllOf {
	return &NullableHyperflexFeatureLimitInternalListAllOf{value: val, isSet: true}
}

func (v NullableHyperflexFeatureLimitInternalListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexFeatureLimitInternalListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
