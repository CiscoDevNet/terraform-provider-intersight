...
// VirtualizationVdiskConfigAllOf Definition of the list of properties defined in 'virtualization.VdiskConfig', excluding properties defined in parent classes.
type VirtualizationVdiskConfigAllOf struct {
...
type _VirtualizationVdiskConfigAllOf VirtualizationVdiskConfigAllOf
...
func NewVirtualizationVdiskConfigAllOf(classId string, objectType string) *VirtualizationVdiskConfigAllOf {
	this := VirtualizationVdiskConfigAllOf{}
...
func (o VirtualizationVdiskConfigAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationVdiskConfigAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationVdiskConfigAllOf := _VirtualizationVdiskConfigAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationVdiskConfigAllOf); err == nil {
		*o = VirtualizationVdiskConfigAllOf(varVirtualizationVdiskConfigAllOf)
	}
...
type NullableVirtualizationVdiskConfigAllOf struct {
	value *VirtualizationVdiskConfigAllOf
	isSet bool
}

func (v NullableVirtualizationVdiskConfigAllOf) Get() *VirtualizationVdiskConfigAllOf {
	return v.value
}

func (v *NullableVirtualizationVdiskConfigAllOf) Set(val *VirtualizationVdiskConfigAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVdiskConfigAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVdiskConfigAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVdiskConfigAllOf(val *VirtualizationVdiskConfigAllOf) *NullableVirtualizationVdiskConfigAllOf {
	return &NullableVirtualizationVdiskConfigAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationVdiskConfigAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVdiskConfigAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
