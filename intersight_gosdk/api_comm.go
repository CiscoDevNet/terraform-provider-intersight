...
type ApiCreateCommTagDefinitionRequest struct {
	ctx               context.Context
	ApiService        *CommApiService
...
// The &#39;comm.TagDefinition&#39; resource to create.
func (r ApiCreateCommTagDefinitionRequest) CommTagDefinition(commTagDefinition CommTagDefinition) ApiCreateCommTagDefinitionRequest {
	r.commTagDefinition = &commTagDefinition
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiCreateCommTagDefinitionRequest) IfMatch(ifMatch string) ApiCreateCommTagDefinitionRequest {
	r.ifMatch = &ifMatch
	return r
}

// For methods that apply server-side changes, If-None-Match used with the * value can be used to create a resource not known to exist, guaranteeing that another resource creation didn&#39;t happen before, losing the data of the previous put. The request will be processed only if the eventually existing resource&#39;s ETag doesn&#39;t match any of the values listed. Otherwise, the status code 412 (Precondition Failed) is used. The asterisk is a special value representing any resource. It is only useful when creating a resource, usually with PUT, to check if another resource with the identity has already been created before. The comparison with the stored ETag uses the weak comparison algorithm, meaning two resources are considered identical if the content is equivalent - they don&#39;t have to be identical byte for byte.
func (r ApiCreateCommTagDefinitionRequest) IfNoneMatch(ifNoneMatch string) ApiCreateCommTagDefinitionRequest {
	r.ifNoneMatch = &ifNoneMatch
	return r
}

func (r ApiCreateCommTagDefinitionRequest) Execute() (*CommTagDefinition, *http.Response, error) {
	return r.ApiService.CreateCommTagDefinitionExecute(r)
}

/*
CreateCommTagDefinition Create a 'comm.TagDefinition' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateCommTagDefinitionRequest
*/
func (a *CommApiService) CreateCommTagDefinition(ctx context.Context) ApiCreateCommTagDefinitionRequest {
	return ApiCreateCommTagDefinitionRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return CommTagDefinition
func (a *CommApiService) CreateCommTagDefinitionExecute(r ApiCreateCommTagDefinitionRequest) (*CommTagDefinition, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CommTagDefinition
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommApiService.CreateCommTagDefinition")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/comm/TagDefinitions"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.commTagDefinition == nil {
		return localVarReturnValue, nil, reportError("commTagDefinition is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.commTagDefinition
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiDeleteCommTagDefinitionRequest struct {
	ctx        context.Context
	ApiService *CommApiService
	moid       string
}

func (r ApiDeleteCommTagDefinitionRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteCommTagDefinitionExecute(r)
}

/*
DeleteCommTagDefinition Delete a 'comm.TagDefinition' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiDeleteCommTagDefinitionRequest
*/
func (a *CommApiService) DeleteCommTagDefinition(ctx context.Context, moid string) ApiDeleteCommTagDefinitionRequest {
	return ApiDeleteCommTagDefinitionRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
// Execute executes the request
func (a *CommApiService) DeleteCommTagDefinitionExecute(r ApiDeleteCommTagDefinitionRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommApiService.DeleteCommTagDefinition")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/comm/TagDefinitions/{Moid}"
	localVarPath = strings.Replace(localVarPath, "{"+"Moid"+"}", url.PathEscape(parameterValueToString(r.moid, "moid")), -1)
...
type ApiGetCommTagDefinitionByMoidRequest struct {
	ctx        context.Context
	ApiService *CommApiService
	moid       string
}

func (r ApiGetCommTagDefinitionByMoidRequest) Execute() (*CommTagDefinition, *http.Response, error) {
	return r.ApiService.GetCommTagDefinitionByMoidExecute(r)
}

/*
GetCommTagDefinitionByMoid Read a 'comm.TagDefinition' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiGetCommTagDefinitionByMoidRequest
*/
func (a *CommApiService) GetCommTagDefinitionByMoid(ctx context.Context, moid string) ApiGetCommTagDefinitionByMoidRequest {
	return ApiGetCommTagDefinitionByMoidRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return CommTagDefinition
func (a *CommApiService) GetCommTagDefinitionByMoidExecute(r ApiGetCommTagDefinitionByMoidRequest) (*CommTagDefinition, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommApiService.GetCommTagDefinitionByMoid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetCommTagDefinitionListRequest struct {
	ctx         context.Context
	ApiService  *CommApiService
	filter      *string
	orderby     *string
...
// Filter criteria for the resources to return. A URI with a $filter query option identifies a subset of the entries from the Collection of Entries. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the $filter option. The expression language that is used in $filter queries supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false).
func (r ApiGetCommTagDefinitionListRequest) Filter(filter string) ApiGetCommTagDefinitionListRequest {
	r.filter = &filter
	return r
}

// Determines what properties are used to sort the collection of resources.
func (r ApiGetCommTagDefinitionListRequest) Orderby(orderby string) ApiGetCommTagDefinitionListRequest {
	r.orderby = &orderby
	return r
}

// Specifies the maximum number of resources to return in the response.
func (r ApiGetCommTagDefinitionListRequest) Top(top int32) ApiGetCommTagDefinitionListRequest {
	r.top = &top
	return r
}

// Specifies the number of resources to skip in the response.
func (r ApiGetCommTagDefinitionListRequest) Skip(skip int32) ApiGetCommTagDefinitionListRequest {
	r.skip = &skip
	return r
}

// Specifies a subset of properties to return.
func (r ApiGetCommTagDefinitionListRequest) Select_(select_ string) ApiGetCommTagDefinitionListRequest {
	r.select_ = &select_
	return r
}

// Specify additional attributes or related resources to return in addition to the primary resources.
func (r ApiGetCommTagDefinitionListRequest) Expand(expand string) ApiGetCommTagDefinitionListRequest {
	r.expand = &expand
	return r
}

// Specify one or more transformation operations to perform aggregation on the resources. The transformations are processed in order with the output from a transformation being used as input for the subsequent transformation. The \&quot;$apply\&quot; query takes a sequence of set transformations, separated by forward slashes to express that they are consecutively applied, i.e., the result of each transformation is the input to the next transformation. Supported aggregation methods are \&quot;aggregate\&quot; and \&quot;groupby\&quot;. The **aggregate** transformation takes a comma-separated list of one or more aggregate expressions as parameters and returns a result set with a single instance, representing the aggregated value for all instances in the input set. The **groupby** transformation takes one or two parameters and 1. Splits the initial set into subsets where all instances in a subset have the same values for the grouping properties specified in the first parameter, 2. Applies set transformations to each subset according to the second parameter, resulting in a new set of potentially different structure and cardinality, 3. Ensures that the instances in the result set contain all grouping properties with the correct values for the group, 4. Concatenates the intermediate result sets into one result set. A groupby transformation affects the structure of the result set.
func (r ApiGetCommTagDefinitionListRequest) Apply(apply string) ApiGetCommTagDefinitionListRequest {
	r.apply = &apply
	return r
}

// The $count query specifies the service should return the count of the matching resources, instead of returning the resources.
func (r ApiGetCommTagDefinitionListRequest) Count(count bool) ApiGetCommTagDefinitionListRequest {
	r.count = &count
	return r
}

// The $inlinecount query option allows clients to request an inline count of the matching resources included with the resources in the response.
func (r ApiGetCommTagDefinitionListRequest) Inlinecount(inlinecount string) ApiGetCommTagDefinitionListRequest {
	r.inlinecount = &inlinecount
	return r
}

// Similar to \&quot;$filter\&quot;, but \&quot;at\&quot; is specifically used to filter versioning information properties for resources to return. A URI with an \&quot;at\&quot; Query Option identifies a subset of the Entries from the Collection of Entries identified by the Resource Path section of the URI. The subset is determined by selecting only the Entries that satisfy the predicate expression specified by the query option. The expression language that is used in at operators supports references to properties and literals. The literal values can be strings enclosed in single quotes, numbers and boolean values (true or false) or any of the additional literal representations shown in the Abstract Type System section.
func (r ApiGetCommTagDefinitionListRequest) At(at string) ApiGetCommTagDefinitionListRequest {
	r.at = &at
	return r
}

// The &#39;tags&#39; parameter is used to request a summary of the Tag utilization for this resource. When the &#39;tags&#39; parameter is specified, the response provides a list of tag keys, the number of times the key has been used across all documents, and the tag values that have been assigned to the tag key.
func (r ApiGetCommTagDefinitionListRequest) Tags(tags string) ApiGetCommTagDefinitionListRequest {
	r.tags = &tags
	return r
}

func (r ApiGetCommTagDefinitionListRequest) Execute() (*CommTagDefinitionResponse, *http.Response, error) {
	return r.ApiService.GetCommTagDefinitionListExecute(r)
}

/*
GetCommTagDefinitionList Read a 'comm.TagDefinition' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetCommTagDefinitionListRequest
*/
func (a *CommApiService) GetCommTagDefinitionList(ctx context.Context) ApiGetCommTagDefinitionListRequest {
	return ApiGetCommTagDefinitionListRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CommApiService) GetCommTagDefinitionListExecute(r ApiGetCommTagDefinitionListRequest) (*CommTagDefinitionResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *CommTagDefinitionResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommApiService.GetCommTagDefinitionList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPatchCommTagDefinitionRequest struct {
	ctx               context.Context
	ApiService        *CommApiService
	moid              string
	commTagDefinition *CommTagDefinition
...
// The &#39;comm.TagDefinition&#39; resource to update.
func (r ApiPatchCommTagDefinitionRequest) CommTagDefinition(commTagDefinition CommTagDefinition) ApiPatchCommTagDefinitionRequest {
	r.commTagDefinition = &commTagDefinition
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiPatchCommTagDefinitionRequest) IfMatch(ifMatch string) ApiPatchCommTagDefinitionRequest {
	r.ifMatch = &ifMatch
	return r
}

func (r ApiPatchCommTagDefinitionRequest) Execute() (*CommTagDefinition, *http.Response, error) {
	return r.ApiService.PatchCommTagDefinitionExecute(r)
}

/*
PatchCommTagDefinition Update a 'comm.TagDefinition' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiPatchCommTagDefinitionRequest
*/
func (a *CommApiService) PatchCommTagDefinition(ctx context.Context, moid string) ApiPatchCommTagDefinitionRequest {
	return ApiPatchCommTagDefinitionRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return CommTagDefinition
func (a *CommApiService) PatchCommTagDefinitionExecute(r ApiPatchCommTagDefinitionRequest) (*CommTagDefinition, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommApiService.PatchCommTagDefinition")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateCommTagDefinitionRequest struct {
	ctx               context.Context
	ApiService        *CommApiService
	moid              string
	commTagDefinition *CommTagDefinition
...
// The &#39;comm.TagDefinition&#39; resource to update.
func (r ApiUpdateCommTagDefinitionRequest) CommTagDefinition(commTagDefinition CommTagDefinition) ApiUpdateCommTagDefinitionRequest {
	r.commTagDefinition = &commTagDefinition
	return r
}

// For methods that apply server-side changes, and in particular for PUT, If-Match can be used to prevent the lost update problem. It can check if the modification of a resource that the user wants to upload will not override another change that has been done since the original resource was fetched. If the request cannot be fulfilled, the 412 (Precondition Failed) response is returned. When modifying a resource using POST or PUT, the If-Match header must be set to the value of the resource ModTime property after which no lost update problem should occur. For example, a client send a GET request to obtain a resource, which includes the ModTime property. The ModTime indicates the last time the resource was created or modified. The client then sends a POST or PUT request with the If-Match header set to the ModTime property of the resource as obtained in the GET request.
func (r ApiUpdateCommTagDefinitionRequest) IfMatch(ifMatch string) ApiUpdateCommTagDefinitionRequest {
	r.ifMatch = &ifMatch
	return r
}

func (r ApiUpdateCommTagDefinitionRequest) Execute() (*CommTagDefinition, *http.Response, error) {
	return r.ApiService.UpdateCommTagDefinitionExecute(r)
}

/*
UpdateCommTagDefinition Update a 'comm.TagDefinition' resource.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param moid The unique Moid identifier of a resource instance.
	@return ApiUpdateCommTagDefinitionRequest
*/
func (a *CommApiService) UpdateCommTagDefinition(ctx context.Context, moid string) ApiUpdateCommTagDefinitionRequest {
	return ApiUpdateCommTagDefinitionRequest{
		ApiService: a,
		ctx:        ctx,
		moid:       moid,
...
//
//	@return CommTagDefinition
func (a *CommApiService) UpdateCommTagDefinitionExecute(r ApiUpdateCommTagDefinitionRequest) (*CommTagDefinition, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommApiService.UpdateCommTagDefinition")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
