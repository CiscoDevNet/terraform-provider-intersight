...
// StorageNetAppVolumeEventAllOf Definition of the list of properties defined in 'storage.NetAppVolumeEvent', excluding properties defined in parent classes.
type StorageNetAppVolumeEventAllOf struct {
...
type _StorageNetAppVolumeEventAllOf StorageNetAppVolumeEventAllOf
...
func NewStorageNetAppVolumeEventAllOf(classId string, objectType string) *StorageNetAppVolumeEventAllOf {
	this := StorageNetAppVolumeEventAllOf{}
...
func (o StorageNetAppVolumeEventAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppVolumeEventAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppVolumeEventAllOf := _StorageNetAppVolumeEventAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppVolumeEventAllOf); err == nil {
		*o = StorageNetAppVolumeEventAllOf(varStorageNetAppVolumeEventAllOf)
	}
...
type NullableStorageNetAppVolumeEventAllOf struct {
	value *StorageNetAppVolumeEventAllOf
	isSet bool
}

func (v NullableStorageNetAppVolumeEventAllOf) Get() *StorageNetAppVolumeEventAllOf {
	return v.value
}

func (v *NullableStorageNetAppVolumeEventAllOf) Set(val *StorageNetAppVolumeEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppVolumeEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppVolumeEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppVolumeEventAllOf(val *StorageNetAppVolumeEventAllOf) *NullableStorageNetAppVolumeEventAllOf {
	return &NullableStorageNetAppVolumeEventAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppVolumeEventAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppVolumeEventAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
