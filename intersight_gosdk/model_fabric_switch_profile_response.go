...
func (dst *FabricSwitchProfileResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "fabric.SwitchProfile.List" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricSwitchProfileResponse as FabricSwitchProfileList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricSwitchProfileResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricSwitchProfileResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FabricSwitchProfileResponse as MoTagSummary: %s", err.Error())
		}
	}
