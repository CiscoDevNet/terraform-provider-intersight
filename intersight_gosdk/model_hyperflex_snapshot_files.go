...
// checks if the HyperflexSnapshotFiles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexSnapshotFiles{}
...
// GetDefaultClassId returns the default value "hyperflex.SnapshotFiles" of the ClassId field.
func (o *HyperflexSnapshotFiles) GetDefaultClassId() interface{} {
	return "hyperflex.SnapshotFiles"
}
...
// GetDefaultObjectType returns the default value "hyperflex.SnapshotFiles" of the ObjectType field.
func (o *HyperflexSnapshotFiles) GetDefaultObjectType() interface{} {
	return "hyperflex.SnapshotFiles"
}
...
func (o *HyperflexSnapshotFiles) GetNameTrackedFilesOk() ([]HyperflexFilePath, bool) {
	if o == nil || IsNil(o.NameTrackedFiles) {
		return nil, false
	}
...
func (o *HyperflexSnapshotFiles) GetUuidTrackedDisksMapOk() ([]HyperflexMapUuidToTrackedDisk, bool) {
	if o == nil || IsNil(o.UuidTrackedDisksMap) {
		return nil, false
	}
...
func (o HyperflexSnapshotFiles) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexSnapshotFiles) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexSnapshotFilesWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexSnapshotFiles)
	if err == nil {
