...
// PortSubGroupListAllOf struct for PortSubGroupListAllOf
type PortSubGroupListAllOf struct {
...
type _PortSubGroupListAllOf PortSubGroupListAllOf
...
// SetResults gets a reference to the given []PortSubGroup and assigns it to the Results field.
func (o *PortSubGroupListAllOf) SetResults(v []PortSubGroup) {
	o.Results = v
}

func (o PortSubGroupListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *PortSubGroupListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varPortSubGroupListAllOf := _PortSubGroupListAllOf{}

	if err = json.Unmarshal(bytes, &varPortSubGroupListAllOf); err == nil {
		*o = PortSubGroupListAllOf(varPortSubGroupListAllOf)
	}
...
type NullablePortSubGroupListAllOf struct {
	value *PortSubGroupListAllOf
	isSet bool
}

func (v NullablePortSubGroupListAllOf) Get() *PortSubGroupListAllOf {
	return v.value
}

func (v *NullablePortSubGroupListAllOf) Set(val *PortSubGroupListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePortSubGroupListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePortSubGroupListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortSubGroupListAllOf(val *PortSubGroupListAllOf) *NullablePortSubGroupListAllOf {
	return &NullablePortSubGroupListAllOf{value: val, isSet: true}
}

func (v NullablePortSubGroupListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortSubGroupListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
