...
// VirtualizationBaseVirtualMachineSnapshotAllOf Definition of the list of properties defined in 'virtualization.BaseVirtualMachineSnapshot', excluding properties defined in parent classes.
type VirtualizationBaseVirtualMachineSnapshotAllOf struct {
...
type _VirtualizationBaseVirtualMachineSnapshotAllOf VirtualizationBaseVirtualMachineSnapshotAllOf
...
func NewVirtualizationBaseVirtualMachineSnapshotAllOf(classId string, objectType string) *VirtualizationBaseVirtualMachineSnapshotAllOf {
	this := VirtualizationBaseVirtualMachineSnapshotAllOf{}
...
func (o VirtualizationBaseVirtualMachineSnapshotAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationBaseVirtualMachineSnapshotAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationBaseVirtualMachineSnapshotAllOf := _VirtualizationBaseVirtualMachineSnapshotAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationBaseVirtualMachineSnapshotAllOf); err == nil {
		*o = VirtualizationBaseVirtualMachineSnapshotAllOf(varVirtualizationBaseVirtualMachineSnapshotAllOf)
	}
...
type NullableVirtualizationBaseVirtualMachineSnapshotAllOf struct {
	value *VirtualizationBaseVirtualMachineSnapshotAllOf
	isSet bool
}

func (v NullableVirtualizationBaseVirtualMachineSnapshotAllOf) Get() *VirtualizationBaseVirtualMachineSnapshotAllOf {
	return v.value
}

func (v *NullableVirtualizationBaseVirtualMachineSnapshotAllOf) Set(val *VirtualizationBaseVirtualMachineSnapshotAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationBaseVirtualMachineSnapshotAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationBaseVirtualMachineSnapshotAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationBaseVirtualMachineSnapshotAllOf(val *VirtualizationBaseVirtualMachineSnapshotAllOf) *NullableVirtualizationBaseVirtualMachineSnapshotAllOf {
	return &NullableVirtualizationBaseVirtualMachineSnapshotAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationBaseVirtualMachineSnapshotAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationBaseVirtualMachineSnapshotAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
