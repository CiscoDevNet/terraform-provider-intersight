...
// checks if the AdapterPhysicalNicModeSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdapterPhysicalNicModeSettings{}
...
// GetDefaultClassId returns the default value "adapter.PhysicalNicModeSettings" of the ClassId field.
func (o *AdapterPhysicalNicModeSettings) GetDefaultClassId() interface{} {
	return "adapter.PhysicalNicModeSettings"
}
...
// GetDefaultObjectType returns the default value "adapter.PhysicalNicModeSettings" of the ObjectType field.
func (o *AdapterPhysicalNicModeSettings) GetDefaultObjectType() interface{} {
	return "adapter.PhysicalNicModeSettings"
}
...
func (o *AdapterPhysicalNicModeSettings) GetPhyNicEnabled() bool {
	if o == nil || IsNil(o.PhyNicEnabled) {
		var ret bool
		return ret
	}
...
func (o AdapterPhysicalNicModeSettings) ToMap() (map[string]interface{}, error) {
...
func (o *AdapterPhysicalNicModeSettings) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAdapterPhysicalNicModeSettingsWithoutEmbeddedStruct)
	if err == nil {
		...
		varAdapterPhysicalNicModeSettings.PhyNicEnabled = varAdapterPhysicalNicModeSettingsWithoutEmbeddedStruct.PhyNicEnabled
	...
	err = json.Unmarshal(data, &varAdapterPhysicalNicModeSettings)
	if err == nil {
