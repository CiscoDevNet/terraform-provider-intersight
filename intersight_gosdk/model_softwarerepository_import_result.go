...
// checks if the SoftwarerepositoryImportResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwarerepositoryImportResult{}
...
// GetDefaultClassId returns the default value "softwarerepository.ImportResult" of the ClassId field.
func (o *SoftwarerepositoryImportResult) GetDefaultClassId() interface{} {
	return "softwarerepository.ImportResult"
}
...
// GetDefaultObjectType returns the default value "softwarerepository.ImportResult" of the ObjectType field.
func (o *SoftwarerepositoryImportResult) GetDefaultObjectType() interface{} {
	return "softwarerepository.ImportResult"
}
...
func (o SoftwarerepositoryImportResult) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwarerepositoryImportResult) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSoftwarerepositoryImportResultWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSoftwarerepositoryImportResult)
	if err == nil {
