...
// CloudAwsNetworkInterfaceListAllOf struct for CloudAwsNetworkInterfaceListAllOf
type CloudAwsNetworkInterfaceListAllOf struct {
...
type _CloudAwsNetworkInterfaceListAllOf CloudAwsNetworkInterfaceListAllOf
...
func NewCloudAwsNetworkInterfaceListAllOf() *CloudAwsNetworkInterfaceListAllOf {
	this := CloudAwsNetworkInterfaceListAllOf{}
	return &this
}
...
func (o CloudAwsNetworkInterfaceListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CloudAwsNetworkInterfaceListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCloudAwsNetworkInterfaceListAllOf := _CloudAwsNetworkInterfaceListAllOf{}

	if err = json.Unmarshal(bytes, &varCloudAwsNetworkInterfaceListAllOf); err == nil {
		*o = CloudAwsNetworkInterfaceListAllOf(varCloudAwsNetworkInterfaceListAllOf)
	}
...
type NullableCloudAwsNetworkInterfaceListAllOf struct {
	value *CloudAwsNetworkInterfaceListAllOf
	isSet bool
}

func (v NullableCloudAwsNetworkInterfaceListAllOf) Get() *CloudAwsNetworkInterfaceListAllOf {
	return v.value
}

func (v *NullableCloudAwsNetworkInterfaceListAllOf) Set(val *CloudAwsNetworkInterfaceListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudAwsNetworkInterfaceListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudAwsNetworkInterfaceListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudAwsNetworkInterfaceListAllOf(val *CloudAwsNetworkInterfaceListAllOf) *NullableCloudAwsNetworkInterfaceListAllOf {
	return &NullableCloudAwsNetworkInterfaceListAllOf{value: val, isSet: true}
}

func (v NullableCloudAwsNetworkInterfaceListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudAwsNetworkInterfaceListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
