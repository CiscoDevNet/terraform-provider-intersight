...
func KubernetesVirtualMachineInfrastructureProviderListAsKubernetesVirtualMachineInfrastructureProviderResponse(v *KubernetesVirtualMachineInfrastructureProviderList) KubernetesVirtualMachineInfrastructureProviderResponse {
	return KubernetesVirtualMachineInfrastructureProviderResponse{
		KubernetesVirtualMachineInfrastructureProviderList: v,
	}
}
...
func (dst *KubernetesVirtualMachineInfrastructureProviderResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "kubernetes.VirtualMachineInfrastructureProvider.List" {
		// try to unmarshal JSON data into KubernetesVirtualMachineInfrastructureProviderList
		err = json.Unmarshal(data, &dst.KubernetesVirtualMachineInfrastructureProviderList)
		if err == nil {
			return nil // data stored in dst.KubernetesVirtualMachineInfrastructureProviderList, return on the first match
		} else {
			dst.KubernetesVirtualMachineInfrastructureProviderList = nil
			return fmt.Errorf("Failed to unmarshal KubernetesVirtualMachineInfrastructureProviderResponse as KubernetesVirtualMachineInfrastructureProviderList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal KubernetesVirtualMachineInfrastructureProviderResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal KubernetesVirtualMachineInfrastructureProviderResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal KubernetesVirtualMachineInfrastructureProviderResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src KubernetesVirtualMachineInfrastructureProviderResponse) MarshalJSON() ([]byte, error) {
	if src.KubernetesVirtualMachineInfrastructureProviderList != nil {
		return json.Marshal(&src.KubernetesVirtualMachineInfrastructureProviderList)
	}
...
type NullableKubernetesVirtualMachineInfrastructureProviderResponse struct {
	value *KubernetesVirtualMachineInfrastructureProviderResponse
	isSet bool
}

func (v NullableKubernetesVirtualMachineInfrastructureProviderResponse) Get() *KubernetesVirtualMachineInfrastructureProviderResponse {
	return v.value
}

func (v *NullableKubernetesVirtualMachineInfrastructureProviderResponse) Set(val *KubernetesVirtualMachineInfrastructureProviderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesVirtualMachineInfrastructureProviderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesVirtualMachineInfrastructureProviderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesVirtualMachineInfrastructureProviderResponse(val *KubernetesVirtualMachineInfrastructureProviderResponse) *NullableKubernetesVirtualMachineInfrastructureProviderResponse {
	return &NullableKubernetesVirtualMachineInfrastructureProviderResponse{value: val, isSet: true}
}

func (v NullableKubernetesVirtualMachineInfrastructureProviderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesVirtualMachineInfrastructureProviderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
