...
// checks if the VnicServiceEthIf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicServiceEthIf{}

// VnicServiceEthIf Service Virtual Ethernet Interface is created  on each adapter to export netflow records to the collector via the Fabric Interconnect.
type VnicServiceEthIf struct {
	MoBaseMo
...
type _VnicServiceEthIf VnicServiceEthIf
...
func NewVnicServiceEthIfWithDefaults() *VnicServiceEthIf {
	this := VnicServiceEthIf{}
	var classId string = "vnic.ServiceEthIf"
	this.ClassId = classId
	var objectType string = "vnic.ServiceEthIf"
	this.ObjectType = objectType
	return &this
}
...
// GetDefaultClassId returns the default value "vnic.ServiceEthIf" of the ClassId field.
func (o *VnicServiceEthIf) GetDefaultClassId() interface{} {
	return "vnic.ServiceEthIf"
}
...
// GetDefaultObjectType returns the default value "vnic.ServiceEthIf" of the ObjectType field.
func (o *VnicServiceEthIf) GetDefaultObjectType() interface{} {
	return "vnic.ServiceEthIf"
}
...
func (o *VnicServiceEthIf) SetPlacementNil() {
	o.Placement.Set(nil)
}
...
func (o *VnicServiceEthIf) SetProfileNil() {
	o.Profile.Set(nil)
}
...
func (o VnicServiceEthIf) MarshalJSON() ([]byte, error) {
...
func (o VnicServiceEthIf) ToMap() (map[string]interface{}, error) {
...
func (o *VnicServiceEthIf) UnmarshalJSON(data []byte) (err error) {
	...
	type VnicServiceEthIfWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varVnicServiceEthIfWithoutEmbeddedStruct := VnicServiceEthIfWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varVnicServiceEthIfWithoutEmbeddedStruct)
	if err == nil {
		varVnicServiceEthIf := _VnicServiceEthIf{}
		varVnicServiceEthIf.ClassId = varVnicServiceEthIfWithoutEmbeddedStruct.ClassId
		varVnicServiceEthIf.ObjectType = varVnicServiceEthIfWithoutEmbeddedStruct.ObjectType
		varVnicServiceEthIf.AdapterId = varVnicServiceEthIfWithoutEmbeddedStruct.AdapterId
		varVnicServiceEthIf.Name = varVnicServiceEthIfWithoutEmbeddedStruct.Name
		varVnicServiceEthIf.OverriddenList = varVnicServiceEthIfWithoutEmbeddedStruct.OverriddenList
		varVnicServiceEthIf.Placement = varVnicServiceEthIfWithoutEmbeddedStruct.Placement
		varVnicServiceEthIf.TemplateActions = varVnicServiceEthIfWithoutEmbeddedStruct.TemplateActions
		varVnicServiceEthIf.TemplateSyncErrors = varVnicServiceEthIfWithoutEmbeddedStruct.TemplateSyncErrors
		varVnicServiceEthIf.TemplateSyncStatus = varVnicServiceEthIfWithoutEmbeddedStruct.TemplateSyncStatus
		varVnicServiceEthIf.VifId = varVnicServiceEthIfWithoutEmbeddedStruct.VifId
		varVnicServiceEthIf.Profile = varVnicServiceEthIfWithoutEmbeddedStruct.Profile
		*o = VnicServiceEthIf(varVnicServiceEthIf)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varVnicServiceEthIf)
	if err == nil {
		o.MoBaseMo = varVnicServiceEthIf.MoBaseMo
	} else {
		return err
	}
...
type NullableVnicServiceEthIf struct {
	value *VnicServiceEthIf
	isSet bool
}

func (v NullableVnicServiceEthIf) Get() *VnicServiceEthIf {
	return v.value
}

func (v *NullableVnicServiceEthIf) Set(val *VnicServiceEthIf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicServiceEthIf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicServiceEthIf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicServiceEthIf(val *VnicServiceEthIf) *NullableVnicServiceEthIf {
	return &NullableVnicServiceEthIf{value: val, isSet: true}
}

func (v NullableVnicServiceEthIf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicServiceEthIf) UnmarshalJSON(src []byte) error {
	v.isSet = true
