...
type FirmwareChassisUpgradeImpact struct {
	...
	ImpactServersDetail []FirmwareServerImpact    `json:"ImpactServersDetail,omitempty"`
...
// GetImpactServersDetail returns the ImpactServersDetail field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FirmwareChassisUpgradeImpact) GetImpactServersDetail() []FirmwareServerImpact {
	if o == nil {
		var ret []FirmwareServerImpact
		return ret
	}
	return o.ImpactServersDetail
}

// GetImpactServersDetailOk returns a tuple with the ImpactServersDetail field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *FirmwareChassisUpgradeImpact) GetImpactServersDetailOk() ([]FirmwareServerImpact, bool) {
	if o == nil || IsNil(o.ImpactServersDetail) {
		return nil, false
	}
	return o.ImpactServersDetail, true
}
...
// SetImpactServersDetail gets a reference to the given []FirmwareServerImpact and assigns it to the ImpactServersDetail field.
func (o *FirmwareChassisUpgradeImpact) SetImpactServersDetail(v []FirmwareServerImpact) {
	o.ImpactServersDetail = v
}
...
func (o FirmwareChassisUpgradeImpact) ToMap() (map[string]interface{}, error) {
	...
	if o.ImpactServersDetail != nil {
		toSerialize["ImpactServersDetail"] = o.ImpactServersDetail
	}
	if !IsNil(o.Name) {
...
func (o *FirmwareChassisUpgradeImpact) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFirmwareChassisUpgradeImpact.ImpactServersDetail = varFirmwareChassisUpgradeImpactWithoutEmbeddedStruct.ImpactServersDetail
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ImpactServersDetail")
