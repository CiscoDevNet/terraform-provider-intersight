...
// StorageControllerDriveAllOf Definition of the list of properties defined in 'storage.ControllerDrive', excluding properties defined in parent classes.
type StorageControllerDriveAllOf struct {
...
type _StorageControllerDriveAllOf StorageControllerDriveAllOf
...
func NewStorageControllerDriveAllOf(classId string, objectType string) *StorageControllerDriveAllOf {
	this := StorageControllerDriveAllOf{}
...
func (o StorageControllerDriveAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageControllerDriveAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageControllerDriveAllOf := _StorageControllerDriveAllOf{}

	if err = json.Unmarshal(bytes, &varStorageControllerDriveAllOf); err == nil {
		*o = StorageControllerDriveAllOf(varStorageControllerDriveAllOf)
	}
...
type NullableStorageControllerDriveAllOf struct {
	value *StorageControllerDriveAllOf
	isSet bool
}

func (v NullableStorageControllerDriveAllOf) Get() *StorageControllerDriveAllOf {
	return v.value
}

func (v *NullableStorageControllerDriveAllOf) Set(val *StorageControllerDriveAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageControllerDriveAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageControllerDriveAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageControllerDriveAllOf(val *StorageControllerDriveAllOf) *NullableStorageControllerDriveAllOf {
	return &NullableStorageControllerDriveAllOf{value: val, isSet: true}
}

func (v NullableStorageControllerDriveAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageControllerDriveAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
