...
func (o *WorkflowSolutionOutput) GetUpgradedMoid() string {
...
// and a boolean to check if the value has been set.
func (o *WorkflowSolutionOutput) GetUpgradedMoidOk() (*string, bool) {
	if o == nil || o.UpgradedMoid == nil {
		return nil, false
	}
...
func (o *WorkflowSolutionOutput) HasUpgradedMoid() bool {
	if o != nil && o.UpgradedMoid != nil {
		return true
	}
...
func (o *WorkflowSolutionOutput) SetUpgradedMoid(v string) {
	o.UpgradedMoid = &v
}
...
func (o *WorkflowSolutionOutput) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varWorkflowSolutionOutput.UpgradedMoid = varWorkflowSolutionOutputWithoutEmbeddedStruct.UpgradedMoid
