...
// checks if the EtherNetworkPortList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EtherNetworkPortList{}
...
func (o EtherNetworkPortList) ToMap() (map[string]interface{}, error) {
...
func (o *EtherNetworkPortList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEtherNetworkPortListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varEtherNetworkPortList)
	if err == nil {
