...
type ResourcepoolLeaseResourceAllOf struct {
	...
	Var0Lease            *ResourcepoolLeaseRelationship `json:"_0_Lease,omitempty"`
...
// GetVar0Lease returns the Var0Lease field value if set, zero value otherwise.
func (o *ResourcepoolLeaseResourceAllOf) GetVar0Lease() ResourcepoolLeaseRelationship {
	if o == nil || o.Var0Lease == nil {
...
// GetVar0LeaseOk returns a tuple with the Var0Lease field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResourcepoolLeaseResourceAllOf) GetVar0LeaseOk() (*ResourcepoolLeaseRelationship, bool) {
	if o == nil || o.Var0Lease == nil {
		return nil, false
	}
	return o.Var0Lease, true
}
...
// SetVar0Lease gets a reference to the given ResourcepoolLeaseRelationship and assigns it to the Var0Lease field.
...
func (o ResourcepoolLeaseResourceAllOf) MarshalJSON() ([]byte, error) {
	...
	if o.Var0Lease != nil {
		toSerialize["_0_Lease"] = o.Var0Lease
	}
	if o.Resource != nil {
...
func (o *ResourcepoolLeaseResourceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_0_Lease")
