...
// IaasLicenseInfoListAllOf struct for IaasLicenseInfoListAllOf
type IaasLicenseInfoListAllOf struct {
...
type _IaasLicenseInfoListAllOf IaasLicenseInfoListAllOf
...
func (o IaasLicenseInfoListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IaasLicenseInfoListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIaasLicenseInfoListAllOf := _IaasLicenseInfoListAllOf{}

	if err = json.Unmarshal(bytes, &varIaasLicenseInfoListAllOf); err == nil {
		*o = IaasLicenseInfoListAllOf(varIaasLicenseInfoListAllOf)
	}
...
type NullableIaasLicenseInfoListAllOf struct {
	value *IaasLicenseInfoListAllOf
	isSet bool
}

func (v NullableIaasLicenseInfoListAllOf) Get() *IaasLicenseInfoListAllOf {
	return v.value
}

func (v *NullableIaasLicenseInfoListAllOf) Set(val *IaasLicenseInfoListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIaasLicenseInfoListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIaasLicenseInfoListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIaasLicenseInfoListAllOf(val *IaasLicenseInfoListAllOf) *NullableIaasLicenseInfoListAllOf {
	return &NullableIaasLicenseInfoListAllOf{value: val, isSet: true}
}

func (v NullableIaasLicenseInfoListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIaasLicenseInfoListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
