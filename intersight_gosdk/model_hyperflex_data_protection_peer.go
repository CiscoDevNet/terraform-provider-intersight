...
// checks if the HyperflexDataProtectionPeer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexDataProtectionPeer{}

// HyperflexDataProtectionPeer The DataProtectionPeer object describes the cluster pair from the HyperFlex backend, emphasizing data protection relationships. #### Purpose DataProtectionPeer focuses on the relationships between cluster pairs, providing essential information for managing data protection across HyperFlex environments. #### Key Concepts - **Peer Relationships:** Defines the connections between clusters, ensuring coherent data protection strategies. - **Status Tracking:** Offers insights into the status and health of peer clusters, supporting informed decision-making. - **Controlled Access:** Manages access through privilege sets, maintaining security and data integrity in peer operations.
...
// GetDefaultClassId returns the default value "hyperflex.DataProtectionPeer" of the ClassId field.
func (o *HyperflexDataProtectionPeer) GetDefaultClassId() interface{} {
	return "hyperflex.DataProtectionPeer"
}
...
// GetDefaultObjectType returns the default value "hyperflex.DataProtectionPeer" of the ObjectType field.
func (o *HyperflexDataProtectionPeer) GetDefaultObjectType() interface{} {
	return "hyperflex.DataProtectionPeer"
}
...
func (o HyperflexDataProtectionPeer) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexDataProtectionPeer) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexDataProtectionPeerWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexDataProtectionPeer)
	if err == nil {
