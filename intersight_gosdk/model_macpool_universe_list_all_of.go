...
// MacpoolUniverseListAllOf struct for MacpoolUniverseListAllOf
type MacpoolUniverseListAllOf struct {
...
type _MacpoolUniverseListAllOf MacpoolUniverseListAllOf
...
func (o MacpoolUniverseListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *MacpoolUniverseListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMacpoolUniverseListAllOf := _MacpoolUniverseListAllOf{}

	if err = json.Unmarshal(bytes, &varMacpoolUniverseListAllOf); err == nil {
		*o = MacpoolUniverseListAllOf(varMacpoolUniverseListAllOf)
	}
...
type NullableMacpoolUniverseListAllOf struct {
	value *MacpoolUniverseListAllOf
	isSet bool
}

func (v NullableMacpoolUniverseListAllOf) Get() *MacpoolUniverseListAllOf {
	return v.value
}

func (v *NullableMacpoolUniverseListAllOf) Set(val *MacpoolUniverseListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableMacpoolUniverseListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableMacpoolUniverseListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMacpoolUniverseListAllOf(val *MacpoolUniverseListAllOf) *NullableMacpoolUniverseListAllOf {
	return &NullableMacpoolUniverseListAllOf{value: val, isSet: true}
}

func (v NullableMacpoolUniverseListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMacpoolUniverseListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
