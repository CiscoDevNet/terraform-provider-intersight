...
// checks if the VnicVifStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicVifStatus{}
...
// GetDefaultClassId returns the default value "vnic.VifStatus" of the ClassId field.
func (o *VnicVifStatus) GetDefaultClassId() interface{} {
	return "vnic.VifStatus"
}
...
// GetDefaultObjectType returns the default value "vnic.VifStatus" of the ObjectType field.
func (o *VnicVifStatus) GetDefaultObjectType() interface{} {
	return "vnic.VifStatus"
}
...
func (o VnicVifStatus) ToMap() (map[string]interface{}, error) {
...
func (o *VnicVifStatus) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicVifStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVnicVifStatus)
	if err == nil {
