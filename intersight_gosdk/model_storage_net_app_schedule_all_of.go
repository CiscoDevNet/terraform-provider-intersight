...
// StorageNetAppScheduleAllOf Definition of the list of properties defined in 'storage.NetAppSchedule', excluding properties defined in parent classes.
type StorageNetAppScheduleAllOf struct {
...
type _StorageNetAppScheduleAllOf StorageNetAppScheduleAllOf
...
func NewStorageNetAppScheduleAllOf(classId string, objectType string) *StorageNetAppScheduleAllOf {
	this := StorageNetAppScheduleAllOf{}
...
func (o *StorageNetAppScheduleAllOf) GetType() string {
	if o == nil || o.Type == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *StorageNetAppScheduleAllOf) GetTypeOk() (*string, bool) {
	if o == nil || o.Type == nil {
		return nil, false
	}
	return o.Type, true
...
func (o *StorageNetAppScheduleAllOf) HasType() bool {
	if o != nil && o.Type != nil {
		return true
	}
...
func (o *StorageNetAppScheduleAllOf) SetType(v string) {
	o.Type = &v
}
...
func (o StorageNetAppScheduleAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppScheduleAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppScheduleAllOf := _StorageNetAppScheduleAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppScheduleAllOf); err == nil {
		*o = StorageNetAppScheduleAllOf(varStorageNetAppScheduleAllOf)
	}
...
type NullableStorageNetAppScheduleAllOf struct {
	value *StorageNetAppScheduleAllOf
	isSet bool
}

func (v NullableStorageNetAppScheduleAllOf) Get() *StorageNetAppScheduleAllOf {
	return v.value
}

func (v *NullableStorageNetAppScheduleAllOf) Set(val *StorageNetAppScheduleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppScheduleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppScheduleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppScheduleAllOf(val *StorageNetAppScheduleAllOf) *NullableStorageNetAppScheduleAllOf {
	return &NullableStorageNetAppScheduleAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppScheduleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppScheduleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
