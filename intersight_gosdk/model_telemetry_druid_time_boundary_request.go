...
// checks if the TelemetryDruidTimeBoundaryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidTimeBoundaryRequest{}
...
func (o TelemetryDruidTimeBoundaryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidTimeBoundaryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidTimeBoundaryRequest)
