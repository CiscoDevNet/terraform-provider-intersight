...
// NiaapiUpgradeAssistFileAllOf Definition of the list of properties defined in 'niaapi.UpgradeAssistFile', excluding properties defined in parent classes.
type NiaapiUpgradeAssistFileAllOf struct {
...
type _NiaapiUpgradeAssistFileAllOf NiaapiUpgradeAssistFileAllOf
...
func NewNiaapiUpgradeAssistFileAllOf(classId string, objectType string) *NiaapiUpgradeAssistFileAllOf {
	this := NiaapiUpgradeAssistFileAllOf{}
...
func (o NiaapiUpgradeAssistFileAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiaapiUpgradeAssistFileAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiaapiUpgradeAssistFileAllOf := _NiaapiUpgradeAssistFileAllOf{}

	if err = json.Unmarshal(bytes, &varNiaapiUpgradeAssistFileAllOf); err == nil {
		*o = NiaapiUpgradeAssistFileAllOf(varNiaapiUpgradeAssistFileAllOf)
	}
...
type NullableNiaapiUpgradeAssistFileAllOf struct {
	value *NiaapiUpgradeAssistFileAllOf
	isSet bool
}

func (v NullableNiaapiUpgradeAssistFileAllOf) Get() *NiaapiUpgradeAssistFileAllOf {
	return v.value
}

func (v *NullableNiaapiUpgradeAssistFileAllOf) Set(val *NiaapiUpgradeAssistFileAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiaapiUpgradeAssistFileAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiaapiUpgradeAssistFileAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiaapiUpgradeAssistFileAllOf(val *NiaapiUpgradeAssistFileAllOf) *NullableNiaapiUpgradeAssistFileAllOf {
	return &NullableNiaapiUpgradeAssistFileAllOf{value: val, isSet: true}
}

func (v NullableNiaapiUpgradeAssistFileAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiaapiUpgradeAssistFileAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
