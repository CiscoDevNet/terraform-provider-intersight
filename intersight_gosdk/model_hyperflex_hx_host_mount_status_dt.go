...
// checks if the HyperflexHxHostMountStatusDt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexHxHostMountStatusDt{}

// HyperflexHxHostMountStatusDt Host mount status for the HyperFlex datastore.
...
// GetDefaultClassId returns the default value "hyperflex.HxHostMountStatusDt" of the ClassId field.
func (o *HyperflexHxHostMountStatusDt) GetDefaultClassId() interface{} {
	return "hyperflex.HxHostMountStatusDt"
}
...
// GetDefaultObjectType returns the default value "hyperflex.HxHostMountStatusDt" of the ObjectType field.
func (o *HyperflexHxHostMountStatusDt) GetDefaultObjectType() interface{} {
	return "hyperflex.HxHostMountStatusDt"
}
...
func (o HyperflexHxHostMountStatusDt) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexHxHostMountStatusDt) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexHxHostMountStatusDtWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexHxHostMountStatusDt)
	if err == nil {
