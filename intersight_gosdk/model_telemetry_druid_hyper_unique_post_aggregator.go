...
// checks if the TelemetryDruidHyperUniquePostAggregator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidHyperUniquePostAggregator{}
...
func (o TelemetryDruidHyperUniquePostAggregator) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidHyperUniquePostAggregator) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidHyperUniquePostAggregator)
