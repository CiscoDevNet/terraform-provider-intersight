...
// checks if the VirtualizationVmwareUplinkPortList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationVmwareUplinkPortList{}
...
func NewVirtualizationVmwareUplinkPortList(objectType string) *VirtualizationVmwareUplinkPortList {
...
func (o VirtualizationVmwareUplinkPortList) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationVmwareUplinkPortList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareUplinkPortListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationVmwareUplinkPortList)
	if err == nil {
