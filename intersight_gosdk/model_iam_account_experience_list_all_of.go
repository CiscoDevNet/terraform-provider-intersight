...
// IamAccountExperienceListAllOf struct for IamAccountExperienceListAllOf
type IamAccountExperienceListAllOf struct {
...
type _IamAccountExperienceListAllOf IamAccountExperienceListAllOf
...
func NewIamAccountExperienceListAllOf() *IamAccountExperienceListAllOf {
	this := IamAccountExperienceListAllOf{}
	return &this
}
...
func (o IamAccountExperienceListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IamAccountExperienceListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamAccountExperienceListAllOf := _IamAccountExperienceListAllOf{}

	if err = json.Unmarshal(bytes, &varIamAccountExperienceListAllOf); err == nil {
		*o = IamAccountExperienceListAllOf(varIamAccountExperienceListAllOf)
	}
...
type NullableIamAccountExperienceListAllOf struct {
	value *IamAccountExperienceListAllOf
	isSet bool
}

func (v NullableIamAccountExperienceListAllOf) Get() *IamAccountExperienceListAllOf {
	return v.value
}

func (v *NullableIamAccountExperienceListAllOf) Set(val *IamAccountExperienceListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamAccountExperienceListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamAccountExperienceListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamAccountExperienceListAllOf(val *IamAccountExperienceListAllOf) *NullableIamAccountExperienceListAllOf {
	return &NullableIamAccountExperienceListAllOf{value: val, isSet: true}
}

func (v NullableIamAccountExperienceListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamAccountExperienceListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
