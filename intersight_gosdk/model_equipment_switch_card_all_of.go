...
func (o *EquipmentSwitchCardAllOf) GetFcPorts() []FcPhysicalPortRelationship {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EquipmentSwitchCardAllOf) GetFcPortsOk() ([]FcPhysicalPortRelationship, bool) {
...
func (o *EquipmentSwitchCardAllOf) HasFcPorts() bool {
	if o != nil && o.FcPorts != nil {
		return true
	}
...
func (o *EquipmentSwitchCardAllOf) SetFcPorts(v []FcPhysicalPortRelationship) {
	o.FcPorts = v
}
