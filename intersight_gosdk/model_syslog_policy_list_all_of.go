...
// SyslogPolicyListAllOf struct for SyslogPolicyListAllOf
type SyslogPolicyListAllOf struct {
...
type _SyslogPolicyListAllOf SyslogPolicyListAllOf
...
func (o SyslogPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *SyslogPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varSyslogPolicyListAllOf := _SyslogPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varSyslogPolicyListAllOf); err == nil {
		*o = SyslogPolicyListAllOf(varSyslogPolicyListAllOf)
	}
...
type NullableSyslogPolicyListAllOf struct {
	value *SyslogPolicyListAllOf
	isSet bool
}

func (v NullableSyslogPolicyListAllOf) Get() *SyslogPolicyListAllOf {
	return v.value
}

func (v *NullableSyslogPolicyListAllOf) Set(val *SyslogPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSyslogPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSyslogPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSyslogPolicyListAllOf(val *SyslogPolicyListAllOf) *NullableSyslogPolicyListAllOf {
	return &NullableSyslogPolicyListAllOf{value: val, isSet: true}
}

func (v NullableSyslogPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSyslogPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
