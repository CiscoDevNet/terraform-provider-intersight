...
func (o *NiatelemetryDcnmPsuDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryDcnmPsuDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryDcnmPsuDetails)
	if err == nil {
