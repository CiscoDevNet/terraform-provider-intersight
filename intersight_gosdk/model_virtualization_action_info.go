...
// checks if the VirtualizationActionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationActionInfo{}
...
// GetDefaultClassId returns the default value "virtualization.ActionInfo" of the ClassId field.
func (o *VirtualizationActionInfo) GetDefaultClassId() interface{} {
	return "virtualization.ActionInfo"
}
...
// GetDefaultObjectType returns the default value "virtualization.ActionInfo" of the ObjectType field.
func (o *VirtualizationActionInfo) GetDefaultObjectType() interface{} {
	return "virtualization.ActionInfo"
}
...
func (o VirtualizationActionInfo) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationActionInfo) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationActionInfoWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationActionInfo)
	if err == nil {
