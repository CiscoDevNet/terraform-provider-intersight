...
func (o *NiatelemetryJobDetail) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryJobDetailWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varNiatelemetryJobDetail)
	if err == nil {
