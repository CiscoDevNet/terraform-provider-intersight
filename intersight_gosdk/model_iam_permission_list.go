...
// checks if the IamPermissionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamPermissionList{}
...
func (o IamPermissionList) ToMap() (map[string]interface{}, error) {
...
func (o *IamPermissionList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamPermissionListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIamPermissionList)
	if err == nil {
