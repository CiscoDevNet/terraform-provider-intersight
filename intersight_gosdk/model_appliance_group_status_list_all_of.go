...
// ApplianceGroupStatusListAllOf struct for ApplianceGroupStatusListAllOf
type ApplianceGroupStatusListAllOf struct {
...
type _ApplianceGroupStatusListAllOf ApplianceGroupStatusListAllOf
...
func NewApplianceGroupStatusListAllOf() *ApplianceGroupStatusListAllOf {
	this := ApplianceGroupStatusListAllOf{}
	return &this
}
...
func (o ApplianceGroupStatusListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceGroupStatusListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceGroupStatusListAllOf := _ApplianceGroupStatusListAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceGroupStatusListAllOf); err == nil {
		*o = ApplianceGroupStatusListAllOf(varApplianceGroupStatusListAllOf)
	}
...
type NullableApplianceGroupStatusListAllOf struct {
	value *ApplianceGroupStatusListAllOf
	isSet bool
}

func (v NullableApplianceGroupStatusListAllOf) Get() *ApplianceGroupStatusListAllOf {
	return v.value
}

func (v *NullableApplianceGroupStatusListAllOf) Set(val *ApplianceGroupStatusListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceGroupStatusListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceGroupStatusListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceGroupStatusListAllOf(val *ApplianceGroupStatusListAllOf) *NullableApplianceGroupStatusListAllOf {
	return &NullableApplianceGroupStatusListAllOf{value: val, isSet: true}
}

func (v NullableApplianceGroupStatusListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceGroupStatusListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
