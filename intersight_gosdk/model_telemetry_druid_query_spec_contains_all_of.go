...
// TelemetryDruidQuerySpecContainsAllOf struct for TelemetryDruidQuerySpecContainsAllOf
type TelemetryDruidQuerySpecContainsAllOf struct {
...
type _TelemetryDruidQuerySpecContainsAllOf TelemetryDruidQuerySpecContainsAllOf
...
func NewTelemetryDruidQuerySpecContainsAllOf(type_ string, value string) *TelemetryDruidQuerySpecContainsAllOf {
	this := TelemetryDruidQuerySpecContainsAllOf{}
	this.Type = type_
	this.Value = value
	return &this
}
...
func (o TelemetryDruidQuerySpecContainsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *TelemetryDruidQuerySpecContainsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidQuerySpecContainsAllOf := _TelemetryDruidQuerySpecContainsAllOf{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidQuerySpecContainsAllOf); err == nil {
		*o = TelemetryDruidQuerySpecContainsAllOf(varTelemetryDruidQuerySpecContainsAllOf)
	}
...
type NullableTelemetryDruidQuerySpecContainsAllOf struct {
	value *TelemetryDruidQuerySpecContainsAllOf
	isSet bool
}

func (v NullableTelemetryDruidQuerySpecContainsAllOf) Get() *TelemetryDruidQuerySpecContainsAllOf {
	return v.value
}

func (v *NullableTelemetryDruidQuerySpecContainsAllOf) Set(val *TelemetryDruidQuerySpecContainsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTelemetryDruidQuerySpecContainsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTelemetryDruidQuerySpecContainsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTelemetryDruidQuerySpecContainsAllOf(val *TelemetryDruidQuerySpecContainsAllOf) *NullableTelemetryDruidQuerySpecContainsAllOf {
	return &NullableTelemetryDruidQuerySpecContainsAllOf{value: val, isSet: true}
}

func (v NullableTelemetryDruidQuerySpecContainsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTelemetryDruidQuerySpecContainsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
