...
// checks if the FabricLinkControlPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricLinkControlPolicy{}
...
// GetDefaultClassId returns the default value "fabric.LinkControlPolicy" of the ClassId field.
func (o *FabricLinkControlPolicy) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "fabric.LinkControlPolicy" of the ObjectType field.
func (o *FabricLinkControlPolicy) GetDefaultObjectType() interface{} {
	return "fabric.LinkControlPolicy"
}
...
func (o *FabricLinkControlPolicy) SetOrganizationNil() {
...
func (o FabricLinkControlPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *FabricLinkControlPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricLinkControlPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricLinkControlPolicy)
	if err == nil {
