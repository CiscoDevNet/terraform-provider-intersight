...
// ComputeBiosPostPolicyAllOf Definition of the list of properties defined in 'compute.BiosPostPolicy', excluding properties defined in parent classes.
type ComputeBiosPostPolicyAllOf struct {
...
type _ComputeBiosPostPolicyAllOf ComputeBiosPostPolicyAllOf
...
func NewComputeBiosPostPolicyAllOf(classId string, objectType string) *ComputeBiosPostPolicyAllOf {
	this := ComputeBiosPostPolicyAllOf{}
...
func NewComputeBiosPostPolicyAllOfWithDefaults() *ComputeBiosPostPolicyAllOf {
	this := ComputeBiosPostPolicyAllOf{}
	var classId string = "compute.BiosPostPolicy"
	this.ClassId = classId
	var objectType string = "compute.BiosPostPolicy"
	this.ObjectType = objectType
	return &this
}
...
func (o ComputeBiosPostPolicyAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ComputeBiosPostPolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varComputeBiosPostPolicyAllOf := _ComputeBiosPostPolicyAllOf{}

	if err = json.Unmarshal(bytes, &varComputeBiosPostPolicyAllOf); err == nil {
		*o = ComputeBiosPostPolicyAllOf(varComputeBiosPostPolicyAllOf)
	}
...
type NullableComputeBiosPostPolicyAllOf struct {
	value *ComputeBiosPostPolicyAllOf
	isSet bool
}

func (v NullableComputeBiosPostPolicyAllOf) Get() *ComputeBiosPostPolicyAllOf {
	return v.value
}

func (v *NullableComputeBiosPostPolicyAllOf) Set(val *ComputeBiosPostPolicyAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableComputeBiosPostPolicyAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableComputeBiosPostPolicyAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputeBiosPostPolicyAllOf(val *ComputeBiosPostPolicyAllOf) *NullableComputeBiosPostPolicyAllOf {
	return &NullableComputeBiosPostPolicyAllOf{value: val, isSet: true}
}

func (v NullableComputeBiosPostPolicyAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputeBiosPostPolicyAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
