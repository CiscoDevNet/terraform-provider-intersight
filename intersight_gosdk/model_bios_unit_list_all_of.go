...
// BiosUnitListAllOf struct for BiosUnitListAllOf
type BiosUnitListAllOf struct {
...
type _BiosUnitListAllOf BiosUnitListAllOf
...
func (o BiosUnitListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BiosUnitListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBiosUnitListAllOf := _BiosUnitListAllOf{}

	if err = json.Unmarshal(bytes, &varBiosUnitListAllOf); err == nil {
		*o = BiosUnitListAllOf(varBiosUnitListAllOf)
	}
...
type NullableBiosUnitListAllOf struct {
	value *BiosUnitListAllOf
	isSet bool
}

func (v NullableBiosUnitListAllOf) Get() *BiosUnitListAllOf {
	return v.value
}

func (v *NullableBiosUnitListAllOf) Set(val *BiosUnitListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBiosUnitListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBiosUnitListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBiosUnitListAllOf(val *BiosUnitListAllOf) *NullableBiosUnitListAllOf {
	return &NullableBiosUnitListAllOf{value: val, isSet: true}
}

func (v NullableBiosUnitListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBiosUnitListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
