...
// VirtualizationBasePhysicalNetworkInterfaceAllOf Definition of the list of properties defined in 'virtualization.BasePhysicalNetworkInterface', excluding properties defined in parent classes.
type VirtualizationBasePhysicalNetworkInterfaceAllOf struct {
...
type _VirtualizationBasePhysicalNetworkInterfaceAllOf VirtualizationBasePhysicalNetworkInterfaceAllOf
...
func NewVirtualizationBasePhysicalNetworkInterfaceAllOf(classId string, objectType string) *VirtualizationBasePhysicalNetworkInterfaceAllOf {
	this := VirtualizationBasePhysicalNetworkInterfaceAllOf{}
...
func (o VirtualizationBasePhysicalNetworkInterfaceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationBasePhysicalNetworkInterfaceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationBasePhysicalNetworkInterfaceAllOf := _VirtualizationBasePhysicalNetworkInterfaceAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationBasePhysicalNetworkInterfaceAllOf); err == nil {
		*o = VirtualizationBasePhysicalNetworkInterfaceAllOf(varVirtualizationBasePhysicalNetworkInterfaceAllOf)
	}
...
type NullableVirtualizationBasePhysicalNetworkInterfaceAllOf struct {
	value *VirtualizationBasePhysicalNetworkInterfaceAllOf
	isSet bool
}

func (v NullableVirtualizationBasePhysicalNetworkInterfaceAllOf) Get() *VirtualizationBasePhysicalNetworkInterfaceAllOf {
	return v.value
}

func (v *NullableVirtualizationBasePhysicalNetworkInterfaceAllOf) Set(val *VirtualizationBasePhysicalNetworkInterfaceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationBasePhysicalNetworkInterfaceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationBasePhysicalNetworkInterfaceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationBasePhysicalNetworkInterfaceAllOf(val *VirtualizationBasePhysicalNetworkInterfaceAllOf) *NullableVirtualizationBasePhysicalNetworkInterfaceAllOf {
	return &NullableVirtualizationBasePhysicalNetworkInterfaceAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationBasePhysicalNetworkInterfaceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationBasePhysicalNetworkInterfaceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
