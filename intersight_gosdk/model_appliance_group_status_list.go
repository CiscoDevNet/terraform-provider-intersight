...
// checks if the ApplianceGroupStatusList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceGroupStatusList{}
...
func NewApplianceGroupStatusList(objectType string) *ApplianceGroupStatusList {
...
func (o ApplianceGroupStatusList) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceGroupStatusList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceGroupStatusListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceGroupStatusList)
	if err == nil {
