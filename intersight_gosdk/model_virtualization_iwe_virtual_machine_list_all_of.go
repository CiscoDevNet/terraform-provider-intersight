...
// VirtualizationIweVirtualMachineListAllOf struct for VirtualizationIweVirtualMachineListAllOf
type VirtualizationIweVirtualMachineListAllOf struct {
...
type _VirtualizationIweVirtualMachineListAllOf VirtualizationIweVirtualMachineListAllOf
...
func NewVirtualizationIweVirtualMachineListAllOf() *VirtualizationIweVirtualMachineListAllOf {
	this := VirtualizationIweVirtualMachineListAllOf{}
	return &this
}
...
func (o VirtualizationIweVirtualMachineListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationIweVirtualMachineListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVirtualizationIweVirtualMachineListAllOf := _VirtualizationIweVirtualMachineListAllOf{}

	if err = json.Unmarshal(bytes, &varVirtualizationIweVirtualMachineListAllOf); err == nil {
		*o = VirtualizationIweVirtualMachineListAllOf(varVirtualizationIweVirtualMachineListAllOf)
	}
...
type NullableVirtualizationIweVirtualMachineListAllOf struct {
	value *VirtualizationIweVirtualMachineListAllOf
	isSet bool
}

func (v NullableVirtualizationIweVirtualMachineListAllOf) Get() *VirtualizationIweVirtualMachineListAllOf {
	return v.value
}

func (v *NullableVirtualizationIweVirtualMachineListAllOf) Set(val *VirtualizationIweVirtualMachineListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationIweVirtualMachineListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationIweVirtualMachineListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationIweVirtualMachineListAllOf(val *VirtualizationIweVirtualMachineListAllOf) *NullableVirtualizationIweVirtualMachineListAllOf {
	return &NullableVirtualizationIweVirtualMachineListAllOf{value: val, isSet: true}
}

func (v NullableVirtualizationIweVirtualMachineListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationIweVirtualMachineListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
