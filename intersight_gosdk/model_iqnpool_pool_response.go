...
func (dst *IqnpoolPoolResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'iqnpool.Pool.List'
	if jsonDict["ObjectType"] == "iqnpool.Pool.List" {
		// try to unmarshal JSON data into IqnpoolPoolList
		err = json.Unmarshal(data, &dst.IqnpoolPoolList)
		if err == nil {
			return nil // data stored in dst.IqnpoolPoolList, return on the first match
		} else {
			dst.IqnpoolPoolList = nil
			return fmt.Errorf("Failed to unmarshal IqnpoolPoolResponse as IqnpoolPoolList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IqnpoolPoolResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IqnpoolPoolResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal IqnpoolPoolResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src IqnpoolPoolResponse) MarshalJSON() ([]byte, error) {
	if src.IqnpoolPoolList != nil {
		return json.Marshal(&src.IqnpoolPoolList)
	}
...
type NullableIqnpoolPoolResponse struct {
	value *IqnpoolPoolResponse
	isSet bool
}

func (v NullableIqnpoolPoolResponse) Get() *IqnpoolPoolResponse {
	return v.value
}

func (v *NullableIqnpoolPoolResponse) Set(val *IqnpoolPoolResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIqnpoolPoolResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIqnpoolPoolResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIqnpoolPoolResponse(val *IqnpoolPoolResponse) *NullableIqnpoolPoolResponse {
	return &NullableIqnpoolPoolResponse{value: val, isSet: true}
}

func (v NullableIqnpoolPoolResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIqnpoolPoolResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
