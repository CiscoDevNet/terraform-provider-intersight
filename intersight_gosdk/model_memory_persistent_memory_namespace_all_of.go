...
func (o *MemoryPersistentMemoryNamespaceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varMemoryPersistentMemoryNamespaceAllOf := _MemoryPersistentMemoryNamespaceAllOf{}

	if err = json.Unmarshal(bytes, &varMemoryPersistentMemoryNamespaceAllOf); err == nil {
		*o = MemoryPersistentMemoryNamespaceAllOf(varMemoryPersistentMemoryNamespaceAllOf)
	}
