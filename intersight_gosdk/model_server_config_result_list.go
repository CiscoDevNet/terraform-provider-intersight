...
func (o *ServerConfigResultList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varServerConfigResultListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varServerConfigResultList)
	if err == nil {
