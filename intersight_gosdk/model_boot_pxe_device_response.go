...
func (dst *BootPxeDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'boot.PxeDevice.List'
	if jsonDict["ObjectType"] == "boot.PxeDevice.List" {
		// try to unmarshal JSON data into BootPxeDeviceList
		err = json.Unmarshal(data, &dst.BootPxeDeviceList)
		if err == nil {
			return nil // data stored in dst.BootPxeDeviceList, return on the first match
		} else {
			dst.BootPxeDeviceList = nil
			return fmt.Errorf("Failed to unmarshal BootPxeDeviceResponse as BootPxeDeviceList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BootPxeDeviceResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BootPxeDeviceResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal BootPxeDeviceResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src BootPxeDeviceResponse) MarshalJSON() ([]byte, error) {
	if src.BootPxeDeviceList != nil {
		return json.Marshal(&src.BootPxeDeviceList)
	}
...
type NullableBootPxeDeviceResponse struct {
	value *BootPxeDeviceResponse
	isSet bool
}

func (v NullableBootPxeDeviceResponse) Get() *BootPxeDeviceResponse {
	return v.value
}

func (v *NullableBootPxeDeviceResponse) Set(val *BootPxeDeviceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBootPxeDeviceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBootPxeDeviceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootPxeDeviceResponse(val *BootPxeDeviceResponse) *NullableBootPxeDeviceResponse {
	return &NullableBootPxeDeviceResponse{value: val, isSet: true}
}

func (v NullableBootPxeDeviceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootPxeDeviceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
