...
// ConnectorFetchStreamMessageAllOf Definition of the list of properties defined in 'connector.FetchStreamMessage', excluding properties defined in parent classes.
type ConnectorFetchStreamMessageAllOf struct {
...
type _ConnectorFetchStreamMessageAllOf ConnectorFetchStreamMessageAllOf
...
func NewConnectorFetchStreamMessageAllOf(classId string, objectType string) *ConnectorFetchStreamMessageAllOf {
	this := ConnectorFetchStreamMessageAllOf{}
...
func (o ConnectorFetchStreamMessageAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ConnectorFetchStreamMessageAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varConnectorFetchStreamMessageAllOf := _ConnectorFetchStreamMessageAllOf{}

	if err = json.Unmarshal(bytes, &varConnectorFetchStreamMessageAllOf); err == nil {
		*o = ConnectorFetchStreamMessageAllOf(varConnectorFetchStreamMessageAllOf)
	}
...
type NullableConnectorFetchStreamMessageAllOf struct {
	value *ConnectorFetchStreamMessageAllOf
	isSet bool
}

func (v NullableConnectorFetchStreamMessageAllOf) Get() *ConnectorFetchStreamMessageAllOf {
	return v.value
}

func (v *NullableConnectorFetchStreamMessageAllOf) Set(val *ConnectorFetchStreamMessageAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorFetchStreamMessageAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorFetchStreamMessageAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorFetchStreamMessageAllOf(val *ConnectorFetchStreamMessageAllOf) *NullableConnectorFetchStreamMessageAllOf {
	return &NullableConnectorFetchStreamMessageAllOf{value: val, isSet: true}
}

func (v NullableConnectorFetchStreamMessageAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorFetchStreamMessageAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
