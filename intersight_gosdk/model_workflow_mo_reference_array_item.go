...
// checks if the WorkflowMoReferenceArrayItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowMoReferenceArrayItem{}
...
// GetDefaultClassId returns the default value "workflow.MoReferenceArrayItem" of the ClassId field.
func (o *WorkflowMoReferenceArrayItem) GetDefaultClassId() interface{} {
	return "workflow.MoReferenceArrayItem"
}
...
// GetDefaultObjectType returns the default value "workflow.MoReferenceArrayItem" of the ObjectType field.
func (o *WorkflowMoReferenceArrayItem) GetDefaultObjectType() interface{} {
	return "workflow.MoReferenceArrayItem"
}
...
func (o WorkflowMoReferenceArrayItem) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowMoReferenceArrayItem) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowMoReferenceArrayItemWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowMoReferenceArrayItem)
	if err == nil {
