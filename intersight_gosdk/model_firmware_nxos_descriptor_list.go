...
func (o *FirmwareNxosDescriptorList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFirmwareNxosDescriptorListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFirmwareNxosDescriptorList)
	if err == nil {
