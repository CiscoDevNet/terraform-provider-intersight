...
// checks if the TaskNexusSystemScopedInventory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskNexusSystemScopedInventory{}
...
// GetDefaultClassId returns the default value "task.NexusSystemScopedInventory" of the ClassId field.
func (o *TaskNexusSystemScopedInventory) GetDefaultClassId() interface{} {
	return "task.NexusSystemScopedInventory"
}
...
// GetDefaultObjectType returns the default value "task.NexusSystemScopedInventory" of the ObjectType field.
func (o *TaskNexusSystemScopedInventory) GetDefaultObjectType() interface{} {
	return "task.NexusSystemScopedInventory"
}
...
func (o *TaskNexusSystemScopedInventory) SetRegisteredDeviceNil() {
...
func (o TaskNexusSystemScopedInventory) ToMap() (map[string]interface{}, error) {
...
func (o *TaskNexusSystemScopedInventory) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTaskNexusSystemScopedInventoryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTaskNexusSystemScopedInventory)
	if err == nil {
