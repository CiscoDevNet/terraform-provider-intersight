...
func (r ApiCreateNtpPolicyRequest) Execute() (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return NtpPolicy
 */
func (a *NtpApiService) CreateNtpPolicyExecute(r ApiCreateNtpPolicyRequest) (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	if r.ntpPolicy == nil {
		executionError.error = "ntpPolicy is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
...
func (r ApiDeleteNtpPolicyRequest) Execute() (*_nethttp.Response, GenericOpenAPIError) {
 ...
 * Execute executes the request
 */
func (a *NtpApiService) DeleteNtpPolicyExecute(r ApiDeleteNtpPolicyRequest) (*_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetNtpPolicyByMoidRequest) Execute() (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return NtpPolicy
 */
func (a *NtpApiService) GetNtpPolicyByMoidExecute(r ApiGetNtpPolicyByMoidRequest) (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetNtpPolicyListRequest) Execute() (NtpPolicyResponse, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *NtpApiService) GetNtpPolicyListExecute(r ApiGetNtpPolicyListRequest) (NtpPolicyResponse, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiPatchNtpPolicyRequest) Execute() (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return NtpPolicy
 */
func (a *NtpApiService) PatchNtpPolicyExecute(r ApiPatchNtpPolicyRequest) (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiUpdateNtpPolicyRequest) Execute() (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return NtpPolicy
 */
func (a *NtpApiService) UpdateNtpPolicyExecute(r ApiUpdateNtpPolicyRequest) (NtpPolicy, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
