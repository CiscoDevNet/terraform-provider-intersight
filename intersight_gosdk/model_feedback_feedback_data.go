...
// FeedbackFeedbackData Feedback data collected from the user through the UI.
type FeedbackFeedbackData struct {
	...
	// Evaluation rating provided by the user to capture user sentiment regarding the issue. * `Excellent` - Option indicating user's excellent evaluation. * `Poor` - Option indicating user's poor evaluation. * `Fair` - Option indicating user's fair evaluation. * `Good` - Option indicating user's good evaluation.
	// Deprecated
	...
	FullStoryUrl *string `json:"FullStoryUrl,omitempty"`
	// User's satisfaction with the product on a 0-10 scale.
	ProductSatisfactionScale *int64 `json:"ProductSatisfactionScale,omitempty"`
	// Survey completion status (True if completed, False otherwise).
	SurveyCompleted *bool `json:"SurveyCompleted,omitempty"`
	// Collection of last traceId for replicating the user's last activity.
	TraceIds interface{} `json:"TraceIds,omitempty"`
	// Type of the feedback from user. * `Evaluation` - User's feedback classified as an evaluation. * `Bug` - User's feedback classified as a bug. * `Survey` - User's response to a survey.
...
// GetDefaultClassId returns the default value "feedback.FeedbackData" of the ClassId field.
func (o *FeedbackFeedbackData) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "feedback.FeedbackData" of the ObjectType field.
func (o *FeedbackFeedbackData) GetDefaultObjectType() interface{} {
	return "feedback.FeedbackData"
}
...
// SetFullStoryUrl gets a reference to the given string and assigns it to the FullStoryUrl field.
...
func (o *FeedbackFeedbackData) GetProductSatisfactionScale() int64 {
	...
	return *o.ProductSatisfactionScale
}
...
// SetProductSatisfactionScale gets a reference to the given int64 and assigns it to the ProductSatisfactionScale field.
func (o *FeedbackFeedbackData) SetProductSatisfactionScale(v int64) {
	o.ProductSatisfactionScale = &v
}
...
// SetSurveyCompleted gets a reference to the given bool and assigns it to the SurveyCompleted field.
...
func (o *FeedbackFeedbackData) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFeedbackFeedbackData.FullStoryUrl = varFeedbackFeedbackDataWithoutEmbeddedStruct.FullStoryUrl
		varFeedbackFeedbackData.ProductSatisfactionScale = varFeedbackFeedbackDataWithoutEmbeddedStruct.ProductSatisfactionScale
		varFeedbackFeedbackData.SurveyCompleted = varFeedbackFeedbackDataWithoutEmbeddedStruct.SurveyCompleted
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "FullStoryUrl")
		delete(additionalProperties, "ProductSatisfactionScale")
		delete(additionalProperties, "SurveyCompleted")
