...
// checks if the SessionAbstractSession type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionAbstractSession{}
...
func (o SessionAbstractSession) ToMap() (map[string]interface{}, error) {
...
func (o *SessionAbstractSession) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSessionAbstractSessionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSessionAbstractSession)
	if err == nil {
