...
func (o *InfraMigGpuConfiguration) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varInfraMigGpuConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varInfraMigGpuConfiguration)
	if err == nil {
