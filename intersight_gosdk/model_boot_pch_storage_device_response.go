...
func (dst *BootPchStorageDeviceResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'boot.PchStorageDevice.List'
	if jsonDict["ObjectType"] == "boot.PchStorageDevice.List" {
		// try to unmarshal JSON data into BootPchStorageDeviceList
		err = json.Unmarshal(data, &dst.BootPchStorageDeviceList)
		if err == nil {
			return nil // data stored in dst.BootPchStorageDeviceList, return on the first match
		} else {
			dst.BootPchStorageDeviceList = nil
			return fmt.Errorf("failed to unmarshal BootPchStorageDeviceResponse as BootPchStorageDeviceList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal BootPchStorageDeviceResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal BootPchStorageDeviceResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal BootPchStorageDeviceResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src BootPchStorageDeviceResponse) MarshalJSON() ([]byte, error) {
	if src.BootPchStorageDeviceList != nil {
		return json.Marshal(&src.BootPchStorageDeviceList)
	}
...
type NullableBootPchStorageDeviceResponse struct {
	value *BootPchStorageDeviceResponse
	isSet bool
}

func (v NullableBootPchStorageDeviceResponse) Get() *BootPchStorageDeviceResponse {
	return v.value
}

func (v *NullableBootPchStorageDeviceResponse) Set(val *BootPchStorageDeviceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBootPchStorageDeviceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBootPchStorageDeviceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootPchStorageDeviceResponse(val *BootPchStorageDeviceResponse) *NullableBootPchStorageDeviceResponse {
	return &NullableBootPchStorageDeviceResponse{value: val, isSet: true}
}

func (v NullableBootPchStorageDeviceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootPchStorageDeviceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
