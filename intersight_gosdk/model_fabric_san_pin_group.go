...
// checks if the FabricSanPinGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricSanPinGroup{}
...
// GetDefaultClassId returns the default value "fabric.SanPinGroup" of the ClassId field.
func (o *FabricSanPinGroup) GetDefaultClassId() interface{} {
	return "fabric.SanPinGroup"
}
...
// GetDefaultObjectType returns the default value "fabric.SanPinGroup" of the ObjectType field.
func (o *FabricSanPinGroup) GetDefaultObjectType() interface{} {
	return "fabric.SanPinGroup"
}
...
func (o *FabricSanPinGroup) SetPinTargetInterfaceRoleNil() {
...
func (o FabricSanPinGroup) ToMap() (map[string]interface{}, error) {
...
func (o *FabricSanPinGroup) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricSanPinGroupWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricSanPinGroup)
	if err == nil {
