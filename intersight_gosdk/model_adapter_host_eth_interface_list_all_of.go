...
// AdapterHostEthInterfaceListAllOf struct for AdapterHostEthInterfaceListAllOf
type AdapterHostEthInterfaceListAllOf struct {
...
type _AdapterHostEthInterfaceListAllOf AdapterHostEthInterfaceListAllOf
...
func NewAdapterHostEthInterfaceListAllOf() *AdapterHostEthInterfaceListAllOf {
	this := AdapterHostEthInterfaceListAllOf{}
	return &this
}
...
func (o AdapterHostEthInterfaceListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *AdapterHostEthInterfaceListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varAdapterHostEthInterfaceListAllOf := _AdapterHostEthInterfaceListAllOf{}

	if err = json.Unmarshal(bytes, &varAdapterHostEthInterfaceListAllOf); err == nil {
		*o = AdapterHostEthInterfaceListAllOf(varAdapterHostEthInterfaceListAllOf)
	}
...
type NullableAdapterHostEthInterfaceListAllOf struct {
	value *AdapterHostEthInterfaceListAllOf
	isSet bool
}

func (v NullableAdapterHostEthInterfaceListAllOf) Get() *AdapterHostEthInterfaceListAllOf {
	return v.value
}

func (v *NullableAdapterHostEthInterfaceListAllOf) Set(val *AdapterHostEthInterfaceListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAdapterHostEthInterfaceListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAdapterHostEthInterfaceListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdapterHostEthInterfaceListAllOf(val *AdapterHostEthInterfaceListAllOf) *NullableAdapterHostEthInterfaceListAllOf {
	return &NullableAdapterHostEthInterfaceListAllOf{value: val, isSet: true}
}

func (v NullableAdapterHostEthInterfaceListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdapterHostEthInterfaceListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
