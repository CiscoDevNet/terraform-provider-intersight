...
// checks if the RecoveryScheduleConfigPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryScheduleConfigPolicy{}

// RecoveryScheduleConfigPolicy Base Schedule configuration for local or remote server.
...
// GetDefaultClassId returns the default value "recovery.ScheduleConfigPolicy" of the ClassId field.
func (o *RecoveryScheduleConfigPolicy) GetDefaultClassId() interface{} {
	return "recovery.ScheduleConfigPolicy"
}
...
// GetDefaultObjectType returns the default value "recovery.ScheduleConfigPolicy" of the ObjectType field.
func (o *RecoveryScheduleConfigPolicy) GetDefaultObjectType() interface{} {
	return "recovery.ScheduleConfigPolicy"
}
...
func (o *RecoveryScheduleConfigPolicy) SetOrganizationNil() {
...
func (o RecoveryScheduleConfigPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *RecoveryScheduleConfigPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRecoveryScheduleConfigPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varRecoveryScheduleConfigPolicy)
	if err == nil {
