...
type ConnectorStartStream struct {
	...
	AckRate *int64 `json:"AckRate,omitempty"`
...
// GetAckRate returns the AckRate field value if set, zero value otherwise.
func (o *ConnectorStartStream) GetAckRate() int64 {
	if o == nil || o.AckRate == nil {
		var ret int64
		return ret
	}
	return *o.AckRate
...
// GetAckRateOk returns a tuple with the AckRate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConnectorStartStream) GetAckRateOk() (*int64, bool) {
	if o == nil || o.AckRate == nil {
		return nil, false
	}
	return o.AckRate, true
}
...
// SetAckRate gets a reference to the given int64 and assigns it to the AckRate field.
...
func (o *ConnectorStartStream) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varConnectorStartStream.AckRate = varConnectorStartStreamWithoutEmbeddedStruct.AckRate
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "AckRate")
