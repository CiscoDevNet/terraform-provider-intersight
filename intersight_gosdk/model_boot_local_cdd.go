...
// checks if the BootLocalCdd type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootLocalCdd{}
...
func (o BootLocalCdd) ToMap() (map[string]interface{}, error) {
...
func (o *BootLocalCdd) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBootLocalCddWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBootLocalCdd)
	if err == nil {
