...
// NiaapiApicSweolListAllOf struct for NiaapiApicSweolListAllOf
type NiaapiApicSweolListAllOf struct {
...
type _NiaapiApicSweolListAllOf NiaapiApicSweolListAllOf
...
func (o NiaapiApicSweolListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiaapiApicSweolListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiaapiApicSweolListAllOf := _NiaapiApicSweolListAllOf{}

	if err = json.Unmarshal(bytes, &varNiaapiApicSweolListAllOf); err == nil {
		*o = NiaapiApicSweolListAllOf(varNiaapiApicSweolListAllOf)
	}
...
type NullableNiaapiApicSweolListAllOf struct {
	value *NiaapiApicSweolListAllOf
	isSet bool
}

func (v NullableNiaapiApicSweolListAllOf) Get() *NiaapiApicSweolListAllOf {
	return v.value
}

func (v *NullableNiaapiApicSweolListAllOf) Set(val *NiaapiApicSweolListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiaapiApicSweolListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiaapiApicSweolListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiaapiApicSweolListAllOf(val *NiaapiApicSweolListAllOf) *NullableNiaapiApicSweolListAllOf {
	return &NullableNiaapiApicSweolListAllOf{value: val, isSet: true}
}

func (v NullableNiaapiApicSweolListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiaapiApicSweolListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
