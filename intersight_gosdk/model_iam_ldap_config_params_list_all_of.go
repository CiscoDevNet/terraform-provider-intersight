...
// IamLdapConfigParamsListAllOf struct for IamLdapConfigParamsListAllOf
type IamLdapConfigParamsListAllOf struct {
...
type _IamLdapConfigParamsListAllOf IamLdapConfigParamsListAllOf
...
func NewIamLdapConfigParamsListAllOf() *IamLdapConfigParamsListAllOf {
	this := IamLdapConfigParamsListAllOf{}
	return &this
}
...
func (o IamLdapConfigParamsListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IamLdapConfigParamsListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamLdapConfigParamsListAllOf := _IamLdapConfigParamsListAllOf{}

	if err = json.Unmarshal(bytes, &varIamLdapConfigParamsListAllOf); err == nil {
		*o = IamLdapConfigParamsListAllOf(varIamLdapConfigParamsListAllOf)
	}
...
type NullableIamLdapConfigParamsListAllOf struct {
	value *IamLdapConfigParamsListAllOf
	isSet bool
}

func (v NullableIamLdapConfigParamsListAllOf) Get() *IamLdapConfigParamsListAllOf {
	return v.value
}

func (v *NullableIamLdapConfigParamsListAllOf) Set(val *IamLdapConfigParamsListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamLdapConfigParamsListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamLdapConfigParamsListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamLdapConfigParamsListAllOf(val *IamLdapConfigParamsListAllOf) *NullableIamLdapConfigParamsListAllOf {
	return &NullableIamLdapConfigParamsListAllOf{value: val, isSet: true}
}

func (v NullableIamLdapConfigParamsListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamLdapConfigParamsListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
