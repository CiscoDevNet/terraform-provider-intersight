...
// StoragePureHostLunListAllOf struct for StoragePureHostLunListAllOf
type StoragePureHostLunListAllOf struct {
...
type _StoragePureHostLunListAllOf StoragePureHostLunListAllOf
...
func NewStoragePureHostLunListAllOf() *StoragePureHostLunListAllOf {
	this := StoragePureHostLunListAllOf{}
	return &this
}
...
func (o StoragePureHostLunListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StoragePureHostLunListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStoragePureHostLunListAllOf := _StoragePureHostLunListAllOf{}

	if err = json.Unmarshal(bytes, &varStoragePureHostLunListAllOf); err == nil {
		*o = StoragePureHostLunListAllOf(varStoragePureHostLunListAllOf)
	}
...
type NullableStoragePureHostLunListAllOf struct {
	value *StoragePureHostLunListAllOf
	isSet bool
}

func (v NullableStoragePureHostLunListAllOf) Get() *StoragePureHostLunListAllOf {
	return v.value
}

func (v *NullableStoragePureHostLunListAllOf) Set(val *StoragePureHostLunListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePureHostLunListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePureHostLunListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePureHostLunListAllOf(val *StoragePureHostLunListAllOf) *NullableStoragePureHostLunListAllOf {
	return &NullableStoragePureHostLunListAllOf{value: val, isSet: true}
}

func (v NullableStoragePureHostLunListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePureHostLunListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
