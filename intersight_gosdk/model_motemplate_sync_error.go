...
func (o *MotemplateSyncError) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMotemplateSyncErrorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varMotemplateSyncError)
	if err == nil {
