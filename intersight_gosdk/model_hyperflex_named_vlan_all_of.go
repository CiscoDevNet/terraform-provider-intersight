...
// HyperflexNamedVlanAllOf Definition of the list of properties defined in 'hyperflex.NamedVlan', excluding properties defined in parent classes.
type HyperflexNamedVlanAllOf struct {
...
type _HyperflexNamedVlanAllOf HyperflexNamedVlanAllOf
...
func (o HyperflexNamedVlanAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexNamedVlanAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexNamedVlanAllOf := _HyperflexNamedVlanAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexNamedVlanAllOf); err == nil {
		*o = HyperflexNamedVlanAllOf(varHyperflexNamedVlanAllOf)
	}
...
type NullableHyperflexNamedVlanAllOf struct {
	value *HyperflexNamedVlanAllOf
	isSet bool
}

func (v NullableHyperflexNamedVlanAllOf) Get() *HyperflexNamedVlanAllOf {
	return v.value
}

func (v *NullableHyperflexNamedVlanAllOf) Set(val *HyperflexNamedVlanAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexNamedVlanAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexNamedVlanAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexNamedVlanAllOf(val *HyperflexNamedVlanAllOf) *NullableHyperflexNamedVlanAllOf {
	return &NullableHyperflexNamedVlanAllOf{value: val, isSet: true}
}

func (v NullableHyperflexNamedVlanAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexNamedVlanAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
