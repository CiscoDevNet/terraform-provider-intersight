...
func (dst *LicenseCustomerOpResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'license.CustomerOp.List'
	if jsonDict["ObjectType"] == "license.CustomerOp.List" {
		// try to unmarshal JSON data into LicenseCustomerOpList
		err = json.Unmarshal(data, &dst.LicenseCustomerOpList)
		if err == nil {
			return nil // data stored in dst.LicenseCustomerOpList, return on the first match
		} else {
			dst.LicenseCustomerOpList = nil
			return fmt.Errorf("Failed to unmarshal LicenseCustomerOpResponse as LicenseCustomerOpList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal LicenseCustomerOpResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal LicenseCustomerOpResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal LicenseCustomerOpResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src LicenseCustomerOpResponse) MarshalJSON() ([]byte, error) {
	if src.LicenseCustomerOpList != nil {
		return json.Marshal(&src.LicenseCustomerOpList)
	}
...
type NullableLicenseCustomerOpResponse struct {
	value *LicenseCustomerOpResponse
	isSet bool
}

func (v NullableLicenseCustomerOpResponse) Get() *LicenseCustomerOpResponse {
	return v.value
}

func (v *NullableLicenseCustomerOpResponse) Set(val *LicenseCustomerOpResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLicenseCustomerOpResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLicenseCustomerOpResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicenseCustomerOpResponse(val *LicenseCustomerOpResponse) *NullableLicenseCustomerOpResponse {
	return &NullableLicenseCustomerOpResponse{value: val, isSet: true}
}

func (v NullableLicenseCustomerOpResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicenseCustomerOpResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
