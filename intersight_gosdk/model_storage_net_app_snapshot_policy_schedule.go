...
func (o *StorageNetAppSnapshotPolicySchedule) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppSnapshotPolicyScheduleWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppSnapshotPolicySchedule)
	if err == nil {
