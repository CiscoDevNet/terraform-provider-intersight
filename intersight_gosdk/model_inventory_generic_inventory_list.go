...
// checks if the InventoryGenericInventoryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InventoryGenericInventoryList{}
...
func NewInventoryGenericInventoryList(objectType string) *InventoryGenericInventoryList {
...
func (o InventoryGenericInventoryList) ToMap() (map[string]interface{}, error) {
...
func (o *InventoryGenericInventoryList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varInventoryGenericInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varInventoryGenericInventoryList)
	if err == nil {
