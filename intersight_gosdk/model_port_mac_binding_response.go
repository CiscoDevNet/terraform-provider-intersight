...
func (dst *PortMacBindingResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal PortMacBindingResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal PortMacBindingResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal PortMacBindingResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'port.MacBinding.List'
	if jsonDict["ObjectType"] == "port.MacBinding.List" {
		// try to unmarshal JSON data into PortMacBindingList
		err = json.Unmarshal(data, &dst.PortMacBindingList)
		if err == nil {
			return nil // data stored in dst.PortMacBindingList, return on the first match
		} else {
			dst.PortMacBindingList = nil
			return fmt.Errorf("Failed to unmarshal PortMacBindingResponse as PortMacBindingList: %s", err.Error())
		}
	}
...
func (src PortMacBindingResponse) MarshalJSON() ([]byte, error) {
	...
	if src.PortMacBindingList != nil {
		return json.Marshal(&src.PortMacBindingList)
	}
...
func (obj *PortMacBindingResponse) GetActualInstance() interface{} {
	...
	if obj.PortMacBindingList != nil {
		return obj.PortMacBindingList
	}
...
type NullablePortMacBindingResponse struct {
	value *PortMacBindingResponse
	isSet bool
}

func (v NullablePortMacBindingResponse) Get() *PortMacBindingResponse {
	return v.value
}

func (v *NullablePortMacBindingResponse) Set(val *PortMacBindingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePortMacBindingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePortMacBindingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePortMacBindingResponse(val *PortMacBindingResponse) *NullablePortMacBindingResponse {
	return &NullablePortMacBindingResponse{value: val, isSet: true}
}

func (v NullablePortMacBindingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePortMacBindingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
