...
// checks if the WorkflowFileTemplateOp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowFileTemplateOp{}
...
// GetDefaultClassId returns the default value "workflow.FileTemplateOp" of the ClassId field.
func (o *WorkflowFileTemplateOp) GetDefaultClassId() interface{} {
	return "workflow.FileTemplateOp"
}
...
// GetDefaultObjectType returns the default value "workflow.FileTemplateOp" of the ObjectType field.
func (o *WorkflowFileTemplateOp) GetDefaultObjectType() interface{} {
	return "workflow.FileTemplateOp"
}
...
func (o WorkflowFileTemplateOp) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowFileTemplateOp) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowFileTemplateOpWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowFileTemplateOp)
	if err == nil {
