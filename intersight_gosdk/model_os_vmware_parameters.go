...
func (o *OsVmwareParameters) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOsVmwareParametersWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varOsVmwareParameters)
	if err == nil {
