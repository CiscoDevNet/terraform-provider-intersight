...
// checks if the StorageVirtualDriveExtensionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageVirtualDriveExtensionList{}
...
func NewStorageVirtualDriveExtensionList(objectType string) *StorageVirtualDriveExtensionList {
...
func (o StorageVirtualDriveExtensionList) ToMap() (map[string]interface{}, error) {
...
func (o *StorageVirtualDriveExtensionList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageVirtualDriveExtensionListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageVirtualDriveExtensionList)
	if err == nil {
