...
func (o *MotemplateActionEntry) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMotemplateActionEntryWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varMotemplateActionEntry)
	if err == nil {
