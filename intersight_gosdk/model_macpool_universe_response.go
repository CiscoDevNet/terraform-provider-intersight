...
func (dst *MacpoolUniverseResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'macpool.Universe.List'
	if jsonDict["ObjectType"] == "macpool.Universe.List" {
		// try to unmarshal JSON data into MacpoolUniverseList
		err = json.Unmarshal(data, &dst.MacpoolUniverseList)
		if err == nil {
			return nil // data stored in dst.MacpoolUniverseList, return on the first match
		} else {
			dst.MacpoolUniverseList = nil
			return fmt.Errorf("Failed to unmarshal MacpoolUniverseResponse as MacpoolUniverseList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MacpoolUniverseResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MacpoolUniverseResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal MacpoolUniverseResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src MacpoolUniverseResponse) MarshalJSON() ([]byte, error) {
	if src.MacpoolUniverseList != nil {
		return json.Marshal(&src.MacpoolUniverseList)
	}
...
type NullableMacpoolUniverseResponse struct {
	value *MacpoolUniverseResponse
	isSet bool
}

func (v NullableMacpoolUniverseResponse) Get() *MacpoolUniverseResponse {
	return v.value
}

func (v *NullableMacpoolUniverseResponse) Set(val *MacpoolUniverseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMacpoolUniverseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMacpoolUniverseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMacpoolUniverseResponse(val *MacpoolUniverseResponse) *NullableMacpoolUniverseResponse {
	return &NullableMacpoolUniverseResponse{value: val, isSet: true}
}

func (v NullableMacpoolUniverseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMacpoolUniverseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
