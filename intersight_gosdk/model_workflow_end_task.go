...
func (o *WorkflowEndTask) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varWorkflowEndTaskWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varWorkflowEndTask)
	if err == nil {
