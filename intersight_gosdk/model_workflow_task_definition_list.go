...
func (o *WorkflowTaskDefinitionList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varWorkflowTaskDefinitionListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varWorkflowTaskDefinitionList)
	if err == nil {
