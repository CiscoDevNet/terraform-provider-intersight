...
// checks if the SoftwareHyperflexDistributable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareHyperflexDistributable{}
...
// GetDefaultClassId returns the default value "software.HyperflexDistributable" of the ClassId field.
func (o *SoftwareHyperflexDistributable) GetDefaultClassId() interface{} {
	return "software.HyperflexDistributable"
}
...
// GetDefaultObjectType returns the default value "software.HyperflexDistributable" of the ObjectType field.
func (o *SoftwareHyperflexDistributable) GetDefaultObjectType() interface{} {
	return "software.HyperflexDistributable"
}
...
func (o *SoftwareHyperflexDistributable) SetCatalogNil() {
	o.Catalog.Set(nil)
}
...
func (o SoftwareHyperflexDistributable) ToMap() (map[string]interface{}, error) {
...
func (o *SoftwareHyperflexDistributable) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSoftwareHyperflexDistributableWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSoftwareHyperflexDistributable)
	if err == nil {
