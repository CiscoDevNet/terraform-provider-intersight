...
func KubernetesAciCniTenantClusterAllocationListAsKubernetesAciCniTenantClusterAllocationResponse(v *KubernetesAciCniTenantClusterAllocationList) KubernetesAciCniTenantClusterAllocationResponse {
	return KubernetesAciCniTenantClusterAllocationResponse{
		KubernetesAciCniTenantClusterAllocationList: v,
	}
}
...
func (dst *KubernetesAciCniTenantClusterAllocationResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "kubernetes.AciCniTenantClusterAllocation.List" {
		// try to unmarshal JSON data into KubernetesAciCniTenantClusterAllocationList
		err = json.Unmarshal(data, &dst.KubernetesAciCniTenantClusterAllocationList)
		if err == nil {
			return nil // data stored in dst.KubernetesAciCniTenantClusterAllocationList, return on the first match
		} else {
			dst.KubernetesAciCniTenantClusterAllocationList = nil
			return fmt.Errorf("Failed to unmarshal KubernetesAciCniTenantClusterAllocationResponse as KubernetesAciCniTenantClusterAllocationList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal KubernetesAciCniTenantClusterAllocationResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal KubernetesAciCniTenantClusterAllocationResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal KubernetesAciCniTenantClusterAllocationResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src KubernetesAciCniTenantClusterAllocationResponse) MarshalJSON() ([]byte, error) {
	if src.KubernetesAciCniTenantClusterAllocationList != nil {
		return json.Marshal(&src.KubernetesAciCniTenantClusterAllocationList)
	}
...
type NullableKubernetesAciCniTenantClusterAllocationResponse struct {
	value *KubernetesAciCniTenantClusterAllocationResponse
	isSet bool
}

func (v NullableKubernetesAciCniTenantClusterAllocationResponse) Get() *KubernetesAciCniTenantClusterAllocationResponse {
	return v.value
}

func (v *NullableKubernetesAciCniTenantClusterAllocationResponse) Set(val *KubernetesAciCniTenantClusterAllocationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesAciCniTenantClusterAllocationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesAciCniTenantClusterAllocationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesAciCniTenantClusterAllocationResponse(val *KubernetesAciCniTenantClusterAllocationResponse) *NullableKubernetesAciCniTenantClusterAllocationResponse {
	return &NullableKubernetesAciCniTenantClusterAllocationResponse{value: val, isSet: true}
}

func (v NullableKubernetesAciCniTenantClusterAllocationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesAciCniTenantClusterAllocationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
