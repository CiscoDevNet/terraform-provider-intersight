...
func Test_intersight_NiaapiApiService(t *testing.T) {
	...
	t.Run("Test NiaapiApiService GetNiaapiNdEncryptedFileDownloadByMoid", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var moid string

		resp, httpRes, err := apiClient.NiaapiApi.GetNiaapiNdEncryptedFileDownloadByMoid(context.Background(), moid).Execute()
	...
	t.Run("Test NiaapiApiService GetNiaapiNdEncryptedFileDownloadList", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.NiaapiApi.GetNiaapiNdEncryptedFileDownloadList(context.Background()).Execute()
	...
	t.Run("Test NiaapiApiService GetNiaapiNdMetadataSoftwareDownloadByMoid", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var moid string

		resp, httpRes, err := apiClient.NiaapiApi.GetNiaapiNdMetadataSoftwareDownloadByMoid(context.Background(), moid).Execute()
	...
	t.Run("Test NiaapiApiService GetNiaapiNdMetadataSoftwareDownloadList", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		resp, httpRes, err := apiClient.NiaapiApi.GetNiaapiNdMetadataSoftwareDownloadList(context.Background()).Execute()
