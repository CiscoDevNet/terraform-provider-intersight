...
func (o *StorageNetAppEthernetPortList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppEthernetPortListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppEthernetPortList)
	if err == nil {
