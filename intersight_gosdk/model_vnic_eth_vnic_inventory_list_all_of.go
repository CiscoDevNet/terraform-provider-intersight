...
// VnicEthVnicInventoryListAllOf struct for VnicEthVnicInventoryListAllOf
type VnicEthVnicInventoryListAllOf struct {
...
type _VnicEthVnicInventoryListAllOf VnicEthVnicInventoryListAllOf
...
func NewVnicEthVnicInventoryListAllOf() *VnicEthVnicInventoryListAllOf {
	this := VnicEthVnicInventoryListAllOf{}
	return &this
}
...
func (o VnicEthVnicInventoryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicEthVnicInventoryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicEthVnicInventoryListAllOf := _VnicEthVnicInventoryListAllOf{}

	if err = json.Unmarshal(bytes, &varVnicEthVnicInventoryListAllOf); err == nil {
		*o = VnicEthVnicInventoryListAllOf(varVnicEthVnicInventoryListAllOf)
	}
...
type NullableVnicEthVnicInventoryListAllOf struct {
	value *VnicEthVnicInventoryListAllOf
	isSet bool
}

func (v NullableVnicEthVnicInventoryListAllOf) Get() *VnicEthVnicInventoryListAllOf {
	return v.value
}

func (v *NullableVnicEthVnicInventoryListAllOf) Set(val *VnicEthVnicInventoryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicEthVnicInventoryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicEthVnicInventoryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicEthVnicInventoryListAllOf(val *VnicEthVnicInventoryListAllOf) *NullableVnicEthVnicInventoryListAllOf {
	return &NullableVnicEthVnicInventoryListAllOf{value: val, isSet: true}
}

func (v NullableVnicEthVnicInventoryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicEthVnicInventoryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
