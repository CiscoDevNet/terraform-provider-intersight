...
// VnicFcVethInventoryListAllOf struct for VnicFcVethInventoryListAllOf
type VnicFcVethInventoryListAllOf struct {
...
type _VnicFcVethInventoryListAllOf VnicFcVethInventoryListAllOf
...
func NewVnicFcVethInventoryListAllOf() *VnicFcVethInventoryListAllOf {
	this := VnicFcVethInventoryListAllOf{}
	return &this
}
...
func (o VnicFcVethInventoryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicFcVethInventoryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicFcVethInventoryListAllOf := _VnicFcVethInventoryListAllOf{}

	if err = json.Unmarshal(bytes, &varVnicFcVethInventoryListAllOf); err == nil {
		*o = VnicFcVethInventoryListAllOf(varVnicFcVethInventoryListAllOf)
	}
...
type NullableVnicFcVethInventoryListAllOf struct {
	value *VnicFcVethInventoryListAllOf
	isSet bool
}

func (v NullableVnicFcVethInventoryListAllOf) Get() *VnicFcVethInventoryListAllOf {
	return v.value
}

func (v *NullableVnicFcVethInventoryListAllOf) Set(val *VnicFcVethInventoryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicFcVethInventoryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicFcVethInventoryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicFcVethInventoryListAllOf(val *VnicFcVethInventoryListAllOf) *NullableVnicFcVethInventoryListAllOf {
	return &NullableVnicFcVethInventoryListAllOf{value: val, isSet: true}
}

func (v NullableVnicFcVethInventoryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicFcVethInventoryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
