...
type ApplianceUpgrade struct {
	...
	PreviousInstallAttempts *int64 `json:"PreviousInstallAttempts,omitempty"`
...
// GetPreviousInstallAttempts returns the PreviousInstallAttempts field value if set, zero value otherwise.
func (o *ApplianceUpgrade) GetPreviousInstallAttempts() int64 {
	if o == nil || IsNil(o.PreviousInstallAttempts) {
		var ret int64
		return ret
	}
	return *o.PreviousInstallAttempts
}

// GetPreviousInstallAttemptsOk returns a tuple with the PreviousInstallAttempts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApplianceUpgrade) GetPreviousInstallAttemptsOk() (*int64, bool) {
	if o == nil || IsNil(o.PreviousInstallAttempts) {
		return nil, false
	}
	return o.PreviousInstallAttempts, true
}
...
// SetPreviousInstallAttempts gets a reference to the given int64 and assigns it to the PreviousInstallAttempts field.
func (o *ApplianceUpgrade) SetPreviousInstallAttempts(v int64) {
	o.PreviousInstallAttempts = &v
}
...
func (o ApplianceUpgrade) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PreviousInstallAttempts) {
		toSerialize["PreviousInstallAttempts"] = o.PreviousInstallAttempts
	}
...
func (o *ApplianceUpgrade) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varApplianceUpgrade.PreviousInstallAttempts = varApplianceUpgradeWithoutEmbeddedStruct.PreviousInstallAttempts
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "PreviousInstallAttempts")
