...
// WorkflowTaskDefinitionListAllOf struct for WorkflowTaskDefinitionListAllOf
type WorkflowTaskDefinitionListAllOf struct {
...
type _WorkflowTaskDefinitionListAllOf WorkflowTaskDefinitionListAllOf
...
func NewWorkflowTaskDefinitionListAllOf() *WorkflowTaskDefinitionListAllOf {
	this := WorkflowTaskDefinitionListAllOf{}
	return &this
}
...
func (o WorkflowTaskDefinitionListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *WorkflowTaskDefinitionListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varWorkflowTaskDefinitionListAllOf := _WorkflowTaskDefinitionListAllOf{}

	if err = json.Unmarshal(bytes, &varWorkflowTaskDefinitionListAllOf); err == nil {
		*o = WorkflowTaskDefinitionListAllOf(varWorkflowTaskDefinitionListAllOf)
	}
...
type NullableWorkflowTaskDefinitionListAllOf struct {
	value *WorkflowTaskDefinitionListAllOf
	isSet bool
}

func (v NullableWorkflowTaskDefinitionListAllOf) Get() *WorkflowTaskDefinitionListAllOf {
	return v.value
}

func (v *NullableWorkflowTaskDefinitionListAllOf) Set(val *WorkflowTaskDefinitionListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTaskDefinitionListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTaskDefinitionListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTaskDefinitionListAllOf(val *WorkflowTaskDefinitionListAllOf) *NullableWorkflowTaskDefinitionListAllOf {
	return &NullableWorkflowTaskDefinitionListAllOf{value: val, isSet: true}
}

func (v NullableWorkflowTaskDefinitionListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowTaskDefinitionListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
