...
// CloudSkuDatabaseTypeListAllOf struct for CloudSkuDatabaseTypeListAllOf
type CloudSkuDatabaseTypeListAllOf struct {
...
type _CloudSkuDatabaseTypeListAllOf CloudSkuDatabaseTypeListAllOf
...
func NewCloudSkuDatabaseTypeListAllOf() *CloudSkuDatabaseTypeListAllOf {
	this := CloudSkuDatabaseTypeListAllOf{}
	return &this
}
...
func (o CloudSkuDatabaseTypeListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CloudSkuDatabaseTypeListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCloudSkuDatabaseTypeListAllOf := _CloudSkuDatabaseTypeListAllOf{}

	if err = json.Unmarshal(bytes, &varCloudSkuDatabaseTypeListAllOf); err == nil {
		*o = CloudSkuDatabaseTypeListAllOf(varCloudSkuDatabaseTypeListAllOf)
	}
...
type NullableCloudSkuDatabaseTypeListAllOf struct {
	value *CloudSkuDatabaseTypeListAllOf
	isSet bool
}

func (v NullableCloudSkuDatabaseTypeListAllOf) Get() *CloudSkuDatabaseTypeListAllOf {
	return v.value
}

func (v *NullableCloudSkuDatabaseTypeListAllOf) Set(val *CloudSkuDatabaseTypeListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudSkuDatabaseTypeListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudSkuDatabaseTypeListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudSkuDatabaseTypeListAllOf(val *CloudSkuDatabaseTypeListAllOf) *NullableCloudSkuDatabaseTypeListAllOf {
	return &NullableCloudSkuDatabaseTypeListAllOf{value: val, isSet: true}
}

func (v NullableCloudSkuDatabaseTypeListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudSkuDatabaseTypeListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
