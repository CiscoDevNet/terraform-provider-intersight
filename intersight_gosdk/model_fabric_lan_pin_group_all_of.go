...
// FabricLanPinGroupAllOf Definition of the list of properties defined in 'fabric.LanPinGroup', excluding properties defined in parent classes.
type FabricLanPinGroupAllOf struct {
...
type _FabricLanPinGroupAllOf FabricLanPinGroupAllOf
...
func (o FabricLanPinGroupAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricLanPinGroupAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricLanPinGroupAllOf := _FabricLanPinGroupAllOf{}

	if err = json.Unmarshal(bytes, &varFabricLanPinGroupAllOf); err == nil {
		*o = FabricLanPinGroupAllOf(varFabricLanPinGroupAllOf)
	}
...
type NullableFabricLanPinGroupAllOf struct {
	value *FabricLanPinGroupAllOf
	isSet bool
}

func (v NullableFabricLanPinGroupAllOf) Get() *FabricLanPinGroupAllOf {
	return v.value
}

func (v *NullableFabricLanPinGroupAllOf) Set(val *FabricLanPinGroupAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricLanPinGroupAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricLanPinGroupAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricLanPinGroupAllOf(val *FabricLanPinGroupAllOf) *NullableFabricLanPinGroupAllOf {
	return &NullableFabricLanPinGroupAllOf{value: val, isSet: true}
}

func (v NullableFabricLanPinGroupAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricLanPinGroupAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
