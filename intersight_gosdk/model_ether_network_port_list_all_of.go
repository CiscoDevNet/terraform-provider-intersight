...
// EtherNetworkPortListAllOf struct for EtherNetworkPortListAllOf
type EtherNetworkPortListAllOf struct {
...
type _EtherNetworkPortListAllOf EtherNetworkPortListAllOf
...
func NewEtherNetworkPortListAllOf() *EtherNetworkPortListAllOf {
	this := EtherNetworkPortListAllOf{}
	return &this
}
...
func (o EtherNetworkPortListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *EtherNetworkPortListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varEtherNetworkPortListAllOf := _EtherNetworkPortListAllOf{}

	if err = json.Unmarshal(bytes, &varEtherNetworkPortListAllOf); err == nil {
		*o = EtherNetworkPortListAllOf(varEtherNetworkPortListAllOf)
	}
...
type NullableEtherNetworkPortListAllOf struct {
	value *EtherNetworkPortListAllOf
	isSet bool
}

func (v NullableEtherNetworkPortListAllOf) Get() *EtherNetworkPortListAllOf {
	return v.value
}

func (v *NullableEtherNetworkPortListAllOf) Set(val *EtherNetworkPortListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEtherNetworkPortListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEtherNetworkPortListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEtherNetworkPortListAllOf(val *EtherNetworkPortListAllOf) *NullableEtherNetworkPortListAllOf {
	return &NullableEtherNetworkPortListAllOf{value: val, isSet: true}
}

func (v NullableEtherNetworkPortListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEtherNetworkPortListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
