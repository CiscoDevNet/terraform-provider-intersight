...
func (dst *AdapterConfigPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'adapter.ConfigPolicy.List'
	if jsonDict["ObjectType"] == "adapter.ConfigPolicy.List" {
		// try to unmarshal JSON data into AdapterConfigPolicyList
		err = json.Unmarshal(data, &dst.AdapterConfigPolicyList)
		if err == nil {
			return nil // data stored in dst.AdapterConfigPolicyList, return on the first match
		} else {
			dst.AdapterConfigPolicyList = nil
			return fmt.Errorf("Failed to unmarshal AdapterConfigPolicyResponse as AdapterConfigPolicyList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AdapterConfigPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AdapterConfigPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AdapterConfigPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src AdapterConfigPolicyResponse) MarshalJSON() ([]byte, error) {
	if src.AdapterConfigPolicyList != nil {
		return json.Marshal(&src.AdapterConfigPolicyList)
	}
...
type NullableAdapterConfigPolicyResponse struct {
	value *AdapterConfigPolicyResponse
	isSet bool
}

func (v NullableAdapterConfigPolicyResponse) Get() *AdapterConfigPolicyResponse {
	return v.value
}

func (v *NullableAdapterConfigPolicyResponse) Set(val *AdapterConfigPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAdapterConfigPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAdapterConfigPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdapterConfigPolicyResponse(val *AdapterConfigPolicyResponse) *NullableAdapterConfigPolicyResponse {
	return &NullableAdapterConfigPolicyResponse{value: val, isSet: true}
}

func (v NullableAdapterConfigPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdapterConfigPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
