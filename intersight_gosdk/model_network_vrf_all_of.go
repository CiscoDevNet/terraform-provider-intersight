...
// NetworkVrfAllOf Definition of the list of properties defined in 'network.Vrf', excluding properties defined in parent classes.
type NetworkVrfAllOf struct {
...
type _NetworkVrfAllOf NetworkVrfAllOf
...
func (o NetworkVrfAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NetworkVrfAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNetworkVrfAllOf := _NetworkVrfAllOf{}

	if err = json.Unmarshal(bytes, &varNetworkVrfAllOf); err == nil {
		*o = NetworkVrfAllOf(varNetworkVrfAllOf)
	}
...
type NullableNetworkVrfAllOf struct {
	value *NetworkVrfAllOf
	isSet bool
}

func (v NullableNetworkVrfAllOf) Get() *NetworkVrfAllOf {
	return v.value
}

func (v *NullableNetworkVrfAllOf) Set(val *NetworkVrfAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkVrfAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkVrfAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkVrfAllOf(val *NetworkVrfAllOf) *NullableNetworkVrfAllOf {
	return &NullableNetworkVrfAllOf{value: val, isSet: true}
}

func (v NullableNetworkVrfAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkVrfAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
