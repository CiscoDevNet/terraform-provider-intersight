...
func (o *SchedulerEveryCadenceParams) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSchedulerEveryCadenceParamsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSchedulerEveryCadenceParams)
	if err == nil {
