...
// checks if the FirmwareHttpServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirmwareHttpServer{}
...
// GetDefaultClassId returns the default value "firmware.HttpServer" of the ClassId field.
func (o *FirmwareHttpServer) GetDefaultClassId() interface{} {
	return "firmware.HttpServer"
}
...
// GetDefaultObjectType returns the default value "firmware.HttpServer" of the ObjectType field.
func (o *FirmwareHttpServer) GetDefaultObjectType() interface{} {
	return "firmware.HttpServer"
}
...
func (o FirmwareHttpServer) ToMap() (map[string]interface{}, error) {
...
func (o *FirmwareHttpServer) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFirmwareHttpServerWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFirmwareHttpServer)
	if err == nil {
