...
// GetAnsiblePackages returns the AnsiblePackages field value if set, zero value otherwise.
...
// GetDcPackages returns the DcPackages field value if set, zero value otherwise.
...
// GetDebugPackages returns the DebugPackages field value if set, zero value otherwise.
...
// GetEndpointPackages returns the EndpointPackages field value if set, zero value otherwise.
...
// GetInfraPackages returns the InfraPackages field value if set, zero value otherwise.
...
// GetInitPackages returns the InitPackages field value if set, zero value otherwise.
...
// GetServicePackages returns the ServicePackages field value if set, zero value otherwise.
