...
// checks if the CapabilityPsuDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityPsuDescriptor{}

// CapabilityPsuDescriptor The capability.PsuDescriptor object is a hardware descriptor that uniquely identifies a Power Supply Unit (PSU) within the capability catalog. It serves as a reference record for specific models of PSUs. #### Purpose The purpose of this object is to maintain a catalog of known PSU models. By capturing key identifiers like vendor, model, version, and revision, it allows the system to validate the PSUs installed in a server or chassis. This ensures that the components are recognized, supported, and compatible with the equipment they are installed in. #### Key Concepts - **Hardware Cataloging:** Provides a structured entry for a specific PSU model in the system's hardware catalog. - **Unique Identification:** Uses a composite key of vendor, model, version, and revision to uniquely identify a PSU type. - **Component Validation:** Enables the system to verify that the PSUs discovered in a device match the known, supported hardware definitions. - **Extensible Framework:** As a HardwareDescriptor, it is part of an extensible catalog that can be updated with new PSU models as they become available.
...
// GetDefaultClassId returns the default value "capability.PsuDescriptor" of the ClassId field.
func (o *CapabilityPsuDescriptor) GetDefaultClassId() interface{} {
	return "capability.PsuDescriptor"
}
...
// GetDefaultObjectType returns the default value "capability.PsuDescriptor" of the ObjectType field.
func (o *CapabilityPsuDescriptor) GetDefaultObjectType() interface{} {
	return "capability.PsuDescriptor"
}
...
func (o CapabilityPsuDescriptor) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityPsuDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityPsuDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityPsuDescriptor)
	if err == nil {
