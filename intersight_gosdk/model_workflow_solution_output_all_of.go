...
// WorkflowSolutionOutputAllOf Definition of the list of properties defined in 'workflow.SolutionOutput', excluding properties defined in parent classes.
type WorkflowSolutionOutputAllOf struct {
...
type _WorkflowSolutionOutputAllOf WorkflowSolutionOutputAllOf
...
func NewWorkflowSolutionOutputAllOf(classId string, objectType string) *WorkflowSolutionOutputAllOf {
	this := WorkflowSolutionOutputAllOf{}
...
func (o WorkflowSolutionOutputAllOf) MarshalJSON() ([]byte, error) {
...
func (o *WorkflowSolutionOutputAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varWorkflowSolutionOutputAllOf := _WorkflowSolutionOutputAllOf{}

	if err = json.Unmarshal(bytes, &varWorkflowSolutionOutputAllOf); err == nil {
		*o = WorkflowSolutionOutputAllOf(varWorkflowSolutionOutputAllOf)
	}
...
type NullableWorkflowSolutionOutputAllOf struct {
	value *WorkflowSolutionOutputAllOf
	isSet bool
}

func (v NullableWorkflowSolutionOutputAllOf) Get() *WorkflowSolutionOutputAllOf {
	return v.value
}

func (v *NullableWorkflowSolutionOutputAllOf) Set(val *WorkflowSolutionOutputAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowSolutionOutputAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowSolutionOutputAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowSolutionOutputAllOf(val *WorkflowSolutionOutputAllOf) *NullableWorkflowSolutionOutputAllOf {
	return &NullableWorkflowSolutionOutputAllOf{value: val, isSet: true}
}

func (v NullableWorkflowSolutionOutputAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowSolutionOutputAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
