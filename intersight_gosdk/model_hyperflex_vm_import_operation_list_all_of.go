...
// HyperflexVmImportOperationListAllOf struct for HyperflexVmImportOperationListAllOf
type HyperflexVmImportOperationListAllOf struct {
...
type _HyperflexVmImportOperationListAllOf HyperflexVmImportOperationListAllOf
...
func NewHyperflexVmImportOperationListAllOf() *HyperflexVmImportOperationListAllOf {
	this := HyperflexVmImportOperationListAllOf{}
	return &this
}
...
func (o HyperflexVmImportOperationListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexVmImportOperationListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexVmImportOperationListAllOf := _HyperflexVmImportOperationListAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexVmImportOperationListAllOf); err == nil {
		*o = HyperflexVmImportOperationListAllOf(varHyperflexVmImportOperationListAllOf)
	}
...
type NullableHyperflexVmImportOperationListAllOf struct {
	value *HyperflexVmImportOperationListAllOf
	isSet bool
}

func (v NullableHyperflexVmImportOperationListAllOf) Get() *HyperflexVmImportOperationListAllOf {
	return v.value
}

func (v *NullableHyperflexVmImportOperationListAllOf) Set(val *HyperflexVmImportOperationListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexVmImportOperationListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexVmImportOperationListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexVmImportOperationListAllOf(val *HyperflexVmImportOperationListAllOf) *NullableHyperflexVmImportOperationListAllOf {
	return &NullableHyperflexVmImportOperationListAllOf{value: val, isSet: true}
}

func (v NullableHyperflexVmImportOperationListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexVmImportOperationListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
