...
// checks if the MetaDisplayNameDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetaDisplayNameDefinition{}
...
// GetDefaultClassId returns the default value "meta.DisplayNameDefinition" of the ClassId field.
func (o *MetaDisplayNameDefinition) GetDefaultClassId() interface{} {
	return "meta.DisplayNameDefinition"
}
...
// GetDefaultObjectType returns the default value "meta.DisplayNameDefinition" of the ObjectType field.
func (o *MetaDisplayNameDefinition) GetDefaultObjectType() interface{} {
	return "meta.DisplayNameDefinition"
}
...
func (o MetaDisplayNameDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *MetaDisplayNameDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMetaDisplayNameDefinitionWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varMetaDisplayNameDefinition)
	if err == nil {
