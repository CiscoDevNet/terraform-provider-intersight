...
// checks if the LicenseIwoCustomerOpList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LicenseIwoCustomerOpList{}
...
func NewLicenseIwoCustomerOpList(objectType string) *LicenseIwoCustomerOpList {
...
func (o LicenseIwoCustomerOpList) ToMap() (map[string]interface{}, error) {
...
func (o *LicenseIwoCustomerOpList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLicenseIwoCustomerOpListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varLicenseIwoCustomerOpList)
	if err == nil {
