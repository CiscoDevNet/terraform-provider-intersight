...
func (r apiDeleteMetaDefinitionRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "MetaApiService.DeleteMetaDefinition")
	if err != nil {
...
func (r apiGetMetaDefinitionByMoidRequest) Execute() (MetaDefinition, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "MetaApiService.GetMetaDefinitionByMoid")
	if err != nil {
...
func (r apiGetMetaDefinitionListRequest) Execute() (MetaDefinitionResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "MetaApiService.GetMetaDefinitionList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
