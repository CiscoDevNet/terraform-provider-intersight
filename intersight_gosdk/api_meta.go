...
func (r ApiDeleteMetaDefinitionRequest) Execute() (*_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *MetaApiService) DeleteMetaDefinitionExecute(r ApiDeleteMetaDefinitionRequest) (*_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetMetaDefinitionByMoidRequest) Execute() (MetaDefinition, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *MetaApiService) GetMetaDefinitionByMoidExecute(r ApiGetMetaDefinitionByMoidRequest) (MetaDefinition, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetMetaDefinitionListRequest) Execute() (MetaDefinitionResponse, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *MetaApiService) GetMetaDefinitionListExecute(r ApiGetMetaDefinitionListRequest) (MetaDefinitionResponse, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
