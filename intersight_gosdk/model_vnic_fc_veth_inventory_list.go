...
func (o *VnicFcVethInventoryList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVnicFcVethInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVnicFcVethInventoryList)
	if err == nil {
