...
// VnicIscsiBootPolicy The IscsiBootPolicy object encapsulates the configuration required to enable servers to boot from remote iSCSI targets over the network.  #### Purpose IscsiBootPolicy automates and standardizes the process of configuring iSCSI boot, including authentication, target selection, and IP address assignment, to ensure reliable and secure remote booting. #### Key Concepts - **Remote Boot Enablement:** Supports network-based operating system boot via iSCSI. - **Comprehensive Configuration:** Manages authentication, IP assignment, and target discovery. - **Policy Integration:** Links to adapter and IP pool policies for end-to-end automation.
...
func NewVnicIscsiBootPolicy(classId string, objectType string) *VnicIscsiBootPolicy {
	...
	var iscsiIpType string = "IPv4"
	this.IscsiIpType = &iscsiIpType
...
// GetDefaultClassId returns the default value "vnic.IscsiBootPolicy" of the ClassId field.
func (o *VnicIscsiBootPolicy) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "vnic.IscsiBootPolicy" of the ObjectType field.
func (o *VnicIscsiBootPolicy) GetDefaultObjectType() interface{} {
	return "vnic.IscsiBootPolicy"
}
...
func (o *VnicIscsiBootPolicy) SetInitiatorStaticIpV6ConfigNil() {
...
func (o *VnicIscsiBootPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varVnicIscsiBootPolicy.InitiatorStaticIpV6Address = varVnicIscsiBootPolicyWithoutEmbeddedStruct.InitiatorStaticIpV6Address
		varVnicIscsiBootPolicy.InitiatorStaticIpV6Config = varVnicIscsiBootPolicyWithoutEmbeddedStruct.InitiatorStaticIpV6Config
		varVnicIscsiBootPolicy.IscsiIpType = varVnicIscsiBootPolicyWithoutEmbeddedStruct.IscsiIpType
