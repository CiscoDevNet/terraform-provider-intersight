...
// StorageNetAppDataIpInterfaceEventAllOf Definition of the list of properties defined in 'storage.NetAppDataIpInterfaceEvent', excluding properties defined in parent classes.
type StorageNetAppDataIpInterfaceEventAllOf struct {
...
type _StorageNetAppDataIpInterfaceEventAllOf StorageNetAppDataIpInterfaceEventAllOf
...
func NewStorageNetAppDataIpInterfaceEventAllOf(classId string, objectType string) *StorageNetAppDataIpInterfaceEventAllOf {
	this := StorageNetAppDataIpInterfaceEventAllOf{}
...
func (o StorageNetAppDataIpInterfaceEventAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppDataIpInterfaceEventAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppDataIpInterfaceEventAllOf := _StorageNetAppDataIpInterfaceEventAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppDataIpInterfaceEventAllOf); err == nil {
		*o = StorageNetAppDataIpInterfaceEventAllOf(varStorageNetAppDataIpInterfaceEventAllOf)
	}
...
type NullableStorageNetAppDataIpInterfaceEventAllOf struct {
	value *StorageNetAppDataIpInterfaceEventAllOf
	isSet bool
}

func (v NullableStorageNetAppDataIpInterfaceEventAllOf) Get() *StorageNetAppDataIpInterfaceEventAllOf {
	return v.value
}

func (v *NullableStorageNetAppDataIpInterfaceEventAllOf) Set(val *StorageNetAppDataIpInterfaceEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppDataIpInterfaceEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppDataIpInterfaceEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppDataIpInterfaceEventAllOf(val *StorageNetAppDataIpInterfaceEventAllOf) *NullableStorageNetAppDataIpInterfaceEventAllOf {
	return &NullableStorageNetAppDataIpInterfaceEventAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppDataIpInterfaceEventAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppDataIpInterfaceEventAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
