...
func (o *VnicFcAdapterPolicyInventoryList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVnicFcAdapterPolicyInventoryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVnicFcAdapterPolicyInventoryList)
	if err == nil {
