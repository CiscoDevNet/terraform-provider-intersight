...
// StorageNvmeVirtualDriveConfigurationAllOf Definition of the list of properties defined in 'storage.NvmeVirtualDriveConfiguration', excluding properties defined in parent classes.
type StorageNvmeVirtualDriveConfigurationAllOf struct {
...
type _StorageNvmeVirtualDriveConfigurationAllOf StorageNvmeVirtualDriveConfigurationAllOf
...
func NewStorageNvmeVirtualDriveConfigurationAllOf(classId string, objectType string) *StorageNvmeVirtualDriveConfigurationAllOf {
	this := StorageNvmeVirtualDriveConfigurationAllOf{}
...
func (o StorageNvmeVirtualDriveConfigurationAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNvmeVirtualDriveConfigurationAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNvmeVirtualDriveConfigurationAllOf := _StorageNvmeVirtualDriveConfigurationAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNvmeVirtualDriveConfigurationAllOf); err == nil {
		*o = StorageNvmeVirtualDriveConfigurationAllOf(varStorageNvmeVirtualDriveConfigurationAllOf)
	}
...
type NullableStorageNvmeVirtualDriveConfigurationAllOf struct {
	value *StorageNvmeVirtualDriveConfigurationAllOf
	isSet bool
}

func (v NullableStorageNvmeVirtualDriveConfigurationAllOf) Get() *StorageNvmeVirtualDriveConfigurationAllOf {
	return v.value
}

func (v *NullableStorageNvmeVirtualDriveConfigurationAllOf) Set(val *StorageNvmeVirtualDriveConfigurationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNvmeVirtualDriveConfigurationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNvmeVirtualDriveConfigurationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNvmeVirtualDriveConfigurationAllOf(val *StorageNvmeVirtualDriveConfigurationAllOf) *NullableStorageNvmeVirtualDriveConfigurationAllOf {
	return &NullableStorageNvmeVirtualDriveConfigurationAllOf{value: val, isSet: true}
}

func (v NullableStorageNvmeVirtualDriveConfigurationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNvmeVirtualDriveConfigurationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
