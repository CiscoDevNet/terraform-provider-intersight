...
// checks if the BootPchStorageDeviceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BootPchStorageDeviceList{}
...
func (o BootPchStorageDeviceList) ToMap() (map[string]interface{}, error) {
...
func (o *BootPchStorageDeviceList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varBootPchStorageDeviceListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varBootPchStorageDeviceList)
	if err == nil {
