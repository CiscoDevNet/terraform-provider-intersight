...
// HyperflexEntityReferenceAllOf Definition of the list of properties defined in 'hyperflex.EntityReference', excluding properties defined in parent classes.
type HyperflexEntityReferenceAllOf struct {
...
type _HyperflexEntityReferenceAllOf HyperflexEntityReferenceAllOf

// NewHyperflexEntityReferenceAllOf instantiates a new HyperflexEntityReferenceAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHyperflexEntityReferenceAllOf(classId string, objectType string) *HyperflexEntityReferenceAllOf {
	this := HyperflexEntityReferenceAllOf{}
...
func (o HyperflexEntityReferenceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexEntityReferenceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexEntityReferenceAllOf := _HyperflexEntityReferenceAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexEntityReferenceAllOf); err == nil {
		*o = HyperflexEntityReferenceAllOf(varHyperflexEntityReferenceAllOf)
	}
...
type NullableHyperflexEntityReferenceAllOf struct {
	value *HyperflexEntityReferenceAllOf
	isSet bool
}

func (v NullableHyperflexEntityReferenceAllOf) Get() *HyperflexEntityReferenceAllOf {
	return v.value
}

func (v *NullableHyperflexEntityReferenceAllOf) Set(val *HyperflexEntityReferenceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexEntityReferenceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexEntityReferenceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexEntityReferenceAllOf(val *HyperflexEntityReferenceAllOf) *NullableHyperflexEntityReferenceAllOf {
	return &NullableHyperflexEntityReferenceAllOf{value: val, isSet: true}
}

func (v NullableHyperflexEntityReferenceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexEntityReferenceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
