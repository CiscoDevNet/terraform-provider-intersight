...
func (dst *IaasUcsdMessagesResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'iaas.UcsdMessages.List'
	if jsonDict["ObjectType"] == "iaas.UcsdMessages.List" {
		// try to unmarshal JSON data into IaasUcsdMessagesList
		err = json.Unmarshal(data, &dst.IaasUcsdMessagesList)
		if err == nil {
			return nil // data stored in dst.IaasUcsdMessagesList, return on the first match
		} else {
			dst.IaasUcsdMessagesList = nil
			return fmt.Errorf("failed to unmarshal IaasUcsdMessagesResponse as IaasUcsdMessagesList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal IaasUcsdMessagesResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal IaasUcsdMessagesResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal IaasUcsdMessagesResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src IaasUcsdMessagesResponse) MarshalJSON() ([]byte, error) {
	if src.IaasUcsdMessagesList != nil {
		return json.Marshal(&src.IaasUcsdMessagesList)
	}
...
type NullableIaasUcsdMessagesResponse struct {
	value *IaasUcsdMessagesResponse
	isSet bool
}

func (v NullableIaasUcsdMessagesResponse) Get() *IaasUcsdMessagesResponse {
	return v.value
}

func (v *NullableIaasUcsdMessagesResponse) Set(val *IaasUcsdMessagesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIaasUcsdMessagesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIaasUcsdMessagesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIaasUcsdMessagesResponse(val *IaasUcsdMessagesResponse) *NullableIaasUcsdMessagesResponse {
	return &NullableIaasUcsdMessagesResponse{value: val, isSet: true}
}

func (v NullableIaasUcsdMessagesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIaasUcsdMessagesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
