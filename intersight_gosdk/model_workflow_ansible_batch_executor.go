...
// checks if the WorkflowAnsibleBatchExecutor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowAnsibleBatchExecutor{}
...
// GetDefaultClassId returns the default value "workflow.AnsibleBatchExecutor" of the ClassId field.
func (o *WorkflowAnsibleBatchExecutor) GetDefaultClassId() interface{} {
	return "workflow.AnsibleBatchExecutor"
}
...
// GetDefaultObjectType returns the default value "workflow.AnsibleBatchExecutor" of the ObjectType field.
func (o *WorkflowAnsibleBatchExecutor) GetDefaultObjectType() interface{} {
	return "workflow.AnsibleBatchExecutor"
}
...
func (o *WorkflowAnsibleBatchExecutor) SetTaskDefinitionNil() {
...
func (o WorkflowAnsibleBatchExecutor) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowAnsibleBatchExecutor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowAnsibleBatchExecutorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowAnsibleBatchExecutor)
	if err == nil {
