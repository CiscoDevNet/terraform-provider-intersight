...
// checks if the NiatelemetryApicTransceiverDetailsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryApicTransceiverDetailsList{}
...
func NewNiatelemetryApicTransceiverDetailsList(objectType string) *NiatelemetryApicTransceiverDetailsList {
...
func (o NiatelemetryApicTransceiverDetailsList) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryApicTransceiverDetailsList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryApicTransceiverDetailsListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryApicTransceiverDetailsList)
	if err == nil {
