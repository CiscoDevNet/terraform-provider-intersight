...
// checks if the NiatelemetrySystemControllerDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetrySystemControllerDetails{}
...
// GetDefaultClassId returns the default value "niatelemetry.SystemControllerDetails" of the ClassId field.
func (o *NiatelemetrySystemControllerDetails) GetDefaultClassId() interface{} {
	return "niatelemetry.SystemControllerDetails"
}
...
// GetDefaultObjectType returns the default value "niatelemetry.SystemControllerDetails" of the ObjectType field.
func (o *NiatelemetrySystemControllerDetails) GetDefaultObjectType() interface{} {
	return "niatelemetry.SystemControllerDetails"
}
...
func (o *NiatelemetrySystemControllerDetails) SetRegisteredDeviceNil() {
...
func (o NiatelemetrySystemControllerDetails) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetrySystemControllerDetails) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetrySystemControllerDetailsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetrySystemControllerDetails)
	if err == nil {
