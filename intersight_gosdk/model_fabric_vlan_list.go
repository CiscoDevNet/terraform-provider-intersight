...
// checks if the FabricVlanList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricVlanList{}
...
func NewFabricVlanList(objectType string) *FabricVlanList {
	this := FabricVlanList{}
...
func (o FabricVlanList) ToMap() (map[string]interface{}, error) {
...
func (o *FabricVlanList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricVlanListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricVlanList)
	if err == nil {
