...
func (o *ConfigMoRef) UnmarshalJSON(bytes []byte) (err error) {
	type ConfigMoRefWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varConfigMoRefWithoutEmbeddedStruct := ConfigMoRefWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varConfigMoRefWithoutEmbeddedStruct)
	if err == nil {
		varConfigMoRef := _ConfigMoRef{}
		varConfigMoRef.ClassId = varConfigMoRefWithoutEmbeddedStruct.ClassId
		varConfigMoRef.ObjectType = varConfigMoRefWithoutEmbeddedStruct.ObjectType
		varConfigMoRef.Moid = varConfigMoRefWithoutEmbeddedStruct.Moid
	...
	err = json.Unmarshal(bytes, &varConfigMoRef)
	if err == nil {
		o.MoBaseComplexType = varConfigMoRef.MoBaseComplexType
	} else {
		return err
	}
