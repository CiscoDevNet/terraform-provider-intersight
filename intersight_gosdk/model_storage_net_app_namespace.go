...
func (o *StorageNetAppNamespace) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppNamespaceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppNamespace)
	if err == nil {
