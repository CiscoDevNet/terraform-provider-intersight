...
// VirtualizationVmInterface Virtual machine interfaces.
...
type _VirtualizationVmInterface VirtualizationVmInterface
...
func NewVirtualizationVmInterface(classId string, objectType string) *VirtualizationVmInterface {
	this := VirtualizationVmInterface{}
...
func (o VirtualizationVmInterface) MarshalJSON() ([]byte, error) {
...
func (o *VirtualizationVmInterface) UnmarshalJSON(bytes []byte) (err error) {
	type VirtualizationVmInterfaceWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varVirtualizationVmInterfaceWithoutEmbeddedStruct := VirtualizationVmInterfaceWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varVirtualizationVmInterfaceWithoutEmbeddedStruct)
	if err == nil {
		varVirtualizationVmInterface := _VirtualizationVmInterface{}
		varVirtualizationVmInterface.ClassId = varVirtualizationVmInterfaceWithoutEmbeddedStruct.ClassId
		varVirtualizationVmInterface.ObjectType = varVirtualizationVmInterfaceWithoutEmbeddedStruct.ObjectType
		varVirtualizationVmInterface.Bridge = varVirtualizationVmInterfaceWithoutEmbeddedStruct.Bridge
		varVirtualizationVmInterface.IpAddress = varVirtualizationVmInterfaceWithoutEmbeddedStruct.IpAddress
		varVirtualizationVmInterface.MacAddress = varVirtualizationVmInterfaceWithoutEmbeddedStruct.MacAddress
		varVirtualizationVmInterface.Model = varVirtualizationVmInterfaceWithoutEmbeddedStruct.Model
		varVirtualizationVmInterface.Name = varVirtualizationVmInterfaceWithoutEmbeddedStruct.Name
		*o = VirtualizationVmInterface(varVirtualizationVmInterface)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varVirtualizationVmInterface)
	if err == nil {
		o.MoBaseComplexType = varVirtualizationVmInterface.MoBaseComplexType
	} else {
		return err
	}
...
type NullableVirtualizationVmInterface struct {
	value *VirtualizationVmInterface
	isSet bool
}

func (v NullableVirtualizationVmInterface) Get() *VirtualizationVmInterface {
	return v.value
}

func (v *NullableVirtualizationVmInterface) Set(val *VirtualizationVmInterface) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmInterface) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmInterface) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmInterface(val *VirtualizationVmInterface) *NullableVirtualizationVmInterface {
	return &NullableVirtualizationVmInterface{value: val, isSet: true}
}

func (v NullableVirtualizationVmInterface) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmInterface) UnmarshalJSON(src []byte) error {
	v.isSet = true
