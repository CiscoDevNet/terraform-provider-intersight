...
// checks if the StorageBaseArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageBaseArray{}
...
func (o StorageBaseArray) ToMap() (map[string]interface{}, error) {
...
func (o *StorageBaseArray) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageBaseArrayWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageBaseArray)
	if err == nil {
