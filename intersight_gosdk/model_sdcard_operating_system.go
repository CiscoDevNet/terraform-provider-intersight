...
// checks if the SdcardOperatingSystem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdcardOperatingSystem{}
...
// GetDefaultClassId returns the default value "sdcard.OperatingSystem" of the ClassId field.
func (o *SdcardOperatingSystem) GetDefaultClassId() interface{} {
	return "sdcard.OperatingSystem"
}
...
// GetDefaultObjectType returns the default value "sdcard.OperatingSystem" of the ObjectType field.
func (o *SdcardOperatingSystem) GetDefaultObjectType() interface{} {
	return "sdcard.OperatingSystem"
}
...
func (o SdcardOperatingSystem) ToMap() (map[string]interface{}, error) {
...
func (o *SdcardOperatingSystem) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSdcardOperatingSystemWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSdcardOperatingSystem)
	if err == nil {
