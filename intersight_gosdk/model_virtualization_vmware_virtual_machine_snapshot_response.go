...
func VirtualizationVmwareVirtualMachineSnapshotListAsVirtualizationVmwareVirtualMachineSnapshotResponse(v *VirtualizationVmwareVirtualMachineSnapshotList) VirtualizationVmwareVirtualMachineSnapshotResponse {
	return VirtualizationVmwareVirtualMachineSnapshotResponse{
		VirtualizationVmwareVirtualMachineSnapshotList: v,
	}
}
...
func (dst *VirtualizationVmwareVirtualMachineSnapshotResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VirtualizationVmwareVirtualMachineSnapshotResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VirtualizationVmwareVirtualMachineSnapshotResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal VirtualizationVmwareVirtualMachineSnapshotResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'virtualization.VmwareVirtualMachineSnapshot.List'
	if jsonDict["ObjectType"] == "virtualization.VmwareVirtualMachineSnapshot.List" {
		// try to unmarshal JSON data into VirtualizationVmwareVirtualMachineSnapshotList
		err = json.Unmarshal(data, &dst.VirtualizationVmwareVirtualMachineSnapshotList)
		if err == nil {
			return nil // data stored in dst.VirtualizationVmwareVirtualMachineSnapshotList, return on the first match
		} else {
			dst.VirtualizationVmwareVirtualMachineSnapshotList = nil
			return fmt.Errorf("failed to unmarshal VirtualizationVmwareVirtualMachineSnapshotResponse as VirtualizationVmwareVirtualMachineSnapshotList: %s", err.Error())
		}
	}
...
func (src VirtualizationVmwareVirtualMachineSnapshotResponse) MarshalJSON() ([]byte, error) {
	...
	if src.VirtualizationVmwareVirtualMachineSnapshotList != nil {
		return json.Marshal(&src.VirtualizationVmwareVirtualMachineSnapshotList)
	}
...
func (obj *VirtualizationVmwareVirtualMachineSnapshotResponse) GetActualInstance() interface{} {
	...
	if obj.VirtualizationVmwareVirtualMachineSnapshotList != nil {
		return obj.VirtualizationVmwareVirtualMachineSnapshotList
	}
...
type NullableVirtualizationVmwareVirtualMachineSnapshotResponse struct {
	value *VirtualizationVmwareVirtualMachineSnapshotResponse
	isSet bool
}

func (v NullableVirtualizationVmwareVirtualMachineSnapshotResponse) Get() *VirtualizationVmwareVirtualMachineSnapshotResponse {
	return v.value
}

func (v *NullableVirtualizationVmwareVirtualMachineSnapshotResponse) Set(val *VirtualizationVmwareVirtualMachineSnapshotResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVmwareVirtualMachineSnapshotResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVmwareVirtualMachineSnapshotResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVmwareVirtualMachineSnapshotResponse(val *VirtualizationVmwareVirtualMachineSnapshotResponse) *NullableVirtualizationVmwareVirtualMachineSnapshotResponse {
	return &NullableVirtualizationVmwareVirtualMachineSnapshotResponse{value: val, isSet: true}
}

func (v NullableVirtualizationVmwareVirtualMachineSnapshotResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVmwareVirtualMachineSnapshotResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
