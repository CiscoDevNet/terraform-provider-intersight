...
func (o *CondAlarmClassificationEligibility) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCondAlarmClassificationEligibilityWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varCondAlarmClassificationEligibility)
	if err == nil {
