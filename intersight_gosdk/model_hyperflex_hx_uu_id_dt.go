...
// checks if the HyperflexHxUuIdDt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexHxUuIdDt{}
...
// GetDefaultClassId returns the default value "hyperflex.HxUuIdDt" of the ClassId field.
func (o *HyperflexHxUuIdDt) GetDefaultClassId() interface{} {
	return "hyperflex.HxUuIdDt"
}
...
// GetDefaultObjectType returns the default value "hyperflex.HxUuIdDt" of the ObjectType field.
func (o *HyperflexHxUuIdDt) GetDefaultObjectType() interface{} {
	return "hyperflex.HxUuIdDt"
}
...
func (o HyperflexHxUuIdDt) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexHxUuIdDt) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexHxUuIdDtWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexHxUuIdDt)
	if err == nil {
