...
// checks if the StoragePureDiskList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePureDiskList{}
...
func (o StoragePureDiskList) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePureDiskList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStoragePureDiskListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStoragePureDiskList)
	if err == nil {
