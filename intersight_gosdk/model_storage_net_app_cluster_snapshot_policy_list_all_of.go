...
// StorageNetAppClusterSnapshotPolicyListAllOf struct for StorageNetAppClusterSnapshotPolicyListAllOf
type StorageNetAppClusterSnapshotPolicyListAllOf struct {
...
type _StorageNetAppClusterSnapshotPolicyListAllOf StorageNetAppClusterSnapshotPolicyListAllOf
...
func NewStorageNetAppClusterSnapshotPolicyListAllOf() *StorageNetAppClusterSnapshotPolicyListAllOf {
	this := StorageNetAppClusterSnapshotPolicyListAllOf{}
	return &this
}
...
func (o StorageNetAppClusterSnapshotPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppClusterSnapshotPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppClusterSnapshotPolicyListAllOf := _StorageNetAppClusterSnapshotPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppClusterSnapshotPolicyListAllOf); err == nil {
		*o = StorageNetAppClusterSnapshotPolicyListAllOf(varStorageNetAppClusterSnapshotPolicyListAllOf)
	}
...
type NullableStorageNetAppClusterSnapshotPolicyListAllOf struct {
	value *StorageNetAppClusterSnapshotPolicyListAllOf
	isSet bool
}

func (v NullableStorageNetAppClusterSnapshotPolicyListAllOf) Get() *StorageNetAppClusterSnapshotPolicyListAllOf {
	return v.value
}

func (v *NullableStorageNetAppClusterSnapshotPolicyListAllOf) Set(val *StorageNetAppClusterSnapshotPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppClusterSnapshotPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppClusterSnapshotPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppClusterSnapshotPolicyListAllOf(val *StorageNetAppClusterSnapshotPolicyListAllOf) *NullableStorageNetAppClusterSnapshotPolicyListAllOf {
	return &NullableStorageNetAppClusterSnapshotPolicyListAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppClusterSnapshotPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppClusterSnapshotPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
