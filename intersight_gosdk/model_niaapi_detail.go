...
// checks if the NiaapiDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiaapiDetail{}
...
// GetDefaultClassId returns the default value "niaapi.Detail" of the ClassId field.
func (o *NiaapiDetail) GetDefaultClassId() interface{} {
	return "niaapi.Detail"
}
...
// GetDefaultObjectType returns the default value "niaapi.Detail" of the ObjectType field.
func (o *NiaapiDetail) GetDefaultObjectType() interface{} {
	return "niaapi.Detail"
}

// GetChksum returns the Chksum field value if set, zero value otherwise.
func (o *NiaapiDetail) GetChksum() string {
	if o == nil || IsNil(o.Chksum) {
		var ret string
		return ret
	}
	return *o.Chksum
...
func (o NiaapiDetail) ToMap() (map[string]interface{}, error) {
...
func (o *NiaapiDetail) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiaapiDetailWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiaapiDetail)
	if err == nil {
