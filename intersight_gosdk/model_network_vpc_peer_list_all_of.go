...
// NetworkVpcPeerListAllOf struct for NetworkVpcPeerListAllOf
type NetworkVpcPeerListAllOf struct {
...
type _NetworkVpcPeerListAllOf NetworkVpcPeerListAllOf
...
func (o NetworkVpcPeerListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NetworkVpcPeerListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNetworkVpcPeerListAllOf := _NetworkVpcPeerListAllOf{}

	if err = json.Unmarshal(bytes, &varNetworkVpcPeerListAllOf); err == nil {
		*o = NetworkVpcPeerListAllOf(varNetworkVpcPeerListAllOf)
	}
...
type NullableNetworkVpcPeerListAllOf struct {
	value *NetworkVpcPeerListAllOf
	isSet bool
}

func (v NullableNetworkVpcPeerListAllOf) Get() *NetworkVpcPeerListAllOf {
	return v.value
}

func (v *NullableNetworkVpcPeerListAllOf) Set(val *NetworkVpcPeerListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkVpcPeerListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkVpcPeerListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkVpcPeerListAllOf(val *NetworkVpcPeerListAllOf) *NullableNetworkVpcPeerListAllOf {
	return &NullableNetworkVpcPeerListAllOf{value: val, isSet: true}
}

func (v NullableNetworkVpcPeerListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkVpcPeerListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
