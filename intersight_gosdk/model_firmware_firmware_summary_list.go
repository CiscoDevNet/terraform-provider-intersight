...
// checks if the FirmwareFirmwareSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirmwareFirmwareSummaryList{}
...
type _FirmwareFirmwareSummaryList FirmwareFirmwareSummaryList
...
func NewFirmwareFirmwareSummaryList(objectType string) *FirmwareFirmwareSummaryList {
...
func (o FirmwareFirmwareSummaryList) ToMap() (map[string]interface{}, error) {
...
func (o *FirmwareFirmwareSummaryList) UnmarshalJSON(data []byte) (err error) {
	...
	type FirmwareFirmwareSummaryListWithoutEmbeddedStruct struct {
		// The total number of 'firmware.FirmwareSummary' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.
		Count *int32 `json:"Count,omitempty"`
		// The array of 'firmware.FirmwareSummary' resources matching the request.
		Results []FirmwareFirmwareSummary `json:"Results,omitempty"`
	...
	varFirmwareFirmwareSummaryListWithoutEmbeddedStruct := FirmwareFirmwareSummaryListWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varFirmwareFirmwareSummaryListWithoutEmbeddedStruct)
	if err == nil {
		varFirmwareFirmwareSummaryList := _FirmwareFirmwareSummaryList{}
		varFirmwareFirmwareSummaryList.Count = varFirmwareFirmwareSummaryListWithoutEmbeddedStruct.Count
		varFirmwareFirmwareSummaryList.Results = varFirmwareFirmwareSummaryListWithoutEmbeddedStruct.Results
		*o = FirmwareFirmwareSummaryList(varFirmwareFirmwareSummaryList)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varFirmwareFirmwareSummaryList)
	if err == nil {
		o.MoBaseResponse = varFirmwareFirmwareSummaryList.MoBaseResponse
	} else {
		return err
	}
