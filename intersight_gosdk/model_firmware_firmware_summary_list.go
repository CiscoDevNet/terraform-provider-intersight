...
func (o *FirmwareFirmwareSummaryList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFirmwareFirmwareSummaryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFirmwareFirmwareSummaryList)
	if err == nil {
