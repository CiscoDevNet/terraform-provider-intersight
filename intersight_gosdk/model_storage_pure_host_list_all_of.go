...
// StoragePureHostListAllOf struct for StoragePureHostListAllOf
type StoragePureHostListAllOf struct {
...
type _StoragePureHostListAllOf StoragePureHostListAllOf
...
func (o StoragePureHostListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StoragePureHostListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStoragePureHostListAllOf := _StoragePureHostListAllOf{}

	if err = json.Unmarshal(bytes, &varStoragePureHostListAllOf); err == nil {
		*o = StoragePureHostListAllOf(varStoragePureHostListAllOf)
	}
...
type NullableStoragePureHostListAllOf struct {
	value *StoragePureHostListAllOf
	isSet bool
}

func (v NullableStoragePureHostListAllOf) Get() *StoragePureHostListAllOf {
	return v.value
}

func (v *NullableStoragePureHostListAllOf) Set(val *StoragePureHostListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePureHostListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePureHostListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePureHostListAllOf(val *StoragePureHostListAllOf) *NullableStoragePureHostListAllOf {
	return &NullableStoragePureHostListAllOf{value: val, isSet: true}
}

func (v NullableStoragePureHostListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePureHostListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
