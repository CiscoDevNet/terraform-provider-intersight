...
// HyperflexClusterStoragePolicyListAllOf struct for HyperflexClusterStoragePolicyListAllOf
type HyperflexClusterStoragePolicyListAllOf struct {
...
type _HyperflexClusterStoragePolicyListAllOf HyperflexClusterStoragePolicyListAllOf
...
func NewHyperflexClusterStoragePolicyListAllOf() *HyperflexClusterStoragePolicyListAllOf {
	this := HyperflexClusterStoragePolicyListAllOf{}
	return &this
}
...
func (o HyperflexClusterStoragePolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *HyperflexClusterStoragePolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexClusterStoragePolicyListAllOf := _HyperflexClusterStoragePolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexClusterStoragePolicyListAllOf); err == nil {
		*o = HyperflexClusterStoragePolicyListAllOf(varHyperflexClusterStoragePolicyListAllOf)
	}
...
type NullableHyperflexClusterStoragePolicyListAllOf struct {
	value *HyperflexClusterStoragePolicyListAllOf
	isSet bool
}

func (v NullableHyperflexClusterStoragePolicyListAllOf) Get() *HyperflexClusterStoragePolicyListAllOf {
	return v.value
}

func (v *NullableHyperflexClusterStoragePolicyListAllOf) Set(val *HyperflexClusterStoragePolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperflexClusterStoragePolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperflexClusterStoragePolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperflexClusterStoragePolicyListAllOf(val *HyperflexClusterStoragePolicyListAllOf) *NullableHyperflexClusterStoragePolicyListAllOf {
	return &NullableHyperflexClusterStoragePolicyListAllOf{value: val, isSet: true}
}

func (v NullableHyperflexClusterStoragePolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperflexClusterStoragePolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
