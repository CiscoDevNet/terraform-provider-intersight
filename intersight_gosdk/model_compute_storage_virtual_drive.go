...
// checks if the ComputeStorageVirtualDrive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputeStorageVirtualDrive{}
...
// GetDefaultClassId returns the default value "compute.StorageVirtualDrive" of the ClassId field.
func (o *ComputeStorageVirtualDrive) GetDefaultClassId() interface{} {
	return "compute.StorageVirtualDrive"
}
...
// GetDefaultObjectType returns the default value "compute.StorageVirtualDrive" of the ObjectType field.
func (o *ComputeStorageVirtualDrive) GetDefaultObjectType() interface{} {
	return "compute.StorageVirtualDrive"
}
...
func (o ComputeStorageVirtualDrive) ToMap() (map[string]interface{}, error) {
...
func (o *ComputeStorageVirtualDrive) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varComputeStorageVirtualDriveWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varComputeStorageVirtualDrive)
	if err == nil {
