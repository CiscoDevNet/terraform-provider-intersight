...
// checks if the ConnectorStreamMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorStreamMessage{}
...
func (o ConnectorStreamMessage) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorStreamMessage) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConnectorStreamMessageWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varConnectorStreamMessage)
	if err == nil {
