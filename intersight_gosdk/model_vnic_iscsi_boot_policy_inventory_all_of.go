...
// VnicIscsiBootPolicyInventoryAllOf Definition of the list of properties defined in 'vnic.IscsiBootPolicyInventory', excluding properties defined in parent classes.
type VnicIscsiBootPolicyInventoryAllOf struct {
...
type _VnicIscsiBootPolicyInventoryAllOf VnicIscsiBootPolicyInventoryAllOf
...
func NewVnicIscsiBootPolicyInventoryAllOf(classId string, objectType string) *VnicIscsiBootPolicyInventoryAllOf {
	this := VnicIscsiBootPolicyInventoryAllOf{}
...
func (o *VnicIscsiBootPolicyInventoryAllOf) SetChapNil() {
	o.Chap.Set(nil)
}
...
func (o *VnicIscsiBootPolicyInventoryAllOf) SetInitiatorStaticIpV4ConfigNil() {
...
func (o *VnicIscsiBootPolicyInventoryAllOf) SetMutualChapNil() {
...
func (o VnicIscsiBootPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicIscsiBootPolicyInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicIscsiBootPolicyInventoryAllOf := _VnicIscsiBootPolicyInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varVnicIscsiBootPolicyInventoryAllOf); err == nil {
		*o = VnicIscsiBootPolicyInventoryAllOf(varVnicIscsiBootPolicyInventoryAllOf)
	}
...
type NullableVnicIscsiBootPolicyInventoryAllOf struct {
	value *VnicIscsiBootPolicyInventoryAllOf
	isSet bool
}

func (v NullableVnicIscsiBootPolicyInventoryAllOf) Get() *VnicIscsiBootPolicyInventoryAllOf {
	return v.value
}

func (v *NullableVnicIscsiBootPolicyInventoryAllOf) Set(val *VnicIscsiBootPolicyInventoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicIscsiBootPolicyInventoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicIscsiBootPolicyInventoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicIscsiBootPolicyInventoryAllOf(val *VnicIscsiBootPolicyInventoryAllOf) *NullableVnicIscsiBootPolicyInventoryAllOf {
	return &NullableVnicIscsiBootPolicyInventoryAllOf{value: val, isSet: true}
}

func (v NullableVnicIscsiBootPolicyInventoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicIscsiBootPolicyInventoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
