...
// checks if the HyperflexPortTypeToPortNumberMap type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexPortTypeToPortNumberMap{}
...
// GetDefaultClassId returns the default value "hyperflex.PortTypeToPortNumberMap" of the ClassId field.
func (o *HyperflexPortTypeToPortNumberMap) GetDefaultClassId() interface{} {
	return "hyperflex.PortTypeToPortNumberMap"
}
...
// GetDefaultObjectType returns the default value "hyperflex.PortTypeToPortNumberMap" of the ObjectType field.
func (o *HyperflexPortTypeToPortNumberMap) GetDefaultObjectType() interface{} {
	return "hyperflex.PortTypeToPortNumberMap"
}

// GetI16 returns the I16 field value if set, zero value otherwise.
func (o *HyperflexPortTypeToPortNumberMap) GetI16() int64 {
	if o == nil || IsNil(o.I16) {
		var ret int64
		return ret
	}
	return *o.I16
...
func (o HyperflexPortTypeToPortNumberMap) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexPortTypeToPortNumberMap) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexPortTypeToPortNumberMapWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexPortTypeToPortNumberMap)
	if err == nil {
