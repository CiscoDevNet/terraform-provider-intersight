...
type _WorkflowForkTaskAllOf WorkflowForkTaskAllOf
...
func (o *WorkflowForkTaskAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varWorkflowForkTaskAllOf := _WorkflowForkTaskAllOf{}

	if err = json.Unmarshal(bytes, &varWorkflowForkTaskAllOf); err == nil {
		*o = WorkflowForkTaskAllOf(varWorkflowForkTaskAllOf)
	}
