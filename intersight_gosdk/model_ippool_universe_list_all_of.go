...
// IppoolUniverseListAllOf struct for IppoolUniverseListAllOf
type IppoolUniverseListAllOf struct {
...
type _IppoolUniverseListAllOf IppoolUniverseListAllOf
...
func (o IppoolUniverseListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IppoolUniverseListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIppoolUniverseListAllOf := _IppoolUniverseListAllOf{}

	if err = json.Unmarshal(bytes, &varIppoolUniverseListAllOf); err == nil {
		*o = IppoolUniverseListAllOf(varIppoolUniverseListAllOf)
	}
...
type NullableIppoolUniverseListAllOf struct {
	value *IppoolUniverseListAllOf
	isSet bool
}

func (v NullableIppoolUniverseListAllOf) Get() *IppoolUniverseListAllOf {
	return v.value
}

func (v *NullableIppoolUniverseListAllOf) Set(val *IppoolUniverseListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIppoolUniverseListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIppoolUniverseListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIppoolUniverseListAllOf(val *IppoolUniverseListAllOf) *NullableIppoolUniverseListAllOf {
	return &NullableIppoolUniverseListAllOf{value: val, isSet: true}
}

func (v NullableIppoolUniverseListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIppoolUniverseListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
