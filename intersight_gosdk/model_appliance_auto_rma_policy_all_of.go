...
// ApplianceAutoRmaPolicyAllOf Definition of the list of properties defined in 'appliance.AutoRmaPolicy', excluding properties defined in parent classes.
type ApplianceAutoRmaPolicyAllOf struct {
...
type _ApplianceAutoRmaPolicyAllOf ApplianceAutoRmaPolicyAllOf
...
func NewApplianceAutoRmaPolicyAllOf(classId string, objectType string) *ApplianceAutoRmaPolicyAllOf {
	this := ApplianceAutoRmaPolicyAllOf{}
...
func (o ApplianceAutoRmaPolicyAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceAutoRmaPolicyAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceAutoRmaPolicyAllOf := _ApplianceAutoRmaPolicyAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceAutoRmaPolicyAllOf); err == nil {
		*o = ApplianceAutoRmaPolicyAllOf(varApplianceAutoRmaPolicyAllOf)
	}
...
type NullableApplianceAutoRmaPolicyAllOf struct {
	value *ApplianceAutoRmaPolicyAllOf
	isSet bool
}

func (v NullableApplianceAutoRmaPolicyAllOf) Get() *ApplianceAutoRmaPolicyAllOf {
	return v.value
}

func (v *NullableApplianceAutoRmaPolicyAllOf) Set(val *ApplianceAutoRmaPolicyAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceAutoRmaPolicyAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceAutoRmaPolicyAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceAutoRmaPolicyAllOf(val *ApplianceAutoRmaPolicyAllOf) *NullableApplianceAutoRmaPolicyAllOf {
	return &NullableApplianceAutoRmaPolicyAllOf{value: val, isSet: true}
}

func (v NullableApplianceAutoRmaPolicyAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceAutoRmaPolicyAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
