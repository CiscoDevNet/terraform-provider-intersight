...
// EquipmentChassisIdPoolAllOf Definition of the list of properties defined in 'equipment.ChassisIdPool', excluding properties defined in parent classes.
type EquipmentChassisIdPoolAllOf struct {
...
type _EquipmentChassisIdPoolAllOf EquipmentChassisIdPoolAllOf
...
func NewEquipmentChassisIdPoolAllOf(classId string, objectType string) *EquipmentChassisIdPoolAllOf {
	this := EquipmentChassisIdPoolAllOf{}
...
func (o EquipmentChassisIdPoolAllOf) MarshalJSON() ([]byte, error) {
...
func (o *EquipmentChassisIdPoolAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varEquipmentChassisIdPoolAllOf := _EquipmentChassisIdPoolAllOf{}

	if err = json.Unmarshal(bytes, &varEquipmentChassisIdPoolAllOf); err == nil {
		*o = EquipmentChassisIdPoolAllOf(varEquipmentChassisIdPoolAllOf)
	}
...
type NullableEquipmentChassisIdPoolAllOf struct {
	value *EquipmentChassisIdPoolAllOf
	isSet bool
}

func (v NullableEquipmentChassisIdPoolAllOf) Get() *EquipmentChassisIdPoolAllOf {
	return v.value
}

func (v *NullableEquipmentChassisIdPoolAllOf) Set(val *EquipmentChassisIdPoolAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentChassisIdPoolAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentChassisIdPoolAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentChassisIdPoolAllOf(val *EquipmentChassisIdPoolAllOf) *NullableEquipmentChassisIdPoolAllOf {
	return &NullableEquipmentChassisIdPoolAllOf{value: val, isSet: true}
}

func (v NullableEquipmentChassisIdPoolAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentChassisIdPoolAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
