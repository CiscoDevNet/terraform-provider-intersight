...
// KvmTunneledKvmPolicy The TunneledKvmPolicy object manages policies controlling tunneled vKVM access within the account. This provides configuration options for enabling or disabling tunneled access and configuration within the account. #### Purpose TunneledKvmPolicy object enables organizations to manage and control tunneled vKVM access through policy configuration. It ensures secure and efficient access by allowing account-specific configurations. #### Key Concepts - **Policy Management:** Manages policies for tunneled vKVM access, ensuring secure and efficient access operations. - **Configuration Options:** Provides options to enable or disable tunneled vKVM access and tunneled vKVM access configuration within the account, supporting tailored access control.
