...
// GetDefaultClassId returns the default value "capability.GpuEndpointDescriptor" of the ClassId field.
func (o *CapabilityGpuEndpointDescriptor) GetDefaultClassId() interface{} {
	return "capability.GpuEndpointDescriptor"
}
...
// GetDefaultObjectType returns the default value "capability.GpuEndpointDescriptor" of the ObjectType field.
func (o *CapabilityGpuEndpointDescriptor) GetDefaultObjectType() interface{} {
	return "capability.GpuEndpointDescriptor"
}
...
func (o CapabilityGpuEndpointDescriptor) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityGpuEndpointDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityGpuEndpointDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityGpuEndpointDescriptor)
	if err == nil {
