...
type PolicyConfigChangeDisruptionDetailType struct {
	...
	IsOnlyRequiredByOtherPolicies *bool `json:"IsOnlyRequiredByOtherPolicies,omitempty"`
	...
	RequiredByPolicies   []string `json:"RequiredByPolicies,omitempty"`
...
// GetIsOnlyRequiredByOtherPolicies returns the IsOnlyRequiredByOtherPolicies field value if set, zero value otherwise.
func (o *PolicyConfigChangeDisruptionDetailType) GetIsOnlyRequiredByOtherPolicies() bool {
	if o == nil || IsNil(o.IsOnlyRequiredByOtherPolicies) {
		var ret bool
		return ret
	}
	return *o.IsOnlyRequiredByOtherPolicies
}

// GetIsOnlyRequiredByOtherPoliciesOk returns a tuple with the IsOnlyRequiredByOtherPolicies field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PolicyConfigChangeDisruptionDetailType) GetIsOnlyRequiredByOtherPoliciesOk() (*bool, bool) {
	if o == nil || IsNil(o.IsOnlyRequiredByOtherPolicies) {
		return nil, false
	}
	return o.IsOnlyRequiredByOtherPolicies, true
}
...
// SetIsOnlyRequiredByOtherPolicies gets a reference to the given bool and assigns it to the IsOnlyRequiredByOtherPolicies field.
func (o *PolicyConfigChangeDisruptionDetailType) SetIsOnlyRequiredByOtherPolicies(v bool) {
	o.IsOnlyRequiredByOtherPolicies = &v
}
...
// GetRequiredByPolicies returns the RequiredByPolicies field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PolicyConfigChangeDisruptionDetailType) GetRequiredByPolicies() []string {
	if o == nil {
		var ret []string
		return ret
	}
	return o.RequiredByPolicies
}

// GetRequiredByPoliciesOk returns a tuple with the RequiredByPolicies field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PolicyConfigChangeDisruptionDetailType) GetRequiredByPoliciesOk() ([]string, bool) {
	if o == nil || IsNil(o.RequiredByPolicies) {
		return nil, false
	}
	return o.RequiredByPolicies, true
}
...
// SetRequiredByPolicies gets a reference to the given []string and assigns it to the RequiredByPolicies field.
func (o *PolicyConfigChangeDisruptionDetailType) SetRequiredByPolicies(v []string) {
	o.RequiredByPolicies = v
}
...
func (o PolicyConfigChangeDisruptionDetailType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsOnlyRequiredByOtherPolicies) {
		toSerialize["IsOnlyRequiredByOtherPolicies"] = o.IsOnlyRequiredByOtherPolicies
	}
	...
	if o.RequiredByPolicies != nil {
		toSerialize["RequiredByPolicies"] = o.RequiredByPolicies
	}
...
func (o *PolicyConfigChangeDisruptionDetailType) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varPolicyConfigChangeDisruptionDetailType.IsOnlyRequiredByOtherPolicies = varPolicyConfigChangeDisruptionDetailTypeWithoutEmbeddedStruct.IsOnlyRequiredByOtherPolicies
		...
		varPolicyConfigChangeDisruptionDetailType.RequiredByPolicies = varPolicyConfigChangeDisruptionDetailTypeWithoutEmbeddedStruct.RequiredByPolicies
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "IsOnlyRequiredByOtherPolicies")
		delete(additionalProperties, "PolicyName")
		delete(additionalProperties, "PolicyPendingAction")
		delete(additionalProperties, "RequiredByPolicies")
