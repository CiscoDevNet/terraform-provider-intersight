...
func (o *PolicyConfigChangeDisruptionDetailType) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varPolicyConfigChangeDisruptionDetailTypeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varPolicyConfigChangeDisruptionDetailType)
	if err == nil {
