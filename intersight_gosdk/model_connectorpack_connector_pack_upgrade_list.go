...
func (o *ConnectorpackConnectorPackUpgradeList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varConnectorpackConnectorPackUpgradeListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varConnectorpackConnectorPackUpgradeList)
	if err == nil {
