...
type EquipmentIoCardOperation struct {
	...
	// Placeholder for affected object name which is a combination of chassis and IOM ID. Used to display affected object in audit log.
...
func (o *EquipmentIoCardOperation) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varEquipmentIoCardOperation.AffectedObjName = varEquipmentIoCardOperationWithoutEmbeddedStruct.AffectedObjName
