...
// checks if the NtpAuthNtpServer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NtpAuthNtpServer{}
...
// GetDefaultClassId returns the default value "ntp.AuthNtpServer" of the ClassId field.
func (o *NtpAuthNtpServer) GetDefaultClassId() interface{} {
	return "ntp.AuthNtpServer"
}
...
// GetDefaultObjectType returns the default value "ntp.AuthNtpServer" of the ObjectType field.
func (o *NtpAuthNtpServer) GetDefaultObjectType() interface{} {
	return "ntp.AuthNtpServer"
}
...
func (o NtpAuthNtpServer) ToMap() (map[string]interface{}, error) {
...
func (o *NtpAuthNtpServer) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNtpAuthNtpServerWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNtpAuthNtpServer)
	if err == nil {
