...
type _NiatelemetryApicFlashDetailsAllOf NiatelemetryApicFlashDetailsAllOf
...
func (o *NiatelemetryApicFlashDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryApicFlashDetailsAllOf := _NiatelemetryApicFlashDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryApicFlashDetailsAllOf); err == nil {
		*o = NiatelemetryApicFlashDetailsAllOf(varNiatelemetryApicFlashDetailsAllOf)
	}
