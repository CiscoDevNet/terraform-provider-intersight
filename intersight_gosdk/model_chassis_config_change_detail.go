...
func (o *ChassisConfigChangeDetail) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varChassisConfigChangeDetailWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varChassisConfigChangeDetail)
	if err == nil {
