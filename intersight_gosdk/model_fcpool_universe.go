...
// checks if the FcpoolUniverse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FcpoolUniverse{}
...
// GetDefaultClassId returns the default value "fcpool.Universe" of the ClassId field.
func (o *FcpoolUniverse) GetDefaultClassId() interface{} {
	return "fcpool.Universe"
}
...
// GetDefaultObjectType returns the default value "fcpool.Universe" of the ObjectType field.
func (o *FcpoolUniverse) GetDefaultObjectType() interface{} {
	return "fcpool.Universe"
}
...
func (o *FcpoolUniverse) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o FcpoolUniverse) ToMap() (map[string]interface{}, error) {
...
func (o *FcpoolUniverse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFcpoolUniverseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFcpoolUniverse)
	if err == nil {
