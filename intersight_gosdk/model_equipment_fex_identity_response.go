...
func (dst *EquipmentFexIdentityResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "equipment.FexIdentity.List" {
		// try to unmarshal JSON data into EquipmentFexIdentityList
		err = json.Unmarshal(data, &dst.EquipmentFexIdentityList)
		if err == nil {
			return nil // data stored in dst.EquipmentFexIdentityList, return on the first match
		} else {
			dst.EquipmentFexIdentityList = nil
			return fmt.Errorf("failed to unmarshal EquipmentFexIdentityResponse as EquipmentFexIdentityList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal EquipmentFexIdentityResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal EquipmentFexIdentityResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal EquipmentFexIdentityResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src EquipmentFexIdentityResponse) MarshalJSON() ([]byte, error) {
	if src.EquipmentFexIdentityList != nil {
		return json.Marshal(&src.EquipmentFexIdentityList)
	}
...
type NullableEquipmentFexIdentityResponse struct {
	value *EquipmentFexIdentityResponse
	isSet bool
}

func (v NullableEquipmentFexIdentityResponse) Get() *EquipmentFexIdentityResponse {
	return v.value
}

func (v *NullableEquipmentFexIdentityResponse) Set(val *EquipmentFexIdentityResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentFexIdentityResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentFexIdentityResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentFexIdentityResponse(val *EquipmentFexIdentityResponse) *NullableEquipmentFexIdentityResponse {
	return &NullableEquipmentFexIdentityResponse{value: val, isSet: true}
}

func (v NullableEquipmentFexIdentityResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentFexIdentityResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
