...
// checks if the HyperflexMapClusterIdToStSnapshotPoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexMapClusterIdToStSnapshotPoint{}
...
// GetDefaultClassId returns the default value "hyperflex.MapClusterIdToStSnapshotPoint" of the ClassId field.
func (o *HyperflexMapClusterIdToStSnapshotPoint) GetDefaultClassId() interface{} {
	return "hyperflex.MapClusterIdToStSnapshotPoint"
}
...
// GetDefaultObjectType returns the default value "hyperflex.MapClusterIdToStSnapshotPoint" of the ObjectType field.
func (o *HyperflexMapClusterIdToStSnapshotPoint) GetDefaultObjectType() interface{} {
	return "hyperflex.MapClusterIdToStSnapshotPoint"
}
...
func (o *HyperflexMapClusterIdToStSnapshotPoint) GetSnapshotPoint() HyperflexSnapshotPoint {
	if o == nil || IsNil(o.SnapshotPoint.Get()) {
...
func (o HyperflexMapClusterIdToStSnapshotPoint) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexMapClusterIdToStSnapshotPoint) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexMapClusterIdToStSnapshotPointWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexMapClusterIdToStSnapshotPoint)
	if err == nil {
