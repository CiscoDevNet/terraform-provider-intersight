...
type IamResourceLimitsListAllOf struct {
	...
	Results              []IamResourceLimits `json:"Results,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IamResourceLimitsListAllOf IamResourceLimitsListAllOf
...
func (o *IamResourceLimitsListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamResourceLimitsListAllOf := _IamResourceLimitsListAllOf{}

	if err = json.Unmarshal(bytes, &varIamResourceLimitsListAllOf); err == nil {
		*o = IamResourceLimitsListAllOf(varIamResourceLimitsListAllOf)
	}
