...
func (o *MarketplaceUseCaseList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMarketplaceUseCaseListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varMarketplaceUseCaseList)
	if err == nil {
