...
// GetDefaultClassId returns the default value "vrf.Vrf" of the ClassId field.
func (o *VrfVrf) GetDefaultClassId() interface{} {
	return "vrf.Vrf"
}
...
// GetDefaultObjectType returns the default value "vrf.Vrf" of the ObjectType field.
func (o *VrfVrf) GetDefaultObjectType() interface{} {
	return "vrf.Vrf"
}
...
func (o VrfVrf) ToMap() (map[string]interface{}, error) {
...
func (o *VrfVrf) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVrfVrfWithoutEmbeddedStruct)
	if err == nil {
		varVrfVrf := _VrfVrf{}
	...
	err = json.Unmarshal(data, &varVrfVrf)
	if err == nil {
