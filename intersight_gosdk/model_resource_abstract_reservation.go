...
func (o *ResourceAbstractReservation) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varResourceAbstractReservationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varResourceAbstractReservation)
	if err == nil {
