...
// GetDefaultClassId returns the default value "capability.ChassisDescriptor" of the ClassId field.
func (o *CapabilityChassisDescriptor) GetDefaultClassId() interface{} {
	return "capability.ChassisDescriptor"
}
...
// GetDefaultObjectType returns the default value "capability.ChassisDescriptor" of the ObjectType field.
func (o *CapabilityChassisDescriptor) GetDefaultObjectType() interface{} {
	return "capability.ChassisDescriptor"
}
...
func (o CapabilityChassisDescriptor) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityChassisDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityChassisDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityChassisDescriptor)
	if err == nil {
