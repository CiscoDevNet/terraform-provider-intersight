...
// CapabilityServerModelsCapabilityDefAllOf Definition of the list of properties defined in 'capability.ServerModelsCapabilityDef', excluding properties defined in parent classes.
type CapabilityServerModelsCapabilityDefAllOf struct {
...
type _CapabilityServerModelsCapabilityDefAllOf CapabilityServerModelsCapabilityDefAllOf
...
func NewCapabilityServerModelsCapabilityDefAllOf(classId string, objectType string) *CapabilityServerModelsCapabilityDefAllOf {
	this := CapabilityServerModelsCapabilityDefAllOf{}
...
func (o CapabilityServerModelsCapabilityDefAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CapabilityServerModelsCapabilityDefAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCapabilityServerModelsCapabilityDefAllOf := _CapabilityServerModelsCapabilityDefAllOf{}

	if err = json.Unmarshal(bytes, &varCapabilityServerModelsCapabilityDefAllOf); err == nil {
		*o = CapabilityServerModelsCapabilityDefAllOf(varCapabilityServerModelsCapabilityDefAllOf)
	}
...
type NullableCapabilityServerModelsCapabilityDefAllOf struct {
	value *CapabilityServerModelsCapabilityDefAllOf
	isSet bool
}

func (v NullableCapabilityServerModelsCapabilityDefAllOf) Get() *CapabilityServerModelsCapabilityDefAllOf {
	return v.value
}

func (v *NullableCapabilityServerModelsCapabilityDefAllOf) Set(val *CapabilityServerModelsCapabilityDefAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityServerModelsCapabilityDefAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityServerModelsCapabilityDefAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityServerModelsCapabilityDefAllOf(val *CapabilityServerModelsCapabilityDefAllOf) *NullableCapabilityServerModelsCapabilityDefAllOf {
	return &NullableCapabilityServerModelsCapabilityDefAllOf{value: val, isSet: true}
}

func (v NullableCapabilityServerModelsCapabilityDefAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityServerModelsCapabilityDefAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
