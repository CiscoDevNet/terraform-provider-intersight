...
// VnicBaseEthIfAllOf Definition of the list of properties defined in 'vnic.BaseEthIf', excluding properties defined in parent classes.
type VnicBaseEthIfAllOf struct {
...
type _VnicBaseEthIfAllOf VnicBaseEthIfAllOf
...
func (o *VnicBaseEthIfAllOf) SetCdnNil() {
	o.Cdn.Set(nil)
}
...
func (o *VnicBaseEthIfAllOf) SetSriovSettingsNil() {
...
func (o *VnicBaseEthIfAllOf) SetUsnicSettingsNil() {
...
func (o *VnicBaseEthIfAllOf) SetVmqSettingsNil() {
...
func (o VnicBaseEthIfAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicBaseEthIfAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicBaseEthIfAllOf := _VnicBaseEthIfAllOf{}

	if err = json.Unmarshal(bytes, &varVnicBaseEthIfAllOf); err == nil {
		*o = VnicBaseEthIfAllOf(varVnicBaseEthIfAllOf)
	}
...
type NullableVnicBaseEthIfAllOf struct {
	value *VnicBaseEthIfAllOf
	isSet bool
}

func (v NullableVnicBaseEthIfAllOf) Get() *VnicBaseEthIfAllOf {
	return v.value
}

func (v *NullableVnicBaseEthIfAllOf) Set(val *VnicBaseEthIfAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicBaseEthIfAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicBaseEthIfAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicBaseEthIfAllOf(val *VnicBaseEthIfAllOf) *NullableVnicBaseEthIfAllOf {
	return &NullableVnicBaseEthIfAllOf{value: val, isSet: true}
}

func (v NullableVnicBaseEthIfAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicBaseEthIfAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
