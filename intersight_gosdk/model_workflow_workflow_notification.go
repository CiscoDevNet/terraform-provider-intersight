...
// WorkflowWorkflowNotification The push notification received from conductor of the workflow which are in terminal state. Terminal state can be completed, failed, terminated, timed out.
type WorkflowWorkflowNotification struct {
	MoBaseMo
...
type _WorkflowWorkflowNotification WorkflowWorkflowNotification
...
func NewWorkflowWorkflowNotification(classId string, objectType string) *WorkflowWorkflowNotification {
	this := WorkflowWorkflowNotification{}
...
func (o WorkflowWorkflowNotification) MarshalJSON() ([]byte, error) {
...
func (o *WorkflowWorkflowNotification) UnmarshalJSON(bytes []byte) (err error) {
	type WorkflowWorkflowNotificationWithoutEmbeddedStruct struct {
		// The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.
		ClassId string `json:"ClassId"`
		// The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.
		ObjectType string `json:"ObjectType"`
	...
	varWorkflowWorkflowNotificationWithoutEmbeddedStruct := WorkflowWorkflowNotificationWithoutEmbeddedStruct{}

	err = json.Unmarshal(bytes, &varWorkflowWorkflowNotificationWithoutEmbeddedStruct)
	if err == nil {
		varWorkflowWorkflowNotification := _WorkflowWorkflowNotification{}
		varWorkflowWorkflowNotification.ClassId = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.ClassId
		varWorkflowWorkflowNotification.ObjectType = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.ObjectType
		varWorkflowWorkflowNotification.CorrelationId = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.CorrelationId
		varWorkflowWorkflowNotification.EndTime = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.EndTime
		varWorkflowWorkflowNotification.Event = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.Event
		varWorkflowWorkflowNotification.ExecutionTime = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.ExecutionTime
		varWorkflowWorkflowNotification.FailedReferenceTaskNames = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.FailedReferenceTaskNames
		varWorkflowWorkflowNotification.Input = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.Input
		varWorkflowWorkflowNotification.Output = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.Output
		varWorkflowWorkflowNotification.ReasonForIncompletion = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.ReasonForIncompletion
		varWorkflowWorkflowNotification.StartTime = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.StartTime
		varWorkflowWorkflowNotification.Status = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.Status
		varWorkflowWorkflowNotification.UpdateTime = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.UpdateTime
		varWorkflowWorkflowNotification.Version = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.Version
		varWorkflowWorkflowNotification.WorkflowId = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.WorkflowId
		varWorkflowWorkflowNotification.WorkflowType = varWorkflowWorkflowNotificationWithoutEmbeddedStruct.WorkflowType
		*o = WorkflowWorkflowNotification(varWorkflowWorkflowNotification)
	} else {
		return err
	}
	...
	err = json.Unmarshal(bytes, &varWorkflowWorkflowNotification)
	if err == nil {
		o.MoBaseMo = varWorkflowWorkflowNotification.MoBaseMo
	} else {
		return err
	}
...
type NullableWorkflowWorkflowNotification struct {
	value *WorkflowWorkflowNotification
	isSet bool
}

func (v NullableWorkflowWorkflowNotification) Get() *WorkflowWorkflowNotification {
	return v.value
}

func (v *NullableWorkflowWorkflowNotification) Set(val *WorkflowWorkflowNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowWorkflowNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowWorkflowNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowWorkflowNotification(val *WorkflowWorkflowNotification) *NullableWorkflowWorkflowNotification {
	return &NullableWorkflowWorkflowNotification{value: val, isSet: true}
}

func (v NullableWorkflowWorkflowNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowWorkflowNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true
