...
// NiatelemetryApicSnmpCommunityDetailsAllOf Definition of the list of properties defined in 'niatelemetry.ApicSnmpCommunityDetails', excluding properties defined in parent classes.
type NiatelemetryApicSnmpCommunityDetailsAllOf struct {
...
type _NiatelemetryApicSnmpCommunityDetailsAllOf NiatelemetryApicSnmpCommunityDetailsAllOf
...
func NewNiatelemetryApicSnmpCommunityDetailsAllOf(classId string, objectType string) *NiatelemetryApicSnmpCommunityDetailsAllOf {
	this := NiatelemetryApicSnmpCommunityDetailsAllOf{}
...
func (o NiatelemetryApicSnmpCommunityDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryApicSnmpCommunityDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryApicSnmpCommunityDetailsAllOf := _NiatelemetryApicSnmpCommunityDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryApicSnmpCommunityDetailsAllOf); err == nil {
		*o = NiatelemetryApicSnmpCommunityDetailsAllOf(varNiatelemetryApicSnmpCommunityDetailsAllOf)
	}
...
type NullableNiatelemetryApicSnmpCommunityDetailsAllOf struct {
	value *NiatelemetryApicSnmpCommunityDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetryApicSnmpCommunityDetailsAllOf) Get() *NiatelemetryApicSnmpCommunityDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetryApicSnmpCommunityDetailsAllOf) Set(val *NiatelemetryApicSnmpCommunityDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryApicSnmpCommunityDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryApicSnmpCommunityDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryApicSnmpCommunityDetailsAllOf(val *NiatelemetryApicSnmpCommunityDetailsAllOf) *NullableNiatelemetryApicSnmpCommunityDetailsAllOf {
	return &NullableNiatelemetryApicSnmpCommunityDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryApicSnmpCommunityDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryApicSnmpCommunityDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
