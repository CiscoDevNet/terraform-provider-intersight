...
// FcpoolPoolMemberAllOf Definition of the list of properties defined in 'fcpool.PoolMember', excluding properties defined in parent classes.
type FcpoolPoolMemberAllOf struct {
	...
	Reservation          *FcpoolReservationRelationship `json:"Reservation,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FcpoolPoolMemberAllOf FcpoolPoolMemberAllOf
...
// SetReservation gets a reference to the given FcpoolReservationRelationship and assigns it to the Reservation field.
func (o *FcpoolPoolMemberAllOf) SetReservation(v FcpoolReservationRelationship) {
	o.Reservation = &v
}

func (o FcpoolPoolMemberAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FcpoolPoolMemberAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFcpoolPoolMemberAllOf := _FcpoolPoolMemberAllOf{}

	if err = json.Unmarshal(bytes, &varFcpoolPoolMemberAllOf); err == nil {
		*o = FcpoolPoolMemberAllOf(varFcpoolPoolMemberAllOf)
	}
...
type NullableFcpoolPoolMemberAllOf struct {
	value *FcpoolPoolMemberAllOf
	isSet bool
}

func (v NullableFcpoolPoolMemberAllOf) Get() *FcpoolPoolMemberAllOf {
	return v.value
}

func (v *NullableFcpoolPoolMemberAllOf) Set(val *FcpoolPoolMemberAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFcpoolPoolMemberAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFcpoolPoolMemberAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFcpoolPoolMemberAllOf(val *FcpoolPoolMemberAllOf) *NullableFcpoolPoolMemberAllOf {
	return &NullableFcpoolPoolMemberAllOf{value: val, isSet: true}
}

func (v NullableFcpoolPoolMemberAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFcpoolPoolMemberAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
