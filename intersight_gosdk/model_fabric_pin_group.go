...
type _FabricPinGroup FabricPinGroup
...
func (o *FabricPinGroup) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varFabricPinGroup.ObjectType = varFabricPinGroupWithoutEmbeddedStruct.ObjectType
		varFabricPinGroup.Name = varFabricPinGroupWithoutEmbeddedStruct.Name
		varFabricPinGroup.PortPolicy = varFabricPinGroupWithoutEmbeddedStruct.PortPolicy
		*o = FabricPinGroup(varFabricPinGroup)
	} else {
		return err
	}
...
type NullableFabricPinGroup struct {
	value *FabricPinGroup
	isSet bool
}

func (v NullableFabricPinGroup) Get() *FabricPinGroup {
	return v.value
}

func (v *NullableFabricPinGroup) Set(val *FabricPinGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricPinGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricPinGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricPinGroup(val *FabricPinGroup) *NullableFabricPinGroup {
	return &NullableFabricPinGroup{value: val, isSet: true}
}

func (v NullableFabricPinGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricPinGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
