...
func NiatelemetrySiteInventoryListAsNiatelemetrySiteInventoryResponse(v *NiatelemetrySiteInventoryList) NiatelemetrySiteInventoryResponse {
	return NiatelemetrySiteInventoryResponse{
		NiatelemetrySiteInventoryList: v,
	}
}
...
func (dst *NiatelemetrySiteInventoryResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiatelemetrySiteInventoryResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiatelemetrySiteInventoryResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal NiatelemetrySiteInventoryResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'niatelemetry.SiteInventory.List'
	if jsonDict["ObjectType"] == "niatelemetry.SiteInventory.List" {
		// try to unmarshal JSON data into NiatelemetrySiteInventoryList
		err = json.Unmarshal(data, &dst.NiatelemetrySiteInventoryList)
		if err == nil {
			return nil // data stored in dst.NiatelemetrySiteInventoryList, return on the first match
		} else {
			dst.NiatelemetrySiteInventoryList = nil
			return fmt.Errorf("Failed to unmarshal NiatelemetrySiteInventoryResponse as NiatelemetrySiteInventoryList: %s", err.Error())
		}
	}
...
func (src NiatelemetrySiteInventoryResponse) MarshalJSON() ([]byte, error) {
	...
	if src.NiatelemetrySiteInventoryList != nil {
		return json.Marshal(&src.NiatelemetrySiteInventoryList)
	}
...
func (obj *NiatelemetrySiteInventoryResponse) GetActualInstance() interface{} {
	...
	if obj.NiatelemetrySiteInventoryList != nil {
		return obj.NiatelemetrySiteInventoryList
	}
...
type NullableNiatelemetrySiteInventoryResponse struct {
	value *NiatelemetrySiteInventoryResponse
	isSet bool
}

func (v NullableNiatelemetrySiteInventoryResponse) Get() *NiatelemetrySiteInventoryResponse {
	return v.value
}

func (v *NullableNiatelemetrySiteInventoryResponse) Set(val *NiatelemetrySiteInventoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetrySiteInventoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetrySiteInventoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetrySiteInventoryResponse(val *NiatelemetrySiteInventoryResponse) *NullableNiatelemetrySiteInventoryResponse {
	return &NullableNiatelemetrySiteInventoryResponse{value: val, isSet: true}
}

func (v NullableNiatelemetrySiteInventoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetrySiteInventoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
