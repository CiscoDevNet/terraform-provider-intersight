...
// CloudBaseNetworkInterfaceAllOf Definition of the list of properties defined in 'cloud.BaseNetworkInterface', excluding properties defined in parent classes.
type CloudBaseNetworkInterfaceAllOf struct {
...
type _CloudBaseNetworkInterfaceAllOf CloudBaseNetworkInterfaceAllOf
...
func NewCloudBaseNetworkInterfaceAllOf(classId string, objectType string) *CloudBaseNetworkInterfaceAllOf {
	this := CloudBaseNetworkInterfaceAllOf{}
...
func (o CloudBaseNetworkInterfaceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CloudBaseNetworkInterfaceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCloudBaseNetworkInterfaceAllOf := _CloudBaseNetworkInterfaceAllOf{}

	if err = json.Unmarshal(bytes, &varCloudBaseNetworkInterfaceAllOf); err == nil {
		*o = CloudBaseNetworkInterfaceAllOf(varCloudBaseNetworkInterfaceAllOf)
	}
...
type NullableCloudBaseNetworkInterfaceAllOf struct {
	value *CloudBaseNetworkInterfaceAllOf
	isSet bool
}

func (v NullableCloudBaseNetworkInterfaceAllOf) Get() *CloudBaseNetworkInterfaceAllOf {
	return v.value
}

func (v *NullableCloudBaseNetworkInterfaceAllOf) Set(val *CloudBaseNetworkInterfaceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudBaseNetworkInterfaceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudBaseNetworkInterfaceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudBaseNetworkInterfaceAllOf(val *CloudBaseNetworkInterfaceAllOf) *NullableCloudBaseNetworkInterfaceAllOf {
	return &NullableCloudBaseNetworkInterfaceAllOf{value: val, isSet: true}
}

func (v NullableCloudBaseNetworkInterfaceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudBaseNetworkInterfaceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
