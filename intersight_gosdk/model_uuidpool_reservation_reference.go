...
func (o *UuidpoolReservationReference) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUuidpoolReservationReferenceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varUuidpoolReservationReference)
	if err == nil {
