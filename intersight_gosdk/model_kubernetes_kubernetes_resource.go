...
// checks if the KubernetesKubernetesResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesKubernetesResource{}
...
func (o KubernetesKubernetesResource) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesKubernetesResource) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesKubernetesResourceWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesKubernetesResource)
	if err == nil {
