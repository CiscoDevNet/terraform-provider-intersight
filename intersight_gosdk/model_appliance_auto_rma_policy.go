...
// checks if the ApplianceAutoRmaPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceAutoRmaPolicy{}
...
// GetDefaultClassId returns the default value "appliance.AutoRmaPolicy" of the ClassId field.
func (o *ApplianceAutoRmaPolicy) GetDefaultClassId() interface{} {
	return "appliance.AutoRmaPolicy"
}
...
// GetDefaultObjectType returns the default value "appliance.AutoRmaPolicy" of the ObjectType field.
func (o *ApplianceAutoRmaPolicy) GetDefaultObjectType() interface{} {
	return "appliance.AutoRmaPolicy"
}
...
func (o *ApplianceAutoRmaPolicy) SetRegisteredDeviceNil() {
...
func (o ApplianceAutoRmaPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceAutoRmaPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceAutoRmaPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceAutoRmaPolicy)
	if err == nil {
