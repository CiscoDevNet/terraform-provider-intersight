...
// SoftwarerepositoryReleaseListAllOf struct for SoftwarerepositoryReleaseListAllOf
type SoftwarerepositoryReleaseListAllOf struct {
...
type _SoftwarerepositoryReleaseListAllOf SoftwarerepositoryReleaseListAllOf
...
func NewSoftwarerepositoryReleaseListAllOf() *SoftwarerepositoryReleaseListAllOf {
	this := SoftwarerepositoryReleaseListAllOf{}
	return &this
}
...
func (o SoftwarerepositoryReleaseListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *SoftwarerepositoryReleaseListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varSoftwarerepositoryReleaseListAllOf := _SoftwarerepositoryReleaseListAllOf{}

	if err = json.Unmarshal(bytes, &varSoftwarerepositoryReleaseListAllOf); err == nil {
		*o = SoftwarerepositoryReleaseListAllOf(varSoftwarerepositoryReleaseListAllOf)
	}
...
type NullableSoftwarerepositoryReleaseListAllOf struct {
	value *SoftwarerepositoryReleaseListAllOf
	isSet bool
}

func (v NullableSoftwarerepositoryReleaseListAllOf) Get() *SoftwarerepositoryReleaseListAllOf {
	return v.value
}

func (v *NullableSoftwarerepositoryReleaseListAllOf) Set(val *SoftwarerepositoryReleaseListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwarerepositoryReleaseListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwarerepositoryReleaseListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwarerepositoryReleaseListAllOf(val *SoftwarerepositoryReleaseListAllOf) *NullableSoftwarerepositoryReleaseListAllOf {
	return &NullableSoftwarerepositoryReleaseListAllOf{value: val, isSet: true}
}

func (v NullableSoftwarerepositoryReleaseListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwarerepositoryReleaseListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
