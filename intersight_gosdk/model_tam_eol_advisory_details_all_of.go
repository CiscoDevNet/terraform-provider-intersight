...
// TamEolAdvisoryDetailsAllOf Definition of the list of properties defined in 'tam.EolAdvisoryDetails', excluding properties defined in parent classes.
type TamEolAdvisoryDetailsAllOf struct {
...
type _TamEolAdvisoryDetailsAllOf TamEolAdvisoryDetailsAllOf
...
func NewTamEolAdvisoryDetailsAllOf(classId string, objectType string) *TamEolAdvisoryDetailsAllOf {
	this := TamEolAdvisoryDetailsAllOf{}
...
func (o TamEolAdvisoryDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *TamEolAdvisoryDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTamEolAdvisoryDetailsAllOf := _TamEolAdvisoryDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varTamEolAdvisoryDetailsAllOf); err == nil {
		*o = TamEolAdvisoryDetailsAllOf(varTamEolAdvisoryDetailsAllOf)
	}
...
type NullableTamEolAdvisoryDetailsAllOf struct {
	value *TamEolAdvisoryDetailsAllOf
	isSet bool
}

func (v NullableTamEolAdvisoryDetailsAllOf) Get() *TamEolAdvisoryDetailsAllOf {
	return v.value
}

func (v *NullableTamEolAdvisoryDetailsAllOf) Set(val *TamEolAdvisoryDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTamEolAdvisoryDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTamEolAdvisoryDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTamEolAdvisoryDetailsAllOf(val *TamEolAdvisoryDetailsAllOf) *NullableTamEolAdvisoryDetailsAllOf {
	return &NullableTamEolAdvisoryDetailsAllOf{value: val, isSet: true}
}

func (v NullableTamEolAdvisoryDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTamEolAdvisoryDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
