...
// NiatelemetryMsoEpgDetailsAllOf Definition of the list of properties defined in 'niatelemetry.MsoEpgDetails', excluding properties defined in parent classes.
type NiatelemetryMsoEpgDetailsAllOf struct {
...
type _NiatelemetryMsoEpgDetailsAllOf NiatelemetryMsoEpgDetailsAllOf
...
func NewNiatelemetryMsoEpgDetailsAllOf(classId string, objectType string) *NiatelemetryMsoEpgDetailsAllOf {
	this := NiatelemetryMsoEpgDetailsAllOf{}
...
func (o NiatelemetryMsoEpgDetailsAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetryMsoEpgDetailsAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetryMsoEpgDetailsAllOf := _NiatelemetryMsoEpgDetailsAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetryMsoEpgDetailsAllOf); err == nil {
		*o = NiatelemetryMsoEpgDetailsAllOf(varNiatelemetryMsoEpgDetailsAllOf)
	}
...
type NullableNiatelemetryMsoEpgDetailsAllOf struct {
	value *NiatelemetryMsoEpgDetailsAllOf
	isSet bool
}

func (v NullableNiatelemetryMsoEpgDetailsAllOf) Get() *NiatelemetryMsoEpgDetailsAllOf {
	return v.value
}

func (v *NullableNiatelemetryMsoEpgDetailsAllOf) Set(val *NiatelemetryMsoEpgDetailsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetryMsoEpgDetailsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetryMsoEpgDetailsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetryMsoEpgDetailsAllOf(val *NiatelemetryMsoEpgDetailsAllOf) *NullableNiatelemetryMsoEpgDetailsAllOf {
	return &NullableNiatelemetryMsoEpgDetailsAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetryMsoEpgDetailsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetryMsoEpgDetailsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
