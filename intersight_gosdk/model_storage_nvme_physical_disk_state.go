...
type _StorageNvmePhysicalDiskState StorageNvmePhysicalDiskState
...
func NewStorageNvmePhysicalDiskState(classId string, objectType string) *StorageNvmePhysicalDiskState {
	this := StorageNvmePhysicalDiskState{}
...
func NewStorageNvmePhysicalDiskStateWithDefaults() *StorageNvmePhysicalDiskState {
	this := StorageNvmePhysicalDiskState{}
	var classId string = "storage.NvmePhysicalDiskState"
	this.ClassId = classId
	var objectType string = "storage.NvmePhysicalDiskState"
	this.ObjectType = objectType
	return &this
}
...
// GetDefaultClassId returns the default value "storage.NvmePhysicalDiskState" of the ClassId field.
func (o *StorageNvmePhysicalDiskState) GetDefaultClassId() interface{} {
	return "storage.NvmePhysicalDiskState"
}
...
// GetDefaultObjectType returns the default value "storage.NvmePhysicalDiskState" of the ObjectType field.
func (o *StorageNvmePhysicalDiskState) GetDefaultObjectType() interface{} {
	return "storage.NvmePhysicalDiskState"
}
...
func (o *StorageNvmePhysicalDiskState) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varStorageNvmePhysicalDiskState.ObjectType = varStorageNvmePhysicalDiskStateWithoutEmbeddedStruct.ObjectType
		varStorageNvmePhysicalDiskState.Slot = varStorageNvmePhysicalDiskStateWithoutEmbeddedStruct.Slot
		varStorageNvmePhysicalDiskState.State = varStorageNvmePhysicalDiskStateWithoutEmbeddedStruct.State
		*o = StorageNvmePhysicalDiskState(varStorageNvmePhysicalDiskState)
	} else {
		return err
	}
...
type NullableStorageNvmePhysicalDiskState struct {
	value *StorageNvmePhysicalDiskState
	isSet bool
}

func (v NullableStorageNvmePhysicalDiskState) Get() *StorageNvmePhysicalDiskState {
	return v.value
}

func (v *NullableStorageNvmePhysicalDiskState) Set(val *StorageNvmePhysicalDiskState) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNvmePhysicalDiskState) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNvmePhysicalDiskState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNvmePhysicalDiskState(val *StorageNvmePhysicalDiskState) *NullableStorageNvmePhysicalDiskState {
	return &NullableStorageNvmePhysicalDiskState{value: val, isSet: true}
}

func (v NullableStorageNvmePhysicalDiskState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNvmePhysicalDiskState) UnmarshalJSON(src []byte) error {
	v.isSet = true
