...
func (r ApiGetIwotenantTenantStatusByMoidRequest) Execute() (IwotenantTenantStatus, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *IwotenantApiService) GetIwotenantTenantStatusByMoidExecute(r ApiGetIwotenantTenantStatusByMoidRequest) (IwotenantTenantStatus, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetIwotenantTenantStatusListRequest) Execute() (IwotenantTenantStatusResponse, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *IwotenantApiService) GetIwotenantTenantStatusListExecute(r ApiGetIwotenantTenantStatusListRequest) (IwotenantTenantStatusResponse, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
