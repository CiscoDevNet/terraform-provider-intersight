...
func (o *WorkflowMessage) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varWorkflowMessageWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varWorkflowMessage)
	if err == nil {
