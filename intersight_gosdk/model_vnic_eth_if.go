...
func (o *VnicEthIf) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varVnicEthIf.NetFlowMonitorSessions = varVnicEthIfWithoutEmbeddedStruct.NetFlowMonitorSessions
