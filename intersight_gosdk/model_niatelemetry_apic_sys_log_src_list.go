...
// checks if the NiatelemetryApicSysLogSrcList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NiatelemetryApicSysLogSrcList{}
...
func (o NiatelemetryApicSysLogSrcList) ToMap() (map[string]interface{}, error) {
...
func (o *NiatelemetryApicSysLogSrcList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNiatelemetryApicSysLogSrcListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNiatelemetryApicSysLogSrcList)
	if err == nil {
