...
// checks if the AssetTargetKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetTargetKey{}
...
// GetDefaultClassId returns the default value "asset.TargetKey" of the ClassId field.
func (o *AssetTargetKey) GetDefaultClassId() interface{} {
	return "asset.TargetKey"
}
...
// GetDefaultObjectType returns the default value "asset.TargetKey" of the ObjectType field.
func (o *AssetTargetKey) GetDefaultObjectType() interface{} {
	return "asset.TargetKey"
}
...
func (o AssetTargetKey) ToMap() (map[string]interface{}, error) {
...
func (o *AssetTargetKey) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetTargetKeyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetTargetKey)
	if err == nil {
