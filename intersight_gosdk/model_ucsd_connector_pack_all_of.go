...
// UcsdConnectorPackAllOf Definition of the list of properties defined in 'ucsd.ConnectorPack', excluding properties defined in parent classes.
type UcsdConnectorPackAllOf struct {
...
type _UcsdConnectorPackAllOf UcsdConnectorPackAllOf
...
func (o UcsdConnectorPackAllOf) MarshalJSON() ([]byte, error) {
...
func (o *UcsdConnectorPackAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varUcsdConnectorPackAllOf := _UcsdConnectorPackAllOf{}

	if err = json.Unmarshal(bytes, &varUcsdConnectorPackAllOf); err == nil {
		*o = UcsdConnectorPackAllOf(varUcsdConnectorPackAllOf)
	}
...
type NullableUcsdConnectorPackAllOf struct {
	value *UcsdConnectorPackAllOf
	isSet bool
}

func (v NullableUcsdConnectorPackAllOf) Get() *UcsdConnectorPackAllOf {
	return v.value
}

func (v *NullableUcsdConnectorPackAllOf) Set(val *UcsdConnectorPackAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableUcsdConnectorPackAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableUcsdConnectorPackAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUcsdConnectorPackAllOf(val *UcsdConnectorPackAllOf) *NullableUcsdConnectorPackAllOf {
	return &NullableUcsdConnectorPackAllOf{value: val, isSet: true}
}

func (v NullableUcsdConnectorPackAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUcsdConnectorPackAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
