...
// checks if the ConnectorStreamAcknowledge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorStreamAcknowledge{}
...
func (o ConnectorStreamAcknowledge) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorStreamAcknowledge) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConnectorStreamAcknowledgeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varConnectorStreamAcknowledge)
	if err == nil {
