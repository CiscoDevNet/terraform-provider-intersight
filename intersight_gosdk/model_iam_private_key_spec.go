...
type IamPrivateKeySpec struct {
	...
	CertificateRequest   NullableIamCertificateRequestRelationship `json:"CertificateRequest,omitempty"`
...
// GetDefaultClassId returns the default value "iam.PrivateKeySpec" of the ClassId field.
func (o *IamPrivateKeySpec) GetDefaultClassId() interface{} {
	return "iam.PrivateKeySpec"
}
...
// GetDefaultObjectType returns the default value "iam.PrivateKeySpec" of the ObjectType field.
func (o *IamPrivateKeySpec) GetDefaultObjectType() interface{} {
	return "iam.PrivateKeySpec"
}
...
// GetCertificateRequest returns the CertificateRequest field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IamPrivateKeySpec) GetCertificateRequest() IamCertificateRequestRelationship {
	if o == nil || IsNil(o.CertificateRequest.Get()) {
		var ret IamCertificateRequestRelationship
		return ret
	}
	return *o.CertificateRequest.Get()
}
...
// SetCertificateRequest gets a reference to the given NullableIamCertificateRequestRelationship and assigns it to the CertificateRequest field.
func (o *IamPrivateKeySpec) SetCertificateRequest(v IamCertificateRequestRelationship) {
	o.CertificateRequest.Set(&v)
}

// SetCertificateRequestNil sets the value for CertificateRequest to be an explicit nil
func (o *IamPrivateKeySpec) SetCertificateRequestNil() {
	o.CertificateRequest.Set(nil)
}
...
func (o IamPrivateKeySpec) ToMap() (map[string]interface{}, error) {
	...
	if o.CertificateRequest.IsSet() {
		toSerialize["CertificateRequest"] = o.CertificateRequest.Get()
	}
...
func (o *IamPrivateKeySpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamPrivateKeySpecWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIamPrivateKeySpec)
	if err == nil {
