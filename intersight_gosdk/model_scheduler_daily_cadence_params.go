...
func (o *SchedulerDailyCadenceParams) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSchedulerDailyCadenceParamsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSchedulerDailyCadenceParams)
	if err == nil {
