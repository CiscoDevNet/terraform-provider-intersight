...
// FabricPinGroupAllOf Definition of the list of properties defined in 'fabric.PinGroup', excluding properties defined in parent classes.
type FabricPinGroupAllOf struct {
...
type _FabricPinGroupAllOf FabricPinGroupAllOf
...
func (o FabricPinGroupAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricPinGroupAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricPinGroupAllOf := _FabricPinGroupAllOf{}

	if err = json.Unmarshal(bytes, &varFabricPinGroupAllOf); err == nil {
		*o = FabricPinGroupAllOf(varFabricPinGroupAllOf)
	}
...
type NullableFabricPinGroupAllOf struct {
	value *FabricPinGroupAllOf
	isSet bool
}

func (v NullableFabricPinGroupAllOf) Get() *FabricPinGroupAllOf {
	return v.value
}

func (v *NullableFabricPinGroupAllOf) Set(val *FabricPinGroupAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricPinGroupAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricPinGroupAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricPinGroupAllOf(val *FabricPinGroupAllOf) *NullableFabricPinGroupAllOf {
	return &NullableFabricPinGroupAllOf{value: val, isSet: true}
}

func (v NullableFabricPinGroupAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricPinGroupAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
