...
// checks if the ConvergedinfraServerComplianceDetailsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvergedinfraServerComplianceDetailsList{}
...
func (o ConvergedinfraServerComplianceDetailsList) ToMap() (map[string]interface{}, error) {
...
func (o *ConvergedinfraServerComplianceDetailsList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varConvergedinfraServerComplianceDetailsListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varConvergedinfraServerComplianceDetailsList)
	if err == nil {
