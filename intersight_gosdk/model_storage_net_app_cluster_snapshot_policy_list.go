...
func (o *StorageNetAppClusterSnapshotPolicyList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppClusterSnapshotPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStorageNetAppClusterSnapshotPolicyList)
	if err == nil {
