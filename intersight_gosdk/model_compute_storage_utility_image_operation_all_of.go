...
// ComputeStorageUtilityImageOperationAllOf Definition of the list of properties defined in 'compute.StorageUtilityImageOperation', excluding properties defined in parent classes.
type ComputeStorageUtilityImageOperationAllOf struct {
...
type _ComputeStorageUtilityImageOperationAllOf ComputeStorageUtilityImageOperationAllOf
...
func NewComputeStorageUtilityImageOperationAllOf(classId string, objectType string) *ComputeStorageUtilityImageOperationAllOf {
	this := ComputeStorageUtilityImageOperationAllOf{}
...
func (o ComputeStorageUtilityImageOperationAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ComputeStorageUtilityImageOperationAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varComputeStorageUtilityImageOperationAllOf := _ComputeStorageUtilityImageOperationAllOf{}

	if err = json.Unmarshal(bytes, &varComputeStorageUtilityImageOperationAllOf); err == nil {
		*o = ComputeStorageUtilityImageOperationAllOf(varComputeStorageUtilityImageOperationAllOf)
	}
...
type NullableComputeStorageUtilityImageOperationAllOf struct {
	value *ComputeStorageUtilityImageOperationAllOf
	isSet bool
}

func (v NullableComputeStorageUtilityImageOperationAllOf) Get() *ComputeStorageUtilityImageOperationAllOf {
	return v.value
}

func (v *NullableComputeStorageUtilityImageOperationAllOf) Set(val *ComputeStorageUtilityImageOperationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableComputeStorageUtilityImageOperationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableComputeStorageUtilityImageOperationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComputeStorageUtilityImageOperationAllOf(val *ComputeStorageUtilityImageOperationAllOf) *NullableComputeStorageUtilityImageOperationAllOf {
	return &NullableComputeStorageUtilityImageOperationAllOf{value: val, isSet: true}
}

func (v NullableComputeStorageUtilityImageOperationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComputeStorageUtilityImageOperationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
