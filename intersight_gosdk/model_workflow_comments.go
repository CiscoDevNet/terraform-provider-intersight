...
// checks if the WorkflowComments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowComments{}
...
// GetDefaultClassId returns the default value "workflow.Comments" of the ClassId field.
func (o *WorkflowComments) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "workflow.Comments" of the ObjectType field.
func (o *WorkflowComments) GetDefaultObjectType() interface{} {
	return "workflow.Comments"
}
...
func (o WorkflowComments) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowComments) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowCommentsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowComments)
	if err == nil {
