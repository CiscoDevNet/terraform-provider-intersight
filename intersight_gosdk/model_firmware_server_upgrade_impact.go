...
// checks if the FirmwareServerUpgradeImpact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirmwareServerUpgradeImpact{}
...
// GetDefaultClassId returns the default value "firmware.ServerUpgradeImpact" of the ClassId field.
func (o *FirmwareServerUpgradeImpact) GetDefaultClassId() interface{} {
	return "firmware.ServerUpgradeImpact"
}
...
// GetDefaultObjectType returns the default value "firmware.ServerUpgradeImpact" of the ObjectType field.
func (o *FirmwareServerUpgradeImpact) GetDefaultObjectType() interface{} {
	return "firmware.ServerUpgradeImpact"
}
...
func (o FirmwareServerUpgradeImpact) ToMap() (map[string]interface{}, error) {
...
func (o *FirmwareServerUpgradeImpact) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFirmwareServerUpgradeImpactWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFirmwareServerUpgradeImpact)
	if err == nil {
