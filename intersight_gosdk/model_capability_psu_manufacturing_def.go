...
// checks if the CapabilityPsuManufacturingDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityPsuManufacturingDef{}

// CapabilityPsuManufacturingDef The capability.PsuManufacturingDef object is a capability definition that stores manufacturing-specific details for a Power Supply Unit (PSU). This provides a comprehensive set of identifiers for product and inventory management. #### Purpose This object's primary function is to act as a reference for the manufacturing details of a PSU. It aggregates key product identifiers such as pid (Product Identifier), vid (Vendor ID), sku (Stock Keeping Unit), and productName. This information is essential for accurate inventory, asset tracking, and integration with support and ordering systems. #### Key Concepts - **Manufacturing Reference:** Centralizes key manufacturing and product data for a specific PSU model. - **Product Identification:** Provides standard identifiers (pid, sku, productName) that allow for easy lookup and correlation with external product databases. - **Descriptive Data:** Includes a caption and description to offer human-readable context about the PSU. - **Capability Catalog Entry:** Serves as a definition within the capability catalog, which can be referenced by other objects to retrieve detailed manufacturing information.
...
// GetDefaultClassId returns the default value "capability.PsuManufacturingDef" of the ClassId field.
func (o *CapabilityPsuManufacturingDef) GetDefaultClassId() interface{} {
	return "capability.PsuManufacturingDef"
}
...
// GetDefaultObjectType returns the default value "capability.PsuManufacturingDef" of the ObjectType field.
func (o *CapabilityPsuManufacturingDef) GetDefaultObjectType() interface{} {
	return "capability.PsuManufacturingDef"
}
...
func (o CapabilityPsuManufacturingDef) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityPsuManufacturingDef) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityPsuManufacturingDefWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityPsuManufacturingDef)
	if err == nil {
