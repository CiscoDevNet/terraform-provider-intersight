...
func (o *SchedulerBaseScheduleParams) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varSchedulerBaseScheduleParams.Duration = varSchedulerBaseScheduleParamsWithoutEmbeddedStruct.Duration
		varSchedulerBaseScheduleParams.Name = varSchedulerBaseScheduleParamsWithoutEmbeddedStruct.Name
