...
func (o SchedulerBaseScheduleParams) MarshalJSON() ([]byte, error) {
	...
	if errSchedulerAbstractSchedulingParams != nil {
		return []byte{}, errSchedulerAbstractSchedulingParams
	}
...
func (o *SchedulerBaseScheduleParams) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSchedulerBaseScheduleParamsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSchedulerBaseScheduleParams)
	if err == nil {
