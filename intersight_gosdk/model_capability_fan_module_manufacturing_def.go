...
// checks if the CapabilityFanModuleManufacturingDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityFanModuleManufacturingDef{}

// CapabilityFanModuleManufacturingDef The capability.FanModuleManufacturingDef object is a capability definition that stores manufacturing-specific details for a fan module. This provides a comprehensive set of identifiers used for inventory and product identification. #### Purpose This object's primary function is to serve as a reference for the manufacturing details of a fan module unit, which may contain multiple individual fans. It aggregates key product identifiers like pid (Product Identifier), vid (Vendor ID), sku (Stock Keeping Unit), and productName. This information is crucial for accurate inventory management, asset tracking, and support. #### Key Concepts - **Manufacturing Data:** Centralizes key manufacturing and product identifiers for a fan module. - **Product Identification:** Provides standard identifiers (pid, sku, productName) for easy lookup and integration with other systems like ordering and support tools. - **Descriptive Information:** Includes a caption and description to provide human-readable context about the fan module. - **Capability Reference:** Acts as a definition within the capability catalog, referenced by other objects to retrieve detailed manufacturing information.
...
// GetDefaultClassId returns the default value "capability.FanModuleManufacturingDef" of the ClassId field.
func (o *CapabilityFanModuleManufacturingDef) GetDefaultClassId() interface{} {
	return "capability.FanModuleManufacturingDef"
}
...
// GetDefaultObjectType returns the default value "capability.FanModuleManufacturingDef" of the ObjectType field.
func (o *CapabilityFanModuleManufacturingDef) GetDefaultObjectType() interface{} {
	return "capability.FanModuleManufacturingDef"
}
...
func (o CapabilityFanModuleManufacturingDef) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityFanModuleManufacturingDef) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityFanModuleManufacturingDefWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityFanModuleManufacturingDef)
	if err == nil {
