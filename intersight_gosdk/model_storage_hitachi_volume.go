...
type StorageHitachiVolume struct {
	...
	// Setting of the capacity saving function (dedupe and compression). * `N/A` - Not available. * `compression` - The capacity saving function (compression) is enabled. * `compression_deduplication` - The capacity saving function (compression and deduplication) is enabled. * `disabled` - The capacity saving function (compression and deduplication) is disabled.
	DataReductionMode *string `json:"DataReductionMode,omitempty"`
	// Status of the capacity saving function. * `N/A` - Not available. * `ENABLED` - The capacity saving function is enabled. * `DISABLED` - The capacity saving function is disabled. * `ENABLING` - The capacity saving function is being enabled. * `REHYDRATING` - The capacity saving function is being disabled. * `DELETING` - The volumes for which the capacity saving function is enabled are being deleted. * `FAILED` - An attempt to enable the capacity saving function failed.
	...
	// RAID level for the volume. * `N/A` - Not available. * `RAID1` - RAID1. * `RAID5` - RAID5. * `RAID6` - RAID6.
	RaidLevel *string `json:"RaidLevel,omitempty"`
	// RAID type drive configuration.
	RaidType *string `json:"RaidType,omitempty"`
	// Status information of the volume. * `N/A` - Not available. * `NML` - The volume is in normal status. * `BLK` - The volume is blocked. * `BSY` - The volume status is being changed. * `Unknown` - The volume status is unknown (not supported).
