...
// checks if the StorageNetAppSensor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageNetAppSensor{}
...
func (o *StorageNetAppSensor) GetDefaultClassId() interface{} {
...
func (o *StorageNetAppSensor) GetDefaultObjectType() interface{} {
	return "storage.NetAppSensor"
}
...
func (o *StorageNetAppSensor) SetArrayControllerNil() {
...
func (o StorageNetAppSensor) ToMap() (map[string]interface{}, error) {
	...
	if errEquipmentBaseSensor != nil {
		return map[string]interface{}{}, errEquipmentBaseSensor
	}
...
func (o *StorageNetAppSensor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageNetAppSensorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageNetAppSensor)
	if err == nil {
