...
// StorageNetAppFcPortListAllOf struct for StorageNetAppFcPortListAllOf
type StorageNetAppFcPortListAllOf struct {
...
type _StorageNetAppFcPortListAllOf StorageNetAppFcPortListAllOf
...
func NewStorageNetAppFcPortListAllOf() *StorageNetAppFcPortListAllOf {
	this := StorageNetAppFcPortListAllOf{}
	return &this
}
...
func (o StorageNetAppFcPortListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppFcPortListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppFcPortListAllOf := _StorageNetAppFcPortListAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppFcPortListAllOf); err == nil {
		*o = StorageNetAppFcPortListAllOf(varStorageNetAppFcPortListAllOf)
	}
...
type NullableStorageNetAppFcPortListAllOf struct {
	value *StorageNetAppFcPortListAllOf
	isSet bool
}

func (v NullableStorageNetAppFcPortListAllOf) Get() *StorageNetAppFcPortListAllOf {
	return v.value
}

func (v *NullableStorageNetAppFcPortListAllOf) Set(val *StorageNetAppFcPortListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppFcPortListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppFcPortListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppFcPortListAllOf(val *StorageNetAppFcPortListAllOf) *NullableStorageNetAppFcPortListAllOf {
	return &NullableStorageNetAppFcPortListAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppFcPortListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppFcPortListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
