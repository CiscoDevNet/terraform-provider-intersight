...
// checks if the OsInstallTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsInstallTarget{}
...
func (o OsInstallTarget) ToMap() (map[string]interface{}, error) {
...
func (o *OsInstallTarget) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsInstallTargetWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsInstallTarget)
	if err == nil {
