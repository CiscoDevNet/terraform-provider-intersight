...
// NiatelemetrySyslogSysMsgAllOf Definition of the list of properties defined in 'niatelemetry.SyslogSysMsg', excluding properties defined in parent classes.
type NiatelemetrySyslogSysMsgAllOf struct {
...
type _NiatelemetrySyslogSysMsgAllOf NiatelemetrySyslogSysMsgAllOf
...
func NewNiatelemetrySyslogSysMsgAllOf(classId string, objectType string) *NiatelemetrySyslogSysMsgAllOf {
	this := NiatelemetrySyslogSysMsgAllOf{}
...
func (o NiatelemetrySyslogSysMsgAllOf) MarshalJSON() ([]byte, error) {
...
func (o *NiatelemetrySyslogSysMsgAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varNiatelemetrySyslogSysMsgAllOf := _NiatelemetrySyslogSysMsgAllOf{}

	if err = json.Unmarshal(bytes, &varNiatelemetrySyslogSysMsgAllOf); err == nil {
		*o = NiatelemetrySyslogSysMsgAllOf(varNiatelemetrySyslogSysMsgAllOf)
	}
...
type NullableNiatelemetrySyslogSysMsgAllOf struct {
	value *NiatelemetrySyslogSysMsgAllOf
	isSet bool
}

func (v NullableNiatelemetrySyslogSysMsgAllOf) Get() *NiatelemetrySyslogSysMsgAllOf {
	return v.value
}

func (v *NullableNiatelemetrySyslogSysMsgAllOf) Set(val *NiatelemetrySyslogSysMsgAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNiatelemetrySyslogSysMsgAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNiatelemetrySyslogSysMsgAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNiatelemetrySyslogSysMsgAllOf(val *NiatelemetrySyslogSysMsgAllOf) *NullableNiatelemetrySyslogSysMsgAllOf {
	return &NullableNiatelemetrySyslogSysMsgAllOf{value: val, isSet: true}
}

func (v NullableNiatelemetrySyslogSysMsgAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNiatelemetrySyslogSysMsgAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
