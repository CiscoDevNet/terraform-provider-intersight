...
// GetDefaultClassId returns the default value "vnic.EthIfInventory" of the ClassId field.
func (o *VnicEthIfInventory) GetDefaultClassId() interface{} {
	return "vnic.EthIfInventory"
}
...
// GetDefaultObjectType returns the default value "vnic.EthIfInventory" of the ObjectType field.
func (o *VnicEthIfInventory) GetDefaultObjectType() interface{} {
	return "vnic.EthIfInventory"
}
...
func (o *VnicEthIfInventory) SetIscsiIpV6ConfigNil() {
...
func (o *VnicEthIfInventory) SetOldInfoNil() {
	o.OldInfo.Set(nil)
}
...
func (o *VnicEthIfInventory) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varVnicEthIfInventory.IscsiIpV6AddressAllocationType = varVnicEthIfInventoryWithoutEmbeddedStruct.IscsiIpV6AddressAllocationType
		varVnicEthIfInventory.IscsiIpV6Config = varVnicEthIfInventoryWithoutEmbeddedStruct.IscsiIpV6Config
		varVnicEthIfInventory.IscsiIpv4Address = varVnicEthIfInventoryWithoutEmbeddedStruct.IscsiIpv4Address
		varVnicEthIfInventory.IscsiIpv6Address = varVnicEthIfInventoryWithoutEmbeddedStruct.IscsiIpv6Address
		...
		varVnicEthIfInventory.Stale = varVnicEthIfInventoryWithoutEmbeddedStruct.Stale
