...
func (dst *StoragePureHostResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal StoragePureHostResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal StoragePureHostResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("failed to unmarshal StoragePureHostResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'storage.PureHost.List'
	if jsonDict["ObjectType"] == "storage.PureHost.List" {
		// try to unmarshal JSON data into StoragePureHostList
		err = json.Unmarshal(data, &dst.StoragePureHostList)
		if err == nil {
			return nil // data stored in dst.StoragePureHostList, return on the first match
		} else {
			dst.StoragePureHostList = nil
			return fmt.Errorf("failed to unmarshal StoragePureHostResponse as StoragePureHostList: %s", err.Error())
		}
	}
...
func (src StoragePureHostResponse) MarshalJSON() ([]byte, error) {
	...
	if src.StoragePureHostList != nil {
		return json.Marshal(&src.StoragePureHostList)
	}
...
func (obj *StoragePureHostResponse) GetActualInstance() interface{} {
	...
	if obj.StoragePureHostList != nil {
		return obj.StoragePureHostList
	}
...
type NullableStoragePureHostResponse struct {
	value *StoragePureHostResponse
	isSet bool
}

func (v NullableStoragePureHostResponse) Get() *StoragePureHostResponse {
	return v.value
}

func (v *NullableStoragePureHostResponse) Set(val *StoragePureHostResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStoragePureHostResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStoragePureHostResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoragePureHostResponse(val *StoragePureHostResponse) *NullableStoragePureHostResponse {
	return &NullableStoragePureHostResponse{value: val, isSet: true}
}

func (v NullableStoragePureHostResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoragePureHostResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
