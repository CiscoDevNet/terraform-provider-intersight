...
// IwotenantTenantCustomizationAllOf Definition of the list of properties defined in 'iwotenant.TenantCustomization', excluding properties defined in parent classes.
type IwotenantTenantCustomizationAllOf struct {
...
type _IwotenantTenantCustomizationAllOf IwotenantTenantCustomizationAllOf
...
func NewIwotenantTenantCustomizationAllOf(classId string, objectType string) *IwotenantTenantCustomizationAllOf {
	this := IwotenantTenantCustomizationAllOf{}
...
func (o IwotenantTenantCustomizationAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IwotenantTenantCustomizationAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIwotenantTenantCustomizationAllOf := _IwotenantTenantCustomizationAllOf{}

	if err = json.Unmarshal(bytes, &varIwotenantTenantCustomizationAllOf); err == nil {
		*o = IwotenantTenantCustomizationAllOf(varIwotenantTenantCustomizationAllOf)
	}
...
type NullableIwotenantTenantCustomizationAllOf struct {
	value *IwotenantTenantCustomizationAllOf
	isSet bool
}

func (v NullableIwotenantTenantCustomizationAllOf) Get() *IwotenantTenantCustomizationAllOf {
	return v.value
}

func (v *NullableIwotenantTenantCustomizationAllOf) Set(val *IwotenantTenantCustomizationAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIwotenantTenantCustomizationAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIwotenantTenantCustomizationAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIwotenantTenantCustomizationAllOf(val *IwotenantTenantCustomizationAllOf) *NullableIwotenantTenantCustomizationAllOf {
	return &NullableIwotenantTenantCustomizationAllOf{value: val, isSet: true}
}

func (v NullableIwotenantTenantCustomizationAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIwotenantTenantCustomizationAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
