...
// StorageNetAppIpInterfaceEventAllOf Definition of the list of properties defined in 'storage.NetAppIpInterfaceEvent', excluding properties defined in parent classes.
type StorageNetAppIpInterfaceEventAllOf struct {
...
type _StorageNetAppIpInterfaceEventAllOf StorageNetAppIpInterfaceEventAllOf
...
func NewStorageNetAppIpInterfaceEventAllOf(classId string, objectType string) *StorageNetAppIpInterfaceEventAllOf {
	this := StorageNetAppIpInterfaceEventAllOf{}
...
func (o StorageNetAppIpInterfaceEventAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageNetAppIpInterfaceEventAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageNetAppIpInterfaceEventAllOf := _StorageNetAppIpInterfaceEventAllOf{}

	if err = json.Unmarshal(bytes, &varStorageNetAppIpInterfaceEventAllOf); err == nil {
		*o = StorageNetAppIpInterfaceEventAllOf(varStorageNetAppIpInterfaceEventAllOf)
	}
...
type NullableStorageNetAppIpInterfaceEventAllOf struct {
	value *StorageNetAppIpInterfaceEventAllOf
	isSet bool
}

func (v NullableStorageNetAppIpInterfaceEventAllOf) Get() *StorageNetAppIpInterfaceEventAllOf {
	return v.value
}

func (v *NullableStorageNetAppIpInterfaceEventAllOf) Set(val *StorageNetAppIpInterfaceEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageNetAppIpInterfaceEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageNetAppIpInterfaceEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageNetAppIpInterfaceEventAllOf(val *StorageNetAppIpInterfaceEventAllOf) *NullableStorageNetAppIpInterfaceEventAllOf {
	return &NullableStorageNetAppIpInterfaceEventAllOf{value: val, isSet: true}
}

func (v NullableStorageNetAppIpInterfaceEventAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageNetAppIpInterfaceEventAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
