...
// checks if the CapabilityPortGroupAggregationDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityPortGroupAggregationDef{}

// CapabilityPortGroupAggregationDef The PortGroupAggregationDef defines how port-groups on FEX/IOCARD modules can be aggregated. #### Purpose A PortGroupAggregationDef serves as the blueprint for defining port group aggregation capabilities, supporting efficient network management and configuration.  #### Key Concepts - **Aggregation Capability:** Specifies the aggregation capabilities associated with port groups, enhancing network efficiency and resource management. - **Module Integration:** Focuses on FEX/IOCARD module port groups, ensuring seamless integration and configuration within network systems. - **Access Management:** Utilizes privilege sets to ensure secure access and management of port group capabilities, maintaining system integrity.
...
// GetDefaultClassId returns the default value "capability.PortGroupAggregationDef" of the ClassId field.
func (o *CapabilityPortGroupAggregationDef) GetDefaultClassId() interface{} {
	return "capability.PortGroupAggregationDef"
}
...
// GetDefaultObjectType returns the default value "capability.PortGroupAggregationDef" of the ObjectType field.
func (o *CapabilityPortGroupAggregationDef) GetDefaultObjectType() interface{} {
	return "capability.PortGroupAggregationDef"
}
...
func (o *CapabilityPortGroupAggregationDef) GetAggregationCap() string {
	if o == nil || IsNil(o.AggregationCap) {
		var ret string
		return ret
	}
...
func (o *CapabilityPortGroupAggregationDef) GetHw40GPortGroupCap() bool {
	if o == nil || IsNil(o.Hw40GPortGroupCap) {
		var ret bool
		return ret
	}
...
func (o CapabilityPortGroupAggregationDef) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AggregationCap) {
		toSerialize["AggregationCap"] = o.AggregationCap
	}
	if !IsNil(o.Hw40GPortGroupCap) {
...
func (o *CapabilityPortGroupAggregationDef) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityPortGroupAggregationDefWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityPortGroupAggregationDef)
	if err == nil {
