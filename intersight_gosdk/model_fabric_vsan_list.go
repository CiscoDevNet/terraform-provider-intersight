...
// checks if the FabricVsanList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricVsanList{}
...
func (o FabricVsanList) ToMap() (map[string]interface{}, error) {
...
func (o *FabricVsanList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricVsanListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricVsanList)
	if err == nil {
