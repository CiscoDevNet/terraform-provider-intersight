...
func (o *SchedulerRecurringScheduleParams) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSchedulerRecurringScheduleParamsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSchedulerRecurringScheduleParams)
	if err == nil {
