...
// GetDefaultClassId returns the default value "appliance.RemoteFileImport" of the ClassId field.
func (o *ApplianceRemoteFileImport) GetDefaultClassId() interface{} {
	return "appliance.RemoteFileImport"
}
...
// GetDefaultObjectType returns the default value "appliance.RemoteFileImport" of the ObjectType field.
func (o *ApplianceRemoteFileImport) GetDefaultObjectType() interface{} {
	return "appliance.RemoteFileImport"
}
...
func (o *ApplianceRemoteFileImport) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o ApplianceRemoteFileImport) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceRemoteFileImport) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceRemoteFileImportWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceRemoteFileImport)
	if err == nil {
