...
// checks if the ResourcepoolPoolList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourcepoolPoolList{}
...
func (o ResourcepoolPoolList) ToMap() (map[string]interface{}, error) {
...
func (o *ResourcepoolPoolList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varResourcepoolPoolListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varResourcepoolPoolList)
	if err == nil {
