...
// checks if the EquipmentDeviceSummaryList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EquipmentDeviceSummaryList{}
...
func (o EquipmentDeviceSummaryList) ToMap() (map[string]interface{}, error) {
...
func (o *EquipmentDeviceSummaryList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEquipmentDeviceSummaryListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varEquipmentDeviceSummaryList)
	if err == nil {
