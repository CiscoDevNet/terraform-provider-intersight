...
// checks if the OsWindowsParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsWindowsParameters{}
...
// GetDefaultClassId returns the default value "os.WindowsParameters" of the ClassId field.
func (o *OsWindowsParameters) GetDefaultClassId() interface{} {
	return "os.WindowsParameters"
}
...
// GetDefaultObjectType returns the default value "os.WindowsParameters" of the ObjectType field.
func (o *OsWindowsParameters) GetDefaultObjectType() interface{} {
	return "os.WindowsParameters"
}
...
func (o OsWindowsParameters) ToMap() (map[string]interface{}, error) {
...
func (o *OsWindowsParameters) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsWindowsParametersWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsWindowsParameters)
	if err == nil {
