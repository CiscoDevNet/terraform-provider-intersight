...
// IamLdapProviderAllOf Definition of the list of properties defined in 'iam.LdapProvider', excluding properties defined in parent classes.
type IamLdapProviderAllOf struct {
...
type _IamLdapProviderAllOf IamLdapProviderAllOf
...
func (o IamLdapProviderAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IamLdapProviderAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIamLdapProviderAllOf := _IamLdapProviderAllOf{}

	if err = json.Unmarshal(bytes, &varIamLdapProviderAllOf); err == nil {
		*o = IamLdapProviderAllOf(varIamLdapProviderAllOf)
	}
...
type NullableIamLdapProviderAllOf struct {
	value *IamLdapProviderAllOf
	isSet bool
}

func (v NullableIamLdapProviderAllOf) Get() *IamLdapProviderAllOf {
	return v.value
}

func (v *NullableIamLdapProviderAllOf) Set(val *IamLdapProviderAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamLdapProviderAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamLdapProviderAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamLdapProviderAllOf(val *IamLdapProviderAllOf) *NullableIamLdapProviderAllOf {
	return &NullableIamLdapProviderAllOf{value: val, isSet: true}
}

func (v NullableIamLdapProviderAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamLdapProviderAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
