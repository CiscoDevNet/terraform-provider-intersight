...
type _BootBootloaderAllOf BootBootloaderAllOf
...
func (o *BootBootloaderAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBootBootloaderAllOf := _BootBootloaderAllOf{}

	if err = json.Unmarshal(bytes, &varBootBootloaderAllOf); err == nil {
		*o = BootBootloaderAllOf(varBootBootloaderAllOf)
	}
