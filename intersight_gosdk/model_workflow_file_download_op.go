...
// checks if the WorkflowFileDownloadOp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowFileDownloadOp{}
...
// GetDefaultClassId returns the default value "workflow.FileDownloadOp" of the ClassId field.
func (o *WorkflowFileDownloadOp) GetDefaultClassId() interface{} {
	return "workflow.FileDownloadOp"
}
...
// GetDefaultObjectType returns the default value "workflow.FileDownloadOp" of the ObjectType field.
func (o *WorkflowFileDownloadOp) GetDefaultObjectType() interface{} {
	return "workflow.FileDownloadOp"
}
...
func (o WorkflowFileDownloadOp) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowFileDownloadOp) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowFileDownloadOpWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowFileDownloadOp)
	if err == nil {
