...
// CondHclStatusDetail ### Overview The HclStatusDetail object provides detailed validation information for each component's firmware and drivers against the Hardware Compatibility List (HCL). It complements the broader HclStatus object by breaking down validation results at a component level. #### Purpose HclStatusDetail is essential for providing granular insights into the compatibility of individual components, helping identify specific issues and validation failures. It aids in maintaining high standards of component compatibility within Cisco environments. #### Key Concepts - **Detailed Validation:** - Offers component-specific validation results, such as \"Validated\" and \"Not-Validated\", for precise compatibility reporting. - **Status Reasoning:** - Provides detailed reasons for validation outcomes, facilitating targeted troubleshooting. - **Integration:** - Works alongside the HclStatus object to deliver comprehensive compatibility insights across server components. - **Access Control:** - Establishes privilege sets for reading component validation details, supporting secure management.
type CondHclStatusDetail struct {
	...
	InvVendor *string `json:"InvVendor,omitempty"`
...
// GetInvVendor returns the InvVendor field value if set, zero value otherwise.
func (o *CondHclStatusDetail) GetInvVendor() string {
	if o == nil || IsNil(o.InvVendor) {
		var ret string
		return ret
	}
	return *o.InvVendor
...
// GetInvVendorOk returns a tuple with the InvVendor field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CondHclStatusDetail) GetInvVendorOk() (*string, bool) {
	if o == nil || IsNil(o.InvVendor) {
		return nil, false
	}
	return o.InvVendor, true
}
...
// SetInvVendor gets a reference to the given string and assigns it to the InvVendor field.
...
func (o CondHclStatusDetail) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InvVendor) {
		toSerialize["InvVendor"] = o.InvVendor
	}
	if !IsNil(o.Reason) {
...
func (o *CondHclStatusDetail) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varCondHclStatusDetail.InvVendor = varCondHclStatusDetailWithoutEmbeddedStruct.InvVendor
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "InvVendor")
