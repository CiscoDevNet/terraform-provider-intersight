...
// checks if the TelemetryDruidHavingDimensionSelectorFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidHavingDimensionSelectorFilter{}
...
func (o TelemetryDruidHavingDimensionSelectorFilter) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidHavingDimensionSelectorFilter) UnmarshalJSON(data []byte) (err error) {
