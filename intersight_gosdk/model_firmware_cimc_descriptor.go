...
// checks if the FirmwareCimcDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirmwareCimcDescriptor{}
...
func (o FirmwareCimcDescriptor) ToMap() (map[string]interface{}, error) {
...
func (o *FirmwareCimcDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFirmwareCimcDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFirmwareCimcDescriptor)
	if err == nil {
