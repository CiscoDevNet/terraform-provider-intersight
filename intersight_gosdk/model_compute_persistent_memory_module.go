...
// checks if the ComputePersistentMemoryModule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputePersistentMemoryModule{}
...
// GetDefaultClassId returns the default value "compute.PersistentMemoryModule" of the ClassId field.
func (o *ComputePersistentMemoryModule) GetDefaultClassId() interface{} {
	return "compute.PersistentMemoryModule"
}
...
// GetDefaultObjectType returns the default value "compute.PersistentMemoryModule" of the ObjectType field.
func (o *ComputePersistentMemoryModule) GetDefaultObjectType() interface{} {
	return "compute.PersistentMemoryModule"
}
...
func (o ComputePersistentMemoryModule) ToMap() (map[string]interface{}, error) {
...
func (o *ComputePersistentMemoryModule) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varComputePersistentMemoryModuleWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varComputePersistentMemoryModule)
	if err == nil {
