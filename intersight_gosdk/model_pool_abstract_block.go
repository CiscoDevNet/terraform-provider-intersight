...
// checks if the PoolAbstractBlock type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoolAbstractBlock{}
...
type PoolAbstractBlock struct {
	...
	IdMappingPolicy      NullablePoolIdMappingPolicyRelationship `json:"IdMappingPolicy,omitempty"`
...
func (o *PoolAbstractBlock) GetFreeBlockCount() int64 {
	if o == nil || IsNil(o.FreeBlockCount) {
		var ret int64
		return ret
	}
...
func (o *PoolAbstractBlock) GetNextIdAllocator() int64 {
	if o == nil || IsNil(o.NextIdAllocator) {
		var ret int64
		return ret
	}
...
// GetIdMappingPolicy returns the IdMappingPolicy field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PoolAbstractBlock) GetIdMappingPolicy() PoolIdMappingPolicyRelationship {
	if o == nil || IsNil(o.IdMappingPolicy.Get()) {
		var ret PoolIdMappingPolicyRelationship
		return ret
	}
	return *o.IdMappingPolicy.Get()
}

// GetIdMappingPolicyOk returns a tuple with the IdMappingPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetIdMappingPolicy gets a reference to the given NullablePoolIdMappingPolicyRelationship and assigns it to the IdMappingPolicy field.
func (o *PoolAbstractBlock) SetIdMappingPolicy(v PoolIdMappingPolicyRelationship) {
	o.IdMappingPolicy.Set(&v)
}

// SetIdMappingPolicyNil sets the value for IdMappingPolicy to be an explicit nil
func (o *PoolAbstractBlock) SetIdMappingPolicyNil() {
	o.IdMappingPolicy.Set(nil)
}
...
func (o PoolAbstractBlock) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FreeBlockCount) {
		toSerialize["FreeBlockCount"] = o.FreeBlockCount
	}
	if !IsNil(o.NextIdAllocator) {
		toSerialize["NextIdAllocator"] = o.NextIdAllocator
	}
	if o.IdMappingPolicy.IsSet() {
		toSerialize["IdMappingPolicy"] = o.IdMappingPolicy.Get()
	}
...
func (o *PoolAbstractBlock) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPoolAbstractBlockWithoutEmbeddedStruct)
	if err == nil {
		...
		varPoolAbstractBlock.IdMappingPolicy = varPoolAbstractBlockWithoutEmbeddedStruct.IdMappingPolicy
	...
	err = json.Unmarshal(data, &varPoolAbstractBlock)
	if err == nil {
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "IdMappingPolicy")
