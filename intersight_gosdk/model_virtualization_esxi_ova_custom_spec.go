...
// checks if the VirtualizationEsxiOvaCustomSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationEsxiOvaCustomSpec{}
...
// GetDefaultClassId returns the default value "virtualization.EsxiOvaCustomSpec" of the ClassId field.
func (o *VirtualizationEsxiOvaCustomSpec) GetDefaultClassId() interface{} {
	return "virtualization.EsxiOvaCustomSpec"
}
...
// GetDefaultObjectType returns the default value "virtualization.EsxiOvaCustomSpec" of the ObjectType field.
func (o *VirtualizationEsxiOvaCustomSpec) GetDefaultObjectType() interface{} {
	return "virtualization.EsxiOvaCustomSpec"
}
...
func (o VirtualizationEsxiOvaCustomSpec) ToMap() (map[string]interface{}, error) {
	...
	if errVirtualizationBaseCustomSpec != nil {
		return map[string]interface{}{}, errVirtualizationBaseCustomSpec
	}
...
func (o *VirtualizationEsxiOvaCustomSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiOvaCustomSpecWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationEsxiOvaCustomSpec)
	if err == nil {
