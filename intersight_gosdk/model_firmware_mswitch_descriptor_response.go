...
func FirmwareMswitchDescriptorListAsFirmwareMswitchDescriptorResponse(v *FirmwareMswitchDescriptorList) FirmwareMswitchDescriptorResponse {
	return FirmwareMswitchDescriptorResponse{
		FirmwareMswitchDescriptorList: v,
	}
}
...
func (dst *FirmwareMswitchDescriptorResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "firmware.MswitchDescriptor.List" {
		// try to unmarshal JSON data into FirmwareMswitchDescriptorList
		err = json.Unmarshal(data, &dst.FirmwareMswitchDescriptorList)
		if err == nil {
			return nil // data stored in dst.FirmwareMswitchDescriptorList, return on the first match
		} else {
			dst.FirmwareMswitchDescriptorList = nil
			return fmt.Errorf("Failed to unmarshal FirmwareMswitchDescriptorResponse as FirmwareMswitchDescriptorList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FirmwareMswitchDescriptorResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FirmwareMswitchDescriptorResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal FirmwareMswitchDescriptorResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src FirmwareMswitchDescriptorResponse) MarshalJSON() ([]byte, error) {
	if src.FirmwareMswitchDescriptorList != nil {
		return json.Marshal(&src.FirmwareMswitchDescriptorList)
	}
...
type NullableFirmwareMswitchDescriptorResponse struct {
	value *FirmwareMswitchDescriptorResponse
	isSet bool
}

func (v NullableFirmwareMswitchDescriptorResponse) Get() *FirmwareMswitchDescriptorResponse {
	return v.value
}

func (v *NullableFirmwareMswitchDescriptorResponse) Set(val *FirmwareMswitchDescriptorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFirmwareMswitchDescriptorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFirmwareMswitchDescriptorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirmwareMswitchDescriptorResponse(val *FirmwareMswitchDescriptorResponse) *NullableFirmwareMswitchDescriptorResponse {
	return &NullableFirmwareMswitchDescriptorResponse{value: val, isSet: true}
}

func (v NullableFirmwareMswitchDescriptorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirmwareMswitchDescriptorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
