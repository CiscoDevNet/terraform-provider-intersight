...
// EquipmentDeviceSummaryListAllOf struct for EquipmentDeviceSummaryListAllOf
type EquipmentDeviceSummaryListAllOf struct {
...
type _EquipmentDeviceSummaryListAllOf EquipmentDeviceSummaryListAllOf
...
func NewEquipmentDeviceSummaryListAllOf() *EquipmentDeviceSummaryListAllOf {
	this := EquipmentDeviceSummaryListAllOf{}
	return &this
}
...
func (o EquipmentDeviceSummaryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *EquipmentDeviceSummaryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varEquipmentDeviceSummaryListAllOf := _EquipmentDeviceSummaryListAllOf{}

	if err = json.Unmarshal(bytes, &varEquipmentDeviceSummaryListAllOf); err == nil {
		*o = EquipmentDeviceSummaryListAllOf(varEquipmentDeviceSummaryListAllOf)
	}
...
type NullableEquipmentDeviceSummaryListAllOf struct {
	value *EquipmentDeviceSummaryListAllOf
	isSet bool
}

func (v NullableEquipmentDeviceSummaryListAllOf) Get() *EquipmentDeviceSummaryListAllOf {
	return v.value
}

func (v *NullableEquipmentDeviceSummaryListAllOf) Set(val *EquipmentDeviceSummaryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableEquipmentDeviceSummaryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableEquipmentDeviceSummaryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEquipmentDeviceSummaryListAllOf(val *EquipmentDeviceSummaryListAllOf) *NullableEquipmentDeviceSummaryListAllOf {
	return &NullableEquipmentDeviceSummaryListAllOf{value: val, isSet: true}
}

func (v NullableEquipmentDeviceSummaryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEquipmentDeviceSummaryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
