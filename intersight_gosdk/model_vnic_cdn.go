...
// checks if the VnicCdn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VnicCdn{}
...
type VnicCdn struct {
	...
	Value                *string `json:"Value,omitempty" validate:"regexp=^[a-zA-Z0-9\\\\-\\\\._:]*$"`
...
// GetDefaultClassId returns the default value "vnic.Cdn" of the ClassId field.
func (o *VnicCdn) GetDefaultClassId() interface{} {
	return "vnic.Cdn"
}
...
// GetDefaultObjectType returns the default value "vnic.Cdn" of the ObjectType field.
func (o *VnicCdn) GetDefaultObjectType() interface{} {
	return "vnic.Cdn"
}
...
func (o VnicCdn) ToMap() (map[string]interface{}, error) {
...
func (o *VnicCdn) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVnicCdnWithoutEmbeddedStruct)
	if err == nil {
		varVnicCdn := _VnicCdn{}
	...
	err = json.Unmarshal(data, &varVnicCdn)
	if err == nil {
