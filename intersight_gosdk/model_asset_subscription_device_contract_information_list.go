...
// checks if the AssetSubscriptionDeviceContractInformationList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetSubscriptionDeviceContractInformationList{}
...
func (o AssetSubscriptionDeviceContractInformationList) ToMap() (map[string]interface{}, error) {
...
func (o *AssetSubscriptionDeviceContractInformationList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAssetSubscriptionDeviceContractInformationListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varAssetSubscriptionDeviceContractInformationList)
	if err == nil {
