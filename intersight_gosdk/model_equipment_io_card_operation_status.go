...
func (o *EquipmentIoCardOperationStatus) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varEquipmentIoCardOperationStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varEquipmentIoCardOperationStatus)
	if err == nil {
