...
// AssetPrivateKeyCredential An credential which performs authentication based on a private key for targets like SSH Endpoint. PrivateKeyCredential used to establish password-less ssh connection to the endpoint.
...
func (o *AssetPrivateKeyCredential) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAssetPrivateKeyCredentialWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varAssetPrivateKeyCredential)
	if err == nil {
