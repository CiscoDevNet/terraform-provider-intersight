...
// checks if the KubernetesNodeAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesNodeAddress{}
...
// GetDefaultClassId returns the default value "kubernetes.NodeAddress" of the ClassId field.
func (o *KubernetesNodeAddress) GetDefaultClassId() interface{} {
	return "kubernetes.NodeAddress"
}
...
// GetDefaultObjectType returns the default value "kubernetes.NodeAddress" of the ObjectType field.
func (o *KubernetesNodeAddress) GetDefaultObjectType() interface{} {
	return "kubernetes.NodeAddress"
}
...
func (o KubernetesNodeAddress) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesNodeAddress) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesNodeAddressWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesNodeAddress)
	if err == nil {
