...
// checks if the StorageInitiator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageInitiator{}
...
func NewStorageInitiator(classId string, objectType string) *StorageInitiator {
...
func (o StorageInitiator) ToMap() (map[string]interface{}, error) {
...
func (o *StorageInitiator) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageInitiatorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageInitiator)
	if err == nil {
