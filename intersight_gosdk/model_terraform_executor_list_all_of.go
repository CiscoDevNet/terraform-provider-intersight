...
// TerraformExecutorListAllOf struct for TerraformExecutorListAllOf
type TerraformExecutorListAllOf struct {
...
type _TerraformExecutorListAllOf TerraformExecutorListAllOf
...
func NewTerraformExecutorListAllOf() *TerraformExecutorListAllOf {
	this := TerraformExecutorListAllOf{}
	return &this
}
...
func (o TerraformExecutorListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *TerraformExecutorListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTerraformExecutorListAllOf := _TerraformExecutorListAllOf{}

	if err = json.Unmarshal(bytes, &varTerraformExecutorListAllOf); err == nil {
		*o = TerraformExecutorListAllOf(varTerraformExecutorListAllOf)
	}
...
type NullableTerraformExecutorListAllOf struct {
	value *TerraformExecutorListAllOf
	isSet bool
}

func (v NullableTerraformExecutorListAllOf) Get() *TerraformExecutorListAllOf {
	return v.value
}

func (v *NullableTerraformExecutorListAllOf) Set(val *TerraformExecutorListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTerraformExecutorListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTerraformExecutorListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTerraformExecutorListAllOf(val *TerraformExecutorListAllOf) *NullableTerraformExecutorListAllOf {
	return &NullableTerraformExecutorListAllOf{value: val, isSet: true}
}

func (v NullableTerraformExecutorListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTerraformExecutorListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
