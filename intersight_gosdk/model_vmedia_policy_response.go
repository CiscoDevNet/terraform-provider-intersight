...
func (dst *VmediaPolicyResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VmediaPolicyResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VmediaPolicyResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VmediaPolicyResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'vmedia.Policy.List'
	if jsonDict["ObjectType"] == "vmedia.Policy.List" {
		// try to unmarshal JSON data into VmediaPolicyList
		err = json.Unmarshal(data, &dst.VmediaPolicyList)
		if err == nil {
			return nil // data stored in dst.VmediaPolicyList, return on the first match
		} else {
			dst.VmediaPolicyList = nil
			return fmt.Errorf("Failed to unmarshal VmediaPolicyResponse as VmediaPolicyList: %s", err.Error())
		}
	}
...
type NullableVmediaPolicyResponse struct {
	value *VmediaPolicyResponse
	isSet bool
}

func (v NullableVmediaPolicyResponse) Get() *VmediaPolicyResponse {
	return v.value
}

func (v *NullableVmediaPolicyResponse) Set(val *VmediaPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVmediaPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVmediaPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmediaPolicyResponse(val *VmediaPolicyResponse) *NullableVmediaPolicyResponse {
	return &NullableVmediaPolicyResponse{value: val, isSet: true}
}

func (v NullableVmediaPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmediaPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
