...
// BootNvmeDeviceAllOf Definition of the list of properties defined in 'boot.NvmeDevice', excluding properties defined in parent classes.
type BootNvmeDeviceAllOf struct {
...
type _BootNvmeDeviceAllOf BootNvmeDeviceAllOf
...
func (o BootNvmeDeviceAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BootNvmeDeviceAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBootNvmeDeviceAllOf := _BootNvmeDeviceAllOf{}

	if err = json.Unmarshal(bytes, &varBootNvmeDeviceAllOf); err == nil {
		*o = BootNvmeDeviceAllOf(varBootNvmeDeviceAllOf)
	}
...
type NullableBootNvmeDeviceAllOf struct {
	value *BootNvmeDeviceAllOf
	isSet bool
}

func (v NullableBootNvmeDeviceAllOf) Get() *BootNvmeDeviceAllOf {
	return v.value
}

func (v *NullableBootNvmeDeviceAllOf) Set(val *BootNvmeDeviceAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBootNvmeDeviceAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBootNvmeDeviceAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootNvmeDeviceAllOf(val *BootNvmeDeviceAllOf) *NullableBootNvmeDeviceAllOf {
	return &NullableBootNvmeDeviceAllOf{value: val, isSet: true}
}

func (v NullableBootNvmeDeviceAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootNvmeDeviceAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
