...
func (o *FabricFcStorageRole) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varFabricFcStorageRoleWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varFabricFcStorageRole)
	if err == nil {
