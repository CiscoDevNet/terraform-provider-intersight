...
func (o *AssetDeploymentAllOf) GetWorkload() string {
...
// and a boolean to check if the value has been set.
func (o *AssetDeploymentAllOf) GetWorkloadOk() (*string, bool) {
	if o == nil || o.Workload == nil {
		return nil, false
	}
...
func (o *AssetDeploymentAllOf) HasWorkload() bool {
	if o != nil && o.Workload != nil {
		return true
	}
...
func (o *AssetDeploymentAllOf) SetWorkload(v string) {
	o.Workload = &v
}
