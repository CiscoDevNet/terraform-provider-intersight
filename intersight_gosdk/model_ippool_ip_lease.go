...
func (o *IppoolIpLease) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varIppoolIpLease.Var0VirtualMachineNodeProfile = varIppoolIpLeaseWithoutEmbeddedStruct.Var0VirtualMachineNodeProfile
		varIppoolIpLease.Var1VirtualMachineNodeProfile = varIppoolIpLeaseWithoutEmbeddedStruct.Var1VirtualMachineNodeProfile
		varIppoolIpLease.Var2ClusterProfile = varIppoolIpLeaseWithoutEmbeddedStruct.Var2ClusterProfile
		varIppoolIpLease.Var3ClusterProfile = varIppoolIpLeaseWithoutEmbeddedStruct.Var3ClusterProfile
