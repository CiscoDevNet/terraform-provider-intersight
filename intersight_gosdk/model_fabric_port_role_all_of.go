...
// FabricPortRoleAllOf Definition of the list of properties defined in 'fabric.PortRole', excluding properties defined in parent classes.
type FabricPortRoleAllOf struct {
...
type _FabricPortRoleAllOf FabricPortRoleAllOf
...
func (o FabricPortRoleAllOf) MarshalJSON() ([]byte, error) {
...
func (o *FabricPortRoleAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varFabricPortRoleAllOf := _FabricPortRoleAllOf{}

	if err = json.Unmarshal(bytes, &varFabricPortRoleAllOf); err == nil {
		*o = FabricPortRoleAllOf(varFabricPortRoleAllOf)
	}
...
type NullableFabricPortRoleAllOf struct {
	value *FabricPortRoleAllOf
	isSet bool
}

func (v NullableFabricPortRoleAllOf) Get() *FabricPortRoleAllOf {
	return v.value
}

func (v *NullableFabricPortRoleAllOf) Set(val *FabricPortRoleAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableFabricPortRoleAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableFabricPortRoleAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFabricPortRoleAllOf(val *FabricPortRoleAllOf) *NullableFabricPortRoleAllOf {
	return &NullableFabricPortRoleAllOf{value: val, isSet: true}
}

func (v NullableFabricPortRoleAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFabricPortRoleAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
