...
// checks if the SyslogPolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogPolicyList{}
...
func (o SyslogPolicyList) ToMap() (map[string]interface{}, error) {
...
func (o *SyslogPolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSyslogPolicyListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varSyslogPolicyList)
	if err == nil {
