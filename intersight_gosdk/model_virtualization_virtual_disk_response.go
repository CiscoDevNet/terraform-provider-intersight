...
func VirtualizationVirtualDiskListAsVirtualizationVirtualDiskResponse(v *VirtualizationVirtualDiskList) VirtualizationVirtualDiskResponse {
	return VirtualizationVirtualDiskResponse{
		VirtualizationVirtualDiskList: v,
	}
}
...
func (dst *VirtualizationVirtualDiskResponse) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVirtualDiskResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVirtualDiskResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal VirtualizationVirtualDiskResponse as MoTagSummary: %s", err.Error())
		}
	}

	// check if the discriminator value is 'virtualization.VirtualDisk.List'
	if jsonDict["ObjectType"] == "virtualization.VirtualDisk.List" {
		// try to unmarshal JSON data into VirtualizationVirtualDiskList
		err = json.Unmarshal(data, &dst.VirtualizationVirtualDiskList)
		if err == nil {
			return nil // data stored in dst.VirtualizationVirtualDiskList, return on the first match
		} else {
			dst.VirtualizationVirtualDiskList = nil
			return fmt.Errorf("Failed to unmarshal VirtualizationVirtualDiskResponse as VirtualizationVirtualDiskList: %s", err.Error())
		}
	}
...
func (src VirtualizationVirtualDiskResponse) MarshalJSON() ([]byte, error) {
	...
	if src.VirtualizationVirtualDiskList != nil {
		return json.Marshal(&src.VirtualizationVirtualDiskList)
	}
...
func (obj *VirtualizationVirtualDiskResponse) GetActualInstance() interface{} {
	...
	if obj.VirtualizationVirtualDiskList != nil {
		return obj.VirtualizationVirtualDiskList
	}
...
type NullableVirtualizationVirtualDiskResponse struct {
	value *VirtualizationVirtualDiskResponse
	isSet bool
}

func (v NullableVirtualizationVirtualDiskResponse) Get() *VirtualizationVirtualDiskResponse {
	return v.value
}

func (v *NullableVirtualizationVirtualDiskResponse) Set(val *VirtualizationVirtualDiskResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualizationVirtualDiskResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualizationVirtualDiskResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualizationVirtualDiskResponse(val *VirtualizationVirtualDiskResponse) *NullableVirtualizationVirtualDiskResponse {
	return &NullableVirtualizationVirtualDiskResponse{value: val, isSet: true}
}

func (v NullableVirtualizationVirtualDiskResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualizationVirtualDiskResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
