...
// checks if the IaasLicenseInfoList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IaasLicenseInfoList{}
...
func NewIaasLicenseInfoList(objectType string) *IaasLicenseInfoList {
...
func (o IaasLicenseInfoList) ToMap() (map[string]interface{}, error) {
...
func (o *IaasLicenseInfoList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIaasLicenseInfoListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIaasLicenseInfoList)
	if err == nil {
