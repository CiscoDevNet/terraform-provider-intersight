...
// checks if the HyperflexMacAddrPrefixRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexMacAddrPrefixRange{}
...
type HyperflexMacAddrPrefixRange struct {
	...
	EndAddr *string `json:"EndAddr,omitempty" validate:"regexp=^$|^00:25:B5:[0-9a-fA-F]{2}$"`
	// The start MAC address prefix of a MAC address prefix range in the form of 00:25:B5:XX.
	StartAddr            *string `json:"StartAddr,omitempty" validate:"regexp=^$|^00:25:B5:[0-9a-fA-F]{2}$"`
...
// GetDefaultClassId returns the default value "hyperflex.MacAddrPrefixRange" of the ClassId field.
func (o *HyperflexMacAddrPrefixRange) GetDefaultClassId() interface{} {
	return "hyperflex.MacAddrPrefixRange"
}
...
// GetDefaultObjectType returns the default value "hyperflex.MacAddrPrefixRange" of the ObjectType field.
func (o *HyperflexMacAddrPrefixRange) GetDefaultObjectType() interface{} {
	return "hyperflex.MacAddrPrefixRange"
}
...
func (o HyperflexMacAddrPrefixRange) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexMacAddrPrefixRange) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexMacAddrPrefixRangeWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexMacAddrPrefixRange)
	if err == nil {
