...
type _CapabilitySwitchNetworkLimits CapabilitySwitchNetworkLimits
...
func NewCapabilitySwitchNetworkLimits(classId string, objectType string) *CapabilitySwitchNetworkLimits {
	this := CapabilitySwitchNetworkLimits{}
...
// GetDefaultClassId returns the default value "capability.SwitchNetworkLimits" of the ClassId field.
func (o *CapabilitySwitchNetworkLimits) GetDefaultClassId() interface{} {
	return "capability.SwitchNetworkLimits"
}
...
// GetDefaultObjectType returns the default value "capability.SwitchNetworkLimits" of the ObjectType field.
func (o *CapabilitySwitchNetworkLimits) GetDefaultObjectType() interface{} {
	return "capability.SwitchNetworkLimits"
}
...
func (o *CapabilitySwitchNetworkLimits) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varCapabilitySwitchNetworkLimits.ObjectType = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.ObjectType
		varCapabilitySwitchNetworkLimits.MaxCompressedPortVlanCount = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaxCompressedPortVlanCount
		varCapabilitySwitchNetworkLimits.MaxUncompressedPortVlanCount = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaxUncompressedPortVlanCount
		varCapabilitySwitchNetworkLimits.MaximumActiveTrafficMonitoringSessions = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumActiveTrafficMonitoringSessions
		varCapabilitySwitchNetworkLimits.MaximumEthernetPortChannels = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumEthernetPortChannels
		varCapabilitySwitchNetworkLimits.MaximumEthernetUplinkPorts = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumEthernetUplinkPorts
		varCapabilitySwitchNetworkLimits.MaximumFcPortChannelMembers = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumFcPortChannelMembers
		varCapabilitySwitchNetworkLimits.MaximumFcPortChannels = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumFcPortChannels
		varCapabilitySwitchNetworkLimits.MaximumIgmpGroups = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumIgmpGroups
		varCapabilitySwitchNetworkLimits.MaximumPortChannelMembers = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumPortChannelMembers
		varCapabilitySwitchNetworkLimits.MaximumPrimaryVlan = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumPrimaryVlan
		varCapabilitySwitchNetworkLimits.MaximumSecondaryVlan = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumSecondaryVlan
		varCapabilitySwitchNetworkLimits.MaximumSecondaryVlanPerPrimary = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumSecondaryVlanPerPrimary
		varCapabilitySwitchNetworkLimits.MaximumVifs = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumVifs
		varCapabilitySwitchNetworkLimits.MaximumVlans = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MaximumVlans
		varCapabilitySwitchNetworkLimits.MinimumActiveFans = varCapabilitySwitchNetworkLimitsWithoutEmbeddedStruct.MinimumActiveFans
		*o = CapabilitySwitchNetworkLimits(varCapabilitySwitchNetworkLimits)
	} else {
		return err
	}
...
type NullableCapabilitySwitchNetworkLimits struct {
	value *CapabilitySwitchNetworkLimits
	isSet bool
}

func (v NullableCapabilitySwitchNetworkLimits) Get() *CapabilitySwitchNetworkLimits {
	return v.value
}

func (v *NullableCapabilitySwitchNetworkLimits) Set(val *CapabilitySwitchNetworkLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilitySwitchNetworkLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilitySwitchNetworkLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilitySwitchNetworkLimits(val *CapabilitySwitchNetworkLimits) *NullableCapabilitySwitchNetworkLimits {
	return &NullableCapabilitySwitchNetworkLimits{value: val, isSet: true}
}

func (v NullableCapabilitySwitchNetworkLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilitySwitchNetworkLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
