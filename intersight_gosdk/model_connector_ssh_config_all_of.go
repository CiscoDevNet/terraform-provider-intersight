...
type ConnectorSshConfigAllOf struct {
	...
	PkeyString *string `json:"PkeyString,omitempty"`
...
// SetPkeyString gets a reference to the given string and assigns it to the PkeyString field.
...
func (o *ConnectorSshConfigAllOf) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = json.Unmarshal(bytes, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "PkeyString")
