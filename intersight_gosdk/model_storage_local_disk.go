...
func (o *StorageLocalDisk) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varStorageLocalDisk.ClassId = varStorageLocalDiskWithoutEmbeddedStruct.ClassId
		varStorageLocalDisk.ObjectType = varStorageLocalDiskWithoutEmbeddedStruct.ObjectType
