...
// checks if the HyperflexAlarmList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexAlarmList{}
...
func NewHyperflexAlarmList(objectType string) *HyperflexAlarmList {
...
func (o HyperflexAlarmList) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexAlarmList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexAlarmListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexAlarmList)
	if err == nil {
