...
// ApplianceAutoRmaPolicyListAllOf struct for ApplianceAutoRmaPolicyListAllOf
type ApplianceAutoRmaPolicyListAllOf struct {
...
type _ApplianceAutoRmaPolicyListAllOf ApplianceAutoRmaPolicyListAllOf
...
func NewApplianceAutoRmaPolicyListAllOf() *ApplianceAutoRmaPolicyListAllOf {
	this := ApplianceAutoRmaPolicyListAllOf{}
	return &this
}
...
func (o ApplianceAutoRmaPolicyListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ApplianceAutoRmaPolicyListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varApplianceAutoRmaPolicyListAllOf := _ApplianceAutoRmaPolicyListAllOf{}

	if err = json.Unmarshal(bytes, &varApplianceAutoRmaPolicyListAllOf); err == nil {
		*o = ApplianceAutoRmaPolicyListAllOf(varApplianceAutoRmaPolicyListAllOf)
	}
...
type NullableApplianceAutoRmaPolicyListAllOf struct {
	value *ApplianceAutoRmaPolicyListAllOf
	isSet bool
}

func (v NullableApplianceAutoRmaPolicyListAllOf) Get() *ApplianceAutoRmaPolicyListAllOf {
	return v.value
}

func (v *NullableApplianceAutoRmaPolicyListAllOf) Set(val *ApplianceAutoRmaPolicyListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableApplianceAutoRmaPolicyListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableApplianceAutoRmaPolicyListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplianceAutoRmaPolicyListAllOf(val *ApplianceAutoRmaPolicyListAllOf) *NullableApplianceAutoRmaPolicyListAllOf {
	return &NullableApplianceAutoRmaPolicyListAllOf{value: val, isSet: true}
}

func (v NullableApplianceAutoRmaPolicyListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplianceAutoRmaPolicyListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
