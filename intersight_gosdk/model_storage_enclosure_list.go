...
// checks if the StorageEnclosureList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageEnclosureList{}
...
func (o StorageEnclosureList) ToMap() (map[string]interface{}, error) {
...
func (o *StorageEnclosureList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStorageEnclosureListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStorageEnclosureList)
	if err == nil {
