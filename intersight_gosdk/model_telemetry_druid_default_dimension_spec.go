...
// checks if the TelemetryDruidDefaultDimensionSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidDefaultDimensionSpec{}
...
func (o *TelemetryDruidDefaultDimensionSpec) GetDefaultOutputType() interface{} {
	return "STRING"
}
...
func (o TelemetryDruidDefaultDimensionSpec) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidDefaultDimensionSpec) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidDefaultDimensionSpec)
