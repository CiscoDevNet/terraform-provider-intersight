...
type HyperflexAlarmAllOf struct {
	...
	AncestorMos          []HyperflexBaseClusterRelationship `json:"AncestorMos,omitempty"`
...
// SetAncestorMos gets a reference to the given []HyperflexBaseClusterRelationship and assigns it to the AncestorMos field.
