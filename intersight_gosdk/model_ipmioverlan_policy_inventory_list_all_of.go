...
// IpmioverlanPolicyInventoryListAllOf struct for IpmioverlanPolicyInventoryListAllOf
type IpmioverlanPolicyInventoryListAllOf struct {
...
type _IpmioverlanPolicyInventoryListAllOf IpmioverlanPolicyInventoryListAllOf
...
func NewIpmioverlanPolicyInventoryListAllOf() *IpmioverlanPolicyInventoryListAllOf {
	this := IpmioverlanPolicyInventoryListAllOf{}
	return &this
}
...
func (o IpmioverlanPolicyInventoryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *IpmioverlanPolicyInventoryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varIpmioverlanPolicyInventoryListAllOf := _IpmioverlanPolicyInventoryListAllOf{}

	if err = json.Unmarshal(bytes, &varIpmioverlanPolicyInventoryListAllOf); err == nil {
		*o = IpmioverlanPolicyInventoryListAllOf(varIpmioverlanPolicyInventoryListAllOf)
	}
...
type NullableIpmioverlanPolicyInventoryListAllOf struct {
	value *IpmioverlanPolicyInventoryListAllOf
	isSet bool
}

func (v NullableIpmioverlanPolicyInventoryListAllOf) Get() *IpmioverlanPolicyInventoryListAllOf {
	return v.value
}

func (v *NullableIpmioverlanPolicyInventoryListAllOf) Set(val *IpmioverlanPolicyInventoryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIpmioverlanPolicyInventoryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIpmioverlanPolicyInventoryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpmioverlanPolicyInventoryListAllOf(val *IpmioverlanPolicyInventoryListAllOf) *NullableIpmioverlanPolicyInventoryListAllOf {
	return &NullableIpmioverlanPolicyInventoryListAllOf{value: val, isSet: true}
}

func (v NullableIpmioverlanPolicyInventoryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpmioverlanPolicyInventoryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
