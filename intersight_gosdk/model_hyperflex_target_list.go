...
func (o *HyperflexTargetList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varHyperflexTargetListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varHyperflexTargetList)
	if err == nil {
