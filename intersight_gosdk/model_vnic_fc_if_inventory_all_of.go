...
// VnicFcIfInventoryAllOf Definition of the list of properties defined in 'vnic.FcIfInventory', excluding properties defined in parent classes.
type VnicFcIfInventoryAllOf struct {
...
type _VnicFcIfInventoryAllOf VnicFcIfInventoryAllOf
...
func (o *VnicFcIfInventoryAllOf) SetPlacementNil() {
	o.Placement.Set(nil)
}
...
func (o VnicFcIfInventoryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicFcIfInventoryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicFcIfInventoryAllOf := _VnicFcIfInventoryAllOf{}

	if err = json.Unmarshal(bytes, &varVnicFcIfInventoryAllOf); err == nil {
		*o = VnicFcIfInventoryAllOf(varVnicFcIfInventoryAllOf)
	}
...
type NullableVnicFcIfInventoryAllOf struct {
	value *VnicFcIfInventoryAllOf
	isSet bool
}

func (v NullableVnicFcIfInventoryAllOf) Get() *VnicFcIfInventoryAllOf {
	return v.value
}

func (v *NullableVnicFcIfInventoryAllOf) Set(val *VnicFcIfInventoryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicFcIfInventoryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicFcIfInventoryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicFcIfInventoryAllOf(val *VnicFcIfInventoryAllOf) *NullableVnicFcIfInventoryAllOf {
	return &NullableVnicFcIfInventoryAllOf{value: val, isSet: true}
}

func (v NullableVnicFcIfInventoryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicFcIfInventoryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
