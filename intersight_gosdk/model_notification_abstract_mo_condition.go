...
// NotificationAbstractMoCondition This condition type gives the ability to subscribe to the cond.Alarm ObjectType and provide a list of Severities you're interested in.
