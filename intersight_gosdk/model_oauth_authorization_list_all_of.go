...
// OauthAuthorizationListAllOf struct for OauthAuthorizationListAllOf
type OauthAuthorizationListAllOf struct {
...
type _OauthAuthorizationListAllOf OauthAuthorizationListAllOf
...
func NewOauthAuthorizationListAllOf() *OauthAuthorizationListAllOf {
	this := OauthAuthorizationListAllOf{}
	return &this
}
...
func (o OauthAuthorizationListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *OauthAuthorizationListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varOauthAuthorizationListAllOf := _OauthAuthorizationListAllOf{}

	if err = json.Unmarshal(bytes, &varOauthAuthorizationListAllOf); err == nil {
		*o = OauthAuthorizationListAllOf(varOauthAuthorizationListAllOf)
	}
...
type NullableOauthAuthorizationListAllOf struct {
	value *OauthAuthorizationListAllOf
	isSet bool
}

func (v NullableOauthAuthorizationListAllOf) Get() *OauthAuthorizationListAllOf {
	return v.value
}

func (v *NullableOauthAuthorizationListAllOf) Set(val *OauthAuthorizationListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableOauthAuthorizationListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableOauthAuthorizationListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOauthAuthorizationListAllOf(val *OauthAuthorizationListAllOf) *NullableOauthAuthorizationListAllOf {
	return &NullableOauthAuthorizationListAllOf{value: val, isSet: true}
}

func (v NullableOauthAuthorizationListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOauthAuthorizationListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
