...
// checks if the TamIdentifiers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TamIdentifiers{}
...
// GetDefaultClassId returns the default value "tam.Identifiers" of the ClassId field.
func (o *TamIdentifiers) GetDefaultClassId() interface{} {
	return "tam.Identifiers"
}
...
// GetDefaultObjectType returns the default value "tam.Identifiers" of the ObjectType field.
func (o *TamIdentifiers) GetDefaultObjectType() interface{} {
	return "tam.Identifiers"
}
...
func (o TamIdentifiers) ToMap() (map[string]interface{}, error) {
...
func (o *TamIdentifiers) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTamIdentifiersWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varTamIdentifiers)
	if err == nil {
