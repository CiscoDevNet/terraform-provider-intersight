...
type EquipmentChassisOperation struct {
	...
	AdminResetConfigSlotId *int64                            `json:"AdminResetConfigSlotId,omitempty"`
...
// GetAdminResetConfigSlotId returns the AdminResetConfigSlotId field value if set, zero value otherwise.
func (o *EquipmentChassisOperation) GetAdminResetConfigSlotId() int64 {
	if o == nil || IsNil(o.AdminResetConfigSlotId) {
		var ret int64
		return ret
	}
	return *o.AdminResetConfigSlotId
}

// GetAdminResetConfigSlotIdOk returns a tuple with the AdminResetConfigSlotId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EquipmentChassisOperation) GetAdminResetConfigSlotIdOk() (*int64, bool) {
	if o == nil || IsNil(o.AdminResetConfigSlotId) {
		return nil, false
	}
	return o.AdminResetConfigSlotId, true
}
...
// SetAdminResetConfigSlotId gets a reference to the given int64 and assigns it to the AdminResetConfigSlotId field.
func (o *EquipmentChassisOperation) SetAdminResetConfigSlotId(v int64) {
	o.AdminResetConfigSlotId = &v
}
...
func (o EquipmentChassisOperation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdminResetConfigSlotId) {
		toSerialize["AdminResetConfigSlotId"] = o.AdminResetConfigSlotId
	}
...
func (o *EquipmentChassisOperation) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varEquipmentChassisOperation.AdminResetConfigSlotId = varEquipmentChassisOperationWithoutEmbeddedStruct.AdminResetConfigSlotId
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "AdminResetConfigSlotId")
