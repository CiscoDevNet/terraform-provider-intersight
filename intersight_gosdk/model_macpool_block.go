...
type _MacpoolBlock MacpoolBlock
...
// GetDefaultClassId returns the default value "macpool.Block" of the ClassId field.
func (o *MacpoolBlock) GetDefaultClassId() interface{} {
	return "macpool.Block"
}
...
// GetDefaultObjectType returns the default value "macpool.Block" of the ObjectType field.
func (o *MacpoolBlock) GetDefaultObjectType() interface{} {
	return "macpool.Block"
}
...
func (o *MacpoolBlock) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varMacpoolBlock.ObjectType = varMacpoolBlockWithoutEmbeddedStruct.ObjectType
		varMacpoolBlock.From = varMacpoolBlockWithoutEmbeddedStruct.From
		varMacpoolBlock.To = varMacpoolBlockWithoutEmbeddedStruct.To
		*o = MacpoolBlock(varMacpoolBlock)
	} else {
		return err
	}
