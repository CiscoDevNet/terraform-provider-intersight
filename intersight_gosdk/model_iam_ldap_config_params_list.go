...
func (o *IamLdapConfigParamsList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varIamLdapConfigParamsListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varIamLdapConfigParamsList)
	if err == nil {
