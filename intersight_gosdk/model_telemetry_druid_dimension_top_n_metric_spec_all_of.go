...
type _TelemetryDruidDimensionTopNMetricSpecAllOf TelemetryDruidDimensionTopNMetricSpecAllOf
...
func (o *TelemetryDruidDimensionTopNMetricSpecAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidDimensionTopNMetricSpecAllOf := _TelemetryDruidDimensionTopNMetricSpecAllOf{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidDimensionTopNMetricSpecAllOf); err == nil {
		*o = TelemetryDruidDimensionTopNMetricSpecAllOf(varTelemetryDruidDimensionTopNMetricSpecAllOf)
	}
