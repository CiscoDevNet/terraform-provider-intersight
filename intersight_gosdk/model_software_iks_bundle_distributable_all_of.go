...
// SoftwareIksBundleDistributableAllOf Definition of the list of properties defined in 'software.IksBundleDistributable', excluding properties defined in parent classes.
type SoftwareIksBundleDistributableAllOf struct {
...
type _SoftwareIksBundleDistributableAllOf SoftwareIksBundleDistributableAllOf
...
func NewSoftwareIksBundleDistributableAllOf(classId string, objectType string) *SoftwareIksBundleDistributableAllOf {
	this := SoftwareIksBundleDistributableAllOf{}
...
func (o SoftwareIksBundleDistributableAllOf) MarshalJSON() ([]byte, error) {
...
func (o *SoftwareIksBundleDistributableAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varSoftwareIksBundleDistributableAllOf := _SoftwareIksBundleDistributableAllOf{}

	if err = json.Unmarshal(bytes, &varSoftwareIksBundleDistributableAllOf); err == nil {
		*o = SoftwareIksBundleDistributableAllOf(varSoftwareIksBundleDistributableAllOf)
	}
...
type NullableSoftwareIksBundleDistributableAllOf struct {
	value *SoftwareIksBundleDistributableAllOf
	isSet bool
}

func (v NullableSoftwareIksBundleDistributableAllOf) Get() *SoftwareIksBundleDistributableAllOf {
	return v.value
}

func (v *NullableSoftwareIksBundleDistributableAllOf) Set(val *SoftwareIksBundleDistributableAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSoftwareIksBundleDistributableAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSoftwareIksBundleDistributableAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSoftwareIksBundleDistributableAllOf(val *SoftwareIksBundleDistributableAllOf) *NullableSoftwareIksBundleDistributableAllOf {
	return &NullableSoftwareIksBundleDistributableAllOf{value: val, isSet: true}
}

func (v NullableSoftwareIksBundleDistributableAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSoftwareIksBundleDistributableAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
