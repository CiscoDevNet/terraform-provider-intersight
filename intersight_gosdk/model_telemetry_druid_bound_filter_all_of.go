...
// TelemetryDruidBoundFilterAllOf struct for TelemetryDruidBoundFilterAllOf
type TelemetryDruidBoundFilterAllOf struct {
...
type _TelemetryDruidBoundFilterAllOf TelemetryDruidBoundFilterAllOf
...
func NewTelemetryDruidBoundFilterAllOf(type_ string, dimension string) *TelemetryDruidBoundFilterAllOf {
	this := TelemetryDruidBoundFilterAllOf{}
	this.Type = type_
...
func (o TelemetryDruidBoundFilterAllOf) MarshalJSON() ([]byte, error) {
...
func (o *TelemetryDruidBoundFilterAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varTelemetryDruidBoundFilterAllOf := _TelemetryDruidBoundFilterAllOf{}

	if err = json.Unmarshal(bytes, &varTelemetryDruidBoundFilterAllOf); err == nil {
		*o = TelemetryDruidBoundFilterAllOf(varTelemetryDruidBoundFilterAllOf)
	}
...
type NullableTelemetryDruidBoundFilterAllOf struct {
	value *TelemetryDruidBoundFilterAllOf
	isSet bool
}

func (v NullableTelemetryDruidBoundFilterAllOf) Get() *TelemetryDruidBoundFilterAllOf {
	return v.value
}

func (v *NullableTelemetryDruidBoundFilterAllOf) Set(val *TelemetryDruidBoundFilterAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableTelemetryDruidBoundFilterAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableTelemetryDruidBoundFilterAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTelemetryDruidBoundFilterAllOf(val *TelemetryDruidBoundFilterAllOf) *NullableTelemetryDruidBoundFilterAllOf {
	return &NullableTelemetryDruidBoundFilterAllOf{value: val, isSet: true}
}

func (v NullableTelemetryDruidBoundFilterAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTelemetryDruidBoundFilterAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
