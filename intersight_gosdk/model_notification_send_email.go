...
// checks if the NotificationSendEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationSendEmail{}
...
// GetDefaultClassId returns the default value "notification.SendEmail" of the ClassId field.
func (o *NotificationSendEmail) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "notification.SendEmail" of the ObjectType field.
func (o *NotificationSendEmail) GetDefaultObjectType() interface{} {
	return "notification.SendEmail"
}
...
func (o NotificationSendEmail) ToMap() (map[string]interface{}, error) {
...
func (o *NotificationSendEmail) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varNotificationSendEmailWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varNotificationSendEmail)
	if err == nil {
