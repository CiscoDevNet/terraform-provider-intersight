...
// checks if the KubernetesVersionPolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesVersionPolicyList{}
...
type KubernetesVersionPolicyList struct {
	...
	Results              []KubernetesVersionPolicy `json:"Results,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _KubernetesVersionPolicyList KubernetesVersionPolicyList
...
func NewKubernetesVersionPolicyList(objectType string) *KubernetesVersionPolicyList {
...
func (o KubernetesVersionPolicyList) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesVersionPolicyList) UnmarshalJSON(data []byte) (err error) {
	...
	type KubernetesVersionPolicyListWithoutEmbeddedStruct struct {
		// The total number of 'kubernetes.VersionPolicy' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.
		Count *int32 `json:"Count,omitempty"`
		// The array of 'kubernetes.VersionPolicy' resources matching the request.
		Results []KubernetesVersionPolicy `json:"Results,omitempty"`
	...
	varKubernetesVersionPolicyListWithoutEmbeddedStruct := KubernetesVersionPolicyListWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varKubernetesVersionPolicyListWithoutEmbeddedStruct)
	if err == nil {
		varKubernetesVersionPolicyList := _KubernetesVersionPolicyList{}
		varKubernetesVersionPolicyList.Count = varKubernetesVersionPolicyListWithoutEmbeddedStruct.Count
		varKubernetesVersionPolicyList.Results = varKubernetesVersionPolicyListWithoutEmbeddedStruct.Results
		*o = KubernetesVersionPolicyList(varKubernetesVersionPolicyList)
	} else {
		return err
	}
	...
	err = json.Unmarshal(data, &varKubernetesVersionPolicyList)
	if err == nil {
		o.MoBaseResponse = varKubernetesVersionPolicyList.MoBaseResponse
	} else {
		return err
	}
