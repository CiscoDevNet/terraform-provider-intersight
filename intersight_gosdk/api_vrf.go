...
func (r apiCreateVrfVrfRequest) Execute() (VrfVrf, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VrfApiService.CreateVrfVrf")
	if err != nil {
...
func (r apiDeleteVrfVrfRequest) Execute() (*_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VrfApiService.DeleteVrfVrf")
	if err != nil {
...
func (r apiGetVrfVrfByMoidRequest) Execute() (VrfVrf, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VrfApiService.GetVrfVrfByMoid")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiGetVrfVrfListRequest) Execute() (VrfVrfResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VrfApiService.GetVrfVrfList")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiPatchVrfVrfRequest) Execute() (VrfVrf, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VrfApiService.PatchVrfVrf")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r apiUpdateVrfVrfRequest) Execute() (VrfVrf, *_nethttp.Response, error) {
	...
	localBasePath, err := r.apiService.client.cfg.ServerURLWithContext(r.ctx, "VrfApiService.UpdateVrfVrf")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
