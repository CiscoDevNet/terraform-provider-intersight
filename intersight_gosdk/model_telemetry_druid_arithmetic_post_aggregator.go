...
// checks if the TelemetryDruidArithmeticPostAggregator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidArithmeticPostAggregator{}
...
func (o TelemetryDruidArithmeticPostAggregator) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidArithmeticPostAggregator) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidArithmeticPostAggregator)
