...
// checks if the ApplianceBackupRotateDataList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplianceBackupRotateDataList{}
...
func (o ApplianceBackupRotateDataList) ToMap() (map[string]interface{}, error) {
...
func (o *ApplianceBackupRotateDataList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varApplianceBackupRotateDataListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varApplianceBackupRotateDataList)
	if err == nil {
