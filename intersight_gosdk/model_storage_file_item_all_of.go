...
// StorageFileItemAllOf Definition of the list of properties defined in 'storage.FileItem', excluding properties defined in parent classes.
type StorageFileItemAllOf struct {
...
type _StorageFileItemAllOf StorageFileItemAllOf
...
func (o StorageFileItemAllOf) MarshalJSON() ([]byte, error) {
...
func (o *StorageFileItemAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varStorageFileItemAllOf := _StorageFileItemAllOf{}

	if err = json.Unmarshal(bytes, &varStorageFileItemAllOf); err == nil {
		*o = StorageFileItemAllOf(varStorageFileItemAllOf)
	}
...
type NullableStorageFileItemAllOf struct {
	value *StorageFileItemAllOf
	isSet bool
}

func (v NullableStorageFileItemAllOf) Get() *StorageFileItemAllOf {
	return v.value
}

func (v *NullableStorageFileItemAllOf) Set(val *StorageFileItemAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageFileItemAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageFileItemAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageFileItemAllOf(val *StorageFileItemAllOf) *NullableStorageFileItemAllOf {
	return &NullableStorageFileItemAllOf{value: val, isSet: true}
}

func (v NullableStorageFileItemAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageFileItemAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
