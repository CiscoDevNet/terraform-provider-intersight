...
// checks if the MacpoolMemberOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MacpoolMemberOf{}
...
// GetDefaultClassId returns the default value "macpool.MemberOf" of the ClassId field.
func (o *MacpoolMemberOf) GetDefaultClassId() interface{} {
	return "macpool.MemberOf"
}
...
// GetDefaultObjectType returns the default value "macpool.MemberOf" of the ObjectType field.
func (o *MacpoolMemberOf) GetDefaultObjectType() interface{} {
	return "macpool.MemberOf"
}
...
func (o MacpoolMemberOf) ToMap() (map[string]interface{}, error) {
...
func (o *MacpoolMemberOf) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varMacpoolMemberOfWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varMacpoolMemberOf)
	if err == nil {
