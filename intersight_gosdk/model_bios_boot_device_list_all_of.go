...
// BiosBootDeviceListAllOf struct for BiosBootDeviceListAllOf
type BiosBootDeviceListAllOf struct {
...
type _BiosBootDeviceListAllOf BiosBootDeviceListAllOf
...
func (o BiosBootDeviceListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BiosBootDeviceListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBiosBootDeviceListAllOf := _BiosBootDeviceListAllOf{}

	if err = json.Unmarshal(bytes, &varBiosBootDeviceListAllOf); err == nil {
		*o = BiosBootDeviceListAllOf(varBiosBootDeviceListAllOf)
	}
...
type NullableBiosBootDeviceListAllOf struct {
	value *BiosBootDeviceListAllOf
	isSet bool
}

func (v NullableBiosBootDeviceListAllOf) Get() *BiosBootDeviceListAllOf {
	return v.value
}

func (v *NullableBiosBootDeviceListAllOf) Set(val *BiosBootDeviceListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBiosBootDeviceListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBiosBootDeviceListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBiosBootDeviceListAllOf(val *BiosBootDeviceListAllOf) *NullableBiosBootDeviceListAllOf {
	return &NullableBiosBootDeviceListAllOf{value: val, isSet: true}
}

func (v NullableBiosBootDeviceListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBiosBootDeviceListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
