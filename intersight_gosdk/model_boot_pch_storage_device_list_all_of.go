...
// BootPchStorageDeviceListAllOf struct for BootPchStorageDeviceListAllOf
type BootPchStorageDeviceListAllOf struct {
...
type _BootPchStorageDeviceListAllOf BootPchStorageDeviceListAllOf
...
func NewBootPchStorageDeviceListAllOf() *BootPchStorageDeviceListAllOf {
	this := BootPchStorageDeviceListAllOf{}
	return &this
}
...
func (o BootPchStorageDeviceListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BootPchStorageDeviceListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBootPchStorageDeviceListAllOf := _BootPchStorageDeviceListAllOf{}

	if err = json.Unmarshal(bytes, &varBootPchStorageDeviceListAllOf); err == nil {
		*o = BootPchStorageDeviceListAllOf(varBootPchStorageDeviceListAllOf)
	}
...
type NullableBootPchStorageDeviceListAllOf struct {
	value *BootPchStorageDeviceListAllOf
	isSet bool
}

func (v NullableBootPchStorageDeviceListAllOf) Get() *BootPchStorageDeviceListAllOf {
	return v.value
}

func (v *NullableBootPchStorageDeviceListAllOf) Set(val *BootPchStorageDeviceListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBootPchStorageDeviceListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBootPchStorageDeviceListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBootPchStorageDeviceListAllOf(val *BootPchStorageDeviceListAllOf) *NullableBootPchStorageDeviceListAllOf {
	return &NullableBootPchStorageDeviceListAllOf{value: val, isSet: true}
}

func (v NullableBootPchStorageDeviceListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBootPchStorageDeviceListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
