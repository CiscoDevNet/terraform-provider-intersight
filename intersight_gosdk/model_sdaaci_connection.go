...
// GetCatalystCenterTarget returns the CatalystCenterTarget field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SdaaciConnection) GetCatalystCenterTarget() AssetTargetRelationship {
	if o == nil || IsNil(o.CatalystCenterTarget.Get()) {
		var ret AssetTargetRelationship
		return ret
	}
	return *o.CatalystCenterTarget.Get()
}

// GetCatalystCenterTargetOk returns a tuple with the CatalystCenterTarget field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetCatalystCenterTarget gets a reference to the given NullableAssetTargetRelationship and assigns it to the CatalystCenterTarget field.
func (o *SdaaciConnection) SetCatalystCenterTarget(v AssetTargetRelationship) {
	o.CatalystCenterTarget.Set(&v)
}

// SetCatalystCenterTargetNil sets the value for CatalystCenterTarget to be an explicit nil
func (o *SdaaciConnection) SetCatalystCenterTargetNil() {
	o.CatalystCenterTarget.Set(nil)
}
...
func (o SdaaciConnection) ToMap() (map[string]interface{}, error) {
	...
	if o.CatalystCenterTarget.IsSet() {
		toSerialize["CatalystCenterTarget"] = o.CatalystCenterTarget.Get()
	}
...
func (o *SdaaciConnection) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varSdaaciConnection.CatalystCenterTarget = varSdaaciConnectionWithoutEmbeddedStruct.CatalystCenterTarget
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "CatalystCenterTarget")
