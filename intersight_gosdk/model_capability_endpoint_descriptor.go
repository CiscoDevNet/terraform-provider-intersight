...
// checks if the CapabilityEndpointDescriptor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityEndpointDescriptor{}
...
func (o CapabilityEndpointDescriptor) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityEndpointDescriptor) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCapabilityEndpointDescriptorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCapabilityEndpointDescriptor)
	if err == nil {
