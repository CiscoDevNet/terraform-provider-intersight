...
// checks if the TelemetryDruidHavingQueryFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryDruidHavingQueryFilter{}
...
func (o TelemetryDruidHavingQueryFilter) ToMap() (map[string]interface{}, error) {
...
func (o *TelemetryDruidHavingQueryFilter) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTelemetryDruidHavingQueryFilter)
