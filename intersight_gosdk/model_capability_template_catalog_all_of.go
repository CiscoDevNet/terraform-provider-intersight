...
// CapabilityTemplateCatalogAllOf Definition of the list of properties defined in 'capability.TemplateCatalog', excluding properties defined in parent classes.
type CapabilityTemplateCatalogAllOf struct {
...
type _CapabilityTemplateCatalogAllOf CapabilityTemplateCatalogAllOf
...
func NewCapabilityTemplateCatalogAllOf(classId string, objectType string) *CapabilityTemplateCatalogAllOf {
	this := CapabilityTemplateCatalogAllOf{}
...
func (o *CapabilityTemplateCatalogAllOf) GetAllowedOverrideListOk() ([]string, bool) {
	if o == nil || o.AllowedOverrideList == nil {
		return nil, false
	}
...
func (o CapabilityTemplateCatalogAllOf) MarshalJSON() ([]byte, error) {
...
func (o *CapabilityTemplateCatalogAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varCapabilityTemplateCatalogAllOf := _CapabilityTemplateCatalogAllOf{}

	if err = json.Unmarshal(bytes, &varCapabilityTemplateCatalogAllOf); err == nil {
		*o = CapabilityTemplateCatalogAllOf(varCapabilityTemplateCatalogAllOf)
	}
...
type NullableCapabilityTemplateCatalogAllOf struct {
	value *CapabilityTemplateCatalogAllOf
	isSet bool
}

func (v NullableCapabilityTemplateCatalogAllOf) Get() *CapabilityTemplateCatalogAllOf {
	return v.value
}

func (v *NullableCapabilityTemplateCatalogAllOf) Set(val *CapabilityTemplateCatalogAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityTemplateCatalogAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityTemplateCatalogAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityTemplateCatalogAllOf(val *CapabilityTemplateCatalogAllOf) *NullableCapabilityTemplateCatalogAllOf {
	return &NullableCapabilityTemplateCatalogAllOf{value: val, isSet: true}
}

func (v NullableCapabilityTemplateCatalogAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityTemplateCatalogAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
