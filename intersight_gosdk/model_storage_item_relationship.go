...
func MoMoRefAsStorageItemRelationship(v *MoMoRef) StorageItemRelationship {
	return StorageItemRelationship{
		MoMoRef: v,
	}
}
...
func (dst *StorageItemRelationship) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["ClassId"] == "mo.MoRef" {
		...
		if err == nil {
			...
			dst.MoMoRef = nil
			return fmt.Errorf("failed to unmarshal StorageItemRelationship as MoMoRef: %s", err.Error())
		}
	}
	...
	if jsonDict["ClassId"] == "storage.Item" {
		...
		if err == nil {
			...
			dst.StorageItem = nil
			return fmt.Errorf("failed to unmarshal StorageItemRelationship as StorageItem: %s", err.Error())
		}
	}
