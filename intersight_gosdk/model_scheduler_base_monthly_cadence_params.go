...
func (o *SchedulerBaseMonthlyCadenceParams) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSchedulerBaseMonthlyCadenceParamsWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varSchedulerBaseMonthlyCadenceParams)
	if err == nil {
