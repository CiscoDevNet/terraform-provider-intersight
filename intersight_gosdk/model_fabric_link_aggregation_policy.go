...
// checks if the FabricLinkAggregationPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FabricLinkAggregationPolicy{}
...
// GetDefaultClassId returns the default value "fabric.LinkAggregationPolicy" of the ClassId field.
func (o *FabricLinkAggregationPolicy) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "fabric.LinkAggregationPolicy" of the ObjectType field.
func (o *FabricLinkAggregationPolicy) GetDefaultObjectType() interface{} {
	return "fabric.LinkAggregationPolicy"
}
...
func (o *FabricLinkAggregationPolicy) GetSuspendIndividual() bool {
	if o == nil || IsNil(o.SuspendIndividual) {
		var ret bool
		return ret
	}
...
func (o *FabricLinkAggregationPolicy) SetOrganizationNil() {
...
func (o FabricLinkAggregationPolicy) ToMap() (map[string]interface{}, error) {
...
func (o *FabricLinkAggregationPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFabricLinkAggregationPolicyWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFabricLinkAggregationPolicy)
	if err == nil {
