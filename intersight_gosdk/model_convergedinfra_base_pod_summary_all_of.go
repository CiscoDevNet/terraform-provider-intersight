...
// ConvergedinfraBasePodSummaryAllOf Definition of the list of properties defined in 'convergedinfra.BasePodSummary', excluding properties defined in parent classes.
type ConvergedinfraBasePodSummaryAllOf struct {
...
type _ConvergedinfraBasePodSummaryAllOf ConvergedinfraBasePodSummaryAllOf
...
func NewConvergedinfraBasePodSummaryAllOf(classId string, objectType string) *ConvergedinfraBasePodSummaryAllOf {
	this := ConvergedinfraBasePodSummaryAllOf{}
...
func (o ConvergedinfraBasePodSummaryAllOf) MarshalJSON() ([]byte, error) {
...
func (o *ConvergedinfraBasePodSummaryAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varConvergedinfraBasePodSummaryAllOf := _ConvergedinfraBasePodSummaryAllOf{}

	if err = json.Unmarshal(bytes, &varConvergedinfraBasePodSummaryAllOf); err == nil {
		*o = ConvergedinfraBasePodSummaryAllOf(varConvergedinfraBasePodSummaryAllOf)
	}
...
type NullableConvergedinfraBasePodSummaryAllOf struct {
	value *ConvergedinfraBasePodSummaryAllOf
	isSet bool
}

func (v NullableConvergedinfraBasePodSummaryAllOf) Get() *ConvergedinfraBasePodSummaryAllOf {
	return v.value
}

func (v *NullableConvergedinfraBasePodSummaryAllOf) Set(val *ConvergedinfraBasePodSummaryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableConvergedinfraBasePodSummaryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableConvergedinfraBasePodSummaryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConvergedinfraBasePodSummaryAllOf(val *ConvergedinfraBasePodSummaryAllOf) *NullableConvergedinfraBasePodSummaryAllOf {
	return &NullableConvergedinfraBasePodSummaryAllOf{value: val, isSet: true}
}

func (v NullableConvergedinfraBasePodSummaryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConvergedinfraBasePodSummaryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
