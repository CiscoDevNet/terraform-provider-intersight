...
// GetDefaultClassId returns the default value "iam.EndPointUser" of the ClassId field.
func (o *IamEndPointUser) GetDefaultClassId() interface{} {
	return "iam.EndPointUser"
}
...
// GetDefaultObjectType returns the default value "iam.EndPointUser" of the ObjectType field.
func (o *IamEndPointUser) GetDefaultObjectType() interface{} {
	return "iam.EndPointUser"
}
...
func (o *IamEndPointUser) SetOrganizationNil() {
	o.Organization.Set(nil)
}

// UnsetOrganization ensures that no value is present for Organization, not even an explicit nil
func (o *IamEndPointUser) UnsetOrganization() {
...
func (o IamEndPointUser) ToMap() (map[string]interface{}, error) {
...
func (o *IamEndPointUser) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varIamEndPointUserWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varIamEndPointUser)
	if err == nil {
