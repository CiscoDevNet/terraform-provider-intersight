...
// checks if the WorkflowWaitTaskPrompt type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowWaitTaskPrompt{}
...
// GetDefaultClassId returns the default value "workflow.WaitTaskPrompt" of the ClassId field.
func (o *WorkflowWaitTaskPrompt) GetDefaultClassId() interface{} {
	return "workflow.WaitTaskPrompt"
}
...
// GetDefaultObjectType returns the default value "workflow.WaitTaskPrompt" of the ObjectType field.
func (o *WorkflowWaitTaskPrompt) GetDefaultObjectType() interface{} {
	return "workflow.WaitTaskPrompt"
}
...
func (o WorkflowWaitTaskPrompt) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowWaitTaskPrompt) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowWaitTaskPromptWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowWaitTaskPrompt)
	if err == nil {
