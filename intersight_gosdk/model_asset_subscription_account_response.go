...
func AssetSubscriptionAccountListAsAssetSubscriptionAccountResponse(v *AssetSubscriptionAccountList) AssetSubscriptionAccountResponse {
	return AssetSubscriptionAccountResponse{
		AssetSubscriptionAccountList: v,
	}
}
...
func (dst *AssetSubscriptionAccountResponse) UnmarshalJSON(data []byte) error {
	...
	// check if the discriminator value is 'asset.SubscriptionAccount.List'
	if jsonDict["ObjectType"] == "asset.SubscriptionAccount.List" {
		// try to unmarshal JSON data into AssetSubscriptionAccountList
		err = json.Unmarshal(data, &dst.AssetSubscriptionAccountList)
		if err == nil {
			return nil // data stored in dst.AssetSubscriptionAccountList, return on the first match
		} else {
			dst.AssetSubscriptionAccountList = nil
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionAccountResponse as AssetSubscriptionAccountList: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.AggregateTransform" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionAccountResponse as MoAggregateTransform: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.DocumentCount" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionAccountResponse as MoDocumentCount: %s", err.Error())
		}
	}
	...
	if jsonDict["ObjectType"] == "mo.TagSummary" {
		...
		if err == nil {
			...
			return fmt.Errorf("Failed to unmarshal AssetSubscriptionAccountResponse as MoTagSummary: %s", err.Error())
		}
	}
...
func (src AssetSubscriptionAccountResponse) MarshalJSON() ([]byte, error) {
	if src.AssetSubscriptionAccountList != nil {
		return json.Marshal(&src.AssetSubscriptionAccountList)
	}
...
type NullableAssetSubscriptionAccountResponse struct {
	value *AssetSubscriptionAccountResponse
	isSet bool
}

func (v NullableAssetSubscriptionAccountResponse) Get() *AssetSubscriptionAccountResponse {
	return v.value
}

func (v *NullableAssetSubscriptionAccountResponse) Set(val *AssetSubscriptionAccountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetSubscriptionAccountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetSubscriptionAccountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetSubscriptionAccountResponse(val *AssetSubscriptionAccountResponse) *NullableAssetSubscriptionAccountResponse {
	return &NullableAssetSubscriptionAccountResponse{value: val, isSet: true}
}

func (v NullableAssetSubscriptionAccountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetSubscriptionAccountResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
