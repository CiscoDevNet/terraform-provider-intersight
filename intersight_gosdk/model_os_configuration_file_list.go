...
// checks if the OsConfigurationFileList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OsConfigurationFileList{}
...
func (o OsConfigurationFileList) ToMap() (map[string]interface{}, error) {
...
func (o *OsConfigurationFileList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varOsConfigurationFileListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varOsConfigurationFileList)
	if err == nil {
