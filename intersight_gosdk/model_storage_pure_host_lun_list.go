...
func (o *StoragePureHostLunList) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varStoragePureHostLunListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varStoragePureHostLunList)
	if err == nil {
