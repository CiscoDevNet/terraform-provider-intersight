...
// checks if the VirtualizationAwsVmNetworkConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationAwsVmNetworkConfiguration{}
...
func (o VirtualizationAwsVmNetworkConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if errVirtualizationCloudVmNetworkConfiguration != nil {
		return map[string]interface{}{}, errVirtualizationCloudVmNetworkConfiguration
	}
...
func (o *VirtualizationAwsVmNetworkConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationAwsVmNetworkConfigurationWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationAwsVmNetworkConfiguration)
	if err == nil {
