...
// WorkflowTaskMetadataAllOf Definition of the list of properties defined in 'workflow.TaskMetadata', excluding properties defined in parent classes.
type WorkflowTaskMetadataAllOf struct {
...
type _WorkflowTaskMetadataAllOf WorkflowTaskMetadataAllOf
...
func NewWorkflowTaskMetadataAllOf(classId string, objectType string) *WorkflowTaskMetadataAllOf {
	this := WorkflowTaskMetadataAllOf{}
...
func (o WorkflowTaskMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o *WorkflowTaskMetadataAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varWorkflowTaskMetadataAllOf := _WorkflowTaskMetadataAllOf{}

	if err = json.Unmarshal(bytes, &varWorkflowTaskMetadataAllOf); err == nil {
		*o = WorkflowTaskMetadataAllOf(varWorkflowTaskMetadataAllOf)
	}
...
type NullableWorkflowTaskMetadataAllOf struct {
	value *WorkflowTaskMetadataAllOf
	isSet bool
}

func (v NullableWorkflowTaskMetadataAllOf) Get() *WorkflowTaskMetadataAllOf {
	return v.value
}

func (v *NullableWorkflowTaskMetadataAllOf) Set(val *WorkflowTaskMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTaskMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTaskMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTaskMetadataAllOf(val *WorkflowTaskMetadataAllOf) *NullableWorkflowTaskMetadataAllOf {
	return &NullableWorkflowTaskMetadataAllOf{value: val, isSet: true}
}

func (v NullableWorkflowTaskMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkflowTaskMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
