...
func (o *VirtualizationBaseCustomSpec) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varVirtualizationBaseCustomSpecWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(bytes, &varVirtualizationBaseCustomSpec)
	if err == nil {
