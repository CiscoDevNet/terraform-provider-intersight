...
type _HyperflexHxapVirtualMachineAllOf HyperflexHxapVirtualMachineAllOf
...
func (o *HyperflexHxapVirtualMachineAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varHyperflexHxapVirtualMachineAllOf := _HyperflexHxapVirtualMachineAllOf{}

	if err = json.Unmarshal(bytes, &varHyperflexHxapVirtualMachineAllOf); err == nil {
		*o = HyperflexHxapVirtualMachineAllOf(varHyperflexHxapVirtualMachineAllOf)
	}
