...
// BulkRequestListAllOf struct for BulkRequestListAllOf
type BulkRequestListAllOf struct {
...
type _BulkRequestListAllOf BulkRequestListAllOf
...
func (o BulkRequestListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *BulkRequestListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varBulkRequestListAllOf := _BulkRequestListAllOf{}

	if err = json.Unmarshal(bytes, &varBulkRequestListAllOf); err == nil {
		*o = BulkRequestListAllOf(varBulkRequestListAllOf)
	}
...
type NullableBulkRequestListAllOf struct {
	value *BulkRequestListAllOf
	isSet bool
}

func (v NullableBulkRequestListAllOf) Get() *BulkRequestListAllOf {
	return v.value
}

func (v *NullableBulkRequestListAllOf) Set(val *BulkRequestListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkRequestListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkRequestListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkRequestListAllOf(val *BulkRequestListAllOf) *NullableBulkRequestListAllOf {
	return &NullableBulkRequestListAllOf{value: val, isSet: true}
}

func (v NullableBulkRequestListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkRequestListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
