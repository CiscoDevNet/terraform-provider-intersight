...
func (o *CertificatemanagementCertificateBase) GetCertType() string {
...
// and a boolean to check if the value has been set.
func (o *CertificatemanagementCertificateBase) GetCertTypeOk() (*string, bool) {
	if o == nil || o.CertType == nil {
		return nil, false
	}
...
func (o *CertificatemanagementCertificateBase) HasCertType() bool {
	if o != nil && o.CertType != nil {
		return true
	}
...
func (o *CertificatemanagementCertificateBase) SetCertType(v string) {
	o.CertType = &v
}
...
func (o *CertificatemanagementCertificateBase) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err == nil {
		...
		varCertificatemanagementCertificateBase.CertType = varCertificatemanagementCertificateBaseWithoutEmbeddedStruct.CertType
