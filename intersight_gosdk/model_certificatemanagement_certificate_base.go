...
// checks if the CertificatemanagementCertificateBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificatemanagementCertificateBase{}
...
func (o CertificatemanagementCertificateBase) ToMap() (map[string]interface{}, error) {
...
func (o *CertificatemanagementCertificateBase) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCertificatemanagementCertificateBaseWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varCertificatemanagementCertificateBase)
	if err == nil {
