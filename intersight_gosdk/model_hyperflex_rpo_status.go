...
// checks if the HyperflexRpoStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexRpoStatus{}
...
// GetDefaultClassId returns the default value "hyperflex.RpoStatus" of the ClassId field.
func (o *HyperflexRpoStatus) GetDefaultClassId() interface{} {
	return "hyperflex.RpoStatus"
}
...
// GetDefaultObjectType returns the default value "hyperflex.RpoStatus" of the ObjectType field.
func (o *HyperflexRpoStatus) GetDefaultObjectType() interface{} {
	return "hyperflex.RpoStatus"
}
...
func (o HyperflexRpoStatus) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexRpoStatus) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexRpoStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexRpoStatus)
	if err == nil {
