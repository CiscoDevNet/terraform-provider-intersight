...
// checks if the HyperflexTrackedDisk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperflexTrackedDisk{}
...
// GetDefaultClassId returns the default value "hyperflex.TrackedDisk" of the ClassId field.
func (o *HyperflexTrackedDisk) GetDefaultClassId() interface{} {
	return "hyperflex.TrackedDisk"
}
...
// GetDefaultObjectType returns the default value "hyperflex.TrackedDisk" of the ObjectType field.
func (o *HyperflexTrackedDisk) GetDefaultObjectType() interface{} {
	return "hyperflex.TrackedDisk"
}
...
func (o HyperflexTrackedDisk) ToMap() (map[string]interface{}, error) {
...
func (o *HyperflexTrackedDisk) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHyperflexTrackedDiskWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varHyperflexTrackedDisk)
	if err == nil {
