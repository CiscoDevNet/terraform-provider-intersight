...
// checks if the VirtualizationBaseDistributedSwitch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualizationBaseDistributedSwitch{}
...
func NewVirtualizationBaseDistributedSwitch(classId string, objectType string) *VirtualizationBaseDistributedSwitch {
...
func (o VirtualizationBaseDistributedSwitch) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualizationBaseDistributedSwitch) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseDistributedSwitchWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varVirtualizationBaseDistributedSwitch)
	if err == nil {
