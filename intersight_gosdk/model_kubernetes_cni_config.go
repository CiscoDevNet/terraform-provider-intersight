...
// checks if the KubernetesCniConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesCniConfig{}
...
func (o *KubernetesCniConfig) GetDefaultClassId() interface{} {
...
func (o *KubernetesCniConfig) GetDefaultObjectType() interface{} {
	return "kubernetes.CalicoConfig"
}
...
func (o KubernetesCniConfig) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesCniConfig) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesCniConfigWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesCniConfig)
	if err == nil {
