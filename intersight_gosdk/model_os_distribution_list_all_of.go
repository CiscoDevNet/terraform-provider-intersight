...
// OsDistributionListAllOf struct for OsDistributionListAllOf
type OsDistributionListAllOf struct {
...
type _OsDistributionListAllOf OsDistributionListAllOf
...
func (o OsDistributionListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *OsDistributionListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varOsDistributionListAllOf := _OsDistributionListAllOf{}

	if err = json.Unmarshal(bytes, &varOsDistributionListAllOf); err == nil {
		*o = OsDistributionListAllOf(varOsDistributionListAllOf)
	}
...
type NullableOsDistributionListAllOf struct {
	value *OsDistributionListAllOf
	isSet bool
}

func (v NullableOsDistributionListAllOf) Get() *OsDistributionListAllOf {
	return v.value
}

func (v *NullableOsDistributionListAllOf) Set(val *OsDistributionListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableOsDistributionListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableOsDistributionListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOsDistributionListAllOf(val *OsDistributionListAllOf) *NullableOsDistributionListAllOf {
	return &NullableOsDistributionListAllOf{value: val, isSet: true}
}

func (v NullableOsDistributionListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOsDistributionListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
