...
type WorkflowAssociatedRoles struct {
	...
	PrivilegeSets          []string                  `json:"PrivilegeSets,omitempty"`
...
// SetPrivilegeSets gets a reference to the given []string and assigns it to the PrivilegeSets field.
...
func (o *WorkflowAssociatedRoles) UnmarshalJSON(data []byte) (err error) {
	...
	if err == nil {
		...
		varWorkflowAssociatedRoles.PrivilegeSets = varWorkflowAssociatedRolesWithoutEmbeddedStruct.PrivilegeSets
