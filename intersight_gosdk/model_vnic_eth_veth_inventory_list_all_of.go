...
// VnicEthVethInventoryListAllOf struct for VnicEthVethInventoryListAllOf
type VnicEthVethInventoryListAllOf struct {
...
type _VnicEthVethInventoryListAllOf VnicEthVethInventoryListAllOf
...
func NewVnicEthVethInventoryListAllOf() *VnicEthVethInventoryListAllOf {
	this := VnicEthVethInventoryListAllOf{}
	return &this
}
...
func (o VnicEthVethInventoryListAllOf) MarshalJSON() ([]byte, error) {
...
func (o *VnicEthVethInventoryListAllOf) UnmarshalJSON(bytes []byte) (err error) {
	varVnicEthVethInventoryListAllOf := _VnicEthVethInventoryListAllOf{}

	if err = json.Unmarshal(bytes, &varVnicEthVethInventoryListAllOf); err == nil {
		*o = VnicEthVethInventoryListAllOf(varVnicEthVethInventoryListAllOf)
	}
...
type NullableVnicEthVethInventoryListAllOf struct {
	value *VnicEthVethInventoryListAllOf
	isSet bool
}

func (v NullableVnicEthVethInventoryListAllOf) Get() *VnicEthVethInventoryListAllOf {
	return v.value
}

func (v *NullableVnicEthVethInventoryListAllOf) Set(val *VnicEthVethInventoryListAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableVnicEthVethInventoryListAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableVnicEthVethInventoryListAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVnicEthVethInventoryListAllOf(val *VnicEthVethInventoryListAllOf) *NullableVnicEthVethInventoryListAllOf {
	return &NullableVnicEthVethInventoryListAllOf{value: val, isSet: true}
}

func (v NullableVnicEthVethInventoryListAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVnicEthVethInventoryListAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
