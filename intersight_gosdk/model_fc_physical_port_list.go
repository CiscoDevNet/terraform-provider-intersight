...
// checks if the FcPhysicalPortList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FcPhysicalPortList{}
...
func (o FcPhysicalPortList) ToMap() (map[string]interface{}, error) {
...
func (o *FcPhysicalPortList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFcPhysicalPortListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varFcPhysicalPortList)
	if err == nil {
