...
// GetDefaultClassId returns the default value "workflow.ValidationError" of the ClassId field.
func (o *WorkflowValidationError) GetDefaultClassId() interface{} {
...
// GetDefaultObjectType returns the default value "workflow.ValidationError" of the ObjectType field.
func (o *WorkflowValidationError) GetDefaultObjectType() interface{} {
	return "workflow.ValidationError"
}
...
func (o *WorkflowValidationError) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varWorkflowValidationErrorWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varWorkflowValidationError)
	if err == nil {
