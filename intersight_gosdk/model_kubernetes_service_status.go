...
// checks if the KubernetesServiceStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesServiceStatus{}
...
// GetDefaultClassId returns the default value "kubernetes.ServiceStatus" of the ClassId field.
func (o *KubernetesServiceStatus) GetDefaultClassId() interface{} {
	return "kubernetes.ServiceStatus"
}
...
// GetDefaultObjectType returns the default value "kubernetes.ServiceStatus" of the ObjectType field.
func (o *KubernetesServiceStatus) GetDefaultObjectType() interface{} {
	return "kubernetes.ServiceStatus"
}
...
func (o KubernetesServiceStatus) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesServiceStatus) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varKubernetesServiceStatusWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varKubernetesServiceStatus)
	if err == nil {
