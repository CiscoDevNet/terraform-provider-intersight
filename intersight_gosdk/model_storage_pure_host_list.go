...
// checks if the StoragePureHostList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoragePureHostList{}
...
func NewStoragePureHostList(objectType string) *StoragePureHostList {
...
func (o StoragePureHostList) ToMap() (map[string]interface{}, error) {
...
func (o *StoragePureHostList) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varStoragePureHostListWithoutEmbeddedStruct)
	if err == nil {
	...
	err = json.Unmarshal(data, &varStoragePureHostList)
	if err == nil {
