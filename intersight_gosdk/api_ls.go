...
func (r ApiGetLsServiceProfileByMoidRequest) Execute() (LsServiceProfile, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *LsApiService) GetLsServiceProfileByMoidExecute(r ApiGetLsServiceProfileByMoidRequest) (LsServiceProfile, *_nethttp.Response, GenericOpenAPIError) {
	var (
...
func (r ApiGetLsServiceProfileListRequest) Execute() (LsServiceProfileResponse, *_nethttp.Response, GenericOpenAPIError) {
 ...
 */
func (a *LsApiService) GetLsServiceProfileListExecute(r ApiGetLsServiceProfileListRequest) (LsServiceProfileResponse, *_nethttp.Response, GenericOpenAPIError) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiPatchLsServiceProfileRequest) Execute() (LsServiceProfile, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return LsServiceProfile
 */
func (a *LsApiService) PatchLsServiceProfileExecute(r ApiPatchLsServiceProfileRequest) (LsServiceProfile, *_nethttp.Response, GenericOpenAPIError) {
	var (
	...
	if r.lsServiceProfile == nil {
		executionError.error = "lsServiceProfile is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
...
func (r ApiUpdateLsServiceProfileRequest) Execute() (LsServiceProfile, *_nethttp.Response, GenericOpenAPIError) {
 ...
 * @return LsServiceProfile
 */
func (a *LsApiService) UpdateLsServiceProfileExecute(r ApiUpdateLsServiceProfileRequest) (LsServiceProfile, *_nethttp.Response, GenericOpenAPIError) {
	var (
