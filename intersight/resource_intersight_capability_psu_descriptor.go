...
func resourceCapabilityPsuDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilityPsuDescriptorCreate,
		Read:   resourceCapabilityPsuDescriptorRead,
		Update: resourceCapabilityPsuDescriptorUpdate,
		Delete: resourceCapabilityPsuDescriptorDelete,
...
func resourceCapabilityPsuDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceCapabilityPsuDescriptorRead(d, meta)
}

func resourceCapabilityPsuDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilityPsuDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilityPsuDescriptorWithDefaults()
...
func resourceCapabilityPsuDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
