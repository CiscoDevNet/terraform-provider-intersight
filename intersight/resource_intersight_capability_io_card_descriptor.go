...
func resourceCapabilityIoCardDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilityIoCardDescriptorCreate,
		Read:   resourceCapabilityIoCardDescriptorRead,
...
func resourceCapabilityIoCardDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceCapabilityIoCardDescriptorRead(d, meta)
}

func resourceCapabilityIoCardDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	...
	if err := d.Set("num_hif_ports", (s.GetNumHifPorts())); err != nil {
		return fmt.Errorf("error occurred while setting property NumHifPorts: %+v", err)
	}
...
func resourceCapabilityIoCardDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilityIoCardDescriptorWithDefaults()
...
func resourceCapabilityIoCardDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
