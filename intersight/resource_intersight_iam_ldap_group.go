...
func resourceIamLdapGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourceIamLdapGroupCreate,
		Read:   resourceIamLdapGroupRead,
		Update: resourceIamLdapGroupUpdate,
		Delete: resourceIamLdapGroupDelete,
...
func resourceIamLdapGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIamLdapGroupRead(d, meta)
}

func resourceIamLdapGroupRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	...
	if err := d.Set("domain", (s.GetDomain())); err != nil {
		return fmt.Errorf("error occurred while setting property Domain: %+v", err)
	}
...
func resourceIamLdapGroupUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewIamLdapGroupWithDefaults()
...
func resourceIamLdapGroupDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
