...
func resourceFabricServerRole() *schema.Resource {
	return &schema.Resource{
		Create: resourceFabricServerRoleCreate,
		Read:   resourceFabricServerRoleRead,
		Update: resourceFabricServerRoleUpdate,
		Delete: resourceFabricServerRoleDelete,
...
func resourceFabricServerRoleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFabricServerRoleRead(d, meta)
}

func resourceFabricServerRoleRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFabricServerRoleUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFabricServerRoleDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
