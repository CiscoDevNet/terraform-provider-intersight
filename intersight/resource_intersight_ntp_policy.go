...
func resourceNtpPolicy() *schema.Resource {
	return &schema.Resource{
		Create: resourceNtpPolicyCreate,
		Read:   resourceNtpPolicyRead,
		Update: resourceNtpPolicyUpdate,
		Delete: resourceNtpPolicyDelete,
...
func resourceNtpPolicyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceNtpPolicyRead(d, meta)
}
func detachNtpPolicyProfiles(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewNtpPolicyWithDefaults()
...
func resourceNtpPolicyRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceNtpPolicyUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewNtpPolicyWithDefaults()
...
func resourceNtpPolicyDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
