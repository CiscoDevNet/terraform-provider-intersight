...
func resourceSoftwareUcsdDistributable() *schema.Resource {
	return &schema.Resource{
		Create: resourceSoftwareUcsdDistributableCreate,
		Read:   resourceSoftwareUcsdDistributableRead,
		Update: resourceSoftwareUcsdDistributableUpdate,
		Delete: resourceSoftwareUcsdDistributableDelete,
...
func resourceSoftwareUcsdDistributableCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceSoftwareUcsdDistributableRead(d, meta)
}

func resourceSoftwareUcsdDistributableRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceSoftwareUcsdDistributableUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewSoftwareUcsdDistributableWithDefaults()
...
func resourceSoftwareUcsdDistributableDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
