...
func resourceSoftwareHclMeta() *schema.Resource {
	return &schema.Resource{
		Create: resourceSoftwareHclMetaCreate,
		Read:   resourceSoftwareHclMetaRead,
		Update: resourceSoftwareHclMetaUpdate,
		Delete: resourceSoftwareHclMetaDelete,
...
func resourceSoftwareHclMetaCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceSoftwareHclMetaRead(d, meta)
}

func resourceSoftwareHclMetaRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceSoftwareHclMetaUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceSoftwareHclMetaDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
