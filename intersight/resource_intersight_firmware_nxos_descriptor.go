...
func resourceFirmwareNxosDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareNxosDescriptorCreate,
		Read:   resourceFirmwareNxosDescriptorRead,
		Update: resourceFirmwareNxosDescriptorUpdate,
		Delete: resourceFirmwareNxosDescriptorDelete,
...
func resourceFirmwareNxosDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFirmwareNxosDescriptorRead(d, meta)
}

func resourceFirmwareNxosDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareNxosDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareNxosDescriptorWithDefaults()
...
func resourceFirmwareNxosDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
