...
func resourceFirmwareMswitchDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareMswitchDescriptorCreate,
		Read:   resourceFirmwareMswitchDescriptorRead,
		Update: resourceFirmwareMswitchDescriptorUpdate,
		Delete: resourceFirmwareMswitchDescriptorDelete,
...
func resourceFirmwareMswitchDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFirmwareMswitchDescriptorRead(d, meta)
}

func resourceFirmwareMswitchDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareMswitchDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareMswitchDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
