...
func GetResourceMapping() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"intersight_capability_server_pcie_connectivity_catalog":             resourceCapabilityServerPcieConnectivityCatalog(),
		"intersight_capability_server_schema_descriptor":                     resourceCapabilityServerSchemaDescriptor(),
		"intersight_capability_server_topology_map":                          resourceCapabilityServerTopologyMap(),
		...
		"intersight_capability_switch_equipment_info":                        resourceCapabilitySwitchEquipmentInfo(),
		"intersight_capability_switch_manufacturing_def":                     resourceCapabilitySwitchManufacturingDef(),
		"intersight_capability_vic_descriptor":                               resourceCapabilityVicDescriptor(),
		"intersight_certificatemanagement_policy":                            resourceCertificatemanagementPolicy(),
		"intersight_changelog_item":                                          resourceChangelogItem(),
		...
		"intersight_firmware_psx_descriptor":                                 resourceFirmwarePsxDescriptor(),
		...
		"intersight_marketplace_use_case":                                    resourceMarketplaceUseCase(),
		"intersight_marketplace_use_case_version":                            resourceMarketplaceUseCaseVersion(),
		...
		"intersight_resourcepool_chassis_qualification_policy":               resourceResourcepoolChassisQualificationPolicy(),
		...
		"intersight_softwarerepository_category_unsupported_models":          resourceSoftwarerepositoryCategoryUnsupportedModels(),
		...
		"intersight_storage_net_app_volume_snapshot":                         resourceStorageNetAppVolumeSnapshot(),
		...
		"intersight_task_workflow_action":                                    resourceTaskWorkflowAction(),
