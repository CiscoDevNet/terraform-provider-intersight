...
func GetResourceMapping() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"intersight_functions_function":                                      resourceFunctionsFunction(),
		"intersight_functions_function_version":                              resourceFunctionsFunctionVersion(),
		"intersight_functions_runtime":                                       resourceFunctionsRuntime(),
		"intersight_functions_upload":                                        resourceFunctionsUpload(),
