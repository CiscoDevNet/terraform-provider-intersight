...
func resourceSoftwareUcsdBundleDistributable() *schema.Resource {
	return &schema.Resource{
		Create: resourceSoftwareUcsdBundleDistributableCreate,
		Read:   resourceSoftwareUcsdBundleDistributableRead,
		Update: resourceSoftwareUcsdBundleDistributableUpdate,
		Delete: resourceSoftwareUcsdBundleDistributableDelete,
...
func resourceSoftwareUcsdBundleDistributableCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceSoftwareUcsdBundleDistributableRead(d, meta)
}

func resourceSoftwareUcsdBundleDistributableRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceSoftwareUcsdBundleDistributableUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceSoftwareUcsdBundleDistributableDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
