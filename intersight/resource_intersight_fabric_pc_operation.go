...
func resourceFabricPcOperation() *schema.Resource {
	return &schema.Resource{
		Create: resourceFabricPcOperationCreate,
		Read:   resourceFabricPcOperationRead,
		Update: resourceFabricPcOperationUpdate,
		Delete: resourceFabricPcOperationDelete,
...
func resourceFabricPcOperationCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFabricPcOperationRead(d, meta)
}

func resourceFabricPcOperationRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFabricPcOperationUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFabricPcOperationWithDefaults()
...
func resourceFabricPcOperationDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
