...
func resourceCapabilitySwitchDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilitySwitchDescriptorCreate,
		Read:   resourceCapabilitySwitchDescriptorRead,
		Update: resourceCapabilitySwitchDescriptorUpdate,
		Delete: resourceCapabilitySwitchDescriptorDelete,
...
func resourceCapabilitySwitchDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceCapabilitySwitchDescriptorRead(d, meta)
}

func resourceCapabilitySwitchDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	...
	if err := d.Set("expected_memory", (s.GetExpectedMemory())); err != nil {
		return fmt.Errorf("error occurred while setting property ExpectedMemory: %+v", err)
	}
...
func resourceCapabilitySwitchDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilitySwitchDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
