...
func resourceCapabilitySwitchManufacturingDef() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilitySwitchManufacturingDefCreate,
		Read:   resourceCapabilitySwitchManufacturingDefRead,
		Update: resourceCapabilitySwitchManufacturingDefUpdate,
		Delete: resourceCapabilitySwitchManufacturingDefDelete,
...
func resourceCapabilitySwitchManufacturingDefCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceCapabilitySwitchManufacturingDefRead(d, meta)
}

func resourceCapabilitySwitchManufacturingDefRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilitySwitchManufacturingDefUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilitySwitchManufacturingDefWithDefaults()
...
func resourceCapabilitySwitchManufacturingDefDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
