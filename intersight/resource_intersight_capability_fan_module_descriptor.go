...
func resourceCapabilityFanModuleDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceCapabilityFanModuleDescriptorCreate,
		Read:   resourceCapabilityFanModuleDescriptorRead,
...
func resourceCapabilityFanModuleDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceCapabilityFanModuleDescriptorRead(d, meta)
}

func resourceCapabilityFanModuleDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceCapabilityFanModuleDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewCapabilityFanModuleDescriptorWithDefaults()
...
func resourceCapabilityFanModuleDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
