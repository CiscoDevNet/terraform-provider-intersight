...
func resourceSoftwarerepositoryCategoryMapperModel() *schema.Resource {
	return &schema.Resource{
		Create: resourceSoftwarerepositoryCategoryMapperModelCreate,
		Read:   resourceSoftwarerepositoryCategoryMapperModelRead,
		Update: resourceSoftwarerepositoryCategoryMapperModelUpdate,
		Delete: resourceSoftwarerepositoryCategoryMapperModelDelete,
...
func resourceSoftwarerepositoryCategoryMapperModelCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceSoftwarerepositoryCategoryMapperModelRead(d, meta)
}

func resourceSoftwarerepositoryCategoryMapperModelRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceSoftwarerepositoryCategoryMapperModelUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceSoftwarerepositoryCategoryMapperModelDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
