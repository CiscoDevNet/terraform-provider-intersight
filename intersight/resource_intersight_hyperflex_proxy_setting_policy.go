...
func resourceHyperflexProxySettingPolicy() *schema.Resource {
	return &schema.Resource{
		Create: resourceHyperflexProxySettingPolicyCreate,
		Read:   resourceHyperflexProxySettingPolicyRead,
		Update: resourceHyperflexProxySettingPolicyUpdate,
		Delete: resourceHyperflexProxySettingPolicyDelete,
...
func resourceHyperflexProxySettingPolicyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceHyperflexProxySettingPolicyRead(d, meta)
}

func resourceHyperflexProxySettingPolicyRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceHyperflexProxySettingPolicyUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewHyperflexProxySettingPolicyWithDefaults()
...
func resourceHyperflexProxySettingPolicyDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
