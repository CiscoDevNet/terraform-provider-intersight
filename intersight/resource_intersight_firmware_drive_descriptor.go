...
func resourceFirmwareDriveDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareDriveDescriptorCreate,
		Read:   resourceFirmwareDriveDescriptorRead,
		Update: resourceFirmwareDriveDescriptorUpdate,
		Delete: resourceFirmwareDriveDescriptorDelete,
...
func resourceFirmwareDriveDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFirmwareDriveDescriptorRead(d, meta)
}

func resourceFirmwareDriveDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareDriveDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareDriveDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
