...
func resourceFirmwareIomDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareIomDescriptorCreate,
		Read:   resourceFirmwareIomDescriptorRead,
		Update: resourceFirmwareIomDescriptorUpdate,
		Delete: resourceFirmwareIomDescriptorDelete,
...
func resourceFirmwareIomDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFirmwareIomDescriptorRead(d, meta)
}

func resourceFirmwareIomDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	...
	if err := d.Set("brand_string", (s.GetBrandString())); err != nil {
		return fmt.Errorf("error occurred while setting property BrandString: %+v", err)
	}
...
func resourceFirmwareIomDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareIomDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
