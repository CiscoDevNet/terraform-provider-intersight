...
func resourceHyperflexFeatureLimitInternal() *schema.Resource {
	return &schema.Resource{
		Create: resourceHyperflexFeatureLimitInternalCreate,
		Read:   resourceHyperflexFeatureLimitInternalRead,
		Update: resourceHyperflexFeatureLimitInternalUpdate,
		Delete: resourceHyperflexFeatureLimitInternalDelete,
...
func resourceHyperflexFeatureLimitInternalCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceHyperflexFeatureLimitInternalRead(d, meta)
}

func resourceHyperflexFeatureLimitInternalRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceHyperflexFeatureLimitInternalUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewHyperflexFeatureLimitInternalWithDefaults()
...
func resourceHyperflexFeatureLimitInternalDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
