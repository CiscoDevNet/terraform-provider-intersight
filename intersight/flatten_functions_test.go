...
func TestFlattenListApplianceApiStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Reason":"Reason %d","Response":32,"ClassId":"appliance.ApiStatus","ObjectType":"appliance.ApiStatus","ElapsedTime":32.000000,"ObjectName":"ObjectName %d"}`
...
func TestFlattenListApplianceCertRenewalPhase(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Message":"Message %d","Name":"Name %d","ClassId":"appliance.CertRenewalPhase","ObjectType":"appliance.CertRenewalPhase","Failed":true}`
	...
	expectedOp := []map[string]interface{}{{"message": "Message 1", "name": "Name 1", "class_id": "appliance.CertRenewalPhase", "object_type": "appliance.CertRenewalPhase", "failed": true}, {"message": "Message 2", "name": "Name 2", "class_id": "appliance.CertRenewalPhase", "object_type": "appliance.CertRenewalPhase", "failed": true}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCapabilityPortRange(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"StartSlotId":32,"EndPortId":32,"ClassId":"capability.PortRange","ObjectType":"capability.PortRange","EndSlotId":32,"StartPortId":32}`
	...
	expectedOp := []map[string]interface{}{{"start_slot_id": 32, "end_port_id": 32, "class_id": "capability.PortRange", "object_type": "capability.PortRange", "end_slot_id": 32, "start_port_id": 32}, {"start_slot_id": 32, "end_port_id": 32, "class_id": "capability.PortRange", "object_type": "capability.PortRange", "end_slot_id": 32, "start_port_id": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudNetworkInterfaceAttachment(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"cloud.NetworkInterfaceAttachment","ObjectType":"cloud.NetworkInterfaceAttachment","MacAddress":"MacAddress %d","NicIndex":32,"Identity":"Identity %d","NetworkName":"NetworkName %d","IpForwardingEnabled":true,"SubNetworkId":"SubNetworkId %d","NetworkId":"NetworkId %d","SubNetworkName":"SubNetworkName %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "cloud.NetworkInterfaceAttachment", "object_type": "cloud.NetworkInterfaceAttachment", "mac_address": "MacAddress 1", "nic_index": 32, "identity": "Identity 1", "network_name": "NetworkName 1", "ip_forwarding_enabled": true, "sub_network_id": "SubNetworkId 1", "network_id": "NetworkId 1", "sub_network_name": "SubNetworkName 1"}, {"class_id": "cloud.NetworkInterfaceAttachment", "object_type": "cloud.NetworkInterfaceAttachment", "mac_address": "MacAddress 2", "nic_index": 32, "identity": "Identity 2", "network_name": "NetworkName 2", "ip_forwarding_enabled": true, "sub_network_id": "SubNetworkId 2", "network_id": "NetworkId 2", "sub_network_name": "SubNetworkName 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudSecurityGroupRule(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"StartPort":32,"EtherType":"EtherType %d","Description":"Description %d","Name":"Name %d","Protocol":"Protocol %d","ClassId":"cloud.SecurityGroupRule","Index":32,"SourceSecurityGroup":"SourceSecurityGroup %d","EndPort":32,"Identity":"Identity %d","Action":"Action %d","ObjectType":"cloud.SecurityGroupRule"}`
	...
	expectedOp := []map[string]interface{}{{"start_port": 32, "ether_type": "EtherType 1", "description": "Description 1", "name": "Name 1", "protocol": "Protocol 1", "class_id": "cloud.SecurityGroupRule", "index": 32, "source_security_group": "SourceSecurityGroup 1", "end_port": 32, "identity": "Identity 1", "action": "Action 1", "object_type": "cloud.SecurityGroupRule"}, {"start_port": 32, "ether_type": "EtherType 2", "description": "Description 2", "name": "Name 2", "protocol": "Protocol 2", "class_id": "cloud.SecurityGroupRule", "index": 32, "source_security_group": "SourceSecurityGroup 2", "end_port": 32, "identity": "Identity 2", "action": "Action 2", "object_type": "cloud.SecurityGroupRule"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudTfcWorkspaceVariables(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Hcl":true,"Key":"Key %d","Sensitive":true,"Value":"Value %d","Category":"Category %d","Identity":"Identity %d","ClassId":"cloud.TfcWorkspaceVariables","ObjectType":"cloud.TfcWorkspaceVariables","Description":"Description %d"}`
	...
	expectedOp := []map[string]interface{}{{"hcl": true, "key": "Key 1", "sensitive": true, "value": "Value 1", "category": "Category 1", "identity": "Identity 1", "class_id": "cloud.TfcWorkspaceVariables", "object_type": "cloud.TfcWorkspaceVariables", "description": "Description 1"}, {"hcl": true, "key": "Key 2", "sensitive": true, "value": "Value 2", "category": "Category 2", "identity": "Identity 2", "class_id": "cloud.TfcWorkspaceVariables", "object_type": "cloud.TfcWorkspaceVariables", "description": "Description 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudVolumeAttachment(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Index":32,"ObjectType":"cloud.VolumeAttachment","IsRoot":true,"Identity":"Identity %d","ClassId":"cloud.VolumeAttachment","DeviceName":"DeviceName %d","AutoDelete":true}`
	...
	expectedOp := []map[string]interface{}{{"index": 32, "object_type": "cloud.VolumeAttachment", "is_root": true, "identity": "Identity 1", "class_id": "cloud.VolumeAttachment", "device_name": "DeviceName 1", "auto_delete": true}, {"index": 32, "object_type": "cloud.VolumeAttachment", "is_root": true, "identity": "Identity 2", "class_id": "cloud.VolumeAttachment", "device_name": "DeviceName 2", "auto_delete": true}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudVolumeInstanceAttachment(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"InstanceId":"InstanceId %d","State":"State %d","AutoDelete":true,"ClassId":"cloud.VolumeInstanceAttachment","ObjectType":"cloud.VolumeInstanceAttachment","DeviceName":"DeviceName %d"}`
...
func TestFlattenListComputeIpAddress(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"HttpsPort":32,"KvmVlan":32,"Address":"Address %d","KvmPort":32,"ClassId":"compute.IpAddress","Category":"Category %d","HttpPort":32,"ObjectType":"compute.IpAddress","Name":"Name %d","Subnet":"Subnet %d","Dn":"Dn %d","Type":"Type %d","DefaultGateway":"DefaultGateway %d"}`
	...
	expectedOp := []map[string]interface{}{{"https_port": 32, "kvm_vlan": 32, "address": "Address 1", "kvm_port": 32, "class_id": "compute.IpAddress", "category": "Category 1", "http_port": 32, "object_type": "compute.IpAddress", "name": "Name 1", "subnet": "Subnet 1", "dn": "Dn 1", "type": "Type 1", "default_gateway": "DefaultGateway 1"}, {"https_port": 32, "kvm_vlan": 32, "address": "Address 2", "kvm_port": 32, "class_id": "compute.IpAddress", "category": "Category 2", "http_port": 32, "object_type": "compute.IpAddress", "name": "Name 2", "subnet": "Subnet 2", "dn": "Dn 2", "type": "Type 2", "default_gateway": "DefaultGateway 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListConnectorpackConnectorPackUpdate(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"NewVersion":"NewVersion %d","CurrentVersion":"CurrentVersion %d","Name":"Name %d","ClassId":"connectorpack.ConnectorPackUpdate","ObjectType":"connectorpack.ConnectorPackUpdate"}`
...
func TestFlattenListContentParameter(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Type":"Type %d","ItemType":"ItemType %d","ComplexType":"ComplexType %d","Secure":true,"Path":"Path %d","Name":"Name %d","AcceptSingleValue":true,"ClassId":"content.Parameter","ObjectType":"content.Parameter"}`
	...
	expectedOp := []map[string]interface{}{{"type": "Type 1", "item_type": "ItemType 1", "complex_type": "ComplexType 1", "secure": true, "path": "Path 1", "name": "Name 1", "accept_single_value": true, "class_id": "content.Parameter", "object_type": "content.Parameter"}, {"type": "Type 2", "item_type": "ItemType 2", "complex_type": "ComplexType 2", "secure": true, "path": "Path 2", "name": "Name 2", "accept_single_value": true, "class_id": "content.Parameter", "object_type": "content.Parameter"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCrdCustomResourceConfigProperty(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Key":"Key %d","ClassId":"crd.CustomResourceConfigProperty","ObjectType":"crd.CustomResourceConfigProperty","Value":"Value %d"}`
	...
	expectedOp := []map[string]interface{}{{"key": "Key 1", "class_id": "crd.CustomResourceConfigProperty", "object_type": "crd.CustomResourceConfigProperty", "value": "Value 1"}, {"key": "Key 2", "class_id": "crd.CustomResourceConfigProperty", "object_type": "crd.CustomResourceConfigProperty", "value": "Value 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListEquipmentIoCardIdentity(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"NetworkElementMoid":"NetworkElementMoid %d","SwitchId":32,"IoCardMoid":"IoCardMoid %d","ModuleId":32,"ClassId":"equipment.IoCardIdentity","ObjectType":"equipment.IoCardIdentity"}`
	...
	expectedOp := []map[string]interface{}{{"network_element_moid": "NetworkElementMoid 1", "switch_id": 32, "io_card_moid": "IoCardMoid 1", "module_id": 32, "class_id": "equipment.IoCardIdentity", "object_type": "equipment.IoCardIdentity"}, {"network_element_moid": "NetworkElementMoid 2", "switch_id": 32, "io_card_moid": "IoCardMoid 2", "module_id": 32, "class_id": "equipment.IoCardIdentity", "object_type": "equipment.IoCardIdentity"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListFabricPortIdentifier(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"fabric.PortIdentifier","PortId":32,"SlotId":32,"AggregatePortId":32,"ClassId":"fabric.PortIdentifier"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "fabric.PortIdentifier", "port_id": 32, "slot_id": 32, "aggregate_port_id": 32, "class_id": "fabric.PortIdentifier"}, {"object_type": "fabric.PortIdentifier", "port_id": 32, "slot_id": 32, "aggregate_port_id": 32, "class_id": "fabric.PortIdentifier"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListFabricQosClass(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","ObjectType":"fabric.QosClass","Cos":32,"BandwidthPercent":32,"MulticastOptimize":true,"PacketDrop":true,"Mtu":32,"ClassId":"fabric.QosClass","AdminState":"AdminState %d","Weight":32}`
...
func TestFlattenListFirmwareBaseImpact(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"firmware.BaseImpact","VersionImpact":"VersionImpact %d","EndPoint":"EndPoint %d","ImpactType":"ImpactType %d","ComputationError":"ComputationError %d","ClassId":"firmware.BaseImpact","TargetFirmwareVersion":"TargetFirmwareVersion %d","ComputationStatusDetail":"ComputationStatusDetail %d","DomainName":"DomainName %d","FirmwareVersion":"FirmwareVersion %d","Model":"Model %d"}`
...
func TestFlattenListFirmwareFirmwareInventory(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"firmware.FirmwareInventory","Category":"Category %d","Model":"Model %d","Vendor":"Vendor %d","Version":"Version %d","Label":"Label %d","ObjectType":"firmware.FirmwareInventory","UpdateUri":"UpdateUri %d"}`
...
func TestFlattenListHyperflexHealthCheckScriptInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"hyperflex.HealthCheckScriptInfo","ScriptExecuteLocation":"ScriptExecuteLocation %d","ScriptName":"ScriptName %d","Version":"Version %d","HyperflexVersion":"HyperflexVersion %d","ObjectType":"hyperflex.HealthCheckScriptInfo","ScriptInput":"ScriptInput %d","AggregateScriptName":"AggregateScriptName %d"}`
...
func TestFlattenListHyperflexVmDisk(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"hyperflex.VmDisk","ObjectType":"hyperflex.VmDisk","Bus":"Bus %d","Type":"Type %d","VirtualDiskReference":"VirtualDiskReference %d","BootOrder":32,"Name":"Name %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "hyperflex.VmDisk", "object_type": "hyperflex.VmDisk", "bus": "Bus 1", "type": "Type 1", "virtual_disk_reference": "VirtualDiskReference 1", "boot_order": 32, "name": "Name 1"}, {"class_id": "hyperflex.VmDisk", "object_type": "hyperflex.VmDisk", "bus": "Bus 2", "type": "Type 2", "virtual_disk_reference": "VirtualDiskReference 2", "boot_order": 32, "name": "Name 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexVmInterface(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Model":"Model %d","Name":"Name %d","Bridge":"Bridge %d","ClassId":"hyperflex.VmInterface","ObjectType":"hyperflex.VmInterface","MacAddress":"MacAddress %d"}`
	...
	expectedOp := []map[string]interface{}{{"model": "Model 1", "name": "Name 1", "bridge": "Bridge 1", "class_id": "hyperflex.VmInterface", "object_type": "hyperflex.VmInterface", "mac_address": "MacAddress 1"}, {"model": "Model 2", "name": "Name 2", "bridge": "Bridge 2", "class_id": "hyperflex.VmInterface", "object_type": "hyperflex.VmInterface", "mac_address": "MacAddress 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListIaasWorkflowSteps(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"iaas.WorkflowSteps","ObjectType":"iaas.WorkflowSteps","Status":"Status %d","StatusMessage":"StatusMessage %d","CompletedTime":"CompletedTime %d","Name":"Name %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "iaas.WorkflowSteps", "object_type": "iaas.WorkflowSteps", "status": "Status 1", "status_message": "StatusMessage 1", "completed_time": "CompletedTime 1", "name": "Name 1"}, {"class_id": "iaas.WorkflowSteps", "object_type": "iaas.WorkflowSteps", "status": "Status 2", "status_message": "StatusMessage 2", "completed_time": "CompletedTime 2", "name": "Name 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListIppoolIpV4Block(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Size":32,"To":"To %d","From":"From %d","ClassId":"ippool.IpV4Block","ObjectType":"ippool.IpV4Block"}`
	...
	expectedOp := []map[string]interface{}{{"size": 32, "to": "To 1", "from": "From 1", "class_id": "ippool.IpV4Block", "object_type": "ippool.IpV4Block"}, {"size": 32, "to": "To 2", "from": "From 2", "class_id": "ippool.IpV4Block", "object_type": "ippool.IpV4Block"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListIqnpoolIqnSuffixBlock(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"object_type": "iqnpool.IqnSuffixBlock", "size": 32, "from": 32, "suffix": "Suffix 1", "to": 32, "class_id": "iqnpool.IqnSuffixBlock"}, {"object_type": "iqnpool.IqnSuffixBlock", "size": 32, "from": 32, "suffix": "Suffix 2", "to": 32, "class_id": "iqnpool.IqnSuffixBlock"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListMemoryPersistentMemoryLogicalNamespace(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Mode":"Mode %d","Name":"Name %d","ClassId":"memory.PersistentMemoryLogicalNamespace","ObjectType":"memory.PersistentMemoryLogicalNamespace","SocketId":32,"SocketMemoryId":"SocketMemoryId %d","Capacity":32}`
	...
	expectedOp := []map[string]interface{}{{"mode": "Mode 1", "name": "Name 1", "class_id": "memory.PersistentMemoryLogicalNamespace", "object_type": "memory.PersistentMemoryLogicalNamespace", "socket_id": 32, "socket_memory_id": "SocketMemoryId 1", "capacity": 32}, {"mode": "Mode 2", "name": "Name 2", "class_id": "memory.PersistentMemoryLogicalNamespace", "object_type": "memory.PersistentMemoryLogicalNamespace", "socket_id": 32, "socket_memory_id": "SocketMemoryId 2", "capacity": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListMetaAccessPrivilege(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Privilege":"Privilege %d","Method":"Method %d","ClassId":"meta.AccessPrivilege","ObjectType":"meta.AccessPrivilege"}`
	...
	expectedOp := []map[string]interface{}{{"privilege": "Privilege 1", "method": "Method 1", "class_id": "meta.AccessPrivilege", "object_type": "meta.AccessPrivilege"}, {"privilege": "Privilege 2", "method": "Method 2", "class_id": "meta.AccessPrivilege", "object_type": "meta.AccessPrivilege"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListMetaDisplayNameDefinition(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Format":"Format %d","IncludeAncestor":true,"ClassId":"meta.DisplayNameDefinition","ObjectType":"meta.DisplayNameDefinition","Name":"Name %d"}`
	...
	expectedOp := []map[string]interface{}{{"format": "Format 1", "include_ancestor": true, "class_id": "meta.DisplayNameDefinition", "object_type": "meta.DisplayNameDefinition", "name": "Name 1"}, {"format": "Format 2", "include_ancestor": true, "class_id": "meta.DisplayNameDefinition", "object_type": "meta.DisplayNameDefinition", "name": "Name 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListMetaRelationshipDefinition(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ApiAccess":"ApiAccess %d","ObjectType":"meta.RelationshipDefinition","ExportWithPeer":true,"Export":true,"Collection":true,"Type":"Type %d","ClassId":"meta.RelationshipDefinition","PeerSync":true,"Name":"Name %d","PeerRelName":"PeerRelName %d"}`
...
func TestFlattenListNiatelemetryInterfaceElement(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","ObjectType":"niatelemetry.InterfaceElement","ClassId":"niatelemetry.InterfaceElement","OperState":"OperState %d","XcvrPresent":"XcvrPresent %d"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "object_type": "niatelemetry.InterfaceElement", "class_id": "niatelemetry.InterfaceElement", "oper_state": "OperState 1", "xcvr_present": "XcvrPresent 1"}, {"name": "Name 2", "object_type": "niatelemetry.InterfaceElement", "class_id": "niatelemetry.InterfaceElement", "oper_state": "OperState 2", "xcvr_present": "XcvrPresent 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListNiatelemetryLogicalLink(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"niatelemetry.LogicalLink","ObjectType":"niatelemetry.LogicalLink","LinkState":"LinkState %d","LinkType":"LinkType %d","Uptime":"Uptime %d","DbId":32,"LinkAddr1":"LinkAddr1 %d","LinkAddr2":"LinkAddr2 %d","IsPresent":true}`
...
func TestFlattenListOnpremImagePackage(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"FileSha":"FileSha %d","ObjectType":"onprem.ImagePackage","Name":"Name %d","Filename":"Filename %d","FilePath":"FilePath %d","Version":"Version %d","ClassId":"onprem.ImagePackage","PackageType":"PackageType %d","FileSize":32}`
	...
	expectedOp := []map[string]interface{}{{"file_sha": "FileSha 1", "object_type": "onprem.ImagePackage", "name": "Name 1", "filename": "Filename 1", "file_path": "FilePath 1", "nr_version": "Version 1", "class_id": "onprem.ImagePackage", "package_type": "PackageType 1", "file_size": 32}, {"file_sha": "FileSha 2", "object_type": "onprem.ImagePackage", "name": "Name 2", "filename": "Filename 2", "file_path": "FilePath 2", "nr_version": "Version 2", "class_id": "onprem.ImagePackage", "package_type": "PackageType 2", "file_size": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListOnpremUpgradePhase(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"onprem.UpgradePhase","Message":"Message %d","Name":"Name %d","ElapsedTime":32,"Failed":true,"ClassId":"onprem.UpgradePhase"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "onprem.UpgradePhase", "message": "Message 1", "name": "Name 1", "elapsed_time": 32, "failed": true, "class_id": "onprem.UpgradePhase"}, {"object_type": "onprem.UpgradePhase", "message": "Message 2", "name": "Name 2", "elapsed_time": 32, "failed": true, "class_id": "onprem.UpgradePhase"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListOsValidationInformation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Status":"Status %d","StepName":"StepName %d","ClassId":"os.ValidationInformation","ObjectType":"os.ValidationInformation","ErrorMsg":"ErrorMsg %d"}`
	...
	expectedOp := []map[string]interface{}{{"status": "Status 1", "step_name": "StepName 1", "class_id": "os.ValidationInformation", "object_type": "os.ValidationInformation", "error_msg": "ErrorMsg 1"}, {"status": "Status 2", "step_name": "StepName 2", "class_id": "os.ValidationInformation", "object_type": "os.ValidationInformation", "error_msg": "ErrorMsg 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListPolicyinventoryJobInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"PolicyName":"PolicyName %d","ExecutionStatus":"ExecutionStatus %d","ClassId":"policyinventory.JobInfo","ObjectType":"policyinventory.JobInfo","PolicyId":"PolicyId %d"}`
	...
	expectedOp := []map[string]interface{}{{"policy_name": "PolicyName 1", "execution_status": "ExecutionStatus 1", "class_id": "policyinventory.JobInfo", "object_type": "policyinventory.JobInfo", "policy_id": "PolicyId 1"}, {"policy_name": "PolicyName 2", "execution_status": "ExecutionStatus 2", "class_id": "policyinventory.JobInfo", "object_type": "policyinventory.JobInfo", "policy_id": "PolicyId 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListSdwanNetworkConfigurationType(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"PortGroup":"PortGroup %d","Vlan":32,"NetworkType":"NetworkType %d","ClassId":"sdwan.NetworkConfigurationType","ObjectType":"sdwan.NetworkConfigurationType"}`
	...
	expectedOp := []map[string]interface{}{{"port_group": "PortGroup 1", "vlan": 32, "network_type": "NetworkType 1", "class_id": "sdwan.NetworkConfigurationType", "object_type": "sdwan.NetworkConfigurationType"}, {"port_group": "PortGroup 2", "vlan": 32, "network_type": "NetworkType 2", "class_id": "sdwan.NetworkConfigurationType", "object_type": "sdwan.NetworkConfigurationType"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListSdwanTemplateInputsType(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"sdwan.TemplateInputsType","ObjectType":"sdwan.TemplateInputsType","Template":"Template %d","Editable":true,"Key":"Key %d","Title":"Title %d","Value":"Value %d","Required":true,"Type":"Type %d"}`
...
func TestFlattenListSnmpTrap(t *testing.T) {
	p := []models.SnmpTrap{}
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"snmp.Trap","ClassId":"snmp.Trap","Destination":"Destination %d","User":"User %d","Port":32,"Enabled":true,"Version":"Version %d","Type":"Type %d","Community":"Community %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "snmp.Trap", "class_id": "snmp.Trap", "destination": "Destination 1", "user": "User 1", "port": 32, "enabled": true, "nr_version": "Version 1", "type": "Type 1", "community": "Community 1"}, {"object_type": "snmp.Trap", "class_id": "snmp.Trap", "destination": "Destination 2", "user": "User 2", "port": 32, "enabled": true, "nr_version": "Version 2", "type": "Type 2", "community": "Community 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListSnmpUser(t *testing.T) {
	p := []models.SnmpUser{}
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","SecurityLevel":"SecurityLevel %d","PrivacyType":"PrivacyType %d","AuthType":"AuthType %d","ClassId":"snmp.User","ObjectType":"snmp.User","IsAuthPasswordSet":true,"IsPrivacyPasswordSet":true}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "security_level": "SecurityLevel 1", "privacy_type": "PrivacyType 1", "auth_type": "AuthType 1", "class_id": "snmp.User", "object_type": "snmp.User", "is_auth_password_set": true, "is_privacy_password_set": true}, {"name": "Name 2", "security_level": "SecurityLevel 2", "privacy_type": "PrivacyType 2", "auth_type": "AuthType 2", "class_id": "snmp.User", "object_type": "snmp.User", "is_auth_password_set": true, "is_privacy_password_set": true}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListSoftwarerepositoryConstraintModels(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"MinVersion":"MinVersion %d","Name":"Name %d","ObjectType":"softwarerepository.ConstraintModels","ClassId":"softwarerepository.ConstraintModels","PlatformRegex":"PlatformRegex %d"}`
	...
	expectedOp := []map[string]interface{}{{"min_version": "MinVersion 1", "name": "Name 1", "object_type": "softwarerepository.ConstraintModels", "class_id": "softwarerepository.ConstraintModels", "platform_regex": "PlatformRegex 1"}, {"min_version": "MinVersion 2", "name": "Name 2", "object_type": "softwarerepository.ConstraintModels", "class_id": "softwarerepository.ConstraintModels", "platform_regex": "PlatformRegex 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListStorageVirtualDriveConfiguration(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ExpandToAvailable":true,"Name":"Name %d","Size":32,"ClassId":"storage.VirtualDriveConfiguration","ObjectType":"storage.VirtualDriveConfiguration","BootDrive":true}`
...
func TestFlattenListTamAction(t *testing.T) {
	p := []models.TamAction{}
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"tam.Action","AffectedObjectType":"AffectedObjectType %d","Type":"Type %d","OperationType":"OperationType %d","AlertType":"AlertType %d","ClassId":"tam.Action","Name":"Name %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "tam.Action", "affected_object_type": "AffectedObjectType 1", "type": "Type 1", "operation_type": "OperationType 1", "alert_type": "AlertType 1", "class_id": "tam.Action", "name": "Name 1"}, {"object_type": "tam.Action", "affected_object_type": "AffectedObjectType 2", "type": "Type 2", "operation_type": "OperationType 2", "alert_type": "AlertType 2", "class_id": "tam.Action", "name": "Name 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListTamApiDataSource(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","ClassId":"tam.ApiDataSource","MoType":"MoType %d","ObjectType":"tam.ApiDataSource","Type":"Type %d"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "class_id": "tam.ApiDataSource", "mo_type": "MoType 1", "object_type": "tam.ApiDataSource", "type": "Type 1"}, {"name": "Name 2", "class_id": "tam.ApiDataSource", "mo_type": "MoType 2", "object_type": "tam.ApiDataSource", "type": "Type 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListTamS3DataSource(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"tam.S3DataSource","S3Path":"S3Path %d","ObjectType":"tam.S3DataSource","Type":"Type %d","Name":"Name %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "tam.S3DataSource", "s3_path": "S3Path 1", "object_type": "tam.S3DataSource", "type": "Type 1", "name": "Name 1"}, {"class_id": "tam.S3DataSource", "s3_path": "S3Path 2", "object_type": "tam.S3DataSource", "type": "Type 2", "name": "Name 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListUcsdConnectorPack(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"State":"State %d","Name":"Name %d","ClassId":"ucsd.ConnectorPack","ObjectType":"ucsd.ConnectorPack","DownloadedVersion":"DownloadedVersion %d","Version":"Version %d","ConnectorFeature":"ConnectorFeature %d"}`
	...
	expectedOp := []map[string]interface{}{{"state": "State 1", "name": "Name 1", "class_id": "ucsd.ConnectorPack", "object_type": "ucsd.ConnectorPack", "downloaded_version": "DownloadedVersion 1", "nr_version": "Version 1", "connector_feature": "ConnectorFeature 1"}, {"state": "State 2", "name": "Name 2", "class_id": "ucsd.ConnectorPack", "object_type": "ucsd.ConnectorPack", "downloaded_version": "DownloadedVersion 2", "nr_version": "Version 2", "connector_feature": "ConnectorFeature 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListUuidpoolUuidBlock(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Size":32,"ClassId":"uuidpool.UuidBlock","To":"To %d","From":"From %d","ObjectType":"uuidpool.UuidBlock"}`
	...
	expectedOp := []map[string]interface{}{{"size": 32, "class_id": "uuidpool.UuidBlock", "to": "To 1", "from": "From 1", "object_type": "uuidpool.UuidBlock"}, {"size": 32, "class_id": "uuidpool.UuidBlock", "to": "To 2", "from": "From 2", "object_type": "uuidpool.UuidBlock"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListVirtualizationNetworkInterface(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ConnectAtPowerOn":true,"DirectPathIo":true,"ClassId":"virtualization.NetworkInterface","Name":"Name %d","AdaptorType":"AdaptorType %d","Bridge":"Bridge %d","ObjectType":"virtualization.NetworkInterface","MacAddress":"MacAddress %d"}`
	...
	expectedOp := []map[string]interface{}{{"connect_at_power_on": true, "direct_path_io": true, "class_id": "virtualization.NetworkInterface", "name": "Name 1", "adaptor_type": "AdaptorType 1", "bridge": "Bridge 1", "object_type": "virtualization.NetworkInterface", "mac_address": "MacAddress 1"}, {"connect_at_power_on": true, "direct_path_io": true, "class_id": "virtualization.NetworkInterface", "name": "Name 2", "adaptor_type": "AdaptorType 2", "bridge": "Bridge 2", "object_type": "virtualization.NetworkInterface", "mac_address": "MacAddress 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListVirtualizationVirtualMachineDisk(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","Type":"Type %d","VirtualDiskReference":"VirtualDiskReference %d","ClassId":"virtualization.VirtualMachineDisk","ObjectType":"virtualization.VirtualMachineDisk","Bus":"Bus %d","Order":32}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "type": "Type 1", "virtual_disk_reference": "VirtualDiskReference 1", "class_id": "virtualization.VirtualMachineDisk", "object_type": "virtualization.VirtualMachineDisk", "bus": "Bus 1", "order": 32}, {"name": "Name 2", "type": "Type 2", "virtual_disk_reference": "VirtualDiskReference 2", "class_id": "virtualization.VirtualMachineDisk", "object_type": "virtualization.VirtualMachineDisk", "bus": "Bus 2", "order": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListVnicVifStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"vnic.VifStatus","ObjectType":"vnic.VifStatus","Status":"Status %d","Name":"Name %d","Reason":"Reason %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "vnic.VifStatus", "object_type": "vnic.VifStatus", "status": "Status 1", "name": "Name 1", "reason": "Reason 1"}, {"class_id": "vnic.VifStatus", "object_type": "vnic.VifStatus", "status": "Status 2", "name": "Name 2", "reason": "Reason 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowApi(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ErrorContentType":"ErrorContentType %d","StartDelay":32,"ClassId":"workflow.Api","Description":"Description %d","ObjectType":"workflow.Api","AssetTargetMoid":"AssetTargetMoid %d","Body":"Body %d","ContentType":"ContentType %d","Timeout":32,"Label":"Label %d","SkipOnCondition":"SkipOnCondition %d","Name":"Name %d"}`
...
func TestFlattenListWorkflowBaseDataType(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"class_id": "workflow.BaseDataType", "description": "Description 1", "label": "Label 1", "name": "Name 1", "object_type": "workflow.BaseDataType", "required": true}, {"class_id": "workflow.BaseDataType", "description": "Description 2", "label": "Label 2", "name": "Name 2", "object_type": "workflow.BaseDataType", "required": true}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowParameterSet(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ControlParameter":"ControlParameter %d","Name":"Name %d","ClassId":"workflow.ParameterSet","ObjectType":"workflow.ParameterSet","Value":"Value %d","Condition":"Condition %d"}`
	...
	expectedOp := []map[string]interface{}{{"control_parameter": "ControlParameter 1", "name": "Name 1", "class_id": "workflow.ParameterSet", "object_type": "workflow.ParameterSet", "value": "Value 1", "condition": "Condition 1"}, {"control_parameter": "ControlParameter 2", "name": "Name 2", "class_id": "workflow.ParameterSet", "object_type": "workflow.ParameterSet", "value": "Value 2", "condition": "Condition 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowRollbackTask(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"CatalogMoid":"CatalogMoid %d","TaskMoid":"TaskMoid %d","Version":32,"ClassId":"workflow.RollbackTask","ObjectType":"workflow.RollbackTask","Name":"Name %d","Description":"Description %d"}`
...
func TestFlattenListWorkflowRollbackWorkflowTask(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"workflow.RollbackWorkflowTask","RollbackTaskName":"RollbackTaskName %d","Name":"Name %d","RefName":"RefName %d","TaskInfoMoid":"TaskInfoMoid %d","ObjectType":"workflow.RollbackWorkflowTask","TaskPath":"TaskPath %d","Status":"Status %d","Description":"Description %d","RollbackCompleted":true}`
...
func TestFlattenListWorkflowWorkflowTask(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"workflow.WorkflowTask","Name":"Name %d","Description":"Description %d","Label":"Label %d","ClassId":"workflow.WorkflowTask"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "workflow.WorkflowTask", "name": "Name 1", "description": "Description 1", "label": "Label 1", "class_id": "workflow.WorkflowTask"}, {"object_type": "workflow.WorkflowTask", "name": "Name 2", "description": "Description 2", "label": "Label 2", "class_id": "workflow.WorkflowTask"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListX509Certificate(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"sha256_fingerprint": "Sha256Fingerprint 1", "class_id": "x509.Certificate", "pem_certificate": "PemCertificate 1", "signature_algorithm": "SignatureAlgorithm 1", "object_type": "x509.Certificate"}, {"sha256_fingerprint": "Sha256Fingerprint 2", "class_id": "x509.Certificate", "pem_certificate": "PemCertificate 2", "signature_algorithm": "SignatureAlgorithm 2", "object_type": "x509.Certificate"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenMapApplianceCertRenewalPhase(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"message": "Message 1", "name": "Name 1", "class_id": "appliance.CertRenewalPhase", "object_type": "appliance.CertRenewalPhase", "failed": true}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapAssetContractInformation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"asset.ContractInformation","ObjectType":"asset.ContractInformation","LineStatus":"LineStatus %d","ContractNumber":"ContractNumber %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "asset.ContractInformation", "object_type": "asset.ContractInformation", "line_status": "LineStatus 1", "contract_number": "ContractNumber 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapAssetDeploymentDeviceInformation(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"description": "Description 1", "mlb_product_name": "MlbProductName 1", "old_device_status_description": "OldDeviceStatusDescription 1", "old_instance_id": "OldInstanceId 1", "item_type": "ItemType 1", "application_name": "ApplicationName 1", "old_device_status_id": 32, "old_device_id": "OldDeviceId 1", "instance_id": "InstanceId 1", "mlb_product_id": 32, "class_id": "asset.DeploymentDeviceInformation", "object_type": "asset.DeploymentDeviceInformation"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapAssetDeviceInformation(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"application_name": "ApplicationName 1", "mlb_product_name": "MlbProductName 1", "mlb_product_id": 32, "old_instance_id": "OldInstanceId 1", "old_device_id": "OldDeviceId 1", "mlb_offer_type": "MlbOfferType 1", "product_type": "ProductType 1", "item_type": "ItemType 1", "instance_id": "InstanceId 1", "old_device_status_id": 32, "product_family": "ProductFamily 1", "class_id": "asset.DeviceInformation", "object_type": "asset.DeviceInformation", "unit_of_measure": "UnitOfMeasure 1", "old_device_status_description": "OldDeviceStatusDescription 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapAssetProductInformation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Group":"Group %d","SubType":"SubType %d","Description":"Description %d","Family":"Family %d","ClassId":"asset.ProductInformation","ObjectType":"asset.ProductInformation","Number":"Number %d"}`
	...
	expectedOp := map[string]interface{}{"group": "Group 1", "sub_type": "SubType 1", "description": "Description 1", "family": "Family 1", "class_id": "asset.ProductInformation", "object_type": "asset.ProductInformation", "number": "Number 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapCapabilitySwitchNetworkLimits(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"maximum_primary_vlan": 32, "maximum_ethernet_port_channels": 32, "maximum_fc_port_channel_members": 32, "max_uncompressed_port_vlan_count": 32, "max_compressed_port_vlan_count": 32, "class_id": "capability.SwitchNetworkLimits", "object_type": "capability.SwitchNetworkLimits", "maximum_active_traffic_monitoring_sessions": 32, "maximum_secondary_vlan": 32, "maximum_secondary_vlan_per_primary": 32, "maximum_vlans": 32, "maximum_igmp_groups": 32, "maximum_fc_port_channels": 32, "minimum_active_fans": 32, "maximum_port_channel_members": 32, "maximum_vifs": 32, "maximum_ethernet_uplink_ports": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapCapabilitySwitchStorageLimits(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"MaximumZoneCount":32,"MaximumUserZoneCount":32,"MaximumVirtualFcInterfaces":32,"MaximumVirtualFcInterfacesPerBladeServer":32,"MaximumVsans":32,"ClassId":"capability.SwitchStorageLimits","ObjectType":"capability.SwitchStorageLimits"}`
	...
	expectedOp := map[string]interface{}{"maximum_zone_count": 32, "maximum_user_zone_count": 32, "maximum_virtual_fc_interfaces": 32, "maximum_virtual_fc_interfaces_per_blade_server": 32, "maximum_vsans": 32, "class_id": "capability.SwitchStorageLimits", "object_type": "capability.SwitchStorageLimits"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapCloudInstanceType(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Architecture":"Architecture %d","ObjectType":"cloud.InstanceType","Name":"Name %d","Cpus":32,"InstanceTypeId":"InstanceTypeId %d","Platform":"Platform %d","ClassId":"cloud.InstanceType","Memory":32,"CpuSpeed":32}`
	...
	expectedOp := map[string]interface{}{"architecture": "Architecture 1", "object_type": "cloud.InstanceType", "name": "Name 1", "cpus": 32, "instance_type_id": "InstanceTypeId 1", "platform": "Platform 1", "class_id": "cloud.InstanceType", "memory": 32, "cpu_speed": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapCloudVolumeIopsInfo(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"class_id": "cloud.VolumeIopsInfo", "object_type": "cloud.VolumeIopsInfo", "throughput_read_limit": 32, "throughput_write_limit": 32, "iops_read_limit": 32, "iops_write_limit": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapFirmwareDirectDownload(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ImageSource":"ImageSource %d","Username":"Username %d","Upgradeoption":"Upgradeoption %d","ClassId":"firmware.DirectDownload","ObjectType":"firmware.DirectDownload","IsPasswordSet":true}`
	...
	expectedOp := map[string]interface{}{"image_source": "ImageSource 1", "username": "Username 1", "upgradeoption": "Upgradeoption 1", "class_id": "firmware.DirectDownload", "object_type": "firmware.DirectDownload", "is_password_set": true}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapFirmwareNetworkShare(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"firmware.NetworkShare","ObjectType":"firmware.NetworkShare","MapType":"MapType %d","Username":"Username %d","Upgradeoption":"Upgradeoption %d","IsPasswordSet":true}`
	...
	expectedOp := map[string]interface{}{"class_id": "firmware.NetworkShare", "object_type": "firmware.NetworkShare", "map_type": "MapType 1", "username": "Username 1", "upgradeoption": "Upgradeoption 1", "is_password_set": true}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexAppSettingConstraint(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ServerModel":"ServerModel %d","DeploymentType":"DeploymentType %d","ClassId":"hyperflex.AppSettingConstraint","ObjectType":"hyperflex.AppSettingConstraint","HxdpVersion":"HxdpVersion %d","HypervisorType":"HypervisorType %d","MgmtPlatform":"MgmtPlatform %d"}`
	...
	expectedOp := map[string]interface{}{"server_model": "ServerModel 1", "deployment_type": "DeploymentType 1", "class_id": "hyperflex.AppSettingConstraint", "object_type": "hyperflex.AppSettingConstraint", "hxdp_version": "HxdpVersion 1", "hypervisor_type": "HypervisorType 1", "mgmt_platform": "MgmtPlatform 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexHealthCheckScriptInfo(t *testing.T) {
	p := models.HyperflexHealthCheckScriptInfo{}
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"hyperflex.HealthCheckScriptInfo","ScriptInput":"ScriptInput %d","AggregateScriptName":"AggregateScriptName %d","HyperflexVersion":"HyperflexVersion %d","ClassId":"hyperflex.HealthCheckScriptInfo","ScriptExecuteLocation":"ScriptExecuteLocation %d","ScriptName":"ScriptName %d","Version":"Version %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "hyperflex.HealthCheckScriptInfo", "script_input": "ScriptInput 1", "aggregate_script_name": "AggregateScriptName 1", "hyperflex_version": "HyperflexVersion 1", "class_id": "hyperflex.HealthCheckScriptInfo", "script_execute_location": "ScriptExecuteLocation 1", "script_name": "ScriptName 1", "nr_version": "Version 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexHxPlatformDatastoreConfigDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","NumMirrors":32,"DataBlockSize":32,"NumStripesForLargeFiles":32,"ProvisionedCapacity":32,"SystemDatastore":true,"ClassId":"hyperflex.HxPlatformDatastoreConfigDt","ObjectType":"hyperflex.HxPlatformDatastoreConfigDt"}`
	...
	expectedOp := map[string]interface{}{"name": "Name 1", "num_mirrors": 32, "data_block_size": 32, "num_stripes_for_large_files": 32, "provisioned_capacity": 32, "system_datastore": true, "class_id": "hyperflex.HxPlatformDatastoreConfigDt", "object_type": "hyperflex.HxPlatformDatastoreConfigDt"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapHyperflexHxRegistrationDetailsDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"NextRenewalAttemptDate":"NextRenewalAttemptDate %d","ObjectType":"hyperflex.HxRegistrationDetailsDt","OutOfComplianceStartDate":"OutOfComplianceStartDate %d","RegistrationFailedReason":"RegistrationFailedReason %d","SmartAccount":"SmartAccount %d","LastRenewalAttemptDate":"LastRenewalAttemptDate %d","InitialRegistrationDate":"InitialRegistrationDate %d","ClassId":"hyperflex.HxRegistrationDetailsDt","RegistrationExpireDate":"RegistrationExpireDate %d","VirtualAccount":"VirtualAccount %d","Status":"Status %d"}`
...
func TestFlattenMapHyperflexHxResiliencyInfoDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"HddFailuresTolerable":32,"NodeFailuresTolerable":32,"ObjectType":"hyperflex.HxResiliencyInfoDt","PolicyCompliance":"PolicyCompliance %d","ResiliencyState":"ResiliencyState %d","SsdFailuresTolerable":32,"DataReplicationFactor":"DataReplicationFactor %d","ClassId":"hyperflex.HxResiliencyInfoDt"}`
	...
	expectedOp := map[string]interface{}{"hdd_failures_tolerable": 32, "node_failures_tolerable": 32, "object_type": "hyperflex.HxResiliencyInfoDt", "policy_compliance": "PolicyCompliance 1", "resiliency_state": "ResiliencyState 1", "ssd_failures_tolerable": 32, "data_replication_factor": "DataReplicationFactor 1", "class_id": "hyperflex.HxResiliencyInfoDt"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexReplicationPeerInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Mcip":"Mcip %d","Status":"Status %d","ObjectType":"hyperflex.ReplicationPeerInfo","StatusDetails":"StatusDetails %d","ClassId":"hyperflex.ReplicationPeerInfo","ReplCip":"ReplCip %d","Dcip":"Dcip %d"}`
	...
	expectedOp := map[string]interface{}{"mcip": "Mcip 1", "status": "Status 1", "object_type": "hyperflex.ReplicationPeerInfo", "status_details": "StatusDetails 1", "class_id": "hyperflex.ReplicationPeerInfo", "repl_cip": "ReplCip 1", "dcip": "Dcip 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexSummary(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"data_replication_factor": "DataReplicationFactor 1", "downtime": "Downtime 1", "total_capacity": 32, "free_capacity": 32, "total_savings": 32.000000, "object_type": "hyperflex.Summary", "cluster_access_policy": "ClusterAccessPolicy 1", "data_replication_compliance": "DataReplicationCompliance 1", "resiliency_details_size": 32, "uptime": "Uptime 1", "active_nodes": "ActiveNodes 1", "space_status": "SpaceStatus 1", "class_id": "hyperflex.Summary", "name": "Name 1", "address": "Address 1", "used_capacity": 32, "compression_savings": 32.000000, "state": "State 1", "boottime": 32, "deduplication_savings": 32.000000}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIamEndPointPasswordProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"iam.EndPointPasswordProperties","EnforceStrongPassword":true,"EnablePasswordExpiry":true,"NotificationPeriod":32,"ObjectType":"iam.EndPointPasswordProperties","PasswordHistory":32,"ForceSendPassword":true,"PasswordExpiryDuration":32,"GracePeriod":32}`
	...
	expectedOp := map[string]interface{}{"class_id": "iam.EndPointPasswordProperties", "enforce_strong_password": true, "enable_password_expiry": true, "notification_period": 32, "object_type": "iam.EndPointPasswordProperties", "password_history": 32, "force_send_password": true, "password_expiry_duration": 32, "grace_period": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIamLdapBaseProperties(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"bind_dn": "BindDn 1", "base_dn": "BaseDn 1", "class_id": "iam.LdapBaseProperties", "attribute": "Attribute 1", "nested_group_search_depth": 32, "enable_encryption": true, "enable_group_authorization": true, "timeout": 32, "object_type": "iam.LdapBaseProperties", "filter": "Filter 1", "group_attribute": "GroupAttribute 1", "domain": "Domain 1", "is_password_set": true, "bind_method": "BindMethod 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIppoolIpV4Block(t *testing.T) {
	p := models.IppoolIpV4Block{}
	var d = &schema.ResourceData{}
	c := `{"To":"To %d","From":"From %d","ClassId":"ippool.IpV4Block","ObjectType":"ippool.IpV4Block","Size":32}`
	...
	expectedOp := map[string]interface{}{"to": "To 1", "from": "From 1", "class_id": "ippool.IpV4Block", "object_type": "ippool.IpV4Block", "size": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIppoolIpV6Block(t *testing.T) {
	p := models.IppoolIpV6Block{}
	var d = &schema.ResourceData{}
	c := `{"Size":32,"ClassId":"ippool.IpV6Block","To":"To %d","From":"From %d","ObjectType":"ippool.IpV6Block"}`
	...
	expectedOp := map[string]interface{}{"size": 32, "class_id": "ippool.IpV6Block", "to": "To 1", "from": "From 1", "object_type": "ippool.IpV6Block"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesActionInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"kubernetes.ActionInfo","Status":"Status %d","FailureReason":"FailureReason %d","Name":"Name %d","ClassId":"kubernetes.ActionInfo"}`
	...
	expectedOp := map[string]interface{}{"object_type": "kubernetes.ActionInfo", "status": "Status 1", "failure_reason": "FailureReason 1", "name": "Name 1", "class_id": "kubernetes.ActionInfo"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapKubernetesAddonConfiguration(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"kubernetes.AddonConfiguration","InstallStrategy":"InstallStrategy %d","Overrides":"Overrides %d","ReleaseNamespace":"ReleaseNamespace %d","UpgradeStrategy":"UpgradeStrategy %d","ClassId":"kubernetes.AddonConfiguration","ReleaseName":"ReleaseName %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "kubernetes.AddonConfiguration", "install_strategy": "InstallStrategy 1", "overrides": "Overrides 1", "release_namespace": "ReleaseNamespace 1", "upgrade_strategy": "UpgradeStrategy 1", "class_id": "kubernetes.AddonConfiguration", "release_name": "ReleaseName 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesClusterCertificateConfiguration(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"SaPublicKey":"SaPublicKey %d","ObjectType":"kubernetes.ClusterCertificateConfiguration","CaCert":"CaCert %d","FrontProxyCert":"FrontProxyCert %d","EtcdCert":"EtcdCert %d","ClassId":"kubernetes.ClusterCertificateConfiguration"}`
	...
	expectedOp := map[string]interface{}{"sa_public_key": "SaPublicKey 1", "object_type": "kubernetes.ClusterCertificateConfiguration", "ca_cert": "CaCert 1", "front_proxy_cert": "FrontProxyCert 1", "etcd_cert": "EtcdCert 1", "class_id": "kubernetes.ClusterCertificateConfiguration"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesDaemonSetStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"kubernetes.DaemonSetStatus","NumberAvailable":"NumberAvailable %d","ObservedGeneration":32,"NumberMisscheduled":32,"UpdatedNumberScheduled":"UpdatedNumberScheduled %d","NumberReady":32,"ClassId":"kubernetes.DaemonSetStatus","DesiredNumberScheduled":32,"CurrentNumberScheduled":32}`
	...
	expectedOp := map[string]interface{}{"object_type": "kubernetes.DaemonSetStatus", "number_available": "NumberAvailable 1", "observed_generation": 32, "number_misscheduled": 32, "updated_number_scheduled": "UpdatedNumberScheduled 1", "number_ready": 32, "class_id": "kubernetes.DaemonSetStatus", "desired_number_scheduled": 32, "current_number_scheduled": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapKubernetesDeploymentStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObservedGeneration":32,"ReadyReplicas":32,"Replicas":32,"UpdatedReplicas":32,"ClassId":"kubernetes.DeploymentStatus","ObjectType":"kubernetes.DeploymentStatus","AvailableReplicas":32}`
	...
	expectedOp := map[string]interface{}{"observed_generation": 32, "ready_replicas": 32, "replicas": 32, "updated_replicas": 32, "class_id": "kubernetes.DeploymentStatus", "object_type": "kubernetes.DeploymentStatus", "available_replicas": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesNodeInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"KubeletVersion":"KubeletVersion %d","KernelVersion":"KernelVersion %d","BootId":"BootId %d","ContainerRuntimeVersion":"ContainerRuntimeVersion %d","ClassId":"kubernetes.NodeInfo","ObjectType":"kubernetes.NodeInfo","KubeProxyVersion":"KubeProxyVersion %d","MachineId":"MachineId %d","OperatingSystem":"OperatingSystem %d","OsImage":"OsImage %d","SystemUuid":"SystemUuid %d","Architecture":"Architecture %d"}`
...
func TestFlattenMapKubernetesPodStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"QosClass":"QosClass %d","StartTime":"StartTime %d","HostIp":"HostIp %d","Phase":"Phase %d","ClassId":"kubernetes.PodStatus","ObjectType":"kubernetes.PodStatus","PodIp":"PodIp %d"}`
	...
	expectedOp := map[string]interface{}{"qos_class": "QosClass 1", "start_time": "StartTime 1", "host_ip": "HostIp 1", "phase": "Phase 1", "class_id": "kubernetes.PodStatus", "object_type": "kubernetes.PodStatus", "pod_ip": "PodIp 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapKubernetesProxyConfig(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Port":32,"Username":"Username %d","ObjectType":"kubernetes.ProxyConfig","Hostname":"Hostname %d","IsPasswordSet":true,"ClassId":"kubernetes.ProxyConfig","Protocol":"Protocol %d"}`
	...
	expectedOp := map[string]interface{}{"port": 32, "username": "Username 1", "object_type": "kubernetes.ProxyConfig", "hostname": "Hostname 1", "is_password_set": true, "class_id": "kubernetes.ProxyConfig", "protocol": "Protocol 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesStatefulSetStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"kubernetes.StatefulSetStatus","AvailableReplicas":32,"CollisionCount":32,"ReadyReplicas":32,"CurrentRevision":"CurrentRevision %d","ObservedGeneration":32,"ClassId":"kubernetes.StatefulSetStatus","UpdatedReplicas":32,"Replicas":32,"UpdateRevision":"UpdateRevision %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "kubernetes.StatefulSetStatus", "available_replicas": 32, "collision_count": 32, "ready_replicas": 32, "current_revision": "CurrentRevision 1", "observed_generation": 32, "class_id": "kubernetes.StatefulSetStatus", "updated_replicas": 32, "replicas": 32, "update_revision": "UpdateRevision 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapNiatelemetryNvePacketCounters(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"McastInpkts":32,"McastOutbytes":32,"UcastInpkts":32,"UcastOutpkts":32,"ClassId":"niatelemetry.NvePacketCounters","ObjectType":"niatelemetry.NvePacketCounters"}`
	...
	expectedOp := map[string]interface{}{"mcast_inpkts": 32, "mcast_outbytes": 32, "ucast_inpkts": 32, "ucast_outpkts": 32, "class_id": "niatelemetry.NvePacketCounters", "object_type": "niatelemetry.NvePacketCounters"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapNiatelemetryNveVni(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"niatelemetry.NveVni","ObjectType":"niatelemetry.NveVni","CpVniCount":32,"DpVniCount":32,"CpVniDown":32,"CpVniUp":32,"DpVniDown":32,"DpVniUp":32}`
	...
	expectedOp := map[string]interface{}{"class_id": "niatelemetry.NveVni", "object_type": "niatelemetry.NveVni", "cp_vni_count": 32, "dp_vni_count": 32, "cp_vni_down": 32, "cp_vni_up": 32, "dp_vni_down": 32, "dp_vni_up": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapNiatelemetryNxosBgpMvpn(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"niatelemetry.NxosBgpMvpn","TotalPaths":32,"NumberOfCommunities":32,"ClassId":"niatelemetry.NxosBgpMvpn","TotalNetworks":32,"MemoryUsed":32,"CapablePeers":32,"TableVersion":32,"ConfiguredPeers":32,"NumberOfClusterLists":32}`
	...
	expectedOp := map[string]interface{}{"object_type": "niatelemetry.NxosBgpMvpn", "total_paths": 32, "number_of_communities": 32, "class_id": "niatelemetry.NxosBgpMvpn", "total_networks": 32, "memory_used": 32, "capable_peers": 32, "table_version": 32, "configured_peers": 32, "number_of_cluster_lists": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapNiatelemetryNxosVtp(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"RunningVersion":"RunningVersion %d","TrapEnabled":"TrapEnabled %d","Version":32,"OperMode":"OperMode %d","PruningMode":"PruningMode %d","ClassId":"niatelemetry.NxosVtp","ObjectType":"niatelemetry.NxosVtp","V2Mode":"V2Mode %d"}`
	...
	expectedOp := map[string]interface{}{"running_version": "RunningVersion 1", "trap_enabled": "TrapEnabled 1", "nr_version": 32, "oper_mode": "OperMode 1", "pruning_mode": "PruningMode 1", "class_id": "niatelemetry.NxosVtp", "object_type": "niatelemetry.NxosVtp", "v2_mode": "V2Mode 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapNiatelemetrySmartLicense(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"niatelemetry.SmartLicense","SmartAccount":"SmartAccount %d","ActiveMode":"ActiveMode %d","AuthStatus":"AuthStatus %d","LicenseUdi":"LicenseUdi %d","ClassId":"niatelemetry.SmartLicense"}`
	...
	expectedOp := map[string]interface{}{"object_type": "niatelemetry.SmartLicense", "smart_account": "SmartAccount 1", "active_mode": "ActiveMode 1", "auth_status": "AuthStatus 1", "license_udi": "LicenseUdi 1", "class_id": "niatelemetry.SmartLicense"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapOnpremSchedule(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"MonthOfYear":32,"DayOfWeek":32,"RepeatInterval":32,"WeekOfMonth":32,"ClassId":"onprem.Schedule","ObjectType":"onprem.Schedule","TimeOfDay":32,"TimeZone":"TimeZone %d","DayOfMonth":32}`
	...
	expectedOp := map[string]interface{}{"month_of_year": 32, "day_of_week": 32, "repeat_interval": 32, "week_of_month": 32, "class_id": "onprem.Schedule", "object_type": "onprem.Schedule", "time_of_day": 32, "time_zone": "TimeZone 1", "day_of_month": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapOnpremUpgradePhase(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"object_type": "onprem.UpgradePhase", "message": "Message 1", "name": "Name 1", "elapsed_time": 32, "failed": true, "class_id": "onprem.UpgradePhase"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapOsAnswers(t *testing.T) {
	p := models.OsAnswers{}
	var d = &schema.ResourceData{}
	c := `{"ProductKey":"ProductKey %d","IsRootPasswordSet":true,"Source":"Source %d","Nameserver":"Nameserver %d","IsRootPasswordCrypted":true,"ClassId":"os.Answers","IpConfigType":"IpConfigType %d","IsAnswerFileSet":true,"ObjectType":"os.Answers","Hostname":"Hostname %d"}`
	...
	expectedOp := map[string]interface{}{"product_key": "ProductKey 1", "is_root_password_set": true, "nr_source": "Source 1", "nameserver": "Nameserver 1", "is_root_password_crypted": true, "class_id": "os.Answers", "ip_config_type": "IpConfigType 1", "is_answer_file_set": true, "object_type": "os.Answers", "hostname": "Hostname 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapOsGlobalConfig(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ConfigurationFileName":"ConfigurationFileName %d","OsImageName":"OsImageName %d","ObjectType":"os.GlobalConfig","WindowsEdition":"WindowsEdition %d","InstallTargetType":"InstallTargetType %d","ConfigurationSource":"ConfigurationSource %d","InstallMethod":"InstallMethod %d","ClassId":"os.GlobalConfig","ScuImageName":"ScuImageName %d"}`
	...
	expectedOp := map[string]interface{}{"configuration_file_name": "ConfigurationFileName 1", "os_image_name": "OsImageName 1", "object_type": "os.GlobalConfig", "windows_edition": "WindowsEdition 1", "install_target_type": "InstallTargetType 1", "configuration_source": "ConfigurationSource 1", "install_method": "InstallMethod 1", "class_id": "os.GlobalConfig", "scu_image_name": "ScuImageName 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapPolicyConfigContext(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ConfigType":"ConfigType %d","ControlAction":"ControlAction %d","ClassId":"policy.ConfigContext","ObjectType":"policy.ConfigContext","ErrorState":"ErrorState %d","OperState":"OperState %d","ConfigState":"ConfigState %d"}`
	...
	expectedOp := map[string]interface{}{"config_type": "ConfigType 1", "control_action": "ControlAction 1", "class_id": "policy.ConfigContext", "object_type": "policy.ConfigContext", "error_state": "ErrorState 1", "oper_state": "OperState 1", "config_state": "ConfigState 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapPolicyConfigResultContext(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"policy.ConfigResultContext","EntityName":"EntityName %d","EntityType":"EntityType %d","EntityMoid":"EntityMoid %d","ClassId":"policy.ConfigResultContext"}`
	...
	expectedOp := map[string]interface{}{"object_type": "policy.ConfigResultContext", "entity_name": "EntityName 1", "entity_type": "EntityType 1", "entity_moid": "EntityMoid 1", "class_id": "policy.ConfigResultContext"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapStorageAutomaticDriveGroup(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"storage.AutomaticDriveGroup","DrivesPerSpan":32,"MinimumDriveSize":32,"NumDedicatedHotSpares":"NumDedicatedHotSpares %d","NumberOfSpans":32,"UseRemainingDrives":true,"ObjectType":"storage.AutomaticDriveGroup","DriveType":"DriveType %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "storage.AutomaticDriveGroup", "drives_per_span": 32, "minimum_drive_size": 32, "num_dedicated_hot_spares": "NumDedicatedHotSpares 1", "number_of_spans": 32, "use_remaining_drives": true, "object_type": "storage.AutomaticDriveGroup", "drive_type": "DriveType 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapStorageBaseCapacity(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Total":32,"Used":32,"ClassId":"storage.BaseCapacity","ObjectType":"storage.BaseCapacity","Available":32,"CapacityUtilization":32.000000,"Free":32}`
	...
	expectedOp := map[string]interface{}{"total": 32, "used": 32, "class_id": "storage.BaseCapacity", "object_type": "storage.BaseCapacity", "available": 32, "capacity_utilization": 32.000000, "free": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapUuidpoolUuidBlock(t *testing.T) {
	p := models.UuidpoolUuidBlock{}
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"uuidpool.UuidBlock","Size":32,"ClassId":"uuidpool.UuidBlock","To":"To %d","From":"From %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "uuidpool.UuidBlock", "size": 32, "class_id": "uuidpool.UuidBlock", "to": "To 1", "from": "From 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationCpuInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"virtualization.CpuInfo","Vendor":"Vendor %d","Cores":32,"Description":"Description %d","Sockets":32,"Speed":32,"ClassId":"virtualization.CpuInfo"}`
	...
	expectedOp := map[string]interface{}{"object_type": "virtualization.CpuInfo", "vendor": "Vendor 1", "cores": 32, "description": "Description 1", "sockets": 32, "speed": 32, "class_id": "virtualization.CpuInfo"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVirtualizationGuestInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","OperatingSystem":"OperatingSystem %d","Hostname":"Hostname %d","IpAddress":"IpAddress %d","ClassId":"virtualization.GuestInfo","ObjectType":"virtualization.GuestInfo"}`
	...
	expectedOp := map[string]interface{}{"name": "Name 1", "operating_system": "OperatingSystem 1", "hostname": "Hostname 1", "ip_address": "IpAddress 1", "class_id": "virtualization.GuestInfo", "object_type": "virtualization.GuestInfo"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationVmwareTeamingAndFailover(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","NotifySwitches":true,"ClassId":"virtualization.VmwareTeamingAndFailover","ObjectType":"virtualization.VmwareTeamingAndFailover","Failback":true,"NetworkFailureDetection":"NetworkFailureDetection %d","LoadBalancing":"LoadBalancing %d"}`
	...
	expectedOp := map[string]interface{}{"name": "Name 1", "notify_switches": true, "class_id": "virtualization.VmwareTeamingAndFailover", "object_type": "virtualization.VmwareTeamingAndFailover", "failback": true, "network_failure_detection": "NetworkFailureDetection 1", "load_balancing": "LoadBalancing 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicEthInterruptSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Mode":"Mode %d","CoalescingTime":32,"CoalescingType":"CoalescingType %d","Count":32,"ClassId":"vnic.EthInterruptSettings","ObjectType":"vnic.EthInterruptSettings"}`
	...
	expectedOp := map[string]interface{}{"mode": "Mode 1", "coalescing_time": 32, "coalescing_type": "CoalescingType 1", "nr_count": 32, "class_id": "vnic.EthInterruptSettings", "object_type": "vnic.EthInterruptSettings"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicEthRxQueueSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"RingSize":32,"ClassId":"vnic.EthRxQueueSettings","ObjectType":"vnic.EthRxQueueSettings","Count":32}`
	...
	expectedOp := map[string]interface{}{"ring_size": 32, "class_id": "vnic.EthRxQueueSettings", "object_type": "vnic.EthRxQueueSettings", "nr_count": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicFcErrorRecoverySettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"IoRetryCount":32,"ClassId":"vnic.FcErrorRecoverySettings","ObjectType":"vnic.FcErrorRecoverySettings","IoRetryTimeout":32,"LinkDownTimeout":32,"PortDownTimeout":32,"Enabled":true}`
	...
	expectedOp := map[string]interface{}{"io_retry_count": 32, "class_id": "vnic.FcErrorRecoverySettings", "object_type": "vnic.FcErrorRecoverySettings", "io_retry_timeout": 32, "link_down_timeout": 32, "port_down_timeout": 32, "enabled": true}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicLun(t *testing.T) {
	p := models.VnicLun{}
	var d = &schema.ResourceData{}
	c := `{"ClassId":"vnic.Lun","ObjectType":"vnic.Lun","LunId":32,"Bootable":true}`
	...
	expectedOp := map[string]interface{}{"class_id": "vnic.Lun", "object_type": "vnic.Lun", "lun_id": 32, "bootable": true}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicPlacementSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Uplink":32,"Id":"Id %d","ClassId":"vnic.PlacementSettings","ObjectType":"vnic.PlacementSettings","PciLink":32,"SwitchId":"SwitchId %d"}`
	...
	expectedOp := map[string]interface{}{"uplink": 32, "id": "Id 1", "class_id": "vnic.PlacementSettings", "object_type": "vnic.PlacementSettings", "pci_link": 32, "switch_id": "SwitchId 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicRoceSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassOfService":32,"Enabled":true,"QueuePairs":32,"ResourceGroups":32,"ObjectType":"vnic.RoceSettings","ClassId":"vnic.RoceSettings","Version":32,"MemoryRegions":32}`
	...
	expectedOp := map[string]interface{}{"class_of_service": 32, "enabled": true, "queue_pairs": 32, "resource_groups": 32, "object_type": "vnic.RoceSettings", "class_id": "vnic.RoceSettings", "nr_version": 32, "memory_regions": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVnicRssHashSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"TcpIpv4Hash":true,"TcpIpv6ExtHash":true,"ObjectType":"vnic.RssHashSettings","Ipv4Hash":true,"Ipv6Hash":true,"UdpIpv6Hash":true,"ClassId":"vnic.RssHashSettings","TcpIpv6Hash":true,"Ipv6ExtHash":true,"UdpIpv4Hash":true}`
	...
	expectedOp := map[string]interface{}{"tcp_ipv4_hash": true, "tcp_ipv6_ext_hash": true, "object_type": "vnic.RssHashSettings", "ipv4_hash": true, "ipv6_hash": true, "udp_ipv6_hash": true, "class_id": "vnic.RssHashSettings", "tcp_ipv6_hash": true, "ipv6_ext_hash": true, "udp_ipv4_hash": true}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicTcpOffloadSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"LargeReceive":true,"LargeSend":true,"RxChecksum":true,"TxChecksum":true,"ClassId":"vnic.TcpOffloadSettings","ObjectType":"vnic.TcpOffloadSettings"}`
	...
	expectedOp := map[string]interface{}{"large_receive": true, "large_send": true, "rx_checksum": true, "tx_checksum": true, "class_id": "vnic.TcpOffloadSettings", "object_type": "vnic.TcpOffloadSettings"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicVmqSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"NumInterrupts":32,"NumSubVnics":32,"NumVmqs":32,"Enabled":true,"ClassId":"vnic.VmqSettings","ObjectType":"vnic.VmqSettings","MultiQueueSupport":true,"VmmqAdapterPolicy":"VmmqAdapterPolicy %d"}`
	...
	expectedOp := map[string]interface{}{"num_interrupts": 32, "num_sub_vnics": 32, "num_vmqs": 32, "enabled": true, "class_id": "vnic.VmqSettings", "object_type": "vnic.VmqSettings", "multi_queue_support": true, "vmmq_adapter_policy": "VmmqAdapterPolicy 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVnicVsanSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"DefaultVlanId":32,"ClassId":"vnic.VsanSettings","ObjectType":"vnic.VsanSettings","Id":32}`
	...
	expectedOp := map[string]interface{}{"default_vlan_id": 32, "class_id": "vnic.VsanSettings", "object_type": "vnic.VsanSettings", "id": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVnicVxlanSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"vnic.VxlanSettings","Enabled":true,"ObjectType":"vnic.VxlanSettings"}`
	...
	expectedOp := map[string]interface{}{"class_id": "vnic.VxlanSettings", "enabled": true, "object_type": "vnic.VxlanSettings"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapWorkflowProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Timeout":32,"ClassId":"workflow.Properties","RetryDelay":32,"RetryCount":32,"RetryPolicy":"RetryPolicy %d","SupportStatus":"SupportStatus %d","ObjectType":"workflow.Properties","ExternalMeta":true,"TimeoutPolicy":"TimeoutPolicy %d"}`
	...
	expectedOp := map[string]interface{}{"timeout": 32, "class_id": "workflow.Properties", "retry_delay": 32, "retry_count": 32, "retry_policy": "RetryPolicy 1", "support_status": "SupportStatus 1", "object_type": "workflow.Properties", "external_meta": true, "timeout_policy": "TimeoutPolicy 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapWorkflowWorkflowProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Cloneable":true,"EnableDebug":true,"ExternalMeta":true,"ClassId":"workflow.WorkflowProperties","ObjectType":"workflow.WorkflowProperties","Retryable":true,"SupportStatus":"SupportStatus %d"}`
	...
	expectedOp := map[string]interface{}{"cloneable": true, "enable_debug": true, "external_meta": true, "class_id": "workflow.WorkflowProperties", "object_type": "workflow.WorkflowProperties", "retryable": true, "support_status": "SupportStatus 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapX509Certificate(t *testing.T) {
	p := models.X509Certificate{}
	var d = &schema.ResourceData{}
	c := `{"PemCertificate":"PemCertificate %d","SignatureAlgorithm":"SignatureAlgorithm %d","ObjectType":"x509.Certificate","Sha256Fingerprint":"Sha256Fingerprint %d","ClassId":"x509.Certificate"}`
	...
	expectedOp := map[string]interface{}{"pem_certificate": "PemCertificate 1", "signature_algorithm": "SignatureAlgorithm 1", "object_type": "x509.Certificate", "sha256_fingerprint": "Sha256Fingerprint 1", "class_id": "x509.Certificate"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
