...
func TestFlattenListApplianceApiStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Response":32,"ElapsedTime":32.000000,"ObjectName":"ObjectName %d","Reason":"Reason %d","ClassId":"appliance.ApiStatus","ObjectType":"appliance.ApiStatus"}`
	...
	expectedOp := []map[string]interface{}{{"response": 32, "elapsed_time": 32.000000, "object_name": "ObjectName 1", "reason": "Reason 1", "class_id": "appliance.ApiStatus", "object_type": "appliance.ApiStatus"}, {"response": 32, "elapsed_time": 32.000000, "object_name": "ObjectName 2", "reason": "Reason 2", "class_id": "appliance.ApiStatus", "object_type": "appliance.ApiStatus"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListBulkHttpHeader(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"bulk.HttpHeader","Name":"Name %d","Value":"Value %d","ClassId":"bulk.HttpHeader"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "bulk.HttpHeader", "name": "Name 1", "value": "Value 1", "class_id": "bulk.HttpHeader"}, {"object_type": "bulk.HttpHeader", "name": "Name 2", "value": "Value 2", "class_id": "bulk.HttpHeader"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCapabilityPortRange(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"StartPortId":32,"StartSlotId":32,"EndPortId":32,"ObjectType":"capability.PortRange","ClassId":"capability.PortRange","EndSlotId":32}`
	...
	expectedOp := []map[string]interface{}{{"start_port_id": 32, "start_slot_id": 32, "end_port_id": 32, "object_type": "capability.PortRange", "class_id": "capability.PortRange", "end_slot_id": 32}, {"start_port_id": 32, "start_slot_id": 32, "end_port_id": 32, "object_type": "capability.PortRange", "class_id": "capability.PortRange", "end_slot_id": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudCustomAttributes(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"cloud.CustomAttributes","ObjectType":"cloud.CustomAttributes","AttributeValue":"AttributeValue %d","AttributeName":"AttributeName %d","AttributeType":"AttributeType %d"}`
...
func TestFlattenListCloudNetworkInterfaceAttachment(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"cloud.NetworkInterfaceAttachment","NetworkName":"NetworkName %d","SubNetworkName":"SubNetworkName %d","NicIndex":32,"ClassId":"cloud.NetworkInterfaceAttachment","NetworkId":"NetworkId %d","IpForwardingEnabled":true,"SubNetworkId":"SubNetworkId %d","Identity":"Identity %d","MacAddress":"MacAddress %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "cloud.NetworkInterfaceAttachment", "network_name": "NetworkName 1", "sub_network_name": "SubNetworkName 1", "nic_index": 32, "class_id": "cloud.NetworkInterfaceAttachment", "network_id": "NetworkId 1", "ip_forwarding_enabled": true, "sub_network_id": "SubNetworkId 1", "identity": "Identity 1", "mac_address": "MacAddress 1"}, {"object_type": "cloud.NetworkInterfaceAttachment", "network_name": "NetworkName 2", "sub_network_name": "SubNetworkName 2", "nic_index": 32, "class_id": "cloud.NetworkInterfaceAttachment", "network_id": "NetworkId 2", "ip_forwarding_enabled": true, "sub_network_id": "SubNetworkId 2", "identity": "Identity 2", "mac_address": "MacAddress 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudSecurityGroupRule(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"SourceSecurityGroup":"SourceSecurityGroup %d","Action":"Action %d","Index":32,"Name":"Name %d","EndPort":32,"Description":"Description %d","ObjectType":"cloud.SecurityGroupRule","StartPort":32,"EtherType":"EtherType %d","Protocol":"Protocol %d","Identity":"Identity %d","ClassId":"cloud.SecurityGroupRule"}`
	...
	expectedOp := []map[string]interface{}{{"source_security_group": "SourceSecurityGroup 1", "action": "Action 1", "index": 32, "name": "Name 1", "end_port": 32, "description": "Description 1", "object_type": "cloud.SecurityGroupRule", "start_port": 32, "ether_type": "EtherType 1", "protocol": "Protocol 1", "identity": "Identity 1", "class_id": "cloud.SecurityGroupRule"}, {"source_security_group": "SourceSecurityGroup 2", "action": "Action 2", "index": 32, "name": "Name 2", "end_port": 32, "description": "Description 2", "object_type": "cloud.SecurityGroupRule", "start_port": 32, "ether_type": "EtherType 2", "protocol": "Protocol 2", "identity": "Identity 2", "class_id": "cloud.SecurityGroupRule"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudTfcWorkspaceVariables(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Hcl":true,"Identity":"Identity %d","ClassId":"cloud.TfcWorkspaceVariables","Category":"Category %d","Key":"Key %d","Sensitive":true,"ObjectType":"cloud.TfcWorkspaceVariables","Value":"Value %d","Description":"Description %d"}`
	...
	expectedOp := []map[string]interface{}{{"hcl": true, "identity": "Identity 1", "class_id": "cloud.TfcWorkspaceVariables", "category": "Category 1", "key": "Key 1", "sensitive": true, "object_type": "cloud.TfcWorkspaceVariables", "value": "Value 1", "description": "Description 1"}, {"hcl": true, "identity": "Identity 2", "class_id": "cloud.TfcWorkspaceVariables", "category": "Category 2", "key": "Key 2", "sensitive": true, "object_type": "cloud.TfcWorkspaceVariables", "value": "Value 2", "description": "Description 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudVolumeAttachment(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Identity":"Identity %d","DeviceName":"DeviceName %d","Index":32,"AutoDelete":true,"ClassId":"cloud.VolumeAttachment","ObjectType":"cloud.VolumeAttachment","IsRoot":true}`
	...
	expectedOp := []map[string]interface{}{{"identity": "Identity 1", "device_name": "DeviceName 1", "index": 32, "auto_delete": true, "class_id": "cloud.VolumeAttachment", "object_type": "cloud.VolumeAttachment", "is_root": true}, {"identity": "Identity 2", "device_name": "DeviceName 2", "index": 32, "auto_delete": true, "class_id": "cloud.VolumeAttachment", "object_type": "cloud.VolumeAttachment", "is_root": true}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListCloudVolumeInstanceAttachment(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"InstanceId":"InstanceId %d","State":"State %d","ClassId":"cloud.VolumeInstanceAttachment","ObjectType":"cloud.VolumeInstanceAttachment","AutoDelete":true,"DeviceName":"DeviceName %d"}`
	...
	expectedOp := []map[string]interface{}{{"instance_id": "InstanceId 1", "state": "State 1", "class_id": "cloud.VolumeInstanceAttachment", "object_type": "cloud.VolumeInstanceAttachment", "auto_delete": true, "device_name": "DeviceName 1"}, {"instance_id": "InstanceId 2", "state": "State 2", "class_id": "cloud.VolumeInstanceAttachment", "object_type": "cloud.VolumeInstanceAttachment", "auto_delete": true, "device_name": "DeviceName 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListComputeIpAddress(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Dn":"Dn %d","KvmPort":32,"KvmVlan":32,"Name":"Name %d","DefaultGateway":"DefaultGateway %d","HttpsPort":32,"ClassId":"compute.IpAddress","Type":"Type %d","ObjectType":"compute.IpAddress","Address":"Address %d","HttpPort":32,"Subnet":"Subnet %d","Category":"Category %d"}`
	...
	expectedOp := []map[string]interface{}{{"dn": "Dn 1", "kvm_port": 32, "kvm_vlan": 32, "name": "Name 1", "default_gateway": "DefaultGateway 1", "https_port": 32, "class_id": "compute.IpAddress", "type": "Type 1", "object_type": "compute.IpAddress", "address": "Address 1", "http_port": 32, "subnet": "Subnet 1", "category": "Category 1"}, {"dn": "Dn 2", "kvm_port": 32, "kvm_vlan": 32, "name": "Name 2", "default_gateway": "DefaultGateway 2", "https_port": 32, "class_id": "compute.IpAddress", "type": "Type 2", "object_type": "compute.IpAddress", "address": "Address 2", "http_port": 32, "subnet": "Subnet 2", "category": "Category 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListContentParameter(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"content.Parameter","Path":"Path %d","ClassId":"content.Parameter","ComplexType":"ComplexType %d","Type":"Type %d","AcceptSingleValue":true,"Name":"Name %d","Secure":true,"ItemType":"ItemType %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "content.Parameter", "path": "Path 1", "class_id": "content.Parameter", "complex_type": "ComplexType 1", "type": "Type 1", "accept_single_value": true, "name": "Name 1", "secure": true, "item_type": "ItemType 1"}, {"object_type": "content.Parameter", "path": "Path 2", "class_id": "content.Parameter", "complex_type": "ComplexType 2", "type": "Type 2", "accept_single_value": true, "name": "Name 2", "secure": true, "item_type": "ItemType 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListEquipmentIoCardIdentity(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"equipment.IoCardIdentity","ObjectType":"equipment.IoCardIdentity","IoCardMoid":"IoCardMoid %d","ModuleId":32,"NetworkElementMoid":"NetworkElementMoid %d","SwitchId":32}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "equipment.IoCardIdentity", "object_type": "equipment.IoCardIdentity", "io_card_moid": "IoCardMoid 1", "module_id": 32, "network_element_moid": "NetworkElementMoid 1", "switch_id": 32}, {"class_id": "equipment.IoCardIdentity", "object_type": "equipment.IoCardIdentity", "io_card_moid": "IoCardMoid 2", "module_id": 32, "network_element_moid": "NetworkElementMoid 2", "switch_id": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListFabricQosClass(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Weight":32,"Cos":32,"MulticastOptimize":true,"AdminState":"AdminState %d","ObjectType":"fabric.QosClass","Mtu":32,"BandwidthPercent":32,"PacketDrop":true,"Name":"Name %d","ClassId":"fabric.QosClass"}`
	...
	expectedOp := []map[string]interface{}{{"weight": 32, "cos": 32, "multicast_optimize": true, "admin_state": "AdminState 1", "object_type": "fabric.QosClass", "mtu": 32, "bandwidth_percent": 32, "packet_drop": true, "name": "Name 1", "class_id": "fabric.QosClass"}, {"weight": 32, "cos": 32, "multicast_optimize": true, "admin_state": "AdminState 2", "object_type": "fabric.QosClass", "mtu": 32, "bandwidth_percent": 32, "packet_drop": true, "name": "Name 2", "class_id": "fabric.QosClass"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListFcpoolBlock(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"class_id": "fcpool.Block", "object_type": "fcpool.Block", "size": 32, "from": "From 1", "to": "To 1"}, {"class_id": "fcpool.Block", "object_type": "fcpool.Block", "size": 32, "from": "From 2", "to": "To 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListFirmwareBaseImpact(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ImpactType":"ImpactType %d","TargetFirmwareVersion":"TargetFirmwareVersion %d","ClassId":"firmware.BaseImpact","ObjectType":"firmware.BaseImpact","ComputationError":"ComputationError %d","FirmwareVersion":"FirmwareVersion %d","DomainName":"DomainName %d","EndPoint":"EndPoint %d","ComputationStatusDetail":"ComputationStatusDetail %d","Model":"Model %d","VersionImpact":"VersionImpact %d"}`
	...
	expectedOp := []map[string]interface{}{{"impact_type": "ImpactType 1", "target_firmware_version": "TargetFirmwareVersion 1", "class_id": "firmware.BaseImpact", "object_type": "firmware.BaseImpact", "computation_error": "ComputationError 1", "firmware_version": "FirmwareVersion 1", "domain_name": "DomainName 1", "end_point": "EndPoint 1", "computation_status_detail": "ComputationStatusDetail 1", "model": "Model 1", "version_impact": "VersionImpact 1"}, {"impact_type": "ImpactType 2", "target_firmware_version": "TargetFirmwareVersion 2", "class_id": "firmware.BaseImpact", "object_type": "firmware.BaseImpact", "computation_error": "ComputationError 2", "firmware_version": "FirmwareVersion 2", "domain_name": "DomainName 2", "end_point": "EndPoint 2", "computation_status_detail": "ComputationStatusDetail 2", "model": "Model 2", "version_impact": "VersionImpact 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListFirmwareComponentMeta(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"IsOobSupported":true,"ClassId":"firmware.ComponentMeta","ObjectType":"firmware.ComponentMeta","ComponentLabel":"ComponentLabel %d","Disruption":"Disruption %d","ComponentType":"ComponentType %d","Vendor":"Vendor %d","ImagePath":"ImagePath %d","Description":"Description %d","RedfishUrl":"RedfishUrl %d","PackedVersion":"PackedVersion %d","Model":"Model %d"}`
	...
	expectedOp := []map[string]interface{}{{"is_oob_supported": true, "class_id": "firmware.ComponentMeta", "object_type": "firmware.ComponentMeta", "component_label": "ComponentLabel 1", "disruption": "Disruption 1", "component_type": "ComponentType 1", "vendor": "Vendor 1", "image_path": "ImagePath 1", "description": "Description 1", "redfish_url": "RedfishUrl 1", "packed_version": "PackedVersion 1", "model": "Model 1"}, {"is_oob_supported": true, "class_id": "firmware.ComponentMeta", "object_type": "firmware.ComponentMeta", "component_label": "ComponentLabel 2", "disruption": "Disruption 2", "component_type": "ComponentType 2", "vendor": "Vendor 2", "image_path": "ImagePath 2", "description": "Description 2", "redfish_url": "RedfishUrl 2", "packed_version": "PackedVersion 2", "model": "Model 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListFirmwareFirmwareInventory(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Category":"Category %d","UpdateUri":"UpdateUri %d","Vendor":"Vendor %d","ClassId":"firmware.FirmwareInventory","ObjectType":"firmware.FirmwareInventory","Label":"Label %d","Model":"Model %d","Version":"Version %d"}`
	...
	expectedOp := []map[string]interface{}{{"category": "Category 1", "update_uri": "UpdateUri 1", "vendor": "Vendor 1", "class_id": "firmware.FirmwareInventory", "object_type": "firmware.FirmwareInventory", "label": "Label 1", "model": "Model 1", "nr_version": "Version 1"}, {"category": "Category 2", "update_uri": "UpdateUri 2", "vendor": "Vendor 2", "class_id": "firmware.FirmwareInventory", "object_type": "firmware.FirmwareInventory", "label": "Label 2", "model": "Model 2", "nr_version": "Version 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexFeatureLimitEntry(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","ClassId":"hyperflex.FeatureLimitEntry","ObjectType":"hyperflex.FeatureLimitEntry","Value":"Value %d"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "class_id": "hyperflex.FeatureLimitEntry", "object_type": "hyperflex.FeatureLimitEntry", "value": "Value 1"}, {"name": "Name 2", "class_id": "hyperflex.FeatureLimitEntry", "object_type": "hyperflex.FeatureLimitEntry", "value": "Value 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexHealthCheckScriptInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"hyperflex.HealthCheckScriptInfo","Version":"Version %d","AggregateScriptName":"AggregateScriptName %d","ScriptExecuteLocation":"ScriptExecuteLocation %d","ClassId":"hyperflex.HealthCheckScriptInfo","ScriptInput":"ScriptInput %d","ScriptName":"ScriptName %d","HyperflexVersion":"HyperflexVersion %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "hyperflex.HealthCheckScriptInfo", "nr_version": "Version 1", "aggregate_script_name": "AggregateScriptName 1", "script_execute_location": "ScriptExecuteLocation 1", "class_id": "hyperflex.HealthCheckScriptInfo", "script_input": "ScriptInput 1", "script_name": "ScriptName 1", "hyperflex_version": "HyperflexVersion 1"}, {"object_type": "hyperflex.HealthCheckScriptInfo", "nr_version": "Version 2", "aggregate_script_name": "AggregateScriptName 2", "script_execute_location": "ScriptExecuteLocation 2", "class_id": "hyperflex.HealthCheckScriptInfo", "script_input": "ScriptInput 2", "script_name": "ScriptName 2", "hyperflex_version": "HyperflexVersion 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexHxHostMountStatusDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"HostName":"HostName %d","Mounted":true,"Reason":"Reason %d","Accessibility":"Accessibility %d","ClassId":"hyperflex.HxHostMountStatusDt","ObjectType":"hyperflex.HxHostMountStatusDt"}`
	...
	expectedOp := []map[string]interface{}{{"host_name": "HostName 1", "mounted": true, "reason": "Reason 1", "accessibility": "Accessibility 1", "class_id": "hyperflex.HxHostMountStatusDt", "object_type": "hyperflex.HxHostMountStatusDt"}, {"host_name": "HostName 2", "mounted": true, "reason": "Reason 2", "accessibility": "Accessibility 2", "class_id": "hyperflex.HxHostMountStatusDt", "object_type": "hyperflex.HxHostMountStatusDt"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexIpAddrRange(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"gateway": "Gateway 1", "netmask": "Netmask 1", "start_addr": "StartAddr 1", "end_addr": "EndAddr 1", "class_id": "hyperflex.IpAddrRange", "object_type": "hyperflex.IpAddrRange"}, {"gateway": "Gateway 2", "netmask": "Netmask 2", "start_addr": "StartAddr 2", "end_addr": "EndAddr 2", "class_id": "hyperflex.IpAddrRange", "object_type": "hyperflex.IpAddrRange"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexNetworkPort(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"hyperflex.NetworkPort","ObjectType":"hyperflex.NetworkPort","Name":"Name %d","PortType":"PortType %d","Vlans":"Vlans %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "hyperflex.NetworkPort", "object_type": "hyperflex.NetworkPort", "name": "Name 1", "port_type": "PortType 1", "vlans": "Vlans 1"}, {"class_id": "hyperflex.NetworkPort", "object_type": "hyperflex.NetworkPort", "name": "Name 2", "port_type": "PortType 2", "vlans": "Vlans 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexServerModelEntry(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","ClassId":"hyperflex.ServerModelEntry","ObjectType":"hyperflex.ServerModelEntry","Value":"Value %d"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "class_id": "hyperflex.ServerModelEntry", "object_type": "hyperflex.ServerModelEntry", "value": "Value 1"}, {"name": "Name 2", "class_id": "hyperflex.ServerModelEntry", "object_type": "hyperflex.ServerModelEntry", "value": "Value 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListHyperflexVmDisk(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"BootOrder":32,"VirtualDiskReference":"VirtualDiskReference %d","Bus":"Bus %d","Name":"Name %d","Type":"Type %d","ClassId":"hyperflex.VmDisk","ObjectType":"hyperflex.VmDisk"}`
	...
	expectedOp := []map[string]interface{}{{"boot_order": 32, "virtual_disk_reference": "VirtualDiskReference 1", "bus": "Bus 1", "name": "Name 1", "type": "Type 1", "class_id": "hyperflex.VmDisk", "object_type": "hyperflex.VmDisk"}, {"boot_order": 32, "virtual_disk_reference": "VirtualDiskReference 2", "bus": "Bus 2", "name": "Name 2", "type": "Type 2", "class_id": "hyperflex.VmDisk", "object_type": "hyperflex.VmDisk"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListIaasLicenseKeysInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ExpirationDate":"ExpirationDate %d","LicenseId":"LicenseId %d","Pid":"Pid %d","ClassId":"iaas.LicenseKeysInfo","ObjectType":"iaas.LicenseKeysInfo","Count":32}`
	...
	expectedOp := []map[string]interface{}{{"expiration_date": "ExpirationDate 1", "license_id": "LicenseId 1", "pid": "Pid 1", "class_id": "iaas.LicenseKeysInfo", "object_type": "iaas.LicenseKeysInfo", "nr_count": 32}, {"expiration_date": "ExpirationDate 2", "license_id": "LicenseId 2", "pid": "Pid 2", "class_id": "iaas.LicenseKeysInfo", "object_type": "iaas.LicenseKeysInfo", "nr_count": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListIaasWorkflowSteps(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","Status":"Status %d","StatusMessage":"StatusMessage %d","ObjectType":"iaas.WorkflowSteps","ClassId":"iaas.WorkflowSteps","CompletedTime":"CompletedTime %d"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "status": "Status 1", "status_message": "StatusMessage 1", "object_type": "iaas.WorkflowSteps", "class_id": "iaas.WorkflowSteps", "completed_time": "CompletedTime 1"}, {"name": "Name 2", "status": "Status 2", "status_message": "StatusMessage 2", "object_type": "iaas.WorkflowSteps", "class_id": "iaas.WorkflowSteps", "completed_time": "CompletedTime 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListIamAccountPermissions(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"AccountIdentifier":"AccountIdentifier %d","ClassId":"iam.AccountPermissions","ObjectType":"iam.AccountPermissions","AccountName":"AccountName %d","AccountStatus":"AccountStatus %d"}`
	...
	expectedOp := []map[string]interface{}{{"account_identifier": "AccountIdentifier 1", "class_id": "iam.AccountPermissions", "object_type": "iam.AccountPermissions", "account_name": "AccountName 1", "account_status": "AccountStatus 1"}, {"account_identifier": "AccountIdentifier 2", "class_id": "iam.AccountPermissions", "object_type": "iam.AccountPermissions", "account_name": "AccountName 2", "account_status": "AccountStatus 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListIqnpoolIqnSuffixBlock(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"To":32,"ClassId":"iqnpool.IqnSuffixBlock","ObjectType":"iqnpool.IqnSuffixBlock","Size":32,"From":32,"Suffix":"Suffix %d"}`
	...
	expectedOp := []map[string]interface{}{{"to": 32, "class_id": "iqnpool.IqnSuffixBlock", "object_type": "iqnpool.IqnSuffixBlock", "size": 32, "from": 32, "suffix": "Suffix 1"}, {"to": 32, "class_id": "iqnpool.IqnSuffixBlock", "object_type": "iqnpool.IqnSuffixBlock", "size": 32, "from": 32, "suffix": "Suffix 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListKubernetesTaint(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Key":"Key %d","Value":"Value %d","ClassId":"kubernetes.Taint","ObjectType":"kubernetes.Taint","Effect":"Effect %d"}`
	...
	expectedOp := []map[string]interface{}{{"key": "Key 1", "value": "Value 1", "class_id": "kubernetes.Taint", "object_type": "kubernetes.Taint", "effect": "Effect 1"}, {"key": "Key 2", "value": "Value 2", "class_id": "kubernetes.Taint", "object_type": "kubernetes.Taint", "effect": "Effect 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListMacpoolBlock(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"class_id": "macpool.Block", "object_type": "macpool.Block", "size": 32, "to": "To 1", "from": "From 1"}, {"class_id": "macpool.Block", "object_type": "macpool.Block", "size": 32, "to": "To 2", "from": "From 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListMetaPropDefinition(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ApiAccess":"ApiAccess %d","Name":"Name %d","ObjectType":"meta.PropDefinition","IsCollection":true,"Type":"Type %d","Kind":"Kind %d","ClassId":"meta.PropDefinition","IsComplexType":true,"OpSecurity":"OpSecurity %d","SearchWeight":32.000000}`
	...
	expectedOp := []map[string]interface{}{{"api_access": "ApiAccess 1", "name": "Name 1", "object_type": "meta.PropDefinition", "is_collection": true, "type": "Type 1", "kind": "Kind 1", "class_id": "meta.PropDefinition", "is_complex_type": true, "op_security": "OpSecurity 1", "search_weight": 32.000000}, {"api_access": "ApiAccess 2", "name": "Name 2", "object_type": "meta.PropDefinition", "is_collection": true, "type": "Type 2", "kind": "Kind 2", "class_id": "meta.PropDefinition", "is_complex_type": true, "op_security": "OpSecurity 2", "search_weight": 32.000000}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListMetaRelationshipDefinition(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"meta.RelationshipDefinition","Name":"Name %d","PeerSync":true,"Type":"Type %d","Collection":true,"Export":true,"ExportWithPeer":true,"ApiAccess":"ApiAccess %d","ObjectType":"meta.RelationshipDefinition","PeerRelName":"PeerRelName %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "meta.RelationshipDefinition", "name": "Name 1", "peer_sync": true, "type": "Type 1", "collection": true, "export": true, "export_with_peer": true, "api_access": "ApiAccess 1", "object_type": "meta.RelationshipDefinition", "peer_rel_name": "PeerRelName 1"}, {"class_id": "meta.RelationshipDefinition", "name": "Name 2", "peer_sync": true, "type": "Type 2", "collection": true, "export": true, "export_with_peer": true, "api_access": "ApiAccess 2", "object_type": "meta.RelationshipDefinition", "peer_rel_name": "PeerRelName 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListNiaapiDetail(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"niaapi.Detail","ClassId":"niaapi.Detail","Name":"Name %d","Chksum":"Chksum %d","Filename":"Filename %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "niaapi.Detail", "class_id": "niaapi.Detail", "name": "Name 1", "chksum": "Chksum 1", "filename": "Filename 1"}, {"object_type": "niaapi.Detail", "class_id": "niaapi.Detail", "name": "Name 2", "chksum": "Chksum 2", "filename": "Filename 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListNiaapiRevisionInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"RevisionNo":"RevisionNo %d","ObjectType":"niaapi.RevisionInfo","ClassId":"niaapi.RevisionInfo","RevisionComment":"RevisionComment %d"}`
	...
	expectedOp := []map[string]interface{}{{"revision_no": "RevisionNo 1", "object_type": "niaapi.RevisionInfo", "class_id": "niaapi.RevisionInfo", "revision_comment": "RevisionComment 1"}, {"revision_no": "RevisionNo 2", "object_type": "niaapi.RevisionInfo", "class_id": "niaapi.RevisionInfo", "revision_comment": "RevisionComment 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListNiatelemetryLogicalLink(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"LinkAddr2":"LinkAddr2 %d","LinkType":"LinkType %d","Uptime":"Uptime %d","LinkState":"LinkState %d","IsPresent":true,"ClassId":"niatelemetry.LogicalLink","ObjectType":"niatelemetry.LogicalLink","LinkAddr1":"LinkAddr1 %d","DbId":32}`
	...
	expectedOp := []map[string]interface{}{{"link_addr2": "LinkAddr2 1", "link_type": "LinkType 1", "uptime": "Uptime 1", "link_state": "LinkState 1", "is_present": true, "class_id": "niatelemetry.LogicalLink", "object_type": "niatelemetry.LogicalLink", "link_addr1": "LinkAddr1 1", "db_id": 32}, {"link_addr2": "LinkAddr2 2", "link_type": "LinkType 2", "uptime": "Uptime 2", "link_state": "LinkState 2", "is_present": true, "class_id": "niatelemetry.LogicalLink", "object_type": "niatelemetry.LogicalLink", "link_addr1": "LinkAddr1 2", "db_id": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListOnpremImagePackage(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","Version":"Version %d","FileSize":32,"ObjectType":"onprem.ImagePackage","Filename":"Filename %d","PackageType":"PackageType %d","ClassId":"onprem.ImagePackage","FileSha":"FileSha %d","FilePath":"FilePath %d"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "nr_version": "Version 1", "file_size": 32, "object_type": "onprem.ImagePackage", "filename": "Filename 1", "package_type": "PackageType 1", "class_id": "onprem.ImagePackage", "file_sha": "FileSha 1", "file_path": "FilePath 1"}, {"name": "Name 2", "nr_version": "Version 2", "file_size": 32, "object_type": "onprem.ImagePackage", "filename": "Filename 2", "package_type": "PackageType 2", "class_id": "onprem.ImagePackage", "file_sha": "FileSha 2", "file_path": "FilePath 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListOnpremUpgradePhase(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","Failed":true,"Message":"Message %d","ElapsedTime":32,"ClassId":"onprem.UpgradePhase","ObjectType":"onprem.UpgradePhase"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "failed": true, "message": "Message 1", "elapsed_time": 32, "class_id": "onprem.UpgradePhase", "object_type": "onprem.UpgradePhase"}, {"name": "Name 2", "failed": true, "message": "Message 2", "elapsed_time": 32, "class_id": "onprem.UpgradePhase", "object_type": "onprem.UpgradePhase"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListOsServerConfig(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"os.ServerConfig","SerialNumber":"SerialNumber %d","ObjectType":"os.ServerConfig","InstallTarget":"InstallTarget %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "os.ServerConfig", "serial_number": "SerialNumber 1", "object_type": "os.ServerConfig", "install_target": "InstallTarget 1"}, {"class_id": "os.ServerConfig", "serial_number": "SerialNumber 2", "object_type": "os.ServerConfig", "install_target": "InstallTarget 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListSdwanNetworkConfigurationType(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"NetworkType":"NetworkType %d","PortGroup":"PortGroup %d","ClassId":"sdwan.NetworkConfigurationType","ObjectType":"sdwan.NetworkConfigurationType","Vlan":32}`
...
func TestFlattenListSdwanTemplateInputsType(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Type":"Type %d","Value":"Value %d","Editable":true,"Template":"Template %d","Required":true,"ClassId":"sdwan.TemplateInputsType","ObjectType":"sdwan.TemplateInputsType","Key":"Key %d","Title":"Title %d"}`
	...
	expectedOp := []map[string]interface{}{{"type": "Type 1", "value": "Value 1", "editable": true, "template": "Template 1", "required": true, "class_id": "sdwan.TemplateInputsType", "object_type": "sdwan.TemplateInputsType", "key": "Key 1", "title": "Title 1"}, {"type": "Type 2", "value": "Value 2", "editable": true, "template": "Template 2", "required": true, "class_id": "sdwan.TemplateInputsType", "object_type": "sdwan.TemplateInputsType", "key": "Key 2", "title": "Title 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListSnmpTrap(t *testing.T) {
	p := []models.SnmpTrap{}
	var d = &schema.ResourceData{}
	c := `{"Community":"Community %d","ClassId":"snmp.Trap","ObjectType":"snmp.Trap","Destination":"Destination %d","Enabled":true,"Port":32,"Version":"Version %d","Type":"Type %d","User":"User %d"}`
	...
	expectedOp := []map[string]interface{}{{"community": "Community 1", "class_id": "snmp.Trap", "object_type": "snmp.Trap", "destination": "Destination 1", "enabled": true, "port": 32, "nr_version": "Version 1", "type": "Type 1", "user": "User 1"}, {"community": "Community 2", "class_id": "snmp.Trap", "object_type": "snmp.Trap", "destination": "Destination 2", "enabled": true, "port": 32, "nr_version": "Version 2", "type": "Type 2", "user": "User 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListSnmpUser(t *testing.T) {
	p := []models.SnmpUser{}
	var d = &schema.ResourceData{}
	c := `{"SecurityLevel":"SecurityLevel %d","AuthType":"AuthType %d","PrivacyType":"PrivacyType %d","Name":"Name %d","IsPrivacyPasswordSet":true,"ClassId":"snmp.User","ObjectType":"snmp.User","IsAuthPasswordSet":true}`
	...
	expectedOp := []map[string]interface{}{{"security_level": "SecurityLevel 1", "auth_type": "AuthType 1", "privacy_type": "PrivacyType 1", "name": "Name 1", "is_privacy_password_set": true, "class_id": "snmp.User", "object_type": "snmp.User", "is_auth_password_set": true}, {"security_level": "SecurityLevel 2", "auth_type": "AuthType 2", "privacy_type": "PrivacyType 2", "name": "Name 2", "is_privacy_password_set": true, "class_id": "snmp.User", "object_type": "snmp.User", "is_auth_password_set": true}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListStorageBaseInitiator(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"storage.BaseInitiator","ClassId":"storage.BaseInitiator","Iqn":"Iqn %d","Name":"Name %d","Type":"Type %d","Wwn":"Wwn %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "storage.BaseInitiator", "class_id": "storage.BaseInitiator", "iqn": "Iqn 1", "name": "Name 1", "type": "Type 1", "wwn": "Wwn 1"}, {"object_type": "storage.BaseInitiator", "class_id": "storage.BaseInitiator", "iqn": "Iqn 2", "name": "Name 2", "type": "Type 2", "wwn": "Wwn 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListStorageNetAppExportPolicyRule(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"storage.NetAppExportPolicyRule","User":"User %d","ObjectType":"storage.NetAppExportPolicyRule","Index":32}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "storage.NetAppExportPolicyRule", "user": "User 1", "object_type": "storage.NetAppExportPolicyRule", "index": 32}, {"class_id": "storage.NetAppExportPolicyRule", "user": "User 2", "object_type": "storage.NetAppExportPolicyRule", "index": 32}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListStorageStorageContainerHostMountStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"storage.StorageContainerHostMountStatus","Accessibility":"Accessibility %d","HostName":"HostName %d","Mounted":true,"Reason":"Reason %d","ClassId":"storage.StorageContainerHostMountStatus"}`
...
func TestFlattenListSyslogRemoteClientBase(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"MinSeverity":"MinSeverity %d","ClassId":"syslog.RemoteClientBase","ObjectType":"syslog.RemoteClientBase","Port":32,"Protocol":"Protocol %d","Enabled":true,"Hostname":"Hostname %d"}`
...
func TestFlattenListTamAction(t *testing.T) {
	p := []models.TamAction{}
	var d = &schema.ResourceData{}
	c := `{"ClassId":"tam.Action","AffectedObjectType":"AffectedObjectType %d","Type":"Type %d","Name":"Name %d","ObjectType":"tam.Action","OperationType":"OperationType %d","AlertType":"AlertType %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "tam.Action", "affected_object_type": "AffectedObjectType 1", "type": "Type 1", "name": "Name 1", "object_type": "tam.Action", "operation_type": "OperationType 1", "alert_type": "AlertType 1"}, {"class_id": "tam.Action", "affected_object_type": "AffectedObjectType 2", "type": "Type 2", "name": "Name 2", "object_type": "tam.Action", "operation_type": "OperationType 2", "alert_type": "AlertType 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListTamS3DataSource(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","S3Path":"S3Path %d","ClassId":"tam.S3DataSource","ObjectType":"tam.S3DataSource","Type":"Type %d"}`
	...
	expectedOp := []map[string]interface{}{{"name": "Name 1", "s3_path": "S3Path 1", "class_id": "tam.S3DataSource", "object_type": "tam.S3DataSource", "type": "Type 1"}, {"name": "Name 2", "s3_path": "S3Path 2", "class_id": "tam.S3DataSource", "object_type": "tam.S3DataSource", "type": "Type 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListTerraformCloudResource(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"DesiredStatus":"DesiredStatus %d","ResourceId":"ResourceId %d","CurrentStatus":"CurrentStatus %d","ClassId":"terraform.CloudResource","ObjectType":"terraform.CloudResource"}`
	...
	expectedOp := []map[string]interface{}{{"desired_status": "DesiredStatus 1", "resource_id": "ResourceId 1", "current_status": "CurrentStatus 1", "class_id": "terraform.CloudResource", "object_type": "terraform.CloudResource"}, {"desired_status": "DesiredStatus 2", "resource_id": "ResourceId 2", "current_status": "CurrentStatus 2", "class_id": "terraform.CloudResource", "object_type": "terraform.CloudResource"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListUcsdConnectorPack(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"ucsd.ConnectorPack","Name":"Name %d","ConnectorFeature":"ConnectorFeature %d","Version":"Version %d","DownloadedVersion":"DownloadedVersion %d","ClassId":"ucsd.ConnectorPack","State":"State %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "ucsd.ConnectorPack", "name": "Name 1", "connector_feature": "ConnectorFeature 1", "nr_version": "Version 1", "downloaded_version": "DownloadedVersion 1", "class_id": "ucsd.ConnectorPack", "state": "State 1"}, {"object_type": "ucsd.ConnectorPack", "name": "Name 2", "connector_feature": "ConnectorFeature 2", "nr_version": "Version 2", "downloaded_version": "DownloadedVersion 2", "class_id": "ucsd.ConnectorPack", "state": "State 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListUuidpoolUuidBlock(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"size": 32, "class_id": "uuidpool.UuidBlock", "object_type": "uuidpool.UuidBlock", "from": "From 1", "to": "To 1"}, {"size": 32, "class_id": "uuidpool.UuidBlock", "object_type": "uuidpool.UuidBlock", "from": "From 2", "to": "To 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListVirtualizationNetworkInterface(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"virtualization.NetworkInterface","ConnectAtPowerOn":true,"DirectPathIo":true,"ClassId":"virtualization.NetworkInterface","MacAddress":"MacAddress %d","Name":"Name %d","AdaptorType":"AdaptorType %d","Bridge":"Bridge %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "virtualization.NetworkInterface", "connect_at_power_on": true, "direct_path_io": true, "class_id": "virtualization.NetworkInterface", "mac_address": "MacAddress 1", "name": "Name 1", "adaptor_type": "AdaptorType 1", "bridge": "Bridge 1"}, {"object_type": "virtualization.NetworkInterface", "connect_at_power_on": true, "direct_path_io": true, "class_id": "virtualization.NetworkInterface", "mac_address": "MacAddress 2", "name": "Name 2", "adaptor_type": "AdaptorType 2", "bridge": "Bridge 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListVirtualizationVirtualMachineDisk(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Type":"Type %d","ObjectType":"virtualization.VirtualMachineDisk","Name":"Name %d","Order":32,"ClassId":"virtualization.VirtualMachineDisk","VirtualDiskReference":"VirtualDiskReference %d","Bus":"Bus %d"}`
	...
	expectedOp := []map[string]interface{}{{"type": "Type 1", "object_type": "virtualization.VirtualMachineDisk", "name": "Name 1", "order": 32, "class_id": "virtualization.VirtualMachineDisk", "virtual_disk_reference": "VirtualDiskReference 1", "bus": "Bus 1"}, {"type": "Type 2", "object_type": "virtualization.VirtualMachineDisk", "name": "Name 2", "order": 32, "class_id": "virtualization.VirtualMachineDisk", "virtual_disk_reference": "VirtualDiskReference 2", "bus": "Bus 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListVmediaMapping(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"RemoteFile":"RemoteFile %d","AuthenticationProtocol":"AuthenticationProtocol %d","IsPasswordSet":true,"ClassId":"vmedia.Mapping","RemotePath":"RemotePath %d","Username":"Username %d","HostName":"HostName %d","MountOptions":"MountOptions %d","MountProtocol":"MountProtocol %d","DeviceType":"DeviceType %d","ObjectType":"vmedia.Mapping","FileLocation":"FileLocation %d","SanitizedFileLocation":"SanitizedFileLocation %d","VolumeName":"VolumeName %d"}`
	...
	expectedOp := []map[string]interface{}{{"remote_file": "RemoteFile 1", "authentication_protocol": "AuthenticationProtocol 1", "is_password_set": true, "class_id": "vmedia.Mapping", "remote_path": "RemotePath 1", "username": "Username 1", "host_name": "HostName 1", "mount_options": "MountOptions 1", "mount_protocol": "MountProtocol 1", "device_type": "DeviceType 1", "object_type": "vmedia.Mapping", "file_location": "FileLocation 1", "sanitized_file_location": "SanitizedFileLocation 1", "volume_name": "VolumeName 1"}, {"remote_file": "RemoteFile 2", "authentication_protocol": "AuthenticationProtocol 2", "is_password_set": true, "class_id": "vmedia.Mapping", "remote_path": "RemotePath 2", "username": "Username 2", "host_name": "HostName 2", "mount_options": "MountOptions 2", "mount_protocol": "MountProtocol 2", "device_type": "DeviceType 2", "object_type": "vmedia.Mapping", "file_location": "FileLocation 2", "sanitized_file_location": "SanitizedFileLocation 2", "volume_name": "VolumeName 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowApi(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"workflow.Api","SkipOnCondition":"SkipOnCondition %d","Name":"Name %d","Timeout":32,"ClassId":"workflow.Api","ErrorContentType":"ErrorContentType %d","Body":"Body %d","StartDelay":32,"ContentType":"ContentType %d","Description":"Description %d","AssetTargetMoid":"AssetTargetMoid %d","Label":"Label %d"}`
	...
	expectedOp := []map[string]interface{}{{"object_type": "workflow.Api", "skip_on_condition": "SkipOnCondition 1", "name": "Name 1", "timeout": 32, "class_id": "workflow.Api", "error_content_type": "ErrorContentType 1", "body": "Body 1", "start_delay": 32, "content_type": "ContentType 1", "description": "Description 1", "asset_target_moid": "AssetTargetMoid 1", "label": "Label 1"}, {"object_type": "workflow.Api", "skip_on_condition": "SkipOnCondition 2", "name": "Name 2", "timeout": 32, "class_id": "workflow.Api", "error_content_type": "ErrorContentType 2", "body": "Body 2", "start_delay": 32, "content_type": "ContentType 2", "description": "Description 2", "asset_target_moid": "AssetTargetMoid 2", "label": "Label 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowBaseDataType(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"workflow.BaseDataType","Required":true,"Label":"Label %d","Description":"Description %d","Name":"Name %d","ObjectType":"workflow.BaseDataType"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "workflow.BaseDataType", "required": true, "label": "Label 1", "description": "Description 1", "name": "Name 1", "object_type": "workflow.BaseDataType"}, {"class_id": "workflow.BaseDataType", "required": true, "label": "Label 2", "description": "Description 2", "name": "Name 2", "object_type": "workflow.BaseDataType"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowParameterSet(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"workflow.ParameterSet","ObjectType":"workflow.ParameterSet","ControlParameter":"ControlParameter %d","Name":"Name %d","Value":"Value %d","Condition":"Condition %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "workflow.ParameterSet", "object_type": "workflow.ParameterSet", "control_parameter": "ControlParameter 1", "name": "Name 1", "value": "Value 1", "condition": "Condition 1"}, {"class_id": "workflow.ParameterSet", "object_type": "workflow.ParameterSet", "control_parameter": "ControlParameter 2", "name": "Name 2", "value": "Value 2", "condition": "Condition 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowRollbackTask(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"workflow.RollbackTask","ObjectType":"workflow.RollbackTask","TaskMoid":"TaskMoid %d","Version":32,"CatalogMoid":"CatalogMoid %d","Name":"Name %d","Description":"Description %d","SkipCondition":"SkipCondition %d"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "workflow.RollbackTask", "object_type": "workflow.RollbackTask", "task_moid": "TaskMoid 1", "nr_version": 32, "catalog_moid": "CatalogMoid 1", "name": "Name 1", "description": "Description 1", "skip_condition": "SkipCondition 1"}, {"class_id": "workflow.RollbackTask", "object_type": "workflow.RollbackTask", "task_moid": "TaskMoid 2", "nr_version": 32, "catalog_moid": "CatalogMoid 2", "name": "Name 2", "description": "Description 2", "skip_condition": "SkipCondition 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowRollbackWorkflowTask(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"workflow.RollbackWorkflowTask","TaskPath":"TaskPath %d","Name":"Name %d","RefName":"RefName %d","TaskInfoMoid":"TaskInfoMoid %d","RollbackCompleted":true,"RollbackTaskName":"RollbackTaskName %d","Status":"Status %d","Description":"Description %d","ObjectType":"workflow.RollbackWorkflowTask"}`
	...
	expectedOp := []map[string]interface{}{{"class_id": "workflow.RollbackWorkflowTask", "task_path": "TaskPath 1", "name": "Name 1", "ref_name": "RefName 1", "task_info_moid": "TaskInfoMoid 1", "rollback_completed": true, "rollback_task_name": "RollbackTaskName 1", "status": "Status 1", "description": "Description 1", "object_type": "workflow.RollbackWorkflowTask"}, {"class_id": "workflow.RollbackWorkflowTask", "task_path": "TaskPath 2", "name": "Name 2", "ref_name": "RefName 2", "task_info_moid": "TaskInfoMoid 2", "rollback_completed": true, "rollback_task_name": "RollbackTaskName 2", "status": "Status 2", "description": "Description 2", "object_type": "workflow.RollbackWorkflowTask"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListWorkflowWorkflowTask(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Label":"Label %d","Name":"Name %d","ClassId":"workflow.WorkflowTask","ObjectType":"workflow.WorkflowTask","Description":"Description %d"}`
	...
	expectedOp := []map[string]interface{}{{"label": "Label 1", "name": "Name 1", "class_id": "workflow.WorkflowTask", "object_type": "workflow.WorkflowTask", "description": "Description 1"}, {"label": "Label 2", "name": "Name 2", "class_id": "workflow.WorkflowTask", "object_type": "workflow.WorkflowTask", "description": "Description 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenListX509Certificate(t *testing.T) {
	...
	expectedOp := []map[string]interface{}{{"class_id": "x509.Certificate", "object_type": "x509.Certificate", "signature_algorithm": "SignatureAlgorithm 1", "pem_certificate": "PemCertificate 1", "sha256_fingerprint": "Sha256Fingerprint 1"}, {"class_id": "x509.Certificate", "object_type": "x509.Certificate", "signature_algorithm": "SignatureAlgorithm 2", "pem_certificate": "PemCertificate 2", "sha256_fingerprint": "Sha256Fingerprint 2"}}
	for i := 0; i < len(expectedOp); i++ {
		err := compareMaps(expectedOp[i], ffOp[i], t)
		CheckError(t, err)
	}
...
func TestFlattenMapAssetDeploymentDeviceInformation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"MlbProductName":"MlbProductName %d","OldDeviceStatusDescription":"OldDeviceStatusDescription %d","MlbProductId":32,"Description":"Description %d","OldDeviceStatusId":32,"ClassId":"asset.DeploymentDeviceInformation","ItemType":"ItemType %d","OldDeviceId":"OldDeviceId %d","ApplicationName":"ApplicationName %d","OldInstanceId":"OldInstanceId %d","ObjectType":"asset.DeploymentDeviceInformation","InstanceId":"InstanceId %d"}`
	...
	expectedOp := map[string]interface{}{"mlb_product_name": "MlbProductName 1", "old_device_status_description": "OldDeviceStatusDescription 1", "mlb_product_id": 32, "description": "Description 1", "old_device_status_id": 32, "class_id": "asset.DeploymentDeviceInformation", "item_type": "ItemType 1", "old_device_id": "OldDeviceId 1", "application_name": "ApplicationName 1", "old_instance_id": "OldInstanceId 1", "object_type": "asset.DeploymentDeviceInformation", "instance_id": "InstanceId 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapAssetDeviceInformation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"OldDeviceStatusDescription":"OldDeviceStatusDescription %d","InstanceId":"InstanceId %d","OldDeviceId":"OldDeviceId %d","ProductType":"ProductType %d","ObjectType":"asset.DeviceInformation","ItemType":"ItemType %d","ProductFamily":"ProductFamily %d","UnitOfMeasure":"UnitOfMeasure %d","MlbProductName":"MlbProductName %d","ApplicationName":"ApplicationName %d","OldDeviceStatusId":32,"ClassId":"asset.DeviceInformation","MlbOfferType":"MlbOfferType %d","OldInstanceId":"OldInstanceId %d","MlbProductId":32}`
	...
	expectedOp := map[string]interface{}{"old_device_status_description": "OldDeviceStatusDescription 1", "instance_id": "InstanceId 1", "old_device_id": "OldDeviceId 1", "product_type": "ProductType 1", "object_type": "asset.DeviceInformation", "item_type": "ItemType 1", "product_family": "ProductFamily 1", "unit_of_measure": "UnitOfMeasure 1", "mlb_product_name": "MlbProductName 1", "application_name": "ApplicationName 1", "old_device_status_id": 32, "class_id": "asset.DeviceInformation", "mlb_offer_type": "MlbOfferType 1", "old_instance_id": "OldInstanceId 1", "mlb_product_id": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapAssetGlobalUltimate(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Name":"Name %d","ClassId":"asset.GlobalUltimate","ObjectType":"asset.GlobalUltimate","Id":"Id %d"}`
	...
	expectedOp := map[string]interface{}{"name": "Name 1", "class_id": "asset.GlobalUltimate", "object_type": "asset.GlobalUltimate", "id": "Id 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapAssetProductInformation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"asset.ProductInformation","Description":"Description %d","SubType":"SubType %d","Family":"Family %d","Group":"Group %d","ObjectType":"asset.ProductInformation","Number":"Number %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "asset.ProductInformation", "description": "Description 1", "sub_type": "SubType 1", "family": "Family 1", "group": "Group 1", "object_type": "asset.ProductInformation", "number": "Number 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapCapabilitySwitchNetworkLimits(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"capability.SwitchNetworkLimits","MaximumEthernetUplinkPorts":32,"MaximumEthernetPortChannels":32,"MaximumPortChannelMembers":32,"MaximumPrimaryVlan":32,"MaximumActiveTrafficMonitoringSessions":32,"MaximumFcPortChannels":32,"MaxUncompressedPortVlanCount":32,"MaximumIgmpGroups":32,"MaximumSecondaryVlanPerPrimary":32,"MaximumVlans":32,"MaximumVifs":32,"ObjectType":"capability.SwitchNetworkLimits","MinimumActiveFans":32,"MaxCompressedPortVlanCount":32,"MaximumFcPortChannelMembers":32,"MaximumSecondaryVlan":32}`
	...
	expectedOp := map[string]interface{}{"class_id": "capability.SwitchNetworkLimits", "maximum_ethernet_uplink_ports": 32, "maximum_ethernet_port_channels": 32, "maximum_port_channel_members": 32, "maximum_primary_vlan": 32, "maximum_active_traffic_monitoring_sessions": 32, "maximum_fc_port_channels": 32, "max_uncompressed_port_vlan_count": 32, "maximum_igmp_groups": 32, "maximum_secondary_vlan_per_primary": 32, "maximum_vlans": 32, "maximum_vifs": 32, "object_type": "capability.SwitchNetworkLimits", "minimum_active_fans": 32, "max_compressed_port_vlan_count": 32, "maximum_fc_port_channel_members": 32, "maximum_secondary_vlan": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapCapabilitySwitchStorageLimits(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"MaximumVsans":32,"MaximumZoneCount":32,"MaximumUserZoneCount":32,"MaximumVirtualFcInterfaces":32,"ClassId":"capability.SwitchStorageLimits","ObjectType":"capability.SwitchStorageLimits","MaximumVirtualFcInterfacesPerBladeServer":32}`
	...
	expectedOp := map[string]interface{}{"maximum_vsans": 32, "maximum_zone_count": 32, "maximum_user_zone_count": 32, "maximum_virtual_fc_interfaces": 32, "class_id": "capability.SwitchStorageLimits", "object_type": "capability.SwitchStorageLimits", "maximum_virtual_fc_interfaces_per_blade_server": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapCloudAvailabilityZone(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"cloud.AvailabilityZone","Name":"Name %d","ZoneId":"ZoneId %d","ClassId":"cloud.AvailabilityZone"}`
	...
	expectedOp := map[string]interface{}{"object_type": "cloud.AvailabilityZone", "name": "Name 1", "zone_id": "ZoneId 1", "class_id": "cloud.AvailabilityZone"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapCloudInstanceType(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"cloud.InstanceType","Cpus":32,"Architecture":"Architecture %d","CpuSpeed":32,"Platform":"Platform %d","Memory":32,"ObjectType":"cloud.InstanceType","InstanceTypeId":"InstanceTypeId %d","Name":"Name %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "cloud.InstanceType", "cpus": 32, "architecture": "Architecture 1", "cpu_speed": 32, "platform": "Platform 1", "memory": 32, "object_type": "cloud.InstanceType", "instance_type_id": "InstanceTypeId 1", "name": "Name 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapCloudVolumeIopsInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ThroughputWriteLimit":32,"ClassId":"cloud.VolumeIopsInfo","ObjectType":"cloud.VolumeIopsInfo","IopsReadLimit":32,"IopsWriteLimit":32,"ThroughputReadLimit":32}`
	...
	expectedOp := map[string]interface{}{"throughput_write_limit": 32, "class_id": "cloud.VolumeIopsInfo", "object_type": "cloud.VolumeIopsInfo", "iops_read_limit": 32, "iops_write_limit": 32, "throughput_read_limit": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapConnectorFileChecksum(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"HashAlgorithm":"HashAlgorithm %d","ClassId":"connector.FileChecksum","ObjectType":"connector.FileChecksum"}`
	...
	expectedOp := map[string]interface{}{"hash_algorithm": "HashAlgorithm 1", "class_id": "connector.FileChecksum", "object_type": "connector.FileChecksum"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapFirmwareDirectDownload(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"firmware.DirectDownload","ClassId":"firmware.DirectDownload","ImageSource":"ImageSource %d","IsPasswordSet":true,"Upgradeoption":"Upgradeoption %d","Username":"Username %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "firmware.DirectDownload", "class_id": "firmware.DirectDownload", "image_source": "ImageSource 1", "is_password_set": true, "upgradeoption": "Upgradeoption 1", "username": "Username 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapFirmwareNetworkShare(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"IsPasswordSet":true,"MapType":"MapType %d","ObjectType":"firmware.NetworkShare","Username":"Username %d","Upgradeoption":"Upgradeoption %d","ClassId":"firmware.NetworkShare"}`
	...
	expectedOp := map[string]interface{}{"is_password_set": true, "map_type": "MapType 1", "object_type": "firmware.NetworkShare", "username": "Username 1", "upgradeoption": "Upgradeoption 1", "class_id": "firmware.NetworkShare"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexAppSettingConstraint(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"HypervisorType":"HypervisorType %d","ClassId":"hyperflex.AppSettingConstraint","ObjectType":"hyperflex.AppSettingConstraint","MgmtPlatform":"MgmtPlatform %d","ServerModel":"ServerModel %d","DeploymentType":"DeploymentType %d","HxdpVersion":"HxdpVersion %d"}`
	...
	expectedOp := map[string]interface{}{"hypervisor_type": "HypervisorType 1", "class_id": "hyperflex.AppSettingConstraint", "object_type": "hyperflex.AppSettingConstraint", "mgmt_platform": "MgmtPlatform 1", "server_model": "ServerModel 1", "deployment_type": "DeploymentType 1", "hxdp_version": "HxdpVersion 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexBondState(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ActiveSlave":"ActiveSlave %d","Mode":"Mode %d","ClassId":"hyperflex.BondState","ObjectType":"hyperflex.BondState"}`
	...
	expectedOp := map[string]interface{}{"active_slave": "ActiveSlave 1", "mode": "Mode 1", "class_id": "hyperflex.BondState", "object_type": "hyperflex.BondState"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexDiskStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"hyperflex.DiskStatus","State":"State %d","VolumeHandle":"VolumeHandle %d","VolumeName":"VolumeName %d","DownloadPercentage":"DownloadPercentage %d","ClassId":"hyperflex.DiskStatus"}`
	...
	expectedOp := map[string]interface{}{"object_type": "hyperflex.DiskStatus", "state": "State 1", "volume_handle": "VolumeHandle 1", "volume_name": "VolumeName 1", "download_percentage": "DownloadPercentage 1", "class_id": "hyperflex.DiskStatus"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapHyperflexEntityReference(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Idtype":"Idtype %d","Name":"Name %d","Type":"Type %d","Confignum":32,"Id":"Id %d","ObjectType":"hyperflex.EntityReference","ClassId":"hyperflex.EntityReference"}`
	...
	expectedOp := map[string]interface{}{"idtype": "Idtype 1", "name": "Name 1", "type": "Type 1", "confignum": 32, "id": "Id 1", "object_type": "hyperflex.EntityReference", "class_id": "hyperflex.EntityReference"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapHyperflexErrorStack(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"hyperflex.ErrorStack","Message":"Message %d","MessageId":32,"ClassId":"hyperflex.ErrorStack"}`
	...
	expectedOp := map[string]interface{}{"object_type": "hyperflex.ErrorStack", "message": "Message 1", "message_id": 32, "class_id": "hyperflex.ErrorStack"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexHxPlatformDatastoreConfigDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"hyperflex.HxPlatformDatastoreConfigDt","ObjectType":"hyperflex.HxPlatformDatastoreConfigDt","ProvisionedCapacity":32,"DataBlockSize":32,"Name":"Name %d","NumStripesForLargeFiles":32,"SystemDatastore":true,"NumMirrors":32}`
	...
	expectedOp := map[string]interface{}{"class_id": "hyperflex.HxPlatformDatastoreConfigDt", "object_type": "hyperflex.HxPlatformDatastoreConfigDt", "provisioned_capacity": 32, "data_block_size": 32, "name": "Name 1", "num_stripes_for_large_files": 32, "system_datastore": true, "num_mirrors": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapHyperflexHxRegistrationDetailsDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"VirtualAccount":"VirtualAccount %d","NextRenewalAttemptDate":"NextRenewalAttemptDate %d","SmartAccount":"SmartAccount %d","OutOfComplianceStartDate":"OutOfComplianceStartDate %d","Status":"Status %d","ClassId":"hyperflex.HxRegistrationDetailsDt","ObjectType":"hyperflex.HxRegistrationDetailsDt","LastRenewalAttemptDate":"LastRenewalAttemptDate %d","InitialRegistrationDate":"InitialRegistrationDate %d","RegistrationFailedReason":"RegistrationFailedReason %d","RegistrationExpireDate":"RegistrationExpireDate %d"}`
	...
	expectedOp := map[string]interface{}{"virtual_account": "VirtualAccount 1", "next_renewal_attempt_date": "NextRenewalAttemptDate 1", "smart_account": "SmartAccount 1", "out_of_compliance_start_date": "OutOfComplianceStartDate 1", "status": "Status 1", "class_id": "hyperflex.HxRegistrationDetailsDt", "object_type": "hyperflex.HxRegistrationDetailsDt", "last_renewal_attempt_date": "LastRenewalAttemptDate 1", "initial_registration_date": "InitialRegistrationDate 1", "registration_failed_reason": "RegistrationFailedReason 1", "registration_expire_date": "RegistrationExpireDate 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapHyperflexHxResiliencyInfoDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"hyperflex.HxResiliencyInfoDt","DataReplicationFactor":"DataReplicationFactor %d","NodeFailuresTolerable":32,"SsdFailuresTolerable":32,"ResiliencyState":"ResiliencyState %d","ClassId":"hyperflex.HxResiliencyInfoDt","HddFailuresTolerable":32,"PolicyCompliance":"PolicyCompliance %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "hyperflex.HxResiliencyInfoDt", "data_replication_factor": "DataReplicationFactor 1", "node_failures_tolerable": 32, "ssd_failures_tolerable": 32, "resiliency_state": "ResiliencyState 1", "class_id": "hyperflex.HxResiliencyInfoDt", "hdd_failures_tolerable": 32, "policy_compliance": "PolicyCompliance 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapHyperflexHxSiteDt(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"hyperflex.HxSiteDt","Name":"Name %d","ClassId":"hyperflex.HxSiteDt"}`
	...
	expectedOp := map[string]interface{}{"object_type": "hyperflex.HxSiteDt", "name": "Name 1", "class_id": "hyperflex.HxSiteDt"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexIpAddrRange(t *testing.T) {
	p := models.HyperflexIpAddrRange{}
	var d = &schema.ResourceData{}
	c := `{"StartAddr":"StartAddr %d","EndAddr":"EndAddr %d","ClassId":"hyperflex.IpAddrRange","ObjectType":"hyperflex.IpAddrRange","Gateway":"Gateway %d","Netmask":"Netmask %d"}`
	...
	expectedOp := map[string]interface{}{"start_addr": "StartAddr 1", "end_addr": "EndAddr 1", "class_id": "hyperflex.IpAddrRange", "object_type": "hyperflex.IpAddrRange", "gateway": "Gateway 1", "netmask": "Netmask 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexMacAddrPrefixRange(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"StartAddr":"StartAddr %d","EndAddr":"EndAddr %d","ClassId":"hyperflex.MacAddrPrefixRange","ObjectType":"hyperflex.MacAddrPrefixRange"}`
	...
	expectedOp := map[string]interface{}{"start_addr": "StartAddr 1", "end_addr": "EndAddr 1", "class_id": "hyperflex.MacAddrPrefixRange", "object_type": "hyperflex.MacAddrPrefixRange"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexNamedVsan(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"VsanId":32,"Name":"Name %d","ClassId":"hyperflex.NamedVsan","ObjectType":"hyperflex.NamedVsan"}`
	...
	expectedOp := map[string]interface{}{"vsan_id": 32, "name": "Name 1", "class_id": "hyperflex.NamedVsan", "object_type": "hyperflex.NamedVsan"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexReplicationPeerInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"hyperflex.ReplicationPeerInfo","ReplCip":"ReplCip %d","StatusDetails":"StatusDetails %d","Mcip":"Mcip %d","ObjectType":"hyperflex.ReplicationPeerInfo","Dcip":"Dcip %d","Status":"Status %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "hyperflex.ReplicationPeerInfo", "repl_cip": "ReplCip 1", "status_details": "StatusDetails 1", "mcip": "Mcip 1", "object_type": "hyperflex.ReplicationPeerInfo", "dcip": "Dcip 1", "status": "Status 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapHyperflexSummary(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"SpaceStatus":"SpaceStatus %d","Uptime":"Uptime %d","ClusterAccessPolicy":"ClusterAccessPolicy %d","TotalCapacity":32,"ResiliencyDetailsSize":32,"Downtime":"Downtime %d","Address":"Address %d","DeduplicationSavings":32.000000,"CompressionSavings":32.000000,"ClassId":"hyperflex.Summary","TotalSavings":32.000000,"State":"State %d","Boottime":32,"ActiveNodes":"ActiveNodes %d","Name":"Name %d","ObjectType":"hyperflex.Summary","DataReplicationFactor":"DataReplicationFactor %d","DataReplicationCompliance":"DataReplicationCompliance %d","UsedCapacity":32,"FreeCapacity":32}`
	...
	expectedOp := map[string]interface{}{"space_status": "SpaceStatus 1", "uptime": "Uptime 1", "cluster_access_policy": "ClusterAccessPolicy 1", "total_capacity": 32, "resiliency_details_size": 32, "downtime": "Downtime 1", "address": "Address 1", "deduplication_savings": 32.000000, "compression_savings": 32.000000, "class_id": "hyperflex.Summary", "total_savings": 32.000000, "state": "State 1", "boottime": 32, "active_nodes": "ActiveNodes 1", "name": "Name 1", "object_type": "hyperflex.Summary", "data_replication_factor": "DataReplicationFactor 1", "data_replication_compliance": "DataReplicationCompliance 1", "used_capacity": 32, "free_capacity": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIamClientMeta(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"UserAgent":"UserAgent %d","ClassId":"iam.ClientMeta","ObjectType":"iam.ClientMeta","DeviceModel":"DeviceModel %d"}`
	...
	expectedOp := map[string]interface{}{"user_agent": "UserAgent 1", "class_id": "iam.ClientMeta", "object_type": "iam.ClientMeta", "device_model": "DeviceModel 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIamEndPointPasswordProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"iam.EndPointPasswordProperties","ObjectType":"iam.EndPointPasswordProperties","PasswordExpiryDuration":32,"GracePeriod":32,"NotificationPeriod":32,"ForceSendPassword":true,"EnablePasswordExpiry":true,"EnforceStrongPassword":true,"PasswordHistory":32}`
	...
	expectedOp := map[string]interface{}{"class_id": "iam.EndPointPasswordProperties", "object_type": "iam.EndPointPasswordProperties", "password_expiry_duration": 32, "grace_period": 32, "notification_period": 32, "force_send_password": true, "enable_password_expiry": true, "enforce_strong_password": true, "password_history": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIamLdapBaseProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"EnableGroupAuthorization":true,"Domain":"Domain %d","IsPasswordSet":true,"NestedGroupSearchDepth":32,"Attribute":"Attribute %d","GroupAttribute":"GroupAttribute %d","BindMethod":"BindMethod %d","BaseDn":"BaseDn %d","EnableEncryption":true,"Filter":"Filter %d","Timeout":32,"BindDn":"BindDn %d","ClassId":"iam.LdapBaseProperties","ObjectType":"iam.LdapBaseProperties"}`
	...
	expectedOp := map[string]interface{}{"enable_group_authorization": true, "domain": "Domain 1", "is_password_set": true, "nested_group_search_depth": 32, "attribute": "Attribute 1", "group_attribute": "GroupAttribute 1", "bind_method": "BindMethod 1", "base_dn": "BaseDn 1", "enable_encryption": true, "filter": "Filter 1", "timeout": 32, "bind_dn": "BindDn 1", "class_id": "iam.LdapBaseProperties", "object_type": "iam.LdapBaseProperties"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIppoolIpV6Config(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"PrimaryDns":"PrimaryDns %d","SecondaryDns":"SecondaryDns %d","Gateway":"Gateway %d","ClassId":"ippool.IpV6Config","ObjectType":"ippool.IpV6Config","Prefix":32}`
	...
	expectedOp := map[string]interface{}{"primary_dns": "PrimaryDns 1", "secondary_dns": "SecondaryDns 1", "gateway": "Gateway 1", "class_id": "ippool.IpV6Config", "object_type": "ippool.IpV6Config", "prefix": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapIqnpoolIqnSuffixBlock(t *testing.T) {
	...
	expectedOp := map[string]interface{}{"class_id": "iqnpool.IqnSuffixBlock", "object_type": "iqnpool.IqnSuffixBlock", "size": 32, "from": 32, "suffix": "Suffix 1", "to": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesAddonConfiguration(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Overrides":"Overrides %d","ReleaseNamespace":"ReleaseNamespace %d","InstallStrategy":"InstallStrategy %d","ReleaseName":"ReleaseName %d","UpgradeStrategy":"UpgradeStrategy %d","ClassId":"kubernetes.AddonConfiguration","ObjectType":"kubernetes.AddonConfiguration"}`
	...
	expectedOp := map[string]interface{}{"overrides": "Overrides 1", "release_namespace": "ReleaseNamespace 1", "install_strategy": "InstallStrategy 1", "release_name": "ReleaseName 1", "upgrade_strategy": "UpgradeStrategy 1", "class_id": "kubernetes.AddonConfiguration", "object_type": "kubernetes.AddonConfiguration"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesClusterCertificateConfiguration(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"kubernetes.ClusterCertificateConfiguration","ObjectType":"kubernetes.ClusterCertificateConfiguration","CaCert":"CaCert %d","EtcdCert":"EtcdCert %d","FrontProxyCert":"FrontProxyCert %d","SaPublicKey":"SaPublicKey %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "kubernetes.ClusterCertificateConfiguration", "object_type": "kubernetes.ClusterCertificateConfiguration", "ca_cert": "CaCert 1", "etcd_cert": "EtcdCert 1", "front_proxy_cert": "FrontProxyCert 1", "sa_public_key": "SaPublicKey 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapKubernetesClusterManagementConfig(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"SshUser":"SshUser %d","ClassId":"kubernetes.ClusterManagementConfig","ObjectType":"kubernetes.ClusterManagementConfig","IsTacPasswdSet":true,"LoadBalancerCount":32,"MasterVip":"MasterVip %d"}`
	...
	expectedOp := map[string]interface{}{"ssh_user": "SshUser 1", "class_id": "kubernetes.ClusterManagementConfig", "object_type": "kubernetes.ClusterManagementConfig", "is_tac_passwd_set": true, "load_balancer_count": 32, "master_vip": "MasterVip 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesDaemonSetStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"kubernetes.DaemonSetStatus","ObjectType":"kubernetes.DaemonSetStatus","DesiredNumberScheduled":32,"NumberReady":32,"CurrentNumberScheduled":32,"NumberMisscheduled":32,"NumberAvailable":"NumberAvailable %d","ObservedGeneration":32,"UpdatedNumberScheduled":"UpdatedNumberScheduled %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "kubernetes.DaemonSetStatus", "object_type": "kubernetes.DaemonSetStatus", "desired_number_scheduled": 32, "number_ready": 32, "current_number_scheduled": 32, "number_misscheduled": 32, "number_available": "NumberAvailable 1", "observed_generation": 32, "updated_number_scheduled": "UpdatedNumberScheduled 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesNodeInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"KubeletVersion":"KubeletVersion %d","OsImage":"OsImage %d","ClassId":"kubernetes.NodeInfo","ObjectType":"kubernetes.NodeInfo","KubeProxyVersion":"KubeProxyVersion %d","BootId":"BootId %d","OperatingSystem":"OperatingSystem %d","ContainerRuntimeVersion":"ContainerRuntimeVersion %d","KernelVersion":"KernelVersion %d","SystemUuid":"SystemUuid %d","Architecture":"Architecture %d","MachineId":"MachineId %d"}`
	...
	expectedOp := map[string]interface{}{"kubelet_version": "KubeletVersion 1", "os_image": "OsImage 1", "class_id": "kubernetes.NodeInfo", "object_type": "kubernetes.NodeInfo", "kube_proxy_version": "KubeProxyVersion 1", "boot_id": "BootId 1", "operating_system": "OperatingSystem 1", "container_runtime_version": "ContainerRuntimeVersion 1", "kernel_version": "KernelVersion 1", "system_uuid": "SystemUuid 1", "architecture": "Architecture 1", "machine_id": "MachineId 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesPodStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Phase":"Phase %d","PodIp":"PodIp %d","QosClass":"QosClass %d","ObjectType":"kubernetes.PodStatus","ClassId":"kubernetes.PodStatus","StartTime":"StartTime %d","HostIp":"HostIp %d"}`
	...
	expectedOp := map[string]interface{}{"phase": "Phase 1", "pod_ip": "PodIp 1", "qos_class": "QosClass 1", "object_type": "kubernetes.PodStatus", "class_id": "kubernetes.PodStatus", "start_time": "StartTime 1", "host_ip": "HostIp 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapKubernetesProxyConfig(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"kubernetes.ProxyConfig","Port":32,"Hostname":"Hostname %d","Username":"Username %d","ClassId":"kubernetes.ProxyConfig","IsPasswordSet":true,"Protocol":"Protocol %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "kubernetes.ProxyConfig", "port": 32, "hostname": "Hostname 1", "username": "Username 1", "class_id": "kubernetes.ProxyConfig", "is_password_set": true, "protocol": "Protocol 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapKubernetesStatefulSetStatus(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"AvailableReplicas":32,"Replicas":32,"CollisionCount":32,"UpdatedReplicas":32,"ObjectType":"kubernetes.StatefulSetStatus","ReadyReplicas":32,"UpdateRevision":"UpdateRevision %d","CurrentRevision":"CurrentRevision %d","ObservedGeneration":32,"ClassId":"kubernetes.StatefulSetStatus"}`
	...
	expectedOp := map[string]interface{}{"available_replicas": 32, "replicas": 32, "collision_count": 32, "updated_replicas": 32, "object_type": "kubernetes.StatefulSetStatus", "ready_replicas": 32, "update_revision": "UpdateRevision 1", "current_revision": "CurrentRevision 1", "observed_generation": 32, "class_id": "kubernetes.StatefulSetStatus"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapMacpoolBlock(t *testing.T) {
	p := models.MacpoolBlock{}
	var d = &schema.ResourceData{}
	c := `{"From":"From %d","ClassId":"macpool.Block","ObjectType":"macpool.Block","Size":32,"To":"To %d"}`
	...
	expectedOp := map[string]interface{}{"from": "From 1", "class_id": "macpool.Block", "object_type": "macpool.Block", "size": 32, "to": "To 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapMemoryPersistentMemoryLocalSecurity(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"memory.PersistentMemoryLocalSecurity","Enabled":true,"IsSecurePassphraseSet":true,"ClassId":"memory.PersistentMemoryLocalSecurity"}`
	...
	expectedOp := map[string]interface{}{"object_type": "memory.PersistentMemoryLocalSecurity", "enabled": true, "is_secure_passphrase_set": true, "class_id": "memory.PersistentMemoryLocalSecurity"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapMoBaseMo(t *testing.T) {
	p := models.MoBaseMo{}
	var d = &schema.ResourceData{}
	c := `{"ClassId":"mo.BaseMo","DomainGroupMoid":"DomainGroupMoid %d","ObjectType":"mo.BaseMo","Moid":"Moid %d","SharedScope":"SharedScope %d","AccountMoid":"AccountMoid %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "mo.BaseMo", "domain_group_moid": "DomainGroupMoid 1", "object_type": "mo.BaseMo", "moid": "Moid 1", "shared_scope": "SharedScope 1", "account_moid": "AccountMoid 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapMoVersionContext(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"mo.VersionContext","VersionType":"VersionType %d","Version":"Version %d","ClassId":"mo.VersionContext"}`
	...
	expectedOp := map[string]interface{}{"object_type": "mo.VersionContext", "version_type": "VersionType 1", "nr_version": "Version 1", "class_id": "mo.VersionContext"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapNiaapiNewReleaseDetail(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ReleaseNoteLink":"ReleaseNoteLink %d","SoftwareDownloadLink":"SoftwareDownloadLink %d","ClassId":"niaapi.NewReleaseDetail","ObjectType":"niaapi.NewReleaseDetail","Title":"Title %d","Version":"Version %d","SoftwareDownloadLinkTitle":"SoftwareDownloadLinkTitle %d","ReleaseNoteLinkTitle":"ReleaseNoteLinkTitle %d","Description":"Description %d","Link":"Link %d"}`
	...
	expectedOp := map[string]interface{}{"release_note_link": "ReleaseNoteLink 1", "software_download_link": "SoftwareDownloadLink 1", "class_id": "niaapi.NewReleaseDetail", "object_type": "niaapi.NewReleaseDetail", "title": "Title 1", "nr_version": "Version 1", "software_download_link_title": "SoftwareDownloadLinkTitle 1", "release_note_link_title": "ReleaseNoteLinkTitle 1", "description": "Description 1", "link": "Link 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapNiatelemetryBootflashDetails(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"niatelemetry.BootflashDetails","ObjectType":"niatelemetry.BootflashDetails","FwRev":"FwRev %d","ModelType":"ModelType %d","Serial":"Serial %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "niatelemetry.BootflashDetails", "object_type": "niatelemetry.BootflashDetails", "fw_rev": "FwRev 1", "model_type": "ModelType 1", "serial": "Serial 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapNiatelemetryDiskinfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Used":32,"Free":32,"Name":"Name %d","Total":32,"ClassId":"niatelemetry.Diskinfo","ObjectType":"niatelemetry.Diskinfo"}`
	...
	expectedOp := map[string]interface{}{"used": 32, "free": 32, "name": "Name 1", "total": 32, "class_id": "niatelemetry.Diskinfo", "object_type": "niatelemetry.Diskinfo"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapNiatelemetryNveVni(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"CpVniCount":32,"CpVniDown":32,"DpVniDown":32,"DpVniUp":32,"ClassId":"niatelemetry.NveVni","CpVniUp":32,"DpVniCount":32,"ObjectType":"niatelemetry.NveVni"}`
	...
	expectedOp := map[string]interface{}{"cp_vni_count": 32, "cp_vni_down": 32, "dp_vni_down": 32, "dp_vni_up": 32, "class_id": "niatelemetry.NveVni", "cp_vni_up": 32, "dp_vni_count": 32, "object_type": "niatelemetry.NveVni"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapNiatelemetryNxosBgpMvpn(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"niatelemetry.NxosBgpMvpn","TotalPaths":32,"CapablePeers":32,"NumberOfClusterLists":32,"ClassId":"niatelemetry.NxosBgpMvpn","NumberOfCommunities":32,"TotalNetworks":32,"ConfiguredPeers":32,"TableVersion":32,"MemoryUsed":32}`
	...
	expectedOp := map[string]interface{}{"object_type": "niatelemetry.NxosBgpMvpn", "total_paths": 32, "capable_peers": 32, "number_of_cluster_lists": 32, "class_id": "niatelemetry.NxosBgpMvpn", "number_of_communities": 32, "total_networks": 32, "configured_peers": 32, "table_version": 32, "memory_used": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapNiatelemetryNxosVtp(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"RunningVersion":"RunningVersion %d","ClassId":"niatelemetry.NxosVtp","Version":32,"V2Mode":"V2Mode %d","OperMode":"OperMode %d","PruningMode":"PruningMode %d","TrapEnabled":"TrapEnabled %d","ObjectType":"niatelemetry.NxosVtp"}`
	...
	expectedOp := map[string]interface{}{"running_version": "RunningVersion 1", "class_id": "niatelemetry.NxosVtp", "nr_version": 32, "v2_mode": "V2Mode 1", "oper_mode": "OperMode 1", "pruning_mode": "PruningMode 1", "trap_enabled": "TrapEnabled 1", "object_type": "niatelemetry.NxosVtp"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapOnpremSchedule(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"onprem.Schedule","DayOfMonth":32,"TimeZone":"TimeZone %d","ObjectType":"onprem.Schedule","RepeatInterval":32,"WeekOfMonth":32,"MonthOfYear":32,"DayOfWeek":32,"TimeOfDay":32}`
	...
	expectedOp := map[string]interface{}{"class_id": "onprem.Schedule", "day_of_month": 32, "time_zone": "TimeZone 1", "object_type": "onprem.Schedule", "repeat_interval": 32, "week_of_month": 32, "month_of_year": 32, "day_of_week": 32, "time_of_day": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapOnpremUpgradePhase(t *testing.T) {
	p := models.OnpremUpgradePhase{}
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"onprem.UpgradePhase","Failed":true,"Message":"Message %d","ElapsedTime":32,"ClassId":"onprem.UpgradePhase","Name":"Name %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "onprem.UpgradePhase", "failed": true, "message": "Message 1", "elapsed_time": 32, "class_id": "onprem.UpgradePhase", "name": "Name 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapOsAnswers(t *testing.T) {
	p := models.OsAnswers{}
	var d = &schema.ResourceData{}
	c := `{"ClassId":"os.Answers","ObjectType":"os.Answers","IsRootPasswordCrypted":true,"IsRootPasswordSet":true,"Nameserver":"Nameserver %d","IsAnswerFileSet":true,"Source":"Source %d","IpConfigType":"IpConfigType %d","Hostname":"Hostname %d","ProductKey":"ProductKey %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "os.Answers", "object_type": "os.Answers", "is_root_password_crypted": true, "is_root_password_set": true, "nameserver": "Nameserver 1", "is_answer_file_set": true, "nr_source": "Source 1", "ip_config_type": "IpConfigType 1", "hostname": "Hostname 1", "product_key": "ProductKey 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapOsGlobalConfig(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"os.GlobalConfig","WindowsEdition":"WindowsEdition %d","OsImageName":"OsImageName %d","ConfigurationSource":"ConfigurationSource %d","ScuImageName":"ScuImageName %d","ClassId":"os.GlobalConfig","InstallMethod":"InstallMethod %d","InstallTargetType":"InstallTargetType %d","ConfigurationFileName":"ConfigurationFileName %d"}`
	...
	expectedOp := map[string]interface{}{"object_type": "os.GlobalConfig", "windows_edition": "WindowsEdition 1", "os_image_name": "OsImageName 1", "configuration_source": "ConfigurationSource 1", "scu_image_name": "ScuImageName 1", "class_id": "os.GlobalConfig", "install_method": "InstallMethod 1", "install_target_type": "InstallTargetType 1", "configuration_file_name": "ConfigurationFileName 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapPolicyConfigContext(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ConfigState":"ConfigState %d","ConfigType":"ConfigType %d","ClassId":"policy.ConfigContext","ObjectType":"policy.ConfigContext","ControlAction":"ControlAction %d","ErrorState":"ErrorState %d","OperState":"OperState %d"}`
	...
	expectedOp := map[string]interface{}{"config_state": "ConfigState 1", "config_type": "ConfigType 1", "class_id": "policy.ConfigContext", "object_type": "policy.ConfigContext", "control_action": "ControlAction 1", "error_state": "ErrorState 1", "oper_state": "OperState 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapPolicyConfigResultContext(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"EntityMoid":"EntityMoid %d","ObjectType":"policy.ConfigResultContext","ClassId":"policy.ConfigResultContext","EntityName":"EntityName %d","EntityType":"EntityType %d"}`
	...
	expectedOp := map[string]interface{}{"entity_moid": "EntityMoid 1", "object_type": "policy.ConfigResultContext", "class_id": "policy.ConfigResultContext", "entity_name": "EntityName 1", "entity_type": "EntityType 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapStorageAutomaticDriveGroup(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"storage.AutomaticDriveGroup","NumDedicatedHotSpares":"NumDedicatedHotSpares %d","NumberOfSpans":32,"UseRemainingDrives":true,"ObjectType":"storage.AutomaticDriveGroup","DrivesPerSpan":32,"MinimumDriveSize":32,"DriveType":"DriveType %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "storage.AutomaticDriveGroup", "num_dedicated_hot_spares": "NumDedicatedHotSpares 1", "number_of_spans": 32, "use_remaining_drives": true, "object_type": "storage.AutomaticDriveGroup", "drives_per_span": 32, "minimum_drive_size": 32, "drive_type": "DriveType 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapStorageBaseCapacity(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Available":32,"CapacityUtilization":32.000000,"Free":32,"ClassId":"storage.BaseCapacity","ObjectType":"storage.BaseCapacity","Total":32,"Used":32}`
	...
	expectedOp := map[string]interface{}{"available": 32, "capacity_utilization": 32.000000, "free": 32, "class_id": "storage.BaseCapacity", "object_type": "storage.BaseCapacity", "total": 32, "used": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapUuidpoolUuidBlock(t *testing.T) {
	p := models.UuidpoolUuidBlock{}
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"uuidpool.UuidBlock","From":"From %d","To":"To %d","Size":32,"ClassId":"uuidpool.UuidBlock"}`
	...
	expectedOp := map[string]interface{}{"object_type": "uuidpool.UuidBlock", "from": "From 1", "to": "To 1", "size": 32, "class_id": "uuidpool.UuidBlock"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationComputeCapacity(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"virtualization.ComputeCapacity","Capacity":32,"Free":32,"Used":32,"ClassId":"virtualization.ComputeCapacity"}`
	...
	expectedOp := map[string]interface{}{"object_type": "virtualization.ComputeCapacity", "capacity": 32, "free": 32, "used": 32, "class_id": "virtualization.ComputeCapacity"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVirtualizationCpuAllocation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Reserved":32,"Total":32,"ClassId":"virtualization.CpuAllocation","ObjectType":"virtualization.CpuAllocation","Used":32,"Free":32}`
	...
	expectedOp := map[string]interface{}{"reserved": 32, "total": 32, "class_id": "virtualization.CpuAllocation", "object_type": "virtualization.CpuAllocation", "used": 32, "free": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationGuestInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"virtualization.GuestInfo","ObjectType":"virtualization.GuestInfo","IpAddress":"IpAddress %d","Name":"Name %d","OperatingSystem":"OperatingSystem %d","Hostname":"Hostname %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "virtualization.GuestInfo", "object_type": "virtualization.GuestInfo", "ip_address": "IpAddress 1", "name": "Name 1", "operating_system": "OperatingSystem 1", "hostname": "Hostname 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVirtualizationMemoryAllocation(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Total":32,"Used":32,"ClassId":"virtualization.MemoryAllocation","ObjectType":"virtualization.MemoryAllocation","Free":32,"Reserved":32}`
	...
	expectedOp := map[string]interface{}{"total": 32, "used": 32, "class_id": "virtualization.MemoryAllocation", "object_type": "virtualization.MemoryAllocation", "free": 32, "reserved": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationProductInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"virtualization.ProductInfo","ObjectType":"virtualization.ProductInfo","ProductType":"ProductType %d","ProductVendor":"ProductVendor %d","Version":"Version %d","Build":"Build %d","ProductName":"ProductName %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "virtualization.ProductInfo", "object_type": "virtualization.ProductInfo", "product_type": "ProductType 1", "product_vendor": "ProductVendor 1", "nr_version": "Version 1", "build": "Build 1", "product_name": "ProductName 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationVmwareSharesInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"Level":"Level %d","ObjectType":"virtualization.VmwareSharesInfo","ClassId":"virtualization.VmwareSharesInfo","Shares":32}`
	...
	expectedOp := map[string]interface{}{"level": "Level 1", "object_type": "virtualization.VmwareSharesInfo", "class_id": "virtualization.VmwareSharesInfo", "shares": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVirtualizationVmwareTeamingAndFailover(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"LoadBalancing":"LoadBalancing %d","ObjectType":"virtualization.VmwareTeamingAndFailover","NotifySwitches":true,"Name":"Name %d","ClassId":"virtualization.VmwareTeamingAndFailover","Failback":true,"NetworkFailureDetection":"NetworkFailureDetection %d"}`
	...
	expectedOp := map[string]interface{}{"load_balancing": "LoadBalancing 1", "object_type": "virtualization.VmwareTeamingAndFailover", "notify_switches": true, "name": "Name 1", "class_id": "virtualization.VmwareTeamingAndFailover", "failback": true, "network_failure_detection": "NetworkFailureDetection 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationVmwareVmCpuShareInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"CpuOverheadLimit":32,"CpuReservation":32,"CpuShares":32,"ClassId":"virtualization.VmwareVmCpuShareInfo","ObjectType":"virtualization.VmwareVmCpuShareInfo","CpuLimit":32}`
	...
	expectedOp := map[string]interface{}{"cpu_overhead_limit": 32, "cpu_reservation": 32, "cpu_shares": 32, "class_id": "virtualization.VmwareVmCpuShareInfo", "object_type": "virtualization.VmwareVmCpuShareInfo", "cpu_limit": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVirtualizationVmwareVmMemoryShareInfo(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"virtualization.VmwareVmMemoryShareInfo","MemLimit":32,"MemOverheadLimit":32,"MemReservation":32,"MemShares":32,"ClassId":"virtualization.VmwareVmMemoryShareInfo"}`
	...
	expectedOp := map[string]interface{}{"object_type": "virtualization.VmwareVmMemoryShareInfo", "mem_limit": 32, "mem_overhead_limit": 32, "mem_reservation": 32, "mem_shares": 32, "class_id": "virtualization.VmwareVmMemoryShareInfo"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicRoceSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"vnic.RoceSettings","ObjectType":"vnic.RoceSettings","QueuePairs":32,"ClassOfService":32,"Enabled":true,"MemoryRegions":32,"ResourceGroups":32,"Version":32}`
	...
	expectedOp := map[string]interface{}{"class_id": "vnic.RoceSettings", "object_type": "vnic.RoceSettings", "queue_pairs": 32, "class_of_service": 32, "enabled": true, "memory_regions": 32, "resource_groups": 32, "nr_version": 32}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
func TestFlattenMapVnicRssHashSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"TcpIpv6Hash":true,"UdpIpv4Hash":true,"Ipv4Hash":true,"Ipv6Hash":true,"Ipv6ExtHash":true,"TcpIpv6ExtHash":true,"UdpIpv6Hash":true,"TcpIpv4Hash":true,"ClassId":"vnic.RssHashSettings","ObjectType":"vnic.RssHashSettings"}`
	...
	expectedOp := map[string]interface{}{"tcp_ipv6_hash": true, "udp_ipv4_hash": true, "ipv4_hash": true, "ipv6_hash": true, "ipv6_ext_hash": true, "tcp_ipv6_ext_hash": true, "udp_ipv6_hash": true, "tcp_ipv4_hash": true, "class_id": "vnic.RssHashSettings", "object_type": "vnic.RssHashSettings"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicTcpOffloadSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"vnic.TcpOffloadSettings","ObjectType":"vnic.TcpOffloadSettings","RxChecksum":true,"TxChecksum":true,"LargeReceive":true,"LargeSend":true}`
	...
	expectedOp := map[string]interface{}{"class_id": "vnic.TcpOffloadSettings", "object_type": "vnic.TcpOffloadSettings", "rx_checksum": true, "tx_checksum": true, "large_receive": true, "large_send": true}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapVnicVmqSettings(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ClassId":"vnic.VmqSettings","Enabled":true,"MultiQueueSupport":true,"NumInterrupts":32,"NumVmqs":32,"ObjectType":"vnic.VmqSettings","NumSubVnics":32,"VmmqAdapterPolicy":"VmmqAdapterPolicy %d"}`
	...
	expectedOp := map[string]interface{}{"class_id": "vnic.VmqSettings", "enabled": true, "multi_queue_support": true, "num_interrupts": 32, "num_vmqs": 32, "object_type": "vnic.VmqSettings", "num_sub_vnics": 32, "vmmq_adapter_policy": "VmmqAdapterPolicy 1"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapWorkflowInternalProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ObjectType":"workflow.InternalProperties","Internal":true,"Owner":"Owner %d","BaseTaskType":"BaseTaskType %d","ClassId":"workflow.InternalProperties"}`
	...
	expectedOp := map[string]interface{}{"object_type": "workflow.InternalProperties", "internal": true, "owner": "Owner 1", "base_task_type": "BaseTaskType 1", "class_id": "workflow.InternalProperties"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapWorkflowProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"RetryCount":32,"RetryPolicy":"RetryPolicy %d","ClassId":"workflow.Properties","RetryDelay":32,"Timeout":32,"Cloneable":true,"SupportStatus":"SupportStatus %d","TimeoutPolicy":"TimeoutPolicy %d","ExternalMeta":true,"ObjectType":"workflow.Properties"}`
	...
	expectedOp := map[string]interface{}{"retry_count": 32, "retry_policy": "RetryPolicy 1", "class_id": "workflow.Properties", "retry_delay": 32, "timeout": 32, "cloneable": true, "support_status": "SupportStatus 1", "timeout_policy": "TimeoutPolicy 1", "external_meta": true, "object_type": "workflow.Properties"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
...
func TestFlattenMapWorkflowWorkflowProperties(t *testing.T) {
	...
	var d = &schema.ResourceData{}
	c := `{"ExternalMeta":true,"Retryable":true,"SupportStatus":"SupportStatus %d","Cloneable":true,"EnableDebug":true,"ClassId":"workflow.WorkflowProperties","ObjectType":"workflow.WorkflowProperties"}`
	...
	expectedOp := map[string]interface{}{"external_meta": true, "retryable": true, "support_status": "SupportStatus 1", "cloneable": true, "enable_debug": true, "class_id": "workflow.WorkflowProperties", "object_type": "workflow.WorkflowProperties"}
	err = compareMaps(expectedOp, ffOp, t)
	CheckError(t, err)
}
