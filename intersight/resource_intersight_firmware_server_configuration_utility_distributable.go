...
func resourceFirmwareServerConfigurationUtilityDistributable() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareServerConfigurationUtilityDistributableCreate,
		Read:   resourceFirmwareServerConfigurationUtilityDistributableRead,
...
func resourceFirmwareServerConfigurationUtilityDistributableCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFirmwareServerConfigurationUtilityDistributableRead(d, meta)
}

func resourceFirmwareServerConfigurationUtilityDistributableRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareServerConfigurationUtilityDistributableUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
	var o = models.NewFirmwareServerConfigurationUtilityDistributableWithDefaults()
...
func resourceFirmwareServerConfigurationUtilityDistributableDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
