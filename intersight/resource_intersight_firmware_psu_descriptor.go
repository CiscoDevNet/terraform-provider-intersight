...
func resourceFirmwarePsuDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwarePsuDescriptorCreate,
		Read:   resourceFirmwarePsuDescriptorRead,
		Update: resourceFirmwarePsuDescriptorUpdate,
		Delete: resourceFirmwarePsuDescriptorDelete,
...
func resourceFirmwarePsuDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFirmwarePsuDescriptorRead(d, meta)
}

func resourceFirmwarePsuDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwarePsuDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwarePsuDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
