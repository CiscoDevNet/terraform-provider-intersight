...
func resourceFirmwareCimcDescriptor() *schema.Resource {
	return &schema.Resource{
		Create: resourceFirmwareCimcDescriptorCreate,
		Read:   resourceFirmwareCimcDescriptorRead,
		Update: resourceFirmwareCimcDescriptorUpdate,
		Delete: resourceFirmwareCimcDescriptorDelete,
...
func resourceFirmwareCimcDescriptorCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceFirmwareCimcDescriptorRead(d, meta)
}

func resourceFirmwareCimcDescriptorRead(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareCimcDescriptorUpdate(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
...
func resourceFirmwareCimcDescriptorDelete(d *schema.ResourceData, meta interface{}) error {
	log.SetFlags(log.LstdFlags | log.Lshortfile)
	log.Printf("%v", meta)
	conn := meta.(*Config)
