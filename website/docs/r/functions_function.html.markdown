...
# Resource: intersight_functions_function
The managed object which has info about custom function to be built and deployed.
## Argument Reference
...
## Import
`intersight_functions_function` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_functions_function.example 1234567890987654321abcde
``` 
