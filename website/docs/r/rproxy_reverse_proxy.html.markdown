...
## Import
`intersight_rproxy_reverse_proxy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_rproxy_reverse_proxy.example 1234567890987654321abcde
``` 