...
This complex property has following sub-properties:
    ...
    + `firmwares`:(Array)
This complex property has following sub-properties:
    + `driver_name`:(string)(ReadOnly) Protocol for which the driver is provided. E.g.  enic, fnic, lsi_mr3. 
    + `driver_version`:(string)(ReadOnly) Version of the Driver supported. 
    ...
    + `firmware_version`:(string)(ReadOnly) Firmware version of the product/adapter supported. 
    + `id`:(string)(ReadOnly) Identifier of the firmware. 
    ...
    + `object_type`:(string) The fully-qualified name of the instantiated, concrete type.The value should be the same as the 'ClassId' property. 
  + `id`:(string)(ReadOnly) Identifier of the product. 
  + `model`:(string) Model/PID of the product/adapter. 
  + `object_type`:(string) The fully-qualified name of the instantiated, concrete type.The value should be the same as the 'ClassId' property. 
  + `revision`:(string)(ReadOnly) Revision of the adapter model. 
  + `type`:(string)(ReadOnly) Type of the product/adapter say OCP, PT, GPU.* `` - Default type of the Product.* `Adapter` - Represents network adapter cards.* `StorageController` - Represents storage controllers.* `GPU` - Represents graphics cards. 
  + `vendor`:(string)(ReadOnly) Vendor of the product or adapter. 
