...
# Resource: intersight_iwotenant_maintenance_notification
Maintenance related notification to be displayed as UI banner when customer logs in the Intersight UI.
## Argument Reference
...
## Import
`intersight_iwotenant_maintenance_notification` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_iwotenant_maintenance_notification.example 1234567890987654321abcde
``` 
