...
# Resource: intersight_kubernetes_nvidia_gpu_product
Information of a Nvidia GPU product.
## Argument Reference
...
## Import
`intersight_kubernetes_nvidia_gpu_product` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_kubernetes_nvidia_gpu_product.example 1234567890987654321abcde
``` 
