...
## Import
`intersight_virtualization_cisco_hypervisor_manager` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_virtualization_cisco_hypervisor_manager.example 1234567890987654321abcde
``` 