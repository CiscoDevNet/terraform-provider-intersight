...
* `is_current_password_set`:(bool)(ReadOnly) Indicates whether the value of the 'currentPassword' property has been set. 
* `is_initial_password_set`:(bool)(ReadOnly) Indicates whether the value of the 'initialPassword' property has been set. 
* `is_new_password_set`:(bool)(ReadOnly) Indicates whether the value of the 'newPassword' property has been set. 
* `mod_time`:(string)(ReadOnly) The time when this managed object was last modified. 
* `moid`:(string) The unique identifier of this Managed Object instance. 
* `need_password_reset`:(bool)(ReadOnly) Indicates whether the user should be prompted to reset their password. 
...
## Import
`intersight_iam_local_user_password` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_iam_local_user_password.example 1234567890987654321abcde
``` 
