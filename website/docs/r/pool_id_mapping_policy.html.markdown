...
* `usage_count`:(int)(ReadOnly) The number of ID pools to which this ID mapping policy is attached. 
...
## Import
`intersight_pool_id_mapping_policy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_pool_id_mapping_policy.example 1234567890987654321abcde
``` 
