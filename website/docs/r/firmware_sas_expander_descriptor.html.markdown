...
# Resource: intersight_firmware_sas_expander_descriptor
Descriptor to uniquely identify a SasExpandar component.
## Usage Example
### Resource Creation
...
## Import
`intersight_firmware_sas_expander_descriptor` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_firmware_sas_expander_descriptor.example 1234567890987654321abcde
``` 