...
This complex property has following sub-properties:
  ...
  + `qinq_vlan`:(int) When activating VIC QinQ (802.1Q) Tunneling, a particular VLAN ID is set. In Access VLAN mode, this QinQ VLAN ID is established as the default VLAN. 
