...
## Import
`intersight_fabric_lan_pin_group` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_fabric_lan_pin_group.example 1234567890987654321abcde
``` 
