...
## Import
`intersight_oauth_authorization` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_oauth_authorization.example 1234567890987654321abcde
``` 
