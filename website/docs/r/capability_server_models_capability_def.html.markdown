...
## Import
`intersight_capability_server_models_capability_def` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_capability_server_models_capability_def.example 1234567890987654321abcde
``` 
