...
## Import
`intersight_appliance_external_syslog_setting` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_appliance_external_syslog_setting.example 1234567890987654321abcde
``` 
