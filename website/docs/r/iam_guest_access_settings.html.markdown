...
# Resource: intersight_iam_guest_access_settings
Stores account level settings for guest user access.
## Argument Reference
...
## Import
`intersight_iam_guest_access_settings` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_iam_guest_access_settings.example 1234567890987654321abcde
``` 
