...
# Resource: intersight_convergedinfra_health_check_definition
Pod health check definition metadata.
## Argument Reference
...
## Import
`intersight_convergedinfra_health_check_definition` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_convergedinfra_health_check_definition.example 1234567890987654321abcde
``` 