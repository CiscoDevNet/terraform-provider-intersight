...
* `properties`:(Array)
This complex property has following sub-properties:
  + `key`:(string) Name of the key/value property. 
  + `object_type`:(string) The fully-qualified name of the instantiated, concrete type.The value should be the same as the 'ClassId' property. 
  + `value`:(string) Value of the key/value property. 
...
## Import
`intersight_crd_custom_resource` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_crd_custom_resource.example 1234567890987654321abcde
``` 
