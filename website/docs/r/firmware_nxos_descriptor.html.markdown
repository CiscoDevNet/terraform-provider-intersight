...
## Import
`intersight_firmware_nxos_descriptor` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_firmware_nxos_descriptor.example 1234567890987654321abcde
``` 
