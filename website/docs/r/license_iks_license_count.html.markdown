...
* `advantage_count`:(int)(ReadOnly) The total number of devices claimed in the IKS Advantage tier. 
...
## Import
`intersight_license_iks_license_count` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_license_iks_license_count.example 1234567890987654321abcde
``` 
