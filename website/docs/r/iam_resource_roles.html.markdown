...
## Import
`intersight_iam_resource_roles` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_iam_resource_roles.example 1234567890987654321abcde
``` 
