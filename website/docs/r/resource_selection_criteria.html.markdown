...
# Resource: intersight_resource_selection_criteria
One or more resources are selected based on a criteria. SelectionCriteria can refer to static resources using  object reference or dynamic resources using OData query filters.
## Argument Reference
...
## Import
`intersight_resource_selection_criteria` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_resource_selection_criteria.example 1234567890987654321abcde
``` 
