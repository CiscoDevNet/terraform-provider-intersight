...
## Import
`intersight_hyperflex_proxy_setting_policy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_hyperflex_proxy_setting_policy.example 1234567890987654321abcde
``` 