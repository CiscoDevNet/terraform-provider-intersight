...
## Import
`intersight_fabric_span_source_vlan` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_fabric_span_source_vlan.example 1234567890987654321abcde
``` 
