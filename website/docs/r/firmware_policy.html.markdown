...
# Resource: intersight_firmware_policy
Firmware policy on the endpoint.
## Argument Reference
...
## Import
`intersight_firmware_policy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_firmware_policy.example 1234567890987654321abcde
``` 
