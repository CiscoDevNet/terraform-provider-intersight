...
## Import
`intersight_fabric_fc_network_policy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_fabric_fc_network_policy.example 1234567890987654321abcde
``` 
