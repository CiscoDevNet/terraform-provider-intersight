...
# Resource: intersight_capability_fex_manufacturing_def
Fabric extender manufacturing def properties.
## Argument Reference
...
## Import
`intersight_capability_fex_manufacturing_def` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_capability_fex_manufacturing_def.example 1234567890987654321abcde
``` 
