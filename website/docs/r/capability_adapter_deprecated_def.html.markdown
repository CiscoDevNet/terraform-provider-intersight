...
## Import
`intersight_capability_adapter_deprecated_def` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_capability_adapter_deprecated_def.example 1234567890987654321abcde
``` 
