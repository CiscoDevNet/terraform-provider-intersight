...
* `hostname`:(string) Hostname of the node being reconnected. 
...
## Import
`intersight_appliance_cluster_worker_node_reuse` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_appliance_cluster_worker_node_reuse.example 1234567890987654321abcde
``` 
