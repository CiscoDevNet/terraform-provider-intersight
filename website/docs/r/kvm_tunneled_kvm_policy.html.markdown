...
## Import
`intersight_kvm_tunneled_kvm_policy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_kvm_tunneled_kvm_policy.example 1234567890987654321abcde
``` 
