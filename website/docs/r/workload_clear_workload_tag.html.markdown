...
# Resource: intersight_workload_clear_workload_tag
### Overview
The ClearWorkloadTag API helps remove the system-defined workload tag from the specified objects. 
This API should only be used under the guidance of TAC or a System Administrator. 
#### Purpose
...
## Import
`intersight_workload_clear_workload_tag` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_workload_clear_workload_tag.example 1234567890987654321abcde
``` 
