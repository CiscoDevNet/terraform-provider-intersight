...
# Resource: intersight_hyperflex_start_reduce_re_sync
Start the execution of reduce re-sync and stale mirror cleanup for the HyperFlex clusters associated with the account.
## Argument Reference
...
## Import
`intersight_hyperflex_start_reduce_re_sync` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_hyperflex_start_reduce_re_sync.example 1234567890987654321abcde
``` 
