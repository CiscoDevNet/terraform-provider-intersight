...
## Import
`intersight_capability_server_schema_descriptor` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_capability_server_schema_descriptor.example 1234567890987654321abcde
``` 