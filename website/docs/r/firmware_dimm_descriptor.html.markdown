...
## Import
`intersight_firmware_dimm_descriptor` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_firmware_dimm_descriptor.example 1234567890987654321abcde
``` 