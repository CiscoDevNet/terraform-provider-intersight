...
# Resource: intersight_license_inc_license_count
Customer operation object to request reservation code.
## Argument Reference
...
## Import
`intersight_license_inc_license_count` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_license_inc_license_count.example 1234567890987654321abcde
``` 
