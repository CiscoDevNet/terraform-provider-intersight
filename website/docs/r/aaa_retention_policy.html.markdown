...
## Import
`intersight_aaa_retention_policy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_aaa_retention_policy.example 1234567890987654321abcde
``` 
