...
# Resource: intersight_iwotenant_migrate
Api used to transfer customer's IWO data.
## Argument Reference
...
## Import
`intersight_iwotenant_migrate` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_iwotenant_migrate.example 1234567890987654321abcde
``` 
