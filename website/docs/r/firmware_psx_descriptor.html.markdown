...
layout: "intersight"
page_title: "Intersight: intersight_firmware_psx_descriptor"
description: |-
        Descriptor to uniquely identify a PSX component.

---

# Resource: intersight_firmware_psx_descriptor
Descriptor to uniquely identify a PSX component.
## Argument Reference
...
## Import
`intersight_firmware_psx_descriptor` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_firmware_psx_descriptor.example 1234567890987654321abcde
``` 
