...
# Resource: intersight_kubernetes_sys_config_policy
A policy specifying system configuration such as timezone, DNS servers, and NTP Servers.
## Usage Example
### Resource Creation
...
## Import
`intersight_kubernetes_sys_config_policy` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_kubernetes_sys_config_policy.example 1234567890987654321abcde
``` 
