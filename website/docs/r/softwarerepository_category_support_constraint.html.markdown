...
sidebar_current: "docs-intersight-resource-softwarerepository-category-support-constraint"
description: |-
  Defines constraints for models which are supported from certain minimum image version.
---

# Resource: intersight_softwarerepository._category_support_constraint
Defines constraints for models which are supported from certain minimum image version.
## Argument Reference
