...
* `cluster_addon_profile`:(HashMap) - A reference to a kubernetesClusterAddonProfile resource.When the $expand query parameter is specified, the referenced resource is returned inline. 
