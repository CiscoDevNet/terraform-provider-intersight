...
* `visual_config`:(JSON as string) Chart configuration options. 


## Import
`intersight_metrics_metrics_exploration` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_metrics_metrics_exploration.example 1234567890987654321abcde
``` 
