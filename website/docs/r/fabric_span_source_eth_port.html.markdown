...
# Resource: intersight_fabric_span_source_eth_port
Configures Ethernet SPAN Source Port (Uplink) for a given SPAN session.
## Argument Reference
...
## Import
`intersight_fabric_span_source_eth_port` can be imported using the Moid of the object, e.g.
```
$ terraform import intersight_fabric_span_source_eth_port.example 1234567890987654321abcde
``` 
