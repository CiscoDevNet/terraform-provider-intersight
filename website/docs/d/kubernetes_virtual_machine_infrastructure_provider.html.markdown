...
To access the ith object of the results obtained, use `data.intersight_kubernetes_virtual_machine_infrastructure_provider.<custom_name>.results[i].<propertyname>`.
