...
layout: "intersight"
page_title: "Intersight: intersight_software_hci_distributable"
description: |-
        An HCI image distributed by Cisco.

---

# Data Source: intersight_software_hci_distributable
An HCI image distributed by Cisco.
## Argument Reference
The results of this data source are stored in `results` property.
All objects matching the filter criteria are fetched through pagination.
To access the ith object of the results obtained, use `data.intersight_software_hci_distributable.<custom_name>.results[i].<propertyname>`.
