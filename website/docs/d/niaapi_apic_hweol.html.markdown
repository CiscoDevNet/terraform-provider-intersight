...
description: |-
        The ApicHweol object is central to hardware lifecycle management, detailing end-of-life status for hardware components specific to the APIC platform. It supports users in planning transitions and maintaining system operability.
        #### Purpose
        ApicHweol provides timelines for the cessation of sales and support for hardware components on the APIC platform, including end-of-maintenance and analysis dates.
        #### Key Concepts
        - **Platform-Specific Lifecycle:** Offers a schedule for hardware lifecycle stages on the APIC platform.
