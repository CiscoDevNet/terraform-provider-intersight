...
# Data Source: intersight_softwarerepository_category_unsupported_models
Defines constraints for models which are unsupported after specific infra version.
## Argument Reference
The results of this data source are stored in `results` property.
All objects matching the filter criteria are fetched through pagination.
To access the ith object of the results obtained, use `data.intersight_softwarerepository_category_unsupported_models.<custom_name>.results[i].<propertyname>`.
