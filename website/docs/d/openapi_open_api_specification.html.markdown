...
subcategory: "openapi"
layout: "intersight"
page_title: "Intersight: intersight_openapi_open_api_specification"
description: |-
        An OpenAPI specification file uploaded to generate workflow tasks.

---

# Data Source: intersight_openapi_open_api_specification
An OpenAPI specification file uploaded to generate workflow tasks.
## Argument Reference
The results of this data source are stored in `results` property.
All objects matching the filter criteria are fetched through pagination.
To access the ith object of the results obtained, use `data.intersight_openapi_open_api_specification.<custom_name>.results[i].<propertyname>`.
...
* `file_upload_id`:(string) A unique tracking ID for the file being uploaded. 
