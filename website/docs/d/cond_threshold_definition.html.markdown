...
subcategory: "cond"
layout: "intersight"
page_title: "Intersight: intersight_cond_threshold_definition"
description: |-
        Defines the conditions to trigger a custom alarm. This has the information needed to construct and evaluate alarms.

---

# Data Source: intersight_cond_threshold_definition
Defines the conditions to trigger a custom alarm. This has the information needed to construct and evaluate alarms.
## Argument Reference
The results of this data source are stored in `results` property.
All objects matching the filter criteria are fetched through pagination.
To access the ith object of the results obtained, use `data.intersight_cond_threshold_definition.<custom_name>.results[i].<propertyname>`.
