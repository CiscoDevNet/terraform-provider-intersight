...
layout: "intersight"
page_title: "Intersight: intersight_workload_clear_workload_tag"
description: |-
        ### Overview
        ...
        #### Key Concepts
        - **Untag Workload Tag:** - Removes the workload tag from all the specified objects.

---

# Data Source: intersight_workload_clear_workload_tag
### Overview
The ClearWorkloadTag API helps remove the system-defined workload tag from the specified objects. 
This API should only be used under the guidance of TAC or a System Administrator. 
#### Purpose
...
To access the ith object of the results obtained, use `data.intersight_workload_clear_workload_tag.<custom_name>.results[i].<propertyname>`.
