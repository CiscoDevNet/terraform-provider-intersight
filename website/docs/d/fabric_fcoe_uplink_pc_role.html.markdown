...
* `fec`:(string) Forward error correction configuration for Fcoe Uplink Port Channel member ports.* `Auto` - Forward error correction option 'Auto'.* `Cl91` - Forward error correction option 'cl91'.* `Cl74` - Forward error correction option 'cl74'. 
