...
To access the ith object of the results obtained, use `data.intersight_virtualization_iwe_virtual_machine_network_interface.<custom_name>.results[i].<propertyname>`.
