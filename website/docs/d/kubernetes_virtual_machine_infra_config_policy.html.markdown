...
To access the ith object of the results obtained, use `data.intersight_kubernetes_virtual_machine_infra_config_policy.<custom_name>.results[i].<propertyname>`.
