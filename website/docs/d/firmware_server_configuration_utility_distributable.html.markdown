...
To access the ith object of the results obtained, use `data.intersight_firmware_server_configuration_utility_distributable.<custom_name>.results[i].<propertyname>`.
