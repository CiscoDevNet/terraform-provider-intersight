...
# Data Source: intersight_firmware_storage_controller_descriptor
Descriptor to uniquely identify a storage controller.
## Argument Reference
The results of this data source are stored in `results` property.
All objects matching the filter criteria are fetched through pagination.
To access the ith object of the results obtained, use `data.intersight_firmware_storage_controller_descriptor.<custom_name>.results[i].<propertyname>`.
