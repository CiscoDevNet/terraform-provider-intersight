...
layout: "intersight"
page_title: "Intersight: intersight_hyperflex_hxap_dv_uplink"
description: |-
  A HyperFlex Application Platform cluster wise distributed uplink entity.
---

# Data Source: intersight_hyperflex_hxap_dv_uplink
A HyperFlex Application Platform cluster wise distributed uplink entity.
## Argument Reference
The results of this data source are stored in `results` property.
All objects matching the filter criteria are fetched through pagination.
To access the ith object of the results obtained, use `data.intersight_hyperflex_hxap_dv_uplink.<custom_name>.results[i].<propertyname>`.
