...
To access the ith object of the results obtained, use `data.intersight_fabric_port_operation.<custom_name>.results[i].<propertyname>`.
...
* `switch_name`:(string) Name of the switch on which the port operation is performed. 
